...
See RM specification of the xref:{class_composition}[COMPOSITION] class.
...
See RM specification of the xref:{class_admin_entry}[ADMIN_ENTRY] class.
...
See RM specification of the xref:{class_instruction}[INSTRUCTION] class.
...
See RM specification of the xref:{class_evaluation}[EVALUATION] class.
...
See RM specification of the xref:{class_element}[ELEMENT] class.
...
See RM specification of the xref:{class_cluster}[CLUSTER] class.
...
See RM specification of the xref:{class_link}[LINK] class.
...
See RM specification of the xref:{class_feeder_audit}[FEEDER_AUDIT] class.
...
See RM specification of the xref:{class_feeder_audit_details}[FEEDER_AUDIT_DETAILS] class.
...
See RM specification of the xref:{class_activity}[ACTIVITY] class.
...
See RM specification of the xref:{class_instruction_details}[INSTRUCTION_DETAILS] class.
...
See RM specification of the xref:{class_event_context}[EVENT_CONTEXT] class.
...
See RM specification of the xref:{class_interval_event}[INTERVAL_EVENT] class.
...
See RM specification of the xref:{class_party_proxy}[PARTY_PROXY] class.
...
See RM specification of the xref:{class_party_self}[PARTY_SELF] class.
...
See RM specification of the xref:{class_party_identified}[PARTY_IDENTIFIED] class.
...
See RM specification of the xref:{class_party_related}[PARTY_RELATED] class.
...
See RM specification of the xref:{class_dv_text}[DV_TEXT] class.
...
See RM specification of the xref:{class_code_phrase}[CODE_PHRASE] class.
...
See RM specification of the xref:{class_term_mapping}[TERM_MAPPING] class.
...
See RM specification of the xref:{class_dv_coded_text}[DV_CODED_TEXT] class.
...
See RM specification of the xref:{class_dv_ordinal}[DV_ORDINAL] class.
...
See RM specification of the xref:{class_dv_boolean}[DV_BOOLEAN] class.
...
See RM specification of the xref:{class_dv_uri}[DV_URI] class.
...
See RM specification of the xref:{class_dv_ehr_uri}[DV_EHR_URI] class.
...
See RM specification of the xref:{class_dv_quantity}[DV_QUANTITY] class.
...
See RM specification of the xref:{class_dv_proportion}[DV_PROPORTION] class.
...
See RM specification of the xref:{class_dv_count}[DV_COUNT] class.
...
See RM specification of the xref:{class_dv_date}[DV_DATE] class.
...
See RM specification of the xref:{class_dv_duration}[DV_DURATION] class.
...
See RM specification of the xref:{class_reference_range}[REFERENCE_RANGE] class.
...
See RM specification of the xref:{class_dv_parsable}[DV_PARSABLE] class.
...
See RM specification of the xref:{class_dv_multimedia}[DV_MULTIMEDIA] class.
...
See RM specification of the xref:{class_dv_interval}[DV_INTERVAL] class.
