...
[.text-center]
.Standalone Launch
image::diagrams/smart_standalone_launch.svg[id=smart_standalone_launch, align="center"]
...
[.text-center]
.Embedded iFrame Launch
image::diagrams/smart_embedded_iframe_launch.svg[id=smart_embedded_iframe_launch, align="center"]
