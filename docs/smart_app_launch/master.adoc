...
* Sidharth Ramesh; openEHR Foundation Management Board.
...
include::master05-authentication_authorization_scopes.adoc[leveloffset=+1]
include::master06-context_selection.adoc[leveloffset=+1]
include::master07-launch.adoc[leveloffset=+1]
