...
[.text-center]
.Standalone Launch
image::{diagrams_uri}/smart_standalone_launch.png[id=smart_standalone_launch, align="center"]
...
[.text-center]
.Embedded iFrame Launch
image::{diagrams_uri}/smart_embedded_iframe_launch.png[id=smart_embedded_iframe_launch, align="center"]
