...
|[[latest_issue]]1.1.1
|{spec_tickets}/SPECITS-94[SPECITS-94^]. Clarified Level Removal (attribute elision vs wrapper collapse) and `EVENT` rule; documented `\|other` suffix for `DV_CODED_TEXT` open value-sets.
|REST WG
