<table>
    ...
    <thead>
    <tr>
        <th colspan="2">© 2003 - 2021 The openEHR Foundation</th>
    </tr>
    </thead>
    <tbody>
    <tr>
...
This specification is in the `STABLE` state, and can be downloaded as [OpenAPI specification](https://spec.openapis.org/oas/v3.0.3) file (in yaml format) [for validation](overview-validation.openapi.yaml), or [for code generators](overview-codegen.openapi.yaml).
