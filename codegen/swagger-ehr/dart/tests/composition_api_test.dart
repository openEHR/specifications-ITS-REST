...
void main() {
  var instance = new COMPOSITIONApi();
  ...
  group('tests for COMPOSITIONApi', () {
    ...
    //
    //Future<Composition> compositionUpdate(Composition body, String ehrId, String uidBasedId, String ifMatch, { String prefer }) async
