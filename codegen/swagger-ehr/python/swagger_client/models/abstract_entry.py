...
import six
from swagger_client.models.content_item import ContentItem  # noqa: F401,E501

class AbstractEntry(ContentItem):
    ...
    if hasattr(ContentItem, "swagger_types"):
        swagger_types.update(ContentItem.swagger_types)
    ...
    if hasattr(ContentItem, "attribute_map"):
        attribute_map.update(ContentItem.attribute_map)

    discriminator_value_class_map = {
            'ADMIN_ENTRY'.lower(): '#/components/schemas/AdminEntry',
            'CARE_ENTRY'.lower(): '#/components/schemas/CareEntry',
            'OBSERVATION'.lower(): '#/components/schemas/Observation',
            'EVALUATION'.lower(): '#/components/schemas/Evaluation',
            'INSTRUCTION'.lower(): '#/components/schemas/Instruction',
            'ACTION'.lower(): '#/components/schemas/Action',
    }

    def __init__(self, language=None, encoding=None, other_participations=None, workflow_id=None, subject=None, provider=None, *args, **kwargs):  # noqa: E501
        """AbstractEntry - a model defined in Swagger"""  # noqa: E501
        self._language = None
        self._encoding = None
        self._other_participations = None
        ...
        if other_participations is not None:
        ...
        ContentItem.__init__(self, *args, **kwargs)

    @property
    def language(self):
        """Gets the language of this AbstractEntry.  # noqa: E501


        :return: The language of this AbstractEntry.  # noqa: E501
        :rtype: CodePhrase
        """
    ...
    def language(self, language):
        """Sets the language of this AbstractEntry.


        :param language: The language of this AbstractEntry.  # noqa: E501
        :type: CodePhrase
        """
        if language is None:
    ...
    @property
    def encoding(self):
        """Gets the encoding of this AbstractEntry.  # noqa: E501


        :return: The encoding of this AbstractEntry.  # noqa: E501
        :rtype: CodePhrase
        """
    ...
    def encoding(self, encoding):
        """Sets the encoding of this AbstractEntry.


        :param encoding: The encoding of this AbstractEntry.  # noqa: E501
        :type: CodePhrase
        """
        if encoding is None:
    ...
    @property
    def other_participations(self):
        """Gets the other_participations of this AbstractEntry.  # noqa: E501


        :return: The other_participations of this AbstractEntry.  # noqa: E501
        :rtype: list[Participation]
        """
        return self._other_participations

    @other_participations.setter
    def other_participations(self, other_participations):
        """Sets the other_participations of this AbstractEntry.


        :param other_participations: The other_participations of this AbstractEntry.  # noqa: E501
        :type: list[Participation]
        """

        self._other_participations = other_participations

    @property
    def workflow_id(self):
        """Gets the workflow_id of this AbstractEntry.  # noqa: E501


        :return: The workflow_id of this AbstractEntry.  # noqa: E501
        :rtype: ObjectRef
        """
    ...
    def workflow_id(self, workflow_id):
        """Sets the workflow_id of this AbstractEntry.


        :param workflow_id: The workflow_id of this AbstractEntry.  # noqa: E501
        :type: ObjectRef
        """
    ...
    @property
    def subject(self):
        """Gets the subject of this AbstractEntry.  # noqa: E501


        :return: The subject of this AbstractEntry.  # noqa: E501
        :rtype: PartyProxy
        """
    ...
    def subject(self, subject):
        """Sets the subject of this AbstractEntry.


        :param subject: The subject of this AbstractEntry.  # noqa: E501
        :type: PartyProxy
        """
        if subject is None:
    ...
    @property
    def provider(self):
        """Gets the provider of this AbstractEntry.  # noqa: E501


        :return: The provider of this AbstractEntry.  # noqa: E501
        :rtype: PartyProxy
        """
    ...
    def provider(self, provider):
        """Sets the provider of this AbstractEntry.


        :param provider: The provider of this AbstractEntry.  # noqa: E501
        :type: PartyProxy
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AbstractEntry, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AbstractEntry):
            return False
