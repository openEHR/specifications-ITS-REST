...
import six
from swagger_client.models.abstract_entry import AbstractEntry  # noqa: F401,E501

class CareEntry(AbstractEntry):
    ...
    if hasattr(AbstractEntry, "swagger_types"):
        swagger_types.update(AbstractEntry.swagger_types)

    attribute_map = {
        'protocol': 'protocol',
        'guideline_id': 'guideline_id'
    }
    if hasattr(AbstractEntry, "attribute_map"):
        attribute_map.update(AbstractEntry.attribute_map)
    ...
    def __init__(self, protocol=None, guideline_id=None, *args, **kwargs):  # noqa: E501
        """CareEntry - a model defined in Swagger"""  # noqa: E501
        self._protocol = None
        self._guideline_id = None
        self.discriminator = 'type'
        if protocol is not None:
            self.protocol = protocol
        if guideline_id is not None:
            self.guideline_id = guideline_id
        AbstractEntry.__init__(self, *args, **kwargs)

    @property
    def protocol(self):
        """Gets the protocol of this CareEntry.  # noqa: E501


        :return: The protocol of this CareEntry.  # noqa: E501
        :rtype: ItemStructure
        """
    ...
    def protocol(self, protocol):
        """Sets the protocol of this CareEntry.


        :param protocol: The protocol of this CareEntry.  # noqa: E501
        :type: ItemStructure
        """
    ...
    @property
    def guideline_id(self):
        """Gets the guideline_id of this CareEntry.  # noqa: E501


        :return: The guideline_id of this CareEntry.  # noqa: E501
        :rtype: ObjectRef
        """
        return self._guideline_id

    @guideline_id.setter
    def guideline_id(self, guideline_id):
        """Sets the guideline_id of this CareEntry.


        :param guideline_id: The guideline_id of this CareEntry.  # noqa: E501
        :type: ObjectRef
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CareEntry):
            return False
