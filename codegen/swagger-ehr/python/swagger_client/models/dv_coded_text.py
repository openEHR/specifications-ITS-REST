...
import six
from swagger_client.models.dv_text import DvText  # noqa: F401,E501
...
class DvCodedText(DvText):
    ...
    if hasattr(DvText, "swagger_types"):
        swagger_types.update(DvText.swagger_types)

    attribute_map = {
        'type': '_type',
        'defining_code': 'defining_code'
    }
    if hasattr(DvText, "attribute_map"):
        attribute_map.update(DvText.attribute_map)

    def __init__(self, type='DV_CODED_TEXT', defining_code=None, *args, **kwargs):  # noqa: E501
        """DvCodedText - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._defining_code = None
        self.discriminator = None
        if type is not None:
            self.type = type
        self.defining_code = defining_code
        DvText.__init__(self, *args, **kwargs)

    @property
    def type(self):
        """Gets the type of this DvCodedText.  # noqa: E501


        :return: The type of this DvCodedText.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this DvCodedText.


        :param type: The type of this DvCodedText.  # noqa: E501
        :type: str
        """
    ...
    def defining_code(self):
        """Gets the defining_code of this DvCodedText.  # noqa: E501


        :return: The defining_code of this DvCodedText.  # noqa: E501
        :rtype: CodePhrase
        """
        return self._defining_code

    @defining_code.setter
    def defining_code(self, defining_code):
        """Sets the defining_code of this DvCodedText.


        :param defining_code: The defining_code of this DvCodedText.  # noqa: E501
        :type: CodePhrase
        """
        if defining_code is None:
            raise ValueError("Invalid value for `defining_code`, must not be `None`")  # noqa: E501

        self._defining_code = defining_code
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DvCodedText, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DvCodedText):
            return False
