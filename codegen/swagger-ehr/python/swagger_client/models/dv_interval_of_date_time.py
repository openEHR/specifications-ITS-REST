...
import six
from swagger_client.models.dv_interval import DvInterval  # noqa: F401,E501

class DvIntervalOfDateTime(DvInterval):
    ...
    if hasattr(DvInterval, "swagger_types"):
        swagger_types.update(DvInterval.swagger_types)
    ...
    if hasattr(DvInterval, "attribute_map"):
        attribute_map.update(DvInterval.attribute_map)

    def __init__(self, type='DV_INTERVAL', lower=None, upper=None, *args, **kwargs):  # noqa: E501
        """DvIntervalOfDateTime - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._lower = None
        self._upper = None
        ...
        if upper is not None:
            self.upper = upper
        DvInterval.__init__(self, *args, **kwargs)

    @property
    def type(self):
        """Gets the type of this DvIntervalOfDateTime.  # noqa: E501


        :return: The type of this DvIntervalOfDateTime.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this DvIntervalOfDateTime.


        :param type: The type of this DvIntervalOfDateTime.  # noqa: E501
        :type: str
        """
    ...
    @property
    def lower(self):
        """Gets the lower of this DvIntervalOfDateTime.  # noqa: E501


        :return: The lower of this DvIntervalOfDateTime.  # noqa: E501
        :rtype: DvDateTime
        """
        return self._lower
    ...
    def lower(self, lower):
        """Sets the lower of this DvIntervalOfDateTime.


        :param lower: The lower of this DvIntervalOfDateTime.  # noqa: E501
        :type: DvDateTime
        """
    ...
    @property
    def upper(self):
        """Gets the upper of this DvIntervalOfDateTime.  # noqa: E501


        :return: The upper of this DvIntervalOfDateTime.  # noqa: E501
        :rtype: DvDateTime
        """
        return self._upper
    ...
    def upper(self, upper):
        """Sets the upper of this DvIntervalOfDateTime.


        :param upper: The upper of this DvIntervalOfDateTime.  # noqa: E501
        :type: DvDateTime
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DvIntervalOfDateTime, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DvIntervalOfDateTime):
            return False
