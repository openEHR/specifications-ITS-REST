...
import six
from swagger_client.models.item_structure import ItemStructure  # noqa: F401,E501
...
class ItemSingle(ItemStructure):
    ...
    if hasattr(ItemStructure, "swagger_types"):
        swagger_types.update(ItemStructure.swagger_types)

    attribute_map = {
        'type': '_type',
        'item': 'item'
    }
    if hasattr(ItemStructure, "attribute_map"):
        attribute_map.update(ItemStructure.attribute_map)

    def __init__(self, type='ITEM_SINGLE', item=None, *args, **kwargs):  # noqa: E501
        """ItemSingle - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._item = None
        ...
        if type is not None:
            self.type = type
        self.item = item
        ItemStructure.__init__(self, *args, **kwargs)

    @property
    def type(self):
        """Gets the type of this ItemSingle.  # noqa: E501


        :return: The type of this ItemSingle.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this ItemSingle.


        :param type: The type of this ItemSingle.  # noqa: E501
        :type: str
        """
    ...
    @property
    def item(self):
        """Gets the item of this ItemSingle.  # noqa: E501


        :return: The item of this ItemSingle.  # noqa: E501
        :rtype: Element
        """
        return self._item
    ...
    @item.setter
    def item(self, item):
        """Sets the item of this ItemSingle.


        :param item: The item of this ItemSingle.  # noqa: E501
        :type: Element
        """
        if item is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ItemSingle):
            return False
