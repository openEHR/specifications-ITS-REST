...
import six
from swagger_client.models.party_identified import PartyIdentified  # noqa: F401,E501
...
class PartyRelated(PartyIdentified):
    ...
    if hasattr(PartyIdentified, "swagger_types"):
        swagger_types.update(PartyIdentified.swagger_types)

    attribute_map = {
        'type': '_type',
        'relationship': 'relationship'
    }
    if hasattr(PartyIdentified, "attribute_map"):
        attribute_map.update(PartyIdentified.attribute_map)

    def __init__(self, type='PARTY_RELATED', relationship=None, *args, **kwargs):  # noqa: E501
        """PartyRelated - a model defined in Swagger"""  # noqa: E501
        self._type = None
        ...
        PartyIdentified.__init__(self, *args, **kwargs)

    @property
    def type(self):
        """Gets the type of this PartyRelated.  # noqa: E501


        :return: The type of this PartyRelated.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this PartyRelated.


        :param type: The type of this PartyRelated.  # noqa: E501
        :type: str
        """
    ...
    def relationship(self):
        """Gets the relationship of this PartyRelated.  # noqa: E501


        :return: The relationship of this PartyRelated.  # noqa: E501
        :rtype: DvCodedText
        """
    ...
    def relationship(self, relationship):
        """Sets the relationship of this PartyRelated.


        :param relationship: The relationship of this PartyRelated.  # noqa: E501
        :type: DvCodedText
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PartyRelated, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PartyRelated):
            return False
