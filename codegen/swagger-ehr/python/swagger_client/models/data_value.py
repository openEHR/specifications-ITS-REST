...
class DataValue(object):
    ...
    discriminator_value_class_map = {
            ...
            'DV_BOOLEAN'.lower(): '#/components/schemas/DvBoolean',
            ...
            'DV_EHR_URI'.lower(): '#/components/schemas/DvEhrUri',
            'DV_ENCAPSULATED'.lower(): '#/components/schemas/DvEncapsulated',
            'DV_IDENTIFIER'.lower(): '#/components/schemas/DvIdentifier',
            'DV_INTERVAL'.lower(): '#/components/schemas/DvInterval',
            'DV_INTERVAL_of_DATE_TIME'.lower(): '#/components/schemas/DvIntervalOfDateTime',
            'DV_MULTIMEDIA'.lower(): '#/components/schemas/DvMultimedia',
            'DV_ORDERED'.lower(): '#/components/schemas/DvOrdered',
            'DV_ORDINAL'.lower(): '#/components/schemas/DvOrdinal',
            'DV_PARSABLE'.lower(): '#/components/schemas/DvParsable',
            ...
            'DV_STATE'.lower(): '#/components/schemas/DvState',
            ...
            'DV_URI'.lower(): '#/components/schemas/DvUri',
    }
    ...
    @property
    def type(self):
        """Gets the type of this DataValue.  # noqa: E501


        :return: The type of this DataValue.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this DataValue.


        :param type: The type of this DataValue.  # noqa: E501
        :type: str
        """
