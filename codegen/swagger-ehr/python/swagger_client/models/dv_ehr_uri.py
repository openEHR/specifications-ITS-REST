...
import six
from swagger_client.models.dv_uri import DvUri  # noqa: F401,E501
...
class DvEhrUri(DvUri):
    ...
    if hasattr(DvUri, "swagger_types"):
        swagger_types.update(DvUri.swagger_types)

    attribute_map = {
        'type': '_type'
    }
    if hasattr(DvUri, "attribute_map"):
        attribute_map.update(DvUri.attribute_map)

    def __init__(self, type='DV_EHR_URI', *args, **kwargs):  # noqa: E501
        """DvEhrUri - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self.discriminator = None
        if type is not None:
            self.type = type
        DvUri.__init__(self, *args, **kwargs)

    @property
    def type(self):
        """Gets the type of this DvEhrUri.  # noqa: E501


        :return: The type of this DvEhrUri.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this DvEhrUri.


        :param type: The type of this DvEhrUri.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DvEhrUri):
            return False
