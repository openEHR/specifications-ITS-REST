...
class Action(CareEntry):
    ...
    def __init__(self, type='ACTION', time=None, ism_transition=None, instruction_details=None, description=None, *args, **kwargs):  # noqa: E501
        """Action - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._time = None
        self._ism_transition = None
    ...
    @property
    def time(self):
        """Gets the time of this Action.  # noqa: E501


        :return: The time of this Action.  # noqa: E501
        :rtype: DvDateTime
        """
        return self._time
    ...
    @property
    def ism_transition(self):
        """Gets the ism_transition of this Action.  # noqa: E501


        :return: The ism_transition of this Action.  # noqa: E501
        :rtype: IsmTransition
        """
        return self._ism_transition

    @ism_transition.setter
    def ism_transition(self, ism_transition):
        """Sets the ism_transition of this Action.


        :param ism_transition: The ism_transition of this Action.  # noqa: E501
        :type: IsmTransition
        """
        if ism_transition is None:
            raise ValueError("Invalid value for `ism_transition`, must not be `None`")  # noqa: E501

        self._ism_transition = ism_transition

    @property
    def instruction_details(self):
        """Gets the instruction_details of this Action.  # noqa: E501


        :return: The instruction_details of this Action.  # noqa: E501
        :rtype: InstructionDetails
        """
        return self._instruction_details

    @instruction_details.setter
    def instruction_details(self, instruction_details):
        """Sets the instruction_details of this Action.


        :param instruction_details: The instruction_details of this Action.  # noqa: E501
