...
class TerminologyId(ObjectId):
    ...
    def __init__(self, type='TERMINOLOGY_ID', *args, **kwargs):  # noqa: E501
        """TerminologyId - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    @property
    def type(self):
        """Gets the type of this TerminologyId.  # noqa: E501


        :return: The type of this TerminologyId.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this TerminologyId.


        :param type: The type of this TerminologyId.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TerminologyId, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TerminologyId):
            return False
