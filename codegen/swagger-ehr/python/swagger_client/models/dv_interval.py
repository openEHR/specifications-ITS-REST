...
import six
from swagger_client.models.data_value import DataValue  # noqa: F401,E501
...
class DvInterval(DataValue):
    ...
    if hasattr(DataValue, "swagger_types"):
        swagger_types.update(DataValue.swagger_types)
    ...
    if hasattr(DataValue, "attribute_map"):
        attribute_map.update(DataValue.attribute_map)

    discriminator_value_class_map = {
            'DV_INTERVAL'.lower(): '#/components/schemas/DvInterval',
            'DV_INTERVAL_of_DATE_TIME'.lower(): '#/components/schemas/DvIntervalOfDateTime',
    }

    def __init__(self, type='DV_INTERVAL', lower_unbounded=None, upper_unbounded=None, lower_included=None, upper_included=None, *args, **kwargs):  # noqa: E501
        """DvInterval - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._lower_unbounded = None
        self._upper_unbounded = None
        self._lower_included = None
        self._upper_included = None
        self.discriminator = 'type'
        if type is not None:
            self.type = type
        self.lower_unbounded = lower_unbounded
        self.upper_unbounded = upper_unbounded
    ...
    @property
    def type(self):
        """Gets the type of this DvInterval.  # noqa: E501


        :return: The type of this DvInterval.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this DvInterval.


        :param type: The type of this DvInterval.  # noqa: E501
        :type: str
        """
    ...
    @property
    def lower_unbounded(self):
        """Gets the lower_unbounded of this DvInterval.  # noqa: E501


        :return: The lower_unbounded of this DvInterval.  # noqa: E501
        :rtype: bool
        """
        return self._lower_unbounded

    @lower_unbounded.setter
    def lower_unbounded(self, lower_unbounded):
        """Sets the lower_unbounded of this DvInterval.


        :param lower_unbounded: The lower_unbounded of this DvInterval.  # noqa: E501
        :type: bool
        """
        if lower_unbounded is None:
            raise ValueError("Invalid value for `lower_unbounded`, must not be `None`")  # noqa: E501

        self._lower_unbounded = lower_unbounded

    @property
    def upper_unbounded(self):
        """Gets the upper_unbounded of this DvInterval.  # noqa: E501


        :return: The upper_unbounded of this DvInterval.  # noqa: E501
        :rtype: bool
        """
        return self._upper_unbounded

    @upper_unbounded.setter
    def upper_unbounded(self, upper_unbounded):
        """Sets the upper_unbounded of this DvInterval.


        :param upper_unbounded: The upper_unbounded of this DvInterval.  # noqa: E501
        :type: bool
        """
        if upper_unbounded is None:
            raise ValueError("Invalid value for `upper_unbounded`, must not be `None`")  # noqa: E501

        self._upper_unbounded = upper_unbounded

    @property
    def lower_included(self):
        """Gets the lower_included of this DvInterval.  # noqa: E501


        :return: The lower_included of this DvInterval.  # noqa: E501
        :rtype: bool
        """
        return self._lower_included

    @lower_included.setter
    def lower_included(self, lower_included):
        """Sets the lower_included of this DvInterval.


        :param lower_included: The lower_included of this DvInterval.  # noqa: E501
        :type: bool
        """
        if lower_included is None:
            raise ValueError("Invalid value for `lower_included`, must not be `None`")  # noqa: E501

        self._lower_included = lower_included

    @property
    def upper_included(self):
        """Gets the upper_included of this DvInterval.  # noqa: E501


        :return: The upper_included of this DvInterval.  # noqa: E501
        :rtype: bool
        """
        return self._upper_included

    @upper_included.setter
    def upper_included(self, upper_included):
        """Sets the upper_included of this DvInterval.


        :param upper_included: The upper_included of this DvInterval.  # noqa: E501
        :type: bool
        """
        if upper_included is None:
            raise ValueError("Invalid value for `upper_included`, must not be `None`")  # noqa: E501

        self._upper_included = upper_included
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DvInterval):
            return False
