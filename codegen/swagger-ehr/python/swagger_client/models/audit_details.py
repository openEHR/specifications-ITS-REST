...
class AuditDetails(object):
    ...
    discriminator_value_class_map = {
            'AUDIT_DETAILS'.lower(): '#/components/schemas/AuditDetails',
            'ATTESTATION'.lower(): '#/components/schemas/Attestation',
    }

    def __init__(self, type='AUDIT_DETAILS', system_id=None, time_committed=None, change_type=None, description=None, committer=None):  # noqa: E501
        """AuditDetails - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._system_id = None
        self._time_committed = None
        self._change_type = None
        self._description = None
        self._committer = None
        self.discriminator = '_type'
        if type is not None:
            self.type = type
    ...
    @property
    def type(self):
        """Gets the type of this AuditDetails.  # noqa: E501


        :return: The type of this AuditDetails.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this AuditDetails.


        :param type: The type of this AuditDetails.  # noqa: E501
        :type: str
        """
    ...
    @property
    def system_id(self):
        """Gets the system_id of this AuditDetails.  # noqa: E501


        :return: The system_id of this AuditDetails.  # noqa: E501
        :rtype: str
        """
    ...
    def system_id(self, system_id):
        """Sets the system_id of this AuditDetails.


        :param system_id: The system_id of this AuditDetails.  # noqa: E501
        :type: str
        """
    ...
    @property
    def time_committed(self):
        """Gets the time_committed of this AuditDetails.  # noqa: E501


        :return: The time_committed of this AuditDetails.  # noqa: E501
        :rtype: DvDateTime
        """
        return self._time_committed

    @time_committed.setter
    def time_committed(self, time_committed):
        """Sets the time_committed of this AuditDetails.


        :param time_committed: The time_committed of this AuditDetails.  # noqa: E501
        :type: DvDateTime
        """
        if time_committed is None:
            raise ValueError("Invalid value for `time_committed`, must not be `None`")  # noqa: E501

        self._time_committed = time_committed

    @property
    def change_type(self):
        """Gets the change_type of this AuditDetails.  # noqa: E501


        :return: The change_type of this AuditDetails.  # noqa: E501
        :rtype: DvCodedText
        """
    ...
    def change_type(self, change_type):
        """Sets the change_type of this AuditDetails.


        :param change_type: The change_type of this AuditDetails.  # noqa: E501
        :type: DvCodedText
        """
    ...
    def description(self):
        """Gets the description of this AuditDetails.  # noqa: E501


        :return: The description of this AuditDetails.  # noqa: E501
        :rtype: DvText
        """
    ...
    def description(self, description):
        """Sets the description of this AuditDetails.


        :param description: The description of this AuditDetails.  # noqa: E501
        :type: DvText
        """
    ...
    @property
    def committer(self):
        """Gets the committer of this AuditDetails.  # noqa: E501


        :return: The committer of this AuditDetails.  # noqa: E501
        :rtype: PartyProxy
        """
    ...
    def committer(self, committer):
        """Sets the committer of this AuditDetails.


        :param committer: The committer of this AuditDetails.  # noqa: E501
        :type: PartyProxy
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AuditDetails, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AuditDetails):
            return False
