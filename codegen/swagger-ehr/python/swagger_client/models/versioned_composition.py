...
import six
from swagger_client.models.versioned_object import VersionedObject  # noqa: F401,E501
...
class VersionedComposition(VersionedObject):
    ...
    if hasattr(VersionedObject, "swagger_types"):
        swagger_types.update(VersionedObject.swagger_types)

    attribute_map = {
        'type': '_type'
    }
    if hasattr(VersionedObject, "attribute_map"):
        attribute_map.update(VersionedObject.attribute_map)

    def __init__(self, type='VERSIONED_COMPOSITION', *args, **kwargs):  # noqa: E501
        """VersionedComposition - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self.discriminator = None
        if type is not None:
            self.type = type
        VersionedObject.__init__(self, *args, **kwargs)

    @property
    def type(self):
        """Gets the type of this VersionedComposition.  # noqa: E501


        :return: The type of this VersionedComposition.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this VersionedComposition.


        :param type: The type of this VersionedComposition.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(VersionedComposition, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VersionedComposition):
            return False
