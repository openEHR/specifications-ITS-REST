...
class UpdateVersion(object):
    ...
    swagger_types = {
        ...
        'attestations': 'list[UpdateAttestation]',
        'data': 'Versionable',
    ...
    def __init__(self, preceding_version_uid=None, signature=None, lifecycle_state=None, attestations=None, data=None, commit_audit=None):  # noqa: E501
        """UpdateVersion - a model defined in Swagger"""  # noqa: E501
        self._preceding_version_uid = None
        self._signature = None
        self._lifecycle_state = None
        self._attestations = None
        self._data = None
        self._commit_audit = None
    ...
    def preceding_version_uid(self):
        """Gets the preceding_version_uid of this UpdateVersion.  # noqa: E501


        :return: The preceding_version_uid of this UpdateVersion.  # noqa: E501
    ...
    def preceding_version_uid(self, preceding_version_uid):
        """Sets the preceding_version_uid of this UpdateVersion.


        :param preceding_version_uid: The preceding_version_uid of this UpdateVersion.  # noqa: E501
    ...
    @property
    def signature(self):
        """Gets the signature of this UpdateVersion.  # noqa: E501


        :return: The signature of this UpdateVersion.  # noqa: E501
        :rtype: str
        """
    ...
    def signature(self, signature):
        """Sets the signature of this UpdateVersion.


        :param signature: The signature of this UpdateVersion.  # noqa: E501
        :type: str
        """
    ...
    def lifecycle_state(self):
        """Gets the lifecycle_state of this UpdateVersion.  # noqa: E501


        :return: The lifecycle_state of this UpdateVersion.  # noqa: E501
        :rtype: TerminologyCode
        """
        return self._lifecycle_state

    @lifecycle_state.setter
    def lifecycle_state(self, lifecycle_state):
        """Sets the lifecycle_state of this UpdateVersion.


        :param lifecycle_state: The lifecycle_state of this UpdateVersion.  # noqa: E501
    ...
    def attestations(self):
        """Gets the attestations of this UpdateVersion.  # noqa: E501


        :return: The attestations of this UpdateVersion.  # noqa: E501
        :rtype: list[UpdateAttestation]
        """
        return self._attestations

    @attestations.setter
    def attestations(self, attestations):
        """Sets the attestations of this UpdateVersion.


        :param attestations: The attestations of this UpdateVersion.  # noqa: E501
        :type: list[UpdateAttestation]
        """
    ...
    @property
    def data(self):
        """Gets the data of this UpdateVersion.  # noqa: E501


        :return: The data of this UpdateVersion.  # noqa: E501
        :rtype: Versionable
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this UpdateVersion.


        :param data: The data of this UpdateVersion.  # noqa: E501
        :type: Versionable
        """
        if data is None:
    ...
    def commit_audit(self):
        """Gets the commit_audit of this UpdateVersion.  # noqa: E501


        :return: The commit_audit of this UpdateVersion.  # noqa: E501
        :rtype: UpdateAudit
        """
        return self._commit_audit

    @commit_audit.setter
    def commit_audit(self, commit_audit):
        """Sets the commit_audit of this UpdateVersion.


        :param commit_audit: The commit_audit of this UpdateVersion.  # noqa: E501
        :type: UpdateAudit
        """
        if commit_audit is None:
            raise ValueError("Invalid value for `commit_audit`, must not be `None`")  # noqa: E501

        self._commit_audit = commit_audit
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdateVersion, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateVersion):
            return False
