...
import six
from swagger_client.models.uid_based_id import UidBasedId  # noqa: F401,E501
...
class ObjectVersionId(UidBasedId):
    ...
    if hasattr(UidBasedId, "swagger_types"):
        swagger_types.update(UidBasedId.swagger_types)

    attribute_map = {
        'value': 'value'
    }
    if hasattr(UidBasedId, "attribute_map"):
        attribute_map.update(UidBasedId.attribute_map)

    def __init__(self, value=None, *args, **kwargs):  # noqa: E501
        """ObjectVersionId - a model defined in Swagger"""  # noqa: E501
        self._value = None
        self.discriminator = None
        self.value = value
        UidBasedId.__init__(self, *args, **kwargs)

    @property
    def value(self):
        """Gets the value of this ObjectVersionId.  # noqa: E501


        :return: The value of this ObjectVersionId.  # noqa: E501
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this ObjectVersionId.


        :param value: The value of this ObjectVersionId.  # noqa: E501
        :type: str
        """
        if value is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ObjectVersionId, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ObjectVersionId):
            return False
