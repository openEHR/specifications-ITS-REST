...
class Evaluation(CareEntry):
    ...
    def __init__(self, type='EVALUATION', data=None, *args, **kwargs):  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this Evaluation.  # noqa: E501


        :return: The data of this Evaluation.  # noqa: E501
        :rtype: ItemStructure
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this Evaluation.


        :param data: The data of this Evaluation.  # noqa: E501
        :type: ItemStructure
        """
        if data is None:
