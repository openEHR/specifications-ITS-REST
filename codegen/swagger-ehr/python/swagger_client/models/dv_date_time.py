...
import six
from swagger_client.models.dv_temporal import DvTemporal  # noqa: F401,E501
...
class DvDateTime(DvTemporal):
    ...
    if hasattr(DvTemporal, "swagger_types"):
        swagger_types.update(DvTemporal.swagger_types)

    attribute_map = {
        'type': '_type',
        'value': 'value'
    }
    if hasattr(DvTemporal, "attribute_map"):
        attribute_map.update(DvTemporal.attribute_map)

    def __init__(self, type='DV_DATE_TIME', value=None, *args, **kwargs):  # noqa: E501
        """DvDateTime - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._value = None
        ...
        if type is not None:
            self.type = type
        self.value = value
        DvTemporal.__init__(self, *args, **kwargs)

    @property
    def type(self):
        """Gets the type of this DvDateTime.  # noqa: E501


        :return: The type of this DvDateTime.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this DvDateTime.


        :param type: The type of this DvDateTime.  # noqa: E501
        :type: str
        """
    ...
    @property
    def value(self):
        """Gets the value of this DvDateTime.  # noqa: E501


        :return: The value of this DvDateTime.  # noqa: E501
        :rtype: datetime
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this DvDateTime.


        :param value: The value of this DvDateTime.  # noqa: E501
        :type: datetime
        """
        if value is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DvDateTime):
            return False
