...
class HierObjectId(UidBasedId):
    ...
    def __init__(self, value=None, *args, **kwargs):  # noqa: E501
        """HierObjectId - a model defined in Swagger"""  # noqa: E501
        self._value = None
    ...
    @property
    def value(self):
        """Gets the value of this HierObjectId.  # noqa: E501


        :return: The value of this HierObjectId.  # noqa: E501
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this HierObjectId.


        :param value: The value of this HierObjectId.  # noqa: E501
        :type: str
        """
        if value is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HierObjectId, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HierObjectId):
            return False
