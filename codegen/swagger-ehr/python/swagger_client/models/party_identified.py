...
import six
from swagger_client.models.party_proxy import PartyProxy  # noqa: F401,E501
...
class PartyIdentified(PartyProxy):
    ...
    swagger_types = {
        'type': 'str',
        'name': 'str',
        'identifiers': 'list[DvIdentifier]'
    }
    if hasattr(PartyProxy, "swagger_types"):
        swagger_types.update(PartyProxy.swagger_types)
    ...
    if hasattr(PartyProxy, "attribute_map"):
        attribute_map.update(PartyProxy.attribute_map)

    discriminator_value_class_map = {
            'PARTY_IDENTIFIED'.lower(): '#/components/schemas/PartyIdentified',
            'PARTY_RELATED'.lower(): '#/components/schemas/PartyRelated',
    }

    def __init__(self, type='PARTY_IDENTIFIED', name=None, identifiers=None, *args, **kwargs):  # noqa: E501
        """PartyIdentified - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._name = None
        ...
        PartyProxy.__init__(self, *args, **kwargs)

    @property
    def type(self):
        """Gets the type of this PartyIdentified.  # noqa: E501


        :return: The type of this PartyIdentified.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this PartyIdentified.


        :param type: The type of this PartyIdentified.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this PartyIdentified.  # noqa: E501


        :return: The name of this PartyIdentified.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this PartyIdentified.


        :param name: The name of this PartyIdentified.  # noqa: E501
        :type: str
        """
    ...
    def identifiers(self):
        """Gets the identifiers of this PartyIdentified.  # noqa: E501


        :return: The identifiers of this PartyIdentified.  # noqa: E501
    ...
    def identifiers(self, identifiers):
        """Sets the identifiers of this PartyIdentified.


        :param identifiers: The identifiers of this PartyIdentified.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PartyIdentified, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PartyIdentified):
            return False
