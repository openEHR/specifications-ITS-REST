...
import six
from swagger_client.models.object_id import ObjectId  # noqa: F401,E501
...
class UidBasedId(ObjectId):
    ...
    if hasattr(ObjectId, "swagger_types"):
        swagger_types.update(ObjectId.swagger_types)

    attribute_map = {
        'type': '_type'
    }
    if hasattr(ObjectId, "attribute_map"):
        attribute_map.update(ObjectId.attribute_map)

    discriminator_value_class_map = {
            'HIER_OBJECT_ID'.lower(): '#/components/schemas/HierObjectId',
            'OBJECT_VERSION_ID'.lower(): '#/components/schemas/ObjectVersionId',
    }

    def __init__(self, type='UID_BASED_ID', *args, **kwargs):  # noqa: E501
        """UidBasedId - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self.discriminator = 'type'
        if type is not None:
            self.type = type
        ObjectId.__init__(self, *args, **kwargs)

    @property
    def type(self):
        """Gets the type of this UidBasedId.  # noqa: E501


        :return: The type of this UidBasedId.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this UidBasedId.


        :param type: The type of this UidBasedId.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UidBasedId):
            return False
