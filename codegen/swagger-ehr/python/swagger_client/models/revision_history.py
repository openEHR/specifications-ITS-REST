...
class RevisionHistory(object):
    ...
    @property
    def items(self):
        """Gets the items of this RevisionHistory.  # noqa: E501


        :return: The items of this RevisionHistory.  # noqa: E501
        :rtype: list[RevisionHistoryItem]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this RevisionHistory.


        :param items: The items of this RevisionHistory.  # noqa: E501
        :type: list[RevisionHistoryItem]
        """
        if items is None:
