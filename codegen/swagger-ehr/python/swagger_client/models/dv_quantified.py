...
import six
from swagger_client.models.dv_ordered import DvOrdered  # noqa: F401,E501
...
class DvQuantified(DvOrdered):
    ...
    if hasattr(DvOrdered, "swagger_types"):
        swagger_types.update(DvOrdered.swagger_types)

    attribute_map = {
        'type': '_type',
        'magnitude_status': 'magnitude_status'
    }
    if hasattr(DvOrdered, "attribute_map"):
        attribute_map.update(DvOrdered.attribute_map)
    ...
    def __init__(self, type='DV_QUANTIFIED', magnitude_status='=', *args, **kwargs):  # noqa: E501
        """DvQuantified - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._magnitude_status = None
        self.discriminator = 'type'
        if type is not None:
            self.type = type
        if magnitude_status is not None:
            self.magnitude_status = magnitude_status
        DvOrdered.__init__(self, *args, **kwargs)

    @property
    def type(self):
        """Gets the type of this DvQuantified.  # noqa: E501


        :return: The type of this DvQuantified.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this DvQuantified.


        :param type: The type of this DvQuantified.  # noqa: E501
        :type: str
        """
    ...
    def magnitude_status(self):
        """Gets the magnitude_status of this DvQuantified.  # noqa: E501


        :return: The magnitude_status of this DvQuantified.  # noqa: E501
        :rtype: str
        """
        return self._magnitude_status

    @magnitude_status.setter
    def magnitude_status(self, magnitude_status):
        """Sets the magnitude_status of this DvQuantified.


        :param magnitude_status: The magnitude_status of this DvQuantified.  # noqa: E501
        :type: str
        """

        self._magnitude_status = magnitude_status
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DvQuantified, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DvQuantified):
            return False
