...
class DvOrdered(DataValue):
    ...
    swagger_types = {
        'type': 'str',
        'normal_status': 'CodePhrase',
        'normal_range': 'DvInterval',
        'other_reference_ranges': 'list[ReferenceRange]'
    }
    ...
    discriminator_value_class_map = {
            'DV_AMOUNT'.lower(): '#/components/schemas/DvAmount',
            'DV_COUNT'.lower(): '#/components/schemas/DvCount',
            'DV_DATE'.lower(): '#/components/schemas/DvDate',
            'DV_DATE_TIME'.lower(): '#/components/schemas/DvDateTime',
            'DV_DURATION'.lower(): '#/components/schemas/DvDuration',
            'DV_ORDINAL'.lower(): '#/components/schemas/DvOrdinal',
            'DV_PROPORTION'.lower(): '#/components/schemas/DvProportion',
            'DV_QUANTIFIED'.lower(): '#/components/schemas/DvQuantified',
            'DV_QUANTITY'.lower(): '#/components/schemas/DvQuantity',
            'DV_SCALE'.lower(): '#/components/schemas/DvScale',
            'DV_TEMPORAL'.lower(): '#/components/schemas/DvTemporal',
            'DV_TIME'.lower(): '#/components/schemas/DvTime',
    }

    def __init__(self, type='DV_ORDERED', normal_status=None, normal_range=None, other_reference_ranges=None, *args, **kwargs):  # noqa: E501
        """DvOrdered - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._normal_status = None
        self._normal_range = None
        self._other_reference_ranges = None
        ...
        if other_reference_ranges is not None:
            self.other_reference_ranges = other_reference_ranges
        DataValue.__init__(self, *args, **kwargs)

    @property
    def type(self):
        """Gets the type of this DvOrdered.  # noqa: E501


        :return: The type of this DvOrdered.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this DvOrdered.


        :param type: The type of this DvOrdered.  # noqa: E501
        :type: str
        """
    ...
    def normal_status(self):
        """Gets the normal_status of this DvOrdered.  # noqa: E501


        :return: The normal_status of this DvOrdered.  # noqa: E501
        :rtype: CodePhrase
        """
        return self._normal_status

    @normal_status.setter
    def normal_status(self, normal_status):
        """Sets the normal_status of this DvOrdered.


        :param normal_status: The normal_status of this DvOrdered.  # noqa: E501
        :type: CodePhrase
        """
    ...
    def normal_range(self):
        """Gets the normal_range of this DvOrdered.  # noqa: E501


        :return: The normal_range of this DvOrdered.  # noqa: E501
        :rtype: DvInterval
        """
    ...
    def normal_range(self, normal_range):
        """Sets the normal_range of this DvOrdered.


        :param normal_range: The normal_range of this DvOrdered.  # noqa: E501
        :type: DvInterval
        """
    ...
    def other_reference_ranges(self):
        """Gets the other_reference_ranges of this DvOrdered.  # noqa: E501


        :return: The other_reference_ranges of this DvOrdered.  # noqa: E501
        :rtype: list[ReferenceRange]
        """
        return self._other_reference_ranges

    @other_reference_ranges.setter
    def other_reference_ranges(self, other_reference_ranges):
        """Sets the other_reference_ranges of this DvOrdered.


        :param other_reference_ranges: The other_reference_ranges of this DvOrdered.  # noqa: E501
        :type: list[ReferenceRange]
        """

        self._other_reference_ranges = other_reference_ranges
