...
import six
from swagger_client.models.data_structure import DataStructure  # noqa: F401,E501
...
class ItemStructure(DataStructure):
    ...
    if hasattr(DataStructure, "swagger_types"):
        swagger_types.update(DataStructure.swagger_types)

    attribute_map = {
        'type': '_type'
    }
    if hasattr(DataStructure, "attribute_map"):
        attribute_map.update(DataStructure.attribute_map)

    discriminator_value_class_map = {
            'ITEM_SINGLE'.lower(): '#/components/schemas/ItemSingle',
            'ITEM_LIST'.lower(): '#/components/schemas/ItemList',
            'ITEM_TABLE'.lower(): '#/components/schemas/ItemTable',
            'ITEM_TREE'.lower(): '#/components/schemas/ItemTree',
    }

    def __init__(self, type=None, *args, **kwargs):  # noqa: E501
        """ItemStructure - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    @property
    def type(self):
        """Gets the type of this ItemStructure.  # noqa: E501


        :return: The type of this ItemStructure.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this ItemStructure.


        :param type: The type of this ItemStructure.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ItemStructure, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ItemStructure):
            return False
