...
import six
from swagger_client.models.version import Version  # noqa: F401,E501
...
class OriginalVersion(Version):
    ...
    swagger_types = {
        ...
        'other_input_version_uids': 'list[ObjectVersionId]',
        'lifecycle_state': 'DvCodedText',
        'attestations': 'list[Attestation]'
    }
    if hasattr(Version, "swagger_types"):
        swagger_types.update(Version.swagger_types)
    ...
    if hasattr(Version, "attribute_map"):
        attribute_map.update(Version.attribute_map)

    def __init__(self, type='ORIGINAL_VERSION', uid=None, preceding_version_uid=None, other_input_version_uids=None, lifecycle_state=None, attestations=None, *args, **kwargs):  # noqa: E501
        """OriginalVersion - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._uid = None
        self._preceding_version_uid = None
        self._other_input_version_uids = None
        ...
        if other_input_version_uids is not None:
    ...
    @property
    def type(self):
        """Gets the type of this OriginalVersion.  # noqa: E501


        :return: The type of this OriginalVersion.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this OriginalVersion.


        :param type: The type of this OriginalVersion.  # noqa: E501
        :type: str
        """
    ...
    @property
    def uid(self):
        """Gets the uid of this OriginalVersion.  # noqa: E501


        :return: The uid of this OriginalVersion.  # noqa: E501
        :rtype: ObjectVersionId
        """
        return self._uid

    @uid.setter
    def uid(self, uid):
        """Sets the uid of this OriginalVersion.


        :param uid: The uid of this OriginalVersion.  # noqa: E501
    ...
    def preceding_version_uid(self):
        """Gets the preceding_version_uid of this OriginalVersion.  # noqa: E501


        :return: The preceding_version_uid of this OriginalVersion.  # noqa: E501
        :rtype: ObjectVersionId
        """
        return self._preceding_version_uid

    @preceding_version_uid.setter
    def preceding_version_uid(self, preceding_version_uid):
        """Sets the preceding_version_uid of this OriginalVersion.


        :param preceding_version_uid: The preceding_version_uid of this OriginalVersion.  # noqa: E501
        :type: ObjectVersionId
        """

        self._preceding_version_uid = preceding_version_uid

    @property
    def other_input_version_uids(self):
        """Gets the other_input_version_uids of this OriginalVersion.  # noqa: E501


        :return: The other_input_version_uids of this OriginalVersion.  # noqa: E501
        :rtype: list[ObjectVersionId]
        """
        return self._other_input_version_uids

    @other_input_version_uids.setter
    def other_input_version_uids(self, other_input_version_uids):
        """Sets the other_input_version_uids of this OriginalVersion.


        :param other_input_version_uids: The other_input_version_uids of this OriginalVersion.  # noqa: E501
        :type: list[ObjectVersionId]
        """

        self._other_input_version_uids = other_input_version_uids

    @property
    def lifecycle_state(self):
        """Gets the lifecycle_state of this OriginalVersion.  # noqa: E501


        :return: The lifecycle_state of this OriginalVersion.  # noqa: E501
        :rtype: DvCodedText
        """
    ...
    def lifecycle_state(self, lifecycle_state):
        """Sets the lifecycle_state of this OriginalVersion.


        :param lifecycle_state: The lifecycle_state of this OriginalVersion.  # noqa: E501
        :type: DvCodedText
        """
        if lifecycle_state is None:
            raise ValueError("Invalid value for `lifecycle_state`, must not be `None`")  # noqa: E501

        self._lifecycle_state = lifecycle_state

    @property
    def attestations(self):
        """Gets the attestations of this OriginalVersion.  # noqa: E501


        :return: The attestations of this OriginalVersion.  # noqa: E501
        :rtype: list[Attestation]
        """
        return self._attestations

    @attestations.setter
    def attestations(self, attestations):
        """Sets the attestations of this OriginalVersion.


        :param attestations: The attestations of this OriginalVersion.  # noqa: E501
        :type: list[Attestation]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OriginalVersion, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OriginalVersion):
            return False
