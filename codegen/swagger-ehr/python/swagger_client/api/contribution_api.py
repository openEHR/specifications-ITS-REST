...
class CONTRIBUTIONApi(object):
    ...
    def contribution_create(self, body, ehr_id, **kwargs):  # noqa: E501
        """Create CONTRIBUTION  # noqa: E501

        We will use the relaxed CONTRIBUTION with the following optional attributes:   - `uid`: when provided, it will be accepted in case is not in-use, otherwise error will be returned   - `audit.time_committed`: server will always set it   - `audit.system_id`: when provided, it will be validated   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.contribution_create(body, ehr_id, async_req=True)
        >>> result = thread.get()
 ...
 (required)
        ...
        if kwargs.get('async_req'):
            return self.contribution_create_with_http_info(body, ehr_id, **kwargs)  # noqa: E501
        else:
            (data) = self.contribution_create_with_http_info(body, ehr_id, **kwargs)  # noqa: E501
            return data

    def contribution_create_with_http_info(self, body, ehr_id, **kwargs):  # noqa: E501
        """Create CONTRIBUTION  # noqa: E501

        We will use the relaxed CONTRIBUTION with the following optional attributes:   - `uid`: when provided, it will be accepted in case is not in-use, otherwise error will be returned   - `audit.time_committed`: server will always set it   - `audit.system_id`: when provided, it will be validated   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.contribution_create_with_http_info(body, ehr_id, async_req=True)
        >>> result = thread.get()
 ...
 (required)
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method contribution_create" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `contribution_create`")  # noqa: E501
        # verify the required parameter 'ehr_id' is set
        if ('ehr_id' not in params or
                params['ehr_id'] is None):
            raise ValueError("Missing the required parameter `ehr_id` when calling `contribution_create`")  # noqa: E501
    ...
    def contribution_get(self, ehr_id, contribution_uid, **kwargs):  # noqa: E501
        """Get CONTRIBUTION by id  # noqa: E501

        Retrieves a CONTRIBUTION identified by `contribution_uid` and associated with the EHR identified by `ehr_id`.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.contribution_get(ehr_id, contribution_uid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str ehr_id: EHR identifier taken from EHR.ehr_id.value.  (required)
        :param str contribution_uid: The CONTRIBUTION uid.  (required)
        :return: Contribution
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.contribution_get_with_http_info(ehr_id, contribution_uid, **kwargs)  # noqa: E501
        else:
            (data) = self.contribution_get_with_http_info(ehr_id, contribution_uid, **kwargs)  # noqa: E501
            return data

    def contribution_get_with_http_info(self, ehr_id, contribution_uid, **kwargs):  # noqa: E501
        """Get CONTRIBUTION by id  # noqa: E501

        Retrieves a CONTRIBUTION identified by `contribution_uid` and associated with the EHR identified by `ehr_id`.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.contribution_get_with_http_info(ehr_id, contribution_uid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['ehr_id', 'contribution_uid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method contribution_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'ehr_id' is set
        if ('ehr_id' not in params or
                params['ehr_id'] is None):
            raise ValueError("Missing the required parameter `ehr_id` when calling `contribution_get`")  # noqa: E501
        # verify the required parameter 'contribution_uid' is set
        if ('contribution_uid' not in params or
                params['contribution_uid'] is None):
            raise ValueError("Missing the required parameter `contribution_uid` when calling `contribution_get`")  # noqa: E501
        ...
        if 'ehr_id' in params:
            path_params['ehr_id'] = params['ehr_id']  # noqa: E501
        if 'contribution_uid' in params:
            path_params['contribution_uid'] = params['contribution_uid']  # noqa: E501
