...
from swagger_client.api.composition_api import COMPOSITIONApi  # noqa: E501
...
class TestCOMPOSITIONApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = COMPOSITIONApi()  # noqa: E501
    ...
    def test_composition_delete(self):
    ...
    def test_versioned_composition_get(self):
    ...
    def test_versioned_composition_revision_history(self):
    ...
    def test_versioned_composition_version_get_at_time(self):
    ...
    def test_versioned_composition_version_get_by_id(self):
