...
from swagger_client.api.ehr_api import EHRApi  # noqa: E501
...
class TestEHRApi(unittest.TestCase):
    ...
    def test_ehr_create_with_id(self):
    ...
    def test_ehr_get_by_subject(self):
