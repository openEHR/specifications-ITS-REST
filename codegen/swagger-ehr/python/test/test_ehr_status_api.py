...
from swagger_client.api.ehr_status_api import EHRSTATUSApi  # noqa: E501
...
class TestEHRSTATUSApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = EHRSTATUSApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_ehr_status_get_at_time(self):
    ...
    def test_ehr_status_get_by_version_id(self):
    ...
    def test_ehr_status_update(self):
    ...
    def test_versioned_ehr_status_get(self):
    ...
    def test_versioned_ehr_status_revision_history(self):
    ...
    def test_versioned_ehr_status_version_get_at_time(self):
    ...
    def test_versioned_ehr_status_version_get_by_id(self):
