...
module SwaggerClient
  class COMPOSITIONApi
    ...
    # @return [Composition]
    def composition_create(body, ehr_id, opts = {})
      data, _status_code, _headers = composition_create_with_http_info(body, ehr_id, opts)
      data
    end
    ...
    # @param ehr_id EHR identifier taken from EHR.ehr_id.value. 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;. 
    # @return [Array<(Composition, Integer, Hash)>] Composition data, response status code and response headers
    def composition_create_with_http_info(body, ehr_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: COMPOSITIONApi.composition_create ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling COMPOSITIONApi.composition_create"
      end
      ...
      if @api_client.config.client_side_validation && opts[:'prefer'] && !['return=representation', 'return=minimal'].include?(opts[:'prefer'])
        fail ArgumentError, 'invalid value for "prefer", must be one of return=representation, return=minimal'
      end
      # resource path
      local_var_path = '/ehr/{ehr_id}/composition'.sub('{' + 'ehr_id' + '}', ehr_id.to_s)
      ...
      return_type = opts[:return_type] || 'Composition' 
    ...
    # @param ehr_id EHR identifier taken from EHR.ehr_id.value. 
    # @param uid_based_id An identifier in a form of an OBJECT_VERSION_ID identifier taken from VERSION.uid.value (i.e. a &#x60;version_uid&#x60;). 
    # @param [Hash] opts the optional parameters
    # @return [nil]
    ...
    def composition_delete_with_http_info(ehr_id, uid_based_id, opts = {})
      ...
      # resource path
      local_var_path = '/ehr/{ehr_id}/composition/{uid_based_id}'.sub('{' + 'ehr_id' + '}', ehr_id.to_s).sub('{' + 'uid_based_id' + '}', uid_based_id.to_s)
    ...
    # @param ehr_id EHR identifier taken from EHR.ehr_id.value. 
    # @param uid_based_id An abstract identifier: it can take a form of an OBJECT_VERSION_ID identifier taken from VERSION.uid.value (i.e. a &#x60;version_uid&#x60;), or a form of a HIER_OBJECT_ID identifier taken from VERSIONED_OBJECT.uid.value (i.e. a &#x60;versioned_object_uid&#x60;). 
    # @param [Hash] opts the optional parameters
    ...
    # @option opts [String] :prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;.  (default to return=minimal)
    # @return [Composition]
    def composition_update(body, if_match, ehr_id, uid_based_id, opts = {})
      data, _status_code, _headers = composition_update_with_http_info(body, if_match, ehr_id, uid_based_id, opts)
      data
    end
    ...
    # @option opts [String] :prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;. 
    # @return [Array<(Composition, Integer, Hash)>] Composition data, response status code and response headers
    def composition_update_with_http_info(body, if_match, ehr_id, uid_based_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: COMPOSITIONApi.composition_update ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling COMPOSITIONApi.composition_update"
      end
    ...
    # @param ehr_id EHR identifier taken from EHR.ehr_id.value. 
    # @param versioned_object_uid VERSIONED_COMPOSITION identifier taken from VERSIONED_COMPOSITION.uid.value. 
    # @param [Hash] opts the optional parameters
    ...
    def versioned_composition_get_with_http_info(ehr_id, versioned_object_uid, opts = {})
      ...
      # resource path
      local_var_path = '/ehr/{ehr_id}/versioned_composition/{versioned_object_uid}'.sub('{' + 'ehr_id' + '}', ehr_id.to_s).sub('{' + 'versioned_object_uid' + '}', versioned_object_uid.to_s)
      ...
      return_type = opts[:return_type] || 'VersionedComposition' 
    ...
    def versioned_composition_revision_history_with_http_info(ehr_id, versioned_object_uid, opts = {})
      ...
      # resource path
      local_var_path = '/ehr/{ehr_id}/versioned_composition/{versioned_object_uid}/revision_history'.sub('{' + 'ehr_id' + '}', ehr_id.to_s).sub('{' + 'versioned_object_uid' + '}', versioned_object_uid.to_s)
      ...
      return_type = opts[:return_type] || 'RevisionHistory' 
    ...
    def versioned_composition_version_get_at_time_with_http_info(ehr_id, versioned_object_uid, opts = {})
      ...
      # resource path
      local_var_path = '/ehr/{ehr_id}/versioned_composition/{versioned_object_uid}/version'.sub('{' + 'ehr_id' + '}', ehr_id.to_s).sub('{' + 'versioned_object_uid' + '}', versioned_object_uid.to_s)
    ...
    def versioned_composition_version_get_by_id_with_http_info(ehr_id, versioned_object_uid, version_uid, opts = {})
      ...
      # resource path
      local_var_path = '/ehr/{ehr_id}/versioned_composition/{versioned_object_uid}/version/{version_uid}'.sub('{' + 'ehr_id' + '}', ehr_id.to_s).sub('{' + 'versioned_object_uid' + '}', versioned_object_uid.to_s).sub('{' + 'version_uid' + '}', version_uid.to_s)
