...
module SwaggerClient
  class DIRECTORYApi
    ...
    # @return [Folder]
    def directory_create(body, ehr_id, opts = {})
      data, _status_code, _headers = directory_create_with_http_info(body, ehr_id, opts)
      data
    end
    ...
    def directory_create_with_http_info(body, ehr_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DIRECTORYApi.directory_create ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling DIRECTORYApi.directory_create"
      end
      ...
      # resource path
      local_var_path = '/ehr/{ehr_id}/directory'.sub('{' + 'ehr_id' + '}', ehr_id.to_s)
    ...
    def directory_get_by_version_id_with_http_info(ehr_id, version_uid, opts = {})
      ...
      # resource path
      local_var_path = '/ehr/{ehr_id}/directory/{version_uid}'.sub('{' + 'ehr_id' + '}', ehr_id.to_s).sub('{' + 'version_uid' + '}', version_uid.to_s)
    ...
    # @option opts [String] :prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;.  (default to return=minimal)
    # @return [Folder]
    def directory_update(body, if_match, ehr_id, opts = {})
      data, _status_code, _headers = directory_update_with_http_info(body, if_match, ehr_id, opts)
      data
    end
    ...
    # @option opts [String] :prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;. 
    # @return [Array<(Folder, Integer, Hash)>] Folder data, response status code and response headers
    def directory_update_with_http_info(body, if_match, ehr_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DIRECTORYApi.directory_update ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling DIRECTORYApi.directory_update"
      end
      # verify the required parameter 'if_match' is set
      if @api_client.config.client_side_validation && if_match.nil?
