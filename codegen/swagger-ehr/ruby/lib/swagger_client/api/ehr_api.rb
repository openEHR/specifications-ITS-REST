...
module SwaggerClient
  class EHRApi
    ...
    # @option opts [EhrStatus] :body An EHR_STATUS resource MAY be also supplied by the client as the request body.
    ...
    def ehr_create_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'Ehr' 
    ...
    def ehr_create_with_id_with_http_info(ehr_id, opts = {})
      ...
      # resource path
      local_var_path = '/ehr/{ehr_id}'.sub('{' + 'ehr_id' + '}', ehr_id.to_s)
    ...
    # @param subject_id The EHR subject id. 
    # @param subject_namespace The EHR subject id namespace. 
    # @param [Hash] opts the optional parameters
    # @return [Ehr]
