...
module SwaggerClient
  class CONTRIBUTIONApi
    ...
    # @return [Contribution]
    def contribution_create(body, ehr_id, opts = {})
      data, _status_code, _headers = contribution_create_with_http_info(body, ehr_id, opts)
      data
    end
    ...
    def contribution_create_with_http_info(body, ehr_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CONTRIBUTIONApi.contribution_create ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling CONTRIBUTIONApi.contribution_create"
      end
      ...
      # resource path
      local_var_path = '/ehr/{ehr_id}/contribution'.sub('{' + 'ehr_id' + '}', ehr_id.to_s)
      ...
      return_type = opts[:return_type] || 'Contribution' 
    ...
    # @param ehr_id EHR identifier taken from EHR.ehr_id.value. 
    # @param contribution_uid The CONTRIBUTION uid. 
    # @param [Hash] opts the optional parameters
    # @return [Contribution]
    ...
    def contribution_get_with_http_info(ehr_id, contribution_uid, opts = {})
      ...
      # resource path
      local_var_path = '/ehr/{ehr_id}/contribution/{contribution_uid}'.sub('{' + 'ehr_id' + '}', ehr_id.to_s).sub('{' + 'contribution_uid' + '}', contribution_uid.to_s)
