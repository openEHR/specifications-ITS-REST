...
module SwaggerClient
  class EHRSTATUSApi
    ...
    def ehr_status_get_at_time_with_http_info(ehr_id, opts = {})
      ...
      # resource path
      local_var_path = '/ehr/{ehr_id}/ehr_status'.sub('{' + 'ehr_id' + '}', ehr_id.to_s)
      ...
      return_type = opts[:return_type] || 'EhrStatus' 
    ...
    def ehr_status_get_by_version_id_with_http_info(ehr_id, version_uid, opts = {})
      ...
      # resource path
      local_var_path = '/ehr/{ehr_id}/ehr_status/{version_uid}'.sub('{' + 'ehr_id' + '}', ehr_id.to_s).sub('{' + 'version_uid' + '}', version_uid.to_s)
    ...
    # @return [EhrStatus]
    def ehr_status_update(body, if_match, ehr_id, opts = {})
      data, _status_code, _headers = ehr_status_update_with_http_info(body, if_match, ehr_id, opts)
      data
    end
    ...
    # @return [Array<(EhrStatus, Integer, Hash)>] EhrStatus data, response status code and response headers
    def ehr_status_update_with_http_info(body, if_match, ehr_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EHRSTATUSApi.ehr_status_update ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling EHRSTATUSApi.ehr_status_update"
      end
    ...
    def versioned_ehr_status_get_with_http_info(ehr_id, opts = {})
      ...
      # resource path
      local_var_path = '/ehr/{ehr_id}/versioned_ehr_status'.sub('{' + 'ehr_id' + '}', ehr_id.to_s)
      ...
      return_type = opts[:return_type] || 'VersionedEhrStatus' 
    ...
    def versioned_ehr_status_revision_history_with_http_info(ehr_id, opts = {})
      ...
      # resource path
      local_var_path = '/ehr/{ehr_id}/versioned_ehr_status/revision_history'.sub('{' + 'ehr_id' + '}', ehr_id.to_s)
    ...
    def versioned_ehr_status_version_get_at_time_with_http_info(ehr_id, opts = {})
      ...
      # resource path
      local_var_path = '/ehr/{ehr_id}/versioned_ehr_status/version'.sub('{' + 'ehr_id' + '}', ehr_id.to_s)
    ...
    def versioned_ehr_status_version_get_by_id_with_http_info(ehr_id, version_uid, opts = {})
      ...
      # resource path
      local_var_path = '/ehr/{ehr_id}/versioned_ehr_status/version/{version_uid}'.sub('{' + 'ehr_id' + '}', ehr_id.to_s).sub('{' + 'version_uid' + '}', version_uid.to_s)
