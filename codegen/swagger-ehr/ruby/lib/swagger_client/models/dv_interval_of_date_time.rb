  ...
  class DvIntervalOfDateTime
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::DvIntervalOfDateTime` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::DvIntervalOfDateTime`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          upper_included == o.upper_included &&
          lower == o.lower &&
          upper == o.upper && super(o)
    end
    ...
    def hash
      [_type, lower_unbounded, upper_unbounded, lower_included, upper_included, lower, upper].hash
    end
