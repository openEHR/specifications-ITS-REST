...
module SwaggerClient
  class DvQuantity
    ...
    attr_accessor :accuracy_is_percent
    ...
    attr_accessor :units_system

    attr_accessor :units_display_name
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::DvQuantity` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::DvQuantity`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'_type')
        ...
        self._type = 'DV_QUANTITY'
      end

      if attributes.key?(:'accuracy_is_percent')
        self.accuracy_is_percent = attributes[:'accuracy_is_percent']
      end
      ...
      if attributes.key?(:'magnitude')
        self.magnitude = attributes[:'magnitude']
      end
      ...
      if attributes.key?(:'units_system')
        self.units_system = attributes[:'units_system']
      end

      if attributes.key?(:'units_display_name')
        self.units_display_name = attributes[:'units_display_name']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @magnitude.nil?
        invalid_properties.push('invalid value for "magnitude", magnitude cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          _type == o._type &&
          accuracy_is_percent == o.accuracy_is_percent &&
          accuracy == o.accuracy &&
          magnitude == o.magnitude &&
          precision == o.precision &&
          units == o.units &&
          units_system == o.units_system &&
          units_display_name == o.units_display_name && super(o)
    end
    ...
    def hash
      [_type, accuracy_is_percent, accuracy, magnitude, precision, units, units_system, units_display_name].hash
    end
