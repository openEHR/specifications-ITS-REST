...
module SwaggerClient
  class EventContext
    ...
    attr_accessor :other_context

    attr_accessor :health_care_facility
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::EventContext` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::EventContext`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'other_context')
        self.other_context = attributes[:'other_context']
      end

      if attributes.key?(:'health_care_facility')
        self.health_care_facility = attributes[:'health_care_facility']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          location == o.location &&
          setting == o.setting &&
          other_context == o.other_context &&
          health_care_facility == o.health_care_facility &&
          participations == o.participations && super(o)
    end
    ...
    def hash
      [_type, start_time, end_time, location, setting, other_context, health_care_facility, participations].hash
    end
