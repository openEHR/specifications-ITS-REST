  ...
  class VersionedComposition
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::VersionedComposition` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::VersionedComposition`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'_type')
        ...
        self._type = 'VERSIONED_COMPOSITION'
      end
    ...
    def list_invalid_properties
      ...
      if @time_created.nil?
        invalid_properties.push('invalid value for "time_created", time_created cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @time_created.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          uid == o.uid &&
          owner_id == o.owner_id &&
          time_created == o.time_created && super(o)
    end
    ...
    def hash
      [_type, uid, owner_id, time_created].hash
    end
