...
module SwaggerClient
  class TerminologyCode
    attr_accessor :terminology_id

    attr_accessor :terminology_version
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::TerminologyCode` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::TerminologyCode`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'terminology_id')
        self.terminology_id = attributes[:'terminology_id']
      end

      if attributes.key?(:'terminology_version')
        self.terminology_version = attributes[:'terminology_version']
      end

      if attributes.key?(:'code_string')
        self.code_string = attributes[:'code_string']
      end
    ...
    def list_invalid_properties
      ...
      if @terminology_id.nil?
        invalid_properties.push('invalid value for "terminology_id", terminology_id cannot be nil.')
      end

      if @code_string.nil?
        invalid_properties.push('invalid value for "code_string", code_string cannot be nil.')
      end
    ...
    def valid?
      return false if @terminology_id.nil?
      return false if @code_string.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          terminology_id == o.terminology_id &&
          terminology_version == o.terminology_version &&
          code_string == o.code_string &&
          uri == o.uri
    end
    ...
    def hash
      [terminology_id, terminology_version, code_string, uri].hash
    end
