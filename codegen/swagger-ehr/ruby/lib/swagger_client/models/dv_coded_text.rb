  ...
  class DvCodedText
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::DvCodedText` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::DvCodedText`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'defining_code')
        self.defining_code = attributes[:'defining_code']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @defining_code.nil?
        invalid_properties.push('invalid value for "defining_code", defining_code cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @defining_code.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          language == o.language &&
          encoding == o.encoding &&
          defining_code == o.defining_code && super(o)
    end
    ...
    def hash
      [_type, value, hyperlink, formatting, mappings, language, encoding, defining_code].hash
    end
