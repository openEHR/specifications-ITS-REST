...
module SwaggerClient
  class OriginalVersion
    ...
    attr_accessor :commit_audit

    attr_accessor :data

    attr_accessor :uid

    attr_accessor :preceding_version_uid

    attr_accessor :other_input_version_uids
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::OriginalVersion` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::OriginalVersion`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'commit_audit')
        self.commit_audit = attributes[:'commit_audit']
      end
      ...
      if attributes.key?(:'preceding_version_uid')
        self.preceding_version_uid = attributes[:'preceding_version_uid']
      end

      if attributes.key?(:'other_input_version_uids')
        if (value = attributes[:'other_input_version_uids']).is_a?(Array)
          self.other_input_version_uids = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @contribution.nil?
        invalid_properties.push('invalid value for "contribution", contribution cannot be nil.')
      end

      if @commit_audit.nil?
        invalid_properties.push('invalid value for "commit_audit", commit_audit cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @commit_audit.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          commit_audit == o.commit_audit &&
          data == o.data &&
          uid == o.uid &&
          preceding_version_uid == o.preceding_version_uid &&
          other_input_version_uids == o.other_input_version_uids &&
          lifecycle_state == o.lifecycle_state &&
          attestations == o.attestations && super(o)
    end
    ...
    def hash
      [_type, contribution, signature, commit_audit, data, uid, preceding_version_uid, other_input_version_uids, lifecycle_state, attestations].hash
    end
