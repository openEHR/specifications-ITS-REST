...
module SwaggerClient
  class Action
    ...
    attr_accessor :guideline_id

    attr_accessor :_type

    attr_accessor :time

    attr_accessor :ism_transition
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::Action` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::Action`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'guideline_id')
        self.guideline_id = attributes[:'guideline_id']
      end
      ...
      if attributes.key?(:'ism_transition')
        self.ism_transition = attributes[:'ism_transition']
      end

      if attributes.key?(:'instruction_details')
        self.instruction_details = attributes[:'instruction_details']
      end
    ...
    def list_invalid_properties
      ...
      if @ism_transition.nil?
        invalid_properties.push('invalid value for "ism_transition", ism_transition cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ism_transition.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          protocol == o.protocol &&
          guideline_id == o.guideline_id &&
          _type == o._type &&
          time == o.time &&
          ism_transition == o.ism_transition &&
          instruction_details == o.instruction_details &&
    ...
    def hash
      [protocol, guideline_id, _type, time, ism_transition, instruction_details, description].hash
    end
