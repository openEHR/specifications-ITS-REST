  ...
  class Attestation
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::Attestation` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::Attestation`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'time_committed')
        self.time_committed = attributes[:'time_committed']
      end
      ...
      if attributes.key?(:'attested_view')
        self.attested_view = attributes[:'attested_view']
      end
    ...
    def list_invalid_properties
      ...
      if @time_committed.nil?
        invalid_properties.push('invalid value for "time_committed", time_committed cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @time_committed.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          time_committed == o.time_committed &&
          change_type == o.change_type &&
          description == o.description &&
          committer == o.committer &&
          attested_view == o.attested_view &&
          proof == o.proof &&
          items == o.items &&
          reason == o.reason &&
          is_pending == o.is_pending && super(o)
    end
    ...
    def hash
      [_type, system_id, time_committed, change_type, description, committer, attested_view, proof, items, reason, is_pending].hash
    end
