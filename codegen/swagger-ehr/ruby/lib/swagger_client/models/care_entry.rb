...
module SwaggerClient
  class CareEntry
    ...
    attr_accessor :other_participations
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::CareEntry` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::CareEntry`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'other_participations')
        if (value = attributes[:'other_participations']).is_a?(Array)
          self.other_participations = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          language == o.language &&
          encoding == o.encoding &&
          other_participations == o.other_participations &&
          workflow_id == o.workflow_id &&
          subject == o.subject &&
          provider == o.provider &&
          protocol == o.protocol &&
          guideline_id == o.guideline_id && super(o)
    end
    ...
    def hash
      [language, encoding, other_participations, workflow_id, subject, provider, protocol, guideline_id].hash
    end
