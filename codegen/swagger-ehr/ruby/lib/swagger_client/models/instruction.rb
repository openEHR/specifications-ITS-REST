  ...
  class Instruction
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::Instruction` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::Instruction`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'wf_definition')
        self.wf_definition = attributes[:'wf_definition']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          wf_definition == o.wf_definition &&
          activities == o.activities && super(o)
    end
    ...
    def hash
      [protocol, guideline_id, _type, narrative, expiry_time, wf_definition, activities].hash
    end
