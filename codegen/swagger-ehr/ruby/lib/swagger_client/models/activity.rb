...
module SwaggerClient
  class Activity
    ...
    attr_accessor :archetype_node_id

    attr_accessor :uid

    attr_accessor :links

    attr_accessor :archetype_details

    attr_accessor :feeder_audit

    attr_accessor :_type

    attr_accessor :timing

    attr_accessor :action_archetype_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::Activity` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::Activity`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'archetype_node_id')
        self.archetype_node_id = attributes[:'archetype_node_id']
      end
      ...
      if attributes.key?(:'archetype_details')
        self.archetype_details = attributes[:'archetype_details']
      end

      if attributes.key?(:'feeder_audit')
        self.feeder_audit = attributes[:'feeder_audit']
      end
      ...
      if attributes.key?(:'action_archetype_id')
        self.action_archetype_id = attributes[:'action_archetype_id']
      end
    ...
    def list_invalid_properties
      ...
      if @archetype_node_id.nil?
        invalid_properties.push('invalid value for "archetype_node_id", archetype_node_id cannot be nil.')
      end

      if @action_archetype_id.nil?
        invalid_properties.push('invalid value for "action_archetype_id", action_archetype_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @archetype_node_id.nil?
      return false if @action_archetype_id.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          uid == o.uid &&
          links == o.links &&
          archetype_details == o.archetype_details &&
          feeder_audit == o.feeder_audit &&
          _type == o._type &&
          timing == o.timing &&
          action_archetype_id == o.action_archetype_id &&
    ...
    def hash
      [name, archetype_node_id, uid, links, archetype_details, feeder_audit, _type, timing, action_archetype_id, description].hash
    end
