...
module SwaggerClient
  class FeederAudit
    attr_accessor :originating_system_item_ids

    attr_accessor :feeder_system_item_ids

    attr_accessor :original_content

    attr_accessor :originating_system_audit

    attr_accessor :feeder_system_audit
    ...
    def self.openapi_types
      {
        :'originating_system_item_ids' => :'Object',
        :'feeder_system_item_ids' => :'Object',
        :'original_content' => :'Object',
        :'originating_system_audit' => :'Object',
        :'feeder_system_audit' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::FeederAudit` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::FeederAudit`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'originating_system_item_ids')
        if (value = attributes[:'originating_system_item_ids']).is_a?(Array)
          self.originating_system_item_ids = value
        end
      end

      if attributes.key?(:'feeder_system_item_ids')
        if (value = attributes[:'feeder_system_item_ids']).is_a?(Array)
          self.feeder_system_item_ids = value
        end
      end
      ...
      if attributes.key?(:'originating_system_audit')
        self.originating_system_audit = attributes[:'originating_system_audit']
      end

      if attributes.key?(:'feeder_system_audit')
        self.feeder_system_audit = attributes[:'feeder_system_audit']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @originating_system_audit.nil?
        invalid_properties.push('invalid value for "originating_system_audit", originating_system_audit cannot be nil.')
      end
    ...
    def valid?
      return false if @originating_system_audit.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          originating_system_item_ids == o.originating_system_item_ids &&
          feeder_system_item_ids == o.feeder_system_item_ids &&
          original_content == o.original_content &&
          originating_system_audit == o.originating_system_audit &&
          feeder_system_audit == o.feeder_system_audit
    end
    ...
    def hash
      [originating_system_item_ids, feeder_system_item_ids, original_content, originating_system_audit, feeder_system_audit].hash
    end
