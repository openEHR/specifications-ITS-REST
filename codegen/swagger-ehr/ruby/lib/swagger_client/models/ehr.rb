...
module SwaggerClient
  ...
  class Ehr
    ...
    attr_accessor :ehr_id

    attr_accessor :ehr_status

    attr_accessor :ehr_access
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::Ehr` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::Ehr`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'ehr_id')
        self.ehr_id = attributes[:'ehr_id']
      end

      if attributes.key?(:'ehr_status')
        self.ehr_status = attributes[:'ehr_status']
      end

      if attributes.key?(:'ehr_access')
        self.ehr_access = attributes[:'ehr_access']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ehr_id == o.ehr_id &&
          ehr_status == o.ehr_status &&
          ehr_access == o.ehr_access &&
    ...
    def hash
      [system_id, ehr_id, ehr_status, ehr_access, time_created].hash
    end
