...
# Models
require 'swagger_client/models/abstract_entry'
require 'swagger_client/models/action'
require 'swagger_client/models/activity'
require 'swagger_client/models/admin_entry'
require 'swagger_client/models/archetype_id'
require 'swagger_client/models/archetyped'
require 'swagger_client/models/attestation'
require 'swagger_client/models/audit_details'
require 'swagger_client/models/care_entry'
require 'swagger_client/models/clstr'
require 'swagger_client/models/code_phrase'
require 'swagger_client/models/composition'
require 'swagger_client/models/content_item'
require 'swagger_client/models/contribution'
require 'swagger_client/models/data_structure'
require 'swagger_client/models/data_value'
require 'swagger_client/models/dv_amount'
require 'swagger_client/models/dv_boolean'
require 'swagger_client/models/dv_coded_text'
require 'swagger_client/models/dv_count'
require 'swagger_client/models/dv_date'
require 'swagger_client/models/dv_date_time'
require 'swagger_client/models/dv_duration'
require 'swagger_client/models/dv_ehr_uri'
require 'swagger_client/models/dv_encapsulated'
require 'swagger_client/models/dv_identifier'
require 'swagger_client/models/dv_interval'
require 'swagger_client/models/dv_interval_of_date_time'
require 'swagger_client/models/dv_multimedia'
require 'swagger_client/models/dv_ordered'
require 'swagger_client/models/dv_ordinal'
require 'swagger_client/models/dv_parsable'
require 'swagger_client/models/dv_proportion'
require 'swagger_client/models/dv_quantified'
require 'swagger_client/models/dv_quantity'
require 'swagger_client/models/dv_scale'
require 'swagger_client/models/dv_state'
require 'swagger_client/models/dv_temporal'
require 'swagger_client/models/dv_text'
require 'swagger_client/models/dv_time'
require 'swagger_client/models/dv_uri'
require 'swagger_client/models/ehr'
require 'swagger_client/models/ehr_status'
require 'swagger_client/models/element'
require 'swagger_client/models/error'
require 'swagger_client/models/evaluation'
require 'swagger_client/models/event'
require 'swagger_client/models/event_context'
require 'swagger_client/models/feeder_audit'
require 'swagger_client/models/feeder_audit_details'
require 'swagger_client/models/folder'
require 'swagger_client/models/generic_id'
require 'swagger_client/models/hier_object_id'
require 'swagger_client/models/history'
require 'swagger_client/models/imported_version'
require 'swagger_client/models/instruction'
require 'swagger_client/models/instruction_details'
require 'swagger_client/models/ism_transition'
require 'swagger_client/models/item'
require 'swagger_client/models/item_list'
require 'swagger_client/models/item_single'
require 'swagger_client/models/item_structure'
require 'swagger_client/models/item_table'
require 'swagger_client/models/item_tree'
require 'swagger_client/models/link'
require 'swagger_client/models/locatable'
require 'swagger_client/models/locatable_ref'
require 'swagger_client/models/new_contribution'
require 'swagger_client/models/object_id'
require 'swagger_client/models/object_ref'
require 'swagger_client/models/object_version_id'
require 'swagger_client/models/observation'
require 'swagger_client/models/original_version'
require 'swagger_client/models/participation'
require 'swagger_client/models/party_identified'
require 'swagger_client/models/party_proxy'
require 'swagger_client/models/party_ref'
require 'swagger_client/models/party_related'
require 'swagger_client/models/party_self'
require 'swagger_client/models/pathable'
require 'swagger_client/models/reference_range'
require 'swagger_client/models/revision_history'
require 'swagger_client/models/revision_history_item'
require 'swagger_client/models/template_id'
require 'swagger_client/models/term_mapping'
require 'swagger_client/models/terminology_code'
require 'swagger_client/models/terminology_id'
require 'swagger_client/models/uid_based_id'
require 'swagger_client/models/update_attestation'
require 'swagger_client/models/update_audit'
require 'swagger_client/models/update_version'
require 'swagger_client/models/version'
require 'swagger_client/models/versionable'
require 'swagger_client/models/versioned_composition'
require 'swagger_client/models/versioned_ehr_status'
require 'swagger_client/models/versioned_object'

# APIs
require 'swagger_client/api/composition_api'
require 'swagger_client/api/contribution_api'
require 'swagger_client/api/directory_api'
require 'swagger_client/api/ehr_api'
require 'swagger_client/api/ehrstatus_api'
