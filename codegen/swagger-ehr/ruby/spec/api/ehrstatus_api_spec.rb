...
# Unit tests for SwaggerClient::EHRSTATUSApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EHRSTATUSApi' do
  before do
    # run before each test
    @instance = SwaggerClient::EHRSTATUSApi.new
  end
  ...
  describe 'test an instance of EHRSTATUSApi' do
    it 'should create an instance of EHRSTATUSApi' do
      expect(@instance).to be_instance_of(SwaggerClient::EHRSTATUSApi)
    end
  end

  # unit tests for ehr_status_get_at_time
  ...
  # @return [EhrStatus]
  describe 'ehr_status_get_at_time test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for ehr_status_get_by_version_id
  ...
  # @param [Hash] opts the optional parameters
  # @return [EhrStatus]
  describe 'ehr_status_get_by_version_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for ehr_status_update
  # Update EHR_STATUS
  ...
  # @return [EhrStatus]
  describe 'ehr_status_update test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for versioned_ehr_status_get
  # Get versioned EHR_STATUS
  # Retrieves a VERSIONED_EHR_STATUS associated with an EHR identified by &#x60;ehr_id&#x60;. 
  # @param ehr_id EHR identifier taken from EHR.ehr_id.value. 
  # @param [Hash] opts the optional parameters
  # @return [VersionedEhrStatus]
  describe 'versioned_ehr_status_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for versioned_ehr_status_revision_history
  # Get versioned EHR_STATUS revision history
  # Retrieves revision history of the VERSIONED_EHR_STATUS associated with the EHR identified by &#x60;ehr_id&#x60;. 
  # @param ehr_id EHR identifier taken from EHR.ehr_id.value. 
  # @param [Hash] opts the optional parameters
  # @return [RevisionHistory]
  describe 'versioned_ehr_status_revision_history test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for versioned_ehr_status_version_get_at_time
  ...
  # @option opts [String] :version_at_time A given time in the extended ISO 8601 format. 
  # @return [Version]
  describe 'versioned_ehr_status_version_get_at_time test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for versioned_ehr_status_version_get_by_id
  ...
  # @param [Hash] opts the optional parameters
  # @return [Version]
  describe 'versioned_ehr_status_version_get_by_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
