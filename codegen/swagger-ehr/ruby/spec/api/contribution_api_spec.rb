...
# Unit tests for SwaggerClient::CONTRIBUTIONApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CONTRIBUTIONApi' do
  before do
    # run before each test
    @instance = SwaggerClient::CONTRIBUTIONApi.new
  end
  ...
  describe 'test an instance of CONTRIBUTIONApi' do
    it 'should create an instance of CONTRIBUTIONApi' do
      expect(@instance).to be_instance_of(SwaggerClient::CONTRIBUTIONApi)
    end
  end

  # unit tests for contribution_create
  # Create CONTRIBUTION
  ...
  # @return [Contribution]
  describe 'contribution_create test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for contribution_get
  ...
  # @param [Hash] opts the optional parameters
  # @return [Contribution]
  describe 'contribution_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
