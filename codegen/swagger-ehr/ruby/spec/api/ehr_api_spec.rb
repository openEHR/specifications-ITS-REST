...
# Unit tests for SwaggerClient::EHRApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EHRApi' do
  before do
    # run before each test
    @instance = SwaggerClient::EHRApi.new
  end
  ...
  describe 'test an instance of EHRApi' do
    it 'should create an instance of EHRApi' do
      expect(@instance).to be_instance_of(SwaggerClient::EHRApi)
    end
  end

  # unit tests for ehr_create
  # Create EHR
  ...
  # @return [Ehr]
  describe 'ehr_create test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for ehr_create_with_id
  # Create EHR with id
  ...
  # @option opts [String] :prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;. 
  # @return [Ehr]
  describe 'ehr_create_with_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for ehr_get_by_id
  # Get EHR by id
  # Retrieve the EHR with the specified &#x60;ehr_id&#x60;. 
  # @param ehr_id EHR identifier taken from EHR.ehr_id.value. 
  # @param [Hash] opts the optional parameters
  # @return [Ehr]
  describe 'ehr_get_by_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for ehr_get_by_subject
  ...
  # @param [Hash] opts the optional parameters
  # @return [Ehr]
  describe 'ehr_get_by_subject test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
