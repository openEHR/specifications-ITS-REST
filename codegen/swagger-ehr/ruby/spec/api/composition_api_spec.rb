...
# Unit tests for SwaggerClient::COMPOSITIONApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'COMPOSITIONApi' do
  before do
    # run before each test
    @instance = SwaggerClient::COMPOSITIONApi.new
  end
  ...
  describe 'test an instance of COMPOSITIONApi' do
    it 'should create an instance of COMPOSITIONApi' do
      expect(@instance).to be_instance_of(SwaggerClient::COMPOSITIONApi)
    end
  end

  # unit tests for composition_create
  # Create COMPOSITION
  ...
  # @return [Composition]
  describe 'composition_create test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for composition_delete
  # Delete COMPOSITION
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'composition_delete test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for composition_get
  # Get COMPOSITION
  ...
  # @return [Composition]
  describe 'composition_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for composition_update
  # Update COMPOSITION
  ...
  # @option opts [String] :prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;. 
  # @return [Composition]
  describe 'composition_update test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for versioned_composition_get
  ...
  describe 'versioned_composition_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for versioned_composition_revision_history
  ...
  describe 'versioned_composition_revision_history test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for versioned_composition_version_get_at_time
  ...
  # @option opts [String] :version_at_time A given time in the extended ISO 8601 format. 
  # @return [Version]
  describe 'versioned_composition_version_get_at_time test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for versioned_composition_version_get_by_id
  ...
  # @param [Hash] opts the optional parameters
  # @return [Version]
  describe 'versioned_composition_version_get_by_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
