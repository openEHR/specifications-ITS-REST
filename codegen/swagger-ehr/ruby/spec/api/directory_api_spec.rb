...
# Unit tests for SwaggerClient::DIRECTORYApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DIRECTORYApi' do
  before do
    # run before each test
    @instance = SwaggerClient::DIRECTORYApi.new
  end
  ...
  describe 'test an instance of DIRECTORYApi' do
    it 'should create an instance of DIRECTORYApi' do
      expect(@instance).to be_instance_of(SwaggerClient::DIRECTORYApi)
    end
  end

  # unit tests for directory_create
  # Create directory
  ...
  # @return [Folder]
  describe 'directory_create test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for directory_delete
  # Delete directory
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'directory_delete test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for directory_get_at_time
  ...
  # @return [Folder]
  describe 'directory_get_at_time test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for directory_get_by_version_id
  ...
  # @option opts [String] :path A path to a sub-folder; consists of slash-separated values of the name attribute of FOLDERs in the directory. 
  # @return [Folder]
  describe 'directory_get_by_version_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for directory_update
  # Update directory
  ...
  # @option opts [String] :prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;. 
  # @return [Folder]
  describe 'directory_update test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
