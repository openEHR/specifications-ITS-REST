...
# Unit tests for SwaggerClient::DvAmount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DvAmount' do
  before do
    # run before each test
    @instance = SwaggerClient::DvAmount.new
  end
  ...
  describe 'test an instance of DvAmount' do
    it 'should create an instance of DvAmount' do
      expect(@instance).to be_instance_of(SwaggerClient::DvAmount)
    end
  end
