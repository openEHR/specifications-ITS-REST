...
# Unit tests for SwaggerClient::Element
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Element' do
  before do
    # run before each test
    @instance = SwaggerClient::Element.new
  end
  ...
  describe 'test an instance of Element' do
    it 'should create an instance of Element' do
      expect(@instance).to be_instance_of(SwaggerClient::Element)
    end
  end
  ...
  describe 'test attribute "null_flavour"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "null_reason"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
