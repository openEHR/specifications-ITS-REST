...
# Unit tests for SwaggerClient::Instruction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Instruction' do
  before do
    # run before each test
    @instance = SwaggerClient::Instruction.new
  end
  ...
  describe 'test an instance of Instruction' do
    it 'should create an instance of Instruction' do
      expect(@instance).to be_instance_of(SwaggerClient::Instruction)
    end
  end
  ...
  describe 'test attribute "wf_definition"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
