...
# Unit tests for SwaggerClient::DvQuantity
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DvQuantity' do
  before do
    # run before each test
    @instance = SwaggerClient::DvQuantity.new
  end
  ...
  describe 'test an instance of DvQuantity' do
    it 'should create an instance of DvQuantity' do
      expect(@instance).to be_instance_of(SwaggerClient::DvQuantity)
    end
  end
  ...
  describe 'test attribute "accuracy_is_percent"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "magnitude"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "units_system"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "units_display_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
