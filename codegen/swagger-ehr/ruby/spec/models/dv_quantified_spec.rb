...
# Unit tests for SwaggerClient::DvQuantified
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DvQuantified' do
  before do
    # run before each test
    @instance = SwaggerClient::DvQuantified.new
  end
  ...
  describe 'test an instance of DvQuantified' do
    it 'should create an instance of DvQuantified' do
      expect(@instance).to be_instance_of(SwaggerClient::DvQuantified)
    end
  end
  ...
  describe 'test attribute "normal_status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "normal_range"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "other_reference_ranges"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "magnitude_status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
