...
# Unit tests for SwaggerClient::DvScale
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DvScale' do
  before do
    # run before each test
    @instance = SwaggerClient::DvScale.new
  end
  ...
  describe 'test an instance of DvScale' do
    it 'should create an instance of DvScale' do
      expect(@instance).to be_instance_of(SwaggerClient::DvScale)
    end
  end
