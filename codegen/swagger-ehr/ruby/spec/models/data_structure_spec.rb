...
# Unit tests for SwaggerClient::DataStructure
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DataStructure' do
  before do
    # run before each test
    @instance = SwaggerClient::DataStructure.new
  end
  ...
  describe 'test an instance of DataStructure' do
    it 'should create an instance of DataStructure' do
      expect(@instance).to be_instance_of(SwaggerClient::DataStructure)
    end
  end
