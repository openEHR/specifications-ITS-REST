...
# Unit tests for SwaggerClient::ImportedVersion
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ImportedVersion' do
  before do
    # run before each test
    @instance = SwaggerClient::ImportedVersion.new
  end
  ...
  describe 'test an instance of ImportedVersion' do
    it 'should create an instance of ImportedVersion' do
      expect(@instance).to be_instance_of(SwaggerClient::ImportedVersion)
    end
  end
