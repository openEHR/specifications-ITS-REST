...
# Unit tests for SwaggerClient::AdminEntry
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AdminEntry' do
  before do
    # run before each test
    @instance = SwaggerClient::AdminEntry.new
  end
  ...
  describe 'test an instance of AdminEntry' do
    it 'should create an instance of AdminEntry' do
      expect(@instance).to be_instance_of(SwaggerClient::AdminEntry)
    end
  end
