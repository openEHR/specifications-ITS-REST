...
# Unit tests for SwaggerClient::DvCodedText
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DvCodedText' do
  before do
    # run before each test
    @instance = SwaggerClient::DvCodedText.new
  end
  ...
  describe 'test an instance of DvCodedText' do
    it 'should create an instance of DvCodedText' do
      expect(@instance).to be_instance_of(SwaggerClient::DvCodedText)
    end
  end
  ...
  describe 'test attribute "defining_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
