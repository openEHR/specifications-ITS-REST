...
# Unit tests for SwaggerClient::DvParsable
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DvParsable' do
  before do
    # run before each test
    @instance = SwaggerClient::DvParsable.new
  end
  ...
  describe 'test an instance of DvParsable' do
    it 'should create an instance of DvParsable' do
      expect(@instance).to be_instance_of(SwaggerClient::DvParsable)
    end
  end
  ...
  describe 'test attribute "formalism"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
