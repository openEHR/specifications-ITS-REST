...
# Unit tests for SwaggerClient::DvCount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DvCount' do
  before do
    # run before each test
    @instance = SwaggerClient::DvCount.new
  end
  ...
  describe 'test an instance of DvCount' do
    it 'should create an instance of DvCount' do
      expect(@instance).to be_instance_of(SwaggerClient::DvCount)
    end
  end
