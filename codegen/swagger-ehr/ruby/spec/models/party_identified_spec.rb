...
# Unit tests for SwaggerClient::PartyIdentified
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PartyIdentified' do
  before do
    # run before each test
    @instance = SwaggerClient::PartyIdentified.new
  end
  ...
  describe 'test an instance of PartyIdentified' do
    it 'should create an instance of PartyIdentified' do
      expect(@instance).to be_instance_of(SwaggerClient::PartyIdentified)
    end
  end
