...
# Unit tests for SwaggerClient::DvIntervalOfDateTime
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DvIntervalOfDateTime' do
  before do
    # run before each test
    @instance = SwaggerClient::DvIntervalOfDateTime.new
  end
  ...
  describe 'test an instance of DvIntervalOfDateTime' do
    it 'should create an instance of DvIntervalOfDateTime' do
      expect(@instance).to be_instance_of(SwaggerClient::DvIntervalOfDateTime)
    end
  end
  ...
  describe 'test attribute "lower_unbounded"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "upper_unbounded"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "lower_included"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "upper_included"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
