...
# Unit tests for SwaggerClient::UpdateAttestation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateAttestation' do
  before do
    # run before each test
    @instance = SwaggerClient::UpdateAttestation.new
  end
  ...
  describe 'test an instance of UpdateAttestation' do
    it 'should create an instance of UpdateAttestation' do
      expect(@instance).to be_instance_of(SwaggerClient::UpdateAttestation)
    end
  end
