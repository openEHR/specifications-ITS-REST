...
# Unit tests for SwaggerClient::DvIdentifier
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DvIdentifier' do
  before do
    # run before each test
    @instance = SwaggerClient::DvIdentifier.new
  end
  ...
  describe 'test an instance of DvIdentifier' do
    it 'should create an instance of DvIdentifier' do
      expect(@instance).to be_instance_of(SwaggerClient::DvIdentifier)
    end
  end
