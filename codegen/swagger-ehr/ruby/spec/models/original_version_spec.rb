...
# Unit tests for SwaggerClient::OriginalVersion
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OriginalVersion' do
  before do
    # run before each test
    @instance = SwaggerClient::OriginalVersion.new
  end
  ...
  describe 'test an instance of OriginalVersion' do
    it 'should create an instance of OriginalVersion' do
      expect(@instance).to be_instance_of(SwaggerClient::OriginalVersion)
    end
  end
  ...
  describe 'test attribute "commit_audit"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
