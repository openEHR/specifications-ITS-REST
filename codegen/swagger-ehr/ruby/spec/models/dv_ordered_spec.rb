...
# Unit tests for SwaggerClient::DvOrdered
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DvOrdered' do
  before do
    # run before each test
    @instance = SwaggerClient::DvOrdered.new
  end
  ...
  describe 'test an instance of DvOrdered' do
    it 'should create an instance of DvOrdered' do
      expect(@instance).to be_instance_of(SwaggerClient::DvOrdered)
    end
  end
