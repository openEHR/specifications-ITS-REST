...
# Unit tests for SwaggerClient::VersionedObject
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VersionedObject' do
  before do
    # run before each test
    @instance = SwaggerClient::VersionedObject.new
  end
  ...
  describe 'test an instance of VersionedObject' do
    it 'should create an instance of VersionedObject' do
      expect(@instance).to be_instance_of(SwaggerClient::VersionedObject)
    end
  end
