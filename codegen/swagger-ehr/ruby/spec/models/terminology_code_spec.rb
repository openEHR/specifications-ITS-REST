...
# Unit tests for SwaggerClient::TerminologyCode
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TerminologyCode' do
  before do
    # run before each test
    @instance = SwaggerClient::TerminologyCode.new
  end
  ...
  describe 'test an instance of TerminologyCode' do
    it 'should create an instance of TerminologyCode' do
      expect(@instance).to be_instance_of(SwaggerClient::TerminologyCode)
    end
  end
  describe 'test attribute "terminology_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "terminology_version"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "code_string"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
