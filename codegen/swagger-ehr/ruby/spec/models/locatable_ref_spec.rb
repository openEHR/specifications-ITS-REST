...
# Unit tests for SwaggerClient::LocatableRef
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LocatableRef' do
  before do
    # run before each test
    @instance = SwaggerClient::LocatableRef.new
  end
  ...
  describe 'test an instance of LocatableRef' do
    it 'should create an instance of LocatableRef' do
      expect(@instance).to be_instance_of(SwaggerClient::LocatableRef)
    end
  end
