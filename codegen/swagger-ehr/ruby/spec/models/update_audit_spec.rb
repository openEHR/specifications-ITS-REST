...
# Unit tests for SwaggerClient::UpdateAudit
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateAudit' do
  before do
    # run before each test
    @instance = SwaggerClient::UpdateAudit.new
  end
  ...
  describe 'test an instance of UpdateAudit' do
    it 'should create an instance of UpdateAudit' do
      expect(@instance).to be_instance_of(SwaggerClient::UpdateAudit)
    end
  end
