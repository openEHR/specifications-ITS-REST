...
# Unit tests for SwaggerClient::Versionable
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Versionable' do
  before do
    # run before each test
    @instance = SwaggerClient::Versionable.new
  end
  ...
  describe 'test an instance of Versionable' do
    it 'should create an instance of Versionable' do
      expect(@instance).to be_instance_of(SwaggerClient::Versionable)
    end
  end
