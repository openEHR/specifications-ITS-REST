...
# Unit tests for SwaggerClient::VersionedEhrStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VersionedEhrStatus' do
  before do
    # run before each test
    @instance = SwaggerClient::VersionedEhrStatus.new
  end
  ...
  describe 'test an instance of VersionedEhrStatus' do
    it 'should create an instance of VersionedEhrStatus' do
      expect(@instance).to be_instance_of(SwaggerClient::VersionedEhrStatus)
    end
  end
