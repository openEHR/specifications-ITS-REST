...
# Unit tests for SwaggerClient::InstructionDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InstructionDetails' do
  before do
    # run before each test
    @instance = SwaggerClient::InstructionDetails.new
  end
  ...
  describe 'test an instance of InstructionDetails' do
    it 'should create an instance of InstructionDetails' do
      expect(@instance).to be_instance_of(SwaggerClient::InstructionDetails)
    end
  end
  ...
  describe 'test attribute "wf_details"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
