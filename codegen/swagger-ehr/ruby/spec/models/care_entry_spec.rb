...
# Unit tests for SwaggerClient::CareEntry
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CareEntry' do
  before do
    # run before each test
    @instance = SwaggerClient::CareEntry.new
  end
  ...
  describe 'test an instance of CareEntry' do
    it 'should create an instance of CareEntry' do
      expect(@instance).to be_instance_of(SwaggerClient::CareEntry)
    end
  end
  ...
  describe 'test attribute "guideline_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
