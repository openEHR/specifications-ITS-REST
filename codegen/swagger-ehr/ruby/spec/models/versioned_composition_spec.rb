...
# Unit tests for SwaggerClient::VersionedComposition
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VersionedComposition' do
  before do
    # run before each test
    @instance = SwaggerClient::VersionedComposition.new
  end
  ...
  describe 'test an instance of VersionedComposition' do
    it 'should create an instance of VersionedComposition' do
      expect(@instance).to be_instance_of(SwaggerClient::VersionedComposition)
    end
  end
