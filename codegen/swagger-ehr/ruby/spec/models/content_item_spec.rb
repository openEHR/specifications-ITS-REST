...
# Unit tests for SwaggerClient::ContentItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ContentItem' do
  before do
    # run before each test
    @instance = SwaggerClient::ContentItem.new
  end
  ...
  describe 'test an instance of ContentItem' do
    it 'should create an instance of ContentItem' do
      expect(@instance).to be_instance_of(SwaggerClient::ContentItem)
    end
  end
