...
# Unit tests for SwaggerClient::DvOrdinal
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DvOrdinal' do
  before do
    # run before each test
    @instance = SwaggerClient::DvOrdinal.new
  end
  ...
  describe 'test an instance of DvOrdinal' do
    it 'should create an instance of DvOrdinal' do
      expect(@instance).to be_instance_of(SwaggerClient::DvOrdinal)
    end
  end
