...
# Unit tests for SwaggerClient::FeederAuditDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeederAuditDetails' do
  before do
    # run before each test
    @instance = SwaggerClient::FeederAuditDetails.new
  end
  ...
  describe 'test an instance of FeederAuditDetails' do
    it 'should create an instance of FeederAuditDetails' do
      expect(@instance).to be_instance_of(SwaggerClient::FeederAuditDetails)
    end
  end
