...
# Unit tests for SwaggerClient::PartyRelated
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PartyRelated' do
  before do
    # run before each test
    @instance = SwaggerClient::PartyRelated.new
  end
  ...
  describe 'test an instance of PartyRelated' do
    it 'should create an instance of PartyRelated' do
      expect(@instance).to be_instance_of(SwaggerClient::PartyRelated)
    end
  end
