...
# Unit tests for SwaggerClient::DvProportion
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DvProportion' do
  before do
    # run before each test
    @instance = SwaggerClient::DvProportion.new
  end
  ...
  describe 'test an instance of DvProportion' do
    it 'should create an instance of DvProportion' do
      expect(@instance).to be_instance_of(SwaggerClient::DvProportion)
    end
  end
