...
# Unit tests for SwaggerClient::AbstractEntry
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AbstractEntry' do
  before do
    # run before each test
    @instance = SwaggerClient::AbstractEntry.new
  end
  ...
  describe 'test an instance of AbstractEntry' do
    it 'should create an instance of AbstractEntry' do
      expect(@instance).to be_instance_of(SwaggerClient::AbstractEntry)
    end
  end
