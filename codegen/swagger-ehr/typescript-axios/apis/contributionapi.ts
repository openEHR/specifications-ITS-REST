...
import { NewContribution } from '../models';
/**
...
export const CONTRIBUTIONApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        contributionCreate: async (body: NewContribution, ehrId: string, prefer?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        contributionGet: async (ehrId: string, contributionUid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'ehrId' is not null or undefined
            if (ehrId === null || ehrId === undefined) {
...
export const CONTRIBUTIONApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async contributionCreate(body: NewContribution, ehrId: string, prefer?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Contribution>>> {
            const localVarAxiosArgs = await CONTRIBUTIONApiAxiosParamCreator(configuration).contributionCreate(body, ehrId, prefer, options);
         ...
         * @throws {RequiredError}
         */
        async contributionGet(ehrId: string, contributionUid: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Contribution>>> {
            const localVarAxiosArgs = await CONTRIBUTIONApiAxiosParamCreator(configuration).contributionGet(ehrId, contributionUid, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const CONTRIBUTIONApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async contributionCreate(body: NewContribution, ehrId: string, prefer?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Contribution>> {
            return CONTRIBUTIONApiFp(configuration).contributionCreate(body, ehrId, prefer, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves a CONTRIBUTION identified by `contribution_uid` and associated with the EHR identified by `ehr_id`. 
         * @summary Get CONTRIBUTION by id
         ...
         * @throws {RequiredError}
         */
        async contributionGet(ehrId: string, contributionUid: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Contribution>> {
            return CONTRIBUTIONApiFp(configuration).contributionGet(ehrId, contributionUid, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class CONTRIBUTIONApi extends BaseAPI {
     ...
     */
    public async contributionCreate(body: NewContribution, ehrId: string, prefer?: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Contribution>> {
        return CONTRIBUTIONApiFp(this.configuration).contributionCreate(body, ehrId, prefer, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieves a CONTRIBUTION identified by `contribution_uid` and associated with the EHR identified by `ehr_id`. 
     * @summary Get CONTRIBUTION by id
     ...
     * @memberof CONTRIBUTIONApi
     */
    public async contributionGet(ehrId: string, contributionUid: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Contribution>> {
        return CONTRIBUTIONApiFp(this.configuration).contributionGet(ehrId, contributionUid, options).then((request) => request(this.axios, this.basePath));
    }
}
