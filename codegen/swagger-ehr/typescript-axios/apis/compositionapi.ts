...
import { VersionedComposition } from '../models';
/**
 * COMPOSITIONApi - axios parameter creator
 * @export
 */
export const COMPOSITIONApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         */
        compositionCreate: async (body: Composition, ehrId: string, prefer?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        compositionDelete: async (ehrId: string, uidBasedId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'ehrId' is not null or undefined
            if (ehrId === null || ehrId === undefined) {
         ...
         * @throws {RequiredError}
         */
        compositionGet: async (ehrId: string, uidBasedId: string, versionAtTime?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'ehrId' is not null or undefined
            if (ehrId === null || ehrId === undefined) {
         ...
         * @throws {RequiredError}
         */
        compositionUpdate: async (body: Composition, ifMatch: string, ehrId: string, uidBasedId: string, prefer?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
         ...
         * @throws {RequiredError}
         */
        versionedCompositionGet: async (ehrId: string, versionedObjectUid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'ehrId' is not null or undefined
            if (ehrId === null || ehrId === undefined) {
         ...
         * @throws {RequiredError}
         */
        versionedCompositionRevisionHistory: async (ehrId: string, versionedObjectUid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'ehrId' is not null or undefined
            if (ehrId === null || ehrId === undefined) {
         ...
         * @throws {RequiredError}
         */
        versionedCompositionVersionGetAtTime: async (ehrId: string, versionedObjectUid: string, versionAtTime?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'ehrId' is not null or undefined
            if (ehrId === null || ehrId === undefined) {
         ...
         * @throws {RequiredError}
         */
        versionedCompositionVersionGetById: async (ehrId: string, versionedObjectUid: string, versionUid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'ehrId' is not null or undefined
            if (ehrId === null || ehrId === undefined) {
...
export const COMPOSITIONApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async compositionCreate(body: Composition, ehrId: string, prefer?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Composition>>> {
            const localVarAxiosArgs = await COMPOSITIONApiAxiosParamCreator(configuration).compositionCreate(body, ehrId, prefer, options);
         ...
         * @throws {RequiredError}
         */
        async compositionDelete(ehrId: string, uidBasedId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await COMPOSITIONApiAxiosParamCreator(configuration).compositionDelete(ehrId, uidBasedId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async compositionGet(ehrId: string, uidBasedId: string, versionAtTime?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Composition>>> {
            const localVarAxiosArgs = await COMPOSITIONApiAxiosParamCreator(configuration).compositionGet(ehrId, uidBasedId, versionAtTime, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async compositionUpdate(body: Composition, ifMatch: string, ehrId: string, uidBasedId: string, prefer?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Composition>>> {
            const localVarAxiosArgs = await COMPOSITIONApiAxiosParamCreator(configuration).compositionUpdate(body, ifMatch, ehrId, uidBasedId, prefer, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async versionedCompositionGet(ehrId: string, versionedObjectUid: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<VersionedComposition>>> {
            const localVarAxiosArgs = await COMPOSITIONApiAxiosParamCreator(configuration).versionedCompositionGet(ehrId, versionedObjectUid, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async versionedCompositionRevisionHistory(ehrId: string, versionedObjectUid: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<RevisionHistory>>> {
            const localVarAxiosArgs = await COMPOSITIONApiAxiosParamCreator(configuration).versionedCompositionRevisionHistory(ehrId, versionedObjectUid, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async versionedCompositionVersionGetAtTime(ehrId: string, versionedObjectUid: string, versionAtTime?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Version>>> {
            const localVarAxiosArgs = await COMPOSITIONApiAxiosParamCreator(configuration).versionedCompositionVersionGetAtTime(ehrId, versionedObjectUid, versionAtTime, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async versionedCompositionVersionGetById(ehrId: string, versionedObjectUid: string, versionUid: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Version>>> {
            const localVarAxiosArgs = await COMPOSITIONApiAxiosParamCreator(configuration).versionedCompositionVersionGetById(ehrId, versionedObjectUid, versionUid, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
 ...
 * @export
 */
export const COMPOSITIONApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        /**
         * Creates the first version of a new COMPOSITION in the EHR identified by `ehr_id`. 
         * @summary Create COMPOSITION
         ...
         * @throws {RequiredError}
         */
        async compositionCreate(body: Composition, ehrId: string, prefer?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Composition>> {
            return COMPOSITIONApiFp(configuration).compositionCreate(body, ehrId, prefer, options).then((request) => request(axios, basePath));
        },
        /**
         * Deletes the COMPOSITION identified by `uid_based_id` and associated with the EHR identified by `ehr_id`.  The `uid_based_id` MUST be in a form of an OBJECT_VERSION_ID identifier taken from the last (most recent) VERSION.uid.value, representing the `preceding_version_uid` to be deleted. 
         * @summary Delete COMPOSITION
         ...
         * @throws {RequiredError}
         */
        async compositionDelete(ehrId: string, uidBasedId: string, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return COMPOSITIONApiFp(configuration).compositionDelete(ehrId, uidBasedId, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves a version of the COMPOSITION identified by `uid_based_id` and associated with the EHR identified by `ehr_id`.  The `uid_based_id` can take a form of an OBJECT_VERSION_ID identifier taken from VERSION.uid.value (i.e. a `version_uid`), or a form of a HIER_OBJECT_ID identifier taken from VERSIONED_OBJECT.uid.value (i.e. a `versioned_object_uid`). The former is used to retrieve a specific known version of the COMPOSITION (e.g. one identified by `8849182c-82ad-4088-a07f-48ead4180515::openEHRSys.example.com::1`), whereas the later (e.g. an identifier like `8849182c-82ad-4088-a07f-48ead4180515`) is be used to retrieve a version from the version container whenever the _version_tree_id_ is unknown or irrelevant (such as when most recent version is requested).  When the `uid_based_id` has the form of a HIER_OBJECT_ID, if the `version_at_time` is supplied, retrieves the version extant _at specified time_, otherwise retrieves the _latest_ COMPOSITION version.  See [Resource identification](overview.html#tag/Resources/Resource-identification) for more details about the identifiers usage and meaning. 
         * @summary Get COMPOSITION
         ...
         * @throws {RequiredError}
         */
        async compositionGet(ehrId: string, uidBasedId: string, versionAtTime?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Composition>> {
            return COMPOSITIONApiFp(configuration).compositionGet(ehrId, uidBasedId, versionAtTime, options).then((request) => request(axios, basePath));
        },
        /**
         * Updates COMPOSITION identified by `uid_based_id` and associated with the EHR identified by `ehr_id`.  The `uid_based_id` can take only a form of an HIER_OBJECT_ID identifier taken from VERSIONED_OBJECT.uid.value (i.e. a `versioned_object_uid`).  If the request body already contains a COMPOSITION.uid.value, it must match the `uid_based_id` in the URL.   The existing latest `version_uid` of COMPOSITION resource (i.e. the `preceding_version_uid`) must be specified in the `If-Match` header. 
         * @summary Update COMPOSITION
         ...
         * @throws {RequiredError}
         */
        async compositionUpdate(body: Composition, ifMatch: string, ehrId: string, uidBasedId: string, prefer?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Composition>> {
            return COMPOSITIONApiFp(configuration).compositionUpdate(body, ifMatch, ehrId, uidBasedId, prefer, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves a VERSIONED_COMPOSITION identified by `versioned_object_uid` and associated with the EHR identified by `ehr_id`. 
         * @summary Get versioned COMPOSITION
         ...
         * @throws {RequiredError}
         */
        async versionedCompositionGet(ehrId: string, versionedObjectUid: string, options?: AxiosRequestConfig): Promise<AxiosResponse<VersionedComposition>> {
            return COMPOSITIONApiFp(configuration).versionedCompositionGet(ehrId, versionedObjectUid, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves revision history of the VERSIONED_COMPOSITION identified by `versioned_object_uid` and associated with the EHR identified by `ehr_id`. 
         * @summary Get versioned COMPOSITION revision history
         ...
         * @throws {RequiredError}
         */
        async versionedCompositionRevisionHistory(ehrId: string, versionedObjectUid: string, options?: AxiosRequestConfig): Promise<AxiosResponse<RevisionHistory>> {
            return COMPOSITIONApiFp(configuration).versionedCompositionRevisionHistory(ehrId, versionedObjectUid, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves a VERSION from the VERSIONED_COMPOSITION identified by `versioned_object_uid` and associated with the EHR identified by `ehr_id`.  If `version_at_time` is supplied, retrieves the VERSION extant _at specified time_, otherwise retrieves the _latest_ VERSION. 
         * @summary Get versioned COMPOSITION version at time
         ...
         * @throws {RequiredError}
         */
        async versionedCompositionVersionGetAtTime(ehrId: string, versionedObjectUid: string, versionAtTime?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Version>> {
            return COMPOSITIONApiFp(configuration).versionedCompositionVersionGetAtTime(ehrId, versionedObjectUid, versionAtTime, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves a VERSION identified by `version_uid` of a VERSIONED_COMPOSITION identified by `versioned_object_uid` and associated with the EHR identified by `ehr_id`. 
         * @summary Get versioned COMPOSITION version by id
         ...
         * @throws {RequiredError}
         */
        async versionedCompositionVersionGetById(ehrId: string, versionedObjectUid: string, versionUid: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Version>> {
            return COMPOSITIONApiFp(configuration).versionedCompositionVersionGetById(ehrId, versionedObjectUid, versionUid, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class COMPOSITIONApi extends BaseAPI {
     ...
     */
    public async compositionCreate(body: Composition, ehrId: string, prefer?: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Composition>> {
        return COMPOSITIONApiFp(this.configuration).compositionCreate(body, ehrId, prefer, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Deletes the COMPOSITION identified by `uid_based_id` and associated with the EHR identified by `ehr_id`.  The `uid_based_id` MUST be in a form of an OBJECT_VERSION_ID identifier taken from the last (most recent) VERSION.uid.value, representing the `preceding_version_uid` to be deleted. 
     * @summary Delete COMPOSITION
     ...
     * @memberof COMPOSITIONApi
     */
    public async compositionDelete(ehrId: string, uidBasedId: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
        return COMPOSITIONApiFp(this.configuration).compositionDelete(ehrId, uidBasedId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieves a version of the COMPOSITION identified by `uid_based_id` and associated with the EHR identified by `ehr_id`.  The `uid_based_id` can take a form of an OBJECT_VERSION_ID identifier taken from VERSION.uid.value (i.e. a `version_uid`), or a form of a HIER_OBJECT_ID identifier taken from VERSIONED_OBJECT.uid.value (i.e. a `versioned_object_uid`). The former is used to retrieve a specific known version of the COMPOSITION (e.g. one identified by `8849182c-82ad-4088-a07f-48ead4180515::openEHRSys.example.com::1`), whereas the later (e.g. an identifier like `8849182c-82ad-4088-a07f-48ead4180515`) is be used to retrieve a version from the version container whenever the _version_tree_id_ is unknown or irrelevant (such as when most recent version is requested).  When the `uid_based_id` has the form of a HIER_OBJECT_ID, if the `version_at_time` is supplied, retrieves the version extant _at specified time_, otherwise retrieves the _latest_ COMPOSITION version.  See [Resource identification](overview.html#tag/Resources/Resource-identification) for more details about the identifiers usage and meaning. 
     * @summary Get COMPOSITION
     ...
     * @memberof COMPOSITIONApi
     */
    public async compositionGet(ehrId: string, uidBasedId: string, versionAtTime?: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Composition>> {
        return COMPOSITIONApiFp(this.configuration).compositionGet(ehrId, uidBasedId, versionAtTime, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Updates COMPOSITION identified by `uid_based_id` and associated with the EHR identified by `ehr_id`.  The `uid_based_id` can take only a form of an HIER_OBJECT_ID identifier taken from VERSIONED_OBJECT.uid.value (i.e. a `versioned_object_uid`).  If the request body already contains a COMPOSITION.uid.value, it must match the `uid_based_id` in the URL.   The existing latest `version_uid` of COMPOSITION resource (i.e. the `preceding_version_uid`) must be specified in the `If-Match` header. 
     * @summary Update COMPOSITION
     ...
     * @memberof COMPOSITIONApi
     */
    public async compositionUpdate(body: Composition, ifMatch: string, ehrId: string, uidBasedId: string, prefer?: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Composition>> {
        return COMPOSITIONApiFp(this.configuration).compositionUpdate(body, ifMatch, ehrId, uidBasedId, prefer, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieves a VERSIONED_COMPOSITION identified by `versioned_object_uid` and associated with the EHR identified by `ehr_id`. 
     * @summary Get versioned COMPOSITION
     ...
     * @memberof COMPOSITIONApi
     */
    public async versionedCompositionGet(ehrId: string, versionedObjectUid: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<VersionedComposition>> {
        return COMPOSITIONApiFp(this.configuration).versionedCompositionGet(ehrId, versionedObjectUid, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieves revision history of the VERSIONED_COMPOSITION identified by `versioned_object_uid` and associated with the EHR identified by `ehr_id`. 
     * @summary Get versioned COMPOSITION revision history
     ...
     * @memberof COMPOSITIONApi
     */
    public async versionedCompositionRevisionHistory(ehrId: string, versionedObjectUid: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<RevisionHistory>> {
        return COMPOSITIONApiFp(this.configuration).versionedCompositionRevisionHistory(ehrId, versionedObjectUid, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieves a VERSION from the VERSIONED_COMPOSITION identified by `versioned_object_uid` and associated with the EHR identified by `ehr_id`.  If `version_at_time` is supplied, retrieves the VERSION extant _at specified time_, otherwise retrieves the _latest_ VERSION. 
     * @summary Get versioned COMPOSITION version at time
     ...
     * @memberof COMPOSITIONApi
     */
    public async versionedCompositionVersionGetAtTime(ehrId: string, versionedObjectUid: string, versionAtTime?: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Version>> {
        return COMPOSITIONApiFp(this.configuration).versionedCompositionVersionGetAtTime(ehrId, versionedObjectUid, versionAtTime, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieves a VERSION identified by `version_uid` of a VERSIONED_COMPOSITION identified by `versioned_object_uid` and associated with the EHR identified by `ehr_id`. 
     * @summary Get versioned COMPOSITION version by id
     ...
     * @memberof COMPOSITIONApi
     */
    public async versionedCompositionVersionGetById(ehrId: string, versionedObjectUid: string, versionUid: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Version>> {
        return COMPOSITIONApiFp(this.configuration).versionedCompositionVersionGetById(ehrId, versionedObjectUid, versionUid, options).then((request) => request(this.axios, this.basePath));
    }
}
