...
export const DIRECTORYApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        directoryCreate: async (body: Folder, ehrId: string, prefer?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        directoryDelete: async (ehrId: string, ifMatch: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'ehrId' is not null or undefined
            if (ehrId === null || ehrId === undefined) {
         ...
         * @throws {RequiredError}
         */
        directoryGetAtTime: async (ehrId: string, versionAtTime?: string, path?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'ehrId' is not null or undefined
            if (ehrId === null || ehrId === undefined) {
         ...
         * @throws {RequiredError}
         */
        directoryGetByVersionId: async (ehrId: string, versionUid: string, path?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'ehrId' is not null or undefined
            if (ehrId === null || ehrId === undefined) {
         ...
         * @throws {RequiredError}
         */
        directoryUpdate: async (body: Folder, ifMatch: string, ehrId: string, prefer?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
...
export const DIRECTORYApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async directoryCreate(body: Folder, ehrId: string, prefer?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Folder>>> {
            const localVarAxiosArgs = await DIRECTORYApiAxiosParamCreator(configuration).directoryCreate(body, ehrId, prefer, options);
         ...
         * @throws {RequiredError}
         */
        async directoryDelete(ehrId: string, ifMatch: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await DIRECTORYApiAxiosParamCreator(configuration).directoryDelete(ehrId, ifMatch, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async directoryGetAtTime(ehrId: string, versionAtTime?: string, path?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Folder>>> {
            const localVarAxiosArgs = await DIRECTORYApiAxiosParamCreator(configuration).directoryGetAtTime(ehrId, versionAtTime, path, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async directoryGetByVersionId(ehrId: string, versionUid: string, path?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Folder>>> {
            const localVarAxiosArgs = await DIRECTORYApiAxiosParamCreator(configuration).directoryGetByVersionId(ehrId, versionUid, path, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async directoryUpdate(body: Folder, ifMatch: string, ehrId: string, prefer?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Folder>>> {
            const localVarAxiosArgs = await DIRECTORYApiAxiosParamCreator(configuration).directoryUpdate(body, ifMatch, ehrId, prefer, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const DIRECTORYApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async directoryCreate(body: Folder, ehrId: string, prefer?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Folder>> {
            return DIRECTORYApiFp(configuration).directoryCreate(body, ehrId, prefer, options).then((request) => request(axios, basePath));
        },
        /**
         * Deletes directory FOLDER associated with the EHR identified by `ehr_id`.  The existing latest `version_uid` of directory FOLDER resource (i.e. the `preceding_version_uid`) must be specified in the `If-Match` header. 
         * @summary Delete directory
         ...
         * @throws {RequiredError}
         */
        async directoryDelete(ehrId: string, ifMatch: string, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return DIRECTORYApiFp(configuration).directoryDelete(ehrId, ifMatch, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves the version of the directory FOLDER associated with the EHR identified by `ehr_id`.  If `version_at_time` is supplied, retrieves the version extant _at specified time_, otherwise retrieves the _latest_ directory FOLDER version.   If `path` is supplied, retrieves from the directory only the sub-FOLDER that is associated with that path. 
         * @summary Get folder in directory version at time
         ...
         * @throws {RequiredError}
         */
        async directoryGetAtTime(ehrId: string, versionAtTime?: string, path?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Folder>> {
            return DIRECTORYApiFp(configuration).directoryGetAtTime(ehrId, versionAtTime, path, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves a particular version of the directory FOLDER identified by `version_uid` and associated with the EHR identified by `ehr_id`.  If `path` is supplied, retrieves from the directory only the sub-FOLDER that is associated with that path. 
         * @summary Get folder in directory version
         ...
         * @throws {RequiredError}
         */
        async directoryGetByVersionId(ehrId: string, versionUid: string, path?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Folder>> {
            return DIRECTORYApiFp(configuration).directoryGetByVersionId(ehrId, versionUid, path, options).then((request) => request(axios, basePath));
        },
        /**
         * Updates directory FOLDER associated with the EHR identified by `ehr_id`.  The existing latest `version_uid` of directory FOLDER resource (i.e. the `preceding_version_uid`) must be specified in the `If-Match` header. 
         * @summary Update directory
         ...
         * @throws {RequiredError}
         */
        async directoryUpdate(body: Folder, ifMatch: string, ehrId: string, prefer?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Folder>> {
            return DIRECTORYApiFp(configuration).directoryUpdate(body, ifMatch, ehrId, prefer, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class DIRECTORYApi extends BaseAPI {
     ...
     */
    public async directoryCreate(body: Folder, ehrId: string, prefer?: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Folder>> {
        return DIRECTORYApiFp(this.configuration).directoryCreate(body, ehrId, prefer, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Deletes directory FOLDER associated with the EHR identified by `ehr_id`.  The existing latest `version_uid` of directory FOLDER resource (i.e. the `preceding_version_uid`) must be specified in the `If-Match` header. 
     * @summary Delete directory
     ...
     * @memberof DIRECTORYApi
     */
    public async directoryDelete(ehrId: string, ifMatch: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
        return DIRECTORYApiFp(this.configuration).directoryDelete(ehrId, ifMatch, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieves the version of the directory FOLDER associated with the EHR identified by `ehr_id`.  If `version_at_time` is supplied, retrieves the version extant _at specified time_, otherwise retrieves the _latest_ directory FOLDER version.   If `path` is supplied, retrieves from the directory only the sub-FOLDER that is associated with that path. 
     * @summary Get folder in directory version at time
     ...
     * @memberof DIRECTORYApi
     */
    public async directoryGetAtTime(ehrId: string, versionAtTime?: string, path?: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Folder>> {
        return DIRECTORYApiFp(this.configuration).directoryGetAtTime(ehrId, versionAtTime, path, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieves a particular version of the directory FOLDER identified by `version_uid` and associated with the EHR identified by `ehr_id`.  If `path` is supplied, retrieves from the directory only the sub-FOLDER that is associated with that path. 
     * @summary Get folder in directory version
     ...
     * @memberof DIRECTORYApi
     */
    public async directoryGetByVersionId(ehrId: string, versionUid: string, path?: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Folder>> {
        return DIRECTORYApiFp(this.configuration).directoryGetByVersionId(ehrId, versionUid, path, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Updates directory FOLDER associated with the EHR identified by `ehr_id`.  The existing latest `version_uid` of directory FOLDER resource (i.e. the `preceding_version_uid`) must be specified in the `If-Match` header. 
     * @summary Update directory
     ...
     * @memberof DIRECTORYApi
     */
    public async directoryUpdate(body: Folder, ifMatch: string, ehrId: string, prefer?: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Folder>> {
        return DIRECTORYApiFp(this.configuration).directoryUpdate(body, ifMatch, ehrId, prefer, options).then((request) => request(this.axios, this.basePath));
    }
}
