...
import { Ehr } from '../models';
import { EhrStatus } from '../models';
/**
 * EHRApi - axios parameter creator
 * @export
 */
export const EHRApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         */
        ehrCreate: async (body?: EhrStatus, prefer?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        ehrCreateWithId: async (ehrId: string, body?: EhrStatus, prefer?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        ehrGetById: async (ehrId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'ehrId' is not null or undefined
            if (ehrId === null || ehrId === undefined) {
         ...
         * @throws {RequiredError}
         */
        ehrGetBySubject: async (subjectId: string, subjectNamespace: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const EHRApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async ehrCreate(body?: EhrStatus, prefer?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Ehr>>> {
            const localVarAxiosArgs = await EHRApiAxiosParamCreator(configuration).ehrCreate(body, prefer, options);
         ...
         * @throws {RequiredError}
         */
        async ehrCreateWithId(ehrId: string, body?: EhrStatus, prefer?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Ehr>>> {
            const localVarAxiosArgs = await EHRApiAxiosParamCreator(configuration).ehrCreateWithId(ehrId, body, prefer, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async ehrGetById(ehrId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Ehr>>> {
            const localVarAxiosArgs = await EHRApiAxiosParamCreator(configuration).ehrGetById(ehrId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async ehrGetBySubject(subjectId: string, subjectNamespace: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Ehr>>> {
            const localVarAxiosArgs = await EHRApiAxiosParamCreator(configuration).ehrGetBySubject(subjectId, subjectNamespace, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
 ...
 * @export
 */
export const EHRApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        /**
         * Create a new `EHR` with an auto-generated identifier.  An EHR_STATUS resource needs to be always created and committed in the new EHR. This resource MAY be also supplied by the client as the request body.  If not supplied, a default EHR_STATUS will be used by the service with following attributes:   - `is_queryable`: true   - `is_modifiable`: true   - `subject`: a PARTY_SELF object  All other required EHR attributes and resources will be automatically created as needed by the [EHR creation semantics](https://specifications.openehr.org/releases/RM/latest/ehr.html#_ehr_creation_semantics). 
         * @summary Create EHR
         ...
         * @throws {RequiredError}
         */
        async ehrCreate(body?: EhrStatus, prefer?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Ehr>> {
            return EHRApiFp(configuration).ehrCreate(body, prefer, options).then((request) => request(axios, basePath));
        },
        /**
         * Create a new EHR with the specified `ehr_id` identifier.  The value of the `ehr_id` unique identifier MUST be valid [HIER_OBJECT_ID](https://specifications.openehr.org/releases/BASE/latest/base_types.html#_hier_object_id_class) value.  It is strongly RECOMMENDED that an UUID always be used for this.  An EHR_STATUS resource needs to be always created and committed in the new EHR. This resource MAY be also supplied by the client as the request body.  If not supplied, a default EHR_STATUS will be used by the service with following attributes:   - `is_queryable`: true   - `is_modifiable`: true   - `subject`: a PARTY_SELF object  All other required EHR attributes and resources will be automatically created as needed by the [EHR creation semantics](https://specifications.openehr.org/releases/RM/latest/ehr.html#_ehr_creation_semantics). 
         * @summary Create EHR with id
         ...
         * @throws {RequiredError}
         */
        async ehrCreateWithId(ehrId: string, body?: EhrStatus, prefer?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Ehr>> {
            return EHRApiFp(configuration).ehrCreateWithId(ehrId, body, prefer, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve the EHR with the specified `ehr_id`. 
         * @summary Get EHR by id
         ...
         * @throws {RequiredError}
         */
        async ehrGetById(ehrId: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Ehr>> {
            return EHRApiFp(configuration).ehrGetById(ehrId, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve the EHR with the specified `subject_id` and `subject_namespace`.  These subject parameters will be matched against EHR's EHR_STATUS.subject.external_ref.id.value and  EHR_STATUS.subject.external_ref.namespace values. 
         * @summary Get EHR by subject id
         ...
         * @throws {RequiredError}
         */
        async ehrGetBySubject(subjectId: string, subjectNamespace: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Ehr>> {
            return EHRApiFp(configuration).ehrGetBySubject(subjectId, subjectNamespace, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class EHRApi extends BaseAPI {
     ...
     * @memberof EHRApi
     */
    public async ehrCreate(body?: EhrStatus, prefer?: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Ehr>> {
        return EHRApiFp(this.configuration).ehrCreate(body, prefer, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Create a new EHR with the specified `ehr_id` identifier.  The value of the `ehr_id` unique identifier MUST be valid [HIER_OBJECT_ID](https://specifications.openehr.org/releases/BASE/latest/base_types.html#_hier_object_id_class) value.  It is strongly RECOMMENDED that an UUID always be used for this.  An EHR_STATUS resource needs to be always created and committed in the new EHR. This resource MAY be also supplied by the client as the request body.  If not supplied, a default EHR_STATUS will be used by the service with following attributes:   - `is_queryable`: true   - `is_modifiable`: true   - `subject`: a PARTY_SELF object  All other required EHR attributes and resources will be automatically created as needed by the [EHR creation semantics](https://specifications.openehr.org/releases/RM/latest/ehr.html#_ehr_creation_semantics). 
     * @summary Create EHR with id
     ...
     * @memberof EHRApi
     */
    public async ehrCreateWithId(ehrId: string, body?: EhrStatus, prefer?: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Ehr>> {
        return EHRApiFp(this.configuration).ehrCreateWithId(ehrId, body, prefer, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieve the EHR with the specified `ehr_id`. 
     * @summary Get EHR by id
     ...
     * @memberof EHRApi
     */
    public async ehrGetById(ehrId: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Ehr>> {
        return EHRApiFp(this.configuration).ehrGetById(ehrId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieve the EHR with the specified `subject_id` and `subject_namespace`.  These subject parameters will be matched against EHR's EHR_STATUS.subject.external_ref.id.value and  EHR_STATUS.subject.external_ref.namespace values. 
     * @summary Get EHR by subject id
     ...
     * @memberof EHRApi
     */
    public async ehrGetBySubject(subjectId: string, subjectNamespace: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Ehr>> {
        return EHRApiFp(this.configuration).ehrGetBySubject(subjectId, subjectNamespace, options).then((request) => request(this.axios, this.basePath));
    }
}
