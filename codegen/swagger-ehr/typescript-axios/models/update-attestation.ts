 ...
 */
import { DvEhrUri } from './dv-ehr-uri';
import { DvMultimedia } from './dv-multimedia';
import { DvText } from './dv-text';
import { PartyProxy } from './party-proxy';
import { TerminologyCode } from './terminology-code';
import { UpdateAudit } from './update-audit';
/**
 * 
 * @export
