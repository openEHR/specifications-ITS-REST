...
public class DirectoryApiTest {
     ...
     */
    @Test
    public void directoryCreateTest() throws Exception {
        Folder body = null;
        String ehrId = null;
        String prefer = null;
        Folder response = api.directoryCreate(body, ehrId, prefer);
     ...
     */
    @Test
    public void directoryDeleteTest() throws Exception {
        String ehrId = null;
        String ifMatch = null;
     ...
     */
    @Test
    public void directoryGetAtTimeTest() throws Exception {
        String ehrId = null;
     ...
     */
    @Test
    public void directoryGetByVersionIdTest() throws Exception {
        String ehrId = null;
     ...
     */
    @Test
    public void directoryUpdateTest() throws Exception {
        Folder body = null;
        String ifMatch = null;
        String ehrId = null;
        String prefer = null;
        Folder response = api.directoryUpdate(body, ifMatch, ehrId, prefer);
