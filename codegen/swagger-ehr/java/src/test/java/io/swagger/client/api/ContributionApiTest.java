...
public class ContributionApiTest {
     ...
     */
    @Test
    public void contributionCreateTest() throws Exception {
        NewContribution body = null;
        String ehrId = null;
        String prefer = null;
        Contribution response = api.contributionCreate(body, ehrId, prefer);
     ...
     */
    @Test
    public void contributionGetTest() throws Exception {
        String ehrId = null;
