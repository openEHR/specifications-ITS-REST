...
public class EhrApiTest {
     ...
     */
    @Test
    public void ehrCreateTest() throws Exception {
        EhrStatus body = null;
        String prefer = null;
        Ehr response = api.ehrCreate(body, prefer);
     ...
     */
    @Test
    public void ehrCreateWithIdTest() throws Exception {
        String ehrId = null;
        EhrStatus body = null;
        String prefer = null;
        Ehr response = api.ehrCreateWithId(ehrId, body, prefer);
     ...
     */
    @Test
    public void ehrGetByIdTest() throws Exception {
        String ehrId = null;
     ...
     */
    @Test
    public void ehrGetBySubjectTest() throws Exception {
