...
import io.swagger.client.model.DataStructure;
...
public class ItemStructure extends DataStructure {
  ...
  private String itemStructureType = null;

  public ItemStructure() {
    this._type = this.getClass().getSimpleName();
  }
  public ItemStructure itemStructureType(String itemStructureType) {
    this.itemStructureType = itemStructureType;
    return this;
  }

   /**
   * Get itemStructureType
   * @return itemStructureType
  **/
  @Schema(description = "")
  public String getItemStructureType() {
    return itemStructureType;
  }

  public void setItemStructureType(String itemStructureType) {
    this.itemStructureType = itemStructureType;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.itemStructureType, itemStructure.itemStructureType) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(itemStructureType, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("    itemStructureType: ").append(toIndentedString(itemStructureType)).append("\n");
    sb.append("}");
    return sb.toString();
  }
