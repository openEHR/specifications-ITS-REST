...
import io.swagger.client.model.DataValue;
 ...
 */
@Schema(description = "Type for representing identifiers of real-world entities. Typical identifiers include drivers licence number, social security number, veterans affairs number, prescription id, order id, and so on.  DV_IDENTIFIER is used to represent any identifier of a real thing, issued by some authority or agency. ")
...
public class DvIdentifier extends DataValue {
  ...
  @SerializedName("type")
  private String dvIdentifierType = null;
  ...
  **/
  ...
  public DvIdentifier dvIdentifierType(String dvIdentifierType) {
    this.dvIdentifierType = dvIdentifierType;
    return this;
  }

   /**
   * Get dvIdentifierType
   * @return dvIdentifierType
  **/
  @Schema(description = "")
  public String getDvIdentifierType() {
    return dvIdentifierType;
  }

  public void setDvIdentifierType(String dvIdentifierType) {
    this.dvIdentifierType = dvIdentifierType;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.issuer, dvIdentifier.issuer) &&
        ...
        Objects.equals(this.dvIdentifierType, dvIdentifier.dvIdentifierType) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(issuer, assigner, id, dvIdentifierType, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("    dvIdentifierType: ").append(toIndentedString(dvIdentifierType)).append("\n");
    sb.append("}");
    return sb.toString();
  }
