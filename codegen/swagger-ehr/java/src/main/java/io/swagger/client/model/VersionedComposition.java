...
import io.swagger.client.model.DvDateTime;
import io.swagger.client.model.HierObjectId;
import io.swagger.client.model.ObjectRef;
import io.swagger.client.model.VersionedObject;
import io.swagger.v3.oas.annotations.media.Schema;
import java.io.IOException;
/**
 * A VERSIONED_COMPOSITION resource
 */
@Schema(description = "A VERSIONED_COMPOSITION resource")
...
public class VersionedComposition extends VersionedObject {
  ...
  private String versionedCompositionType = "VERSIONED_COMPOSITION";

  public VersionedComposition versionedCompositionType(String versionedCompositionType) {
    this.versionedCompositionType = versionedCompositionType;
    return this;
  }

   /**
   * Get versionedCompositionType
   * @return versionedCompositionType
  **/
  @Schema(description = "")
  public String getVersionedCompositionType() {
    return versionedCompositionType;
  }

  public void setVersionedCompositionType(String versionedCompositionType) {
    this.versionedCompositionType = versionedCompositionType;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.versionedCompositionType, versionedComposition.versionedCompositionType) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(versionedCompositionType, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("    versionedCompositionType: ").append(toIndentedString(versionedCompositionType)).append("\n");
    sb.append("}");
    return sb.toString();
  }
