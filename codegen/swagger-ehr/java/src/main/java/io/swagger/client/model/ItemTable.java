...
import io.swagger.client.model.Clstr;
...
public class ItemTable extends ItemStructure {
  ...
  private String itemTableType = "ITEM_TABLE";

  @SerializedName("items")
  private List<Clstr> items = null;

  public ItemTable itemTableType(String itemTableType) {
  ...
  **/
  @Schema(description = "")
  public String getItemTableType() {
    return itemTableType;
  }

  public void setItemTableType(String itemTableType) {
    this.itemTableType = itemTableType;
  }
  ...
  public ItemTable addItemsItem(Clstr itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<Clstr>();
    }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.itemTableType, itemTable.itemTableType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(itemTableType, items, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("    itemTableType: ").append(toIndentedString(itemTableType)).append("\n");
