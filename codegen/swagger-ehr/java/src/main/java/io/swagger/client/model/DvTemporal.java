...
import io.swagger.client.model.DvDuration;
import io.swagger.client.model.DvQuantified;
...
public class DvTemporal extends DvQuantified {
  ...
  private String dvTemporalType = "DV_TEMPORAL";

  @SerializedName("accuracy")
  private DvDuration accuracy = null;

  public DvTemporal() {
    this._type = this.getClass().getSimpleName();
  }
  public DvTemporal dvTemporalType(String dvTemporalType) {
    this.dvTemporalType = dvTemporalType;
    return this;
  }

   /**
   * Get dvTemporalType
   * @return dvTemporalType
  **/
  @Schema(description = "")
  public String getDvTemporalType() {
    return dvTemporalType;
  }

  public void setDvTemporalType(String dvTemporalType) {
    this.dvTemporalType = dvTemporalType;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.dvTemporalType, dvTemporal.dvTemporalType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dvTemporalType, accuracy, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("    dvTemporalType: ").append(toIndentedString(dvTemporalType)).append("\n");
