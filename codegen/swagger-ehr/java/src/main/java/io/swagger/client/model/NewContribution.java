...
import io.swagger.client.model.UpdateVersion;
 ...
 */
@Schema(description = "A new (un-committed) CONTRIBUTION resource")
...
public class NewContribution {
  ...
  private List<UpdateVersion> versions = new ArrayList<UpdateVersion>();
