...
import io.swagger.client.model.DvIdentifier;
import io.swagger.client.model.PartyProxy;
import io.swagger.client.model.PartyRef;
...
public class PartyIdentified extends PartyProxy {
  ...
  private String partyIdentifiedType = "PARTY_IDENTIFIED";
  ...
  public PartyIdentified partyIdentifiedType(String partyIdentifiedType) {
    this.partyIdentifiedType = partyIdentifiedType;
    return this;
  }

   /**
   * Get partyIdentifiedType
   * @return partyIdentifiedType
  **/
  @Schema(description = "")
  public String getPartyIdentifiedType() {
    return partyIdentifiedType;
  }

  public void setPartyIdentifiedType(String partyIdentifiedType) {
    this.partyIdentifiedType = partyIdentifiedType;
  }
  ...
  **/
  ...
  public PartyIdentified addIdentifiersItem(DvIdentifier identifiersItem) {
    if (this.identifiers == null) {
      this.identifiers = new ArrayList<DvIdentifier>();
    }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.partyIdentifiedType, partyIdentified.partyIdentifiedType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(partyIdentifiedType, name, identifiers, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("    partyIdentifiedType: ").append(toIndentedString(partyIdentifiedType)).append("\n");
