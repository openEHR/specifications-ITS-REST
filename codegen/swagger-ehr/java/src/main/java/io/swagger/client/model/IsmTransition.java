...
public class IsmTransition extends Pathable {
  ...
  private String ismTransitionType = "ISM_TRANSITION";

  @SerializedName("current_state")
  private DvCodedText currentState = null;

  @SerializedName("transition")
  private DvCodedText transition = null;

  @SerializedName("careflow_step")
  private DvCodedText careflowStep = null;

  @SerializedName("reason")
  private List<DvText> reason = null;

  public IsmTransition ismTransitionType(String ismTransitionType) {
    this.ismTransitionType = ismTransitionType;
    return this;
  }

   /**
   * Get ismTransitionType
   * @return ismTransitionType
  **/
  @Schema(description = "")
  public String getIsmTransitionType() {
    return ismTransitionType;
  }

  public void setIsmTransitionType(String ismTransitionType) {
    this.ismTransitionType = ismTransitionType;
  }
  ...
  **/
  ...
  public IsmTransition addReasonItem(DvText reasonItem) {
    if (this.reason == null) {
      this.reason = new ArrayList<DvText>();
    }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.ismTransitionType, ismTransition.ismTransitionType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ismTransitionType, currentState, transition, careflowStep, reason, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("    ismTransitionType: ").append(toIndentedString(ismTransitionType)).append("\n");
