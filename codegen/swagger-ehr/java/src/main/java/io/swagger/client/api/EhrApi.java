...
import io.swagger.client.model.Ehr;
...
public class EhrApi {
    ...
    public EhrApi(ApiClient apiClient) {
    ...
    /**
     * Build call for ehrCreate
     * @param body An EHR_STATUS resource MAY be also supplied by the client as the request body.
 (optional)
     ...
     */
    public com.squareup.okhttp.Call ehrCreateCall(EhrStatus body, String prefer, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/ehr";
    ...
    private com.squareup.okhttp.Call ehrCreateValidateBeforeCall(EhrStatus body, String prefer, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = ehrCreateCall(body, prefer, progressListener, progressRequestListener);
        return call;
 ...
 (optional)
     ...
     */
    public Ehr ehrCreate(EhrStatus body, String prefer) throws ApiException {
        ApiResponse<Ehr> resp = ehrCreateWithHttpInfo(body, prefer);
        return resp.getData();
    }
 ...
 (optional)
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Ehr> ehrCreateWithHttpInfo(EhrStatus body, String prefer) throws ApiException {
        com.squareup.okhttp.Call call = ehrCreateValidateBeforeCall(body, prefer, null, null);
        Type localVarReturnType = new TypeToken<Ehr>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Create EHR (asynchronously)
     * Create a new &#x60;EHR&#x60; with an auto-generated identifier.  An EHR_STATUS resource needs to be always created and committed in the new EHR. This resource MAY be also supplied by the client as the request body.  If not supplied, a default EHR_STATUS will be used by the service with following attributes:   - &#x60;is_queryable&#x60;: true   - &#x60;is_modifiable&#x60;: true   - &#x60;subject&#x60;: a PARTY_SELF object  All other required EHR attributes and resources will be automatically created as needed by the [EHR creation semantics](https://specifications.openehr.org/releases/RM/latest/ehr.html#_ehr_creation_semantics). 
     * @param body An EHR_STATUS resource MAY be also supplied by the client as the request body.
 (optional)
     * @param prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;.  (optional, default to return=minimal)
     ...
     */
    public com.squareup.okhttp.Call ehrCreateAsync(EhrStatus body, String prefer, final ApiCallback<Ehr> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = ehrCreateValidateBeforeCall(body, prefer, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Ehr>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for ehrCreateWithId
 ...
 (optional)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call ehrCreateWithIdCall(String ehrId, EhrStatus body, String prefer, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/ehr/{ehr_id}"
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call ehrCreateWithIdValidateBeforeCall(String ehrId, EhrStatus body, String prefer, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'ehrId' is set
        if (ehrId == null) {
            throw new ApiException("Missing the required parameter 'ehrId' when calling ehrCreateWithId(Async)");
        }
        
        com.squareup.okhttp.Call call = ehrCreateWithIdCall(ehrId, body, prefer, progressListener, progressRequestListener);
        return call;
 ...
 (optional)
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Ehr ehrCreateWithId(String ehrId, EhrStatus body, String prefer) throws ApiException {
        ApiResponse<Ehr> resp = ehrCreateWithIdWithHttpInfo(ehrId, body, prefer);
        return resp.getData();
    }
 ...
 (optional)
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Ehr> ehrCreateWithIdWithHttpInfo(String ehrId, EhrStatus body, String prefer) throws ApiException {
        com.squareup.okhttp.Call call = ehrCreateWithIdValidateBeforeCall(ehrId, body, prefer, null, null);
        Type localVarReturnType = new TypeToken<Ehr>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Create EHR with id (asynchronously)
     * Create a new EHR with the specified &#x60;ehr_id&#x60; identifier.  The value of the &#x60;ehr_id&#x60; unique identifier MUST be valid [HIER_OBJECT_ID](https://specifications.openehr.org/releases/BASE/latest/base_types.html#_hier_object_id_class) value.  It is strongly RECOMMENDED that an UUID always be used for this.  An EHR_STATUS resource needs to be always created and committed in the new EHR. This resource MAY be also supplied by the client as the request body.  If not supplied, a default EHR_STATUS will be used by the service with following attributes:   - &#x60;is_queryable&#x60;: true   - &#x60;is_modifiable&#x60;: true   - &#x60;subject&#x60;: a PARTY_SELF object  All other required EHR attributes and resources will be automatically created as needed by the [EHR creation semantics](https://specifications.openehr.org/releases/RM/latest/ehr.html#_ehr_creation_semantics). 
     * @param ehrId EHR identifier taken from EHR.ehr_id.value.  (required)
     * @param body An EHR_STATUS resource MAY be also supplied by the client as the request body.
 (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call ehrCreateWithIdAsync(String ehrId, EhrStatus body, String prefer, final ApiCallback<Ehr> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = ehrCreateWithIdValidateBeforeCall(ehrId, body, prefer, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Ehr>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for ehrGetById
     * @param ehrId EHR identifier taken from EHR.ehr_id.value.  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call ehrGetByIdCall(String ehrId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call ehrGetByIdValidateBeforeCall(String ehrId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'ehrId' is set
        if (ehrId == null) {
            throw new ApiException("Missing the required parameter 'ehrId' when calling ehrGetById(Async)");
        }
        
        com.squareup.okhttp.Call call = ehrGetByIdCall(ehrId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Ehr ehrGetById(String ehrId) throws ApiException {
        ApiResponse<Ehr> resp = ehrGetByIdWithHttpInfo(ehrId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Ehr> ehrGetByIdWithHttpInfo(String ehrId) throws ApiException {
        com.squareup.okhttp.Call call = ehrGetByIdValidateBeforeCall(ehrId, null, null);
        Type localVarReturnType = new TypeToken<Ehr>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get EHR by id (asynchronously)
     * Retrieve the EHR with the specified &#x60;ehr_id&#x60;. 
     * @param ehrId EHR identifier taken from EHR.ehr_id.value.  (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call ehrGetByIdAsync(String ehrId, final ApiCallback<Ehr> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = ehrGetByIdValidateBeforeCall(ehrId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Ehr>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for ehrGetBySubject
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call ehrGetBySubjectCall(String subjectId, String subjectNamespace, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        localVarQueryParams.addAll(apiClient.parameterToPair("subject_namespace", subjectNamespace));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call ehrGetBySubjectValidateBeforeCall(String subjectId, String subjectNamespace, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'subjectId' is set
        if (subjectId == null) {
            throw new ApiException("Missing the required parameter 'subjectId' when calling ehrGetBySubject(Async)");
        }
        // verify the required parameter 'subjectNamespace' is set
        if (subjectNamespace == null) {
            throw new ApiException("Missing the required parameter 'subjectNamespace' when calling ehrGetBySubject(Async)");
        }
        
        com.squareup.okhttp.Call call = ehrGetBySubjectCall(subjectId, subjectNamespace, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Ehr ehrGetBySubject(String subjectId, String subjectNamespace) throws ApiException {
        ApiResponse<Ehr> resp = ehrGetBySubjectWithHttpInfo(subjectId, subjectNamespace);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Ehr> ehrGetBySubjectWithHttpInfo(String subjectId, String subjectNamespace) throws ApiException {
        com.squareup.okhttp.Call call = ehrGetBySubjectValidateBeforeCall(subjectId, subjectNamespace, null, null);
        Type localVarReturnType = new TypeToken<Ehr>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get EHR by subject id (asynchronously)
     * Retrieve the EHR with the specified &#x60;subject_id&#x60; and &#x60;subject_namespace&#x60;.  These subject parameters will be matched against EHR&#x27;s EHR_STATUS.subject.external_ref.id.value and  EHR_STATUS.subject.external_ref.namespace values. 
     * @param subjectId The EHR subject id.  (required)
     * @param subjectNamespace The EHR subject id namespace.  (required)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call ehrGetBySubjectAsync(String subjectId, String subjectNamespace, final ApiCallback<Ehr> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = ehrGetBySubjectValidateBeforeCall(subjectId, subjectNamespace, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Ehr>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
