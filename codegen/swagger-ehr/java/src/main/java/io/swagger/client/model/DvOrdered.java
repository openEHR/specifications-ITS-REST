...
public class DvOrdered extends DataValue {
  ...
  private String dvOrderedType = "DV_ORDERED";
  ...
  public DvOrdered dvOrderedType(String dvOrderedType) {
    this.dvOrderedType = dvOrderedType;
    return this;
  }

   /**
   * Get dvOrderedType
   * @return dvOrderedType
  **/
  @Schema(description = "")
  public String getDvOrderedType() {
    return dvOrderedType;
  }

  public void setDvOrderedType(String dvOrderedType) {
    this.dvOrderedType = dvOrderedType;
  }
  ...
  **/
  ...
  public DvOrdered addOtherReferenceRangesItem(ReferenceRange otherReferenceRangesItem) {
    if (this.otherReferenceRanges == null) {
      this.otherReferenceRanges = new ArrayList<ReferenceRange>();
    }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.dvOrderedType, dvOrdered.dvOrderedType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dvOrderedType, normalStatus, normalRange, otherReferenceRanges, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("    dvOrderedType: ").append(toIndentedString(dvOrderedType)).append("\n");
