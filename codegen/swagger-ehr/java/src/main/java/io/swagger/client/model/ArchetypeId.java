...
public class ArchetypeId extends ObjectId {
  ...
  private String archetypeIdType = "ARCHETYPE_ID";

  public ArchetypeId archetypeIdType(String archetypeIdType) {
    this.archetypeIdType = archetypeIdType;
    return this;
  }

   /**
   * Get archetypeIdType
   * @return archetypeIdType
  **/
  @Schema(description = "")
  public String getArchetypeIdType() {
    return archetypeIdType;
  }

  public void setArchetypeIdType(String archetypeIdType) {
    this.archetypeIdType = archetypeIdType;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.archetypeIdType, archetypeId.archetypeIdType) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(archetypeIdType, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("    archetypeIdType: ").append(toIndentedString(archetypeIdType)).append("\n");
    sb.append("}");
    return sb.toString();
  }
