...
public class UidBasedId extends ObjectId {
  ...
  private String uidBasedIdType = "UID_BASED_ID";

  public UidBasedId() {
    this._type = this.getClass().getSimpleName();
  }
  public UidBasedId uidBasedIdType(String uidBasedIdType) {
    this.uidBasedIdType = uidBasedIdType;
    return this;
  }

   /**
   * Get uidBasedIdType
   * @return uidBasedIdType
  **/
  @Schema(description = "")
  public String getUidBasedIdType() {
    return uidBasedIdType;
  }

  public void setUidBasedIdType(String uidBasedIdType) {
    this.uidBasedIdType = uidBasedIdType;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.uidBasedIdType, uidBasedId.uidBasedIdType) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(uidBasedIdType, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("    uidBasedIdType: ").append(toIndentedString(uidBasedIdType)).append("\n");
    sb.append("}");
    return sb.toString();
  }
