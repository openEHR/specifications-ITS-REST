...
import io.swagger.client.model.DvEhrUri;
import io.swagger.client.model.DvMultimedia;
import io.swagger.client.model.DvText;
import io.swagger.client.model.PartyProxy;
import io.swagger.client.model.TerminologyCode;
import io.swagger.client.model.UpdateAudit;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2022-11-16T20:40:41.299Z[GMT]")
public class UpdateAttestation extends UpdateAudit {
  @SerializedName("_type")
  private String updateAttestationType = "UPDATE_ATTESTATION";
  ...
  public UpdateAttestation updateAttestationType(String updateAttestationType) {
    this.updateAttestationType = updateAttestationType;
    return this;
  }

   /**
   * Get updateAttestationType
   * @return updateAttestationType
  **/
  @Schema(description = "")
  public String getUpdateAttestationType() {
    return updateAttestationType;
  }

  public void setUpdateAttestationType(String updateAttestationType) {
    this.updateAttestationType = updateAttestationType;
  }
  ...
  **/
  ...
  public UpdateAttestation addItemsItem(DvEhrUri itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<DvEhrUri>();
    }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.updateAttestationType, updateAttestation.updateAttestationType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(updateAttestationType, attestedView, proof, items, reason, isPending, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("    updateAttestationType: ").append(toIndentedString(updateAttestationType)).append("\n");
