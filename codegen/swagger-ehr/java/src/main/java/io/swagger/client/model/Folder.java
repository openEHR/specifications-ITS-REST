 ...
 * A FOLDER resource
 */
@Schema(description = "A FOLDER resource")
...
public class Folder extends Locatable {
  ...
  private ItemStructure details = null;
  ...
  **/
  ...
  public Folder addItemsItem(ObjectRef itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<ObjectRef>();
    }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.folderType, folder.folderType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(folderType, items, folders, details, super.hashCode());
  }
