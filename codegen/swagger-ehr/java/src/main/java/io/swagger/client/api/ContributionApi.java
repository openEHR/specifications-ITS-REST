...
import io.swagger.client.model.NewContribution;
...
public class ContributionApi {
 ...
 (required)
     ...
     */
    public com.squareup.okhttp.Call contributionCreateCall(NewContribution body, String ehrId, String prefer, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call contributionCreateValidateBeforeCall(NewContribution body, String ehrId, String prefer, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling contributionCreate(Async)");
        }
        ...
        com.squareup.okhttp.Call call = contributionCreateCall(body, ehrId, prefer, progressListener, progressRequestListener);
        return call;
 ...
 (required)
     ...
     */
    public Contribution contributionCreate(NewContribution body, String ehrId, String prefer) throws ApiException {
        ApiResponse<Contribution> resp = contributionCreateWithHttpInfo(body, ehrId, prefer);
        return resp.getData();
    }
 ...
 (required)
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Contribution> contributionCreateWithHttpInfo(NewContribution body, String ehrId, String prefer) throws ApiException {
        com.squareup.okhttp.Call call = contributionCreateValidateBeforeCall(body, ehrId, prefer, null, null);
 ...
 (required)
     ...
     */
    public com.squareup.okhttp.Call contributionCreateAsync(NewContribution body, String ehrId, String prefer, final ApiCallback<Contribution> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = contributionCreateValidateBeforeCall(body, ehrId, prefer, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Contribution>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call contributionGetCall(String ehrId, String contributionUid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/ehr/{ehr_id}/contribution/{contribution_uid}"
            .replaceAll("\\{" + "ehr_id" + "\\}", apiClient.escapeString(ehrId.toString()))
            .replaceAll("\\{" + "contribution_uid" + "\\}", apiClient.escapeString(contributionUid.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call contributionGetValidateBeforeCall(String ehrId, String contributionUid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'ehrId' is set
        if (ehrId == null) {
        ...
        com.squareup.okhttp.Call call = contributionGetCall(ehrId, contributionUid, progressListener, progressRequestListener);
        return call;
    ...
    public Contribution contributionGet(String ehrId, String contributionUid) throws ApiException {
        ApiResponse<Contribution> resp = contributionGetWithHttpInfo(ehrId, contributionUid);
        return resp.getData();
    }
    ...
    public ApiResponse<Contribution> contributionGetWithHttpInfo(String ehrId, String contributionUid) throws ApiException {
        com.squareup.okhttp.Call call = contributionGetValidateBeforeCall(ehrId, contributionUid, null, null);
        Type localVarReturnType = new TypeToken<Contribution>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call contributionGetAsync(String ehrId, String contributionUid, final ApiCallback<Contribution> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = contributionGetValidateBeforeCall(ehrId, contributionUid, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Contribution>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
