...
import io.swagger.client.model.RevisionHistoryItem;
 ...
 */
@Schema(description = "A REVISION_HISTORY resource")
...
public class RevisionHistory {
  ...
  private List<RevisionHistoryItem> items = new ArrayList<RevisionHistoryItem>();
