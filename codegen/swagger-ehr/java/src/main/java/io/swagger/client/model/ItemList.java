...
public class ItemList extends ItemStructure {
  ...
  private String itemListType = "ITEM_LIST";

  @SerializedName("items")
  private List<Element> items = null;

  public ItemList itemListType(String itemListType) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.itemListType, itemList.itemListType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(itemListType, items, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("    itemListType: ").append(toIndentedString(itemListType)).append("\n");
