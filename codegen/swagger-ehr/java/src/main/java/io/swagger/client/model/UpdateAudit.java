 ...
 */
@Schema(description = "The set of attributes required to document the committal of an information item to a repository. Used by the server to create an AUDIT_DETAILS object.")
...
public class UpdateAudit {
  ...
  private String _type = "UPDATE_AUDIT";
  ...
  public UpdateAudit _type(String _type) {
    this._type = _type;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this._type, updateAudit._type) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(_type, changeType, description, committer);
  }
