...
public class Clstr extends Item {
  ...
  private String clstrType = "CLUSTER";

  @SerializedName("items")
  private List<Item> items = new ArrayList<Item>();

  public Clstr clstrType(String clstrType) {
    this.clstrType = clstrType;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public String getClstrType() {
    return clstrType;
  }

  public void setClstrType(String clstrType) {
    this.clstrType = clstrType;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Clstr clstr = (Clstr) o;
    return Objects.equals(this.clstrType, clstr.clstrType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clstrType, items, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("    clstrType: ").append(toIndentedString(clstrType)).append("\n");
