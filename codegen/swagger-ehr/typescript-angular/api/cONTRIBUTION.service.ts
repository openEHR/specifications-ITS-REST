...
export class CONTRIBUTIONService {
     ...
     */
    public contributionCreate(body: NewContribution, ehrId: string, prefer?: string, observe?: 'body', reportProgress?: boolean): Observable<Contribution>;
    public contributionCreate(body: NewContribution, ehrId: string, prefer?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Contribution>>;
    public contributionCreate(body: NewContribution, ehrId: string, prefer?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Contribution>>;
    public contributionCreate(body: NewContribution, ehrId: string, prefer?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling contributionCreate.');
        }

        if (ehrId === null || ehrId === undefined) {
            throw new Error('Required parameter ehrId was null or undefined when calling contributionCreate.');
        }
        ...
        return this.httpClient.request<Contribution>('post',`${this.basePath}/ehr/${encodeURIComponent(String(ehrId))}/contribution`,
            {
                body: body,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public contributionGet(ehrId: string, contributionUid: string, observe?: 'body', reportProgress?: boolean): Observable<Contribution>;
    public contributionGet(ehrId: string, contributionUid: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Contribution>>;
    public contributionGet(ehrId: string, contributionUid: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Contribution>>;
    public contributionGet(ehrId: string, contributionUid: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (ehrId === null || ehrId === undefined) {
            throw new Error('Required parameter ehrId was null or undefined when calling contributionGet.');
        }

        if (contributionUid === null || contributionUid === undefined) {
            throw new Error('Required parameter contributionUid was null or undefined when calling contributionGet.');
        }
        ...
        return this.httpClient.request<Contribution>('get',`${this.basePath}/ehr/${encodeURIComponent(String(ehrId))}/contribution/${encodeURIComponent(String(contributionUid))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
