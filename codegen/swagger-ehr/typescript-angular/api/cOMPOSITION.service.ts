...
export class COMPOSITIONService {
    ...
    protected basePath = 'https://{baseUrl}/v1';
     ...
     */
    public compositionCreate(body: Composition, ehrId: string, prefer?: string, observe?: 'body', reportProgress?: boolean): Observable<Composition>;
    public compositionCreate(body: Composition, ehrId: string, prefer?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Composition>>;
    public compositionCreate(body: Composition, ehrId: string, prefer?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Composition>>;
    public compositionCreate(body: Composition, ehrId: string, prefer?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling compositionCreate.');
        }

        if (ehrId === null || ehrId === undefined) {
            throw new Error('Required parameter ehrId was null or undefined when calling compositionCreate.');
        }
        ...
        return this.httpClient.request<Composition>('post',`${this.basePath}/ehr/${encodeURIComponent(String(ehrId))}/composition`,
            {
                body: body,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public compositionDelete(ehrId: string, uidBasedId: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public compositionDelete(ehrId: string, uidBasedId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public compositionDelete(ehrId: string, uidBasedId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public compositionDelete(ehrId: string, uidBasedId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (ehrId === null || ehrId === undefined) {
            throw new Error('Required parameter ehrId was null or undefined when calling compositionDelete.');
        }

        if (uidBasedId === null || uidBasedId === undefined) {
            throw new Error('Required parameter uidBasedId was null or undefined when calling compositionDelete.');
        }
        ...
        return this.httpClient.request<any>('delete',`${this.basePath}/ehr/${encodeURIComponent(String(ehrId))}/composition/${encodeURIComponent(String(uidBasedId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public compositionGet(ehrId: string, uidBasedId: string, versionAtTime?: string, observe?: 'body', reportProgress?: boolean): Observable<Composition>;
    public compositionGet(ehrId: string, uidBasedId: string, versionAtTime?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Composition>>;
    public compositionGet(ehrId: string, uidBasedId: string, versionAtTime?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Composition>>;
    public compositionGet(ehrId: string, uidBasedId: string, versionAtTime?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (ehrId === null || ehrId === undefined) {
            throw new Error('Required parameter ehrId was null or undefined when calling compositionGet.');
        }

        if (uidBasedId === null || uidBasedId === undefined) {
            throw new Error('Required parameter uidBasedId was null or undefined when calling compositionGet.');
        }


        let queryParameters = new HttpParams({encoder: new CustomHttpUrlEncodingCodec()});
        if (versionAtTime !== undefined && versionAtTime !== null) {
            queryParameters = queryParameters.set('version_at_time', <any>versionAtTime);
        }
        ...
        return this.httpClient.request<Composition>('get',`${this.basePath}/ehr/${encodeURIComponent(String(ehrId))}/composition/${encodeURIComponent(String(uidBasedId))}`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public compositionUpdate(body: Composition, ifMatch: string, ehrId: string, uidBasedId: string, prefer?: string, observe?: 'body', reportProgress?: boolean): Observable<Composition>;
    public compositionUpdate(body: Composition, ifMatch: string, ehrId: string, uidBasedId: string, prefer?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Composition>>;
    public compositionUpdate(body: Composition, ifMatch: string, ehrId: string, uidBasedId: string, prefer?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Composition>>;
    public compositionUpdate(body: Composition, ifMatch: string, ehrId: string, uidBasedId: string, prefer?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling compositionUpdate.');
        }

        if (ifMatch === null || ifMatch === undefined) {
            throw new Error('Required parameter ifMatch was null or undefined when calling compositionUpdate.');
        }

        if (ehrId === null || ehrId === undefined) {
            throw new Error('Required parameter ehrId was null or undefined when calling compositionUpdate.');
        }

        if (uidBasedId === null || uidBasedId === undefined) {
            throw new Error('Required parameter uidBasedId was null or undefined when calling compositionUpdate.');
        }
        ...
        return this.httpClient.request<Composition>('put',`${this.basePath}/ehr/${encodeURIComponent(String(ehrId))}/composition/${encodeURIComponent(String(uidBasedId))}`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public versionedCompositionGet(ehrId: string, versionedObjectUid: string, observe?: 'body', reportProgress?: boolean): Observable<VersionedComposition>;
    public versionedCompositionGet(ehrId: string, versionedObjectUid: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<VersionedComposition>>;
    public versionedCompositionGet(ehrId: string, versionedObjectUid: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<VersionedComposition>>;
    public versionedCompositionGet(ehrId: string, versionedObjectUid: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (ehrId === null || ehrId === undefined) {
            throw new Error('Required parameter ehrId was null or undefined when calling versionedCompositionGet.');
        }

        if (versionedObjectUid === null || versionedObjectUid === undefined) {
            throw new Error('Required parameter versionedObjectUid was null or undefined when calling versionedCompositionGet.');
        }
        ...
        return this.httpClient.request<VersionedComposition>('get',`${this.basePath}/ehr/${encodeURIComponent(String(ehrId))}/versioned_composition/${encodeURIComponent(String(versionedObjectUid))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public versionedCompositionRevisionHistory(ehrId: string, versionedObjectUid: string, observe?: 'body', reportProgress?: boolean): Observable<RevisionHistory>;
    public versionedCompositionRevisionHistory(ehrId: string, versionedObjectUid: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<RevisionHistory>>;
    public versionedCompositionRevisionHistory(ehrId: string, versionedObjectUid: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<RevisionHistory>>;
    public versionedCompositionRevisionHistory(ehrId: string, versionedObjectUid: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (ehrId === null || ehrId === undefined) {
            throw new Error('Required parameter ehrId was null or undefined when calling versionedCompositionRevisionHistory.');
        }

        if (versionedObjectUid === null || versionedObjectUid === undefined) {
            throw new Error('Required parameter versionedObjectUid was null or undefined when calling versionedCompositionRevisionHistory.');
        }
        ...
        return this.httpClient.request<RevisionHistory>('get',`${this.basePath}/ehr/${encodeURIComponent(String(ehrId))}/versioned_composition/${encodeURIComponent(String(versionedObjectUid))}/revision_history`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public versionedCompositionVersionGetAtTime(ehrId: string, versionedObjectUid: string, versionAtTime?: string, observe?: 'body', reportProgress?: boolean): Observable<Version>;
    public versionedCompositionVersionGetAtTime(ehrId: string, versionedObjectUid: string, versionAtTime?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Version>>;
    public versionedCompositionVersionGetAtTime(ehrId: string, versionedObjectUid: string, versionAtTime?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Version>>;
    public versionedCompositionVersionGetAtTime(ehrId: string, versionedObjectUid: string, versionAtTime?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (ehrId === null || ehrId === undefined) {
            throw new Error('Required parameter ehrId was null or undefined when calling versionedCompositionVersionGetAtTime.');
        }

        if (versionedObjectUid === null || versionedObjectUid === undefined) {
            throw new Error('Required parameter versionedObjectUid was null or undefined when calling versionedCompositionVersionGetAtTime.');
        }
        ...
        return this.httpClient.request<Version>('get',`${this.basePath}/ehr/${encodeURIComponent(String(ehrId))}/versioned_composition/${encodeURIComponent(String(versionedObjectUid))}/version`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public versionedCompositionVersionGetById(ehrId: string, versionedObjectUid: string, versionUid: string, observe?: 'body', reportProgress?: boolean): Observable<Version>;
    public versionedCompositionVersionGetById(ehrId: string, versionedObjectUid: string, versionUid: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Version>>;
    public versionedCompositionVersionGetById(ehrId: string, versionedObjectUid: string, versionUid: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Version>>;
    public versionedCompositionVersionGetById(ehrId: string, versionedObjectUid: string, versionUid: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (ehrId === null || ehrId === undefined) {
            throw new Error('Required parameter ehrId was null or undefined when calling versionedCompositionVersionGetById.');
        }

        if (versionedObjectUid === null || versionedObjectUid === undefined) {
            throw new Error('Required parameter versionedObjectUid was null or undefined when calling versionedCompositionVersionGetById.');
        }

        if (versionUid === null || versionUid === undefined) {
            throw new Error('Required parameter versionUid was null or undefined when calling versionedCompositionVersionGetById.');
        }
        ...
        return this.httpClient.request<Version>('get',`${this.basePath}/ehr/${encodeURIComponent(String(ehrId))}/versioned_composition/${encodeURIComponent(String(versionedObjectUid))}/version/${encodeURIComponent(String(versionUid))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
