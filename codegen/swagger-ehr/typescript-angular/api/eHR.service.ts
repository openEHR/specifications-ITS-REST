...
export class EHRService {
     ...
     */
    public ehrCreate(body?: EhrStatus, prefer?: string, observe?: 'body', reportProgress?: boolean): Observable<Ehr>;
    public ehrCreate(body?: EhrStatus, prefer?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Ehr>>;
    public ehrCreate(body?: EhrStatus, prefer?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Ehr>>;
    public ehrCreate(body?: EhrStatus, prefer?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Ehr>('post',`${this.basePath}/ehr`,
            {
                body: body,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public ehrCreateWithId(ehrId: string, body?: EhrStatus, prefer?: string, observe?: 'body', reportProgress?: boolean): Observable<Ehr>;
    public ehrCreateWithId(ehrId: string, body?: EhrStatus, prefer?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Ehr>>;
    public ehrCreateWithId(ehrId: string, body?: EhrStatus, prefer?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Ehr>>;
    public ehrCreateWithId(ehrId: string, body?: EhrStatus, prefer?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (ehrId === null || ehrId === undefined) {
            throw new Error('Required parameter ehrId was null or undefined when calling ehrCreateWithId.');
        }
        ...
        return this.httpClient.request<Ehr>('put',`${this.basePath}/ehr/${encodeURIComponent(String(ehrId))}`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public ehrGetById(ehrId: string, observe?: 'body', reportProgress?: boolean): Observable<Ehr>;
    public ehrGetById(ehrId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Ehr>>;
    public ehrGetById(ehrId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Ehr>>;
    public ehrGetById(ehrId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (ehrId === null || ehrId === undefined) {
            throw new Error('Required parameter ehrId was null or undefined when calling ehrGetById.');
        }
        ...
        return this.httpClient.request<Ehr>('get',`${this.basePath}/ehr/${encodeURIComponent(String(ehrId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public ehrGetBySubject(subjectId: string, subjectNamespace: string, observe?: 'body', reportProgress?: boolean): Observable<Ehr>;
    public ehrGetBySubject(subjectId: string, subjectNamespace: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Ehr>>;
    public ehrGetBySubject(subjectId: string, subjectNamespace: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Ehr>>;
    public ehrGetBySubject(subjectId: string, subjectNamespace: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (subjectId === null || subjectId === undefined) {
            throw new Error('Required parameter subjectId was null or undefined when calling ehrGetBySubject.');
        }

        if (subjectNamespace === null || subjectNamespace === undefined) {
            throw new Error('Required parameter subjectNamespace was null or undefined when calling ehrGetBySubject.');
        }
        ...
        if (subjectNamespace !== undefined && subjectNamespace !== null) {
            queryParameters = queryParameters.set('subject_namespace', <any>subjectNamespace);
        }
        ...
        return this.httpClient.request<Ehr>('get',`${this.basePath}/ehr`,
            {
