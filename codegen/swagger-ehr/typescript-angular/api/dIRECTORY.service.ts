...
export class DIRECTORYService {
     ...
     */
    public directoryCreate(body: Folder, ehrId: string, prefer?: string, observe?: 'body', reportProgress?: boolean): Observable<Folder>;
    public directoryCreate(body: Folder, ehrId: string, prefer?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Folder>>;
    public directoryCreate(body: Folder, ehrId: string, prefer?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Folder>>;
    public directoryCreate(body: Folder, ehrId: string, prefer?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling directoryCreate.');
        }

        if (ehrId === null || ehrId === undefined) {
            throw new Error('Required parameter ehrId was null or undefined when calling directoryCreate.');
        }
        ...
        return this.httpClient.request<Folder>('post',`${this.basePath}/ehr/${encodeURIComponent(String(ehrId))}/directory`,
            {
                body: body,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public directoryDelete(ehrId: string, ifMatch: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public directoryDelete(ehrId: string, ifMatch: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public directoryDelete(ehrId: string, ifMatch: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public directoryDelete(ehrId: string, ifMatch: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (ehrId === null || ehrId === undefined) {
            throw new Error('Required parameter ehrId was null or undefined when calling directoryDelete.');
        }

        if (ifMatch === null || ifMatch === undefined) {
            throw new Error('Required parameter ifMatch was null or undefined when calling directoryDelete.');
        }
        ...
        return this.httpClient.request<any>('delete',`${this.basePath}/ehr/${encodeURIComponent(String(ehrId))}/directory`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public directoryGetAtTime(ehrId: string, versionAtTime?: string, path?: string, observe?: 'body', reportProgress?: boolean): Observable<Folder>;
    public directoryGetAtTime(ehrId: string, versionAtTime?: string, path?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Folder>>;
    public directoryGetAtTime(ehrId: string, versionAtTime?: string, path?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Folder>>;
    public directoryGetAtTime(ehrId: string, versionAtTime?: string, path?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (ehrId === null || ehrId === undefined) {
            throw new Error('Required parameter ehrId was null or undefined when calling directoryGetAtTime.');
        }
        ...
        return this.httpClient.request<Folder>('get',`${this.basePath}/ehr/${encodeURIComponent(String(ehrId))}/directory`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public directoryGetByVersionId(ehrId: string, versionUid: string, path?: string, observe?: 'body', reportProgress?: boolean): Observable<Folder>;
    public directoryGetByVersionId(ehrId: string, versionUid: string, path?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Folder>>;
    public directoryGetByVersionId(ehrId: string, versionUid: string, path?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Folder>>;
    public directoryGetByVersionId(ehrId: string, versionUid: string, path?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (ehrId === null || ehrId === undefined) {
            throw new Error('Required parameter ehrId was null or undefined when calling directoryGetByVersionId.');
        }

        if (versionUid === null || versionUid === undefined) {
            throw new Error('Required parameter versionUid was null or undefined when calling directoryGetByVersionId.');
        }
        ...
        return this.httpClient.request<Folder>('get',`${this.basePath}/ehr/${encodeURIComponent(String(ehrId))}/directory/${encodeURIComponent(String(versionUid))}`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public directoryUpdate(body: Folder, ifMatch: string, ehrId: string, prefer?: string, observe?: 'body', reportProgress?: boolean): Observable<Folder>;
    public directoryUpdate(body: Folder, ifMatch: string, ehrId: string, prefer?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Folder>>;
    public directoryUpdate(body: Folder, ifMatch: string, ehrId: string, prefer?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Folder>>;
    public directoryUpdate(body: Folder, ifMatch: string, ehrId: string, prefer?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling directoryUpdate.');
        }

        if (ifMatch === null || ifMatch === undefined) {
            throw new Error('Required parameter ifMatch was null or undefined when calling directoryUpdate.');
        }

        if (ehrId === null || ehrId === undefined) {
            throw new Error('Required parameter ehrId was null or undefined when calling directoryUpdate.');
        }
        ...
        return this.httpClient.request<Folder>('put',`${this.basePath}/ehr/${encodeURIComponent(String(ehrId))}/directory`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
