...
export class EHRApi {
    ...
    */
     ...
     * @callback moduleapi/EHRApi~ehrCreateCallback
     ...
     * @param {module:model/EhrStatus} opts.body An EHR_STATUS resource MAY be also supplied by the client as the request body.
     ...
     * @callback moduleapi/EHRApi~ehrCreateWithIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Ehr{ data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    ehrCreateWithId(ehrId, opts, callback) {
      opts = opts || {};
      let postBody = opts['body'];
      // verify the required parameter 'ehrId' is set
      if (ehrId === undefined || ehrId === null) {
        throw new Error("Missing the required parameter 'ehrId' when calling ehrCreateWithId");
      }
     ...
     * @callback moduleapi/EHRApi~ehrGetByIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Ehr{ data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    ehrGetById(ehrId, callback) {
      
      let postBody = null;
      // verify the required parameter 'ehrId' is set
      if (ehrId === undefined || ehrId === null) {
        throw new Error("Missing the required parameter 'ehrId' when calling ehrGetById");
      }
     ...
     * @callback moduleapi/EHRApi~ehrGetBySubjectCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Ehr{ data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    ehrGetBySubject(subjectId, subjectNamespace, callback) {
      
      let postBody = null;
      // verify the required parameter 'subjectId' is set
      if (subjectId === undefined || subjectId === null) {
        throw new Error("Missing the required parameter 'subjectId' when calling ehrGetBySubject");
      }
      // verify the required parameter 'subjectNamespace' is set
      if (subjectNamespace === undefined || subjectNamespace === null) {
        throw new Error("Missing the required parameter 'subjectNamespace' when calling ehrGetBySubject");
      }
      ...
      let queryParams = {
        'subject_id': subjectId,'subject_namespace': subjectNamespace
      };
      let headerParams = {
