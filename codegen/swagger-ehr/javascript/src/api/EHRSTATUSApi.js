...
export class EHRSTATUSApi {
    ...
    */
     ...
     * @callback moduleapi/EHRSTATUSApi~ehrStatusGetAtTimeCallback
     ...
     */
    ehrStatusGetAtTime(ehrId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'ehrId' is set
      if (ehrId === undefined || ehrId === null) {
        throw new Error("Missing the required parameter 'ehrId' when calling ehrStatusGetAtTime");
      }
     ...
     * @callback moduleapi/EHRSTATUSApi~ehrStatusGetByVersionIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/EhrStatus{ data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    ehrStatusGetByVersionId(ehrId, versionUid, callback) {
      
      let postBody = null;
      // verify the required parameter 'ehrId' is set
      if (ehrId === undefined || ehrId === null) {
        throw new Error("Missing the required parameter 'ehrId' when calling ehrStatusGetByVersionId");
      }
      // verify the required parameter 'versionUid' is set
      if (versionUid === undefined || versionUid === null) {
        throw new Error("Missing the required parameter 'versionUid' when calling ehrStatusGetByVersionId");
      }

      let pathParams = {
        'ehr_id': ehrId,'version_uid': versionUid
      };
      let queryParams = {
     ...
     * @callback moduleapi/EHRSTATUSApi~ehrStatusUpdateCallback
     * @param {String} error Error message, if any.
     * @param {module:model/EhrStatus{ data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/EhrStatus} body The new EHR_STATUS.
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    ehrStatusUpdate(body, ehrId, ifMatch, opts, callback) {
      opts = opts || {};
      let postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling ehrStatusUpdate");
      }
      // verify the required parameter 'ehrId' is set
      if (ehrId === undefined || ehrId === null) {
        throw new Error("Missing the required parameter 'ehrId' when calling ehrStatusUpdate");
      }
      // verify the required parameter 'ifMatch' is set
      if (ifMatch === undefined || ifMatch === null) {
        throw new Error("Missing the required parameter 'ifMatch' when calling ehrStatusUpdate");
      }
     ...
     * @callback moduleapi/EHRSTATUSApi~versionedEhrStatusGetCallback
     * @param {String} error Error message, if any.
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    versionedEhrStatusGet(ehrId, callback) {
      
      let postBody = null;
      // verify the required parameter 'ehrId' is set
      if (ehrId === undefined || ehrId === null) {
        throw new Error("Missing the required parameter 'ehrId' when calling versionedEhrStatusGet");
      }
     ...
     * @callback moduleapi/EHRSTATUSApi~versionedEhrStatusRevisionHistoryCallback
     * @param {String} error Error message, if any.
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    versionedEhrStatusRevisionHistory(ehrId, callback) {
      
      let postBody = null;
      // verify the required parameter 'ehrId' is set
      if (ehrId === undefined || ehrId === null) {
        throw new Error("Missing the required parameter 'ehrId' when calling versionedEhrStatusRevisionHistory");
      }
     ...
     * @callback moduleapi/EHRSTATUSApi~versionedEhrStatusVersionGetAtTimeCallback
     * @param {String} error Error message, if any.
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    versionedEhrStatusVersionGetAtTime(ehrId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'ehrId' is set
      if (ehrId === undefined || ehrId === null) {
        throw new Error("Missing the required parameter 'ehrId' when calling versionedEhrStatusVersionGetAtTime");
      }
     ...
     * @callback moduleapi/EHRSTATUSApi~versionedEhrStatusVersionGetByIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Version{ data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    versionedEhrStatusVersionGetById(ehrId, versionUid, callback) {
      
      let postBody = null;
      // verify the required parameter 'ehrId' is set
      if (ehrId === undefined || ehrId === null) {
        throw new Error("Missing the required parameter 'ehrId' when calling versionedEhrStatusVersionGetById");
      }
      // verify the required parameter 'versionUid' is set
      if (versionUid === undefined || versionUid === null) {
        throw new Error("Missing the required parameter 'versionUid' when calling versionedEhrStatusVersionGetById");
      }
