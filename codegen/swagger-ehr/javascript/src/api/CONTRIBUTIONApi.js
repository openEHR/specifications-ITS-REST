...
export class CONTRIBUTIONApi {
    ...
    */
     ...
     * @callback moduleapi/CONTRIBUTIONApi~contributionCreateCallback
     ...
     * @param {module:model/NewContribution} body The CONTRIBUTION.
     ...
     */
    contributionCreate(body, ehrId, opts, callback) {
      opts = opts || {};
      let postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling contributionCreate");
      }
      // verify the required parameter 'ehrId' is set
      if (ehrId === undefined || ehrId === null) {
        throw new Error("Missing the required parameter 'ehrId' when calling contributionCreate");
      }
     ...
     * @callback moduleapi/CONTRIBUTIONApi~contributionGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Contribution{ data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    contributionGet(ehrId, contributionUid, callback) {
      
      let postBody = null;
      // verify the required parameter 'ehrId' is set
      if (ehrId === undefined || ehrId === null) {
        throw new Error("Missing the required parameter 'ehrId' when calling contributionGet");
      }
      // verify the required parameter 'contributionUid' is set
      if (contributionUid === undefined || contributionUid === null) {
        throw new Error("Missing the required parameter 'contributionUid' when calling contributionGet");
      }

      let pathParams = {
        'ehr_id': ehrId,'contribution_uid': contributionUid
      };
      let queryParams = {
