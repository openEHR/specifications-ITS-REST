...
export class COMPOSITIONApi {
    ...
    */
     ...
     * @callback moduleapi/COMPOSITIONApi~compositionCreateCallback
     ...
     * @param {module:model/Composition} body The COMPOSITION.

     * @param {String} ehrId EHR identifier taken from EHR.ehr_id.value. 
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;.  (default to <.>)
     ...
     */
    compositionCreate(body, ehrId, opts, callback) {
      opts = opts || {};
      let postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling compositionCreate");
      }
      // verify the required parameter 'ehrId' is set
      if (ehrId === undefined || ehrId === null) {
        throw new Error("Missing the required parameter 'ehrId' when calling compositionCreate");
      }
     ...
     * @callback moduleapi/COMPOSITIONApi~compositionDeleteCallback
     * @param {String} error Error message, if any.
     ...
     */
    compositionDelete(ehrId, uidBasedId, callback) {
      
      let postBody = null;
      // verify the required parameter 'ehrId' is set
      if (ehrId === undefined || ehrId === null) {
        throw new Error("Missing the required parameter 'ehrId' when calling compositionDelete");
      }
      // verify the required parameter 'uidBasedId' is set
      if (uidBasedId === undefined || uidBasedId === null) {
        throw new Error("Missing the required parameter 'uidBasedId' when calling compositionDelete");
      }

      let pathParams = {
        'ehr_id': ehrId,'uid_based_id': uidBasedId
      };
      let queryParams = {
     ...
     * @callback moduleapi/COMPOSITIONApi~compositionGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Composition{ data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.versionAtTime A given time in the extended ISO 8601 format. 
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    compositionGet(ehrId, uidBasedId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'ehrId' is set
      if (ehrId === undefined || ehrId === null) {
        throw new Error("Missing the required parameter 'ehrId' when calling compositionGet");
      }
      // verify the required parameter 'uidBasedId' is set
      if (uidBasedId === undefined || uidBasedId === null) {
        throw new Error("Missing the required parameter 'uidBasedId' when calling compositionGet");
      }
      ...
      let queryParams = {
        'version_at_time': opts['versionAtTime']
      };
      let headerParams = {
     ...
     * @callback moduleapi/COMPOSITIONApi~compositionUpdateCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Composition{ data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/Composition} body The new COMPOSITION.
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    compositionUpdate(body, ehrId, uidBasedId, ifMatch, opts, callback) {
      opts = opts || {};
      let postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling compositionUpdate");
      }
      // verify the required parameter 'ehrId' is set
      if (ehrId === undefined || ehrId === null) {
        throw new Error("Missing the required parameter 'ehrId' when calling compositionUpdate");
      }
      // verify the required parameter 'uidBasedId' is set
      if (uidBasedId === undefined || uidBasedId === null) {
        throw new Error("Missing the required parameter 'uidBasedId' when calling compositionUpdate");
      }
      // verify the required parameter 'ifMatch' is set
      if (ifMatch === undefined || ifMatch === null) {
        throw new Error("Missing the required parameter 'ifMatch' when calling compositionUpdate");
      }
      ...
      let headerParams = {
        'If-Match': ifMatch,'Prefer': opts['prefer']
      };
      let formParams = {
     ...
     * @callback moduleapi/COMPOSITIONApi~versionedCompositionGetCallback
     * @param {String} error Error message, if any.
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    versionedCompositionGet(ehrId, versionedObjectUid, callback) {
      
      let postBody = null;
      // verify the required parameter 'ehrId' is set
      if (ehrId === undefined || ehrId === null) {
        throw new Error("Missing the required parameter 'ehrId' when calling versionedCompositionGet");
      }
      // verify the required parameter 'versionedObjectUid' is set
      if (versionedObjectUid === undefined || versionedObjectUid === null) {
        throw new Error("Missing the required parameter 'versionedObjectUid' when calling versionedCompositionGet");
      }

      let pathParams = {
        'ehr_id': ehrId,'versioned_object_uid': versionedObjectUid
      };
      let queryParams = {
     ...
     * @callback moduleapi/COMPOSITIONApi~versionedCompositionRevisionHistoryCallback
     * @param {String} error Error message, if any.
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    versionedCompositionRevisionHistory(ehrId, versionedObjectUid, callback) {
      
      let postBody = null;
      // verify the required parameter 'ehrId' is set
      if (ehrId === undefined || ehrId === null) {
        throw new Error("Missing the required parameter 'ehrId' when calling versionedCompositionRevisionHistory");
      }
      // verify the required parameter 'versionedObjectUid' is set
      if (versionedObjectUid === undefined || versionedObjectUid === null) {
        throw new Error("Missing the required parameter 'versionedObjectUid' when calling versionedCompositionRevisionHistory");
      }
     ...
     * @callback moduleapi/COMPOSITIONApi~versionedCompositionVersionGetAtTimeCallback
     * @param {String} error Error message, if any.
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    versionedCompositionVersionGetAtTime(ehrId, versionedObjectUid, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'ehrId' is set
      if (ehrId === undefined || ehrId === null) {
        throw new Error("Missing the required parameter 'ehrId' when calling versionedCompositionVersionGetAtTime");
      }
      // verify the required parameter 'versionedObjectUid' is set
      if (versionedObjectUid === undefined || versionedObjectUid === null) {
        throw new Error("Missing the required parameter 'versionedObjectUid' when calling versionedCompositionVersionGetAtTime");
      }
     ...
     * @callback moduleapi/COMPOSITIONApi~versionedCompositionVersionGetByIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Version{ data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    versionedCompositionVersionGetById(ehrId, versionedObjectUid, versionUid, callback) {
      
      let postBody = null;
      // verify the required parameter 'ehrId' is set
      if (ehrId === undefined || ehrId === null) {
        throw new Error("Missing the required parameter 'ehrId' when calling versionedCompositionVersionGetById");
      }
      // verify the required parameter 'versionedObjectUid' is set
      if (versionedObjectUid === undefined || versionedObjectUid === null) {
        throw new Error("Missing the required parameter 'versionedObjectUid' when calling versionedCompositionVersionGetById");
      }
      // verify the required parameter 'versionUid' is set
      if (versionUid === undefined || versionUid === null) {
        throw new Error("Missing the required parameter 'versionUid' when calling versionedCompositionVersionGetById");
      }

      let pathParams = {
        'ehr_id': ehrId,'versioned_object_uid': versionedObjectUid,'version_uid': versionUid
      };
      let queryParams = {
