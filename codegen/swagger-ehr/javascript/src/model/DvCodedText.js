  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('defining_code'))
        obj.definingCode = CodePhrase.constructFromObject(data['defining_code']);
    }
    return obj;
  }
}
 ...
 */
DvCodedText.prototype.type = 'DV_CODED_TEXT';

/**
 * @member {module:model/CodePhrase} definingCode
 */
DvCodedText.prototype.definingCode = undefined;
