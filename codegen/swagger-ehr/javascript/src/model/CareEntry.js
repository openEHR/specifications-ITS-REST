 ...
 * @version latest
 */
export class CareEntry extends AbstractEntry {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('guideline_id'))
        obj.guidelineId = ObjectRef.constructFromObject(data['guideline_id']);
    }
    return obj;
  }
}
...
/**
 * @member {module:model/ObjectRef} guidelineId
 */
CareEntry.prototype.guidelineId = undefined;
