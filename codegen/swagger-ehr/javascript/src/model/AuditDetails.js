...
export class AuditDetails {
   ...
   * @param timeCommitted {module:model/DvDateTime} 
   * @param changeType {module:model/DvCodedText} 
   * @param committer {module:model/PartyProxy} 
   */
  constructor(systemId, timeCommitted, changeType, committer) {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('time_committed'))
        obj.timeCommitted = DvDateTime.constructFromObject(data['time_committed']);
      if (data.hasOwnProperty('change_type'))
        obj.changeType = DvCodedText.constructFromObject(data['change_type']);
 ...
 */
AuditDetails.prototype.type = 'AUDIT_DETAILS';

/**
 * @member {String} systemId
 */
AuditDetails.prototype.systemId = undefined;

/**
 * @member {module:model/DvDateTime} timeCommitted
 */
AuditDetails.prototype.timeCommitted = undefined;

/**
 * @member {module:model/DvCodedText} changeType
 */
AuditDetails.prototype.changeType = undefined;
