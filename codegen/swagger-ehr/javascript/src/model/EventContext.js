 ...
 * @version latest
 */
export class EventContext extends Pathable {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('start_time'))
        obj.startTime = DvDateTime.constructFromObject(data['start_time']);
      if (data.hasOwnProperty('end_time'))
        obj.endTime = DvDateTime.constructFromObject(data['end_time']);
      ...
      if (data.hasOwnProperty('other_context'))
        obj.otherContext = ItemStructure.constructFromObject(data['other_context']);
      if (data.hasOwnProperty('health_care_facility'))
        obj.healthCareFacility = PartyIdentified.constructFromObject(data['health_care_facility']);
...
/**
 * @member {module:model/DvDateTime} startTime
 */
EventContext.prototype.startTime = undefined;

/**
 * @member {module:model/DvDateTime} endTime
 */
EventContext.prototype.endTime = undefined;
...
/**
 * @member {module:model/ItemStructure} otherContext
 */
EventContext.prototype.otherContext = undefined;

/**
 * @member {module:model/PartyIdentified} healthCareFacility
 */
EventContext.prototype.healthCareFacility = undefined;
