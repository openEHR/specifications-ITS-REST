...
export class UpdateAudit {
   ...
   * @class
   * @param changeType {module:model/TerminologyCode} 
   * @param committer {module:model/PartyProxy} 
   */
  constructor(changeType, committer) {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('change_type'))
        obj.changeType = TerminologyCode.constructFromObject(data['change_type']);
 ...
 */
UpdateAudit.prototype.type = 'UPDATE_AUDIT';

/**
 * @member {module:model/TerminologyCode} changeType
 */
UpdateAudit.prototype.changeType = undefined;
