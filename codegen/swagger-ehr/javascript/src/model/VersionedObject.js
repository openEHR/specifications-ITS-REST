...
export class VersionedObject {
   ...
   * @param ownerId {module:model/ObjectRef} 
   * @param timeCreated {module:model/DvDateTime} 
   */
  constructor(uid, ownerId, timeCreated) {
    this.uid = uid;
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('owner_id'))
        obj.ownerId = ObjectRef.constructFromObject(data['owner_id']);
      if (data.hasOwnProperty('time_created'))
        obj.timeCreated = DvDateTime.constructFromObject(data['time_created']);
    }
    return obj;
  }
}
 ...
 * @member {String} type
 */
VersionedObject.prototype.type = undefined;
...
/**
 * @member {module:model/ObjectRef} ownerId
 */
VersionedObject.prototype.ownerId = undefined;

/**
 * @member {module:model/DvDateTime} timeCreated
 */
VersionedObject.prototype.timeCreated = undefined;
