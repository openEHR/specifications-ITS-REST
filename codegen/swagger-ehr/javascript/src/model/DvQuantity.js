 ...
 * @version latest
 */
export class DvQuantity extends DvAmount {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('units_system'))
        obj.unitsSystem = ApiClient.convertToType(data['units_system'], 'String');
      if (data.hasOwnProperty('units_display_name'))
        obj.unitsDisplayName = ApiClient.convertToType(data['units_display_name'], 'String');
    }
    return obj;
  }
}
 ...
 * @default 'DV_QUANTITY'
 */
DvQuantity.prototype.type = 'DV_QUANTITY';
...
/**
 * @member {String} unitsSystem
 */
DvQuantity.prototype.unitsSystem = undefined;

/**
 * @member {String} unitsDisplayName
 */
DvQuantity.prototype.unitsDisplayName = undefined;
