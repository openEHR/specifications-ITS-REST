 ...
 * @version latest
 */
export class EhrStatus extends Versionable {
  /**
   ...
   * @param isModifiable {} 
   */
  constructor(subject, isQueryable, isModifiable) {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('is_queryable'))
        obj.isQueryable = ApiClient.convertToType(data['is_queryable'], 'Boolean');
      if (data.hasOwnProperty('is_modifiable'))
        obj.isModifiable = ApiClient.convertToType(data['is_modifiable'], 'Boolean');
 ...
 * @default 'EHR_STATUS'
 */
EhrStatus.prototype.type = 'EHR_STATUS';
 ...
 * @default true
 */
EhrStatus.prototype.isQueryable = true;

/**
 * @member {Boolean} isModifiable
 * @default true
 */
EhrStatus.prototype.isModifiable = true;

/**
 * @member {module:model/ItemStructure} otherDetails
 */
EhrStatus.prototype.otherDetails = undefined;
