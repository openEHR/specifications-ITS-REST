  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('external_ref'))
        obj.externalRef = PartyRef.constructFromObject(data['external_ref']);
    }
    return obj;
  }
}
 ...
 * @default 'PARTY_PROXY'
 */
PartyProxy.prototype.type = 'PARTY_PROXY';

/**
 * @member {module:model/PartyRef} externalRef
 */
PartyProxy.prototype.externalRef = undefined;
