  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('system_id'))
        obj.systemId = HierObjectId.constructFromObject(data['system_id']);
      if (data.hasOwnProperty('ehr_id'))
        obj.ehrId = HierObjectId.constructFromObject(data['ehr_id']);
      if (data.hasOwnProperty('ehr_status'))
        obj.ehrStatus = ObjectRef.constructFromObject(data['ehr_status']);
      if (data.hasOwnProperty('ehr_access'))
        obj.ehrAccess = ObjectRef.constructFromObject(data['ehr_access']);
...
/**
 * @member {module:model/HierObjectId} systemId
 */
Ehr.prototype.systemId = undefined;

/**
 * @member {module:model/HierObjectId} ehrId
 */
Ehr.prototype.ehrId = undefined;

/**
 * @member {module:model/ObjectRef} ehrStatus
 */
Ehr.prototype.ehrStatus = undefined;

/**
 * @member {module:model/ObjectRef} ehrAccess
 */
Ehr.prototype.ehrAccess = undefined;

/**
 * @member {module:model/DvDateTime} timeCreated
 */
Ehr.prototype.timeCreated = undefined;
