 ...
 * @version latest
 */
export class DvState extends DataValue {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('is_terminal'))
        obj.isTerminal = ApiClient.convertToType(data['is_terminal'], 'Boolean');
    }
    return obj;
  }
}
 ...
 * @default 'DV_STATE'
 */
DvState.prototype.type = 'DV_STATE';
...
/**
 * @member {Boolean} isTerminal
 */
DvState.prototype.isTerminal = undefined;
