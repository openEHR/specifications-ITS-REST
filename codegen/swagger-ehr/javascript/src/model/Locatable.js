 ...
 * @version latest
 */
export class Locatable extends Pathable {
  /**
   ...
   */
  constructor(name, archetypeNodeId) {
    super();
    this.name = name;
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('archetype_node_id'))
        obj.archetypeNodeId = ApiClient.convertToType(data['archetype_node_id'], 'String');
      ...
      if (data.hasOwnProperty('archetype_details'))
        obj.archetypeDetails = Archetyped.constructFromObject(data['archetype_details']);
      if (data.hasOwnProperty('feeder_audit'))
        obj.feederAudit = FeederAudit.constructFromObject(data['feeder_audit']);
    }
    return obj;
  }
}
...
/**
 * @member {String} archetypeNodeId
 */
Locatable.prototype.archetypeNodeId = undefined;
...
/**
 * @member {module:model/Archetyped} archetypeDetails
 */
Locatable.prototype.archetypeDetails = undefined;

/**
 * @member {module:model/FeederAudit} feederAudit
 */
Locatable.prototype.feederAudit = undefined;
