  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('null_flavour'))
        obj.nullFlavour = DvCodedText.constructFromObject(data['null_flavour']);
      if (data.hasOwnProperty('value'))
        obj.value = DataValue.constructFromObject(data['value']);
      if (data.hasOwnProperty('null_reason'))
        obj.nullReason = DvText.constructFromObject(data['null_reason']);
    }
    return obj;
  }
}
...
/**
 * @member {module:model/DvCodedText} nullFlavour
 */
Element.prototype.nullFlavour = undefined;
...
/**
 * @member {module:model/DvText} nullReason
 */
Element.prototype.nullReason = undefined;
