...
export class RevisionHistoryItem {
   ...
   * @class
   * @param versionId {module:model/ObjectVersionId} 
   * @param audits {Array.<module:model/AuditDetails>} 
   */
  constructor(versionId, audits) {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('version_id'))
        obj.versionId = ObjectVersionId.constructFromObject(data['version_id']);
...
/**
 * @member {module:model/ObjectVersionId} versionId
 */
RevisionHistoryItem.prototype.versionId = undefined;
