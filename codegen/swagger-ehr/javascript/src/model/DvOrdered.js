 ...
 * @version latest
 */
export class DvOrdered extends DataValue {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('normal_status'))
        obj.normalStatus = CodePhrase.constructFromObject(data['normal_status']);
      if (data.hasOwnProperty('normal_range'))
        obj.normalRange = DvInterval.constructFromObject(data['normal_range']);
      if (data.hasOwnProperty('other_reference_ranges'))
        obj.otherReferenceRanges = ApiClient.convertToType(data['other_reference_ranges'], [ReferenceRange]);
    }
    return obj;
  }
}
 ...
 * @default 'DV_ORDERED'
 */
DvOrdered.prototype.type = 'DV_ORDERED';

/**
 * @member {module:model/CodePhrase} normalStatus
 */
DvOrdered.prototype.normalStatus = undefined;

/**
 * @member {module:model/DvInterval} normalRange
 */
DvOrdered.prototype.normalRange = undefined;

/**
 * @member {Array.<module:model/ReferenceRange>} otherReferenceRanges
 */
DvOrdered.prototype.otherReferenceRanges = undefined;
