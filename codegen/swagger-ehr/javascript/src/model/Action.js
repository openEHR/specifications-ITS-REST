 ...
 * @version latest
 */
export class Action extends CareEntry {
  /**
   ...
   * @param description {} 
   */
  constructor(time, ismTransition, description) {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('ism_transition'))
        obj.ismTransition = IsmTransition.constructFromObject(data['ism_transition']);
      if (data.hasOwnProperty('instruction_details'))
        obj.instructionDetails = InstructionDetails.constructFromObject(data['instruction_details']);
...
/**
 * @member {module:model/IsmTransition} ismTransition
 */
Action.prototype.ismTransition = undefined;

/**
 * @member {module:model/InstructionDetails} instructionDetails
 */
Action.prototype.instructionDetails = undefined;
