...
export class UpdateVersion {
   ...
   * @class
   * @param lifecycleState {module:model/TerminologyCode} 
   * @param data {module:model/Versionable} 
   * @param commitAudit {module:model/UpdateAudit} 
   */
  constructor(lifecycleState, data, commitAudit) {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('lifecycle_state'))
        obj.lifecycleState = TerminologyCode.constructFromObject(data['lifecycle_state']);
      ...
      if (data.hasOwnProperty('commit_audit'))
        obj.commitAudit = UpdateAudit.constructFromObject(data['commit_audit']);
    }
    return obj;
  }
}
 ...
 */
UpdateVersion.prototype.precedingVersionUid = undefined;
...
/**
 * @member {module:model/TerminologyCode} lifecycleState
 */
UpdateVersion.prototype.lifecycleState = undefined;
...
/**
 * @member {module:model/UpdateAudit} commitAudit
 */
UpdateVersion.prototype.commitAudit = undefined;
