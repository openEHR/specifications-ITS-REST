 ...
 * @version latest
 */
export class Instruction extends CareEntry {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('expiry_time'))
        obj.expiryTime = DvDateTime.constructFromObject(data['expiry_time']);
      if (data.hasOwnProperty('wf_definition'))
        obj.wfDefinition = DvParsable.constructFromObject(data['wf_definition']);
...
/**
 * @member {module:model/DvDateTime} expiryTime
 */
Instruction.prototype.expiryTime = undefined;

/**
 * @member {module:model/DvParsable} wfDefinition
 */
Instruction.prototype.wfDefinition = undefined;
