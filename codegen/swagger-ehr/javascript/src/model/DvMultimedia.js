...
export class DvMultimedia extends DvEncapsulated {
   ...
   * @param size {} 
   */
  constructor(type, mediaType, size) {
    super(type);
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('_type'))
        obj.type = ApiClient.convertToType(data['_type'], 'String');
      if (data.hasOwnProperty('alternate_text'))
        obj.alternateText = ApiClient.convertToType(data['alternate_text'], 'String');
      if (data.hasOwnProperty('uri'))
        obj.uri = DvUri.constructFromObject(data['uri']);
      if (data.hasOwnProperty('data'))
        obj.data = ApiClient.convertToType(data['data'], 'String');
      if (data.hasOwnProperty('media_type'))
        obj.mediaType = CodePhrase.constructFromObject(data['media_type']);
      if (data.hasOwnProperty('compression_algorithm'))
        obj.compressionAlgorithm = CodePhrase.constructFromObject(data['compression_algorithm']);
      if (data.hasOwnProperty('integrity_check'))
        obj.integrityCheck = ApiClient.convertToType(data['integrity_check'], 'String');
      if (data.hasOwnProperty('integrity_check_algorithm'))
        obj.integrityCheckAlgorithm = CodePhrase.constructFromObject(data['integrity_check_algorithm']);
 ...
 */
DvMultimedia.prototype.type = 'DV_MULTIMEDIA';

/**
 * @member {String} alternateText
 */
DvMultimedia.prototype.alternateText = undefined;
...
/**
 * @member {module:model/CodePhrase} mediaType
 */
DvMultimedia.prototype.mediaType = undefined;

/**
 * @member {module:model/CodePhrase} compressionAlgorithm
 */
DvMultimedia.prototype.compressionAlgorithm = undefined;

/**
 * @member {String} integrityCheck
 */
DvMultimedia.prototype.integrityCheck = undefined;

/**
 * @member {module:model/CodePhrase} integrityCheckAlgorithm
 */
DvMultimedia.prototype.integrityCheckAlgorithm = undefined;
