 ...
 * @version latest
 */
export class DvAmount extends DvQuantified {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('accuracy_is_percent'))
        obj.accuracyIsPercent = ApiClient.convertToType(data['accuracy_is_percent'], 'Boolean');
 ...
 * @default 'DV_AMOUNT'
 */
DvAmount.prototype.type = 'DV_AMOUNT';

/**
 * @member {Boolean} accuracyIsPercent
 */
DvAmount.prototype.accuracyIsPercent = undefined;
