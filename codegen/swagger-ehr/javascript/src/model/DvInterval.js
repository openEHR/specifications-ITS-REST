 ...
 * @version latest
 */
export class DvInterval extends DataValue {
  /**
   ...
   * @param upperIncluded {} 
   */
  constructor(lowerUnbounded, upperUnbounded, lowerIncluded, upperIncluded) {
    super();
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('lower_unbounded'))
        obj.lowerUnbounded = ApiClient.convertToType(data['lower_unbounded'], 'Boolean');
      if (data.hasOwnProperty('upper_unbounded'))
        obj.upperUnbounded = ApiClient.convertToType(data['upper_unbounded'], 'Boolean');
      if (data.hasOwnProperty('lower_included'))
        obj.lowerIncluded = ApiClient.convertToType(data['lower_included'], 'Boolean');
      if (data.hasOwnProperty('upper_included'))
        obj.upperIncluded = ApiClient.convertToType(data['upper_included'], 'Boolean');
    }
    return obj;
  }
}
 ...
 * @default 'DV_INTERVAL'
 */
DvInterval.prototype.type = 'DV_INTERVAL';

/**
 * @member {Boolean} lowerUnbounded
 */
DvInterval.prototype.lowerUnbounded = undefined;

/**
 * @member {Boolean} upperUnbounded
 */
DvInterval.prototype.upperUnbounded = undefined;

/**
 * @member {Boolean} lowerIncluded
 */
DvInterval.prototype.lowerIncluded = undefined;

/**
 * @member {Boolean} upperIncluded
 */
DvInterval.prototype.upperIncluded = undefined;
