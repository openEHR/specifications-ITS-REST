...
export class Version {
   ...
   * @param commitAudit {module:model/AuditDetails} 
   * @param data {module:model/Versionable} 
   */
  constructor(contribution, commitAudit, data) {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('commit_audit'))
        obj.commitAudit = AuditDetails.constructFromObject(data['commit_audit']);
...
/**
 * @member {module:model/AuditDetails} commitAudit
 */
Version.prototype.commitAudit = undefined;
