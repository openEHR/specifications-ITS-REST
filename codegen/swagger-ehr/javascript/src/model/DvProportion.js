 ...
 * @version latest
 */
export class DvProportion extends DvAmount {
  /**
   ...
   * @param semanticType {} 
   */
  constructor(numerator, denominator, semanticType) {
    super();
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('semantic_type'))
        obj.semanticType = ApiClient.convertToType(data['semantic_type'], 'Number');
 ...
 */
DvProportion.prototype.type = 'DV_PROPORTION';
...
/**
 * @member {Number} semanticType
 */
DvProportion.prototype.semanticType = undefined;
