...
export class Activity extends Locatable {
   ...
   * @param description {} 
   */
  constructor(name, archetypeNodeId, actionArchetypeId, description) {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('action_archetype_id'))
        obj.actionArchetypeId = ApiClient.convertToType(data['action_archetype_id'], 'String');
...
/**
 * @member {String} actionArchetypeId
 */
Activity.prototype.actionArchetypeId = undefined;
