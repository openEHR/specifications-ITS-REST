 ...
 * @version latest
 */
export class OriginalVersion extends Version {
  /**
   ...
   */
  constructor(contribution, commitAudit, data, uid, lifecycleState) {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('preceding_version_uid'))
        obj.precedingVersionUid = ObjectVersionId.constructFromObject(data['preceding_version_uid']);
      if (data.hasOwnProperty('other_input_version_uids'))
        obj.otherInputVersionUids = ApiClient.convertToType(data['other_input_version_uids'], [ObjectVersionId]);
      if (data.hasOwnProperty('lifecycle_state'))
        obj.lifecycleState = DvCodedText.constructFromObject(data['lifecycle_state']);
 ...
 */
OriginalVersion.prototype.type = 'ORIGINAL_VERSION';
...
/**
 * @member {module:model/ObjectVersionId} precedingVersionUid
 */
OriginalVersion.prototype.precedingVersionUid = undefined;

/**
 * @member {Array.<module:model/ObjectVersionId>} otherInputVersionUids
 */
OriginalVersion.prototype.otherInputVersionUids = undefined;

/**
 * @member {module:model/DvCodedText} lifecycleState
 */
OriginalVersion.prototype.lifecycleState = undefined;
