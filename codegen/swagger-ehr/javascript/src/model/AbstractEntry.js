 ...
 * @version latest
 */
export class AbstractEntry extends ContentItem {
  /**
   ...
   * @param subject {} 
   */
  constructor(language, encoding, subject) {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('other_participations'))
        obj.otherParticipations = ApiClient.convertToType(data['other_participations'], [Participation]);
      if (data.hasOwnProperty('workflow_id'))
        obj.workflowId = ObjectRef.constructFromObject(data['workflow_id']);
...
/**
 * @member {Array.<module:model/Participation>} otherParticipations
 */
AbstractEntry.prototype.otherParticipations = undefined;

/**
 * @member {module:model/ObjectRef} workflowId
 */
AbstractEntry.prototype.workflowId = undefined;
