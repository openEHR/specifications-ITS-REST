 ...
 * @version latest
 */
export class InstructionDetails extends Pathable {
  /**
   ...
   * @param activityId {} 
   */
  constructor(instructionId, activityId) {
    super();
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('instruction_id'))
        obj.instructionId = LocatableRef.constructFromObject(data['instruction_id']);
      if (data.hasOwnProperty('activity_id'))
        obj.activityId = ApiClient.convertToType(data['activity_id'], 'String');
      if (data.hasOwnProperty('wf_details'))
        obj.wfDetails = ItemStructure.constructFromObject(data['wf_details']);
    }
    return obj;
  }
}
 ...
 */
InstructionDetails.prototype.type = 'INSTRUCTION_DETAILS';

/**
 * @member {module:model/LocatableRef} instructionId
 */
InstructionDetails.prototype.instructionId = undefined;

/**
 * @member {String} activityId
 */
InstructionDetails.prototype.activityId = undefined;

/**
 * @member {module:model/ItemStructure} wfDetails
 */
InstructionDetails.prototype.wfDetails = undefined;
