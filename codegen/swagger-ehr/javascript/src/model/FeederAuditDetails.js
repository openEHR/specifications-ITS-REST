 ...
 * @version latest
 */
export class FeederAuditDetails {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('system_id'))
        obj.systemId = ApiClient.convertToType(data['system_id'], 'String');
      ...
      if (data.hasOwnProperty('version_id'))
        obj.versionId = ApiClient.convertToType(data['version_id'], 'String');
      if (data.hasOwnProperty('other_details'))
        obj.otherDetails = ItemStructure.constructFromObject(data['other_details']);
    }
    return obj;
  }
}
 ...
 */
FeederAuditDetails.prototype.systemId = undefined;
 ...
 */
FeederAuditDetails.prototype.versionId = undefined;

/**
 * @member {module:model/ItemStructure} otherDetails
 */
FeederAuditDetails.prototype.otherDetails = undefined;
