...
export class Archetyped {
   ...
   * @class
   * @param archetypeId {module:model/ArchetypeId} 
   * @param rmVersion {String} 
   */
  constructor(archetypeId, rmVersion) {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('archetype_id'))
        obj.archetypeId = ArchetypeId.constructFromObject(data['archetype_id']);
      if (data.hasOwnProperty('template_id'))
        obj.templateId = TemplateId.constructFromObject(data['template_id']);
      if (data.hasOwnProperty('rm_version'))
        obj.rmVersion = ApiClient.convertToType(data['rm_version'], 'String');
    }
    return obj;
  }
}
...
/**
 * @member {module:model/ArchetypeId} archetypeId
 */
Archetyped.prototype.archetypeId = undefined;

/**
 * @member {module:model/TemplateId} templateId
 */
Archetyped.prototype.templateId = undefined;

/**
 * @member {String} rmVersion
 */
Archetyped.prototype.rmVersion = undefined;
