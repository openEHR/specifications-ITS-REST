...
export class CodePhrase {
   ...
   * @class
   * @param terminologyId {module:model/TerminologyId} 
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('terminology_id'))
        obj.terminologyId = TerminologyId.constructFromObject(data['terminology_id']);
      ...
      if (data.hasOwnProperty('preferred_term'))
        obj.preferredTerm = ApiClient.convertToType(data['preferred_term'], 'String');
    }
    return obj;
  }
}
...
/**
 * @member {module:model/TerminologyId} terminologyId
 */
CodePhrase.prototype.terminologyId = undefined;

/**
 * @member {String} codeString
 */
CodePhrase.prototype.codeString = undefined;

/**
 * @member {String} preferredTerm
 */
CodePhrase.prototype.preferredTerm = undefined;
