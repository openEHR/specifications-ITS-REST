...
export class FeederAudit {
   ...
   * @class
   * @param originatingSystemAudit {module:model/FeederAuditDetails} 
   */
  constructor(originatingSystemAudit) {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('originating_system_item_ids'))
        obj.originatingSystemItemIds = ApiClient.convertToType(data['originating_system_item_ids'], [DvIdentifier]);
      if (data.hasOwnProperty('feeder_system_item_ids'))
        obj.feederSystemItemIds = ApiClient.convertToType(data['feeder_system_item_ids'], [DvIdentifier]);
      if (data.hasOwnProperty('original_content'))
        obj.originalContent = DvEncapsulated.constructFromObject(data['original_content']);
      if (data.hasOwnProperty('originating_system_audit'))
        obj.originatingSystemAudit = FeederAuditDetails.constructFromObject(data['originating_system_audit']);
      if (data.hasOwnProperty('feeder_system_audit'))
        obj.feederSystemAudit = FeederAuditDetails.constructFromObject(data['feeder_system_audit']);
    }
    return obj;
  }
}
...
/**
 * @member {Array.<module:model/DvIdentifier>} originatingSystemItemIds
 */
FeederAudit.prototype.originatingSystemItemIds = undefined;

/**
 * @member {Array.<module:model/DvIdentifier>} feederSystemItemIds
 */
FeederAudit.prototype.feederSystemItemIds = undefined;

/**
 * @member {module:model/DvEncapsulated} originalContent
 */
FeederAudit.prototype.originalContent = undefined;

/**
 * @member {module:model/FeederAuditDetails} originatingSystemAudit
 */
FeederAudit.prototype.originatingSystemAudit = undefined;

/**
 * @member {module:model/FeederAuditDetails} feederSystemAudit
 */
FeederAudit.prototype.feederSystemAudit = undefined;
