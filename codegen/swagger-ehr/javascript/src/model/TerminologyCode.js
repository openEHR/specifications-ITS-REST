  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('terminology_id'))
        obj.terminologyId = ApiClient.convertToType(data['terminology_id'], 'String');
      if (data.hasOwnProperty('terminology_version'))
        obj.terminologyVersion = ApiClient.convertToType(data['terminology_version'], 'String');
      if (data.hasOwnProperty('code_string'))
        obj.codeString = ApiClient.convertToType(data['code_string'], 'String');
 ...
 */
TerminologyCode.prototype.terminologyId = undefined;

/**
 * @member {String} terminologyVersion
 */
TerminologyCode.prototype.terminologyVersion = undefined;

/**
 * @member {String} codeString
 */
TerminologyCode.prototype.codeString = undefined;
