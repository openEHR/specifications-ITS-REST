 ...
 * @version latest
 */
export class UpdateAttestation extends UpdateAudit {
  /**
   ...
   * @param isPending {} 
   */
  constructor(changeType, committer, reason, isPending) {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attested_view'))
        obj.attestedView = DvMultimedia.constructFromObject(data['attested_view']);
      ...
      if (data.hasOwnProperty('is_pending'))
        obj.isPending = ApiClient.convertToType(data['is_pending'], 'Boolean');
    }
    return obj;
  }
}
 ...
 */
UpdateAttestation.prototype.type = 'UPDATE_ATTESTATION';

/**
 * @member {module:model/DvMultimedia} attestedView
 */
UpdateAttestation.prototype.attestedView = undefined;
 ...
 */
UpdateAttestation.prototype.isPending = undefined;
