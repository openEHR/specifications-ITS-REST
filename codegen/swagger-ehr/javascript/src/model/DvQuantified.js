 ...
 * @version latest
 */
export class DvQuantified extends DvOrdered {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('magnitude_status'))
        obj.magnitudeStatus = ApiClient.convertToType(data['magnitude_status'], 'String');
    }
    return obj;
  }
}
 ...
 */
DvQuantified.prototype.type = 'DV_QUANTIFIED';

/**
 * @member {String} magnitudeStatus
 * @default '='
 */
DvQuantified.prototype.magnitudeStatus = '=';
