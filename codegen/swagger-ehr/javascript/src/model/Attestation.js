 ...
 * @version latest
 */
export class Attestation extends AuditDetails {
  /**
   ...
   * @param isPending {} 
   */
  constructor(systemId, timeCommitted, changeType, committer, reason, isPending) {
 ...
 * @default 'ATTESTATION'
 */
Attestation.prototype.type = 'ATTESTATION';

/**
 * @member {module:model/DvMultimedia} attestedView
 */
Attestation.prototype.attestedView = undefined;
 ...
 */
Attestation.prototype.isPending = undefined;
