 ...
 * @version latest
 */
export class IsmTransition extends Pathable {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('current_state'))
        obj.currentState = DvCodedText.constructFromObject(data['current_state']);
      ...
      if (data.hasOwnProperty('careflow_step'))
        obj.careflowStep = DvCodedText.constructFromObject(data['careflow_step']);
 ...
 */
IsmTransition.prototype.type = 'ISM_TRANSITION';

/**
 * @member {module:model/DvCodedText} currentState
 */
IsmTransition.prototype.currentState = undefined;
...
/**
 * @member {module:model/DvCodedText} careflowStep
 */
IsmTransition.prototype.careflowStep = undefined;
