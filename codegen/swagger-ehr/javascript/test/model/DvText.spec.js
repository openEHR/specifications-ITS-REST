...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DvText', function() {
      beforeEach(function() {
        instance = new EhrApi.DvText();
      });

      it('should create an instance of DvText', function() {
        // TODO: update the code to test DvText
        expect(instance).to.be.a(EhrApi.DvText);
      });
      ...
      it('should have the property hyperlink (base name: "hyperlink")', function() {
        // TODO: update the code to test the property hyperlink
        expect(instance).to.have.property('hyperlink');
        // expect(instance.hyperlink).to.be(expectedValueLiteral);
      });

      it('should have the property formatting (base name: "formatting")', function() {
        // TODO: update the code to test the property formatting
        expect(instance).to.have.property('formatting');
        // expect(instance.formatting).to.be(expectedValueLiteral);
      });
