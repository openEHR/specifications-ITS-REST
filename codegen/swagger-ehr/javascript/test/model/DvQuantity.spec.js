...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DvQuantity', function() {
      beforeEach(function() {
        instance = new EhrApi.DvQuantity();
      });

      it('should create an instance of DvQuantity', function() {
        // TODO: update the code to test DvQuantity
        expect(instance).to.be.a(EhrApi.DvQuantity);
      });
      ...
      it('should have the property magnitude (base name: "magnitude")', function() {
        // TODO: update the code to test the property magnitude
        expect(instance).to.have.property('magnitude');
        // expect(instance.magnitude).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property unitsSystem (base name: "units_system")', function() {
        // TODO: update the code to test the property unitsSystem
        expect(instance).to.have.property('unitsSystem');
        // expect(instance.unitsSystem).to.be(expectedValueLiteral);
      });

      it('should have the property unitsDisplayName (base name: "units_display_name")', function() {
        // TODO: update the code to test the property unitsDisplayName
        expect(instance).to.have.property('unitsDisplayName');
        // expect(instance.unitsDisplayName).to.be(expectedValueLiteral);
      });
