...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FeederAudit', function() {
      beforeEach(function() {
        instance = new EhrApi.FeederAudit();
      });

      it('should create an instance of FeederAudit', function() {
        // TODO: update the code to test FeederAudit
        expect(instance).to.be.a(EhrApi.FeederAudit);
      });

      it('should have the property originatingSystemItemIds (base name: "originating_system_item_ids")', function() {
        // TODO: update the code to test the property originatingSystemItemIds
        expect(instance).to.have.property('originatingSystemItemIds');
        // expect(instance.originatingSystemItemIds).to.be(expectedValueLiteral);
      });

      it('should have the property feederSystemItemIds (base name: "feeder_system_item_ids")', function() {
        // TODO: update the code to test the property feederSystemItemIds
        expect(instance).to.have.property('feederSystemItemIds');
        // expect(instance.feederSystemItemIds).to.be(expectedValueLiteral);
      });

      it('should have the property originalContent (base name: "original_content")', function() {
        // TODO: update the code to test the property originalContent
        expect(instance).to.have.property('originalContent');
        // expect(instance.originalContent).to.be(expectedValueLiteral);
      });

      it('should have the property originatingSystemAudit (base name: "originating_system_audit")', function() {
        // TODO: update the code to test the property originatingSystemAudit
        expect(instance).to.have.property('originatingSystemAudit');
        // expect(instance.originatingSystemAudit).to.be(expectedValueLiteral);
      });

      it('should have the property feederSystemAudit (base name: "feeder_system_audit")', function() {
        // TODO: update the code to test the property feederSystemAudit
        expect(instance).to.have.property('feederSystemAudit');
        // expect(instance.feederSystemAudit).to.be(expectedValueLiteral);
      });
