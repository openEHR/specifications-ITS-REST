...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Action', function() {
      ...
      it('should have the property ismTransition (base name: "ism_transition")', function() {
        // TODO: update the code to test the property ismTransition
        expect(instance).to.have.property('ismTransition');
        // expect(instance.ismTransition).to.be(expectedValueLiteral);
      });

      it('should have the property instructionDetails (base name: "instruction_details")', function() {
        // TODO: update the code to test the property instructionDetails
        expect(instance).to.have.property('instructionDetails');
        // expect(instance.instructionDetails).to.be(expectedValueLiteral);
      });
