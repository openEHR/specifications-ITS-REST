  ...
  describe('(package)', function() {
    describe('DvProportion', function() {
      ...
      it('should create an instance of DvProportion', function() {
        // TODO: update the code to test DvProportion
      ...
      it('should have the property semanticType (base name: "semantic_type")', function() {
        // TODO: update the code to test the property semanticType
        expect(instance).to.have.property('semanticType');
        // expect(instance.semanticType).to.be(expectedValueLiteral);
      });
