...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Element', function() {
      beforeEach(function() {
        instance = new EhrApi.Element();
      });

      it('should create an instance of Element', function() {
        // TODO: update the code to test Element
        expect(instance).to.be.a(EhrApi.Element);
      });
      ...
      it('should have the property nullFlavour (base name: "null_flavour")', function() {
        // TODO: update the code to test the property nullFlavour
        expect(instance).to.have.property('nullFlavour');
        // expect(instance.nullFlavour).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property nullReason (base name: "null_reason")', function() {
        // TODO: update the code to test the property nullReason
        expect(instance).to.have.property('nullReason');
        // expect(instance.nullReason).to.be(expectedValueLiteral);
      });
