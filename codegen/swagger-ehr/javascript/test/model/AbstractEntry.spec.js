...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AbstractEntry', function() {
      beforeEach(function() {
        instance = new EhrApi.AbstractEntry();
      });

      it('should create an instance of AbstractEntry', function() {
        // TODO: update the code to test AbstractEntry
        expect(instance).to.be.a(EhrApi.AbstractEntry);
      });
      ...
      it('should have the property otherParticipations (base name: "other_participations")', function() {
        // TODO: update the code to test the property otherParticipations
        expect(instance).to.have.property('otherParticipations');
        // expect(instance.otherParticipations).to.be(expectedValueLiteral);
      });
