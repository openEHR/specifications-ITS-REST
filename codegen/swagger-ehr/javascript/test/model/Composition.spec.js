...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Composition', function() {
      beforeEach(function() {
        instance = new EhrApi.Composition();
      });

      it('should create an instance of Composition', function() {
        // TODO: update the code to test Composition
        expect(instance).to.be.a(EhrApi.Composition);
      });
      ...
      it('should have the property territory (base name: "territory")', function() {
        // TODO: update the code to test the property territory
        expect(instance).to.have.property('territory');
        // expect(instance.territory).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property composer (base name: "composer")', function() {
        // TODO: update the code to test the property composer
        expect(instance).to.have.property('composer');
        // expect(instance.composer).to.be(expectedValueLiteral);
      });
