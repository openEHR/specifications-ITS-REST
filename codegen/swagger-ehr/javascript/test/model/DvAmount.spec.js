  ...
  describe('(package)', function() {
    describe('DvAmount', function() {
      ...
      it('should create an instance of DvAmount', function() {
        // TODO: update the code to test DvAmount
      ...
      it('should have the property accuracyIsPercent (base name: "accuracy_is_percent")', function() {
        // TODO: update the code to test the property accuracyIsPercent
        expect(instance).to.have.property('accuracyIsPercent');
        // expect(instance.accuracyIsPercent).to.be(expectedValueLiteral);
      });
