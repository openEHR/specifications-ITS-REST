...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DvIntervalOfDateTime', function() {
      beforeEach(function() {
        instance = new EhrApi.DvIntervalOfDateTime();
      });

      it('should create an instance of DvIntervalOfDateTime', function() {
        // TODO: update the code to test DvIntervalOfDateTime
        expect(instance).to.be.a(EhrApi.DvIntervalOfDateTime);
      });
      ...
      it('should have the property lower (base name: "lower")', function() {
        // TODO: update the code to test the property lower
        expect(instance).to.have.property('lower');
        // expect(instance.lower).to.be(expectedValueLiteral);
      });

      it('should have the property upper (base name: "upper")', function() {
        // TODO: update the code to test the property upper
        expect(instance).to.have.property('upper');
        // expect(instance.upper).to.be(expectedValueLiteral);
      });
