...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Locatable', function() {
      beforeEach(function() {
        instance = new EhrApi.Locatable();
      });

      it('should create an instance of Locatable', function() {
        // TODO: update the code to test Locatable
        expect(instance).to.be.a(EhrApi.Locatable);
      });
      ...
      it('should have the property archetypeNodeId (base name: "archetype_node_id")', function() {
        // TODO: update the code to test the property archetypeNodeId
        expect(instance).to.have.property('archetypeNodeId');
        // expect(instance.archetypeNodeId).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property archetypeDetails (base name: "archetype_details")', function() {
        // TODO: update the code to test the property archetypeDetails
        expect(instance).to.have.property('archetypeDetails');
        // expect(instance.archetypeDetails).to.be(expectedValueLiteral);
      });

      it('should have the property feederAudit (base name: "feeder_audit")', function() {
        // TODO: update the code to test the property feederAudit
        expect(instance).to.have.property('feederAudit');
        // expect(instance.feederAudit).to.be(expectedValueLiteral);
      });
