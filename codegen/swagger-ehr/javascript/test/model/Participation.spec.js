  ...
  describe('(package)', function() {
    describe('Participation', function() {
      ...
      it('should have the property performer (base name: "performer")', function() {
        // TODO: update the code to test the property performer
        expect(instance).to.have.property('performer');
        // expect(instance.performer).to.be(expectedValueLiteral);
      });
