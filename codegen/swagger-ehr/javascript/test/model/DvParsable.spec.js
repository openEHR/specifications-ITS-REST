  ...
  describe('(package)', function() {
    describe('DvParsable', function() {
      ...
      it('should create an instance of DvParsable', function() {
        // TODO: update the code to test DvParsable
      ...
      it('should have the property formalism (base name: "formalism")', function() {
        // TODO: update the code to test the property formalism
        expect(instance).to.have.property('formalism');
        // expect(instance.formalism).to.be(expectedValueLiteral);
      });
