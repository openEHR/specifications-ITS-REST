  ...
  describe('(package)', function() {
    describe('DvCodedText', function() {
      ...
      it('should create an instance of DvCodedText', function() {
        // TODO: update the code to test DvCodedText
      ...
      it('should have the property definingCode (base name: "defining_code")', function() {
        // TODO: update the code to test the property definingCode
        expect(instance).to.have.property('definingCode');
        // expect(instance.definingCode).to.be(expectedValueLiteral);
      });
