  ...
  describe('(package)', function() {
    describe('PartyProxy', function() {
      ...
      it('should create an instance of PartyProxy', function() {
        // TODO: update the code to test PartyProxy
      ...
      it('should have the property externalRef (base name: "external_ref")', function() {
        // TODO: update the code to test the property externalRef
        expect(instance).to.have.property('externalRef');
        // expect(instance.externalRef).to.be(expectedValueLiteral);
      });
