  ...
  describe('(package)', function() {
    describe('DvQuantified', function() {
      ...
      it('should create an instance of DvQuantified', function() {
        // TODO: update the code to test DvQuantified
      ...
      it('should have the property magnitudeStatus (base name: "magnitude_status")', function() {
        // TODO: update the code to test the property magnitudeStatus
        expect(instance).to.have.property('magnitudeStatus');
        // expect(instance.magnitudeStatus).to.be(expectedValueLiteral);
      });
