...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NewContribution', function() {
      beforeEach(function() {
        instance = new EhrApi.NewContribution();
      });

      it('should create an instance of NewContribution', function() {
        // TODO: update the code to test NewContribution
        expect(instance).to.be.a(EhrApi.NewContribution);
      });
      ...
      it('should have the property audit (base name: "audit")', function() {
        // TODO: update the code to test the property audit
        expect(instance).to.have.property('audit');
        // expect(instance.audit).to.be(expectedValueLiteral);
      });
