...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReferenceRange', function() {
      beforeEach(function() {
        instance = new EhrApi.ReferenceRange();
      });

      it('should create an instance of ReferenceRange', function() {
        // TODO: update the code to test ReferenceRange
        expect(instance).to.be.a(EhrApi.ReferenceRange);
      });

      it('should have the property meaning (base name: "meaning")', function() {
        // TODO: update the code to test the property meaning
        expect(instance).to.have.property('meaning');
        // expect(instance.meaning).to.be(expectedValueLiteral);
      });
