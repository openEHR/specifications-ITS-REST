  ...
  describe('(package)', function() {
    describe('OriginalVersion', function() {
      ...
      it('should create an instance of OriginalVersion', function() {
        // TODO: update the code to test OriginalVersion
      ...
      it('should have the property precedingVersionUid (base name: "preceding_version_uid")', function() {
        // TODO: update the code to test the property precedingVersionUid
        expect(instance).to.have.property('precedingVersionUid');
        // expect(instance.precedingVersionUid).to.be(expectedValueLiteral);
      });

      it('should have the property otherInputVersionUids (base name: "other_input_version_uids")', function() {
        // TODO: update the code to test the property otherInputVersionUids
        expect(instance).to.have.property('otherInputVersionUids');
        // expect(instance.otherInputVersionUids).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property attestations (base name: "attestations")', function() {
        // TODO: update the code to test the property attestations
        expect(instance).to.have.property('attestations');
        // expect(instance.attestations).to.be(expectedValueLiteral);
      });
