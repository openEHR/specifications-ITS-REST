  ...
  describe('(package)', function() {
    describe('UpdateAttestation', function() {
      ...
      it('should create an instance of UpdateAttestation', function() {
        // TODO: update the code to test UpdateAttestation
      ...
      it('should have the property attestedView (base name: "attested_view")', function() {
        // TODO: update the code to test the property attestedView
        expect(instance).to.have.property('attestedView');
        // expect(instance.attestedView).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property isPending (base name: "is_pending")', function() {
        // TODO: update the code to test the property isPending
        expect(instance).to.have.property('isPending');
        // expect(instance.isPending).to.be(expectedValueLiteral);
      });
