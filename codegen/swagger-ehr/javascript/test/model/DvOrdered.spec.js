...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DvOrdered', function() {
      beforeEach(function() {
        instance = new EhrApi.DvOrdered();
      });

      it('should create an instance of DvOrdered', function() {
        // TODO: update the code to test DvOrdered
        expect(instance).to.be.a(EhrApi.DvOrdered);
      });
      ...
      it('should have the property normalStatus (base name: "normal_status")', function() {
        // TODO: update the code to test the property normalStatus
        expect(instance).to.have.property('normalStatus');
        // expect(instance.normalStatus).to.be(expectedValueLiteral);
      });

      it('should have the property normalRange (base name: "normal_range")', function() {
        // TODO: update the code to test the property normalRange
        expect(instance).to.have.property('normalRange');
        // expect(instance.normalRange).to.be(expectedValueLiteral);
      });

      it('should have the property otherReferenceRanges (base name: "other_reference_ranges")', function() {
        // TODO: update the code to test the property otherReferenceRanges
        expect(instance).to.have.property('otherReferenceRanges');
        // expect(instance.otherReferenceRanges).to.be(expectedValueLiteral);
      });
