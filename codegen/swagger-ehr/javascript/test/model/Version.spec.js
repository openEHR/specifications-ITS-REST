  ...
  describe('(package)', function() {
    describe('Version', function() {
      ...
      it('should have the property contribution (base name: "contribution")', function() {
        // TODO: update the code to test the property contribution
        expect(instance).to.have.property('contribution');
        // expect(instance.contribution).to.be(expectedValueLiteral);
      });
