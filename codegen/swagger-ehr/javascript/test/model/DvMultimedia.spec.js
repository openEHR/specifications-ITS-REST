...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DvMultimedia', function() {
      beforeEach(function() {
        instance = new EhrApi.DvMultimedia();
      });

      it('should create an instance of DvMultimedia', function() {
        // TODO: update the code to test DvMultimedia
        expect(instance).to.be.a(EhrApi.DvMultimedia);
      });
      ...
      it('should have the property alternateText (base name: "alternate_text")', function() {
        // TODO: update the code to test the property alternateText
        expect(instance).to.have.property('alternateText');
        // expect(instance.alternateText).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property compressionAlgorithm (base name: "compression_algorithm")', function() {
      ...
      it('should have the property integrityCheck (base name: "integrity_check")', function() {
        // TODO: update the code to test the property integrityCheck
        expect(instance).to.have.property('integrityCheck');
        // expect(instance.integrityCheck).to.be(expectedValueLiteral);
      });

      it('should have the property integrityCheckAlgorithm (base name: "integrity_check_algorithm")', function() {
        // TODO: update the code to test the property integrityCheckAlgorithm
        expect(instance).to.have.property('integrityCheckAlgorithm');
        // expect(instance.integrityCheckAlgorithm).to.be(expectedValueLiteral);
      });
