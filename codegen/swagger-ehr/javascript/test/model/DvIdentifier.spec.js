...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DvIdentifier', function() {
      beforeEach(function() {
        instance = new EhrApi.DvIdentifier();
      });

      it('should create an instance of DvIdentifier', function() {
        // TODO: update the code to test DvIdentifier
        expect(instance).to.be.a(EhrApi.DvIdentifier);
      });
      ...
      it('should have the property assigner (base name: "assigner")', function() {
        // TODO: update the code to test the property assigner
        expect(instance).to.have.property('assigner');
        // expect(instance.assigner).to.be(expectedValueLiteral);
      });
