  ...
  describe('(package)', function() {
    describe('Ehr', function() {
      ...
      it('should create an instance of Ehr', function() {
        // TODO: update the code to test Ehr
      ...
      it('should have the property ehrId (base name: "ehr_id")', function() {
      ...
      it('should have the property ehrStatus (base name: "ehr_status")', function() {
        // TODO: update the code to test the property ehrStatus
        expect(instance).to.have.property('ehrStatus');
        // expect(instance.ehrStatus).to.be(expectedValueLiteral);
      });

      it('should have the property ehrAccess (base name: "ehr_access")', function() {
        // TODO: update the code to test the property ehrAccess
        expect(instance).to.have.property('ehrAccess');
        // expect(instance.ehrAccess).to.be(expectedValueLiteral);
      });

      it('should have the property timeCreated (base name: "time_created")', function() {
        // TODO: update the code to test the property timeCreated
        expect(instance).to.have.property('timeCreated');
        // expect(instance.timeCreated).to.be(expectedValueLiteral);
      });
