...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TerminologyCode', function() {
      beforeEach(function() {
        instance = new EhrApi.TerminologyCode();
      });

      it('should create an instance of TerminologyCode', function() {
        // TODO: update the code to test TerminologyCode
        expect(instance).to.be.a(EhrApi.TerminologyCode);
      });

      it('should have the property terminologyId (base name: "terminology_id")', function() {
        // TODO: update the code to test the property terminologyId
        expect(instance).to.have.property('terminologyId');
        // expect(instance.terminologyId).to.be(expectedValueLiteral);
      });

      it('should have the property terminologyVersion (base name: "terminology_version")', function() {
        // TODO: update the code to test the property terminologyVersion
        expect(instance).to.have.property('terminologyVersion');
        // expect(instance.terminologyVersion).to.be(expectedValueLiteral);
      });

      it('should have the property codeString (base name: "code_string")', function() {
        // TODO: update the code to test the property codeString
        expect(instance).to.have.property('codeString');
        // expect(instance.codeString).to.be(expectedValueLiteral);
      });
