...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DvInterval', function() {
      beforeEach(function() {
        instance = new EhrApi.DvInterval();
      });

      it('should create an instance of DvInterval', function() {
        // TODO: update the code to test DvInterval
        expect(instance).to.be.a(EhrApi.DvInterval);
      });
      ...
      it('should have the property lowerUnbounded (base name: "lower_unbounded")', function() {
        // TODO: update the code to test the property lowerUnbounded
        expect(instance).to.have.property('lowerUnbounded');
        // expect(instance.lowerUnbounded).to.be(expectedValueLiteral);
      });

      it('should have the property upperUnbounded (base name: "upper_unbounded")', function() {
        // TODO: update the code to test the property upperUnbounded
        expect(instance).to.have.property('upperUnbounded');
        // expect(instance.upperUnbounded).to.be(expectedValueLiteral);
      });

      it('should have the property lowerIncluded (base name: "lower_included")', function() {
        // TODO: update the code to test the property lowerIncluded
        expect(instance).to.have.property('lowerIncluded');
        // expect(instance.lowerIncluded).to.be(expectedValueLiteral);
      });

      it('should have the property upperIncluded (base name: "upper_included")', function() {
        // TODO: update the code to test the property upperIncluded
        expect(instance).to.have.property('upperIncluded');
        // expect(instance.upperIncluded).to.be(expectedValueLiteral);
      });
