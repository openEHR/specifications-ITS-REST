...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CodePhrase', function() {
      beforeEach(function() {
        instance = new EhrApi.CodePhrase();
      });

      it('should create an instance of CodePhrase', function() {
        // TODO: update the code to test CodePhrase
        expect(instance).to.be.a(EhrApi.CodePhrase);
      });
      ...
      it('should have the property preferredTerm (base name: "preferred_term")', function() {
        // TODO: update the code to test the property preferredTerm
        expect(instance).to.have.property('preferredTerm');
        // expect(instance.preferredTerm).to.be(expectedValueLiteral);
      });
