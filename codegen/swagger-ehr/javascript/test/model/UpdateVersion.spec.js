...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateVersion', function() {
      beforeEach(function() {
        instance = new EhrApi.UpdateVersion();
      });

      it('should create an instance of UpdateVersion', function() {
        // TODO: update the code to test UpdateVersion
        expect(instance).to.be.a(EhrApi.UpdateVersion);
      });
      ...
      it('should have the property commitAudit (base name: "commit_audit")', function() {
        // TODO: update the code to test the property commitAudit
        expect(instance).to.have.property('commitAudit');
        // expect(instance.commitAudit).to.be(expectedValueLiteral);
      });
