...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CareEntry', function() {
      beforeEach(function() {
        instance = new EhrApi.CareEntry();
      });

      it('should create an instance of CareEntry', function() {
        // TODO: update the code to test CareEntry
        expect(instance).to.be.a(EhrApi.CareEntry);
      });
      ...
      it('should have the property guidelineId (base name: "guideline_id")', function() {
        // TODO: update the code to test the property guidelineId
        expect(instance).to.have.property('guidelineId');
        // expect(instance.guidelineId).to.be(expectedValueLiteral);
      });
