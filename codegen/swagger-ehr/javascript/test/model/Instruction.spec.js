  ...
  describe('(package)', function() {
    describe('Instruction', function() {
      ...
      it('should create an instance of Instruction', function() {
        // TODO: update the code to test Instruction
      ...
      it('should have the property wfDefinition (base name: "wf_definition")', function() {
        // TODO: update the code to test the property wfDefinition
        expect(instance).to.have.property('wfDefinition');
        // expect(instance.wfDefinition).to.be(expectedValueLiteral);
      });
