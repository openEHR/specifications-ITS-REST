  ...
  describe('(package)', function() {
    describe('Archetyped', function() {
      ...
      it('should create an instance of Archetyped', function() {
        // TODO: update the code to test Archetyped
        expect(instance).to.be.a(EhrApi.Archetyped);
      });

      it('should have the property archetypeId (base name: "archetype_id")', function() {
      ...
      it('should have the property rmVersion (base name: "rm_version")', function() {
        // TODO: update the code to test the property rmVersion
        expect(instance).to.have.property('rmVersion');
        // expect(instance.rmVersion).to.be(expectedValueLiteral);
      });
