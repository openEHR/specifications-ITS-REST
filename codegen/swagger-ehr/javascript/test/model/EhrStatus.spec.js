...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EhrStatus', function() {
      beforeEach(function() {
        instance = new EhrApi.EhrStatus();
      });

      it('should create an instance of EhrStatus', function() {
        // TODO: update the code to test EhrStatus
        expect(instance).to.be.a(EhrApi.EhrStatus);
      });
      ...
      it('should have the property isQueryable (base name: "is_queryable")', function() {
        // TODO: update the code to test the property isQueryable
        expect(instance).to.have.property('isQueryable');
        // expect(instance.isQueryable).to.be(expectedValueLiteral);
      });

      it('should have the property isModifiable (base name: "is_modifiable")', function() {
        // TODO: update the code to test the property isModifiable
        expect(instance).to.have.property('isModifiable');
        // expect(instance.isModifiable).to.be(expectedValueLiteral);
      });

      it('should have the property otherDetails (base name: "other_details")', function() {
        // TODO: update the code to test the property otherDetails
        expect(instance).to.have.property('otherDetails');
        // expect(instance.otherDetails).to.be(expectedValueLiteral);
      });
