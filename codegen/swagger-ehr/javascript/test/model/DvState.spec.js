  ...
  describe('(package)', function() {
    describe('DvState', function() {
      ...
      it('should create an instance of DvState', function() {
        // TODO: update the code to test DvState
      ...
      it('should have the property isTerminal (base name: "is_terminal")', function() {
        // TODO: update the code to test the property isTerminal
        expect(instance).to.have.property('isTerminal');
        // expect(instance.isTerminal).to.be(expectedValueLiteral);
      });
