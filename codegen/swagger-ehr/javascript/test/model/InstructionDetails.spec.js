  ...
  describe('(package)', function() {
    describe('InstructionDetails', function() {
      ...
      it('should create an instance of InstructionDetails', function() {
        // TODO: update the code to test InstructionDetails
      ...
      it('should have the property instructionId (base name: "instruction_id")', function() {
      ...
      it('should have the property wfDetails (base name: "wf_details")', function() {
        // TODO: update the code to test the property wfDetails
        expect(instance).to.have.property('wfDetails');
        // expect(instance.wfDetails).to.be(expectedValueLiteral);
      });
