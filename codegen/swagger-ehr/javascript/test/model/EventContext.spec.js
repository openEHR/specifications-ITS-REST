...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EventContext', function() {
      beforeEach(function() {
        instance = new EhrApi.EventContext();
      });

      it('should create an instance of EventContext', function() {
        // TODO: update the code to test EventContext
        expect(instance).to.be.a(EhrApi.EventContext);
      });
      ...
      it('should have the property otherContext (base name: "other_context")', function() {
        // TODO: update the code to test the property otherContext
        expect(instance).to.have.property('otherContext');
        // expect(instance.otherContext).to.be(expectedValueLiteral);
      });

      it('should have the property healthCareFacility (base name: "health_care_facility")', function() {
        // TODO: update the code to test the property healthCareFacility
        expect(instance).to.have.property('healthCareFacility');
        // expect(instance.healthCareFacility).to.be(expectedValueLiteral);
      });

      it('should have the property participations (base name: "participations")', function() {
        // TODO: update the code to test the property participations
        expect(instance).to.have.property('participations');
        // expect(instance.participations).to.be(expectedValueLiteral);
      });
