  ...
  describe('(package)', function() {
    describe('IsmTransition', function() {
      ...
      it('should create an instance of IsmTransition', function() {
        // TODO: update the code to test IsmTransition
      ...
      it('should have the property transition (base name: "transition")', function() {
        // TODO: update the code to test the property transition
        expect(instance).to.have.property('transition');
        // expect(instance.transition).to.be(expectedValueLiteral);
      });

      it('should have the property careflowStep (base name: "careflow_step")', function() {
        // TODO: update the code to test the property careflowStep
        expect(instance).to.have.property('careflowStep');
        // expect(instance.careflowStep).to.be(expectedValueLiteral);
      });
