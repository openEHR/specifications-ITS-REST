...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.EhrApi);
  }
}(this, function(expect, EhrApi) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new EhrApi.COMPOSITIONApi();
  });

  describe('(package)', function() {
    describe('COMPOSITIONApi', function() {
      describe('compositionCreate', function() {
        it('should call compositionCreate successfully', function(done) {
          // TODO: uncomment, update parameter values for compositionCreate call and complete the assertions
          /*
          var opts = {};

          instance.compositionCreate(body, ehrId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(EhrApi.Composition);
      ...
      describe('compositionDelete', function() {
        it('should call compositionDelete successfully', function(done) {
          // TODO: uncomment, update parameter values for compositionDelete call
          /*

          instance.compositionDelete(ehrId, uidBasedId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('compositionGet', function() {
        it('should call compositionGet successfully', function(done) {
          // TODO: uncomment, update parameter values for compositionGet call and complete the assertions
          /*
          var opts = {};

          instance.compositionGet(ehrId, uidBasedId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('compositionUpdate', function() {
        it('should call compositionUpdate successfully', function(done) {
          // TODO: uncomment, update parameter values for compositionUpdate call and complete the assertions
          /*
          var opts = {};

          instance.compositionUpdate(body, ehrId, uidBasedId, ifMatch, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('versionedCompositionGet', function() {
        it('should call versionedCompositionGet successfully', function(done) {
          // TODO: uncomment, update parameter values for versionedCompositionGet call and complete the assertions
          /*

          instance.versionedCompositionGet(ehrId, versionedObjectUid, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(EhrApi.VersionedComposition);
      ...
      describe('versionedCompositionRevisionHistory', function() {
        it('should call versionedCompositionRevisionHistory successfully', function(done) {
          // TODO: uncomment, update parameter values for versionedCompositionRevisionHistory call and complete the assertions
          /*

          instance.versionedCompositionRevisionHistory(ehrId, versionedObjectUid, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(EhrApi.RevisionHistory);
      ...
      describe('versionedCompositionVersionGetAtTime', function() {
        it('should call versionedCompositionVersionGetAtTime successfully', function(done) {
          // TODO: uncomment, update parameter values for versionedCompositionVersionGetAtTime call and complete the assertions
          /*
          var opts = {};

          instance.versionedCompositionVersionGetAtTime(ehrId, versionedObjectUid, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(EhrApi.Version);
      ...
      describe('versionedCompositionVersionGetById', function() {
        it('should call versionedCompositionVersionGetById successfully', function(done) {
          // TODO: uncomment, update parameter values for versionedCompositionVersionGetById call and complete the assertions
          /*

          instance.versionedCompositionVersionGetById(ehrId, versionedObjectUid, versionUid, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
