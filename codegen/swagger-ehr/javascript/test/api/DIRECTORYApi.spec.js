...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.DIRECTORYApi();
  });

  describe('(package)', function() {
    describe('DIRECTORYApi', function() {
      describe('directoryCreate', function() {
        it('should call directoryCreate successfully', function(done) {
          // TODO: uncomment, update parameter values for directoryCreate call and complete the assertions
          /*
          var opts = {};

          instance.directoryCreate(body, ehrId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(EhrApi.Folder);
      ...
      describe('directoryDelete', function() {
        it('should call directoryDelete successfully', function(done) {
          // TODO: uncomment, update parameter values for directoryDelete call
          /*

          instance.directoryDelete(ehrId, ifMatch, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('directoryGetAtTime', function() {
        it('should call directoryGetAtTime successfully', function(done) {
          // TODO: uncomment, update parameter values for directoryGetAtTime call and complete the assertions
          /*
          var opts = {};

          instance.directoryGetAtTime(ehrId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('directoryGetByVersionId', function() {
        it('should call directoryGetByVersionId successfully', function(done) {
          // TODO: uncomment, update parameter values for directoryGetByVersionId call and complete the assertions
          /*
          var opts = {};

          instance.directoryGetByVersionId(ehrId, versionUid, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('directoryUpdate', function() {
        it('should call directoryUpdate successfully', function(done) {
          // TODO: uncomment, update parameter values for directoryUpdate call and complete the assertions
          /*
          var opts = {};

          instance.directoryUpdate(body, ehrId, ifMatch, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
