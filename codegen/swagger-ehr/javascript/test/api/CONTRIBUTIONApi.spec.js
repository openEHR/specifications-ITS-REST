...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.CONTRIBUTIONApi();
  });

  describe('(package)', function() {
    describe('CONTRIBUTIONApi', function() {
      describe('contributionCreate', function() {
        it('should call contributionCreate successfully', function(done) {
          // TODO: uncomment, update parameter values for contributionCreate call and complete the assertions
          /*
          var opts = {};

          instance.contributionCreate(body, ehrId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(EhrApi.Contribution);
      ...
      describe('contributionGet', function() {
        it('should call contributionGet successfully', function(done) {
          // TODO: uncomment, update parameter values for contributionGet call and complete the assertions
          /*

          instance.contributionGet(ehrId, contributionUid, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
