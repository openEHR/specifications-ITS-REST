...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.EHRApi();
  });

  describe('(package)', function() {
    describe('EHRApi', function() {
      describe('ehrCreate', function() {
        it('should call ehrCreate successfully', function(done) {
          // TODO: uncomment, update parameter values for ehrCreate call and complete the assertions
          /*
          var opts = {};

          instance.ehrCreate(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(EhrApi.Ehr);
      ...
      describe('ehrCreateWithId', function() {
        it('should call ehrCreateWithId successfully', function(done) {
          // TODO: uncomment, update parameter values for ehrCreateWithId call and complete the assertions
          /*
          var opts = {};

          instance.ehrCreateWithId(ehrId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('ehrGetById', function() {
        it('should call ehrGetById successfully', function(done) {
          // TODO: uncomment, update parameter values for ehrGetById call and complete the assertions
          /*

          instance.ehrGetById(ehrId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('ehrGetBySubject', function() {
        it('should call ehrGetBySubject successfully', function(done) {
          // TODO: uncomment, update parameter values for ehrGetBySubject call and complete the assertions
          /*

          instance.ehrGetBySubject(subjectId, subjectNamespace, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
