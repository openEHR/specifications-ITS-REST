...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.EHRSTATUSApi();
  });

  describe('(package)', function() {
    describe('EHRSTATUSApi', function() {
      describe('ehrStatusGetAtTime', function() {
        it('should call ehrStatusGetAtTime successfully', function(done) {
          // TODO: uncomment, update parameter values for ehrStatusGetAtTime call and complete the assertions
          /*
          var opts = {};

          instance.ehrStatusGetAtTime(ehrId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(EhrApi.EhrStatus);
      ...
      describe('ehrStatusGetByVersionId', function() {
        it('should call ehrStatusGetByVersionId successfully', function(done) {
          // TODO: uncomment, update parameter values for ehrStatusGetByVersionId call and complete the assertions
          /*

          instance.ehrStatusGetByVersionId(ehrId, versionUid, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('ehrStatusUpdate', function() {
        it('should call ehrStatusUpdate successfully', function(done) {
          // TODO: uncomment, update parameter values for ehrStatusUpdate call and complete the assertions
          /*
          var opts = {};

          instance.ehrStatusUpdate(body, ehrId, ifMatch, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('versionedEhrStatusGet', function() {
        it('should call versionedEhrStatusGet successfully', function(done) {
          // TODO: uncomment, update parameter values for versionedEhrStatusGet call and complete the assertions
          /*

          instance.versionedEhrStatusGet(ehrId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(EhrApi.VersionedEhrStatus);
      ...
      describe('versionedEhrStatusRevisionHistory', function() {
        it('should call versionedEhrStatusRevisionHistory successfully', function(done) {
          // TODO: uncomment, update parameter values for versionedEhrStatusRevisionHistory call and complete the assertions
          /*

          instance.versionedEhrStatusRevisionHistory(ehrId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('versionedEhrStatusVersionGetAtTime', function() {
        it('should call versionedEhrStatusVersionGetAtTime successfully', function(done) {
          // TODO: uncomment, update parameter values for versionedEhrStatusVersionGetAtTime call and complete the assertions
          /*
          var opts = {};

          instance.versionedEhrStatusVersionGetAtTime(ehrId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('versionedEhrStatusVersionGetById', function() {
        it('should call versionedEhrStatusVersionGetById successfully', function(done) {
          // TODO: uncomment, update parameter values for versionedEhrStatusVersionGetById call and complete the assertions
          /*

          instance.versionedEhrStatusVersionGetById(ehrId, versionUid, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
