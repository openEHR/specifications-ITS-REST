...
class CONTRIBUTIONApi
{
     ...
     * Create CONTRIBUTION
     *
     * @param  \Swagger\Client\Model\NewContribution $body The CONTRIBUTION.
 (required)
     ...
     * @return \Swagger\Client\Model\Contribution
     */
    public function contributionCreate($body, $ehr_id, $prefer = 'return=minimal')
    {
        list($response) = $this->contributionCreateWithHttpInfo($body, $ehr_id, $prefer);
        return $response;
    }
 ...
 (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\Contribution, HTTP status code, HTTP response headers (array of strings)
     */
    public function contributionCreateWithHttpInfo($body, $ehr_id, $prefer = 'return=minimal')
    {
        $returnType = '\Swagger\Client\Model\Contribution';
        $request = $this->contributionCreateRequest($body, $ehr_id, $prefer);
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\Contribution',
 ...
 (required)
     ...
     */
    public function contributionCreateAsync($body, $ehr_id, $prefer = 'return=minimal')
    {
        return $this->contributionCreateAsyncWithHttpInfo($body, $ehr_id, $prefer)
            ->then(
                function ($response) {
                    return $response[0];
                }
 ...
 (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contributionCreateAsyncWithHttpInfo($body, $ehr_id, $prefer = 'return=minimal')
    {
        $returnType = '\Swagger\Client\Model\Contribution';
        $request = $this->contributionCreateRequest($body, $ehr_id, $prefer);
 ...
 (required)
     ...
     */
    protected function contributionCreateRequest($body, $ehr_id, $prefer = 'return=minimal')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling contributionCreate'
            );
        }
     ...
     * @return \Swagger\Client\Model\Contribution
     */
    public function contributionGet($ehr_id, $contribution_uid)
    {
        list($response) = $this->contributionGetWithHttpInfo($ehr_id, $contribution_uid);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\Contribution, HTTP status code, HTTP response headers (array of strings)
     */
    public function contributionGetWithHttpInfo($ehr_id, $contribution_uid)
    {
        $returnType = '\Swagger\Client\Model\Contribution';
        $request = $this->contributionGetRequest($ehr_id, $contribution_uid);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contributionGetAsync($ehr_id, $contribution_uid)
    {
        return $this->contributionGetAsyncWithHttpInfo($ehr_id, $contribution_uid)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contributionGetAsyncWithHttpInfo($ehr_id, $contribution_uid)
    {
        $returnType = '\Swagger\Client\Model\Contribution';
        $request = $this->contributionGetRequest($ehr_id, $contribution_uid);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function contributionGetRequest($ehr_id, $contribution_uid)
    {
        // verify the required parameter 'ehr_id' is set
        if ($ehr_id === null || (is_array($ehr_id) && count($ehr_id) === 0)) {
            throw new \InvalidArgumentException(
