 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LocatableRef implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LocatableRef';
    ...
    protected static $swaggerTypes = [
        'namespace' => 'string',
'type' => 'string',
'id' => '\Swagger\Client\Model\UidBasedId',
'path' => 'string'    ];
...
'path' => 'getPath'    ];
     ...
     * Sets id
     *
     * @param \Swagger\Client\Model\UidBasedId $id id
     *
     * @return $this
     */
