...
class DvProportion extends DvAmount 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DvProportion';
...
'precision' => 'getPrecision'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['_type'] = isset($data['_type']) ? $data['_type'] : 'DV_PROPORTION';
        ...
        $this->container['semantic_type'] = isset($data['semantic_type']) ? $data['semantic_type'] : null;
