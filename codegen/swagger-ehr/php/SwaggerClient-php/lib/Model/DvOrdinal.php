...
class DvOrdinal extends DvOrdered 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DvOrdinal';
    ...
    protected static $swaggerTypes = [
        '_type' => 'string',
'symbol' => '\Swagger\Client\Model\DvCodedText',
'value' => 'int'    ];
...
'value' => 'getValue'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['_type'] = isset($data['_type']) ? $data['_type'] : 'DV_ORDINAL';
     ...
     * Sets symbol
     *
     * @param \Swagger\Client\Model\DvCodedText $symbol symbol
     *
     * @return $this
     */
