...
'state' => '\Swagger\Client\Model\ItemStructure',
'data' => '\Swagger\Client\Model\ItemStructure'    ];
...
'data' => 'getData'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['_type'] = isset($data['_type']) ? $data['_type'] : 'EVENT';
     ...
     * Sets state
     *
     * @param \Swagger\Client\Model\ItemStructure $state state
     *
     * @return $this
     */
     ...
     * Sets data
     *
     * @param \Swagger\Client\Model\ItemStructure $data data
     *
     * @return $this
     */
