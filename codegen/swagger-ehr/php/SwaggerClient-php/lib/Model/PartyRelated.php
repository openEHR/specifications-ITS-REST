...
/**
 * PartyRelated Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class PartyRelated extends PartyIdentified 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PartyRelated';
    ...
    protected static $swaggerTypes = [
        '_type' => 'string',
'relationship' => '\Swagger\Client\Model\DvCodedText'    ];
...
'relationship' => 'getRelationship'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['_type'] = isset($data['_type']) ? $data['_type'] : 'PARTY_RELATED';
     ...
     * Sets relationship
     *
     * @param \Swagger\Client\Model\DvCodedText $relationship relationship
     *
     * @return $this
     */
