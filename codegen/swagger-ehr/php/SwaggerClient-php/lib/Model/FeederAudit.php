 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FeederAudit implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FeederAudit';
    ...
    protected static $swaggerTypes = [
        'originating_system_item_ids' => '\Swagger\Client\Model\DvIdentifier[]',
'feeder_system_item_ids' => '\Swagger\Client\Model\DvIdentifier[]',
'original_content' => '\Swagger\Client\Model\DvEncapsulated',
'originating_system_audit' => '\Swagger\Client\Model\FeederAuditDetails',
'feeder_system_audit' => '\Swagger\Client\Model\FeederAuditDetails'    ];
...
'feeder_system_audit' => 'getFeederSystemAudit'    ];
    ...
    {
        $this->container['originating_system_item_ids'] = isset($data['originating_system_item_ids']) ? $data['originating_system_item_ids'] : null;
        $this->container['feeder_system_item_ids'] = isset($data['feeder_system_item_ids']) ? $data['feeder_system_item_ids'] : null;
        $this->container['original_content'] = isset($data['original_content']) ? $data['original_content'] : null;
        $this->container['originating_system_audit'] = isset($data['originating_system_audit']) ? $data['originating_system_audit'] : null;
        $this->container['feeder_system_audit'] = isset($data['feeder_system_audit']) ? $data['feeder_system_audit'] : null;
    }
     ...
     *
     * @return \Swagger\Client\Model\DvIdentifier[]
     */
     ...
     *
     * @param \Swagger\Client\Model\DvIdentifier[] $originating_system_item_ids originating_system_item_ids
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\DvIdentifier[] $feeder_system_item_ids feeder_system_item_ids
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\DvEncapsulated
     */
     ...
     *
     * @param \Swagger\Client\Model\DvEncapsulated $original_content original_content
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\FeederAuditDetails
     */
     ...
     *
     * @param \Swagger\Client\Model\FeederAuditDetails $originating_system_audit originating_system_audit
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\FeederAuditDetails $feeder_system_audit feeder_system_audit
     *
     * @return $this
     */
