...
class DvQuantified extends DvOrdered 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DvQuantified';
...
'magnitude_status' => 'getMagnitudeStatus'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['_type'] = isset($data['_type']) ? $data['_type'] : 'DV_QUANTIFIED';
        $this->container['magnitude_status'] = isset($data['magnitude_status']) ? $data['magnitude_status'] : '=';
     ...
     *
     * @param string $magnitude_status magnitude_status
     *
     * @return $this
     */
