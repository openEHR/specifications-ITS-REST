...
class DvQuantity extends DvAmount 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DvQuantity';
...
'units_display_name' => 'getUnitsDisplayName'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['_type'] = isset($data['_type']) ? $data['_type'] : 'DV_QUANTITY';
        ...
        $this->container['units_system'] = isset($data['units_system']) ? $data['units_system'] : null;
        $this->container['units_display_name'] = isset($data['units_display_name']) ? $data['units_display_name'] : null;
    }
     ...
     * Sets units_system
     *
     * @param string $units_system units_system
     *
     * @return $this
     */
     ...
     *
     * @param string $units_display_name units_display_name
     *
     * @return $this
     */
