...
class DvParsable extends DvEncapsulated 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DvParsable';
...
'formalism' => 'getFormalism'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['_type'] = isset($data['_type']) ? $data['_type'] : 'DV_PARSABLE';
        $this->container['value'] = isset($data['value']) ? $data['value'] : null;
        $this->container['formalism'] = isset($data['formalism']) ? $data['formalism'] : null;
    }
