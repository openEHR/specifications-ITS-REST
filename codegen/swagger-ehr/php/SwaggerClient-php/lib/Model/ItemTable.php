...
class ItemTable extends ItemStructure 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ItemTable';
    ...
    protected static $swaggerTypes = [
        '_type' => 'string',
'items' => '\Swagger\Client\Model\Clstr[]'    ];
...
'items' => 'getItems'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['_type'] = isset($data['_type']) ? $data['_type'] : 'ITEM_TABLE';
     ...
     * Gets items
     *
     * @return \Swagger\Client\Model\Clstr[]
     */
     ...
     * Sets items
     *
     * @param \Swagger\Client\Model\Clstr[] $items items
     *
     * @return $this
     */
