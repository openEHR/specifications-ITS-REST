...
/**
 * PartyIdentified Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class PartyIdentified extends PartyProxy 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PartyIdentified';
    ...
    protected static $swaggerTypes = [
        '_type' => 'string',
'name' => 'string',
'identifiers' => '\Swagger\Client\Model\DvIdentifier[]'    ];
...
'identifiers' => 'getIdentifiers'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['_type'] = isset($data['_type']) ? $data['_type'] : 'PARTY_IDENTIFIED';
     ...
     * Sets identifiers
     *
     * @param \Swagger\Client\Model\DvIdentifier[] $identifiers identifiers
     *
     * @return $this
     */
