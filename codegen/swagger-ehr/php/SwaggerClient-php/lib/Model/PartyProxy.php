 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PartyProxy implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PartyProxy';
    ...
    protected static $swaggerTypes = [
        '_type' => 'string',
'external_ref' => '\Swagger\Client\Model\PartyRef'    ];
...
'external_ref' => 'getExternalRef'    ];
    ...
    {
        $this->container['_type'] = isset($data['_type']) ? $data['_type'] : 'PARTY_PROXY';
     ...
     * Gets external_ref
     *
     * @return \Swagger\Client\Model\PartyRef
     */
     ...
     * Sets external_ref
     *
     * @param \Swagger\Client\Model\PartyRef $external_ref external_ref
     *
     * @return $this
     */
