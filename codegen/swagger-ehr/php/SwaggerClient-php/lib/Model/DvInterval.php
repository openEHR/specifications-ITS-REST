...
class DvInterval extends DataValue 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DvInterval';
...
'upper_included' => 'getUpperIncluded'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['_type'] = isset($data['_type']) ? $data['_type'] : 'DV_INTERVAL';
        $this->container['lower_unbounded'] = isset($data['lower_unbounded']) ? $data['lower_unbounded'] : null;
        $this->container['upper_unbounded'] = isset($data['upper_unbounded']) ? $data['upper_unbounded'] : null;
        $this->container['lower_included'] = isset($data['lower_included']) ? $data['lower_included'] : null;
        $this->container['upper_included'] = isset($data['upper_included']) ? $data['upper_included'] : null;

        // Initialize discriminator property with the model name.
        $discriminator = array_search('_type', self::$attributeMap, true);
