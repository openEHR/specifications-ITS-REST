...
class Observation extends CareEntry 
{
    ...
    protected static $swaggerTypes = [
        '_type' => 'string',
'data' => '\Swagger\Client\Model\History',
'state' => '\Swagger\Client\Model\History'    ];
...
'state' => 'getState'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['_type'] = isset($data['_type']) ? $data['_type'] : 'OBSERVATION';
     ...
     * Gets data
     *
     * @return \Swagger\Client\Model\History
     */
     ...
     * Sets data
     *
     * @param \Swagger\Client\Model\History $data data
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param \Swagger\Client\Model\History $state state
     *
     * @return $this
     */
