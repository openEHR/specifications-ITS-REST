...
class ItemSingle extends ItemStructure 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ItemSingle';
    ...
    protected static $swaggerTypes = [
        '_type' => 'string',
'item' => '\Swagger\Client\Model\Element'    ];
...
'item' => 'getItem'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['_type'] = isset($data['_type']) ? $data['_type'] : 'ITEM_SINGLE';
     ...
     * Sets item
     *
     * @param \Swagger\Client\Model\Element $item item
     *
     * @return $this
     */
