...
class UpdateAttestation extends UpdateAudit 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateAttestation';
    ...
    protected static $swaggerTypes = [
        '_type' => 'string',
'attested_view' => '\Swagger\Client\Model\DvMultimedia',
'proof' => 'string',
'items' => '\Swagger\Client\Model\DvEhrUri[]',
...
'is_pending' => 'getIsPending'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['_type'] = isset($data['_type']) ? $data['_type'] : 'UPDATE_ATTESTATION';
        $this->container['attested_view'] = isset($data['attested_view']) ? $data['attested_view'] : null;
     ...
     * Sets attested_view
     *
     * @param \Swagger\Client\Model\DvMultimedia $attested_view attested_view
     *
     * @return $this
     */
     ...
     * Gets items
     *
     * @return \Swagger\Client\Model\DvEhrUri[]
     */
     ...
     * Sets items
     *
     * @param \Swagger\Client\Model\DvEhrUri[] $items items
     *
     * @return $this
     */
