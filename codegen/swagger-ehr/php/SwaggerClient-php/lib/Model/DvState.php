...
class DvState extends DataValue 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DvState';
    ...
    protected static $swaggerTypes = [
        '_type' => 'string',
'value' => '\Swagger\Client\Model\DvCodedText',
'is_terminal' => 'bool'    ];
...
'is_terminal' => 'getIsTerminal'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['_type'] = isset($data['_type']) ? $data['_type'] : 'DV_STATE';
     ...
     * Sets value
     *
     * @param \Swagger\Client\Model\DvCodedText $value value
     *
     * @return $this
     */
