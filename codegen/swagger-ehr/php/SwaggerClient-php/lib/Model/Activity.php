...
class Activity extends Locatable 
{
    ...
    protected static $swaggerTypes = [
        '_type' => 'string',
'timing' => '\Swagger\Client\Model\DvParsable',
...
'description' => 'getDescription'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['_type'] = isset($data['_type']) ? $data['_type'] : 'ACTIVITY';
        $this->container['timing'] = isset($data['timing']) ? $data['timing'] : null;
        $this->container['action_archetype_id'] = isset($data['action_archetype_id']) ? $data['action_archetype_id'] : null;
     ...
     * Gets timing
     *
     * @return \Swagger\Client\Model\DvParsable
     */
     ...
     * Sets timing
     *
     * @param \Swagger\Client\Model\DvParsable $timing timing
     *
     * @return $this
     */
