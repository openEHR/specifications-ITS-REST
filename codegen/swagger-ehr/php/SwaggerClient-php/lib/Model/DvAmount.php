...
class DvAmount extends DvQuantified 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DvAmount';
...
'accuracy' => 'getAccuracy'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['_type'] = isset($data['_type']) ? $data['_type'] : 'DV_AMOUNT';
        $this->container['accuracy_is_percent'] = isset($data['accuracy_is_percent']) ? $data['accuracy_is_percent'] : null;
     ...
     *
     * @param bool $accuracy_is_percent accuracy_is_percent
     *
     * @return $this
     */
