 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TerminologyCode implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TerminologyCode';
...
'uri' => 'getUri'    ];
    ...
    {
        $this->container['terminology_id'] = isset($data['terminology_id']) ? $data['terminology_id'] : null;
        $this->container['terminology_version'] = isset($data['terminology_version']) ? $data['terminology_version'] : null;
        $this->container['code_string'] = isset($data['code_string']) ? $data['code_string'] : null;
     ...
     *
     * @param string $terminology_version terminology_version
     *
     * @return $this
     */
