...
class DvCodedText extends DvText 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DvCodedText';
    ...
    protected static $swaggerTypes = [
        '_type' => 'string',
'defining_code' => '\Swagger\Client\Model\CodePhrase'    ];
...
'defining_code' => 'getDefiningCode'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['_type'] = isset($data['_type']) ? $data['_type'] : 'DV_CODED_TEXT';
        $this->container['defining_code'] = isset($data['defining_code']) ? $data['defining_code'] : null;
    }
     ...
     * Sets defining_code
     *
     * @param \Swagger\Client\Model\CodePhrase $defining_code defining_code
     *
     * @return $this
     */
