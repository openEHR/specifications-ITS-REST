...
class DvEncapsulated extends DataValue 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DvEncapsulated';
    ...
    protected static $swaggerTypes = [
        '_type' => 'string',
'charset' => '\Swagger\Client\Model\CodePhrase',
...
'language' => 'getLanguage'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['_type'] = isset($data['_type']) ? $data['_type'] : 'DV_ENCAPSULATED';
     ...
     * Sets charset
     *
     * @param \Swagger\Client\Model\CodePhrase $charset charset
     *
     * @return $this
     */
