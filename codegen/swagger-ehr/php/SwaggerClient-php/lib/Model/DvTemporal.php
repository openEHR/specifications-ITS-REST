...
class DvTemporal extends DvQuantified 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DvTemporal';
    ...
    protected static $swaggerTypes = [
        '_type' => 'string',
'accuracy' => '\Swagger\Client\Model\DvDuration'    ];
...
'accuracy' => 'getAccuracy'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['_type'] = isset($data['_type']) ? $data['_type'] : 'DV_TEMPORAL';
     ...
     * Sets accuracy
     *
     * @param \Swagger\Client\Model\DvDuration $accuracy accuracy
     *
     * @return $this
     */
