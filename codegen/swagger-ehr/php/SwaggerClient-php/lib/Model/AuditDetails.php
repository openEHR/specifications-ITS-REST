...
/**
 * AuditDetails Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AuditDetails implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AuditDetails';
    ...
    protected static $swaggerTypes = [
        '_type' => 'string',
'system_id' => 'string',
'time_committed' => '\Swagger\Client\Model\DvDateTime',
'change_type' => '\Swagger\Client\Model\DvCodedText',
'description' => '\Swagger\Client\Model\DvText',
'committer' => '\Swagger\Client\Model\PartyProxy'    ];
...
'time_committed' => 'setTimeCommitted',
...
'time_committed' => 'getTimeCommitted',
...
'committer' => 'getCommitter'    ];
    ...
    {
        $this->container['_type'] = isset($data['_type']) ? $data['_type'] : 'AUDIT_DETAILS';
        $this->container['system_id'] = isset($data['system_id']) ? $data['system_id'] : null;
        $this->container['time_committed'] = isset($data['time_committed']) ? $data['time_committed'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['time_committed'] === null) {
            $invalidProperties[] = "'time_committed' can't be null";
        }
     ...
     */
    public function getTimeCommitted()
    {
        return $this->container['time_committed'];
    }

    /**
     * Sets time_committed
     *
     * @param \Swagger\Client\Model\DvDateTime $time_committed time_committed
     *
     * @return $this
     */
    public function setTimeCommitted($time_committed)
    {
        $this->container['time_committed'] = $time_committed;
     ...
     * Sets change_type
     *
     * @param \Swagger\Client\Model\DvCodedText $change_type change_type
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param \Swagger\Client\Model\DvText $description description
     *
     * @return $this
     */
     ...
     * Sets committer
     *
     * @param \Swagger\Client\Model\PartyProxy $committer committer
     *
     * @return $this
     */
