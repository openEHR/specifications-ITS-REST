...
import io.swagger.client.models.EhrStatus
import io.swagger.client.models.RevisionHistory
import io.swagger.client.models.Version
import io.swagger.client.models.VersionedEhrStatus

import io.swagger.client.infrastructure.*

class EHRSTATUSApi(basePath: kotlin.String = "https://{baseUrl}/v1") : ApiClient(basePath) {
    ...
    fun ehrStatusGetAtTime(ehrId: kotlin.String, versionAtTime: kotlin.String? = null): EhrStatus {
        ...
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/ehr/{ehr_id}/ehr_status".replace("{" + "ehr_id" + "}", "$ehrId"), query = localVariableQuery
        )
        val response = request<EhrStatus>(
                localVariableConfig
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as EhrStatus
    ...
    fun ehrStatusGetByVersionId(ehrId: kotlin.String, versionUid: kotlin.String): EhrStatus {
        ...
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/ehr/{ehr_id}/ehr_status/{version_uid}".replace("{" + "ehr_id" + "}", "$ehrId").replace("{" + "version_uid" + "}", "$versionUid")
        )
        val response = request<EhrStatus>(
                localVariableConfig
        )
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun ehrStatusUpdate(body: EhrStatus, ifMatch: kotlin.String, ehrId: kotlin.String, prefer: kotlin.String? = null): EhrStatus {
        ...
        val localVariableConfig = RequestConfig(
                RequestMethod.PUT,
                "/ehr/{ehr_id}/ehr_status".replace("{" + "ehr_id" + "}", "$ehrId"), headers = localVariableHeaders
        )
        val response = request<EhrStatus>(
    ...
    fun versionedEhrStatusGet(ehrId: kotlin.String): VersionedEhrStatus {
        ...
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/ehr/{ehr_id}/versioned_ehr_status".replace("{" + "ehr_id" + "}", "$ehrId")
        )
        val response = request<VersionedEhrStatus>(
                localVariableConfig
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as VersionedEhrStatus
            ResponseType.Informational -> TODO()
            ResponseType.Redirection -> TODO()
            ResponseType.ClientError -> throw ClientException((response as ClientError<*>).body as? String ?: "Client error")
            ResponseType.ServerError -> throw ServerException((response as ServerError<*>).message ?: "Server error")
    ...
    fun versionedEhrStatusRevisionHistory(ehrId: kotlin.String): RevisionHistory {
        ...
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/ehr/{ehr_id}/versioned_ehr_status/revision_history".replace("{" + "ehr_id" + "}", "$ehrId")
        )
    ...
    fun versionedEhrStatusVersionGetAtTime(ehrId: kotlin.String, versionAtTime: kotlin.String? = null): Version {
        ...
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/ehr/{ehr_id}/versioned_ehr_status/version".replace("{" + "ehr_id" + "}", "$ehrId"), query = localVariableQuery
        )
    ...
    fun versionedEhrStatusVersionGetById(ehrId: kotlin.String, versionUid: kotlin.String): Version {
        ...
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/ehr/{ehr_id}/versioned_ehr_status/version/{version_uid}".replace("{" + "ehr_id" + "}", "$ehrId").replace("{" + "version_uid" + "}", "$versionUid")
        )
        val response = request<Version>(
                localVariableConfig
        )
