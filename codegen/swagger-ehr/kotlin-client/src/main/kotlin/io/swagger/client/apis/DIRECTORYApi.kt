...
import io.swagger.client.models.Folder

import io.swagger.client.infrastructure.*

class DIRECTORYApi(basePath: kotlin.String = "https://{baseUrl}/v1") : ApiClient(basePath) {
    ...
    fun directoryCreate(body: Folder, ehrId: kotlin.String, prefer: kotlin.String? = null): Folder {
        ...
        val localVariableConfig = RequestConfig(
                RequestMethod.POST,
                "/ehr/{ehr_id}/directory".replace("{" + "ehr_id" + "}", "$ehrId"), headers = localVariableHeaders
        )
        val response = request<Folder>(
                localVariableConfig, localVariableBody
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as Folder
    ...
    fun directoryDelete(ehrId: kotlin.String, ifMatch: kotlin.String): Unit {
        ...
        val localVariableHeaders: kotlin.collections.Map<kotlin.String, kotlin.String> = mapOf("If-Match" to ifMatch)
        val localVariableConfig = RequestConfig(
    ...
    fun directoryGetAtTime(ehrId: kotlin.String, versionAtTime: kotlin.String? = null, path: kotlin.String? = null): Folder {
        val localVariableQuery: MultiValueMap = mapOf("version_at_time" to listOf("$versionAtTime"), "path" to listOf("$path"))
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/ehr/{ehr_id}/directory".replace("{" + "ehr_id" + "}", "$ehrId"), query = localVariableQuery
        )
        val response = request<Folder>(
                localVariableConfig
        )
    ...
    fun directoryGetByVersionId(ehrId: kotlin.String, versionUid: kotlin.String, path: kotlin.String? = null): Folder {
        val localVariableQuery: MultiValueMap = mapOf("path" to listOf("$path"))
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/ehr/{ehr_id}/directory/{version_uid}".replace("{" + "ehr_id" + "}", "$ehrId").replace("{" + "version_uid" + "}", "$versionUid"), query = localVariableQuery
        )
        val response = request<Folder>(
                localVariableConfig
        )
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun directoryUpdate(body: Folder, ifMatch: kotlin.String, ehrId: kotlin.String, prefer: kotlin.String? = null): Folder {
        val localVariableBody: kotlin.Any? = body
