...
import io.swagger.client.models.Composition
import io.swagger.client.models.Error
import io.swagger.client.models.RevisionHistory
import io.swagger.client.models.Version
import io.swagger.client.models.VersionedComposition

import io.swagger.client.infrastructure.*

class COMPOSITIONApi(basePath: kotlin.String = "https://{baseUrl}/v1") : ApiClient(basePath) {
    ...
    fun compositionCreate(body: Composition, ehrId: kotlin.String, prefer: kotlin.String? = null): Composition {
        val localVariableBody: kotlin.Any? = body
        
        val localVariableHeaders: kotlin.collections.Map<kotlin.String, kotlin.String> = mapOf("Prefer" to prefer.toString())
        val localVariableConfig = RequestConfig(
                RequestMethod.POST,
                "/ehr/{ehr_id}/composition".replace("{" + "ehr_id" + "}", "$ehrId"), headers = localVariableHeaders
        )
        val response = request<Composition>(
                localVariableConfig, localVariableBody
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as Composition
    ...
    fun compositionDelete(ehrId: kotlin.String, uidBasedId: kotlin.String): Unit {
        ...
        val localVariableConfig = RequestConfig(
                ...
                "/ehr/{ehr_id}/composition/{uid_based_id}".replace("{" + "ehr_id" + "}", "$ehrId").replace("{" + "uid_based_id" + "}", "$uidBasedId")
        )
    ...
    fun compositionGet(ehrId: kotlin.String, uidBasedId: kotlin.String, versionAtTime: kotlin.String? = null): Composition {
        val localVariableQuery: MultiValueMap = mapOf("version_at_time" to listOf("$versionAtTime"))
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/ehr/{ehr_id}/composition/{uid_based_id}".replace("{" + "ehr_id" + "}", "$ehrId").replace("{" + "uid_based_id" + "}", "$uidBasedId"), query = localVariableQuery
        )
        val response = request<Composition>(
                localVariableConfig
        )
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun compositionUpdate(body: Composition, ifMatch: kotlin.String, ehrId: kotlin.String, uidBasedId: kotlin.String, prefer: kotlin.String? = null): Composition {
        val localVariableBody: kotlin.Any? = body
        
        val localVariableHeaders: kotlin.collections.Map<kotlin.String, kotlin.String> = mapOf("If-Match" to ifMatch, "Prefer" to prefer.toString())
        val localVariableConfig = RequestConfig(
                RequestMethod.PUT,
                "/ehr/{ehr_id}/composition/{uid_based_id}".replace("{" + "ehr_id" + "}", "$ehrId").replace("{" + "uid_based_id" + "}", "$uidBasedId"), headers = localVariableHeaders
        )
        val response = request<Composition>(
                localVariableConfig, localVariableBody
        )
    ...
    fun versionedCompositionGet(ehrId: kotlin.String, versionedObjectUid: kotlin.String): VersionedComposition {
        ...
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/ehr/{ehr_id}/versioned_composition/{versioned_object_uid}".replace("{" + "ehr_id" + "}", "$ehrId").replace("{" + "versioned_object_uid" + "}", "$versionedObjectUid")
        )
        val response = request<VersionedComposition>(
                localVariableConfig
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as VersionedComposition
            ResponseType.Informational -> TODO()
            ResponseType.Redirection -> TODO()
            ResponseType.ClientError -> throw ClientException((response as ClientError<*>).body as? String ?: "Client error")
            ResponseType.ServerError -> throw ServerException((response as ServerError<*>).message ?: "Server error")
    ...
    fun versionedCompositionRevisionHistory(ehrId: kotlin.String, versionedObjectUid: kotlin.String): RevisionHistory {
        ...
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/ehr/{ehr_id}/versioned_composition/{versioned_object_uid}/revision_history".replace("{" + "ehr_id" + "}", "$ehrId").replace("{" + "versioned_object_uid" + "}", "$versionedObjectUid")
        )
        val response = request<RevisionHistory>(
                localVariableConfig
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as RevisionHistory
            ResponseType.Informational -> TODO()
            ResponseType.Redirection -> TODO()
            ResponseType.ClientError -> throw ClientException((response as ClientError<*>).body as? String ?: "Client error")
            ResponseType.ServerError -> throw ServerException((response as ServerError<*>).message ?: "Server error")
    ...
    fun versionedCompositionVersionGetAtTime(ehrId: kotlin.String, versionedObjectUid: kotlin.String, versionAtTime: kotlin.String? = null): Version {
        ...
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/ehr/{ehr_id}/versioned_composition/{versioned_object_uid}/version".replace("{" + "ehr_id" + "}", "$ehrId").replace("{" + "versioned_object_uid" + "}", "$versionedObjectUid"), query = localVariableQuery
        )
        ...
        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as Version
            ResponseType.Informational -> TODO()
            ResponseType.Redirection -> TODO()
            ResponseType.ClientError -> throw ClientException((response as ClientError<*>).body as? String ?: "Client error")
            ResponseType.ServerError -> throw ServerException((response as ServerError<*>).message ?: "Server error")
    ...
    fun versionedCompositionVersionGetById(ehrId: kotlin.String, versionedObjectUid: kotlin.String, versionUid: kotlin.String): Version {
        ...
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/ehr/{ehr_id}/versioned_composition/{versioned_object_uid}/version/{version_uid}".replace("{" + "ehr_id" + "}", "$ehrId").replace("{" + "versioned_object_uid" + "}", "$versionedObjectUid").replace("{" + "version_uid" + "}", "$versionUid")
        )
        val response = request<Version>(
                localVariableConfig
        )
