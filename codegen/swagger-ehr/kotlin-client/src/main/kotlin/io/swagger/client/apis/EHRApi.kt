...
import io.swagger.client.models.Ehr
import io.swagger.client.models.EhrStatus

import io.swagger.client.infrastructure.*

class EHRApi(basePath: kotlin.String = "https://{baseUrl}/v1") : ApiClient(basePath) {
 ...
 (optional)
    ...
    fun ehrCreate(body: EhrStatus? = null, prefer: kotlin.String? = null): Ehr {
        ...
        val localVariableConfig = RequestConfig(
                RequestMethod.POST,
                "/ehr", headers = localVariableHeaders
        )
        val response = request<Ehr>(
                localVariableConfig, localVariableBody
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as Ehr
 ...
 (optional)
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun ehrCreateWithId(ehrId: kotlin.String, body: EhrStatus? = null, prefer: kotlin.String? = null): Ehr {
        val localVariableBody: kotlin.Any? = body
        
        val localVariableHeaders: kotlin.collections.Map<kotlin.String, kotlin.String> = mapOf("Prefer" to prefer.toString())
        val localVariableConfig = RequestConfig(
                RequestMethod.PUT,
                "/ehr/{ehr_id}".replace("{" + "ehr_id" + "}", "$ehrId"), headers = localVariableHeaders
        )
        val response = request<Ehr>(
                localVariableConfig, localVariableBody
        )
    ...
    fun ehrGetById(ehrId: kotlin.String): Ehr {
        ...
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/ehr/{ehr_id}".replace("{" + "ehr_id" + "}", "$ehrId")
        )
        val response = request<Ehr>(
                localVariableConfig
        )
    ...
    fun ehrGetBySubject(subjectId: kotlin.String, subjectNamespace: kotlin.String): Ehr {
        val localVariableQuery: MultiValueMap = mapOf("subject_id" to listOf("$subjectId"), "subject_namespace" to listOf("$subjectNamespace"))
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/ehr", query = localVariableQuery
        )
        val response = request<Ehr>(
                localVariableConfig
        )
