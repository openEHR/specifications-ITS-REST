...
/*
EHRSTATUSApiService Get EHR_STATUS at time
 ...
 * @param optional nil or *EHRSTATUSApiEhrStatusGetAtTimeOpts - Optional Parameters:
     * @param "VersionAtTime" (optional.String) -  A given time in the extended ISO 8601 format. 
@return EhrStatus
*/

type EHRSTATUSApiEhrStatusGetAtTimeOpts struct {
    VersionAtTime optional.String
}

func (a *EHRSTATUSApiService) EhrStatusGetAtTime(ctx context.Context, ehrId string, localVarOptionals *EHRSTATUSApiEhrStatusGetAtTimeOpts) (EhrStatus, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/ehr/{ehr_id}/ehr_status"
...
/*
EHRSTATUSApiService Get EHR_STATUS by version id
...
@return EhrStatus
*/
func (a *EHRSTATUSApiService) EhrStatusGetByVersionId(ctx context.Context, ehrId string, versionUid string) (EhrStatus, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ehr/{ehr_id}/ehr_status/{version_uid}"
	localVarPath = strings.Replace(localVarPath, "{"+"ehr_id"+"}", fmt.Sprintf("%v", ehrId), -1)
...
/*
EHRSTATUSApiService Update EHR_STATUS
 ...
 * @param ehrId EHR identifier taken from EHR.ehr_id.value. 
 * @param optional nil or *EHRSTATUSApiEhrStatusUpdateOpts - Optional Parameters:
...
type EHRSTATUSApiEhrStatusUpdateOpts struct {
    Prefer optional.String
}

func (a *EHRSTATUSApiService) EhrStatusUpdate(ctx context.Context, body EhrStatus, ifMatch string, ehrId string, localVarOptionals *EHRSTATUSApiEhrStatusUpdateOpts) (EhrStatus, *http.Response, error) {
	var (
...
/*
EHRSTATUSApiService Get versioned EHR_STATUS
Retrieves a VERSIONED_EHR_STATUS associated with an EHR identified by &#x60;ehr_id&#x60;. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param ehrId EHR identifier taken from EHR.ehr_id.value. 
@return VersionedEhrStatus
*/
func (a *EHRSTATUSApiService) VersionedEhrStatusGet(ctx context.Context, ehrId string) (VersionedEhrStatus, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ehr/{ehr_id}/versioned_ehr_status"
	localVarPath = strings.Replace(localVarPath, "{"+"ehr_id"+"}", fmt.Sprintf("%v", ehrId), -1)
...
/*
EHRSTATUSApiService Get versioned EHR_STATUS revision history
Retrieves revision history of the VERSIONED_EHR_STATUS associated with the EHR identified by &#x60;ehr_id&#x60;. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param ehrId EHR identifier taken from EHR.ehr_id.value. 
@return RevisionHistory
*/
func (a *EHRSTATUSApiService) VersionedEhrStatusRevisionHistory(ctx context.Context, ehrId string) (RevisionHistory, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ehr/{ehr_id}/versioned_ehr_status/revision_history"
	localVarPath = strings.Replace(localVarPath, "{"+"ehr_id"+"}", fmt.Sprintf("%v", ehrId), -1)
...
/*
EHRSTATUSApiService Get versioned EHR_STATUS version at time
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param ehrId EHR identifier taken from EHR.ehr_id.value. 
 * @param optional nil or *EHRSTATUSApiVersionedEhrStatusVersionGetAtTimeOpts - Optional Parameters:
     * @param "VersionAtTime" (optional.String) -  A given time in the extended ISO 8601 format. 
@return Version
*/

type EHRSTATUSApiVersionedEhrStatusVersionGetAtTimeOpts struct {
    VersionAtTime optional.String
}

func (a *EHRSTATUSApiService) VersionedEhrStatusVersionGetAtTime(ctx context.Context, ehrId string, localVarOptionals *EHRSTATUSApiVersionedEhrStatusVersionGetAtTimeOpts) (Version, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ehr/{ehr_id}/versioned_ehr_status/version"
	localVarPath = strings.Replace(localVarPath, "{"+"ehr_id"+"}", fmt.Sprintf("%v", ehrId), -1)
...
/*
EHRSTATUSApiService Get versioned EHR_STATUS version by id
...
@return Version
*/
func (a *EHRSTATUSApiService) VersionedEhrStatusVersionGetById(ctx context.Context, ehrId string, versionUid string) (Version, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ehr/{ehr_id}/versioned_ehr_status/version/{version_uid}"
	localVarPath = strings.Replace(localVarPath, "{"+"ehr_id"+"}", fmt.Sprintf("%v", ehrId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"version_uid"+"}", fmt.Sprintf("%v", versionUid), -1)
