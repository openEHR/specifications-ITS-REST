...
/*
CONTRIBUTIONApiService Create CONTRIBUTION
 ...
 * @param optional nil or *CONTRIBUTIONApiContributionCreateOpts - Optional Parameters:
...
type CONTRIBUTIONApiContributionCreateOpts struct {
    Prefer optional.String
}

func (a *CONTRIBUTIONApiService) ContributionCreate(ctx context.Context, body NewContribution, ehrId string, localVarOptionals *CONTRIBUTIONApiContributionCreateOpts) (Contribution, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/ehr/{ehr_id}/contribution"
...
/*
CONTRIBUTIONApiService Get CONTRIBUTION by id
...
@return Contribution
*/
func (a *CONTRIBUTIONApiService) ContributionGet(ctx context.Context, ehrId string, contributionUid string) (Contribution, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ehr/{ehr_id}/contribution/{contribution_uid}"
	localVarPath = strings.Replace(localVarPath, "{"+"ehr_id"+"}", fmt.Sprintf("%v", ehrId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"contribution_uid"+"}", fmt.Sprintf("%v", contributionUid), -1)
