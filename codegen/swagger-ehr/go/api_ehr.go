 ...
 * @param optional nil or *EHRApiEhrCreateOpts - Optional Parameters:
     * @param "Body" (optional.Interface of EhrStatus) -  An EHR_STATUS resource MAY be also supplied by the client as the request body.
...
type EHRApiEhrCreateOpts struct {
    Body optional.Interface
    Prefer optional.String
}

func (a *EHRApiService) EhrCreate(ctx context.Context, localVarOptionals *EHRApiEhrCreateOpts) (Ehr, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/ehr"
...
/*
EHRApiService Create EHR with id
 ...
 * @param optional nil or *EHRApiEhrCreateWithIdOpts - Optional Parameters:
     * @param "Body" (optional.Interface of EhrStatus) -  An EHR_STATUS resource MAY be also supplied by the client as the request body.
...
type EHRApiEhrCreateWithIdOpts struct {
    Body optional.Interface
    Prefer optional.String
}

func (a *EHRApiService) EhrCreateWithId(ctx context.Context, ehrId string, localVarOptionals *EHRApiEhrCreateWithIdOpts) (Ehr, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ehr/{ehr_id}"
...
/*
EHRApiService Get EHR by id
Retrieve the EHR with the specified &#x60;ehr_id&#x60;. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param ehrId EHR identifier taken from EHR.ehr_id.value. 
@return Ehr
*/
func (a *EHRApiService) EhrGetById(ctx context.Context, ehrId string) (Ehr, *http.Response, error) {
	var (
...
/*
EHRApiService Get EHR by subject id
...
@return Ehr
*/
func (a *EHRApiService) EhrGetBySubject(ctx context.Context, subjectId string, subjectNamespace string) (Ehr, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	localVarQueryParams.Add("subject_id", parameterToString(subjectId, ""))
	localVarQueryParams.Add("subject_namespace", parameterToString(subjectNamespace, ""))
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
