...
type DIRECTORYApiDirectoryCreateOpts struct {
    Prefer optional.String
}

func (a *DIRECTORYApiService) DirectoryCreate(ctx context.Context, body Folder, ehrId string, localVarOptionals *DIRECTORYApiDirectoryCreateOpts) (Folder, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/ehr/{ehr_id}/directory"
...
/*
DIRECTORYApiService Delete directory
...
*/
func (a *DIRECTORYApiService) DirectoryDelete(ctx context.Context, ehrId string, ifMatch string) (*http.Response, error) {
	var (
...
/*
DIRECTORYApiService Get folder in directory version at time
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param ehrId EHR identifier taken from EHR.ehr_id.value. 
 * @param optional nil or *DIRECTORYApiDirectoryGetAtTimeOpts - Optional Parameters:
     * @param "VersionAtTime" (optional.String) -  A given time in the extended ISO 8601 format. 
     * @param "Path" (optional.String) -  A path to a sub-folder; consists of slash-separated values of the name attribute of FOLDERs in the directory. 
@return Folder
*/

type DIRECTORYApiDirectoryGetAtTimeOpts struct {
    VersionAtTime optional.String
    Path optional.String
}

func (a *DIRECTORYApiService) DirectoryGetAtTime(ctx context.Context, ehrId string, localVarOptionals *DIRECTORYApiDirectoryGetAtTimeOpts) (Folder, *http.Response, error) {
	var (
...
/*
DIRECTORYApiService Get folder in directory version
 ...
 * @param optional nil or *DIRECTORYApiDirectoryGetByVersionIdOpts - Optional Parameters:
     * @param "Path" (optional.String) -  A path to a sub-folder; consists of slash-separated values of the name attribute of FOLDERs in the directory. 
@return Folder
*/

type DIRECTORYApiDirectoryGetByVersionIdOpts struct {
    Path optional.String
}

func (a *DIRECTORYApiService) DirectoryGetByVersionId(ctx context.Context, ehrId string, versionUid string, localVarOptionals *DIRECTORYApiDirectoryGetByVersionIdOpts) (Folder, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ehr/{ehr_id}/directory/{version_uid}"
	localVarPath = strings.Replace(localVarPath, "{"+"ehr_id"+"}", fmt.Sprintf("%v", ehrId), -1)
...
/*
DIRECTORYApiService Update directory
 ...
 * @param ifMatch Header to make the request conditional.  Together with &#x60;ETag&#x60; request tag, it helps to prevent simultaneous updates of a resource from overwriting each other (\&quot;mid-air collisions\&quot;). The format is always an &#x60;version_uid&#x60; identifier enclosed by double quotes. The operation will be performed only if the existing latest &#x60;version_uid&#x60; of the resource (i.e. the &#x60;preceding_version_uid&#x60;) matches this header&#x27;s value. 
 * @param ehrId EHR identifier taken from EHR.ehr_id.value. 
 * @param optional nil or *DIRECTORYApiDirectoryUpdateOpts - Optional Parameters:
     * @param "Prefer" (optional.String) -  Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;. 
@return Folder
*/

type DIRECTORYApiDirectoryUpdateOpts struct {
    Prefer optional.String
}

func (a *DIRECTORYApiService) DirectoryUpdate(ctx context.Context, body Folder, ifMatch string, ehrId string, localVarOptionals *DIRECTORYApiDirectoryUpdateOpts) (Folder, *http.Response, error) {
	var (
