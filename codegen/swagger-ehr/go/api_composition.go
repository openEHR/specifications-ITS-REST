...
/*
COMPOSITIONApiService Create COMPOSITION
 ...
 * @param optional nil or *COMPOSITIONApiCompositionCreateOpts - Optional Parameters:
     * @param "Prefer" (optional.String) -  Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;. 
@return Composition
*/

type COMPOSITIONApiCompositionCreateOpts struct {
    Prefer optional.String
}

func (a *COMPOSITIONApiService) CompositionCreate(ctx context.Context, body Composition, ehrId string, localVarOptionals *COMPOSITIONApiCompositionCreateOpts) (Composition, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/ehr/{ehr_id}/composition"
	localVarPath = strings.Replace(localVarPath, "{"+"ehr_id"+"}", fmt.Sprintf("%v", ehrId), -1)
...
/*
COMPOSITIONApiService Delete COMPOSITION
...
*/
func (a *COMPOSITIONApiService) CompositionDelete(ctx context.Context, ehrId string, uidBasedId string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ehr/{ehr_id}/composition/{uid_based_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"ehr_id"+"}", fmt.Sprintf("%v", ehrId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"uid_based_id"+"}", fmt.Sprintf("%v", uidBasedId), -1)
...
/*
COMPOSITIONApiService Get COMPOSITION
 ...
 * @param optional nil or *COMPOSITIONApiCompositionGetOpts - Optional Parameters:
     * @param "VersionAtTime" (optional.String) -  A given time in the extended ISO 8601 format. 
@return Composition
*/

type COMPOSITIONApiCompositionGetOpts struct {
    VersionAtTime optional.String
}

func (a *COMPOSITIONApiService) CompositionGet(ctx context.Context, ehrId string, uidBasedId string, localVarOptionals *COMPOSITIONApiCompositionGetOpts) (Composition, *http.Response, error) {
	var (
	...
	if localVarOptionals != nil && localVarOptionals.VersionAtTime.IsSet() {
		localVarQueryParams.Add("version_at_time", parameterToString(localVarOptionals.VersionAtTime.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
/*
COMPOSITIONApiService Update COMPOSITION
 ...
 * @param optional nil or *COMPOSITIONApiCompositionUpdateOpts - Optional Parameters:
     * @param "Prefer" (optional.String) -  Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;. 
@return Composition
*/

type COMPOSITIONApiCompositionUpdateOpts struct {
    Prefer optional.String
}

func (a *COMPOSITIONApiService) CompositionUpdate(ctx context.Context, body Composition, ifMatch string, ehrId string, uidBasedId string, localVarOptionals *COMPOSITIONApiCompositionUpdateOpts) (Composition, *http.Response, error) {
	var (
...
/*
COMPOSITIONApiService Get versioned COMPOSITION
...
*/
func (a *COMPOSITIONApiService) VersionedCompositionGet(ctx context.Context, ehrId string, versionedObjectUid string) (VersionedComposition, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ehr/{ehr_id}/versioned_composition/{versioned_object_uid}"
	localVarPath = strings.Replace(localVarPath, "{"+"ehr_id"+"}", fmt.Sprintf("%v", ehrId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"versioned_object_uid"+"}", fmt.Sprintf("%v", versionedObjectUid), -1)
...
/*
COMPOSITIONApiService Get versioned COMPOSITION revision history
...
*/
func (a *COMPOSITIONApiService) VersionedCompositionRevisionHistory(ctx context.Context, ehrId string, versionedObjectUid string) (RevisionHistory, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ehr/{ehr_id}/versioned_composition/{versioned_object_uid}/revision_history"
	localVarPath = strings.Replace(localVarPath, "{"+"ehr_id"+"}", fmt.Sprintf("%v", ehrId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"versioned_object_uid"+"}", fmt.Sprintf("%v", versionedObjectUid), -1)
...
/*
COMPOSITIONApiService Get versioned COMPOSITION version at time
 ...
 * @param ehrId EHR identifier taken from EHR.ehr_id.value. 
 * @param versionedObjectUid VERSIONED_COMPOSITION identifier taken from VERSIONED_COMPOSITION.uid.value. 
 * @param optional nil or *COMPOSITIONApiVersionedCompositionVersionGetAtTimeOpts - Optional Parameters:
     * @param "VersionAtTime" (optional.String) -  A given time in the extended ISO 8601 format. 
@return Version
*/

type COMPOSITIONApiVersionedCompositionVersionGetAtTimeOpts struct {
    VersionAtTime optional.String
}

func (a *COMPOSITIONApiService) VersionedCompositionVersionGetAtTime(ctx context.Context, ehrId string, versionedObjectUid string, localVarOptionals *COMPOSITIONApiVersionedCompositionVersionGetAtTimeOpts) (Version, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ehr/{ehr_id}/versioned_composition/{versioned_object_uid}/version"
	localVarPath = strings.Replace(localVarPath, "{"+"ehr_id"+"}", fmt.Sprintf("%v", ehrId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"versioned_object_uid"+"}", fmt.Sprintf("%v", versionedObjectUid), -1)
...
/*
COMPOSITIONApiService Get versioned COMPOSITION version by id
...
@return Version
*/
func (a *COMPOSITIONApiService) VersionedCompositionVersionGetById(ctx context.Context, ehrId string, versionedObjectUid string, versionUid string) (Version, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ehr/{ehr_id}/versioned_composition/{versioned_object_uid}/version/{version_uid}"
	localVarPath = strings.Replace(localVarPath, "{"+"ehr_id"+"}", fmt.Sprintf("%v", ehrId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"versioned_object_uid"+"}", fmt.Sprintf("%v", versionedObjectUid), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"version_uid"+"}", fmt.Sprintf("%v", versionUid), -1)
