...
@JsonSubTypes({
  @JsonSubTypes.Type(value = DvBoolean.class, name = "DV_INTERVAL"),
  @JsonSubTypes.Type(value = DvCodedText.class, name = "DV_INTERVAL"),
  @JsonSubTypes.Type(value = DvCount.class, name = "DV_INTERVAL"),
  @JsonSubTypes.Type(value = DvDateTime.class, name = "DV_INTERVAL"),
  @JsonSubTypes.Type(value = DvDuration.class, name = "DV_INTERVAL"),
  @JsonSubTypes.Type(value = DvEhrUri.class, name = "DV_INTERVAL"),
  @JsonSubTypes.Type(value = DvIdentifier.class, name = "DV_INTERVAL"),
  ...
  @JsonSubTypes.Type(value = DvMultimedia.class, name = "DV_INTERVAL"),
  @JsonSubTypes.Type(value = DvOrdinal.class, name = "DV_INTERVAL"),
  @JsonSubTypes.Type(value = DvParsable.class, name = "DV_INTERVAL"),
  @JsonSubTypes.Type(value = DvProportion.class, name = "DV_INTERVAL"),
  @JsonSubTypes.Type(value = DvQuantity.class, name = "DV_INTERVAL"),
  @JsonSubTypes.Type(value = DvScale.class, name = "DV_INTERVAL"),
  @JsonSubTypes.Type(value = DvText.class, name = "DV_INTERVAL"),
  @JsonSubTypes.Type(value = DvUri.class, name = "DV_INTERVAL"),
  @JsonSubTypes.Type(value = DvIntervalOfDateTime.class, name = "DV_INTERVAL")
})
