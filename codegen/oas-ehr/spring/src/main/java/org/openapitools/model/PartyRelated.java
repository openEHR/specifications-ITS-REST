...
@JsonSubTypes({
  @JsonSubTypes.Type(value = PartyIdentified.class, name = "PARTY_RELATED"),
...
public class PartyRelated extends PartyIdentified {
  ...
  */
  @NotNull @Valid 
  @Schema(name = "relationship", required = true)
  ...
  public PartyRelated identifiers(List<DvIdentifier> identifiers) {
