...
@JsonSubTypes({
  @JsonSubTypes.Type(value = ItemList.class, name = "ITEM_SINGLE"),
  @JsonSubTypes.Type(value = ItemSingle.class, name = "ITEM_SINGLE"),
  @JsonSubTypes.Type(value = ItemTable.class, name = "ITEM_SINGLE"),
  @JsonSubTypes.Type(value = ItemTree.class, name = "ITEM_SINGLE")
})
...
public class ItemSingle extends ItemStructure {
  ...
  */
  ...
  public ItemSingle links(List<Link> links) {
