...
@JsonSubTypes({
  @JsonSubTypes.Type(value = DvDate.class, name = "DV_TIME"),
  @JsonSubTypes.Type(value = DvDateTime.class, name = "DV_TIME"),
...
public class DvTime extends DvTemporal {
  ...
  */
  ...
  public DvTime otherReferenceRanges(List<ReferenceRange> otherReferenceRanges) {
