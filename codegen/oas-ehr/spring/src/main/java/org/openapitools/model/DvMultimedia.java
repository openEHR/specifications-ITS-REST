...
@JsonSubTypes({
  ...
  @JsonSubTypes.Type(value = DvParsable.class, name = "DV_MULTIMEDIA")
})
...
public class DvMultimedia extends DvEncapsulated {
  ...
  */
  ...
  @Schema(name = "alternate_text", required = false)
  ...
  */
  @Valid 
  @Schema(name = "compression_algorithm", required = false)
  ...
  */
  ...
  @Schema(name = "integrity_check", required = false)
  ...
  */
  @Valid 
  @Schema(name = "integrity_check_algorithm", required = false)
  ...
  */
  @Valid 
  @Schema(name = "thumbnail", required = false)
