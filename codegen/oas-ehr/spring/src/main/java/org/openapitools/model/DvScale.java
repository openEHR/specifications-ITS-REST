...
@JsonSubTypes({
  @JsonSubTypes.Type(value = DvAmount.class, name = "DV_SCALE"),
  @JsonSubTypes.Type(value = DvCount.class, name = "DV_SCALE"),
  @JsonSubTypes.Type(value = DvDate.class, name = "DV_SCALE"),
  ...
  @JsonSubTypes.Type(value = DvQuantified.class, name = "DV_SCALE"),
  @JsonSubTypes.Type(value = DvQuantity.class, name = "DV_SCALE"),
  @JsonSubTypes.Type(value = DvScale.class, name = "DV_SCALE"),
  @JsonSubTypes.Type(value = DvTemporal.class, name = "DV_SCALE"),
  @JsonSubTypes.Type(value = DvTime.class, name = "DV_SCALE")
})
