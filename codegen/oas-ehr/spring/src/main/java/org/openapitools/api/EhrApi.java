...
@Validated
@Tag(name = "ehr", description = "Management of [COMPOSITION](https://specifications.openehr.org/releases/RM/latest/ehr.html#_composition_class) and [VERSIONED_COMPOSITION](https://specifications.openehr.org/releases/RM/latest/ehr.html#_versioned_composition_class) resources.
...
public interface EhrApi {
    ...
    default ResponseEntity<Composition> compositionCreate(
        @Parameter(name = "ehr_id", description = "EHR identifier taken from EHR.ehr_id.value. ", required = true) @PathVariable("ehr_id") String ehrId,
        @Parameter(name = "Composition", description = "The COMPOSITION. ", required = true) @Valid @RequestBody Composition composition,
        @Parameter(name = "Prefer", description = "Request header to indicate the preference over response details. The response will contain the entire resource when the `Prefer` header has a value of `return=representation`. ") @RequestHeader(value = "Prefer", required = false, defaultValue = "return=minimal") String prefer
    ) {
    ...
    default ResponseEntity<Void> compositionDelete(
        @Parameter(name = "ehr_id", description = "EHR identifier taken from EHR.ehr_id.value. ", required = true) @PathVariable("ehr_id") String ehrId,
        @Parameter(name = "uid_based_id", description = "An identifier in a form of an OBJECT_VERSION_ID identifier taken from VERSION.uid.value (i.e. a `version_uid`). ", required = true) @PathVariable("uid_based_id") String uidBasedId
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<Composition> compositionGet(
        @Parameter(name = "ehr_id", description = "EHR identifier taken from EHR.ehr_id.value. ", required = true) @PathVariable("ehr_id") String ehrId,
        @Parameter(name = "uid_based_id", description = "An abstract identifier: it can take a form of an OBJECT_VERSION_ID identifier taken from VERSION.uid.value (i.e. a `version_uid`), or a form of a HIER_OBJECT_ID identifier taken from VERSIONED_OBJECT.uid.value (i.e. a `versioned_object_uid`). ", required = true) @PathVariable("uid_based_id") String uidBasedId,
        @Parameter(name = "version_at_time", description = "A given time in the extended ISO 8601 format. ") @Valid @RequestParam(value = "version_at_time", required = false) String versionAtTime
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<Composition> compositionUpdate(
        @Parameter(name = "ehr_id", description = "EHR identifier taken from EHR.ehr_id.value. ", required = true) @PathVariable("ehr_id") String ehrId,
        @Parameter(name = "uid_based_id", description = "An identifier in a form of a HIER_OBJECT_ID identifier taken from VERSIONED_OBJECT.uid.value (i.e. a `versioned_object_uid`). ", required = true) @PathVariable("uid_based_id") String uidBasedId,
        @NotNull @Parameter(name = "If-Match", description = "Header to make the request conditional.  Together with `ETag` request tag, it helps to prevent simultaneous updates of a resource from overwriting each other (\"mid-air collisions\"). The format is always an `version_uid` identifier enclosed by double quotes. The operation will be performed only if the existing latest `version_uid` of the resource (i.e. the `preceding_version_uid`) matches this header's value. ", required = true) @RequestHeader(value = "If-Match", required = true) String ifMatch,
    ...
    default ResponseEntity<Contribution> contributionGet(
        @Parameter(name = "ehr_id", description = "EHR identifier taken from EHR.ehr_id.value. ", required = true) @PathVariable("ehr_id") String ehrId,
        @Parameter(name = "contribution_uid", description = "The CONTRIBUTION uid. ", required = true) @PathVariable("contribution_uid") String contributionUid
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<Folder> directoryGetAtTime(
        @Parameter(name = "ehr_id", description = "EHR identifier taken from EHR.ehr_id.value. ", required = true) @PathVariable("ehr_id") String ehrId,
        @Parameter(name = "version_at_time", description = "A given time in the extended ISO 8601 format. ") @Valid @RequestParam(value = "version_at_time", required = false) String versionAtTime,
        @Parameter(name = "path", description = "A path to a sub-folder; consists of slash-separated values of the name attribute of FOLDERs in the directory. ") @Valid @RequestParam(value = "path", required = false) String path
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<Folder> directoryGetByVersionId(
        @Parameter(name = "ehr_id", description = "EHR identifier taken from EHR.ehr_id.value. ", required = true) @PathVariable("ehr_id") String ehrId,
        @Parameter(name = "version_uid", description = "VERSION identifier taken from VERSION.uid.value. ", required = true) @PathVariable("version_uid") String versionUid,
        @Parameter(name = "path", description = "A path to a sub-folder; consists of slash-separated values of the name attribute of FOLDERs in the directory. ") @Valid @RequestParam(value = "path", required = false) String path
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
    ...
    default ResponseEntity<Ehr> ehrGetBySubject(
        @NotNull @Parameter(name = "subject_id", description = "The EHR subject id. ", required = true) @Valid @RequestParam(value = "subject_id", required = true) String subjectId,
        @NotNull @Parameter(name = "subject_namespace", description = "The EHR subject id namespace. ", required = true) @Valid @RequestParam(value = "subject_namespace", required = true) String subjectNamespace
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default ResponseEntity<VersionedComposition> versionedCompositionGet(
        @Parameter(name = "ehr_id", description = "EHR identifier taken from EHR.ehr_id.value. ", required = true) @PathVariable("ehr_id") String ehrId,
        @Parameter(name = "versioned_object_uid", description = "VERSIONED_COMPOSITION identifier taken from VERSIONED_COMPOSITION.uid.value. ", required = true) @PathVariable("versioned_object_uid") String versionedObjectUid
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
