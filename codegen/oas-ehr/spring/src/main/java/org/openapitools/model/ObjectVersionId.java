...
@JsonSubTypes({
  @JsonSubTypes.Type(value = HierObjectId.class, name = "OBJECT_VERSION_ID"),
...
public class ObjectVersionId extends UidBasedId {
  ...
  */
  @NotNull 
  @Schema(name = "value", example = "6cb19121-4307-4648-9da0-d62e4d51f19b::openEHRSys.example.com::2", required = true)
