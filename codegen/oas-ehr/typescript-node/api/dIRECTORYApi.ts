...
export enum DIRECTORYApiApiKeys {
}
...
export class DIRECTORYApi {
    ...
    public setApiKey(key: DIRECTORYApiApiKeys, value: string) {
        (this.authentications as any)[DIRECTORYApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async directoryCreate (ehrId: string, folder: Folder, prefer?: 'return=representation' | 'return=minimal', options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Folder;  }> {
        const localVarPath = this.basePath + '/ehr/{ehr_id}/directory'
        ...
        if (folder === null || folder === undefined) {
            throw new Error('Required parameter folder was null or undefined when calling directoryCreate.');
        }
     ...
     */
    public async directoryDelete (ehrId: string, ifMatch: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/ehr/{ehr_id}/directory'
            .replace('{' + 'ehr_id' + '}', encodeURIComponent(String(ehrId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async directoryGetAtTime (ehrId: string, versionAtTime?: string, path?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Folder;  }> {
        const localVarPath = this.basePath + '/ehr/{ehr_id}/directory'
            .replace('{' + 'ehr_id' + '}', encodeURIComponent(String(ehrId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param path A path to a sub-folder; consists of slash-separated values of the name attribute of FOLDERs in the directory. 
     */
    public async directoryGetByVersionId (ehrId: string, versionUid: string, path?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Folder;  }> {
        const localVarPath = this.basePath + '/ehr/{ehr_id}/directory/{version_uid}'
            .replace('{' + 'ehr_id' + '}', encodeURIComponent(String(ehrId)))
     ...
     * @param prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;. 
     */
    public async directoryUpdate (ehrId: string, ifMatch: string, folder: Folder, prefer?: 'return=representation' | 'return=minimal', options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Folder;  }> {
        const localVarPath = this.basePath + '/ehr/{ehr_id}/directory'
            .replace('{' + 'ehr_id' + '}', encodeURIComponent(String(ehrId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'folder' is not null or undefined
        if (folder === null || folder === undefined) {
            throw new Error('Required parameter folder was null or undefined when calling directoryUpdate.');
        }
