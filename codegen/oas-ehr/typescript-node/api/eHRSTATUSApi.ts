...
export enum EHRSTATUSApiApiKeys {
}
...
export class EHRSTATUSApi {
    ...
    public setApiKey(key: EHRSTATUSApiApiKeys, value: string) {
        (this.authentications as any)[EHRSTATUSApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async ehrStatusGetAtTime (ehrId: string, versionAtTime?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: EhrStatus;  }> {
        const localVarPath = this.basePath + '/ehr/{ehr_id}/ehr_status'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: EhrStatus;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "EhrStatus");
     ...
     */
    public async ehrStatusGetByVersionId (ehrId: string, versionUid: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: EhrStatus;  }> {
        const localVarPath = this.basePath + '/ehr/{ehr_id}/ehr_status/{version_uid}'
            .replace('{' + 'ehr_id' + '}', encodeURIComponent(String(ehrId)))
     ...
     */
    public async ehrStatusUpdate (ehrId: string, ifMatch: string, ehrStatus: EhrStatus, prefer?: 'return=representation' | 'return=minimal', options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: EhrStatus;  }> {
        const localVarPath = this.basePath + '/ehr/{ehr_id}/ehr_status'
            .replace('{' + 'ehr_id' + '}', encodeURIComponent(String(ehrId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'ehrStatus' is not null or undefined
        if (ehrStatus === null || ehrStatus === undefined) {
            throw new Error('Required parameter ehrStatus was null or undefined when calling ehrStatusUpdate.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(ehrStatus, "EhrStatus")
        };
     ...
     * @param ehrId EHR identifier taken from EHR.ehr_id.value. 
     */
    public async versionedEhrStatusGet (ehrId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VersionedEhrStatus;  }> {
        const localVarPath = this.basePath + '/ehr/{ehr_id}/versioned_ehr_status'
            .replace('{' + 'ehr_id' + '}', encodeURIComponent(String(ehrId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: VersionedEhrStatus;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "VersionedEhrStatus");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param ehrId EHR identifier taken from EHR.ehr_id.value. 
     */
    public async versionedEhrStatusRevisionHistory (ehrId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RevisionHistory;  }> {
        const localVarPath = this.basePath + '/ehr/{ehr_id}/versioned_ehr_status/revision_history'
            .replace('{' + 'ehr_id' + '}', encodeURIComponent(String(ehrId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
     ...
     * @param versionAtTime A given time in the extended ISO 8601 format. 
     */
    public async versionedEhrStatusVersionGetAtTime (ehrId: string, versionAtTime?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Version;  }> {
        const localVarPath = this.basePath + '/ehr/{ehr_id}/versioned_ehr_status/version'
            .replace('{' + 'ehr_id' + '}', encodeURIComponent(String(ehrId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
     ...
     * @param versionUid VERSION identifier taken from VERSION.uid.value. 
     */
    public async versionedEhrStatusVersionGetById (ehrId: string, versionUid: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Version;  }> {
        const localVarPath = this.basePath + '/ehr/{ehr_id}/versioned_ehr_status/version/{version_uid}'
            .replace('{' + 'ehr_id' + '}', encodeURIComponent(String(ehrId)))
            .replace('{' + 'version_uid' + '}', encodeURIComponent(String(versionUid)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
