...
let defaultBasePath = 'https://openEHRSys.example.com/v1';

// ===============================================
// This file is autogenerated - Please do not edit
// ===============================================

export enum COMPOSITIONApiApiKeys {
}
...
export class COMPOSITIONApi {
    ...
    public setApiKey(key: COMPOSITIONApiApiKeys, value: string) {
        (this.authentications as any)[COMPOSITIONApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async compositionCreate (ehrId: string, composition: Composition, prefer?: 'return=representation' | 'return=minimal', options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Composition;  }> {
        const localVarPath = this.basePath + '/ehr/{ehr_id}/composition'
        ...
        if (composition === null || composition === undefined) {
            throw new Error('Required parameter composition was null or undefined when calling compositionCreate.');
        }

        localVarHeaderParams['Prefer'] = ObjectSerializer.serialize(prefer, "'return=representation' | 'return=minimal'");
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(composition, "Composition")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Composition;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "Composition");
     ...
     */
    public async compositionDelete (ehrId: string, uidBasedId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/ehr/{ehr_id}/composition/{uid_based_id}'
            .replace('{' + 'ehr_id' + '}', encodeURIComponent(String(ehrId)))
     ...
     */
    public async compositionGet (ehrId: string, uidBasedId: string, versionAtTime?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Composition;  }> {
        const localVarPath = this.basePath + '/ehr/{ehr_id}/composition/{uid_based_id}'
            .replace('{' + 'ehr_id' + '}', encodeURIComponent(String(ehrId)))
            .replace('{' + 'uid_based_id' + '}', encodeURIComponent(String(uidBasedId)));
        let localVarQueryParameters: any = {};
        ...
        if (versionAtTime !== undefined) {
            localVarQueryParameters['version_at_time'] = ObjectSerializer.serialize(versionAtTime, "string");
        }
     ...
     * @param prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;. 
     */
    public async compositionUpdate (ehrId: string, uidBasedId: string, ifMatch: string, composition: Composition, prefer?: 'return=representation' | 'return=minimal', options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Composition;  }> {
        const localVarPath = this.basePath + '/ehr/{ehr_id}/composition/{uid_based_id}'
            .replace('{' + 'ehr_id' + '}', encodeURIComponent(String(ehrId)))
            .replace('{' + 'uid_based_id' + '}', encodeURIComponent(String(uidBasedId)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'composition' is not null or undefined
        if (composition === null || composition === undefined) {
            throw new Error('Required parameter composition was null or undefined when calling compositionUpdate.');
        }
     ...
     */
    public async versionedCompositionGet (ehrId: string, versionedObjectUid: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VersionedComposition;  }> {
        const localVarPath = this.basePath + '/ehr/{ehr_id}/versioned_composition/{versioned_object_uid}'
            .replace('{' + 'ehr_id' + '}', encodeURIComponent(String(ehrId)))
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: VersionedComposition;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "VersionedComposition");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param versionedObjectUid VERSIONED_COMPOSITION identifier taken from VERSIONED_COMPOSITION.uid.value. 
     */
    public async versionedCompositionRevisionHistory (ehrId: string, versionedObjectUid: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RevisionHistory;  }> {
        const localVarPath = this.basePath + '/ehr/{ehr_id}/versioned_composition/{versioned_object_uid}/revision_history'
            .replace('{' + 'ehr_id' + '}', encodeURIComponent(String(ehrId)))
            .replace('{' + 'versioned_object_uid' + '}', encodeURIComponent(String(versionedObjectUid)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: RevisionHistory;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "RevisionHistory");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param versionAtTime A given time in the extended ISO 8601 format. 
     */
    public async versionedCompositionVersionGetAtTime (ehrId: string, versionedObjectUid: string, versionAtTime?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Version;  }> {
        const localVarPath = this.basePath + '/ehr/{ehr_id}/versioned_composition/{versioned_object_uid}/version'
            .replace('{' + 'ehr_id' + '}', encodeURIComponent(String(ehrId)))
            .replace('{' + 'versioned_object_uid' + '}', encodeURIComponent(String(versionedObjectUid)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async versionedCompositionVersionGetById (ehrId: string, versionedObjectUid: string, versionUid: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Version;  }> {
        const localVarPath = this.basePath + '/ehr/{ehr_id}/versioned_composition/{versioned_object_uid}/version/{version_uid}'
            .replace('{' + 'ehr_id' + '}', encodeURIComponent(String(ehrId)))
            .replace('{' + 'versioned_object_uid' + '}', encodeURIComponent(String(versionedObjectUid)))
