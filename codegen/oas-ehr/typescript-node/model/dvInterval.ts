...
export class DvInterval extends DataValue {
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "baseName": "lower_unbounded",
            "type": "boolean"
        },
        {
            "name": "upper_unbounded",
            "baseName": "upper_unbounded",
            "type": "boolean"
        },
        {
            "name": "lower_included",
            "baseName": "lower_included",
            "type": "boolean"
        },
        {
            "name": "upper_included",
            "baseName": "upper_included",
            "type": "boolean"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(DvInterval.attributeTypeMap);
    }
}
