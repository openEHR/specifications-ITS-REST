    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "baseName": "originating_system_item_ids",
            "type": "Array<DvIdentifier>"
        },
        {
            "name": "feeder_system_item_ids",
            "baseName": "feeder_system_item_ids",
            "type": "Array<DvIdentifier>"
        },
        {
            "name": "original_content",
            "baseName": "original_content",
            "type": "DvEncapsulated"
        },
        {
            "name": "originating_system_audit",
            "baseName": "originating_system_audit",
            "type": "FeederAuditDetails"
        },
        {
            "name": "feeder_system_audit",
            "baseName": "feeder_system_audit",
            "type": "FeederAuditDetails"
        }    ];

    static getAttributeTypeMap() {
        return FeederAudit.attributeTypeMap;
    }
}
