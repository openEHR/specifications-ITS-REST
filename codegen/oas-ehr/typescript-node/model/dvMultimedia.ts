...
export class DvMultimedia extends DvEncapsulated {
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "baseName": "compression_algorithm",
            "type": "CodePhrase"
        },
        {
        ...
        },
        {
            ...
            "baseName": "integrity_check_algorithm",
            "type": "CodePhrase"
        },
        {
            "name": "thumbnail",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(DvMultimedia.attributeTypeMap);
    }
}
