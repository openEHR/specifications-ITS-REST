...
export class EhrStatus extends Versionable {
    '_type'?: string = 'EHR_STATUS';
    'subject': PartyProxy;
    'is_queryable': boolean = true;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "is_queryable",
            "baseName": "is_queryable",
            "type": "boolean"
        },
        {
            "name": "is_modifiable",
            "baseName": "is_modifiable",
            "type": "boolean"
        },
        {
            "name": "other_details",
            "baseName": "other_details",
            "type": "ItemStructure"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(EhrStatus.attributeTypeMap);
    }
}
