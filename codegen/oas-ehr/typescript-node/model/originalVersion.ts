...
export class OriginalVersion extends Version {
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "baseName": "preceding_version_uid",
            "type": "ObjectVersionId"
        },
        {
            "name": "other_input_version_uids",
            "baseName": "other_input_version_uids",
            "type": "Array<ObjectVersionId>"
        },
        {
            "name": "lifecycle_state",
            "baseName": "lifecycle_state",
            "type": "DvCodedText"
        },
        {
            "name": "attestations",
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(OriginalVersion.attributeTypeMap);
    }
}
