...
class TestNewContribution(unittest.TestCase):
    """NewContribution unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NewContribution:
        """Test NewContribution
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewContribution`
        """
        model = NewContribution()
        if include_optional:
            return NewContribution(
                uid = openapi_client.models.hier_object_id.HIER_OBJECT_ID(
                    value = '6cb19121-4307-4648-9da0-d62e4d51f19b', ),
                versions = [
                    openapi_client.models.update_version.UPDATE_VERSION(
                        preceding_version_uid = openapi_client.models.object_version_id.OBJECT_VERSION_ID(
                            value = '6cb19121-4307-4648-9da0-d62e4d51f19b::openEHRSys.example.com::2', ), 
                        signature = '', 
                        lifecycle_state = {"terminology_id":"snomed_ct","code_string":"308335008"}, 
                        attestations = [
                            openapi_client.models.update_attestation.UPDATE_ATTESTATION(
                                _type = 'UPDATE_ATTESTATION', 
                                attested_view = openapi_client.models.dv_multimedia.DV_MULTIMEDIA(
                                    _type = 'DV_MULTIMEDIA', 
                                    alternate_text = '', 
                                    uri = openapi_client.models.dv_uri.DV_URI(
                                        value = '', ), 
                                    data = '', 
                                    media_type = {"terminology_id":{"value":"local"},"code_string":"at0001"}, 
                                    compression_algorithm = {"terminology_id":{"value":"local"},"code_string":"at0001"}, 
                                    integrity_check = '', 
                                    integrity_check_algorithm = {"terminology_id":{"value":"local"},"code_string":"at0001"}, 
                                    thumbnail = openapi_client.models.dv_multimedia.DV_MULTIMEDIA(
                                        _type = 'DV_MULTIMEDIA', 
                                        alternate_text = '', 
                                        data = '', 
                                        media_type = {"terminology_id":{"value":"local"},"code_string":"at0001"}, 
                                ...
                                proof = '', 
                                items = [
                                    {"_type":"DV_EHR_URI","value":"ehr://system_id/ehr_id/top_level_structure_locator/path_inside_top_level_structure"}
                                    ], 
                                reason = openapi_client.models.dv_text.DV_TEXT(
                                    value = '', 
                        ...
                        data = openapi_client.models.versionable.Versionable(), 
                        commit_audit = {"change_type":{"value":"creation","defining_code":{"terminology_id":"openehr","code_string":"249"}},"description":"Description text","committer":{"_type":"PARTY_IDENTIFIED","name":"A user name"}}, )
                    ],
                audit = {"change_type":{"value":"creation","defining_code":{"terminology_id":"openehr","code_string":"249"}},"description":"Description text","committer":{"_type":"PARTY_IDENTIFIED","name":"A user name"}}
            )
        else:
            return NewContribution(
                versions = [
