...
class TestDvQuantity(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DvQuantity:
        """Test DvQuantity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DvQuantity`
        """
        model = DvQuantity()
        if include_optional:
            return DvQuantity(
