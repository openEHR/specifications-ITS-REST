...
class TestArchetyped(unittest.TestCase):
    """Archetyped unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Archetyped:
        """Test Archetyped
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Archetyped`
        """
        model = Archetyped()
        if include_optional:
            return Archetyped(
                archetype_id = openapi_client.models.archetype_id.ARCHETYPE_ID(
                    _type = 'ARCHETYPE_ID', ),
                template_id = openapi_client.models.template_id.TEMPLATE_ID(
                    _type = 'TEMPLATE_ID', ),
                rm_version = ''
            )
        else:
