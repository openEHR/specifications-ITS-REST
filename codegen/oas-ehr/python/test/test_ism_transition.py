...
class TestIsmTransition(unittest.TestCase):
    """IsmTransition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IsmTransition:
        """Test IsmTransition
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IsmTransition`
        """
        model = IsmTransition()
        if include_optional:
