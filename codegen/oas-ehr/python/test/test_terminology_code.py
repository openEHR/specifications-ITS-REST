...
class TestTerminologyCode(unittest.TestCase):
    """TerminologyCode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TerminologyCode:
        """Test TerminologyCode
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TerminologyCode`
        """
