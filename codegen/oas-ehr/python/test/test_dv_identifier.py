...
class TestDvIdentifier(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DvIdentifier:
        """Test DvIdentifier
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DvIdentifier`
        """
        model = DvIdentifier()
        if include_optional:
            return DvIdentifier(
