...
class TestUpdateAudit(unittest.TestCase):
    """UpdateAudit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAudit:
        """Test UpdateAudit
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAudit`
        """
        model = UpdateAudit()
        if include_optional:
            return UpdateAudit(
                type = 'UPDATE_AUDIT',
                change_type = {"terminology_id":"snomed_ct","code_string":"308335008"},
                description = openapi_client.models.dv_text.DV_TEXT(
                    value = '', 
                ...
                committer = openapi_client.models.party_proxy.PARTY_PROXY(
                    _type = 'PARTY_PROXY', 
