...
class TestUpdateAttestation(unittest.TestCase):
    """UpdateAttestation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAttestation:
        """Test UpdateAttestation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAttestation`
        """
        model = UpdateAttestation()
        if include_optional:
    ...
    def testUpdateAttestation(self):
        """Test UpdateAttestation"""
