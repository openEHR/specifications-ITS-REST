...
class TestInstructionDetails(unittest.TestCase):
    """InstructionDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstructionDetails:
        """Test InstructionDetails
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstructionDetails`
        """
        model = InstructionDetails()
        if include_optional:
    ...
    def testInstructionDetails(self):
        """Test InstructionDetails"""
