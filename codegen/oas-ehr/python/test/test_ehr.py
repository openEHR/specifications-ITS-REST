...
class TestEhr(unittest.TestCase):
    """Ehr unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Ehr:
        """Test Ehr
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Ehr`
        """
        model = Ehr()
        if include_optional:
            return Ehr(
                system_id = openapi_client.models.hier_object_id.HIER_OBJECT_ID(
                    value = '6cb19121-4307-4648-9da0-d62e4d51f19b', ),
                ehr_id = openapi_client.models.hier_object_id.HIER_OBJECT_ID(
                    value = '6cb19121-4307-4648-9da0-d62e4d51f19b', ),
                ehr_status = {"id":{"_type":"OBJECT_VERSION_ID","value":"fb458d9c-1323-42bc-b7f8-787f3660a0b5::openEHRSys.example.com::1"},"namespace":"local","type":"COMPOSITION"},
                ehr_access = {"id":{"_type":"OBJECT_VERSION_ID","value":"fb458d9c-1323-42bc-b7f8-787f3660a0b5::openEHRSys.example.com::1"},"namespace":"local","type":"COMPOSITION"},
                time_created = {"_type":"DV_DATE_TIME","value":"2017-08-15T10:37:15.422+02:00"}
            )
        else:
            return Ehr(
        )
