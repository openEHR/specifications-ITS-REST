...
class TestLocatableRef(unittest.TestCase):
    """LocatableRef unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocatableRef:
        """Test LocatableRef
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocatableRef`
        """
        model = LocatableRef()
        if include_optional:
            return LocatableRef(
