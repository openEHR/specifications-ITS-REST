...
class TestCodePhrase(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CodePhrase:
        """Test CodePhrase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CodePhrase`
        """
        model = CodePhrase()
        if include_optional:
            return CodePhrase(
                terminology_id = openapi_client.models.terminology_id.TERMINOLOGY_ID(
