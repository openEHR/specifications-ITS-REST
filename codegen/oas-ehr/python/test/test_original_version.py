...
class TestOriginalVersion(unittest.TestCase):
    """OriginalVersion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OriginalVersion:
        """Test OriginalVersion
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OriginalVersion`
        """
        ...
        if include_optional:
            return OriginalVersion(
                ...
                other_input_version_uids = [
                    openapi_client.models.object_version_id.OBJECT_VERSION_ID(
                        value = '6cb19121-4307-4648-9da0-d62e4d51f19b::openEHRSys.example.com::2', )
                    ],
