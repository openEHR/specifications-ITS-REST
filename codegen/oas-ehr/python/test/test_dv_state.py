...
class TestDvState(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DvState:
        """Test DvState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DvState`
        """
        model = DvState()
        if include_optional:
            return DvState(
                type = 'DV_STATE',
                value = {"value":"Coded text value","defining_code":{"terminology_id":{"value":"local"},"code_string":"at0001"}},
                is_terminal = True
            )
        else:
            return DvState(
