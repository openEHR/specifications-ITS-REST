...
class TestDvScale(unittest.TestCase):
    """DvScale unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DvScale:
        """Test DvScale
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DvScale`
        """
        model = DvScale()
        if include_optional:
            return DvScale(
                type = 'DV_SCALE',
                symbol = {"value":"Coded text value","defining_code":{"terminology_id":{"value":"local"},"code_string":"at0001"}},
                value = 1.337
            )
        else:
            return DvScale(
