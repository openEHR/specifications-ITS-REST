...
class TestDvInterval(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DvInterval:
        """Test DvInterval
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DvInterval`
        """
        model = DvInterval()
        if include_optional:
            return DvInterval(
