    ...
    def make_instance(self, include_optional) -> Action:
        ...
        if include_optional:
            return Action(
                ...
                ism_transition = openapi_client.models.ism_transition.ISM_TRANSITION(
                    _type = 'ISM_TRANSITION', 
                    current_state = {"value":"Coded text value","defining_code":{"terminology_id":{"value":"local"},"code_string":"at0001"}}, 
                    transition = {"value":"Coded text value","defining_code":{"terminology_id":{"value":"local"},"code_string":"at0001"}}, 
                    careflow_step = {"value":"Coded text value","defining_code":{"terminology_id":{"value":"local"},"code_string":"at0001"}}, 
                    reason = [
                        openapi_client.models.dv_text.DV_TEXT(
                            value = '', 
                ...
                instruction_details = openapi_client.models.instruction_details.INSTRUCTION_DETAILS(
                    _type = 'INSTRUCTION_DETAILS', 
                    instruction_id = openapi_client.models.locatable_ref.LOCATABLE_REF(
                        namespace = '', 
                        type = '', 
                        id = openapi_client.models.uid_based_id.UID_BASED_ID(), 
                        path = '', ), 
                    activity_id = '', 
                    wf_details = openapi_client.models.item_structure.ITEM_STRUCTURE(), ),
                description = openapi_client.models.item_structure.ITEM_STRUCTURE()
            )
        else:
            return Action(
                time = {"_type":"DV_DATE_TIME","value":"2017-08-15T10:37:15.422+02:00"},
