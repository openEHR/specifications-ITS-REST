...
class TestImportedVersion(unittest.TestCase):
    """ImportedVersion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImportedVersion:
        """Test ImportedVersion
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImportedVersion`
        """
        model = ImportedVersion()
        if include_optional:
            return ImportedVersion(
                type = 'IMPORTED_VERSION',
                item = openapi_client.models.original_version.ORIGINAL_VERSION(
                    _type = 'ORIGINAL_VERSION', 
                    uid = openapi_client.models.object_version_id.OBJECT_VERSION_ID(
                    ...
                    lifecycle_state = {"value":"Coded text value","defining_code":{"terminology_id":{"value":"local"},"code_string":"at0001"}}, 
                    attestations = [
                        openapi_client.models.attestation.ATTESTATION(
                            _type = 'ATTESTATION', 
