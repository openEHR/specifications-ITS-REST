...
class TestAbstractEntry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AbstractEntry:
        """Test AbstractEntry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AbstractEntry`
        """
        model = AbstractEntry()
        if include_optional:
            return AbstractEntry(
                ...
                workflow_id = {"id":{"_type":"OBJECT_VERSION_ID","value":"fb458d9c-1323-42bc-b7f8-787f3660a0b5::openEHRSys.example.com::1"},"namespace":"local","type":"COMPOSITION"},
                subject = openapi_client.models.party_proxy.PARTY_PROXY(
                    _type = 'PARTY_PROXY', 
                    external_ref = {"id":{"_type":"OBJECT_VERSION_ID","value":"b52b9408-7048-4ec8-94bd-831fb0727e67::openEHRSys.example.com::1"},"namespace":"local","type":"PERSON"}, ),
                provider = openapi_client.models.party_proxy.PARTY_PROXY(
                    _type = 'PARTY_PROXY', 
                    external_ref = {"id":{"_type":"OBJECT_VERSION_ID","value":"b52b9408-7048-4ec8-94bd-831fb0727e67::openEHRSys.example.com::1"},"namespace":"local","type":"PERSON"}, )
            )
        else:
