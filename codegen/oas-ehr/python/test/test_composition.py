    ...
    def make_instance(self, include_optional) -> Composition:
        ...
        if include_optional:
            return Composition(
                ...
                territory = {"terminology_id":{"value":"local"},"code_string":"at0001"},
                category = {"value":"Coded text value","defining_code":{"terminology_id":{"value":"local"},"code_string":"at0001"}},
                context = openapi_client.models.event_context.EVENT_CONTEXT(
                    start_time = {"_type":"DV_DATE_TIME","value":"2017-08-15T10:37:15.422+02:00"}, 
                    end_time = {"_type":"DV_DATE_TIME","value":"2017-08-15T10:37:15.422+02:00"}, 
                    location = '', 
                    setting = {"value":"Coded text value","defining_code":{"terminology_id":{"value":"local"},"code_string":"at0001"}}, 
                    other_context = openapi_client.models.item_structure.ITEM_STRUCTURE(), 
                    health_care_facility = {"_type":"PARTY_IDENTIFIED","external_ref":{"id":{"_type":"GENERIC_ID","value":"16b74749-e6aa-4945-b760-b42bdc07098a","scheme":"pid"},"namespace":"openEHRSys.example.com","type":"PERSON"},"name":"A name"}, 
                    participations = [
                        openapi_client.models.participation.PARTICIPATION(
                            function = openapi_client.models.dv_text.DV_TEXT(
                                value = '', 
                            ...
                            mode = {"value":"Coded text value","defining_code":{"terminology_id":{"value":"local"},"code_string":"at0001"}}, 
                            performer = openapi_client.models.party_proxy.PARTY_PROXY(
                                _type = 'PARTY_PROXY', 
                            ...
                            time = openapi_client.models.dv_interval_of_date_time.DV_INTERVAL_of_DATE_TIME(
                                _type = 'DV_INTERVAL', 
                                lower = {"_type":"DV_DATE_TIME","value":"2017-08-15T10:37:15.422+02:00"}, 
                                upper = {"_type":"DV_DATE_TIME","value":"2017-08-15T10:37:15.422+02:00"}, ), )
                        ], ),
                composer = openapi_client.models.party_proxy.PARTY_PROXY(
                    _type = 'PARTY_PROXY', 
                    external_ref = {"id":{"_type":"OBJECT_VERSION_ID","value":"b52b9408-7048-4ec8-94bd-831fb0727e67::openEHRSys.example.com::1"},"namespace":"local","type":"PERSON"}, ),
                content = [
                    openapi_client.models.content_item.CONTENT_ITEM()
                    ]
            )
        else:
            return Composition(
