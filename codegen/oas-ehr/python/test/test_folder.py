    ...
    def make_instance(self, include_optional) -> Folder:
        ...
        if include_optional:
            return Folder(
                ...
                folders = [
                    {"archetype_node_id":"openEHR-EHR-FOLDER.directory.v1","name":{"value":"Directory"},"uid":{"_type":"OBJECT_VERSION_ID","value":"8849182c-82ad-4088-a07f-48ead4180515::openEHRSys.example.com::1"},"items":[],"folders":[]}
                    ],
                details = openapi_client.models.item_structure.ITEM_STRUCTURE()
            )
        else:
            return Folder(
        )
