...
from openapi_client.api.ehr_api import EHRApi


class TestEHRApi(unittest.TestCase):
    """EHRApi unit test stubs"""
    ...
    def test_ehr_create(self) -> None:
        """Test case for ehr_create

        Create EHR
        """
        pass

    def test_ehr_create_with_id(self) -> None:
        """Test case for ehr_create_with_id

        Create EHR with id
        """
        pass

    def test_ehr_get_by_id(self) -> None:
        """Test case for ehr_get_by_id

        Get EHR by id
        """
        pass

    def test_ehr_get_by_subject(self) -> None:
        """Test case for ehr_get_by_subject
