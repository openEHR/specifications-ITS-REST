...
class TestFeederAuditDetails(unittest.TestCase):
    """FeederAuditDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeederAuditDetails:
        """Test FeederAuditDetails
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeederAuditDetails`
        """
        model = FeederAuditDetails()
        if include_optional:
    ...
    def testFeederAuditDetails(self):
        """Test FeederAuditDetails"""
