...
from openapi_client.api.ehrstatus_api import EHRSTATUSApi


class TestEHRSTATUSApi(unittest.TestCase):
    """EHRSTATUSApi unit test stubs"""

    def setUp(self) -> None:
        self.api = EHRSTATUSApi()

    def tearDown(self) -> None:
        pass

    def test_ehr_status_get_at_time(self) -> None:
        """Test case for ehr_status_get_at_time

        Get EHR_STATUS at time
        """
        pass

    def test_ehr_status_get_by_version_id(self) -> None:
        """Test case for ehr_status_get_by_version_id

        Get EHR_STATUS by version id
        """
        pass

    def test_ehr_status_update(self) -> None:
        """Test case for ehr_status_update

        Update EHR_STATUS
        """
        pass

    def test_versioned_ehr_status_get(self) -> None:
        """Test case for versioned_ehr_status_get

        Get versioned EHR_STATUS
        """
        pass

    def test_versioned_ehr_status_revision_history(self) -> None:
        """Test case for versioned_ehr_status_revision_history

        Get versioned EHR_STATUS revision history
        """
        pass

    def test_versioned_ehr_status_version_get_at_time(self) -> None:
        """Test case for versioned_ehr_status_version_get_at_time

        Get versioned EHR_STATUS version at time
        """
        pass

    def test_versioned_ehr_status_version_get_by_id(self) -> None:
        """Test case for versioned_ehr_status_version_get_by_id
