    ...
    def make_instance(self, include_optional) -> Contribution:
        ...
        if include_optional:
            return Contribution(
                ...
                versions = [
                    {"id":{"_type":"OBJECT_VERSION_ID","value":"fb458d9c-1323-42bc-b7f8-787f3660a0b5::openEHRSys.example.com::1"},"namespace":"local","type":"COMPOSITION"}
                    ],
                audit = {"system_id":"9624982A-9F42-41A5-9318-AE13D5F5031F","committer":{"_type":"PARTY_IDENTIFIED","name":"A user name"},"time_committed":{"value":"2017-08-15T10:37:15.422+02:00"},"change_type":{"value":"creation","defining_code":{"terminology_id":{"value":"openehr"},"code_string":"249"}},"description":{"value":"Description text"}}
            )
        else:
            return Contribution(
                uid = openapi_client.models.hier_object_id.HIER_OBJECT_ID(
