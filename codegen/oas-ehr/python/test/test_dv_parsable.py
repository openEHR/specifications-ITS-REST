...
class TestDvParsable(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DvParsable:
        """Test DvParsable
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DvParsable`
        """
        model = DvParsable()
        if include_optional:
            return DvParsable(
