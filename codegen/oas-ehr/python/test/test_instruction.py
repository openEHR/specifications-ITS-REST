...
class TestInstruction(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Instruction:
        ...
        if include_optional:
            return Instruction(
                type = 'INSTRUCTION',
                narrative = openapi_client.models.dv_text.DV_TEXT(
                    value = '', 
                ...
                expiry_time = {"_type":"DV_DATE_TIME","value":"2017-08-15T10:37:15.422+02:00"},
                wf_definition = openapi_client.models.dv_parsable.DV_PARSABLE(
                    _type = 'DV_PARSABLE', 
                    value = '', 
                    formalism = '', ),
                activities = [
                    openapi_client.models.activity.ACTIVITY(
                        _type = 'ACTIVITY', 
                        timing = openapi_client.models.dv_parsable.DV_PARSABLE(
                            _type = 'DV_PARSABLE', 
                            value = '', 
                            formalism = '', ), 
                        action_archetype_id = '', 
