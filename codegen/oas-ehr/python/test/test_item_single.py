...
class TestItemSingle(unittest.TestCase):
    """ItemSingle unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemSingle:
        """Test ItemSingle
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemSingle`
        """
        model = ItemSingle()
        if include_optional:
            return ItemSingle(
                type = 'ITEM_SINGLE',
                item = openapi_client.models.element.ELEMENT(
                    _type = 'ELEMENT', 
                    null_flavour = {"value":"Coded text value","defining_code":{"terminology_id":{"value":"local"},"code_string":"at0001"}}, 
                    value = openapi_client.models.data_value.DATA_VALUE(), 
                    null_reason = openapi_client.models.dv_text.DV_TEXT(
                        value = '', 
