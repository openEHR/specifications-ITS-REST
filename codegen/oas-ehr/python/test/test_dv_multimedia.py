...
class TestDvMultimedia(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DvMultimedia:
        """Test DvMultimedia
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DvMultimedia`
        """
        model = DvMultimedia()
        if include_optional:
            return DvMultimedia(
