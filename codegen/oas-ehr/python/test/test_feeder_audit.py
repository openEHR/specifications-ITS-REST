...
class TestFeederAudit(unittest.TestCase):
    """FeederAudit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeederAudit:
        """Test FeederAudit
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeederAudit`
        """
        model = FeederAudit()
        if include_optional:
            return FeederAudit(
