...
class TestTermMapping(unittest.TestCase):
    """TermMapping unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TermMapping:
        """Test TermMapping
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TermMapping`
        """
        model = TermMapping()
        if include_optional:
            return TermMapping(
