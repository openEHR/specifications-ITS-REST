...
class TestDvOrdered(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DvOrdered:
        """Test DvOrdered
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DvOrdered`
        """
        model = DvOrdered()
        if include_optional:
            return DvOrdered(
                type = 'DV_ORDERED',
                normal_status = {"terminology_id":{"value":"local"},"code_string":"at0001"},
                normal_range = openapi_client.models.dv_interval.DV_INTERVAL(
                    lower_unbounded = True, 
                    upper_unbounded = True, 
                    lower_included = True, 
                    upper_included = True, ),
                other_reference_ranges = [
                    openapi_client.models.reference_range.REFERENCE_RANGE(
                        ...
                        range = openapi_client.models.dv_interval.DV_INTERVAL(
                            lower_unbounded = True, 
                            upper_unbounded = True, 
                            lower_included = True, 
                            upper_included = True, ), )
