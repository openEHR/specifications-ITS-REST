...
class TestEhrStatus(unittest.TestCase):
    """EhrStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EhrStatus:
        """Test EhrStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EhrStatus`
        """
        model = EhrStatus()
        if include_optional:
            return EhrStatus(
