...
class TestItemTree(unittest.TestCase):
    """ItemTree unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemTree:
        """Test ItemTree
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemTree`
        """
        model = ItemTree()
        if include_optional:
            return ItemTree(
