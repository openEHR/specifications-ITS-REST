...
class TestObservation(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Observation:
        ...
        if include_optional:
            return Observation(
                type = 'OBSERVATION',
                data = openapi_client.models.history.HISTORY(
                    _type = 'HISTORY', 
                    origin = {"_type":"DV_DATE_TIME","value":"2017-08-15T10:37:15.422+02:00"}, 
                    period = openapi_client.models.dv_duration.DV_DURATION(
                        _type = 'DV_DURATION', ), 
                    duration = openapi_client.models.dv_duration.DV_DURATION(
                        _type = 'DV_DURATION', ), 
                    summary = openapi_client.models.item_structure.ITEM_STRUCTURE(), 
                    events = [
                        openapi_client.models.event.EVENT(
                            _type = 'EVENT', 
                            time = {"_type":"DV_DATE_TIME","value":"2017-08-15T10:37:15.422+02:00"}, 
                            state = openapi_client.models.item_structure.ITEM_STRUCTURE(), 
                            data = , )
                        ], ),
                state = openapi_client.models.history.HISTORY(
                    _type = 'HISTORY', 
                    origin = {"_type":"DV_DATE_TIME","value":"2017-08-15T10:37:15.422+02:00"}, 
                    period = openapi_client.models.dv_duration.DV_DURATION(
                        _type = 'DV_DURATION', ), 
