...
class TestRevisionHistoryItem(unittest.TestCase):
    """RevisionHistoryItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RevisionHistoryItem:
        """Test RevisionHistoryItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RevisionHistoryItem`
        """
        model = RevisionHistoryItem()
        if include_optional:
            return RevisionHistoryItem(
                version_id = openapi_client.models.object_version_id.OBJECT_VERSION_ID(
    ...
    def testRevisionHistoryItem(self):
        """Test RevisionHistoryItem"""
