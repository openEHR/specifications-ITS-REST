...
class TestPartyIdentified(unittest.TestCase):
    """PartyIdentified unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PartyIdentified:
        """Test PartyIdentified
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PartyIdentified`
        """
        model = PartyIdentified()
        if include_optional:
