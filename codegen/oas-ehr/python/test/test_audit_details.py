    ...
    def make_instance(self, include_optional) -> AuditDetails:
        ...
        if include_optional:
            return AuditDetails(
                type = 'AUDIT_DETAILS',
                system_id = '',
                time_committed = {"_type":"DV_DATE_TIME","value":"2017-08-15T10:37:15.422+02:00"},
                change_type = {"value":"Coded text value","defining_code":{"terminology_id":{"value":"local"},"code_string":"at0001"}},
