...
class TestLocatable(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Locatable:
        """Test Locatable
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Locatable`
        """
        model = Locatable()
        if include_optional:
            return Locatable(
                name = openapi_client.models.dv_text.DV_TEXT(
                    value = '', 
                    hyperlink = openapi_client.models.dv_uri.DV_URI(
                        value = '', ), 
                    formatting = '', 
                    mappings = [
                        openapi_client.models.term_mapping.TERM_MAPPING(
                            match = '>', 
                            purpose = {"value":"Coded text value","defining_code":{"terminology_id":{"value":"local"},"code_string":"at0001"}}, 
                            target = {"terminology_id":{"value":"local"},"code_string":"at0001"}, )
                        ], 
                    language = {"terminology_id":{"value":"local"},"code_string":"at0001"}, 
                    encoding = {"terminology_id":{"value":"local"},"code_string":"at0001"}, ),
                archetype_node_id = '',
                uid = openapi_client.models.uid_based_id.UID_BASED_ID(),
                links = [
                    openapi_client.models.link.LINK(
                        meaning = openapi_client.models.dv_text.DV_TEXT(
                            value = '', 
                            hyperlink = openapi_client.models.dv_uri.DV_URI(
                                value = '', ), 
                            formatting = '', 
                            ...
                            language = {"terminology_id":{"value":"local"},"code_string":"at0001"}, 
                            encoding = {"terminology_id":{"value":"local"},"code_string":"at0001"}, ), 
                        type = openapi_client.models.dv_text.DV_TEXT(
                            value = '', 
                            formatting = '', ), 
                        target = {"_type":"DV_EHR_URI","value":"ehr://system_id/ehr_id/top_level_structure_locator/path_inside_top_level_structure"}, )
                    ],
                archetype_details = {"archetype_id":{"value":"openEHR-EHR-COMPOSITION.encounter.v1"},"template_id":{"value":"Example.v1::c7ec861c-c413-39ff-9965-a198ebf44747"},"rm_version":"1.0.2"},
                feeder_audit = openapi_client.models.feeder_audit.FEEDER_AUDIT(
                    originating_system_item_ids = [
                        {"id":"16b74749-e6aa-4945-b760-b42bdc07098a","type":"Patient"}
                        ], 
                    feeder_system_item_ids = [
                        {"id":"16b74749-e6aa-4945-b760-b42bdc07098a","type":"Patient"}
                        ], 
                    original_content = openapi_client.models.dv_encapsulated.DV_ENCAPSULATED(
                        _type = 'DV_ENCAPSULATED', 
                        charset = {"terminology_id":{"value":"local"},"code_string":"at0001"}, 
                        language = {"terminology_id":{"value":"local"},"code_string":"at0001"}, ), 
                    originating_system_audit = openapi_client.models.feeder_audit_details.FEEDER_AUDIT_DETAILS(
                        system_id = '', 
                        location = {"_type":"PARTY_IDENTIFIED","external_ref":{"id":{"_type":"GENERIC_ID","value":"16b74749-e6aa-4945-b760-b42bdc07098a","scheme":"pid"},"namespace":"openEHRSys.example.com","type":"PERSON"},"name":"A name"}, 
                        subject = openapi_client.models.party_proxy.PARTY_PROXY(
                            _type = 'PARTY_PROXY', 
                            external_ref = {"id":{"_type":"OBJECT_VERSION_ID","value":"b52b9408-7048-4ec8-94bd-831fb0727e67::openEHRSys.example.com::1"},"namespace":"local","type":"PERSON"}, ), 
                        provider = {"_type":"PARTY_IDENTIFIED","external_ref":{"id":{"_type":"GENERIC_ID","value":"16b74749-e6aa-4945-b760-b42bdc07098a","scheme":"pid"},"namespace":"openEHRSys.example.com","type":"PERSON"},"name":"A name"}, 
                        time = {"_type":"DV_DATE_TIME","value":"2017-08-15T10:37:15.422+02:00"}, 
                        version_id = '', 
                        other_details = openapi_client.models.item_structure.ITEM_STRUCTURE(), ), 
                    feeder_system_audit = openapi_client.models.feeder_audit_details.FEEDER_AUDIT_DETAILS(
                        system_id = '', 
                        version_id = '', ), )
            )
        else:
