...
from openapi_client.api.composition_api import COMPOSITIONApi


class TestCOMPOSITIONApi(unittest.TestCase):
    """COMPOSITIONApi unit test stubs"""

    def setUp(self) -> None:
        self.api = COMPOSITIONApi()

    def tearDown(self) -> None:
        pass

    def test_composition_create(self) -> None:
        """Test case for composition_create

        Create COMPOSITION
        """
        pass

    def test_composition_delete(self) -> None:
        """Test case for composition_delete

        Delete COMPOSITION
        """
        pass

    def test_composition_get(self) -> None:
        """Test case for composition_get

        Get COMPOSITION
        """
        pass

    def test_composition_update(self) -> None:
        """Test case for composition_update

        Update COMPOSITION
        """
        pass

    def test_versioned_composition_get(self) -> None:
        """Test case for versioned_composition_get

        Get versioned COMPOSITION
        """
        pass

    def test_versioned_composition_revision_history(self) -> None:
        """Test case for versioned_composition_revision_history

        Get versioned COMPOSITION revision history
        """
        pass

    def test_versioned_composition_version_get_at_time(self) -> None:
        """Test case for versioned_composition_version_get_at_time

        Get versioned COMPOSITION version at time
        """
        pass

    def test_versioned_composition_version_get_by_id(self) -> None:
        """Test case for versioned_composition_version_get_by_id
