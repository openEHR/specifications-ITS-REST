...
class TestVersionedObject(unittest.TestCase):
    """VersionedObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VersionedObject:
        """Test VersionedObject
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VersionedObject`
        """
        model = VersionedObject()
        if include_optional:
            return VersionedObject(
                type = '',
                uid = openapi_client.models.hier_object_id.HIER_OBJECT_ID(
                    value = '6cb19121-4307-4648-9da0-d62e4d51f19b', ),
                owner_id = {"id":{"_type":"OBJECT_VERSION_ID","value":"fb458d9c-1323-42bc-b7f8-787f3660a0b5::openEHRSys.example.com::1"},"namespace":"local","type":"COMPOSITION"},
