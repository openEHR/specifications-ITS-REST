...
class DvQuantified(DvOrdered):
    ...
    DvQuantified
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='DV_QUANTIFIED', alias="_type")
    magnitude_status: Optional[StrictStr] = '='
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'DV_AMOUNT': 'DvAmount','DV_COUNT': 'DvCount','DV_DATE': 'DvDate','DV_DATE_TIME': 'DvDateTime','DV_DURATION': 'DvDuration','DV_PROPORTION': 'DvProportion','DV_QUANTITY': 'DvQuantity','DV_TEMPORAL': 'DvTemporal','DV_TIME': 'DvTime'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("DvQuantified failed to lookup discriminator value from " +
...
DvQuantified.model_rebuild(raise_errors=False)
