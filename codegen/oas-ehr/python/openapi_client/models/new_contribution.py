...
class NewContribution(BaseModel):
    ...
    audit: UpdateAudit
    __properties: ClassVar[List[str]] = ["uid", "versions", "audit"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "versions": [UpdateVersion.from_dict(_item) for _item in obj.get("versions")] if obj.get("versions") is not None else None,
            "audit": UpdateAudit.from_dict(obj.get("audit")) if obj.get("audit") is not None else None
        })
        return _obj
