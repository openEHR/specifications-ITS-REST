...
class DvAmount(DvQuantified):
    ...
    DvAmount
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='DV_AMOUNT', alias="_type")
    accuracy_is_percent: Optional[StrictBool] = None
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'DV_COUNT': 'DvCount','DV_DURATION': 'DvDuration','DV_PROPORTION': 'DvProportion','DV_QUANTITY': 'DvQuantity'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("DvAmount failed to lookup discriminator value from " +
...
DvAmount.model_rebuild(raise_errors=False)
