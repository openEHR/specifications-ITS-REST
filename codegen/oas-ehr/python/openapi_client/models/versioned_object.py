...
class VersionedObject(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'VERSIONED_COMPOSITION': 'VersionedComposition','VERSIONED_EHR_STATUS': 'VersionedEhrStatus'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VersionedObject failed to lookup discriminator value from " +
...
VersionedObject.model_rebuild(raise_errors=False)
