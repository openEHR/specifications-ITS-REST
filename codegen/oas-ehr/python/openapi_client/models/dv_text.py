...
class DvText(DataValue):
    ...
    DvText
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='DV_TEXT', alias="_type")
    value: StrictStr
    hyperlink: Optional[DvUri] = None
    formatting: Optional[StrictStr] = None
    mappings: Optional[List[TermMapping]] = None
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("DvText failed to lookup discriminator value from " +
                             json.dumps(obj) + ". Discriminator property name: " + cls.__discriminator_property_name +
                             ", mapping: " + json.dumps(cls.__discriminator_value_class_map))

from openapi_client.models.dv_coded_text import DvCodedText
# TODO: Rewrite to not use raise_errors
DvText.model_rebuild(raise_errors=False)
