...
class DvEncapsulated(DataValue):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'DV_MULTIMEDIA': 'DvMultimedia','DV_PARSABLE': 'DvParsable'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("DvEncapsulated failed to lookup discriminator value from " +
...
DvEncapsulated.model_rebuild(raise_errors=False)
