...
class Versionable(Locatable):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'COMPOSITION': 'Composition','EHR_STATUS': 'EhrStatus'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("Versionable failed to lookup discriminator value from " +
...
Versionable.model_rebuild(raise_errors=False)
