...
class Link(BaseModel):
    ...
    type: DvText
    target: DvEhrUri
    __properties: ClassVar[List[str]] = ["meaning", "type", "target"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of meaning
        if self.meaning:
            _dict['meaning'] = self.meaning.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "meaning": DvText.from_dict(obj.get("meaning")) if obj.get("meaning") is not None else None,
            "type": DvText.from_dict(obj.get("type")) if obj.get("type") is not None else None,
            "target": DvEhrUri.from_dict(obj.get("target")) if obj.get("target") is not None else None
        })
        return _obj
