...
class DvMultimedia(DvEncapsulated):
    ...
    DvMultimedia
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='DV_MULTIMEDIA', alias="_type")
    alternate_text: Optional[StrictStr] = None
    uri: Optional[DvUri] = None
    data: Optional[StrictStr] = None
    media_type: CodePhrase
    compression_algorithm: Optional[CodePhrase] = None
    integrity_check: Optional[StrictStr] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "_type": obj.get("_type") if obj.get("_type") is not None else 'DV_MULTIMEDIA'
        })
        return _obj

# TODO: Rewrite to not use raise_errors
DvMultimedia.model_rebuild(raise_errors=False)
