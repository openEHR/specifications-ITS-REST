...
class AbstractEntry(ContentItem):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ACTION': 'Action','ADMIN_ENTRY': 'AdminEntry','CARE_ENTRY': 'CareEntry','EVALUATION': 'Evaluation','INSTRUCTION': 'Instruction','OBSERVATION': 'Observation'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("AbstractEntry failed to lookup discriminator value from " +
...
AbstractEntry.model_rebuild(raise_errors=False)
