...
class UpdateAudit(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='UPDATE_AUDIT', alias="_type")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("UpdateAudit failed to lookup discriminator value from " +
                             json.dumps(obj) + ". Discriminator property name: " + cls.__discriminator_property_name +
                             ", mapping: " + json.dumps(cls.__discriminator_value_class_map))

from openapi_client.models.update_attestation import UpdateAttestation
# TODO: Rewrite to not use raise_errors
UpdateAudit.model_rebuild(raise_errors=False)
