...
class DvOrdered(DataValue):
    ...
    DvOrdered
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='DV_ORDERED', alias="_type")
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'DV_AMOUNT': 'DvAmount','DV_COUNT': 'DvCount','DV_DATE': 'DvDate','DV_DATE_TIME': 'DvDateTime','DV_DURATION': 'DvDuration','DV_ORDINAL': 'DvOrdinal','DV_PROPORTION': 'DvProportion','DV_QUANTIFIED': 'DvQuantified','DV_QUANTITY': 'DvQuantity','DV_SCALE': 'DvScale','DV_TEMPORAL': 'DvTemporal','DV_TIME': 'DvTime'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("DvOrdered failed to lookup discriminator value from " +
...
DvOrdered.model_rebuild(raise_errors=False)
