...
class DvInterval(DataValue):
    ...
    DvInterval
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='DV_INTERVAL', alias="_type")
    lower_unbounded: StrictBool
    upper_unbounded: StrictBool
    lower_included: StrictBool
    upper_included: StrictBool
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("DvInterval failed to lookup discriminator value from " +
                             json.dumps(obj) + ". Discriminator property name: " + cls.__discriminator_property_name +
                             ", mapping: " + json.dumps(cls.__discriminator_value_class_map))

from openapi_client.models.dv_interval_of_date_time import DvIntervalOfDateTime
# TODO: Rewrite to not use raise_errors
DvInterval.model_rebuild(raise_errors=False)
