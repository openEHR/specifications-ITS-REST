...
class UpdateVersion(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["preceding_version_uid", "signature", "lifecycle_state", "attestations", "data", "commit_audit"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of preceding_version_uid
        if self.preceding_version_uid:
            _dict['preceding_version_uid'] = self.preceding_version_uid.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of commit_audit
        if self.commit_audit:
            _dict['commit_audit'] = self.commit_audit.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "preceding_version_uid": ObjectVersionId.from_dict(obj.get("preceding_version_uid")) if obj.get("preceding_version_uid") is not None else None,
            "signature": obj.get("signature"),
            "lifecycle_state": TerminologyCode.from_dict(obj.get("lifecycle_state")) if obj.get("lifecycle_state") is not None else None,
            "attestations": [UpdateAttestation.from_dict(_item) for _item in obj.get("attestations")] if obj.get("attestations") is not None else None,
            "data": Versionable.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "commit_audit": UpdateAudit.from_dict(obj.get("commit_audit")) if obj.get("commit_audit") is not None else None
        })
        return _obj
