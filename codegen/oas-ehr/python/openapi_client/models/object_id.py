...
class ObjectId(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ARCHETYPE_ID': 'ArchetypeId','GENERIC_ID': 'GenericId','HIER_OBJECT_ID': 'HierObjectId','OBJECT_VERSION_ID': 'ObjectVersionId','TEMPLATE_ID': 'TemplateId','TERMINOLOGY_ID': 'TerminologyId','UID_BASED_ID': 'UidBasedId'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("ObjectId failed to lookup discriminator value from " +
...
ObjectId.model_rebuild(raise_errors=False)
