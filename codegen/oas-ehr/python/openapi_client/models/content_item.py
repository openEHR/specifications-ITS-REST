...
class ContentItem(Locatable):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ACTION': 'Action','ADMIN_ENTRY': 'AdminEntry','CARE_ENTRY': 'CareEntry','ENTRY': 'AbstractEntry','EVALUATION': 'Evaluation','INSTRUCTION': 'Instruction','OBSERVATION': 'Observation'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("ContentItem failed to lookup discriminator value from " +
...
ContentItem.model_rebuild(raise_errors=False)
