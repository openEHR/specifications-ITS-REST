...
class ItemStructure(DataStructure):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ITEM_LIST': 'ItemList','ITEM_SINGLE': 'ItemSingle','ITEM_TABLE': 'ItemTable','ITEM_TREE': 'ItemTree'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("ItemStructure failed to lookup discriminator value from " +
...
ItemStructure.model_rebuild(raise_errors=False)
