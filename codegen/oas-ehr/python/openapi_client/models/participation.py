...
class Participation(BaseModel):
    ...
    time: Optional[DvIntervalOfDateTime] = None
    __properties: ClassVar[List[str]] = ["function", "mode", "performer", "time"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "function": DvText.from_dict(obj.get("function")) if obj.get("function") is not None else None,
            "mode": DvCodedText.from_dict(obj.get("mode")) if obj.get("mode") is not None else None,
            "performer": PartyProxy.from_dict(obj.get("performer")) if obj.get("performer") is not None else None,
            "time": DvIntervalOfDateTime.from_dict(obj.get("time")) if obj.get("time") is not None else None
        })
        return _obj
