...
class PartyIdentified(PartyProxy):
    ...
    PartyIdentified
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='PARTY_IDENTIFIED', alias="_type")
    name: Optional[StrictStr] = None
    identifiers: Optional[List[DvIdentifier]] = None
    __properties: ClassVar[List[str]] = ["_type", "external_ref"]
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("PartyIdentified failed to lookup discriminator value from " +
                             json.dumps(obj) + ". Discriminator property name: " + cls.__discriminator_property_name +
                             ", mapping: " + json.dumps(cls.__discriminator_value_class_map))

from openapi_client.models.party_related import PartyRelated
# TODO: Rewrite to not use raise_errors
PartyIdentified.model_rebuild(raise_errors=False)
