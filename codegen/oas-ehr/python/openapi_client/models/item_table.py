...
class ItemTable(ItemStructure):
    ...
    ItemTable
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='ITEM_TABLE', alias="_type")
    items: Optional[List[Clstr]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "_type": obj.get("_type") if obj.get("_type") is not None else 'ITEM_TABLE'
        })
        return _obj
