...
class CodePhrase(BaseModel):
    ...
    code_string: StrictStr
    preferred_term: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["terminology_id", "code_string", "preferred_term"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of terminology_id
        if self.terminology_id:
            _dict['terminology_id'] = self.terminology_id.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "terminology_id": TerminologyId.from_dict(obj.get("terminology_id")) if obj.get("terminology_id") is not None else None,
            "code_string": obj.get("code_string"),
            "preferred_term": obj.get("preferred_term")
        })
        return _obj
