...
class DvTemporal(DvQuantified):
    ...
    DvTemporal
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='DV_TEMPORAL', alias="_type")
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'DV_DATE': 'DvDate','DV_DATE_TIME': 'DvDateTime','DV_TIME': 'DvTime'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("DvTemporal failed to lookup discriminator value from " +
...
DvTemporal.model_rebuild(raise_errors=False)
