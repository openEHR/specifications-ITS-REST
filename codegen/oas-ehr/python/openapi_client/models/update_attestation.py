...
class UpdateAttestation(UpdateAudit):
    ...
    UpdateAttestation
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='UPDATE_ATTESTATION', alias="_type")
    ...
    __properties: ClassVar[List[str]] = ["_type", "change_type", "description", "committer"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "_type": obj.get("_type") if obj.get("_type") is not None else 'UPDATE_ATTESTATION',
            "change_type": TerminologyCode.from_dict(obj.get("change_type")) if obj.get("change_type") is not None else None,
