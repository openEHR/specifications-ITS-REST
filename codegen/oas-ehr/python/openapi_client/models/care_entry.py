...
class CareEntry(AbstractEntry):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ACTION': 'Action','EVALUATION': 'Evaluation','INSTRUCTION': 'Instruction','OBSERVATION': 'Observation'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("CareEntry failed to lookup discriminator value from " +
...
CareEntry.model_rebuild(raise_errors=False)
