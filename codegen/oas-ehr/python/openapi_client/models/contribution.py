...
class Contribution(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "versions": [ObjectRef.from_dict(_item) for _item in obj.get("versions")] if obj.get("versions") is not None else None,
            "audit": AuditDetails.from_dict(obj.get("audit")) if obj.get("audit") is not None else None
        })
        return _obj
