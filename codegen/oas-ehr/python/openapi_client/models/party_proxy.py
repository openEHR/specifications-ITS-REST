...
class PartyProxy(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'PARTY_IDENTIFIED': 'PartyIdentified','PARTY_RELATED': 'PartyRelated','PARTY_SELF': 'PartySelf'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("PartyProxy failed to lookup discriminator value from " +
...
PartyProxy.model_rebuild(raise_errors=False)
