...
class DvUri(DataValue):
    ...
    DvUri
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='DV_URI', alias="_type")
    value: StrictStr
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("DvUri failed to lookup discriminator value from " +
                             json.dumps(obj) + ". Discriminator property name: " + cls.__discriminator_property_name +
                             ", mapping: " + json.dumps(cls.__discriminator_value_class_map))

from openapi_client.models.dv_ehr_uri import DvEhrUri
# TODO: Rewrite to not use raise_errors
DvUri.model_rebuild(raise_errors=False)
