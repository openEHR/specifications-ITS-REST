...
class Pathable(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ACTION': 'Action','ACTIVITY': 'Activity','ADMIN_ENTRY': 'AdminEntry','CARE_ENTRY': 'CareEntry','CLUSTER': 'Clstr','COMPOSITION': 'Composition','CONTENT_ITEM': 'ContentItem','DATA_STRUCTURE': 'DataStructure','EHR_STATUS': 'EhrStatus','ELEMENT': 'Element','ENTRY': 'AbstractEntry','EVALUATION': 'Evaluation','EVENT': 'Event','EVENT_CONTEXT': 'EventContext','FOLDER': 'Folder','HISTORY': 'History','INSTRUCTION': 'Instruction','INSTRUCTION_DETAILS': 'InstructionDetails','ISM_TRANSITION': 'IsmTransition','ITEM': 'Item','ITEM_LIST': 'ItemList','ITEM_SINGLE': 'ItemSingle','ITEM_STRUCTURE': 'ItemStructure','ITEM_TABLE': 'ItemTable','ITEM_TREE': 'ItemTree','LOCATABLE': 'Locatable','OBSERVATION': 'Observation','Versionable': 'Versionable'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("Pathable failed to lookup discriminator value from " +
...
Pathable.model_rebuild(raise_errors=False)
