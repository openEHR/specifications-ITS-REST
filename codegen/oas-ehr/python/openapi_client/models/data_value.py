...
class DataValue(BaseModel):
    ...
    __discriminator_property_name: ClassVar[List[str]] = '_type'

    # discriminator mappings
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'DV_AMOUNT': 'DvAmount','DV_BOOLEAN': 'DvBoolean','DV_CODED_TEXT': 'DvCodedText','DV_COUNT': 'DvCount','DV_DATE': 'DvDate','DV_DATE_TIME': 'DvDateTime','DV_DURATION': 'DvDuration','DV_EHR_URI': 'DvEhrUri','DV_ENCAPSULATED': 'DvEncapsulated','DV_IDENTIFIER': 'DvIdentifier','DV_INTERVAL': 'DvInterval','DV_INTERVAL_of_DATE_TIME': 'DvIntervalOfDateTime','DV_MULTIMEDIA': 'DvMultimedia','DV_ORDERED': 'DvOrdered','DV_ORDINAL': 'DvOrdinal','DV_PARSABLE': 'DvParsable','DV_PROPORTION': 'DvProportion','DV_QUANTIFIED': 'DvQuantified','DV_QUANTITY': 'DvQuantity','DV_SCALE': 'DvScale','DV_STATE': 'DvState','DV_TEMPORAL': 'DvTemporal','DV_TEXT': 'DvText','DV_TIME': 'DvTime','DV_URI': 'DvUri'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("DataValue failed to lookup discriminator value from " +
...
DataValue.model_rebuild(raise_errors=False)
