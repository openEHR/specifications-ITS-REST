...
class EhrStatus(Versionable):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='EHR_STATUS', alias="_type")
    subject: PartyProxy
    is_queryable: StrictBool
    is_modifiable: StrictBool
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "_type": obj.get("_type") if obj.get("_type") is not None else 'EHR_STATUS'
        })
        return _obj
