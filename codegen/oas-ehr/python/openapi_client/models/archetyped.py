...
class Archetyped(BaseModel):
    ...
    rm_version: StrictStr
    __properties: ClassVar[List[str]] = ["archetype_id", "template_id", "rm_version"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of archetype_id
        if self.archetype_id:
            _dict['archetype_id'] = self.archetype_id.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "archetype_id": ArchetypeId.from_dict(obj.get("archetype_id")) if obj.get("archetype_id") is not None else None,
            "template_id": TemplateId.from_dict(obj.get("template_id")) if obj.get("template_id") is not None else None,
            "rm_version": obj.get("rm_version")
        })
        return _obj
