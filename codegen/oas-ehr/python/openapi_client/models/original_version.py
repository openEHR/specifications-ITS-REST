...
class OriginalVersion(Version):
    ...
    OriginalVersion
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='ORIGINAL_VERSION', alias="_type")
    uid: ObjectVersionId
    ...
    __properties: ClassVar[List[str]] = ["_type", "contribution", "signature", "commit_audit", "data"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "_type": obj.get("_type") if obj.get("_type") is not None else 'ORIGINAL_VERSION',
            "contribution": ObjectRef.from_dict(obj.get("contribution")) if obj.get("contribution") is not None else None,
            "signature": obj.get("signature"),
            "commit_audit": AuditDetails.from_dict(obj.get("commit_audit")) if obj.get("commit_audit") is not None else None,
