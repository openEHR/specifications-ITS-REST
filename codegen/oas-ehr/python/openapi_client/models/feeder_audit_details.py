...
class FeederAuditDetails(BaseModel):
    ...
    subject: Optional[PartyProxy] = None
    ...
    __properties: ClassVar[List[str]] = ["system_id", "location", "subject", "provider", "time", "version_id", "other_details"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of other_details
        if self.other_details:
            _dict['other_details'] = self.other_details.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "location": PartyIdentified.from_dict(obj.get("location")) if obj.get("location") is not None else None,
            "subject": PartyProxy.from_dict(obj.get("subject")) if obj.get("subject") is not None else None,
            "provider": PartyIdentified.from_dict(obj.get("provider")) if obj.get("provider") is not None else None,
            "time": DvDateTime.from_dict(obj.get("time")) if obj.get("time") is not None else None,
            "version_id": obj.get("version_id"),
            "other_details": ItemStructure.from_dict(obj.get("other_details")) if obj.get("other_details") is not None else None
        })
        return _obj
