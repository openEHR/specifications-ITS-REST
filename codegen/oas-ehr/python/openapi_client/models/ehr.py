...
class Ehr(BaseModel):
    ...
    An EHR resource
    """ # noqa: E501
    system_id: Optional[HierObjectId] = None
    ehr_id: Optional[HierObjectId] = None
    ehr_status: Optional[ObjectRef] = None
    ehr_access: Optional[ObjectRef] = None
    time_created: Optional[DvDateTime] = None
    __properties: ClassVar[List[str]] = ["system_id", "ehr_id", "ehr_status", "ehr_access", "time_created"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.system_id:
            _dict['system_id'] = self.system_id.to_dict()
        # override the default output from pydantic by calling `to_dict()` of ehr_id
        if self.ehr_id:
            _dict['ehr_id'] = self.ehr_id.to_dict()
        # override the default output from pydantic by calling `to_dict()` of ehr_status
        if self.ehr_status:
            _dict['ehr_status'] = self.ehr_status.to_dict()
        # override the default output from pydantic by calling `to_dict()` of ehr_access
        if self.ehr_access:
            _dict['ehr_access'] = self.ehr_access.to_dict()
        # override the default output from pydantic by calling `to_dict()` of time_created
        if self.time_created:
            _dict['time_created'] = self.time_created.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "system_id": HierObjectId.from_dict(obj.get("system_id")) if obj.get("system_id") is not None else None,
            "ehr_id": HierObjectId.from_dict(obj.get("ehr_id")) if obj.get("ehr_id") is not None else None,
            "ehr_status": ObjectRef.from_dict(obj.get("ehr_status")) if obj.get("ehr_status") is not None else None,
            "ehr_access": ObjectRef.from_dict(obj.get("ehr_access")) if obj.get("ehr_access") is not None else None,
            "time_created": DvDateTime.from_dict(obj.get("time_created")) if obj.get("time_created") is not None else None
        })
        return _obj
