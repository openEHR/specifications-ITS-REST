...
class DvQuantity(DvAmount):
    ...
    DvQuantity
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='DV_QUANTITY', alias="_type")
    magnitude: Union[StrictFloat, StrictInt]
    precision: Optional[StrictInt] = None
    units: StrictStr
    units_system: Optional[StrictStr] = None
    units_display_name: Optional[StrictStr] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "_type": obj.get("_type") if obj.get("_type") is not None else 'DV_QUANTITY'
        })
        return _obj
