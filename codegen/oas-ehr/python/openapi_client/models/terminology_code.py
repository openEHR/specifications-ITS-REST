...
class TerminologyCode(BaseModel):
    ...
    TerminologyCode
    """ # noqa: E501
    terminology_id: StrictStr
    terminology_version: Optional[StrictStr] = None
    code_string: StrictStr
    uri: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["terminology_id", "terminology_version", "code_string", "uri"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "terminology_id": obj.get("terminology_id"),
            "terminology_version": obj.get("terminology_version"),
