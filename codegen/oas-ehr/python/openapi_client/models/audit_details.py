...
class AuditDetails(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='AUDIT_DETAILS', alias="_type")
    system_id: StrictStr
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("AuditDetails failed to lookup discriminator value from " +
                             json.dumps(obj) + ". Discriminator property name: " + cls.__discriminator_property_name +
                             ", mapping: " + json.dumps(cls.__discriminator_value_class_map))

from openapi_client.models.attestation import Attestation
# TODO: Rewrite to not use raise_errors
AuditDetails.model_rebuild(raise_errors=False)
