...
class VersionedComposition(VersionedObject):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='VERSIONED_COMPOSITION', alias="_type")
    __properties: ClassVar[List[str]] = ["_type", "uid", "owner_id", "time_created"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.owner_id:
            _dict['owner_id'] = self.owner_id.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "_type": obj.get("_type") if obj.get("_type") is not None else 'VERSIONED_COMPOSITION',
            "uid": HierObjectId.from_dict(obj.get("uid")) if obj.get("uid") is not None else None,
            "owner_id": ObjectRef.from_dict(obj.get("owner_id")) if obj.get("owner_id") is not None else None,
