...
class DataStructure(Locatable):
    ...
    DataStructure
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='DATA_STRUCTURE', alias="_type")
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ITEM_LIST': 'ItemList','ITEM_SINGLE': 'ItemSingle','ITEM_STRUCTURE': 'ItemStructure','ITEM_TABLE': 'ItemTable','ITEM_TREE': 'ItemTree'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("DataStructure failed to lookup discriminator value from " +
...
DataStructure.model_rebuild(raise_errors=False)
