...
class UidBasedId(ObjectId):
    ...
    UidBasedId
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='UID_BASED_ID', alias="_type")
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'HIER_OBJECT_ID': 'HierObjectId','OBJECT_VERSION_ID': 'ObjectVersionId'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("UidBasedId failed to lookup discriminator value from " +
...
UidBasedId.model_rebuild(raise_errors=False)
