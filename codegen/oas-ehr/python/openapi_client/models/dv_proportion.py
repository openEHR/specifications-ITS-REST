...
class DvProportion(DvAmount):
    ...
    DvProportion
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='DV_PROPORTION', alias="_type")
    numerator: Union[StrictFloat, StrictInt]
    denominator: Union[StrictFloat, StrictInt]
    semantic_type: StrictInt
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "_type": obj.get("_type") if obj.get("_type") is not None else 'DV_PROPORTION'
        })
        return _obj
