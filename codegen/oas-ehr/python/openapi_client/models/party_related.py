...
class PartyRelated(PartyIdentified):
    ...
    PartyRelated
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='PARTY_RELATED', alias="_type")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "_type": obj.get("_type") if obj.get("_type") is not None else 'PARTY_RELATED',
            "external_ref": PartyRef.from_dict(obj.get("external_ref")) if obj.get("external_ref") is not None else None
        })
        return _obj
