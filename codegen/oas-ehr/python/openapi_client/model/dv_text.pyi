...
class DvText(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["value", "_type", "hyperlink", "language", "encoding", "formatting", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["value", "_type", "hyperlink", "language", "encoding", "formatting", ], str]):
