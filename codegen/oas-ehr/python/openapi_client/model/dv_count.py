...
class DvCount(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["magnitude", "_type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["magnitude", "_type", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        magnitude: typing.Union[MetaOapg.properties.magnitude, decimal.Decimal, int, ],
