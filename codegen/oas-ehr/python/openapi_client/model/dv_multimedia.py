...
class DvMultimedia(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def media_type() -> typing.Type['CodePhrase']:
                return CodePhrase
            size = schemas.IntSchema
            _type = schemas.StrSchema
            alternate_text = schemas.StrSchema
        
            @staticmethod
            def uri() -> typing.Type['DvUri']:
                return DvUri
            data = schemas.StrSchema
        
            @staticmethod
            def compression_algorithm() -> typing.Type['CodePhrase']:
                return CodePhrase
            integrity_check = schemas.StrSchema
        
            @staticmethod
            def integrity_check_algorithm() -> typing.Type['CodePhrase']:
                return CodePhrase
        
            @staticmethod
            def thumbnail() -> typing.Type['DvMultimedia']:
                return DvMultimedia
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["media_type"]) -> 'CodePhrase': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["alternate_text"]) -> MetaOapg.properties.alternate_text: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["uri"]) -> 'DvUri': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> MetaOapg.properties.data: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["compression_algorithm"]) -> 'CodePhrase': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["integrity_check"]) -> MetaOapg.properties.integrity_check: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["integrity_check_algorithm"]) -> 'CodePhrase': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["thumbnail"]) -> 'DvMultimedia': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["media_type", "size", "_type", "alternate_text", "uri", "data", "compression_algorithm", "integrity_check", "integrity_check_algorithm", "thumbnail", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["media_type"]) -> 'CodePhrase': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["size"]) -> MetaOapg.properties.size: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_type"]) -> typing.Union[MetaOapg.properties._type, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["alternate_text"]) -> typing.Union[MetaOapg.properties.alternate_text, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["uri"]) -> typing.Union['DvUri', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> typing.Union[MetaOapg.properties.data, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["compression_algorithm"]) -> typing.Union['CodePhrase', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["integrity_check"]) -> typing.Union[MetaOapg.properties.integrity_check, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["integrity_check_algorithm"]) -> typing.Union['CodePhrase', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["thumbnail"]) -> typing.Union['DvMultimedia', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["media_type", "size", "_type", "alternate_text", "uri", "data", "compression_algorithm", "integrity_check", "integrity_check_algorithm", "thumbnail", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        media_type: 'CodePhrase',
        _type: typing.Union[MetaOapg.properties._type, str, schemas.Unset] = schemas.unset,
        alternate_text: typing.Union[MetaOapg.properties.alternate_text, str, schemas.Unset] = schemas.unset,
        uri: typing.Union['DvUri', schemas.Unset] = schemas.unset,
        data: typing.Union[MetaOapg.properties.data, str, schemas.Unset] = schemas.unset,
        compression_algorithm: typing.Union['CodePhrase', schemas.Unset] = schemas.unset,
        integrity_check: typing.Union[MetaOapg.properties.integrity_check, str, schemas.Unset] = schemas.unset,
        integrity_check_algorithm: typing.Union['CodePhrase', schemas.Unset] = schemas.unset,
        thumbnail: typing.Union['DvMultimedia', schemas.Unset] = schemas.unset,
