...
class Action(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def ism_transition() -> typing.Type['IsmTransition']:
                return IsmTransition
        
            @staticmethod
            def description() -> typing.Type['ItemStructure']:
                return ItemStructure
            _type = schemas.StrSchema
        
            @staticmethod
            def instruction_details() -> typing.Type['InstructionDetails']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ism_transition"]) -> 'IsmTransition': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["description"]) -> 'ItemStructure': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_type"]) -> MetaOapg.properties._type: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["instruction_details"]) -> 'InstructionDetails': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["time", "ism_transition", "description", "_type", "instruction_details", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["time"]) -> 'DvDateTime': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ism_transition"]) -> 'IsmTransition': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["description"]) -> 'ItemStructure': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_type"]) -> typing.Union[MetaOapg.properties._type, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["instruction_details"]) -> typing.Union['InstructionDetails', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["time", "ism_transition", "description", "_type", "instruction_details", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        instruction_details: typing.Union['InstructionDetails', schemas.Unset] = schemas.unset,
