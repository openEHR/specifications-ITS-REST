...
class LocatableRef(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["id"]) -> 'UidBasedId': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["namespace", "type", "id", "path", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["id"]) -> 'UidBasedId': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["namespace", "type", "id", "path", ], str]):
