...
class ItemSingle(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["item"]) -> 'Element': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["item"]) -> 'Element': ...
