...
class Clstr(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["items", "_type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["items", "_type", ], str]):
