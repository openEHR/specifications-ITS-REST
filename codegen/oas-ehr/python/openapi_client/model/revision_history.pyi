        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['RevisionHistoryItem']:
                        return RevisionHistoryItem
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['RevisionHistoryItem'], typing.List['RevisionHistoryItem']],
                ...
                def __getitem__(self, i: int) -> 'RevisionHistoryItem':
