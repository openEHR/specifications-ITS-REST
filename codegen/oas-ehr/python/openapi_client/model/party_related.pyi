...
class PartyRelated(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def relationship() -> typing.Type['DvCodedText']:
                return DvCodedText
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["relationship"]) -> 'DvCodedText': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["relationship", "_type", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["relationship"]) -> 'DvCodedText': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["relationship", "_type", ], str]):
