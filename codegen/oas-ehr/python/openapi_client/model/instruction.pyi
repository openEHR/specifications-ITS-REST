...
class Instruction(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def narrative() -> typing.Type['DvText']:
                return DvText
            _type = schemas.StrSchema
        
            @staticmethod
            def expiry_time() -> typing.Type['DvDateTime']:
                return DvDateTime
        
            @staticmethod
            def wf_definition() -> typing.Type['DvParsable']:
                return DvParsable
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["narrative"]) -> 'DvText': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_type"]) -> MetaOapg.properties._type: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["expiry_time"]) -> 'DvDateTime': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["wf_definition"]) -> 'DvParsable': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["narrative", "_type", "expiry_time", "wf_definition", "activities", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["narrative"]) -> 'DvText': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_type"]) -> typing.Union[MetaOapg.properties._type, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["expiry_time"]) -> typing.Union['DvDateTime', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["wf_definition"]) -> typing.Union['DvParsable', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["narrative", "_type", "expiry_time", "wf_definition", "activities", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        expiry_time: typing.Union['DvDateTime', schemas.Unset] = schemas.unset,
        wf_definition: typing.Union['DvParsable', schemas.Unset] = schemas.unset,
