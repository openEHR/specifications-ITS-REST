...
class DvProportion(
    ...
    class MetaOapg:
        ...
        class properties:
            numerator = schemas.NumberSchema
            denominator = schemas.NumberSchema
            semantic_type = schemas.IntSchema
    ...
    semantic_type: MetaOapg.properties.semantic_type
    denominator: MetaOapg.properties.denominator
    numerator: MetaOapg.properties.numerator
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["numerator"]) -> MetaOapg.properties.numerator: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["denominator"]) -> MetaOapg.properties.denominator: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["semantic_type"]) -> MetaOapg.properties.semantic_type: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["numerator", "denominator", "semantic_type", "_type", "precision", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["numerator"]) -> MetaOapg.properties.numerator: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["denominator"]) -> MetaOapg.properties.denominator: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["semantic_type"]) -> MetaOapg.properties.semantic_type: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["numerator", "denominator", "semantic_type", "_type", "precision", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        semantic_type: typing.Union[MetaOapg.properties.semantic_type, decimal.Decimal, int, ],
        denominator: typing.Union[MetaOapg.properties.denominator, decimal.Decimal, int, float, ],
        numerator: typing.Union[MetaOapg.properties.numerator, decimal.Decimal, int, float, ],
