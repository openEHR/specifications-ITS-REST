...
class DvAmount(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            accuracy_is_percent = schemas.BoolSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["accuracy_is_percent"]) -> MetaOapg.properties.accuracy_is_percent: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["_type", "accuracy_is_percent", "accuracy", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["accuracy_is_percent"]) -> typing.Union[MetaOapg.properties.accuracy_is_percent, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["_type", "accuracy_is_percent", "accuracy", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        accuracy_is_percent: typing.Union[MetaOapg.properties.accuracy_is_percent, bool, schemas.Unset] = schemas.unset,
