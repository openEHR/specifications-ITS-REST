...
class Attestation(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def reason() -> typing.Type['DvText']:
                return DvText
            is_pending = schemas.BoolSchema
            _type = schemas.StrSchema
        
            @staticmethod
            def attested_view() -> typing.Type['DvMultimedia']:
                return DvMultimedia
            proof = schemas.StrSchema
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DvEhrUri']:
                        return DvEhrUri
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['DvEhrUri'], typing.List['DvEhrUri']],
                ...
                def __getitem__(self, i: int) -> 'DvEhrUri':
    ...
    reason: 'DvText'
    is_pending: MetaOapg.properties.is_pending
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["reason"]) -> 'DvText': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["attested_view"]) -> 'DvMultimedia': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["proof"]) -> MetaOapg.properties.proof: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["reason", "is_pending", "_type", "attested_view", "proof", "items", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["reason"]) -> 'DvText': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["is_pending"]) -> MetaOapg.properties.is_pending: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_type"]) -> typing.Union[MetaOapg.properties._type, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["attested_view"]) -> typing.Union['DvMultimedia', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["proof"]) -> typing.Union[MetaOapg.properties.proof, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["reason", "is_pending", "_type", "attested_view", "proof", "items", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        reason: 'DvText',
        is_pending: typing.Union[MetaOapg.properties.is_pending, bool, ],
        _type: typing.Union[MetaOapg.properties._type, str, schemas.Unset] = schemas.unset,
        attested_view: typing.Union['DvMultimedia', schemas.Unset] = schemas.unset,
        proof: typing.Union[MetaOapg.properties.proof, str, schemas.Unset] = schemas.unset,
