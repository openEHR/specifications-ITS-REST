...
class RevisionHistoryItem(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def version_id() -> typing.Type['ObjectVersionId']:
            ...
            class audits(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['AuditDetails'], typing.List['AuditDetails']],
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["version_id"]) -> 'ObjectVersionId': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["version_id", "audits", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["version_id"]) -> 'ObjectVersionId': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["version_id", "audits", ], str]):
