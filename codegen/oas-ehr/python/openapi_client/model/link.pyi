...
class Link(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def meaning() -> typing.Type['DvText']:
                return DvText
        
            @staticmethod
            def type() -> typing.Type['DvText']:
                return DvText
        
            @staticmethod
            def target() -> typing.Type['DvEhrUri']:
                return DvEhrUri
            __annotations__ = {
                "meaning": meaning,
                "type": type,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meaning"]) -> 'DvText': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["type"]) -> 'DvText': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["target"]) -> 'DvEhrUri': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["meaning", "type", "target", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meaning"]) -> 'DvText': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["type"]) -> 'DvText': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["target"]) -> 'DvEhrUri': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["meaning", "type", "target", ], str]):
