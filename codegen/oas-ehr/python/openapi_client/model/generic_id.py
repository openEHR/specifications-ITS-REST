...
class GenericId(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["scheme", "_type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["scheme", "_type", ], str]):
