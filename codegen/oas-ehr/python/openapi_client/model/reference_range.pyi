...
class ReferenceRange(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def range() -> typing.Type['DvInterval']:
                return DvInterval
            __annotations__ = {
                "meaning": meaning,
                "range": range,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["range"]) -> 'DvInterval': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["meaning", "range", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["range"]) -> 'DvInterval': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["meaning", "range", ], str]):
