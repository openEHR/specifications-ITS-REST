...
class CodePhrase(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def terminology_id() -> typing.Type['TerminologyId']:
                return TerminologyId
            code_string = schemas.StrSchema
            preferred_term = schemas.StrSchema
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["terminology_id"]) -> 'TerminologyId': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["code_string"]) -> MetaOapg.properties.code_string: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["preferred_term"]) -> MetaOapg.properties.preferred_term: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["terminology_id", "code_string", "preferred_term", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["terminology_id"]) -> 'TerminologyId': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["code_string"]) -> MetaOapg.properties.code_string: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["preferred_term"]) -> typing.Union[MetaOapg.properties.preferred_term, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["terminology_id", "code_string", "preferred_term", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        preferred_term: typing.Union[MetaOapg.properties.preferred_term, str, schemas.Unset] = schemas.unset,
