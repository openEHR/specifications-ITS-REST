...
class OriginalVersion(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def uid() -> typing.Type['ObjectVersionId']:
                return ObjectVersionId
        
            @staticmethod
            def lifecycle_state() -> typing.Type['DvCodedText']:
                return DvCodedText
            _type = schemas.StrSchema
        
            @staticmethod
            def preceding_version_uid() -> typing.Type['ObjectVersionId']:
                return ObjectVersionId
            
            
            class other_input_version_uids(
                schemas.ListSchema
            ):
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ObjectVersionId']:
                        return ObjectVersionId
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ObjectVersionId'], typing.List['ObjectVersionId']],
                ...
                def __getitem__(self, i: int) -> 'ObjectVersionId':
            ...
            class attestations(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Attestation']:
                        return Attestation
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Attestation'], typing.List['Attestation']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'attestations':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'Attestation':
                    return super().__getitem__(i)
            __annotations__ = {
                "uid": uid,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["uid"]) -> 'ObjectVersionId': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["lifecycle_state"]) -> 'DvCodedText': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_type"]) -> MetaOapg.properties._type: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["preceding_version_uid"]) -> 'ObjectVersionId': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["other_input_version_uids"]) -> MetaOapg.properties.other_input_version_uids: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["attestations"]) -> MetaOapg.properties.attestations: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["uid", "lifecycle_state", "_type", "preceding_version_uid", "other_input_version_uids", "attestations", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["uid"]) -> 'ObjectVersionId': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["lifecycle_state"]) -> 'DvCodedText': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_type"]) -> typing.Union[MetaOapg.properties._type, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["preceding_version_uid"]) -> typing.Union['ObjectVersionId', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["other_input_version_uids"]) -> typing.Union[MetaOapg.properties.other_input_version_uids, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["attestations"]) -> typing.Union[MetaOapg.properties.attestations, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["uid", "lifecycle_state", "_type", "preceding_version_uid", "other_input_version_uids", "attestations", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        preceding_version_uid: typing.Union['ObjectVersionId', schemas.Unset] = schemas.unset,
        other_input_version_uids: typing.Union[MetaOapg.properties.other_input_version_uids, list, tuple, schemas.Unset] = schemas.unset,
        attestations: typing.Union[MetaOapg.properties.attestations, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
