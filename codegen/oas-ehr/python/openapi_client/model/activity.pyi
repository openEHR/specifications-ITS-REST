...
class Activity(
    ...
    class MetaOapg:
        ...
        class properties:
            action_archetype_id = schemas.StrSchema
            ...
            @staticmethod
            def timing() -> typing.Type['DvParsable']:
                return DvParsable
            __annotations__ = {
    ...
    action_archetype_id: MetaOapg.properties.action_archetype_id
    description: 'ItemStructure'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["action_archetype_id"]) -> MetaOapg.properties.action_archetype_id: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["timing"]) -> 'DvParsable': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["action_archetype_id", "description", "_type", "timing", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["action_archetype_id"]) -> MetaOapg.properties.action_archetype_id: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["timing"]) -> typing.Union['DvParsable', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["action_archetype_id", "description", "_type", "timing", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        action_archetype_id: typing.Union[MetaOapg.properties.action_archetype_id, str, ],
        description: 'ItemStructure',
        _type: typing.Union[MetaOapg.properties._type, str, schemas.Unset] = schemas.unset,
        timing: typing.Union['DvParsable', schemas.Unset] = schemas.unset,
