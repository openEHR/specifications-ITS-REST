...
class CareEntry(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def protocol() -> typing.Type['ItemStructure']:
                return ItemStructure
        
            @staticmethod
            def guideline_id() -> typing.Type['ObjectRef']:
                return ObjectRef
            __annotations__ = {
                "protocol": protocol,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["protocol"]) -> 'ItemStructure': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["guideline_id"]) -> 'ObjectRef': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["protocol", "guideline_id", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["protocol"]) -> typing.Union['ItemStructure', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["guideline_id"]) -> typing.Union['ObjectRef', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["protocol", "guideline_id", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        protocol: typing.Union['ItemStructure', schemas.Unset] = schemas.unset,
        guideline_id: typing.Union['ObjectRef', schemas.Unset] = schemas.unset,
