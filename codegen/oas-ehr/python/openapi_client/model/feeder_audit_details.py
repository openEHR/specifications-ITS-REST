...
class FeederAuditDetails(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def location() -> typing.Type['PartyIdentified']:
            ...
            @staticmethod
            def provider() -> typing.Type['PartyIdentified']:
                return PartyIdentified
        
            @staticmethod
            def time() -> typing.Type['DvDateTime']:
                return DvDateTime
            version_id = schemas.StrSchema
        
            @staticmethod
            def other_details() -> typing.Type['ItemStructure']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["location"]) -> 'PartyIdentified': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["subject"]) -> 'PartyProxy': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["provider"]) -> 'PartyIdentified': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["time"]) -> 'DvDateTime': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["version_id"]) -> MetaOapg.properties.version_id: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["other_details"]) -> 'ItemStructure': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["system_id", "location", "subject", "provider", "time", "version_id", "other_details", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["location"]) -> typing.Union['PartyIdentified', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["subject"]) -> typing.Union['PartyProxy', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["provider"]) -> typing.Union['PartyIdentified', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["time"]) -> typing.Union['DvDateTime', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["other_details"]) -> typing.Union['ItemStructure', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["system_id", "location", "subject", "provider", "time", "version_id", "other_details", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        system_id: typing.Union[MetaOapg.properties.system_id, str, ],
        location: typing.Union['PartyIdentified', schemas.Unset] = schemas.unset,
        subject: typing.Union['PartyProxy', schemas.Unset] = schemas.unset,
        provider: typing.Union['PartyIdentified', schemas.Unset] = schemas.unset,
        time: typing.Union['DvDateTime', schemas.Unset] = schemas.unset,
        version_id: typing.Union[MetaOapg.properties.version_id, str, schemas.Unset] = schemas.unset,
        other_details: typing.Union['ItemStructure', schemas.Unset] = schemas.unset,
