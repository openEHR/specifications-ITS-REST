...
class InstructionDetails(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def instruction_id() -> typing.Type['LocatableRef']:
                return LocatableRef
            activity_id = schemas.StrSchema
            _type = schemas.StrSchema
        
            @staticmethod
            def wf_details() -> typing.Type['ItemStructure']:
    ...
    activity_id: MetaOapg.properties.activity_id
    instruction_id: 'LocatableRef'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["instruction_id"]) -> 'LocatableRef': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["activity_id"]) -> MetaOapg.properties.activity_id: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_type"]) -> MetaOapg.properties._type: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["wf_details"]) -> 'ItemStructure': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["instruction_id", "activity_id", "_type", "wf_details", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["instruction_id"]) -> 'LocatableRef': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["activity_id"]) -> MetaOapg.properties.activity_id: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_type"]) -> typing.Union[MetaOapg.properties._type, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["wf_details"]) -> typing.Union['ItemStructure', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["instruction_id", "activity_id", "_type", "wf_details", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        activity_id: typing.Union[MetaOapg.properties.activity_id, str, ],
        instruction_id: 'LocatableRef',
        _type: typing.Union[MetaOapg.properties._type, str, schemas.Unset] = schemas.unset,
        wf_details: typing.Union['ItemStructure', schemas.Unset] = schemas.unset,
