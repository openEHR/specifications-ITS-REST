...
class Participation(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def function() -> typing.Type['DvText']:
                return DvText
        
            @staticmethod
            def performer() -> typing.Type['PartyProxy']:
                return PartyProxy
        
            @staticmethod
            def mode() -> typing.Type['DvCodedText']:
                return DvCodedText
        
            @staticmethod
            def time() -> typing.Type['DvIntervalOfDateTime']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["function"]) -> 'DvText': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["performer"]) -> 'PartyProxy': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["mode"]) -> 'DvCodedText': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["time"]) -> 'DvIntervalOfDateTime': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["function", "performer", "mode", "time", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["function"]) -> 'DvText': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["performer"]) -> 'PartyProxy': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["mode"]) -> typing.Union['DvCodedText', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["time"]) -> typing.Union['DvIntervalOfDateTime', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["function", "performer", "mode", "time", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        performer: 'PartyProxy',
        function: 'DvText',
        mode: typing.Union['DvCodedText', schemas.Unset] = schemas.unset,
        time: typing.Union['DvIntervalOfDateTime', schemas.Unset] = schemas.unset,
