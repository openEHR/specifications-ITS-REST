...
class DvInterval(
    ...
    class MetaOapg:
        ...
        def discriminator():
            return {
                '_type': {
                    ...
                    'DV_INTERVAL_of_DATE_TIME': DvIntervalOfDateTime,
        ...
        class properties:
            lower_unbounded = schemas.BoolSchema
            upper_unbounded = schemas.BoolSchema
            lower_included = schemas.BoolSchema
            upper_included = schemas.BoolSchema
    ...
    lower_included: MetaOapg.properties.lower_included
    upper_included: MetaOapg.properties.upper_included
    lower_unbounded: MetaOapg.properties.lower_unbounded
    upper_unbounded: MetaOapg.properties.upper_unbounded
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["lower_unbounded"]) -> MetaOapg.properties.lower_unbounded: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["upper_unbounded"]) -> MetaOapg.properties.upper_unbounded: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["lower_included"]) -> MetaOapg.properties.lower_included: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["upper_included"]) -> MetaOapg.properties.upper_included: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["lower_unbounded", "upper_unbounded", "lower_included", "upper_included", "_type", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["lower_unbounded"]) -> MetaOapg.properties.lower_unbounded: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["upper_unbounded"]) -> MetaOapg.properties.upper_unbounded: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["lower_included"]) -> MetaOapg.properties.lower_included: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["upper_included"]) -> MetaOapg.properties.upper_included: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["lower_unbounded", "upper_unbounded", "lower_included", "upper_included", "_type", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        lower_included: typing.Union[MetaOapg.properties.lower_included, bool, ],
        upper_included: typing.Union[MetaOapg.properties.upper_included, bool, ],
        lower_unbounded: typing.Union[MetaOapg.properties.lower_unbounded, bool, ],
        upper_unbounded: typing.Union[MetaOapg.properties.upper_unbounded, bool, ],
