...
class Ehr(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def system_id() -> typing.Type['HierObjectId']:
                return HierObjectId
        
            @staticmethod
            def ehr_id() -> typing.Type['HierObjectId']:
                return HierObjectId
        
            @staticmethod
            def ehr_status() -> typing.Type['ObjectRef']:
                return ObjectRef
        
            @staticmethod
            def ehr_access() -> typing.Type['ObjectRef']:
                return ObjectRef
        
            @staticmethod
            def time_created() -> typing.Type['DvDateTime']:
                return DvDateTime
            __annotations__ = {
                "system_id": system_id,
                "ehr_id": ehr_id,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["system_id"]) -> 'HierObjectId': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ehr_id"]) -> 'HierObjectId': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ehr_status"]) -> 'ObjectRef': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ehr_access"]) -> 'ObjectRef': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["time_created"]) -> 'DvDateTime': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["system_id", "ehr_id", "ehr_status", "ehr_access", "time_created", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["system_id"]) -> typing.Union['HierObjectId', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ehr_id"]) -> typing.Union['HierObjectId', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ehr_status"]) -> typing.Union['ObjectRef', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ehr_access"]) -> typing.Union['ObjectRef', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["time_created"]) -> typing.Union['DvDateTime', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["system_id", "ehr_id", "ehr_status", "ehr_access", "time_created", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        system_id: typing.Union['HierObjectId', schemas.Unset] = schemas.unset,
        ehr_id: typing.Union['HierObjectId', schemas.Unset] = schemas.unset,
        ehr_status: typing.Union['ObjectRef', schemas.Unset] = schemas.unset,
        ehr_access: typing.Union['ObjectRef', schemas.Unset] = schemas.unset,
        time_created: typing.Union['DvDateTime', schemas.Unset] = schemas.unset,
