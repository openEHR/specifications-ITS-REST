...
class Archetyped(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def archetype_id() -> typing.Type['ArchetypeId']:
                return ArchetypeId
            rm_version = schemas.StrSchema
        
            @staticmethod
            def template_id() -> typing.Type['TemplateId']:
                return TemplateId
            __annotations__ = {
    ...
    rm_version: MetaOapg.properties.rm_version
    archetype_id: 'ArchetypeId'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["rm_version"]) -> MetaOapg.properties.rm_version: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["archetype_id"]) -> 'ArchetypeId': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["template_id"]) -> 'TemplateId': ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["rm_version"], typing_extensions.Literal["archetype_id"], typing_extensions.Literal["template_id"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["rm_version"]) -> MetaOapg.properties.rm_version: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["archetype_id"]) -> 'ArchetypeId': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["template_id"]) -> typing.Union['TemplateId', schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["rm_version"], typing_extensions.Literal["archetype_id"], typing_extensions.Literal["template_id"], ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, ],
        rm_version: typing.Union[MetaOapg.properties.rm_version, str, ],
        archetype_id: 'ArchetypeId',
        template_id: typing.Union['TemplateId', schemas.Unset] = schemas.unset,
