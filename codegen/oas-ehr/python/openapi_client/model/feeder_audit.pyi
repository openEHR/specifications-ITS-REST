...
class FeederAudit(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def originating_system_audit() -> typing.Type['FeederAuditDetails']:
                return FeederAuditDetails
            
            
            class originating_system_item_ids(
                schemas.ListSchema
            ):
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DvIdentifier']:
                        return DvIdentifier
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['DvIdentifier'], typing.List['DvIdentifier']],
                ...
                def __getitem__(self, i: int) -> 'DvIdentifier':
                    return super().__getitem__(i)
            
            
            class feeder_system_item_ids(
                schemas.ListSchema
            ):
            ...
            @staticmethod
            def original_content() -> typing.Type['DvEncapsulated']:
                return DvEncapsulated
        
            @staticmethod
            def feeder_system_audit() -> typing.Type['FeederAuditDetails']:
                return FeederAuditDetails
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["originating_system_audit"]) -> 'FeederAuditDetails': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["originating_system_item_ids"]) -> MetaOapg.properties.originating_system_item_ids: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["feeder_system_item_ids"]) -> MetaOapg.properties.feeder_system_item_ids: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["original_content"]) -> 'DvEncapsulated': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["feeder_system_audit"]) -> 'FeederAuditDetails': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["originating_system_audit", "originating_system_item_ids", "feeder_system_item_ids", "original_content", "feeder_system_audit", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["originating_system_audit"]) -> 'FeederAuditDetails': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["originating_system_item_ids"]) -> typing.Union[MetaOapg.properties.originating_system_item_ids, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["feeder_system_item_ids"]) -> typing.Union[MetaOapg.properties.feeder_system_item_ids, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["original_content"]) -> typing.Union['DvEncapsulated', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["feeder_system_audit"]) -> typing.Union['FeederAuditDetails', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["originating_system_audit", "originating_system_item_ids", "feeder_system_item_ids", "original_content", "feeder_system_audit", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        originating_system_audit: 'FeederAuditDetails',
        originating_system_item_ids: typing.Union[MetaOapg.properties.originating_system_item_ids, list, tuple, schemas.Unset] = schemas.unset,
        feeder_system_item_ids: typing.Union[MetaOapg.properties.feeder_system_item_ids, list, tuple, schemas.Unset] = schemas.unset,
        original_content: typing.Union['DvEncapsulated', schemas.Unset] = schemas.unset,
        feeder_system_audit: typing.Union['FeederAuditDetails', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
