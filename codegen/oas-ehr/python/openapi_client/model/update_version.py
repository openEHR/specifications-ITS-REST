...
class UpdateVersion(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def lifecycle_state() -> typing.Type['TerminologyCode']:
                return TerminologyCode
        
            @staticmethod
            def data() -> typing.Type['Versionable']:
                return Versionable
        
            @staticmethod
            def commit_audit() -> typing.Type['UpdateAudit']:
                return UpdateAudit
            ...
            class attestations(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['UpdateAttestation']:
                        return UpdateAttestation
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['UpdateAttestation'], typing.List['UpdateAttestation']],
                ...
                def __getitem__(self, i: int) -> 'UpdateAttestation':
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["lifecycle_state"]) -> 'TerminologyCode': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'Versionable': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["commit_audit"]) -> 'UpdateAudit': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["lifecycle_state", "data", "commit_audit", "preceding_version_uid", "signature", "attestations", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["lifecycle_state"]) -> 'TerminologyCode': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'Versionable': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["commit_audit"]) -> 'UpdateAudit': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["lifecycle_state", "data", "commit_audit", "preceding_version_uid", "signature", "attestations", ], str]):
