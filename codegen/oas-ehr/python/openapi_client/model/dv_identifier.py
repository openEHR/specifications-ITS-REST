...
DV_IDENTIFIER is used to represent any identifier of a real thing, issued by some authority or agency.
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["assigner"]) -> MetaOapg.properties.assigner: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "issuer", "assigner", "type", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["assigner"]) -> typing.Union[MetaOapg.properties.assigner, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "issuer", "assigner", "type", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        assigner: typing.Union[MetaOapg.properties.assigner, str, schemas.Unset] = schemas.unset,
