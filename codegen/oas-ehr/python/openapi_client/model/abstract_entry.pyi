...
class AbstractEntry(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def language() -> typing.Type['CodePhrase']:
                return CodePhrase
        
            @staticmethod
            def encoding() -> typing.Type['CodePhrase']:
                return CodePhrase
        
            @staticmethod
            def subject() -> typing.Type['PartyProxy']:
                return PartyProxy
            
            
            class other_participations(
                schemas.ListSchema
            ):
            ...
            @staticmethod
            def workflow_id() -> typing.Type['ObjectRef']:
                return ObjectRef
        
            @staticmethod
            def provider() -> typing.Type['PartyProxy']:
                return PartyProxy
            __annotations__ = {
                "language": language,
                "encoding": encoding,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["language"]) -> 'CodePhrase': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["encoding"]) -> 'CodePhrase': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["subject"]) -> 'PartyProxy': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["other_participations"]) -> MetaOapg.properties.other_participations: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["workflow_id"]) -> 'ObjectRef': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["provider"]) -> 'PartyProxy': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["language", "encoding", "subject", "other_participations", "workflow_id", "provider", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["language"]) -> 'CodePhrase': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["encoding"]) -> 'CodePhrase': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["subject"]) -> 'PartyProxy': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["other_participations"]) -> typing.Union[MetaOapg.properties.other_participations, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["workflow_id"]) -> typing.Union['ObjectRef', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["provider"]) -> typing.Union['PartyProxy', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["language", "encoding", "subject", "other_participations", "workflow_id", "provider", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        language: 'CodePhrase',
        encoding: 'CodePhrase',
        other_participations: typing.Union[MetaOapg.properties.other_participations, list, tuple, schemas.Unset] = schemas.unset,
        workflow_id: typing.Union['ObjectRef', schemas.Unset] = schemas.unset,
        provider: typing.Union['PartyProxy', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
