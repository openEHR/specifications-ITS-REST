...
class EventContext(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def start_time() -> typing.Type['DvDateTime']:
                return DvDateTime
        
            @staticmethod
            def setting() -> typing.Type['DvCodedText']:
                return DvCodedText
        
            @staticmethod
            def end_time() -> typing.Type['DvDateTime']:
                return DvDateTime
            location = schemas.StrSchema
        
            @staticmethod
            def other_context() -> typing.Type['ItemStructure']:
                return ItemStructure
        
            @staticmethod
            def health_care_facility() -> typing.Type['PartyIdentified']:
            ...
            class participations(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Participation'], typing.List['Participation']],
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["start_time"]) -> 'DvDateTime': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["setting"]) -> 'DvCodedText': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["end_time"]) -> 'DvDateTime': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["location"]) -> MetaOapg.properties.location: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["other_context"]) -> 'ItemStructure': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["health_care_facility"]) -> 'PartyIdentified': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["participations"]) -> MetaOapg.properties.participations: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["start_time", "setting", "end_time", "location", "other_context", "health_care_facility", "participations", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["start_time"]) -> 'DvDateTime': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["setting"]) -> 'DvCodedText': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["end_time"]) -> typing.Union['DvDateTime', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["location"]) -> typing.Union[MetaOapg.properties.location, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["other_context"]) -> typing.Union['ItemStructure', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["health_care_facility"]) -> typing.Union['PartyIdentified', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["participations"]) -> typing.Union[MetaOapg.properties.participations, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["start_time", "setting", "end_time", "location", "other_context", "health_care_facility", "participations", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        start_time: 'DvDateTime',
        setting: 'DvCodedText',
        end_time: typing.Union['DvDateTime', schemas.Unset] = schemas.unset,
        location: typing.Union[MetaOapg.properties.location, str, schemas.Unset] = schemas.unset,
        other_context: typing.Union['ItemStructure', schemas.Unset] = schemas.unset,
        health_care_facility: typing.Union['PartyIdentified', schemas.Unset] = schemas.unset,
        participations: typing.Union[MetaOapg.properties.participations, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
