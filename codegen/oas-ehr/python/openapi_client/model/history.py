...
class History(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def origin() -> typing.Type['DvDateTime']:
                return DvDateTime
            _type = schemas.StrSchema
        
            @staticmethod
            def period() -> typing.Type['DvDuration']:
                return DvDuration
        
            @staticmethod
            def duration() -> typing.Type['DvDuration']:
                return DvDuration
        
            @staticmethod
            def summary() -> typing.Type['ItemStructure']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["origin"]) -> 'DvDateTime': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_type"]) -> MetaOapg.properties._type: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["period"]) -> 'DvDuration': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["duration"]) -> 'DvDuration': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["summary"]) -> 'ItemStructure': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["origin", "_type", "period", "duration", "summary", "events", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["origin"]) -> 'DvDateTime': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_type"]) -> typing.Union[MetaOapg.properties._type, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["period"]) -> typing.Union['DvDuration', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["duration"]) -> typing.Union['DvDuration', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["summary"]) -> typing.Union['ItemStructure', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["origin", "_type", "period", "duration", "summary", "events", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        period: typing.Union['DvDuration', schemas.Unset] = schemas.unset,
        duration: typing.Union['DvDuration', schemas.Unset] = schemas.unset,
        summary: typing.Union['ItemStructure', schemas.Unset] = schemas.unset,
