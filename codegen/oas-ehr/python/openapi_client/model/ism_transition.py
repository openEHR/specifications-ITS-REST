...
class IsmTransition(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def current_state() -> typing.Type['DvCodedText']:
                return DvCodedText
            _type = schemas.StrSchema
        
            @staticmethod
            def transition() -> typing.Type['DvCodedText']:
                return DvCodedText
        
            @staticmethod
            def careflow_step() -> typing.Type['DvCodedText']:
                return DvCodedText
            ...
            class reason(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DvText']:
                        return DvText
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['DvText'], typing.List['DvText']],
                ...
                def __getitem__(self, i: int) -> 'DvText':
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["current_state"]) -> 'DvCodedText': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_type"]) -> MetaOapg.properties._type: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["transition"]) -> 'DvCodedText': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["careflow_step"]) -> 'DvCodedText': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["current_state", "_type", "transition", "careflow_step", "reason", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["current_state"]) -> 'DvCodedText': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_type"]) -> typing.Union[MetaOapg.properties._type, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["transition"]) -> typing.Union['DvCodedText', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["careflow_step"]) -> typing.Union['DvCodedText', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["current_state", "_type", "transition", "careflow_step", "reason", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        transition: typing.Union['DvCodedText', schemas.Unset] = schemas.unset,
        careflow_step: typing.Union['DvCodedText', schemas.Unset] = schemas.unset,
        reason: typing.Union[MetaOapg.properties.reason, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
