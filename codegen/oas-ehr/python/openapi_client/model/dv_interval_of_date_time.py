...
class DvIntervalOfDateTime(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def lower() -> typing.Type['DvDateTime']:
                return DvDateTime
        
            @staticmethod
            def upper() -> typing.Type['DvDateTime']:
                return DvDateTime
            __annotations__ = {
                "_type": _type,
                "lower": lower,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["lower"]) -> 'DvDateTime': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["upper"]) -> 'DvDateTime': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["_type", "lower", "upper", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["lower"]) -> typing.Union['DvDateTime', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["upper"]) -> typing.Union['DvDateTime', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["_type", "lower", "upper", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        lower: typing.Union['DvDateTime', schemas.Unset] = schemas.unset,
        upper: typing.Union['DvDateTime', schemas.Unset] = schemas.unset,
