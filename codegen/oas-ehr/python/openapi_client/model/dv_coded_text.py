...
class DvCodedText(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def defining_code() -> typing.Type['CodePhrase']:
                return CodePhrase
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["defining_code"]) -> 'CodePhrase': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["defining_code", "_type", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["defining_code"]) -> 'CodePhrase': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["defining_code", "_type", ], str]):
