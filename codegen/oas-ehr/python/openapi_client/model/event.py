...
class Event(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['ItemStructure']:
                return ItemStructure
            _type = schemas.StrSchema
        
            @staticmethod
            def state() -> typing.Type['ItemStructure']:
                return ItemStructure
            __annotations__ = {
                "time": time,
                "data": data,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'ItemStructure': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_type"]) -> MetaOapg.properties._type: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["state"]) -> 'ItemStructure': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["time", "data", "_type", "state", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'ItemStructure': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_type"]) -> typing.Union[MetaOapg.properties._type, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["state"]) -> typing.Union['ItemStructure', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["time", "data", "_type", "state", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        state: typing.Union['ItemStructure', schemas.Unset] = schemas.unset,
