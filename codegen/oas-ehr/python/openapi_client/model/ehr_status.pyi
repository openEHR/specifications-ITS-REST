...
class EhrStatus(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            def subject() -> typing.Type['PartyProxy']:
                return PartyProxy
            is_queryable = schemas.BoolSchema
            is_modifiable = schemas.BoolSchema
    ...
    is_queryable: MetaOapg.properties.is_queryable
    subject: 'PartyProxy'
    is_modifiable: MetaOapg.properties.is_modifiable
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["subject"]) -> 'PartyProxy': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["is_queryable"]) -> MetaOapg.properties.is_queryable: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["is_modifiable"]) -> MetaOapg.properties.is_modifiable: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["subject", "is_queryable", "is_modifiable", "_type", "other_details", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["is_queryable"]) -> MetaOapg.properties.is_queryable: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["is_modifiable"]) -> MetaOapg.properties.is_modifiable: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["subject", "is_queryable", "is_modifiable", "_type", "other_details", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        is_queryable: typing.Union[MetaOapg.properties.is_queryable, bool, ],
        subject: 'PartyProxy',
        is_modifiable: typing.Union[MetaOapg.properties.is_modifiable, bool, ],
