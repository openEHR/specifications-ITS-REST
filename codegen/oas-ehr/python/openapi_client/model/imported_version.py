...
class ImportedVersion(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def item() -> typing.Type['OriginalVersion']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["item"]) -> 'OriginalVersion': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["item", "_type", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["item"]) -> 'OriginalVersion': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["item", "_type", ], str]):
