...
class AuditDetails(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def time_committed() -> typing.Type['DvDateTime']:
                return DvDateTime
        
            @staticmethod
            def change_type() -> typing.Type['DvCodedText']:
                return DvCodedText
        
            @staticmethod
            def committer() -> typing.Type['PartyProxy']:
                return PartyProxy
            _type = schemas.StrSchema
        
            @staticmethod
            def description() -> typing.Type['DvText']:
                return DvText
            __annotations__ = {
                "system_id": system_id,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["time_committed"]) -> 'DvDateTime': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["change_type"]) -> 'DvCodedText': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["committer"]) -> 'PartyProxy': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_type"]) -> MetaOapg.properties._type: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["description"]) -> 'DvText': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["system_id", "time_committed", "change_type", "committer", "_type", "description", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["time_committed"]) -> 'DvDateTime': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["change_type"]) -> 'DvCodedText': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["committer"]) -> 'PartyProxy': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_type"]) -> typing.Union[MetaOapg.properties._type, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["description"]) -> typing.Union['DvText', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["system_id", "time_committed", "change_type", "committer", "_type", "description", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        description: typing.Union['DvText', schemas.Unset] = schemas.unset,
