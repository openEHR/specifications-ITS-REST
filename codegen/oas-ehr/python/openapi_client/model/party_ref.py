...
class PartyRef(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                class MetaOapg:
                    regex=[{
                        'pattern': r'^PERSON|ORGANISATION|GROUP|AGENT|ROLE|PARTY|ACTOR$',  # noqa: E501
                    }]
        
            @staticmethod
            def id() -> typing.Type['ObjectId']:
                return ObjectId
            __annotations__ = {
                "namespace": namespace,
                "type": type,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["id"]) -> 'ObjectId': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["namespace", "type", "id", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["id"]) -> 'ObjectId': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["namespace", "type", "id", ], str]):
