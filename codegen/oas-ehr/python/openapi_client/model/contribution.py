...
class Contribution(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def audit() -> typing.Type['AuditDetails']:
                return AuditDetails
            __annotations__ = {
                "uid": uid,
                "versions": versions,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["audit"]) -> 'AuditDetails': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["uid", "versions", "audit", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["audit"]) -> 'AuditDetails': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["uid", "versions", "audit", ], str]):
