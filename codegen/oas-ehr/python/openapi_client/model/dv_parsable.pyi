...
class DvParsable(
    ...
    formalism: MetaOapg.properties.formalism
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["formalism"]) -> MetaOapg.properties.formalism: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["value", "formalism", "_type", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["formalism"]) -> MetaOapg.properties.formalism: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["value", "formalism", "_type", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        formalism: typing.Union[MetaOapg.properties.formalism, str, ],
