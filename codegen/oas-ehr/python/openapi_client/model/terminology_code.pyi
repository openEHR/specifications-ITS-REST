...
class TerminologyCode(
    ...
    class MetaOapg:
        ...
        class properties:
            terminology_id = schemas.StrSchema
            code_string = schemas.StrSchema
            terminology_version = schemas.StrSchema
    ...
    terminology_id: MetaOapg.properties.terminology_id
    code_string: MetaOapg.properties.code_string
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["terminology_id"]) -> MetaOapg.properties.terminology_id: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["code_string"]) -> MetaOapg.properties.code_string: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["terminology_version"]) -> MetaOapg.properties.terminology_version: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["terminology_id", "code_string", "terminology_version", "uri", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["terminology_id"]) -> MetaOapg.properties.terminology_id: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["code_string"]) -> MetaOapg.properties.code_string: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["terminology_version"]) -> typing.Union[MetaOapg.properties.terminology_version, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["terminology_id", "code_string", "terminology_version", "uri", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        terminology_id: typing.Union[MetaOapg.properties.terminology_id, str, ],
        code_string: typing.Union[MetaOapg.properties.code_string, str, ],
        terminology_version: typing.Union[MetaOapg.properties.terminology_version, str, schemas.Unset] = schemas.unset,
