...
class TermMapping(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def target() -> typing.Type['CodePhrase']:
                return CodePhrase
        
            @staticmethod
            def purpose() -> typing.Type['DvCodedText']:
                return DvCodedText
            __annotations__ = {
                "match": match,
                "target": target,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["target"]) -> 'CodePhrase': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["purpose"]) -> 'DvCodedText': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["match", "target", "purpose", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["target"]) -> 'CodePhrase': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["purpose"]) -> typing.Union['DvCodedText', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["match", "target", "purpose", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        target: 'CodePhrase',
        purpose: typing.Union['DvCodedText', schemas.Unset] = schemas.unset,
