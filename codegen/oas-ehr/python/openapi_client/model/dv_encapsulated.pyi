...
class DvEncapsulated(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def charset() -> typing.Type['CodePhrase']:
                return CodePhrase
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["charset"]) -> 'CodePhrase': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["_type", "charset", "language", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["charset"]) -> typing.Union['CodePhrase', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["_type", "charset", "language", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        charset: typing.Union['CodePhrase', schemas.Unset] = schemas.unset,
