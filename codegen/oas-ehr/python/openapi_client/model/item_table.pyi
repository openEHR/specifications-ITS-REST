...
class ItemTable(
        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Clstr']:
                        return Clstr
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Clstr'], typing.List['Clstr']],
                ...
                def __getitem__(self, i: int) -> 'Clstr':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["_type", "items", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["_type", "items", ], str]):
