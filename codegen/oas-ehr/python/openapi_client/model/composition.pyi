...
class Composition(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def territory() -> typing.Type['CodePhrase']:
                return CodePhrase
        
            @staticmethod
            def category() -> typing.Type['DvCodedText']:
                return DvCodedText
        
            @staticmethod
            def context() -> typing.Type['EventContext']:
                return EventContext
        
            @staticmethod
            def composer() -> typing.Type['PartyProxy']:
                return PartyProxy
            ...
            class content(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ContentItem'], typing.List['ContentItem']],
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["territory"]) -> 'CodePhrase': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["category"]) -> 'DvCodedText': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["context"]) -> 'EventContext': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["composer"]) -> 'PartyProxy': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["language", "territory", "category", "context", "composer", "content", "_type", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["territory"]) -> 'CodePhrase': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["category"]) -> 'DvCodedText': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["context"]) -> 'EventContext': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["composer"]) -> 'PartyProxy': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["language", "territory", "category", "context", "composer", "content", "_type", ], str]):
