...
class DIRECTORYApi:
    ...
    def directory_create(
        ...
        folder: Annotated[Folder, Field(description="The directory. ")],
        ...
        _param = self._directory_create_serialize(
            ehr_id=ehr_id,
            folder=folder,
            prefer=prefer,
    ...
    @validate_call
    def directory_create_with_http_info(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        folder: Annotated[Folder, Field(description="The directory. ")],
        prefer: Annotated[Optional[StrictStr], Field(description="Request header to indicate the preference over response details. The response will contain the entire resource when the `Prefer` header has a value of `return=representation`. ")] = None,
    ...
    @validate_call
    def directory_create_without_preload_content(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        folder: Annotated[Folder, Field(description="The directory. ")],
        prefer: Annotated[Optional[StrictStr], Field(description="Request header to indicate the preference over response details. The response will contain the entire resource when the `Prefer` header has a value of `return=representation`. ")] = None,
    ...
    def _directory_create_serialize(
        self,
        ehr_id,
        folder,
        prefer,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/ehr/{ehr_id}/directory',
    ...
    def directory_delete(
        ...
        _param = self._directory_delete_serialize(
            ehr_id=ehr_id,
            if_match=if_match,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def directory_delete_with_http_info(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        if_match: Annotated[StrictStr, Field(description="Header to make the request conditional.  Together with `ETag` request tag, it helps to prevent simultaneous updates of a resource from overwriting each other (\"mid-air collisions\"). The format is always an `version_uid` identifier enclosed by double quotes. The operation will be performed only if the existing latest `version_uid` of the resource (i.e. the `preceding_version_uid`) matches this header's value. ")],
        _request_timeout: Union[
    ...
    @validate_call
    def directory_delete_without_preload_content(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        if_match: Annotated[StrictStr, Field(description="Header to make the request conditional.  Together with `ETag` request tag, it helps to prevent simultaneous updates of a resource from overwriting each other (\"mid-air collisions\"). The format is always an `version_uid` identifier enclosed by double quotes. The operation will be performed only if the existing latest `version_uid` of the resource (i.e. the `preceding_version_uid`) matches this header's value. ")],
        _request_timeout: Union[
    ...
    def _directory_delete_serialize(
        self,
        ehr_id,
        if_match,
        _request_auth,
    ...
    @validate_call
    def directory_get_at_time(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        version_at_time: Annotated[Optional[StrictStr], Field(description="A given time in the extended ISO 8601 format. ")] = None,
        path: Annotated[Optional[StrictStr], Field(description="A path to a sub-folder; consists of slash-separated values of the name attribute of FOLDERs in the directory. ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._directory_get_at_time_serialize(
            ehr_id=ehr_id,
    ...
    @validate_call
    def directory_get_at_time_with_http_info(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        version_at_time: Annotated[Optional[StrictStr], Field(description="A given time in the extended ISO 8601 format. ")] = None,
        path: Annotated[Optional[StrictStr], Field(description="A path to a sub-folder; consists of slash-separated values of the name attribute of FOLDERs in the directory. ")] = None,
    ...
    @validate_call
    def directory_get_at_time_without_preload_content(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        version_at_time: Annotated[Optional[StrictStr], Field(description="A given time in the extended ISO 8601 format. ")] = None,
        path: Annotated[Optional[StrictStr], Field(description="A path to a sub-folder; consists of slash-separated values of the name attribute of FOLDERs in the directory. ")] = None,
    ...
    def _directory_get_at_time_serialize(
        self,
        ehr_id,
        version_at_time,
        path,
    ...
    @validate_call
    def directory_get_by_version_id(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        ...
        _param = self._directory_get_by_version_id_serialize(
            ehr_id=ehr_id,
    ...
    @validate_call
    def directory_get_by_version_id_with_http_info(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        version_uid: Annotated[StrictStr, Field(description="VERSION identifier taken from VERSION.uid.value. ")],
        path: Annotated[Optional[StrictStr], Field(description="A path to a sub-folder; consists of slash-separated values of the name attribute of FOLDERs in the directory. ")] = None,
    ...
    @validate_call
    def directory_get_by_version_id_without_preload_content(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        version_uid: Annotated[StrictStr, Field(description="VERSION identifier taken from VERSION.uid.value. ")],
        path: Annotated[Optional[StrictStr], Field(description="A path to a sub-folder; consists of slash-separated values of the name attribute of FOLDERs in the directory. ")] = None,
    ...
    def _directory_get_by_version_id_serialize(
        self,
        ehr_id,
        version_uid,
        path,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/ehr/{ehr_id}/directory/{version_uid}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def directory_update(
        ...
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        if_match: Annotated[StrictStr, Field(description="Header to make the request conditional.  Together with `ETag` request tag, it helps to prevent simultaneous updates of a resource from overwriting each other (\"mid-air collisions\"). The format is always an `version_uid` identifier enclosed by double quotes. The operation will be performed only if the existing latest `version_uid` of the resource (i.e. the `preceding_version_uid`) matches this header's value. ")],
        folder: Annotated[Folder, Field(description="The new directory. ")],
        prefer: Annotated[Optional[StrictStr], Field(description="Request header to indicate the preference over response details. The response will contain the entire resource when the `Prefer` header has a value of `return=representation`. ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._directory_update_serialize(
            ehr_id=ehr_id,
            if_match=if_match,
            folder=folder,
            prefer=prefer,
    ...
    @validate_call
    def directory_update_with_http_info(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        if_match: Annotated[StrictStr, Field(description="Header to make the request conditional.  Together with `ETag` request tag, it helps to prevent simultaneous updates of a resource from overwriting each other (\"mid-air collisions\"). The format is always an `version_uid` identifier enclosed by double quotes. The operation will be performed only if the existing latest `version_uid` of the resource (i.e. the `preceding_version_uid`) matches this header's value. ")],
        folder: Annotated[Folder, Field(description="The new directory. ")],
    ...
    @validate_call
    def directory_update_without_preload_content(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        if_match: Annotated[StrictStr, Field(description="Header to make the request conditional.  Together with `ETag` request tag, it helps to prevent simultaneous updates of a resource from overwriting each other (\"mid-air collisions\"). The format is always an `version_uid` identifier enclosed by double quotes. The operation will be performed only if the existing latest `version_uid` of the resource (i.e. the `preceding_version_uid`) matches this header's value. ")],
        folder: Annotated[Folder, Field(description="The new directory. ")],
    ...
    def _directory_update_serialize(
        self,
        ehr_id,
        if_match,
        folder,
