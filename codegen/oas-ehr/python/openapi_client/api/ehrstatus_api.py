...
class EHRSTATUSApi:
    ...
    @validate_call
    def ehr_status_get_at_time(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        version_at_time: Annotated[Optional[StrictStr], Field(description="A given time in the extended ISO 8601 format. ")] = None,
        ...
        _param = self._ehr_status_get_at_time_serialize(
            ehr_id=ehr_id,
    ...
    @validate_call
    def ehr_status_get_at_time_with_http_info(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        version_at_time: Annotated[Optional[StrictStr], Field(description="A given time in the extended ISO 8601 format. ")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def ehr_status_get_at_time_without_preload_content(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        version_at_time: Annotated[Optional[StrictStr], Field(description="A given time in the extended ISO 8601 format. ")] = None,
        _request_timeout: Union[
    ...
    def _ehr_status_get_at_time_serialize(
        self,
        ehr_id,
        version_at_time,
        _request_auth,
        ...
        if version_at_time is not None:
            ...
            _query_params.append(('version_at_time', version_at_time))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/ehr/{ehr_id}/ehr_status',
    ...
    @validate_call
    def ehr_status_get_by_version_id(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        version_uid: Annotated[StrictStr, Field(description="VERSION identifier taken from VERSION.uid.value. ")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param ehr_id: EHR identifier taken from EHR.ehr_id.value.  (required)
        :type ehr_id: str
        :param version_uid: VERSION identifier taken from VERSION.uid.value.  (required)
        ...
        _param = self._ehr_status_get_by_version_id_serialize(
            ehr_id=ehr_id,
    ...
    @validate_call
    def ehr_status_get_by_version_id_with_http_info(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        version_uid: Annotated[StrictStr, Field(description="VERSION identifier taken from VERSION.uid.value. ")],
        _request_timeout: Union[
    ...
    @validate_call
    def ehr_status_get_by_version_id_without_preload_content(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        version_uid: Annotated[StrictStr, Field(description="VERSION identifier taken from VERSION.uid.value. ")],
        _request_timeout: Union[
    ...
    def _ehr_status_get_by_version_id_serialize(
        self,
        ehr_id,
        version_uid,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/ehr/{ehr_id}/ehr_status/{version_uid}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def ehr_status_update(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        if_match: Annotated[StrictStr, Field(description="Header to make the request conditional.  Together with `ETag` request tag, it helps to prevent simultaneous updates of a resource from overwriting each other (\"mid-air collisions\"). The format is always an `version_uid` identifier enclosed by double quotes. The operation will be performed only if the existing latest `version_uid` of the resource (i.e. the `preceding_version_uid`) matches this header's value. ")],
        ehr_status: Annotated[EhrStatus, Field(description="The new EHR_STATUS. ")],
        ...
        :type if_match: str
        :param ehr_status: The new EHR_STATUS.  (required)
        ...
        _param = self._ehr_status_update_serialize(
            ehr_id=ehr_id,
            if_match=if_match,
    ...
    @validate_call
    def ehr_status_update_with_http_info(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        if_match: Annotated[StrictStr, Field(description="Header to make the request conditional.  Together with `ETag` request tag, it helps to prevent simultaneous updates of a resource from overwriting each other (\"mid-air collisions\"). The format is always an `version_uid` identifier enclosed by double quotes. The operation will be performed only if the existing latest `version_uid` of the resource (i.e. the `preceding_version_uid`) matches this header's value. ")],
        ehr_status: Annotated[EhrStatus, Field(description="The new EHR_STATUS. ")],
    ...
    @validate_call
    def ehr_status_update_without_preload_content(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        if_match: Annotated[StrictStr, Field(description="Header to make the request conditional.  Together with `ETag` request tag, it helps to prevent simultaneous updates of a resource from overwriting each other (\"mid-air collisions\"). The format is always an `version_uid` identifier enclosed by double quotes. The operation will be performed only if the existing latest `version_uid` of the resource (i.e. the `preceding_version_uid`) matches this header's value. ")],
        ehr_status: Annotated[EhrStatus, Field(description="The new EHR_STATUS. ")],
    ...
    def _ehr_status_update_serialize(
        self,
        ehr_id,
        if_match,
        ehr_status,
    ...
    def versioned_ehr_status_get(
        ...
        _param = self._versioned_ehr_status_get_serialize(
            ehr_id=ehr_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def versioned_ehr_status_get_with_http_info(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[VersionedEhrStatus]:
        """Get versioned EHR_STATUS
    ...
    @validate_call
    def versioned_ehr_status_get_without_preload_content(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        _request_timeout: Union[
            None,
    ...
    def _versioned_ehr_status_get_serialize(
        self,
        ehr_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/ehr/{ehr_id}/versioned_ehr_status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def versioned_ehr_status_revision_history(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        _request_timeout: Union[
            None,
        ...
        _param = self._versioned_ehr_status_revision_history_serialize(
            ehr_id=ehr_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def versioned_ehr_status_revision_history_with_http_info(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def versioned_ehr_status_revision_history_without_preload_content(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        _request_timeout: Union[
            None,
    ...
    def _versioned_ehr_status_revision_history_serialize(
        self,
        ehr_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/ehr/{ehr_id}/versioned_ehr_status/revision_history',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def versioned_ehr_status_version_get_at_time(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        version_at_time: Annotated[Optional[StrictStr], Field(description="A given time in the extended ISO 8601 format. ")] = None,
        _request_timeout: Union[
        ...
        _param = self._versioned_ehr_status_version_get_at_time_serialize(
            ehr_id=ehr_id,
            version_at_time=version_at_time,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def versioned_ehr_status_version_get_at_time_with_http_info(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        version_at_time: Annotated[Optional[StrictStr], Field(description="A given time in the extended ISO 8601 format. ")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def versioned_ehr_status_version_get_at_time_without_preload_content(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        version_at_time: Annotated[Optional[StrictStr], Field(description="A given time in the extended ISO 8601 format. ")] = None,
        _request_timeout: Union[
    ...
    def _versioned_ehr_status_version_get_at_time_serialize(
        self,
        ehr_id,
        version_at_time,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/ehr/{ehr_id}/versioned_ehr_status/version',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def versioned_ehr_status_version_get_by_id(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        version_uid: Annotated[StrictStr, Field(description="VERSION identifier taken from VERSION.uid.value. ")],
        _request_timeout: Union[
        ...
        _param = self._versioned_ehr_status_version_get_by_id_serialize(
            ehr_id=ehr_id,
            version_uid=version_uid,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def versioned_ehr_status_version_get_by_id_with_http_info(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        version_uid: Annotated[StrictStr, Field(description="VERSION identifier taken from VERSION.uid.value. ")],
        _request_timeout: Union[
    ...
    @validate_call
    def versioned_ehr_status_version_get_by_id_without_preload_content(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        version_uid: Annotated[StrictStr, Field(description="VERSION identifier taken from VERSION.uid.value. ")],
        _request_timeout: Union[
    ...
    def _versioned_ehr_status_version_get_by_id_serialize(
        self,
        ehr_id,
        version_uid,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/ehr/{ehr_id}/versioned_ehr_status/version/{version_uid}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
