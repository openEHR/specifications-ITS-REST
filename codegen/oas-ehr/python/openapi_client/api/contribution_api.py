...
class CONTRIBUTIONApi:
    ...
    def contribution_create(
        ...
        new_contribution: Annotated[NewContribution, Field(description="The CONTRIBUTION. ")],
        ...
        :type ehr_id: str
        :param new_contribution: The CONTRIBUTION.  (required)
        :type new_contribution: NewContribution
        ...
        _param = self._contribution_create_serialize(
            ehr_id=ehr_id,
    ...
    @validate_call
    def contribution_create_with_http_info(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        new_contribution: Annotated[NewContribution, Field(description="The CONTRIBUTION. ")],
        prefer: Annotated[Optional[StrictStr], Field(description="Request header to indicate the preference over response details. The response will contain the entire resource when the `Prefer` header has a value of `return=representation`. ")] = None,
    ...
    @validate_call
    def contribution_create_without_preload_content(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        new_contribution: Annotated[NewContribution, Field(description="The CONTRIBUTION. ")],
        prefer: Annotated[Optional[StrictStr], Field(description="Request header to indicate the preference over response details. The response will contain the entire resource when the `Prefer` header has a value of `return=representation`. ")] = None,
    ...
    def _contribution_create_serialize(
        self,
        ehr_id,
        new_contribution,
        prefer,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/ehr/{ehr_id}/contribution',
    ...
    def contribution_get(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        contribution_uid: Annotated[StrictStr, Field(description="The CONTRIBUTION uid. ")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param ehr_id: EHR identifier taken from EHR.ehr_id.value.  (required)
        :type ehr_id: str
        :param contribution_uid: The CONTRIBUTION uid.  (required)
        :type contribution_uid: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._contribution_get_serialize(
            ehr_id=ehr_id,
    ...
    @validate_call
    def contribution_get_with_http_info(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        contribution_uid: Annotated[StrictStr, Field(description="The CONTRIBUTION uid. ")],
        _request_timeout: Union[
    ...
    @validate_call
    def contribution_get_without_preload_content(
        self,
        ehr_id: Annotated[StrictStr, Field(description="EHR identifier taken from EHR.ehr_id.value. ")],
        contribution_uid: Annotated[StrictStr, Field(description="The CONTRIBUTION uid. ")],
        _request_timeout: Union[
    ...
    def _contribution_get_serialize(
        self,
        ehr_id,
        contribution_uid,
        _request_auth,
        ...
        if ehr_id is not None:
            _path_params['ehr_id'] = ehr_id
        if contribution_uid is not None:
            _path_params['contribution_uid'] = contribution_uid
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/ehr/{ehr_id}/contribution/{contribution_uid}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
