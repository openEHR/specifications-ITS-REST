...
#
package WWW::OpenAPIClient::EHRSTATUSApi;
...
# @param string $version_at_time A given time in the extended ISO 8601 format.  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'ehr_status_get_at_time' } = {
...
# @return EhrStatus
#
sub ehr_status_get_at_time {
    my ($self, %args) = @_;

    # verify the required parameter 'ehr_id' is set
    unless (exists $args{'ehr_id'}) {
      croak("Missing the required parameter 'ehr_id' when calling ehr_status_get_at_time");
    }

    # parse inputs
    my $_resource_path = '/ehr/{ehr_id}/ehr_status';
    ...
    my $_response_object = $self->{api_client}->deserialize('EhrStatus', $response);
...
# @param string $version_uid VERSION identifier taken from VERSION.uid.value.  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'ehr_status_get_by_version_id' } = {
...
# @return EhrStatus
#
sub ehr_status_get_by_version_id {
    my ($self, %args) = @_;

    # verify the required parameter 'ehr_id' is set
    unless (exists $args{'ehr_id'}) {
      croak("Missing the required parameter 'ehr_id' when calling ehr_status_get_by_version_id");
    }

    # verify the required parameter 'version_uid' is set
    unless (exists $args{'version_uid'}) {
      croak("Missing the required parameter 'version_uid' when calling ehr_status_get_by_version_id");
    }

    # parse inputs
    my $_resource_path = '/ehr/{ehr_id}/ehr_status/{version_uid}';
...
# @param EhrStatus $ehr_status The new EHR_STATUS.  (required)
# @param string $prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;.  (optional, default to 'return=minimal')
{
    ...
    __PACKAGE__->method_documentation->{ 'ehr_status_update' } = {
...
# @return EhrStatus
#
sub ehr_status_update {
    my ($self, %args) = @_;

    # verify the required parameter 'ehr_id' is set
    unless (exists $args{'ehr_id'}) {
      croak("Missing the required parameter 'ehr_id' when calling ehr_status_update");
    }

    # verify the required parameter 'if_match' is set
    unless (exists $args{'if_match'}) {
      croak("Missing the required parameter 'if_match' when calling ehr_status_update");
    }

    # verify the required parameter 'ehr_status' is set
    unless (exists $args{'ehr_status'}) {
      croak("Missing the required parameter 'ehr_status' when calling ehr_status_update");
    }
    ...
    my $_body_data;
    # body params
    if ( exists $args{'ehr_status'}) {
        $_body_data = $args{'ehr_status'};
    }
...
# @param string $ehr_id EHR identifier taken from EHR.ehr_id.value.  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'versioned_ehr_status_get' } = {
        summary => 'Get versioned EHR_STATUS',
        params => $params,
        returns => 'VersionedEhrStatus',
        };
}
# @return VersionedEhrStatus
#
sub versioned_ehr_status_get {
    my ($self, %args) = @_;

    # verify the required parameter 'ehr_id' is set
    unless (exists $args{'ehr_id'}) {
      croak("Missing the required parameter 'ehr_id' when calling versioned_ehr_status_get");
    }

    # parse inputs
    my $_resource_path = '/ehr/{ehr_id}/versioned_ehr_status';
    ...
    my $_response_object = $self->{api_client}->deserialize('VersionedEhrStatus', $response);
    return $_response_object;
}
...
# @param string $ehr_id EHR identifier taken from EHR.ehr_id.value.  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'versioned_ehr_status_revision_history' } = {
...
#
sub versioned_ehr_status_revision_history {
    my ($self, %args) = @_;

    # verify the required parameter 'ehr_id' is set
    unless (exists $args{'ehr_id'}) {
      croak("Missing the required parameter 'ehr_id' when calling versioned_ehr_status_revision_history");
    }

    # parse inputs
    my $_resource_path = '/ehr/{ehr_id}/versioned_ehr_status/revision_history';
...
# @param string $version_at_time A given time in the extended ISO 8601 format.  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'versioned_ehr_status_version_get_at_time' } = {
...
# @return Version
#
sub versioned_ehr_status_version_get_at_time {
    my ($self, %args) = @_;

    # verify the required parameter 'ehr_id' is set
    unless (exists $args{'ehr_id'}) {
      croak("Missing the required parameter 'ehr_id' when calling versioned_ehr_status_version_get_at_time");
    }

    # parse inputs
    my $_resource_path = '/ehr/{ehr_id}/versioned_ehr_status/version';
...
# @param string $version_uid VERSION identifier taken from VERSION.uid.value.  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'versioned_ehr_status_version_get_by_id' } = {
...
# @return Version
#
sub versioned_ehr_status_version_get_by_id {
    my ($self, %args) = @_;

    # verify the required parameter 'ehr_id' is set
    unless (exists $args{'ehr_id'}) {
      croak("Missing the required parameter 'ehr_id' when calling versioned_ehr_status_version_get_by_id");
    }

    # verify the required parameter 'version_uid' is set
    unless (exists $args{'version_uid'}) {
      croak("Missing the required parameter 'version_uid' when calling versioned_ehr_status_version_get_by_id");
    }

    # parse inputs
    my $_resource_path = '/ehr/{ehr_id}/versioned_ehr_status/version/{version_uid}';
