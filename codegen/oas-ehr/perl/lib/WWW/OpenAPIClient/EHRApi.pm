...
#
package WWW::OpenAPIClient::EHRApi;
...
# @param EhrStatus $ehr_status An EHR_STATUS resource MAY be also supplied by the client as the request body.  (optional)
{
    my $params = {
    'prefer' => {
        data_type => 'string',
    ...
    __PACKAGE__->method_documentation->{ 'ehr_create' } = {
        summary => 'Create EHR',
        params => $params,
        returns => 'Ehr',
        };
...
sub ehr_create {
    ...
    my $_response_object = $self->{api_client}->deserialize('Ehr', $response);
...
# @param EhrStatus $ehr_status An EHR_STATUS resource MAY be also supplied by the client as the request body.  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'ehr_create_with_id' } = {
...
# @return Ehr
#
sub ehr_create_with_id {
    my ($self, %args) = @_;

    # verify the required parameter 'ehr_id' is set
    unless (exists $args{'ehr_id'}) {
      croak("Missing the required parameter 'ehr_id' when calling ehr_create_with_id");
    }

    # parse inputs
    my $_resource_path = '/ehr/{ehr_id}';
...
# @param string $ehr_id EHR identifier taken from EHR.ehr_id.value.  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'ehr_get_by_id' } = {
...
sub ehr_get_by_id {
    ...
    # verify the required parameter 'ehr_id' is set
    unless (exists $args{'ehr_id'}) {
      croak("Missing the required parameter 'ehr_id' when calling ehr_get_by_id");
    }
...
# @param string $subject_namespace The EHR subject id namespace.  (required)
{
    ...
    'subject_id' => {
        data_type => 'string',
        description => 'The EHR subject id. ',
        required => '1',
    },
    'subject_namespace' => {
        data_type => 'string',
        description => 'The EHR subject id namespace. ',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'ehr_get_by_subject' } = {
...
# @return Ehr
#
sub ehr_get_by_subject {
    my ($self, %args) = @_;

    # verify the required parameter 'subject_id' is set
    unless (exists $args{'subject_id'}) {
      croak("Missing the required parameter 'subject_id' when calling ehr_get_by_subject");
    }

    # verify the required parameter 'subject_namespace' is set
    unless (exists $args{'subject_namespace'}) {
      croak("Missing the required parameter 'subject_namespace' when calling ehr_get_by_subject");
    }
    ...
    # query params
    if ( exists $args{'subject_id'}) {
        $query_params->{'subject_id'} = $self->{api_client}->to_query_value($args{'subject_id'});
    }

    # query params
    if ( exists $args{'subject_namespace'}) {
        $query_params->{'subject_namespace'} = $self->{api_client}->to_query_value($args{'subject_namespace'});
    }
