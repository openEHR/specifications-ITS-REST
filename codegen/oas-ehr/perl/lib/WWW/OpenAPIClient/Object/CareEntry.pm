...
#
package WWW::OpenAPIClient::Object::CareEntry;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::AbstractEntry");
...
sub init
{
    ...
    # initialize parent object AbstractEntry
    $self->WWW::OpenAPIClient::Object::AbstractEntry::init(%args);
}
...
sub to_hash {
    ...
    # call AbstractEntry to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::AbstractEntry::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (AbstractEntry) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::AbstractEntry::TO_JSON };
...
sub from_hash {
    ...
    # call parent (AbstractEntry) from_hash
    $self->WWW::OpenAPIClient::Object::AbstractEntry::from_hash($hash);
