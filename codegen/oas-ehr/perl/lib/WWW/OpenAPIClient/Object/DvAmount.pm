...
#
package WWW::OpenAPIClient::Object::DvAmount;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::DvQuantified");
...
sub init
{
    ...
    # initialize parent object DvQuantified
    $self->WWW::OpenAPIClient::Object::DvQuantified::init(%args);
}
...
sub to_hash {
    ...
    # call DvQuantified to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::DvQuantified::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (DvQuantified) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::DvQuantified::TO_JSON };
...
sub from_hash {
    ...
    # call parent (DvQuantified) from_hash
    $self->WWW::OpenAPIClient::Object::DvQuantified::from_hash($hash);
