...
#
package WWW::OpenAPIClient::Object::OriginalVersion;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::Version");
...
sub init
{
    ...
    # initialize parent object Version
    $self->WWW::OpenAPIClient::Object::Version::init(%args);
}
...
sub to_hash {
    ...
    # call Version to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::Version::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (Version) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::Version::TO_JSON };
...
sub from_hash {
    ...
    # call parent (Version) from_hash
    $self->WWW::OpenAPIClient::Object::Version::from_hash($hash);
...
__PACKAGE__->method_documentation({
    ...
    'preceding_version_uid' => {
        datatype => 'ObjectVersionId',
        base_name => 'preceding_version_uid',
        description => '',
        format => '',
        read_only => '',
            },
    'other_input_version_uids' => {
        datatype => 'ARRAY[ObjectVersionId]',
        base_name => 'other_input_version_uids',
        description => '',
        format => '',
        read_only => '',
            },
    'lifecycle_state' => {
        datatype => 'DvCodedText',
        base_name => 'lifecycle_state',
        description => '',
        format => '',
        read_only => '',
            },
    'attestations' => {
        datatype => 'ARRAY[Attestation]',
        base_name => 'attestations',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'commit_audit' => {
        datatype => 'AuditDetails',
        base_name => 'commit_audit',
        description => '',
        format => '',
        read_only => '',
            },
    'data' => {
        datatype => 'Versionable',
        base_name => 'data',
        description => '',
        format => '',
        read_only => '',
