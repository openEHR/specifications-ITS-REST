...
#
package WWW::OpenAPIClient::Object::VersionedComposition;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::VersionedObject");
...
sub init
{
    ...
    # initialize parent object VersionedObject
    $self->WWW::OpenAPIClient::Object::VersionedObject::init(%args);
}
...
sub to_hash {
    ...
    # call VersionedObject to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::VersionedObject::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (VersionedObject) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::VersionedObject::TO_JSON };
...
sub from_hash {
    ...
    # call parent (VersionedObject) from_hash
    $self->WWW::OpenAPIClient::Object::VersionedObject::from_hash($hash);
...
__PACKAGE__->class_documentation({description => 'A VERSIONED_COMPOSITION resource',
