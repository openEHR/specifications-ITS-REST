...
#
package WWW::OpenAPIClient::Object::EventContext;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::Pathable");
...
sub init
{
    ...
    # initialize parent object Pathable
    $self->WWW::OpenAPIClient::Object::Pathable::init(%args);
}
...
sub to_hash {
    ...
    # call Pathable to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::Pathable::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (Pathable) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::Pathable::TO_JSON };
...
sub from_hash {
    ...
    # call parent (Pathable) from_hash
    $self->WWW::OpenAPIClient::Object::Pathable::from_hash($hash);
...
__PACKAGE__->method_documentation({
    ...
    'other_context' => {
        ...
        base_name => 'other_context',
        description => '',
        format => '',
        read_only => '',
            },
    'health_care_facility' => {
        datatype => 'PartyIdentified',
        base_name => 'health_care_facility',
        description => '',
        format => '',
        read_only => '',
            },
    'participations' => {
        datatype => 'ARRAY[Participation]',
