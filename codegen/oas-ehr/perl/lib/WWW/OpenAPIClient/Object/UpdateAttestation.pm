...
#
package WWW::OpenAPIClient::Object::UpdateAttestation;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::UpdateAudit");
...
sub init
{
    ...
    # initialize parent object UpdateAudit
    $self->WWW::OpenAPIClient::Object::UpdateAudit::init(%args);
}
...
sub to_hash {
    ...
    # call UpdateAudit to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::UpdateAudit::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (UpdateAudit) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::UpdateAudit::TO_JSON };
...
sub from_hash {
    ...
    # call parent (UpdateAudit) from_hash
    $self->WWW::OpenAPIClient::Object::UpdateAudit::from_hash($hash);
...
__PACKAGE__->method_documentation({
    ...
    'is_pending' => {
        datatype => 'boolean',
        base_name => 'is_pending',
        description => '',
        format => '',
        read_only => '',
            },
    'change_type' => {
        datatype => 'TerminologyCode',
        base_name => 'change_type',
        description => '',
        format => '',
        read_only => '',
            },
