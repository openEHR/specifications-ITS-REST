...
#
package WWW::OpenAPIClient::Object::AuditDetails;
...
__PACKAGE__->class_documentation({description => 'The set of attributes required to document the committal of an information item to a repository.',
                                  class => 'AuditDetails',
                                  required => [], # TODO
}                                 );
