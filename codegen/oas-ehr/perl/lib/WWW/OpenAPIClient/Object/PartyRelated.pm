...
#
package WWW::OpenAPIClient::Object::PartyRelated;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::PartyIdentified");
...
sub init
{
    ...
    # initialize parent object PartyIdentified
    $self->WWW::OpenAPIClient::Object::PartyIdentified::init(%args);
}
...
sub to_hash {
    ...
    # call PartyIdentified to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::PartyIdentified::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (PartyIdentified) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::PartyIdentified::TO_JSON };
...
sub from_hash {
    ...
    # call parent (PartyIdentified) from_hash
    $self->WWW::OpenAPIClient::Object::PartyIdentified::from_hash($hash);
