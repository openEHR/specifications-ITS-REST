...
#
package WWW::OpenAPIClient::Object::TerminologyId;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::ObjectId");
...
sub init
{
    ...
    # initialize parent object ObjectId
    $self->WWW::OpenAPIClient::Object::ObjectId::init(%args);
}
...
sub to_hash {
    ...
    # call ObjectId to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::ObjectId::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (ObjectId) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::ObjectId::TO_JSON };
...
sub from_hash {
    ...
    # call parent (ObjectId) from_hash
    $self->WWW::OpenAPIClient::Object::ObjectId::from_hash($hash);
