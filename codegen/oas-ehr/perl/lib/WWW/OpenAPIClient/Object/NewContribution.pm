...
#
package WWW::OpenAPIClient::Object::NewContribution;
...
__PACKAGE__->class_documentation({description => 'A new (un-committed) CONTRIBUTION resource',
