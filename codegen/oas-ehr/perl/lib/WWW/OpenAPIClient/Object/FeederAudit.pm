...
#
package WWW::OpenAPIClient::Object::FeederAudit;
...
__PACKAGE__->method_documentation({
    'originating_system_item_ids' => {
        ...
        base_name => 'originating_system_item_ids',
        description => '',
        format => '',
        read_only => '',
            },
    'feeder_system_item_ids' => {
        datatype => 'ARRAY[DvIdentifier]',
        base_name => 'feeder_system_item_ids',
        description => '',
        format => '',
        read_only => '',
            },
    'original_content' => {
        datatype => 'DvEncapsulated',
        base_name => 'original_content',
        description => '',
        format => '',
        read_only => '',
            },
    'originating_system_audit' => {
        datatype => 'FeederAuditDetails',
        base_name => 'originating_system_audit',
        description => '',
        format => '',
        read_only => '',
            },
