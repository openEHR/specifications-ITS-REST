...
#
package WWW::OpenAPIClient::Object::DvQuantity;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::DvAmount");
...
sub init
{
    ...
    # initialize parent object DvAmount
    $self->WWW::OpenAPIClient::Object::DvAmount::init(%args);
}
...
sub to_hash {
    ...
    # call DvAmount to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::DvAmount::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (DvAmount) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::DvAmount::TO_JSON };
...
sub from_hash {
    ...
    # call parent (DvAmount) from_hash
    $self->WWW::OpenAPIClient::Object::DvAmount::from_hash($hash);
