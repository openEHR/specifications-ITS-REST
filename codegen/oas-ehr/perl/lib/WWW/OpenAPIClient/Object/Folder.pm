...
#
package WWW::OpenAPIClient::Object::Folder;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::Locatable");
...
sub init
{
    ...
    # initialize parent object Locatable
    $self->WWW::OpenAPIClient::Object::Locatable::init(%args);
}
...
sub to_hash {
    ...
    # call Locatable to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::Locatable::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (Locatable) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::Locatable::TO_JSON };
...
sub from_hash {
    ...
    # call parent (Locatable) from_hash
    $self->WWW::OpenAPIClient::Object::Locatable::from_hash($hash);
...
__PACKAGE__->class_documentation({description => 'A FOLDER resource',
                                  class => 'Folder',
                                  required => [], # TODO
}                                 );
