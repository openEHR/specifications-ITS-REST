...
#
package WWW::OpenAPIClient::Object::DvMultimedia;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::DvEncapsulated");
...
sub init
{
    ...
    # initialize parent object DvEncapsulated
    $self->WWW::OpenAPIClient::Object::DvEncapsulated::init(%args);
}
...
sub to_hash {
    ...
    # call DvEncapsulated to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::DvEncapsulated::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (DvEncapsulated) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::DvEncapsulated::TO_JSON };
...
sub from_hash {
    ...
    # call parent (DvEncapsulated) from_hash
    $self->WWW::OpenAPIClient::Object::DvEncapsulated::from_hash($hash);
...
__PACKAGE__->method_documentation({
    ...
    'compression_algorithm' => {
        datatype => 'CodePhrase',
        base_name => 'compression_algorithm',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'integrity_check_algorithm' => {
        datatype => 'CodePhrase',
        base_name => 'integrity_check_algorithm',
        description => '',
        format => '',
        read_only => '',
            },
    'thumbnail' => {
        datatype => 'DvMultimedia',
        base_name => 'thumbnail',
        description => '',
        format => '',
        read_only => '',
