...
#
package WWW::OpenAPIClient::Object::DvDateTime;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::DvTemporal");
...
sub init
{
    ...
    # initialize parent object DvTemporal
    $self->WWW::OpenAPIClient::Object::DvTemporal::init(%args);
}
...
sub to_hash {
    ...
    # call DvTemporal to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::DvTemporal::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (DvTemporal) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::DvTemporal::TO_JSON };
...
sub from_hash {
    ...
    # call parent (DvTemporal) from_hash
    $self->WWW::OpenAPIClient::Object::DvTemporal::from_hash($hash);
