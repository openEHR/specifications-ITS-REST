...
#
package WWW::OpenAPIClient::Object::PartyIdentified;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::PartyProxy");
...
sub init
{
    ...
    # initialize parent object PartyProxy
    $self->WWW::OpenAPIClient::Object::PartyProxy::init(%args);
}
...
sub to_hash {
    ...
    # call PartyProxy to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::PartyProxy::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (PartyProxy) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::PartyProxy::TO_JSON };
...
sub from_hash {
    ...
    # call parent (PartyProxy) from_hash
    $self->WWW::OpenAPIClient::Object::PartyProxy::from_hash($hash);
