...
#
package WWW::OpenAPIClient::Object::Composition;
...
__PACKAGE__->class_documentation({description => 'A COMPOSITION resource',
                                  class => 'Composition',
                                  required => [], # TODO
}                                 );
