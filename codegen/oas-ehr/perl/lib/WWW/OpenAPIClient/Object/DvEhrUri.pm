...
#
package WWW::OpenAPIClient::Object::DvEhrUri;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::DvUri");
...
sub init
{
    ...
    # initialize parent object DvUri
    $self->WWW::OpenAPIClient::Object::DvUri::init(%args);
}
...
sub to_hash {
    ...
    # call DvUri to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::DvUri::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (DvUri) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::DvUri::TO_JSON };
...
sub from_hash {
    ...
    # call parent (DvUri) from_hash
    $self->WWW::OpenAPIClient::Object::DvUri::from_hash($hash);
