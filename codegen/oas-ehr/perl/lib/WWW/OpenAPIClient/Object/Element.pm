...
#
package WWW::OpenAPIClient::Object::Element;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::Item");
...
sub init
{
    ...
    # initialize parent object Item
    $self->WWW::OpenAPIClient::Object::Item::init(%args);
}
...
sub to_hash {
    ...
    # call Item to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::Item::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (Item) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::Item::TO_JSON };
...
sub from_hash {
    ...
    # call parent (Item) from_hash
    $self->WWW::OpenAPIClient::Object::Item::from_hash($hash);
