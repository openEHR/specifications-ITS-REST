...
#
package WWW::OpenAPIClient::Object::Action;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::CareEntry");
...
sub init
{
    ...
    # initialize parent object CareEntry
    $self->WWW::OpenAPIClient::Object::CareEntry::init(%args);
}
...
sub to_hash {
    ...
    # call CareEntry to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::CareEntry::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (CareEntry) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::CareEntry::TO_JSON };
...
sub from_hash {
    ...
    # call parent (CareEntry) from_hash
    $self->WWW::OpenAPIClient::Object::CareEntry::from_hash($hash);
...
__PACKAGE__->method_documentation({
    ...
    'ism_transition' => {
        datatype => 'IsmTransition',
        base_name => 'ism_transition',
        description => '',
        format => '',
        read_only => '',
            },
    'instruction_details' => {
        datatype => 'InstructionDetails',
        base_name => 'instruction_details',
        description => '',
        format => '',
        read_only => '',
            },
