...
#
package WWW::OpenAPIClient::Object::Attestation;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::AuditDetails");
...
sub init
{
    ...
    # initialize parent object AuditDetails
    $self->WWW::OpenAPIClient::Object::AuditDetails::init(%args);
}
...
sub to_hash {
    ...
    # call AuditDetails to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::AuditDetails::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (AuditDetails) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::AuditDetails::TO_JSON };
...
sub from_hash {
    ...
    # call parent (AuditDetails) from_hash
    $self->WWW::OpenAPIClient::Object::AuditDetails::from_hash($hash);
