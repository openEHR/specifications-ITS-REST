...
#
package WWW::OpenAPIClient::Object::DvQuantified;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::DvOrdered");
...
sub init
{
    ...
    # initialize parent object DvOrdered
    $self->WWW::OpenAPIClient::Object::DvOrdered::init(%args);
}
...
sub to_hash {
    ...
    # call DvOrdered to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::DvOrdered::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (DvOrdered) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::DvOrdered::TO_JSON };
...
sub from_hash {
    ...
    # call parent (DvOrdered) from_hash
    $self->WWW::OpenAPIClient::Object::DvOrdered::from_hash($hash);
