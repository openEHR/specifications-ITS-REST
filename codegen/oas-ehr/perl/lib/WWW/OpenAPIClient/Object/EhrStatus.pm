...
#
package WWW::OpenAPIClient::Object::EhrStatus;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::Versionable");
...
sub init
{
    ...
    # initialize parent object Versionable
    $self->WWW::OpenAPIClient::Object::Versionable::init(%args);
}
...
sub to_hash {
    ...
    # call Versionable to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::Versionable::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (Versionable) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::Versionable::TO_JSON };
...
sub from_hash {
    ...
    # call parent (Versionable) from_hash
    $self->WWW::OpenAPIClient::Object::Versionable::from_hash($hash);
...
__PACKAGE__->class_documentation({description => 'An EHR_STATUS resource',
                                  class => 'EhrStatus',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'is_modifiable' => {
        datatype => 'boolean',
        base_name => 'is_modifiable',
        description => '',
        format => '',
        read_only => '',
            },
    'other_details' => {
        datatype => 'ItemStructure',
        base_name => 'other_details',
        description => '',
        format => '',
        read_only => '',
            },
