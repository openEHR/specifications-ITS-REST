...
#
package WWW::OpenAPIClient::Object::AbstractEntry;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::ContentItem");
...
sub init
{
    ...
    # initialize parent object ContentItem
    $self->WWW::OpenAPIClient::Object::ContentItem::init(%args);
}
...
sub to_hash {
    ...
    # call ContentItem to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::ContentItem::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (ContentItem) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::ContentItem::TO_JSON };
...
sub from_hash {
    ...
    # call parent (ContentItem) from_hash
    $self->WWW::OpenAPIClient::Object::ContentItem::from_hash($hash);
...
__PACKAGE__->method_documentation({
    ...
    'other_participations' => {
        ...
        base_name => 'other_participations',
        description => '',
        format => '',
        read_only => '',
            },
