...
#
package WWW::OpenAPIClient::Object::DvIntervalOfDateTime;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::DvInterval");
...
sub init
{
    ...
    # initialize parent object DvInterval
    $self->WWW::OpenAPIClient::Object::DvInterval::init(%args);
}
...
sub to_hash {
    ...
    # call DvInterval to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::DvInterval::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (DvInterval) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::DvInterval::TO_JSON };
...
sub from_hash {
    ...
    # call parent (DvInterval) from_hash
    $self->WWW::OpenAPIClient::Object::DvInterval::from_hash($hash);
