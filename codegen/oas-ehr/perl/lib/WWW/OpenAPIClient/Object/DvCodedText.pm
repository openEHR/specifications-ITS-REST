...
#
package WWW::OpenAPIClient::Object::DvCodedText;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::DvText");
...
sub init
{
    ...
    # initialize parent object DvText
    $self->WWW::OpenAPIClient::Object::DvText::init(%args);
}
...
sub to_hash {
    ...
    # call DvText to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::DvText::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (DvText) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::DvText::TO_JSON };
...
sub from_hash {
    ...
    # call parent (DvText) from_hash
    $self->WWW::OpenAPIClient::Object::DvText::from_hash($hash);
