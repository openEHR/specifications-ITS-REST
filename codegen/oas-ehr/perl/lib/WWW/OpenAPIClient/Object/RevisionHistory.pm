...
#
package WWW::OpenAPIClient::Object::RevisionHistory;
...
__PACKAGE__->class_documentation({description => 'A REVISION_HISTORY resource',
...
__PACKAGE__->method_documentation({
    'items' => {
        datatype => 'ARRAY[RevisionHistoryItem]',
        base_name => 'items',
        description => '',
        format => '',
        read_only => '',
