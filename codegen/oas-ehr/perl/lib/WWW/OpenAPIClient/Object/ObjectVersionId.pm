...
#
package WWW::OpenAPIClient::Object::ObjectVersionId;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::UidBasedId");
...
sub init
{
    ...
    # initialize parent object UidBasedId
    $self->WWW::OpenAPIClient::Object::UidBasedId::init(%args);
}
...
sub to_hash {
    ...
    # call UidBasedId to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::UidBasedId::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (UidBasedId) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::UidBasedId::TO_JSON };
...
sub from_hash {
    ...
    # call parent (UidBasedId) from_hash
    $self->WWW::OpenAPIClient::Object::UidBasedId::from_hash($hash);
