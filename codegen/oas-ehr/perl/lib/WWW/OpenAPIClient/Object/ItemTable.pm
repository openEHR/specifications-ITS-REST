...
#
package WWW::OpenAPIClient::Object::ItemTable;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::ItemStructure");
...
sub init
{
    ...
    # initialize parent object ItemStructure
    $self->WWW::OpenAPIClient::Object::ItemStructure::init(%args);
}
...
sub to_hash {
    ...
    # call ItemStructure to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::ItemStructure::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (ItemStructure) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::ItemStructure::TO_JSON };
...
sub from_hash {
    ...
    # call parent (ItemStructure) from_hash
    $self->WWW::OpenAPIClient::Object::ItemStructure::from_hash($hash);
