...
#
package WWW::OpenAPIClient::Object::DvOrdered;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::DataValue");
...
sub init
{
    ...
    # initialize parent object DataValue
    $self->WWW::OpenAPIClient::Object::DataValue::init(%args);
}
...
sub to_hash {
    ...
    # call DataValue to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::DataValue::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (DataValue) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::DataValue::TO_JSON };
...
sub from_hash {
    ...
    # call parent (DataValue) from_hash
    $self->WWW::OpenAPIClient::Object::DataValue::from_hash($hash);
...
__PACKAGE__->method_documentation({
    ...
    'normal_range' => {
        datatype => 'DvInterval',
        base_name => 'normal_range',
        description => '',
        format => '',
        read_only => '',
            },
    'other_reference_ranges' => {
        datatype => 'ARRAY[ReferenceRange]',
        base_name => 'other_reference_ranges',
        description => '',
        format => '',
        read_only => '',
            },
