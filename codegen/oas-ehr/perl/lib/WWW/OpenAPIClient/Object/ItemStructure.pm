...
#
package WWW::OpenAPIClient::Object::ItemStructure;
...
use base ("Class::Accessor", "Class::Data::Inheritable", "WWW::OpenAPIClient::Object::DataStructure");
...
sub init
{
    ...
    # initialize parent object DataStructure
    $self->WWW::OpenAPIClient::Object::DataStructure::init(%args);
}
...
sub to_hash {
    ...
    # call DataStructure to_hash and then combine hash
    $_hash = { %$_hash, %$self->WWW::OpenAPIClient::Object::DataStructure::to_hash };
...
sub TO_JSON {
    ...
    # combine parent (DataStructure) TO_JSON
    $_data = { %$_data, %$self->WWW::OpenAPIClient::Object::DataStructure::TO_JSON };
...
sub from_hash {
    ...
    # call parent (DataStructure) from_hash
    $self->WWW::OpenAPIClient::Object::DataStructure::from_hash($hash);
