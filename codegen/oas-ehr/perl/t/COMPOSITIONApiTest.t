...
use_ok('WWW::OpenAPIClient::COMPOSITIONApi');

my $api = WWW::OpenAPIClient::COMPOSITIONApi->new();
isa_ok($api, 'WWW::OpenAPIClient::COMPOSITIONApi');

#
# composition_create test
#
# uncomment below and update the test
#my $composition_create_ehr_id = undef; # replace NULL with a proper value
#my $composition_create_composition = undef; # replace NULL with a proper value
#my $composition_create_prefer = undef; # replace NULL with a proper value
#my $composition_create_result = $api->composition_create(ehr_id => $composition_create_ehr_id, composition => $composition_create_composition, prefer => $composition_create_prefer);

#
# composition_delete test
#
# uncomment below and update the test
#my $composition_delete_ehr_id = undef; # replace NULL with a proper value
#my $composition_delete_uid_based_id = undef; # replace NULL with a proper value
#my $composition_delete_result = $api->composition_delete(ehr_id => $composition_delete_ehr_id, uid_based_id => $composition_delete_uid_based_id);

#
# composition_get test
#
# uncomment below and update the test
#my $composition_get_ehr_id = undef; # replace NULL with a proper value
#my $composition_get_uid_based_id = undef; # replace NULL with a proper value
#my $composition_get_version_at_time = undef; # replace NULL with a proper value
#my $composition_get_result = $api->composition_get(ehr_id => $composition_get_ehr_id, uid_based_id => $composition_get_uid_based_id, version_at_time => $composition_get_version_at_time);

#
# composition_update test
#
# uncomment below and update the test
#my $composition_update_ehr_id = undef; # replace NULL with a proper value
#my $composition_update_uid_based_id = undef; # replace NULL with a proper value
#my $composition_update_if_match = undef; # replace NULL with a proper value
#my $composition_update_composition = undef; # replace NULL with a proper value
#my $composition_update_prefer = undef; # replace NULL with a proper value
#my $composition_update_result = $api->composition_update(ehr_id => $composition_update_ehr_id, uid_based_id => $composition_update_uid_based_id, if_match => $composition_update_if_match, composition => $composition_update_composition, prefer => $composition_update_prefer);

#
# versioned_composition_get test
#
# uncomment below and update the test
#my $versioned_composition_get_ehr_id = undef; # replace NULL with a proper value
#my $versioned_composition_get_versioned_object_uid = undef; # replace NULL with a proper value
#my $versioned_composition_get_result = $api->versioned_composition_get(ehr_id => $versioned_composition_get_ehr_id, versioned_object_uid => $versioned_composition_get_versioned_object_uid);

#
# versioned_composition_revision_history test
#
# uncomment below and update the test
#my $versioned_composition_revision_history_ehr_id = undef; # replace NULL with a proper value
#my $versioned_composition_revision_history_versioned_object_uid = undef; # replace NULL with a proper value
#my $versioned_composition_revision_history_result = $api->versioned_composition_revision_history(ehr_id => $versioned_composition_revision_history_ehr_id, versioned_object_uid => $versioned_composition_revision_history_versioned_object_uid);

#
# versioned_composition_version_get_at_time test
#
# uncomment below and update the test
#my $versioned_composition_version_get_at_time_ehr_id = undef; # replace NULL with a proper value
#my $versioned_composition_version_get_at_time_versioned_object_uid = undef; # replace NULL with a proper value
#my $versioned_composition_version_get_at_time_version_at_time = undef; # replace NULL with a proper value
#my $versioned_composition_version_get_at_time_result = $api->versioned_composition_version_get_at_time(ehr_id => $versioned_composition_version_get_at_time_ehr_id, versioned_object_uid => $versioned_composition_version_get_at_time_versioned_object_uid, version_at_time => $versioned_composition_version_get_at_time_version_at_time);

#
# versioned_composition_version_get_by_id test
#
# uncomment below and update the test
#my $versioned_composition_version_get_by_id_ehr_id = undef; # replace NULL with a proper value
#my $versioned_composition_version_get_by_id_versioned_object_uid = undef; # replace NULL with a proper value
#my $versioned_composition_version_get_by_id_version_uid = undef; # replace NULL with a proper value
#my $versioned_composition_version_get_by_id_result = $api->versioned_composition_version_get_by_id(ehr_id => $versioned_composition_version_get_by_id_ehr_id, versioned_object_uid => $versioned_composition_version_get_by_id_versioned_object_uid, version_uid => $versioned_composition_version_get_by_id_version_uid);
