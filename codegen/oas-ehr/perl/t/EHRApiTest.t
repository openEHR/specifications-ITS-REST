...
use_ok('WWW::OpenAPIClient::EHRApi');

my $api = WWW::OpenAPIClient::EHRApi->new();
isa_ok($api, 'WWW::OpenAPIClient::EHRApi');

#
# ehr_create test
#
# uncomment below and update the test
#my $ehr_create_prefer = undef; # replace NULL with a proper value
#my $ehr_create_ehr_status = undef; # replace NULL with a proper value
#my $ehr_create_result = $api->ehr_create(prefer => $ehr_create_prefer, ehr_status => $ehr_create_ehr_status);

#
# ehr_create_with_id test
#
# uncomment below and update the test
#my $ehr_create_with_id_ehr_id = undef; # replace NULL with a proper value
#my $ehr_create_with_id_prefer = undef; # replace NULL with a proper value
#my $ehr_create_with_id_ehr_status = undef; # replace NULL with a proper value
#my $ehr_create_with_id_result = $api->ehr_create_with_id(ehr_id => $ehr_create_with_id_ehr_id, prefer => $ehr_create_with_id_prefer, ehr_status => $ehr_create_with_id_ehr_status);

#
# ehr_get_by_id test
#
# uncomment below and update the test
#my $ehr_get_by_id_ehr_id = undef; # replace NULL with a proper value
#my $ehr_get_by_id_result = $api->ehr_get_by_id(ehr_id => $ehr_get_by_id_ehr_id);

#
# ehr_get_by_subject test
#
# uncomment below and update the test
#my $ehr_get_by_subject_subject_id = undef; # replace NULL with a proper value
#my $ehr_get_by_subject_subject_namespace = undef; # replace NULL with a proper value
#my $ehr_get_by_subject_result = $api->ehr_get_by_subject(subject_id => $ehr_get_by_subject_subject_id, subject_namespace => $ehr_get_by_subject_subject_namespace);
