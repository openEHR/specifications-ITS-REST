...
use_ok('WWW::OpenAPIClient::DIRECTORYApi');

my $api = WWW::OpenAPIClient::DIRECTORYApi->new();
isa_ok($api, 'WWW::OpenAPIClient::DIRECTORYApi');

#
# directory_create test
#
# uncomment below and update the test
#my $directory_create_ehr_id = undef; # replace NULL with a proper value
#my $directory_create_folder = undef; # replace NULL with a proper value
#my $directory_create_prefer = undef; # replace NULL with a proper value
#my $directory_create_result = $api->directory_create(ehr_id => $directory_create_ehr_id, folder => $directory_create_folder, prefer => $directory_create_prefer);

#
# directory_delete test
#
# uncomment below and update the test
#my $directory_delete_ehr_id = undef; # replace NULL with a proper value
#my $directory_delete_if_match = undef; # replace NULL with a proper value
#my $directory_delete_result = $api->directory_delete(ehr_id => $directory_delete_ehr_id, if_match => $directory_delete_if_match);

#
# directory_get_at_time test
#
# uncomment below and update the test
#my $directory_get_at_time_ehr_id = undef; # replace NULL with a proper value
#my $directory_get_at_time_version_at_time = undef; # replace NULL with a proper value
#my $directory_get_at_time_path = undef; # replace NULL with a proper value
#my $directory_get_at_time_result = $api->directory_get_at_time(ehr_id => $directory_get_at_time_ehr_id, version_at_time => $directory_get_at_time_version_at_time, path => $directory_get_at_time_path);

#
# directory_get_by_version_id test
#
# uncomment below and update the test
#my $directory_get_by_version_id_ehr_id = undef; # replace NULL with a proper value
#my $directory_get_by_version_id_version_uid = undef; # replace NULL with a proper value
#my $directory_get_by_version_id_path = undef; # replace NULL with a proper value
#my $directory_get_by_version_id_result = $api->directory_get_by_version_id(ehr_id => $directory_get_by_version_id_ehr_id, version_uid => $directory_get_by_version_id_version_uid, path => $directory_get_by_version_id_path);

#
# directory_update test
#
# uncomment below and update the test
#my $directory_update_ehr_id = undef; # replace NULL with a proper value
#my $directory_update_if_match = undef; # replace NULL with a proper value
#my $directory_update_folder = undef; # replace NULL with a proper value
#my $directory_update_prefer = undef; # replace NULL with a proper value
#my $directory_update_result = $api->directory_update(ehr_id => $directory_update_ehr_id, if_match => $directory_update_if_match, folder => $directory_update_folder, prefer => $directory_update_prefer);
