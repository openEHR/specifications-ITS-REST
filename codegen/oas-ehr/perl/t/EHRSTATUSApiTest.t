...
use_ok('WWW::OpenAPIClient::EHRSTATUSApi');

my $api = WWW::OpenAPIClient::EHRSTATUSApi->new();
isa_ok($api, 'WWW::OpenAPIClient::EHRSTATUSApi');

#
# ehr_status_get_at_time test
#
# uncomment below and update the test
#my $ehr_status_get_at_time_ehr_id = undef; # replace NULL with a proper value
#my $ehr_status_get_at_time_version_at_time = undef; # replace NULL with a proper value
#my $ehr_status_get_at_time_result = $api->ehr_status_get_at_time(ehr_id => $ehr_status_get_at_time_ehr_id, version_at_time => $ehr_status_get_at_time_version_at_time);

#
# ehr_status_get_by_version_id test
#
# uncomment below and update the test
#my $ehr_status_get_by_version_id_ehr_id = undef; # replace NULL with a proper value
#my $ehr_status_get_by_version_id_version_uid = undef; # replace NULL with a proper value
#my $ehr_status_get_by_version_id_result = $api->ehr_status_get_by_version_id(ehr_id => $ehr_status_get_by_version_id_ehr_id, version_uid => $ehr_status_get_by_version_id_version_uid);

#
# ehr_status_update test
#
# uncomment below and update the test
#my $ehr_status_update_ehr_id = undef; # replace NULL with a proper value
#my $ehr_status_update_if_match = undef; # replace NULL with a proper value
#my $ehr_status_update_ehr_status = undef; # replace NULL with a proper value
#my $ehr_status_update_prefer = undef; # replace NULL with a proper value
#my $ehr_status_update_result = $api->ehr_status_update(ehr_id => $ehr_status_update_ehr_id, if_match => $ehr_status_update_if_match, ehr_status => $ehr_status_update_ehr_status, prefer => $ehr_status_update_prefer);

#
# versioned_ehr_status_get test
#
# uncomment below and update the test
#my $versioned_ehr_status_get_ehr_id = undef; # replace NULL with a proper value
#my $versioned_ehr_status_get_result = $api->versioned_ehr_status_get(ehr_id => $versioned_ehr_status_get_ehr_id);

#
# versioned_ehr_status_revision_history test
#
# uncomment below and update the test
#my $versioned_ehr_status_revision_history_ehr_id = undef; # replace NULL with a proper value
#my $versioned_ehr_status_revision_history_result = $api->versioned_ehr_status_revision_history(ehr_id => $versioned_ehr_status_revision_history_ehr_id);

#
# versioned_ehr_status_version_get_at_time test
#
# uncomment below and update the test
#my $versioned_ehr_status_version_get_at_time_ehr_id = undef; # replace NULL with a proper value
#my $versioned_ehr_status_version_get_at_time_version_at_time = undef; # replace NULL with a proper value
#my $versioned_ehr_status_version_get_at_time_result = $api->versioned_ehr_status_version_get_at_time(ehr_id => $versioned_ehr_status_version_get_at_time_ehr_id, version_at_time => $versioned_ehr_status_version_get_at_time_version_at_time);

#
# versioned_ehr_status_version_get_by_id test
#
# uncomment below and update the test
#my $versioned_ehr_status_version_get_by_id_ehr_id = undef; # replace NULL with a proper value
#my $versioned_ehr_status_version_get_by_id_version_uid = undef; # replace NULL with a proper value
#my $versioned_ehr_status_version_get_by_id_result = $api->versioned_ehr_status_version_get_by_id(ehr_id => $versioned_ehr_status_version_get_by_id_ehr_id, version_uid => $versioned_ehr_status_version_get_by_id_version_uid);
