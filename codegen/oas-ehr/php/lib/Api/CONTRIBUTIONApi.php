...
/**
    ...
    /**
     * Operation contributionCreate
     *
     * Create CONTRIBUTION
     *
     * @param  string $ehr_id EHR identifier taken from EHR.ehr_id.value. (required)
     * @param  \OpenAPI\Client\Model\NewContribution $new_contribution The CONTRIBUTION. (required)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['contributionCreate'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Contribution|\OpenAPI\Client\Model\Error
     */
    public function contributionCreate($ehr_id, $new_contribution, $prefer = 'return=minimal', string $contentType = self::contentTypes['contributionCreate'][0])
    {
        list($response) = $this->contributionCreateWithHttpInfo($ehr_id, $new_contribution, $prefer, $contentType);
        return $response;
    }

    /**
     * Operation contributionCreateWithHttpInfo
     *
     * Create CONTRIBUTION
     *
     * @param  string $ehr_id EHR identifier taken from EHR.ehr_id.value. (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\Contribution|\OpenAPI\Client\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function contributionCreateWithHttpInfo($ehr_id, $new_contribution, $prefer = 'return=minimal', string $contentType = self::contentTypes['contributionCreate'][0])
    {
        $request = $this->contributionCreateRequest($ehr_id, $new_contribution, $prefer, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\Client\Model\Contribution' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\Contribution' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\Contribution', []),
            ...
            $returnType = '\OpenAPI\Client\Model\Contribution';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\Contribution',
    ...
    /**
     * Operation contributionCreateAsync
     *
     * Create CONTRIBUTION
     *
     * @param  string $ehr_id EHR identifier taken from EHR.ehr_id.value. (required)
     ...
     */
    public function contributionCreateAsync($ehr_id, $new_contribution, $prefer = 'return=minimal', string $contentType = self::contentTypes['contributionCreate'][0])
    {
        return $this->contributionCreateAsyncWithHttpInfo($ehr_id, $new_contribution, $prefer, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation contributionCreateAsyncWithHttpInfo
     *
     * Create CONTRIBUTION
     *
     * @param  string $ehr_id EHR identifier taken from EHR.ehr_id.value. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contributionCreateAsyncWithHttpInfo($ehr_id, $new_contribution, $prefer = 'return=minimal', string $contentType = self::contentTypes['contributionCreate'][0])
    {
        $returnType = '\OpenAPI\Client\Model\Contribution';
        $request = $this->contributionCreateRequest($ehr_id, $new_contribution, $prefer, $contentType);
    ...
    /**
     * Create request for operation 'contributionCreate'
     *
     * @param  string $ehr_id EHR identifier taken from EHR.ehr_id.value. (required)
     * @param  \OpenAPI\Client\Model\NewContribution $new_contribution The CONTRIBUTION. (required)
     * @param  string $prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;. (optional, default to 'return=minimal')
     ...
     */
    public function contributionCreateRequest($ehr_id, $new_contribution, $prefer = 'return=minimal', string $contentType = self::contentTypes['contributionCreate'][0])
    {

        // verify the required parameter 'ehr_id' is set
        if ($ehr_id === null || (is_array($ehr_id) && count($ehr_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ehr_id when calling contributionCreate'
            );
        }

        // verify the required parameter 'new_contribution' is set
        if ($new_contribution === null || (is_array($new_contribution) && count($new_contribution) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $new_contribution when calling contributionCreate'
            );
        }



        $resourcePath = '/ehr/{ehr_id}/contribution';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($new_contribution)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($new_contribution));
            } else {
                $httpBody = $new_contribution;
            }
    ...
    /**
     * Operation contributionGet
     *
     * Get CONTRIBUTION by id
     *
     * @param  string $ehr_id EHR identifier taken from EHR.ehr_id.value. (required)
     * @param  string $contribution_uid The CONTRIBUTION uid. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['contributionGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Contribution
     */
    public function contributionGet($ehr_id, $contribution_uid, string $contentType = self::contentTypes['contributionGet'][0])
    {
        list($response) = $this->contributionGetWithHttpInfo($ehr_id, $contribution_uid, $contentType);
        return $response;
    }

    /**
     * Operation contributionGetWithHttpInfo
     *
     * Get CONTRIBUTION by id
     *
     * @param  string $ehr_id EHR identifier taken from EHR.ehr_id.value. (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\Contribution, HTTP status code, HTTP response headers (array of strings)
     */
    public function contributionGetWithHttpInfo($ehr_id, $contribution_uid, string $contentType = self::contentTypes['contributionGet'][0])
    {
        $request = $this->contributionGetRequest($ehr_id, $contribution_uid, $contentType);
    ...
    /**
     * Operation contributionGetAsync
     *
     * Get CONTRIBUTION by id
     *
     * @param  string $ehr_id EHR identifier taken from EHR.ehr_id.value. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contributionGetAsync($ehr_id, $contribution_uid, string $contentType = self::contentTypes['contributionGet'][0])
    {
        return $this->contributionGetAsyncWithHttpInfo($ehr_id, $contribution_uid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation contributionGetAsyncWithHttpInfo
     *
     * Get CONTRIBUTION by id
     *
     * @param  string $ehr_id EHR identifier taken from EHR.ehr_id.value. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contributionGetAsyncWithHttpInfo($ehr_id, $contribution_uid, string $contentType = self::contentTypes['contributionGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\Contribution';
        $request = $this->contributionGetRequest($ehr_id, $contribution_uid, $contentType);
    ...
    /**
     * Create request for operation 'contributionGet'
     *
     * @param  string $ehr_id EHR identifier taken from EHR.ehr_id.value. (required)
     * @param  string $contribution_uid The CONTRIBUTION uid. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['contributionGet'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function contributionGetRequest($ehr_id, $contribution_uid, string $contentType = self::contentTypes['contributionGet'][0])
    {

        // verify the required parameter 'ehr_id' is set
        if ($ehr_id === null || (is_array($ehr_id) && count($ehr_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ehr_id when calling contributionGet'
            );
        }

        // verify the required parameter 'contribution_uid' is set
        if ($contribution_uid === null || (is_array($contribution_uid) && count($contribution_uid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $contribution_uid when calling contributionGet'
            );
        }


        $resourcePath = '/ehr/{ehr_id}/contribution/{contribution_uid}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($contribution_uid !== null) {
            $resourcePath = str_replace(
                '{' . 'contribution_uid' . '}',
                ObjectSerializer::toPathValue($contribution_uid),
                $resourcePath
            );
        }
