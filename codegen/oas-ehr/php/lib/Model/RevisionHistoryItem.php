...
/**
 * RevisionHistoryItem Class Doc Comment
 *
 * @category Class
 ...
 */
class RevisionHistoryItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RevisionHistoryItem';
    ...
    protected static $openAPITypes = [
        'version_id' => '\OpenAPI\Client\Model\ObjectVersionId',
        'audits' => '\OpenAPI\Client\Model\AuditDetails[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('audits', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['audits'] === null) {
            $invalidProperties[] = "'audits' can't be null";
        }
     ...
     * Sets version_id
     *
     * @param \OpenAPI\Client\Model\ObjectVersionId $version_id version_id
     *
     * @return self
     */
     ...
     * Sets audits
     *
     * @param \OpenAPI\Client\Model\AuditDetails[] $audits audits
     *
     * @return self
     */
    ...
    {
        if (is_null($audits)) {
            throw new \InvalidArgumentException('non-nullable audits cannot be null');
        }
