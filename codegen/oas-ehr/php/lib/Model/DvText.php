...
class DvText extends DataValue
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DvText';
    ...
    protected static $openAPITypes = [
        '_type' => 'string',
        'value' => 'string',
        'hyperlink' => '\OpenAPI\Client\Model\DvUri',
        'formatting' => 'string',
        'mappings' => '\OpenAPI\Client\Model\TermMapping[]',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'DV_TEXT');
        $this->setIfExists('value', $data ?? [], null);
        $this->setIfExists('hyperlink', $data ?? [], null);
        $this->setIfExists('formatting', $data ?? [], null);
    ...
    */
     ...
     * Sets hyperlink
     *
     * @param \OpenAPI\Client\Model\DvUri|null $hyperlink hyperlink
     *
     * @return self
     */
    ...
    public function setFormatting($formatting)
    {
        if (is_null($formatting)) {
            throw new \InvalidArgumentException('non-nullable formatting cannot be null');
        }
     ...
     * Gets mappings
     *
     * @return \OpenAPI\Client\Model\TermMapping[]|null
     */
     ...
     * Sets mappings
     *
     * @param \OpenAPI\Client\Model\TermMapping[]|null $mappings mappings
     *
     * @return self
     */
     ...
     * Sets language
     *
     * @param \OpenAPI\Client\Model\CodePhrase|null $language language
     *
     * @return self
     */
     ...
     * Sets encoding
     *
     * @param \OpenAPI\Client\Model\CodePhrase|null $encoding encoding
     *
     * @return self
     */
