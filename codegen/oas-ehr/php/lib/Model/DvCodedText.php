...
class DvCodedText extends DvText
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DvCodedText';
    ...
    protected static $openAPITypes = [
        '_type' => 'string',
        'defining_code' => '\OpenAPI\Client\Model\CodePhrase'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'DV_CODED_TEXT');
        $this->setIfExists('defining_code', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['defining_code'] === null) {
            $invalidProperties[] = "'defining_code' can't be null";
        }
     ...
     */
    public function getDefiningCode()
    {
        return $this->container['defining_code'];
    }

    /**
     * Sets defining_code
     *
     * @param \OpenAPI\Client\Model\CodePhrase $defining_code defining_code
     *
     * @return self
     */
    public function setDefiningCode($defining_code)
    {
        if (is_null($defining_code)) {
            throw new \InvalidArgumentException('non-nullable defining_code cannot be null');
        }
        $this->container['defining_code'] = $defining_code;
