 ...
 */
class AuditDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuditDetails';
    ...
    protected static $openAPITypes = [
        '_type' => 'string',
        'system_id' => 'string',
        'time_committed' => '\OpenAPI\Client\Model\DvDateTime',
        'change_type' => '\OpenAPI\Client\Model\DvCodedText',
        'description' => '\OpenAPI\Client\Model\DvText',
        'committer' => '\OpenAPI\Client\Model\PartyProxy'
    ];
    ...
    {
        $this->setIfExists('_type', $data ?? [], 'AUDIT_DETAILS');
        $this->setIfExists('system_id', $data ?? [], null);
        $this->setIfExists('time_committed', $data ?? [], null);
    ...
    */
     ...
     * Sets time_committed
     *
     * @param \OpenAPI\Client\Model\DvDateTime $time_committed time_committed
     *
     * @return self
     */
    public function setTimeCommitted($time_committed)
    {
        if (is_null($time_committed)) {
            throw new \InvalidArgumentException('non-nullable time_committed cannot be null');
        }
     ...
     * Sets change_type
     *
     * @param \OpenAPI\Client\Model\DvCodedText $change_type change_type
     *
     * @return self
     */
     ...
     * Gets description
     *
     * @return \OpenAPI\Client\Model\DvText|null
     */
     ...
     * Sets description
     *
     * @param \OpenAPI\Client\Model\DvText|null $description description
     *
     * @return self
     */
     ...
     * Sets committer
     *
     * @param \OpenAPI\Client\Model\PartyProxy $committer committer
     *
     * @return self
     */
