...
class DvParsable extends DvEncapsulated
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DvParsable';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'DV_PARSABLE');
        $this->setIfExists('value', $data ?? [], null);
        $this->setIfExists('formalism', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['formalism'] === null) {
            $invalidProperties[] = "'formalism' can't be null";
        }
     ...
     * @return string
     */
    public function getFormalism()
    {
        return $this->container['formalism'];
    }

    /**
     * Sets formalism
     *
     * @param string $formalism formalism
     *
     * @return self
     */
    public function setFormalism($formalism)
    {

        if (is_null($formalism)) {
            throw new \InvalidArgumentException('non-nullable formalism cannot be null');
        }

        $this->container['formalism'] = $formalism;
