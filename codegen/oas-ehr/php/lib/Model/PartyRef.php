 ...
 */
class PartyRef implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartyRef';
    ...
    protected static $openAPITypes = [
        'namespace' => 'string',
        'type' => 'string',
        'id' => '\OpenAPI\Client\Model\ObjectId'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^PERSON|ORGANISATION|GROUP|AGENT|ROLE|PARTY|ACTOR$/", $this->container['type'])) {
            $invalidProperties[] = "invalid value for 'type', must be conform to the pattern /^PERSON|ORGANISATION|GROUP|AGENT|ROLE|PARTY|ACTOR$/.";
        }
    ...
    public function setType($type)
    {
        ...
        if ((!preg_match("/^PERSON|ORGANISATION|GROUP|AGENT|ROLE|PARTY|ACTOR$/", ObjectSerializer::toString($type)))) {
            throw new \InvalidArgumentException("invalid value for \$type when calling PartyRef., must conform to the pattern /^PERSON|ORGANISATION|GROUP|AGENT|ROLE|PARTY|ACTOR$/.");
        }
     ...
     * Gets id
     *
     * @return \OpenAPI\Client\Model\ObjectId
     */
     ...
     * Sets id
     *
     * @param \OpenAPI\Client\Model\ObjectId $id id
     *
     * @return self
     */
