...
/**
 * OriginalVersion Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class OriginalVersion extends Version
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OriginalVersion';
    ...
    protected static $openAPITypes = [
        '_type' => 'string',
        'uid' => '\OpenAPI\Client\Model\ObjectVersionId',
        'preceding_version_uid' => '\OpenAPI\Client\Model\ObjectVersionId',
        'other_input_version_uids' => '\OpenAPI\Client\Model\ObjectVersionId[]',
        'lifecycle_state' => '\OpenAPI\Client\Model\DvCodedText',
        'attestations' => '\OpenAPI\Client\Model\Attestation[]'
    ];
    ...
    protected static array $openAPINullables = [
        '_type' => false,
		'uid' => false,
		'preceding_version_uid' => false,
		'other_input_version_uids' => false,
    ...
    protected static $setters = [
        '_type' => 'setType',
        'uid' => 'setUid',
        'preceding_version_uid' => 'setPrecedingVersionUid',
        'other_input_version_uids' => 'setOtherInputVersionUids',
    ...
    protected static $getters = [
        '_type' => 'getType',
        'uid' => 'getUid',
        'preceding_version_uid' => 'getPrecedingVersionUid',
        'other_input_version_uids' => 'getOtherInputVersionUids',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'ORIGINAL_VERSION');
        $this->setIfExists('uid', $data ?? [], null);
        $this->setIfExists('preceding_version_uid', $data ?? [], null);
        $this->setIfExists('other_input_version_uids', $data ?? [], null);
    ...
    */
     ...
     * Gets uid
     *
     * @return \OpenAPI\Client\Model\ObjectVersionId
     */
     ...
     * Sets uid
     *
     * @param \OpenAPI\Client\Model\ObjectVersionId $uid uid
     *
     * @return self
     */
    ...
    /**
     * Gets preceding_version_uid
     *
     * @return \OpenAPI\Client\Model\ObjectVersionId|null
     */
    public function getPrecedingVersionUid()
    {
        return $this->container['preceding_version_uid'];
    }

    /**
     * Sets preceding_version_uid
     *
     * @param \OpenAPI\Client\Model\ObjectVersionId|null $preceding_version_uid preceding_version_uid
     *
     * @return self
     */
    public function setPrecedingVersionUid($preceding_version_uid)
    {
        if (is_null($preceding_version_uid)) {
            throw new \InvalidArgumentException('non-nullable preceding_version_uid cannot be null');
        }
        $this->container['preceding_version_uid'] = $preceding_version_uid;

        return $this;
    }

    /**
     * Gets other_input_version_uids
     *
     * @return \OpenAPI\Client\Model\ObjectVersionId[]|null
     */
    public function getOtherInputVersionUids()
    {
        return $this->container['other_input_version_uids'];
    }

    /**
     * Sets other_input_version_uids
     *
     * @param \OpenAPI\Client\Model\ObjectVersionId[]|null $other_input_version_uids other_input_version_uids
     *
     * @return self
     */
    public function setOtherInputVersionUids($other_input_version_uids)
    {
        if (is_null($other_input_version_uids)) {
            throw new \InvalidArgumentException('non-nullable other_input_version_uids cannot be null');
        }
        $this->container['other_input_version_uids'] = $other_input_version_uids;
     ...
     *
     * @param \OpenAPI\Client\Model\DvCodedText $lifecycle_state lifecycle_state
     *
     * @return self
     */
     ...
     * Gets attestations
     *
     * @return \OpenAPI\Client\Model\Attestation[]|null
     */
     ...
     * Sets attestations
     *
     * @param \OpenAPI\Client\Model\Attestation[]|null $attestations attestations
     *
     * @return self
     */
    public function setAttestations($attestations)
    {
