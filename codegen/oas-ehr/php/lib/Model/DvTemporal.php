...
class DvTemporal extends DvQuantified
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DvTemporal';
    ...
    protected static $openAPITypes = [
        '_type' => 'string',
        'accuracy' => '\OpenAPI\Client\Model\DvDuration'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'DV_TEMPORAL');
    ...
    */
     ...
     * Sets accuracy
     *
     * @param \OpenAPI\Client\Model\DvDuration|null $accuracy accuracy
     *
     * @return self
     */
