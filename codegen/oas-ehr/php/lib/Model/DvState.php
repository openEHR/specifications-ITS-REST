...
class DvState extends DataValue
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DvState';
    ...
    protected static $openAPITypes = [
        '_type' => 'string',
        'value' => '\OpenAPI\Client\Model\DvCodedText',
        'is_terminal' => 'bool'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'DV_STATE');
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_terminal'] === null) {
            $invalidProperties[] = "'is_terminal' can't be null";
        }
     ...
     * Sets value
     *
     * @param \OpenAPI\Client\Model\DvCodedText $value value
     *
     * @return self
     */
     ...
     * Sets is_terminal
     *
     * @param bool $is_terminal is_terminal
     *
     * @return self
     */
    public function setIsTerminal($is_terminal)
    {
        if (is_null($is_terminal)) {
            throw new \InvalidArgumentException('non-nullable is_terminal cannot be null');
        }
