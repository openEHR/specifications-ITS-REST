...
class ImportedVersion extends Version
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImportedVersion';
    ...
    protected static $openAPITypes = [
        '_type' => 'string',
        'item' => '\OpenAPI\Client\Model\OriginalVersion'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'IMPORTED_VERSION');
    ...
    */
     ...
     * Gets item
     *
     * @return \OpenAPI\Client\Model\OriginalVersion
     */
     ...
     * Sets item
     *
     * @param \OpenAPI\Client\Model\OriginalVersion $item item
     *
     * @return self
     */
