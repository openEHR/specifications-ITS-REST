...
class DvOrdinal extends DvOrdered
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DvOrdinal';
    ...
    protected static $openAPITypes = [
        '_type' => 'string',
        'symbol' => '\OpenAPI\Client\Model\DvCodedText',
        'value' => 'int'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'DV_ORDINAL');
    ...
    */
     ...
     * Sets symbol
     *
     * @param \OpenAPI\Client\Model\DvCodedText $symbol symbol
     *
     * @return self
     */
