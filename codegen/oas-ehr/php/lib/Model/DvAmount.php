...
class DvAmount extends DvQuantified
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DvAmount';
    ...
    protected static $setters = [
        '_type' => 'setType',
        'accuracy_is_percent' => 'setAccuracyIsPercent',
    ...
    protected static $getters = [
        '_type' => 'getType',
        'accuracy_is_percent' => 'getAccuracyIsPercent',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'DV_AMOUNT');
        $this->setIfExists('accuracy_is_percent', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets accuracy_is_percent
     *
     * @return bool|null
     */
    public function getAccuracyIsPercent()
    {
        return $this->container['accuracy_is_percent'];
    }

    /**
     * Sets accuracy_is_percent
     *
     * @param bool|null $accuracy_is_percent accuracy_is_percent
     *
     * @return self
     */
    public function setAccuracyIsPercent($accuracy_is_percent)
    {
        if (is_null($accuracy_is_percent)) {
            throw new \InvalidArgumentException('non-nullable accuracy_is_percent cannot be null');
        }
        $this->container['accuracy_is_percent'] = $accuracy_is_percent;
