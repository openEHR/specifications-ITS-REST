...
/**
 * UpdateAttestation Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateAttestation extends UpdateAudit
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateAttestation';
    ...
    protected static $openAPITypes = [
        '_type' => 'string',
        'attested_view' => '\OpenAPI\Client\Model\DvMultimedia',
        'proof' => 'string',
        'items' => '\OpenAPI\Client\Model\DvEhrUri[]',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'UPDATE_ATTESTATION');
        $this->setIfExists('attested_view', $data ?? [], null);
    ...
    */
     ...
     */
    public function getAttestedView()
    {
        return $this->container['attested_view'];
    }

    /**
     * Sets attested_view
     *
     * @param \OpenAPI\Client\Model\DvMultimedia|null $attested_view attested_view
     *
     * @return self
     */
    public function setAttestedView($attested_view)
    {
        if (is_null($attested_view)) {
            throw new \InvalidArgumentException('non-nullable attested_view cannot be null');
        }
        $this->container['attested_view'] = $attested_view;
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\DvEhrUri[]|null
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\DvEhrUri[]|null $items items
     *
     * @return self
     */
     ...
     * Sets reason
     *
     * @param \OpenAPI\Client\Model\DvText $reason reason
     *
     * @return self
     */
