...
class DvQuantity extends DvAmount
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DvQuantity';
    ...
    protected static $setters = [
        ...
        'units_display_name' => 'setUnitsDisplayName'
    ];
    ...
    protected static $getters = [
        ...
        'units_display_name' => 'getUnitsDisplayName'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'DV_QUANTITY');
        $this->setIfExists('magnitude', $data ?? [], null);
        $this->setIfExists('precision', $data ?? [], null);
        $this->setIfExists('units', $data ?? [], null);
        $this->setIfExists('units_system', $data ?? [], null);
        $this->setIfExists('units_display_name', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['magnitude'] === null) {
            $invalidProperties[] = "'magnitude' can't be null";
        }
     ...
     * Sets magnitude
     *
     * @param float $magnitude magnitude
     *
     * @return self
     */
    public function setMagnitude($magnitude)
    {
        if (is_null($magnitude)) {
            throw new \InvalidArgumentException('non-nullable magnitude cannot be null');
        }
    ...
    {
        return $this->container['units_system'];
    }

    /**
     * Sets units_system
     *
     * @param string|null $units_system units_system
     *
     * @return self
     */
    public function setUnitsSystem($units_system)
    {
        if (is_null($units_system)) {
            throw new \InvalidArgumentException('non-nullable units_system cannot be null');
        }
        $this->container['units_system'] = $units_system;

        return $this;
    }

    /**
     * Gets units_display_name
     *
     * @return string|null
     */
    public function getUnitsDisplayName()
    {
        return $this->container['units_display_name'];
    }

    /**
     * Sets units_display_name
     *
     * @param string|null $units_display_name units_display_name
     *
     * @return self
     */
    public function setUnitsDisplayName($units_display_name)
    {
        if (is_null($units_display_name)) {
            throw new \InvalidArgumentException('non-nullable units_display_name cannot be null');
        }
        $this->container['units_display_name'] = $units_display_name;
