...
{
    public const DISCRIMINATOR = '_type';
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DvInterval';
    ...
    protected static $setters = [
        '_type' => 'setType',
        'lower_unbounded' => 'setLowerUnbounded',
        'upper_unbounded' => 'setUpperUnbounded',
        'lower_included' => 'setLowerIncluded',
        'upper_included' => 'setUpperIncluded'
    ];
    ...
    protected static $getters = [
        '_type' => 'getType',
        'lower_unbounded' => 'getLowerUnbounded',
        'upper_unbounded' => 'getUpperUnbounded',
        'lower_included' => 'getLowerIncluded',
        'upper_included' => 'getUpperIncluded'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'DV_INTERVAL');
        $this->setIfExists('lower_unbounded', $data ?? [], null);
        $this->setIfExists('upper_unbounded', $data ?? [], null);
        $this->setIfExists('lower_included', $data ?? [], null);
        $this->setIfExists('upper_included', $data ?? [], null);

        // Initialize discriminator property with the model name.
        $this->container['_type'] = static::$openAPIModelName;
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['lower_unbounded'] === null) {
            $invalidProperties[] = "'lower_unbounded' can't be null";
        }
        if ($this->container['upper_unbounded'] === null) {
            $invalidProperties[] = "'upper_unbounded' can't be null";
        }
        if ($this->container['lower_included'] === null) {
            $invalidProperties[] = "'lower_included' can't be null";
        }
        if ($this->container['upper_included'] === null) {
            $invalidProperties[] = "'upper_included' can't be null";
        }
    ...
    /**
     * Gets lower_unbounded
     *
     * @return bool
     */
    public function getLowerUnbounded()
    {
        return $this->container['lower_unbounded'];
    }

    /**
     * Sets lower_unbounded
     *
     * @param bool $lower_unbounded lower_unbounded
     *
     * @return self
     */
    public function setLowerUnbounded($lower_unbounded)
    {
        if (is_null($lower_unbounded)) {
            throw new \InvalidArgumentException('non-nullable lower_unbounded cannot be null');
        }
        $this->container['lower_unbounded'] = $lower_unbounded;

        return $this;
    }

    /**
     * Gets upper_unbounded
     *
     * @return bool
     */
    public function getUpperUnbounded()
    {
        return $this->container['upper_unbounded'];
    }

    /**
     * Sets upper_unbounded
     *
     * @param bool $upper_unbounded upper_unbounded
     *
     * @return self
     */
    public function setUpperUnbounded($upper_unbounded)
    {
        if (is_null($upper_unbounded)) {
            throw new \InvalidArgumentException('non-nullable upper_unbounded cannot be null');
        }
        $this->container['upper_unbounded'] = $upper_unbounded;
     ...
     * @return bool
     */
    public function getLowerIncluded()
    {
        return $this->container['lower_included'];
    }

    /**
     * Sets lower_included
     *
     * @param bool $lower_included lower_included
     *
     * @return self
     */
    public function setLowerIncluded($lower_included)
    {
        if (is_null($lower_included)) {
            throw new \InvalidArgumentException('non-nullable lower_included cannot be null');
        }
        $this->container['lower_included'] = $lower_included;
     ...
     * @return bool
     */
    public function getUpperIncluded()
    {
        return $this->container['upper_included'];
    }

    /**
     * Sets upper_included
     *
     * @param bool $upper_included upper_included
     *
     * @return self
     */
    public function setUpperIncluded($upper_included)
    {
        if (is_null($upper_included)) {
            throw new \InvalidArgumentException('non-nullable upper_included cannot be null');
        }
        $this->container['upper_included'] = $upper_included;
