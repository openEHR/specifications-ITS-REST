...
class Action extends CareEntry
{
    ...
    protected static $openAPITypes = [
        ...
        'ism_transition' => '\OpenAPI\Client\Model\IsmTransition',
        'instruction_details' => '\OpenAPI\Client\Model\InstructionDetails',
        'description' => '\OpenAPI\Client\Model\ItemStructure'
    ];
    ...
    protected static array $openAPINullables = [
        '_type' => false,
		'time' => false,
		'ism_transition' => false,
		'instruction_details' => false,
		'description' => false
    ];
    ...
    protected static $setters = [
        '_type' => 'setType',
        'time' => 'setTime',
        'ism_transition' => 'setIsmTransition',
        'instruction_details' => 'setInstructionDetails',
    ...
    protected static $getters = [
        '_type' => 'getType',
        'time' => 'getTime',
        'ism_transition' => 'getIsmTransition',
        'instruction_details' => 'getInstructionDetails',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'ACTION');
        $this->setIfExists('time', $data ?? [], null);
        $this->setIfExists('ism_transition', $data ?? [], null);
        $this->setIfExists('instruction_details', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ism_transition'] === null) {
            $invalidProperties[] = "'ism_transition' can't be null";
        }
     ...
     * Sets time
     *
     * @param \OpenAPI\Client\Model\DvDateTime $time time
     *
     * @return self
     */
     ...
     * Gets ism_transition
     *
     * @return \OpenAPI\Client\Model\IsmTransition
     */
    public function getIsmTransition()
    {
        return $this->container['ism_transition'];
    }

    /**
     * Sets ism_transition
     *
     * @param \OpenAPI\Client\Model\IsmTransition $ism_transition ism_transition
     *
     * @return self
     */
    public function setIsmTransition($ism_transition)
    {
        if (is_null($ism_transition)) {
            throw new \InvalidArgumentException('non-nullable ism_transition cannot be null');
        }
        $this->container['ism_transition'] = $ism_transition;

        return $this;
    }

    /**
     * Gets instruction_details
     *
     * @return \OpenAPI\Client\Model\InstructionDetails|null
     */
    public function getInstructionDetails()
    {
        return $this->container['instruction_details'];
    }

    /**
     * Sets instruction_details
     *
     * @param \OpenAPI\Client\Model\InstructionDetails|null $instruction_details instruction_details
     *
     * @return self
     */
    public function setInstructionDetails($instruction_details)
    {
        if (is_null($instruction_details)) {
            throw new \InvalidArgumentException('non-nullable instruction_details cannot be null');
        }
        $this->container['instruction_details'] = $instruction_details;
     ...
     * Gets description
     *
     * @return \OpenAPI\Client\Model\ItemStructure
     */
     ...
     * Sets description
     *
     * @param \OpenAPI\Client\Model\ItemStructure $description description
     *
     * @return self
     */
