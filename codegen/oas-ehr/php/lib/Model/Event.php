...
class Event extends Locatable
{
    ...
    protected static $openAPITypes = [
        ...
        'state' => '\OpenAPI\Client\Model\ItemStructure',
        'data' => '\OpenAPI\Client\Model\ItemStructure'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'EVENT');
    ...
    */
     ...
     * Sets state
     *
     * @param \OpenAPI\Client\Model\ItemStructure|null $state state
     *
     * @return self
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\ItemStructure $data data
     *
     * @return self
     */
