...
/**
 * IsmTransition Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class IsmTransition extends Pathable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IsmTransition';
    ...
    protected static $openAPITypes = [
        '_type' => 'string',
        'current_state' => '\OpenAPI\Client\Model\DvCodedText',
        'transition' => '\OpenAPI\Client\Model\DvCodedText',
        'careflow_step' => '\OpenAPI\Client\Model\DvCodedText',
        'reason' => '\OpenAPI\Client\Model\DvText[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'ISM_TRANSITION');
        $this->setIfExists('current_state', $data ?? [], null);
        $this->setIfExists('transition', $data ?? [], null);
        $this->setIfExists('careflow_step', $data ?? [], null);
    ...
    */
     ...
     * Sets current_state
     *
     * @param \OpenAPI\Client\Model\DvCodedText $current_state current_state
     *
     * @return self
     */
     ...
     * Sets transition
     *
     * @param \OpenAPI\Client\Model\DvCodedText|null $transition transition
     *
     * @return self
     */
     ...
     * @return \OpenAPI\Client\Model\DvCodedText|null
     */
    public function getCareflowStep()
    {
        return $this->container['careflow_step'];
    }

    /**
     * Sets careflow_step
     *
     * @param \OpenAPI\Client\Model\DvCodedText|null $careflow_step careflow_step
     *
     * @return self
     */
    public function setCareflowStep($careflow_step)
    {

        if (is_null($careflow_step)) {
            throw new \InvalidArgumentException('non-nullable careflow_step cannot be null');
        }

        $this->container['careflow_step'] = $careflow_step;
     ...
     * Sets reason
     *
     * @param \OpenAPI\Client\Model\DvText[]|null $reason reason
     *
     * @return self
     */
