...
/**
 * AbstractEntry Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AbstractEntry extends ContentItem
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AbstractEntry';
    ...
    protected static $openAPITypes = [
        'language' => '\OpenAPI\Client\Model\CodePhrase',
        'encoding' => '\OpenAPI\Client\Model\CodePhrase',
        'other_participations' => '\OpenAPI\Client\Model\Participation[]',
        'workflow_id' => '\OpenAPI\Client\Model\ObjectRef',
        'subject' => '\OpenAPI\Client\Model\PartyProxy',
        'provider' => '\OpenAPI\Client\Model\PartyProxy'
    ];
    ...
    protected static $setters = [
        ...
        'other_participations' => 'setOtherParticipations',
    ...
    protected static $getters = [
        ...
        'other_participations' => 'getOtherParticipations',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('other_participations', $data ?? [], null);
    ...
    */
     ...
     * Gets language
     *
     * @return \OpenAPI\Client\Model\CodePhrase
     */
     ...
     * Sets language
     *
     * @param \OpenAPI\Client\Model\CodePhrase $language language
     *
     * @return self
     */
     ...
     * Sets encoding
     *
     * @param \OpenAPI\Client\Model\CodePhrase $encoding encoding
     *
     * @return self
     */
    ...
    /**
     * Gets other_participations
     *
     * @return \OpenAPI\Client\Model\Participation[]|null
     */
    public function getOtherParticipations()
    {
        return $this->container['other_participations'];
    }

    /**
     * Sets other_participations
     *
     * @param \OpenAPI\Client\Model\Participation[]|null $other_participations other_participations
     *
     * @return self
     */
    public function setOtherParticipations($other_participations)
    {

        if (is_null($other_participations)) {
            throw new \InvalidArgumentException('non-nullable other_participations cannot be null');
        }

        $this->container['other_participations'] = $other_participations;
     ...
     * Sets workflow_id
     *
     * @param \OpenAPI\Client\Model\ObjectRef|null $workflow_id workflow_id
     *
     * @return self
     */
     ...
     * Gets subject
     *
     * @return \OpenAPI\Client\Model\PartyProxy
     */
     ...
     * Sets subject
     *
     * @param \OpenAPI\Client\Model\PartyProxy $subject subject
     *
     * @return self
     */
     ...
     * Sets provider
     *
     * @param \OpenAPI\Client\Model\PartyProxy|null $provider provider
     *
     * @return self
     */
