...
/**
 * UpdateVersion Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateVersion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateVersion';
    ...
    protected static $openAPITypes = [
        ...
        'signature' => 'string',
        'lifecycle_state' => '\OpenAPI\Client\Model\TerminologyCode',
        'attestations' => '\OpenAPI\Client\Model\UpdateAttestation[]',
        'data' => '\OpenAPI\Client\Model\Versionable',
        'commit_audit' => '\OpenAPI\Client\Model\UpdateAudit'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('commit_audit', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['commit_audit'] === null) {
            $invalidProperties[] = "'commit_audit' can't be null";
        }
     ...
     *
     * @return \OpenAPI\Client\Model\TerminologyCode
     */
     ...
     *
     * @param \OpenAPI\Client\Model\TerminologyCode $lifecycle_state lifecycle_state
     *
     * @return self
     */
     ...
     * Gets attestations
     *
     * @return \OpenAPI\Client\Model\UpdateAttestation[]|null
     */
     ...
     * Sets attestations
     *
     * @param \OpenAPI\Client\Model\UpdateAttestation[]|null $attestations attestations
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\Versionable
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\Versionable $data data
     *
     * @return self
     */
     ...
     * Gets commit_audit
     *
     * @return \OpenAPI\Client\Model\UpdateAudit
     */
    public function getCommitAudit()
    {
        return $this->container['commit_audit'];
    }

    /**
     * Sets commit_audit
     *
     * @param \OpenAPI\Client\Model\UpdateAudit $commit_audit commit_audit
     *
     * @return self
     */
    public function setCommitAudit($commit_audit)
    {

        if (is_null($commit_audit)) {
            throw new \InvalidArgumentException('non-nullable commit_audit cannot be null');
        }

        $this->container['commit_audit'] = $commit_audit;
