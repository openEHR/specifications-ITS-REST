...
class DvOrdered extends DataValue
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DvOrdered';
    ...
    protected static $openAPITypes = [
        '_type' => 'string',
        'normal_status' => '\OpenAPI\Client\Model\CodePhrase',
        'normal_range' => '\OpenAPI\Client\Model\DvInterval',
        'other_reference_ranges' => '\OpenAPI\Client\Model\ReferenceRange[]'
    ];
    ...
    protected static $setters = [
        '_type' => 'setType',
        'normal_status' => 'setNormalStatus',
        'normal_range' => 'setNormalRange',
        'other_reference_ranges' => 'setOtherReferenceRanges'
    ];
    ...
    protected static $getters = [
        '_type' => 'getType',
        'normal_status' => 'getNormalStatus',
        'normal_range' => 'getNormalRange',
        'other_reference_ranges' => 'getOtherReferenceRanges'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'DV_ORDERED');
        $this->setIfExists('normal_status', $data ?? [], null);
        $this->setIfExists('normal_range', $data ?? [], null);
        $this->setIfExists('other_reference_ranges', $data ?? [], null);
    ...
    */
     ...
     * Gets normal_status
     *
     * @return \OpenAPI\Client\Model\CodePhrase|null
     */
    public function getNormalStatus()
    {
        return $this->container['normal_status'];
    }

    /**
     * Sets normal_status
     *
     * @param \OpenAPI\Client\Model\CodePhrase|null $normal_status normal_status
     *
     * @return self
     */
    public function setNormalStatus($normal_status)
    {
        if (is_null($normal_status)) {
            throw new \InvalidArgumentException('non-nullable normal_status cannot be null');
        }
        $this->container['normal_status'] = $normal_status;
     ...
     * Gets normal_range
     *
     * @return \OpenAPI\Client\Model\DvInterval|null
     */
    public function getNormalRange()
    {
        return $this->container['normal_range'];
    }

    /**
     * Sets normal_range
     *
     * @param \OpenAPI\Client\Model\DvInterval|null $normal_range normal_range
     *
     * @return self
     */
    public function setNormalRange($normal_range)
    {
        if (is_null($normal_range)) {
            throw new \InvalidArgumentException('non-nullable normal_range cannot be null');
        }
        $this->container['normal_range'] = $normal_range;

        return $this;
    }

    /**
     * Gets other_reference_ranges
     *
     * @return \OpenAPI\Client\Model\ReferenceRange[]|null
     */
    public function getOtherReferenceRanges()
    {
        return $this->container['other_reference_ranges'];
    }

    /**
     * Sets other_reference_ranges
     *
     * @param \OpenAPI\Client\Model\ReferenceRange[]|null $other_reference_ranges other_reference_ranges
     *
     * @return self
     */
    public function setOtherReferenceRanges($other_reference_ranges)
    {
        if (is_null($other_reference_ranges)) {
            throw new \InvalidArgumentException('non-nullable other_reference_ranges cannot be null');
        }
        $this->container['other_reference_ranges'] = $other_reference_ranges;
