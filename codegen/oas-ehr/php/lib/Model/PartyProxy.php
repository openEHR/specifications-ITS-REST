 ...
 */
class PartyProxy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartyProxy';
    ...
    protected static $openAPITypes = [
        '_type' => 'string',
        'external_ref' => '\OpenAPI\Client\Model\PartyRef'
    ];
    ...
    {
        $this->setIfExists('_type', $data ?? [], 'PARTY_PROXY');
    ...
    */
     ...
     * Gets external_ref
     *
     * @return \OpenAPI\Client\Model\PartyRef|null
     */
     ...
     * Sets external_ref
     *
     * @param \OpenAPI\Client\Model\PartyRef|null $external_ref external_ref
     *
     * @return self
     */
