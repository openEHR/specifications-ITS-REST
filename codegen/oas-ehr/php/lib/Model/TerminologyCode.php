...
/**
 * TerminologyCode Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TerminologyCode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TerminologyCode';
    ...
    protected static $setters = [
        'terminology_id' => 'setTerminologyId',
        'terminology_version' => 'setTerminologyVersion',
        'code_string' => 'setCodeString',
        'uri' => 'setUri'
    ];
    ...
    protected static $getters = [
        'terminology_id' => 'getTerminologyId',
        'terminology_version' => 'getTerminologyVersion',
        'code_string' => 'getCodeString',
        'uri' => 'getUri'
    ];
    ...
    {
        $this->setIfExists('terminology_id', $data ?? [], null);
        $this->setIfExists('terminology_version', $data ?? [], null);
        $this->setIfExists('code_string', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['terminology_id'] === null) {
            $invalidProperties[] = "'terminology_id' can't be null";
        }
        if ($this->container['code_string'] === null) {
            $invalidProperties[] = "'code_string' can't be null";
        }
    ...
    {
        return $this->container['terminology_id'];
    }

    /**
     * Sets terminology_id
     *
     * @param string $terminology_id terminology_id
     *
     * @return self
     */
    public function setTerminologyId($terminology_id)
    {

        if (is_null($terminology_id)) {
            throw new \InvalidArgumentException('non-nullable terminology_id cannot be null');
        }

        $this->container['terminology_id'] = $terminology_id;

        return $this;
    }

    /**
     * Gets terminology_version
     *
     * @return string|null
     */
    public function getTerminologyVersion()
    {
        return $this->container['terminology_version'];
    }

    /**
     * Sets terminology_version
     *
     * @param string|null $terminology_version terminology_version
     *
     * @return self
     */
    public function setTerminologyVersion($terminology_version)
    {

        if (is_null($terminology_version)) {
            throw new \InvalidArgumentException('non-nullable terminology_version cannot be null');
        }

        $this->container['terminology_version'] = $terminology_version;
    ...
    {
        return $this->container['code_string'];
    }

    /**
     * Sets code_string
     *
     * @param string $code_string code_string
     *
     * @return self
     */
    public function setCodeString($code_string)
    {

        if (is_null($code_string)) {
            throw new \InvalidArgumentException('non-nullable code_string cannot be null');
        }

        $this->container['code_string'] = $code_string;
