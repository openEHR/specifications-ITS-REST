...
class Locatable extends Pathable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Locatable';
    ...
    protected static $openAPITypes = [
        'name' => '\OpenAPI\Client\Model\DvText',
        'archetype_node_id' => 'string',
        'uid' => '\OpenAPI\Client\Model\UidBasedId',
        'links' => '\OpenAPI\Client\Model\Link[]',
        'archetype_details' => '\OpenAPI\Client\Model\Archetyped',
        'feeder_audit' => '\OpenAPI\Client\Model\FeederAudit'
    ];
    ...
    protected static array $openAPINullables = [
        'name' => false,
		'archetype_node_id' => false,
		'uid' => false,
		'links' => false,
		'archetype_details' => false,
		'feeder_audit' => false
    ];
    ...
    protected static $setters = [
        'name' => 'setName',
        'archetype_node_id' => 'setArchetypeNodeId',
        'uid' => 'setUid',
        'links' => 'setLinks',
        'archetype_details' => 'setArchetypeDetails',
        'feeder_audit' => 'setFeederAudit'
    ];
    ...
    protected static $getters = [
        'name' => 'getName',
        'archetype_node_id' => 'getArchetypeNodeId',
        'uid' => 'getUid',
        'links' => 'getLinks',
        'archetype_details' => 'getArchetypeDetails',
        'feeder_audit' => 'getFeederAudit'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('archetype_node_id', $data ?? [], null);
        $this->setIfExists('uid', $data ?? [], null);
        $this->setIfExists('links', $data ?? [], null);
        $this->setIfExists('archetype_details', $data ?? [], null);
        $this->setIfExists('feeder_audit', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['archetype_node_id'] === null) {
            $invalidProperties[] = "'archetype_node_id' can't be null";
        }
     ...
     * Gets name
     *
     * @return \OpenAPI\Client\Model\DvText
     */
     ...
     * Sets name
     *
     * @param \OpenAPI\Client\Model\DvText $name name
     *
     * @return self
     */
    ...
    /**
     * Gets archetype_node_id
     *
     * @return string
     */
    public function getArchetypeNodeId()
    {
        return $this->container['archetype_node_id'];
    }

    /**
     * Sets archetype_node_id
     *
     * @param string $archetype_node_id archetype_node_id
     *
     * @return self
     */
    public function setArchetypeNodeId($archetype_node_id)
    {
        if (is_null($archetype_node_id)) {
            throw new \InvalidArgumentException('non-nullable archetype_node_id cannot be null');
        }
        $this->container['archetype_node_id'] = $archetype_node_id;
     ...
     * Gets uid
     *
     * @return \OpenAPI\Client\Model\UidBasedId|null
     */
     ...
     * Sets uid
     *
     * @param \OpenAPI\Client\Model\UidBasedId|null $uid uid
     *
     * @return self
     */
    ...
    /**
     * Gets archetype_details
     *
     * @return \OpenAPI\Client\Model\Archetyped|null
     */
    public function getArchetypeDetails()
    {
        return $this->container['archetype_details'];
    }

    /**
     * Sets archetype_details
     *
     * @param \OpenAPI\Client\Model\Archetyped|null $archetype_details archetype_details
     *
     * @return self
     */
    public function setArchetypeDetails($archetype_details)
    {
        if (is_null($archetype_details)) {
            throw new \InvalidArgumentException('non-nullable archetype_details cannot be null');
        }
        $this->container['archetype_details'] = $archetype_details;
     ...
     * Gets feeder_audit
     *
     * @return \OpenAPI\Client\Model\FeederAudit|null
     */
    public function getFeederAudit()
    {
        return $this->container['feeder_audit'];
    }

    /**
     * Sets feeder_audit
     *
     * @param \OpenAPI\Client\Model\FeederAudit|null $feeder_audit feeder_audit
     *
     * @return self
     */
    public function setFeederAudit($feeder_audit)
    {
        if (is_null($feeder_audit)) {
            throw new \InvalidArgumentException('non-nullable feeder_audit cannot be null');
        }
        $this->container['feeder_audit'] = $feeder_audit;
