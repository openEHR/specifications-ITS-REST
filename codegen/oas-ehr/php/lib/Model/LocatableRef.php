...
/**
 * LocatableRef Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LocatableRef implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LocatableRef';
    ...
    protected static $openAPITypes = [
        'namespace' => 'string',
        'type' => 'string',
        'id' => '\OpenAPI\Client\Model\UidBasedId',
        'path' => 'string'
    ];
    ...
    */
     ...
     * Gets id
     *
     * @return \OpenAPI\Client\Model\UidBasedId
     */
     ...
     * Sets id
     *
     * @param \OpenAPI\Client\Model\UidBasedId $id id
     *
     * @return self
     */
