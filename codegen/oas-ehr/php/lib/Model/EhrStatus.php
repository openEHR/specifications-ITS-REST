...
class EhrStatus extends Versionable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EhrStatus';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'EHR_STATUS');
        $this->setIfExists('subject', $data ?? [], null);
        $this->setIfExists('is_queryable', $data ?? [], true);
        $this->setIfExists('is_modifiable', $data ?? [], true);
    ...
    */
    ...
    {
        if (is_null($is_queryable)) {
            throw new \InvalidArgumentException('non-nullable is_queryable cannot be null');
        }
    ...
    {
        if (is_null($is_modifiable)) {
            throw new \InvalidArgumentException('non-nullable is_modifiable cannot be null');
        }
