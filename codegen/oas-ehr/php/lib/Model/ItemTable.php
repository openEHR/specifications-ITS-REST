...
class ItemTable extends ItemStructure
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ItemTable';
    ...
    protected static $openAPITypes = [
        '_type' => 'string',
        'items' => '\OpenAPI\Client\Model\Clstr[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'ITEM_TABLE');
    ...
    */
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\Clstr[]|null
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\Clstr[]|null $items items
     *
     * @return self
     */
