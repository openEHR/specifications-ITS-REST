 ...
 */
class CareEntry extends AbstractEntry
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CareEntry';
    ...
    protected static $openAPITypes = [
        'protocol' => '\OpenAPI\Client\Model\ItemStructure',
        'guideline_id' => '\OpenAPI\Client\Model\ObjectRef'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('guideline_id', $data ?? [], null);
    ...
    */
     ...
     * Sets protocol
     *
     * @param \OpenAPI\Client\Model\ItemStructure|null $protocol protocol
     *
     * @return self
     */
    ...
    {
        return $this->container['guideline_id'];
    }

    /**
     * Sets guideline_id
     *
     * @param \OpenAPI\Client\Model\ObjectRef|null $guideline_id guideline_id
     *
     * @return self
     */
    public function setGuidelineId($guideline_id)
    {
        if (is_null($guideline_id)) {
            throw new \InvalidArgumentException('non-nullable guideline_id cannot be null');
        }
        $this->container['guideline_id'] = $guideline_id;
