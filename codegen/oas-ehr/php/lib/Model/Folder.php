...
class Folder extends Locatable
{
    ...
    protected static $openAPITypes = [
        '_type' => 'string',
        'items' => '\OpenAPI\Client\Model\ObjectRef[]',
        'folders' => '\OpenAPI\Client\Model\Folder[]',
        'details' => '\OpenAPI\Client\Model\ItemStructure'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'FOLDER');
    ...
    */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\ObjectRef[]|null $items items
     *
     * @return self
     */
     ...
     * Sets folders
     *
     * @param \OpenAPI\Client\Model\Folder[]|null $folders folders
     *
     * @return self
     */
     ...
     * Sets details
     *
     * @param \OpenAPI\Client\Model\ItemStructure|null $details details
     *
     * @return self
     */
