...
class ItemSingle extends ItemStructure
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ItemSingle';
    ...
    protected static $openAPITypes = [
        '_type' => 'string',
        'item' => '\OpenAPI\Client\Model\Element'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'ITEM_SINGLE');
    ...
    */
     ...
     * Sets item
     *
     * @param \OpenAPI\Client\Model\Element $item item
     *
     * @return self
     */
