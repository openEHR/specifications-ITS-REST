 ...
 */
class UpdateAudit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateAudit';
    ...
    protected static $openAPITypes = [
        '_type' => 'string',
        'change_type' => '\OpenAPI\Client\Model\TerminologyCode',
    ...
    {
        $this->setIfExists('_type', $data ?? [], 'UPDATE_AUDIT');
    ...
    */
     ...
     * Sets change_type
     *
     * @param \OpenAPI\Client\Model\TerminologyCode $change_type change_type
     *
     * @return self
     */
