...
/**
 * RevisionHistory Class Doc Comment
 *
 * @category Class
 ...
 */
class RevisionHistory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RevisionHistory';
    ...
    protected static $openAPITypes = [
        'items' => '\OpenAPI\Client\Model\RevisionHistoryItem[]'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\RevisionHistoryItem[]
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\RevisionHistoryItem[] $items items
     *
     * @return self
     */
