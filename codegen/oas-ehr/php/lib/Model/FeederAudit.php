 ...
 */
class FeederAudit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FeederAudit';
    ...
    protected static $openAPITypes = [
        'originating_system_item_ids' => '\OpenAPI\Client\Model\DvIdentifier[]',
        'feeder_system_item_ids' => '\OpenAPI\Client\Model\DvIdentifier[]',
        'original_content' => '\OpenAPI\Client\Model\DvEncapsulated',
        'originating_system_audit' => '\OpenAPI\Client\Model\FeederAuditDetails',
        'feeder_system_audit' => '\OpenAPI\Client\Model\FeederAuditDetails'
    ];
    ...
    protected static array $openAPINullables = [
        'originating_system_item_ids' => false,
		'feeder_system_item_ids' => false,
		'original_content' => false,
		'originating_system_audit' => false,
		'feeder_system_audit' => false
    ];
    ...
    protected static $setters = [
        'originating_system_item_ids' => 'setOriginatingSystemItemIds',
        'feeder_system_item_ids' => 'setFeederSystemItemIds',
        'original_content' => 'setOriginalContent',
        'originating_system_audit' => 'setOriginatingSystemAudit',
        'feeder_system_audit' => 'setFeederSystemAudit'
    ];
    ...
    protected static $getters = [
        'originating_system_item_ids' => 'getOriginatingSystemItemIds',
        'feeder_system_item_ids' => 'getFeederSystemItemIds',
        'original_content' => 'getOriginalContent',
        'originating_system_audit' => 'getOriginatingSystemAudit',
        'feeder_system_audit' => 'getFeederSystemAudit'
    ];
    ...
    {
        $this->setIfExists('originating_system_item_ids', $data ?? [], null);
        $this->setIfExists('feeder_system_item_ids', $data ?? [], null);
        $this->setIfExists('original_content', $data ?? [], null);
        $this->setIfExists('originating_system_audit', $data ?? [], null);
        $this->setIfExists('feeder_system_audit', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['originating_system_audit'] === null) {
            $invalidProperties[] = "'originating_system_audit' can't be null";
        }
    ...
    /**
     * Gets originating_system_item_ids
     *
     * @return \OpenAPI\Client\Model\DvIdentifier[]|null
     */
    public function getOriginatingSystemItemIds()
    {
        return $this->container['originating_system_item_ids'];
    }

    /**
     * Sets originating_system_item_ids
     *
     * @param \OpenAPI\Client\Model\DvIdentifier[]|null $originating_system_item_ids originating_system_item_ids
     *
     * @return self
     */
    public function setOriginatingSystemItemIds($originating_system_item_ids)
    {

        if (is_null($originating_system_item_ids)) {
            throw new \InvalidArgumentException('non-nullable originating_system_item_ids cannot be null');
        }

        $this->container['originating_system_item_ids'] = $originating_system_item_ids;

        return $this;
    }

    /**
     * Gets feeder_system_item_ids
     *
     * @return \OpenAPI\Client\Model\DvIdentifier[]|null
     */
    public function getFeederSystemItemIds()
    {
        return $this->container['feeder_system_item_ids'];
    }

    /**
     * Sets feeder_system_item_ids
     *
     * @param \OpenAPI\Client\Model\DvIdentifier[]|null $feeder_system_item_ids feeder_system_item_ids
     *
     * @return self
     */
    public function setFeederSystemItemIds($feeder_system_item_ids)
    {

        if (is_null($feeder_system_item_ids)) {
            throw new \InvalidArgumentException('non-nullable feeder_system_item_ids cannot be null');
        }

        $this->container['feeder_system_item_ids'] = $feeder_system_item_ids;
     ...
     *
     * @return \OpenAPI\Client\Model\DvEncapsulated|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\DvEncapsulated|null $original_content original_content
     *
     * @return self
     */
    public function setOriginalContent($original_content)
    {
        ...
        if (is_null($original_content)) {
            throw new \InvalidArgumentException('non-nullable original_content cannot be null');
        }
    ...
    /**
     * Gets originating_system_audit
     *
     * @return \OpenAPI\Client\Model\FeederAuditDetails
     */
    public function getOriginatingSystemAudit()
    {
        return $this->container['originating_system_audit'];
    }

    /**
     * Sets originating_system_audit
     *
     * @param \OpenAPI\Client\Model\FeederAuditDetails $originating_system_audit originating_system_audit
     *
     * @return self
     */
    public function setOriginatingSystemAudit($originating_system_audit)
    {

        if (is_null($originating_system_audit)) {
            throw new \InvalidArgumentException('non-nullable originating_system_audit cannot be null');
        }

        $this->container['originating_system_audit'] = $originating_system_audit;

        return $this;
    }

    /**
     * Gets feeder_system_audit
     *
     * @return \OpenAPI\Client\Model\FeederAuditDetails|null
     */
    public function getFeederSystemAudit()
    {
        return $this->container['feeder_system_audit'];
    }

    /**
     * Sets feeder_system_audit
     *
     * @param \OpenAPI\Client\Model\FeederAuditDetails|null $feeder_system_audit feeder_system_audit
     *
     * @return self
     */
    public function setFeederSystemAudit($feeder_system_audit)
    {

        if (is_null($feeder_system_audit)) {
            throw new \InvalidArgumentException('non-nullable feeder_system_audit cannot be null');
        }

        $this->container['feeder_system_audit'] = $feeder_system_audit;
