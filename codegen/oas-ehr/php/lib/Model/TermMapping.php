 ...
 */
class TermMapping implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TermMapping';
    ...
    protected static $openAPITypes = [
        'match' => 'string',
        'purpose' => '\OpenAPI\Client\Model\DvCodedText',
        'target' => '\OpenAPI\Client\Model\CodePhrase'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[><=?]$/", $this->container['match'])) {
            $invalidProperties[] = "invalid value for 'match', must be conform to the pattern /^[><=?]$/.";
        }
    ...
    public function setMatch($match)
    {
        ...
        if ((!preg_match("/^[><=?]$/", ObjectSerializer::toString($match)))) {
            throw new \InvalidArgumentException("invalid value for \$match when calling TermMapping., must conform to the pattern /^[><=?]$/.");
        }
     ...
     * Sets purpose
     *
     * @param \OpenAPI\Client\Model\DvCodedText|null $purpose purpose
     *
     * @return self
     */
     ...
     * Sets target
     *
     * @param \OpenAPI\Client\Model\CodePhrase $target target
     *
     * @return self
     */
