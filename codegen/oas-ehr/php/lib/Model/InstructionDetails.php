...
/**
 * InstructionDetails Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class InstructionDetails extends Pathable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InstructionDetails';
    ...
    protected static $openAPITypes = [
        '_type' => 'string',
        'instruction_id' => '\OpenAPI\Client\Model\LocatableRef',
        'activity_id' => 'string',
        'wf_details' => '\OpenAPI\Client\Model\ItemStructure'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'INSTRUCTION_DETAILS');
        $this->setIfExists('instruction_id', $data ?? [], null);
        $this->setIfExists('activity_id', $data ?? [], null);
        $this->setIfExists('wf_details', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets instruction_id
     *
     * @return \OpenAPI\Client\Model\LocatableRef
     */
     ...
     * Sets instruction_id
     *
     * @param \OpenAPI\Client\Model\LocatableRef $instruction_id instruction_id
     *
     * @return self
     */
     ...
     */
    public function getWfDetails()
    {
        return $this->container['wf_details'];
    }

    /**
     * Sets wf_details
     *
     * @param \OpenAPI\Client\Model\ItemStructure|null $wf_details wf_details
     *
     * @return self
     */
    public function setWfDetails($wf_details)
    {
        if (is_null($wf_details)) {
            throw new \InvalidArgumentException('non-nullable wf_details cannot be null');
        }
        $this->container['wf_details'] = $wf_details;
