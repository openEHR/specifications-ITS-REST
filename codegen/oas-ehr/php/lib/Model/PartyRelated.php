...
class PartyRelated extends PartyIdentified
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartyRelated';
    ...
    protected static $openAPITypes = [
        '_type' => 'string',
        'relationship' => '\OpenAPI\Client\Model\DvCodedText'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'PARTY_RELATED');
    ...
    */
     ...
     * Sets relationship
     *
     * @param \OpenAPI\Client\Model\DvCodedText $relationship relationship
     *
     * @return self
     */
