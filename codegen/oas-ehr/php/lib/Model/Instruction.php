...
class Instruction extends CareEntry
{
    ...
    protected static $openAPITypes = [
        '_type' => 'string',
        'narrative' => '\OpenAPI\Client\Model\DvText',
        'expiry_time' => '\OpenAPI\Client\Model\DvDateTime',
        'wf_definition' => '\OpenAPI\Client\Model\DvParsable',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'INSTRUCTION');
        $this->setIfExists('narrative', $data ?? [], null);
        $this->setIfExists('expiry_time', $data ?? [], null);
        $this->setIfExists('wf_definition', $data ?? [], null);
    ...
    */
     ...
     * Sets narrative
     *
     * @param \OpenAPI\Client\Model\DvText $narrative narrative
     *
     * @return self
     */
     ...
     * Sets expiry_time
     *
     * @param \OpenAPI\Client\Model\DvDateTime|null $expiry_time expiry_time
     *
     * @return self
     */
     ...
     */
    public function getWfDefinition()
    {
        return $this->container['wf_definition'];
    }

    /**
     * Sets wf_definition
     *
     * @param \OpenAPI\Client\Model\DvParsable|null $wf_definition wf_definition
     *
     * @return self
     */
    public function setWfDefinition($wf_definition)
    {
        if (is_null($wf_definition)) {
            throw new \InvalidArgumentException('non-nullable wf_definition cannot be null');
        }
        $this->container['wf_definition'] = $wf_definition;
