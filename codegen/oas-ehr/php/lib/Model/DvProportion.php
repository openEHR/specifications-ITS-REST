...
/**
 * DvProportion Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class DvProportion extends DvAmount
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DvProportion';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'DV_PROPORTION');
        $this->setIfExists('numerator', $data ?? [], null);
        $this->setIfExists('denominator', $data ?? [], null);
        $this->setIfExists('semantic_type', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['semantic_type'] === null) {
            $invalidProperties[] = "'semantic_type' can't be null";
        }
    ...
    {
        return $this->container['semantic_type'];
    }

    /**
     * Sets semantic_type
     *
     * @param int $semantic_type semantic_type
     *
     * @return self
     */
    public function setSemanticType($semantic_type)
    {
        if (is_null($semantic_type)) {
            throw new \InvalidArgumentException('non-nullable semantic_type cannot be null');
        }
        $this->container['semantic_type'] = $semantic_type;
