...
class Observation extends CareEntry
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Observation';
    ...
    protected static $openAPITypes = [
        '_type' => 'string',
        'data' => '\OpenAPI\Client\Model\History',
        'state' => '\OpenAPI\Client\Model\History'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'OBSERVATION');
    ...
    */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\History $data data
     *
     * @return self
     */
     ...
     * Sets state
     *
     * @param \OpenAPI\Client\Model\History|null $state state
     *
     * @return self
     */
