...
/**
 * DvEncapsulated Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class DvEncapsulated extends DataValue
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DvEncapsulated';
    ...
    protected static $openAPITypes = [
        '_type' => 'string',
        'charset' => '\OpenAPI\Client\Model\CodePhrase',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'DV_ENCAPSULATED');
    ...
    */
     ...
     * Sets charset
     *
     * @param \OpenAPI\Client\Model\CodePhrase|null $charset charset
     *
     * @return self
     */
