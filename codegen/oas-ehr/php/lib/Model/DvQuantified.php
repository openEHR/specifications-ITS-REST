...
/**
 * DvQuantified Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class DvQuantified extends DvOrdered
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DvQuantified';
    ...
    protected static $setters = [
        '_type' => 'setType',
        'magnitude_status' => 'setMagnitudeStatus'
    ];
    ...
    protected static $getters = [
        '_type' => 'getType',
        'magnitude_status' => 'getMagnitudeStatus'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'DV_QUANTIFIED');
        $this->setIfExists('magnitude_status', $data ?? [], '=');
    ...
    */
    ...
    /**
     * Gets magnitude_status
     *
     * @return string|null
     */
    public function getMagnitudeStatus()
    {
        return $this->container['magnitude_status'];
    }

    /**
     * Sets magnitude_status
     *
     * @param string|null $magnitude_status magnitude_status
     *
     * @return self
     */
    public function setMagnitudeStatus($magnitude_status)
    {
        if (is_null($magnitude_status)) {
            throw new \InvalidArgumentException('non-nullable magnitude_status cannot be null');
        }
        $this->container['magnitude_status'] = $magnitude_status;
