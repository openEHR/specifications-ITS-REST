...
class PartyIdentified extends PartyProxy
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartyIdentified';
    ...
    protected static $openAPITypes = [
        '_type' => 'string',
        'name' => 'string',
        'identifiers' => '\OpenAPI\Client\Model\DvIdentifier[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_type', $data ?? [], 'PARTY_IDENTIFIED');
    ...
    */
     ...
     * Sets identifiers
     *
     * @param \OpenAPI\Client\Model\DvIdentifier[]|null $identifiers identifiers
     *
     * @return self
     */
