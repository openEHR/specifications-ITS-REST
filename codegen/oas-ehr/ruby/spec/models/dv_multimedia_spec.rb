...
# Unit tests for OpenapiClient::DvMultimedia
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DvMultimedia do
  let(:instance) { OpenapiClient::DvMultimedia.new }

  describe 'test an instance of DvMultimedia' do
    it 'should create an instance of DvMultimedia' do
      expect(instance).to be_instance_of(OpenapiClient::DvMultimedia)
    end
  end
  ...
  describe 'test attribute "integrity_check"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "integrity_check_algorithm"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
