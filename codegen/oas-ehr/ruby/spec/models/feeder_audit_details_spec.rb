...
# Unit tests for OpenapiClient::FeederAuditDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::FeederAuditDetails do
  let(:instance) { OpenapiClient::FeederAuditDetails.new }

  describe 'test an instance of FeederAuditDetails' do
    it 'should create an instance of FeederAuditDetails' do
      expect(instance).to be_instance_of(OpenapiClient::FeederAuditDetails)
    end
  end
