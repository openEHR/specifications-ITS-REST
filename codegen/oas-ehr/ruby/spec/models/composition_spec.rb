...
# Unit tests for OpenapiClient::Composition
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Composition do
  let(:instance) { OpenapiClient::Composition.new }

  describe 'test an instance of Composition' do
    it 'should create an instance of Composition' do
      expect(instance).to be_instance_of(OpenapiClient::Composition)
    end
  end
