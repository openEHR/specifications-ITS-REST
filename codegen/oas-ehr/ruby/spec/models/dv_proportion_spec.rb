...
# Unit tests for OpenapiClient::DvProportion
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DvProportion do
  let(:instance) { OpenapiClient::DvProportion.new }

  describe 'test an instance of DvProportion' do
    it 'should create an instance of DvProportion' do
      expect(instance).to be_instance_of(OpenapiClient::DvProportion)
    end
  end
