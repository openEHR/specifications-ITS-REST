...
# Unit tests for OpenapiClient::DvInterval
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DvInterval do
  let(:instance) { OpenapiClient::DvInterval.new }

  describe 'test an instance of DvInterval' do
    it 'should create an instance of DvInterval' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::DvInterval)
    end
  end
