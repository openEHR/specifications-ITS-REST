...
# Unit tests for OpenapiClient::AbstractEntry
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AbstractEntry do
  let(:instance) { OpenapiClient::AbstractEntry.new }

  describe 'test an instance of AbstractEntry' do
    it 'should create an instance of AbstractEntry' do
      expect(instance).to be_instance_of(OpenapiClient::AbstractEntry)
    end
  end
  ...
  describe 'test attribute "other_participations"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
