...
# Unit tests for OpenapiClient::OriginalVersion
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OriginalVersion do
  let(:instance) { OpenapiClient::OriginalVersion.new }

  describe 'test an instance of OriginalVersion' do
    it 'should create an instance of OriginalVersion' do
      expect(instance).to be_instance_of(OpenapiClient::OriginalVersion)
    end
  end
  ...
  describe 'test attribute "preceding_version_uid"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "other_input_version_uids"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
