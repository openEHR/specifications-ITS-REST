...
# Unit tests for OpenapiClient::DvQuantity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DvQuantity do
  let(:instance) { OpenapiClient::DvQuantity.new }

  describe 'test an instance of DvQuantity' do
    it 'should create an instance of DvQuantity' do
      expect(instance).to be_instance_of(OpenapiClient::DvQuantity)
    end
  end
