...
# Unit tests for OpenapiClient::Locatable
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Locatable do
  let(:instance) { OpenapiClient::Locatable.new }

  describe 'test an instance of Locatable' do
    it 'should create an instance of Locatable' do
      expect(instance).to be_instance_of(OpenapiClient::Locatable)
    end
  end
  ...
  describe 'test attribute "archetype_node_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "archetype_details"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "feeder_audit"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
