...
# Unit tests for OpenapiClient::AuditDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AuditDetails do
  let(:instance) { OpenapiClient::AuditDetails.new }

  describe 'test an instance of AuditDetails' do
    it 'should create an instance of AuditDetails' do
      expect(instance).to be_instance_of(OpenapiClient::AuditDetails)
    end
  end
  ...
  describe 'test attribute "time_committed"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
