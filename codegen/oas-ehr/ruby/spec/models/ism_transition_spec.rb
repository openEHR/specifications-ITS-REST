...
# Unit tests for OpenapiClient::IsmTransition
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::IsmTransition do
  let(:instance) { OpenapiClient::IsmTransition.new }

  describe 'test an instance of IsmTransition' do
    it 'should create an instance of IsmTransition' do
      expect(instance).to be_instance_of(OpenapiClient::IsmTransition)
    end
  end
  ...
  describe 'test attribute "careflow_step"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
