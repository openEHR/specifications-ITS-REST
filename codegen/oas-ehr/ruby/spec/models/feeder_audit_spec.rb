...
# Unit tests for OpenapiClient::FeederAudit
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::FeederAudit do
  let(:instance) { OpenapiClient::FeederAudit.new }

  describe 'test an instance of FeederAudit' do
    it 'should create an instance of FeederAudit' do
      expect(instance).to be_instance_of(OpenapiClient::FeederAudit)
    end
  end
  describe 'test attribute "originating_system_item_ids"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "feeder_system_item_ids"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "originating_system_audit"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "feeder_system_audit"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
