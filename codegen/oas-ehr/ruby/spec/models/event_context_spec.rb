...
# Unit tests for OpenapiClient::EventContext
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::EventContext do
  let(:instance) { OpenapiClient::EventContext.new }

  describe 'test an instance of EventContext' do
    it 'should create an instance of EventContext' do
      expect(instance).to be_instance_of(OpenapiClient::EventContext)
    end
  end
  ...
  describe 'test attribute "other_context"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "health_care_facility"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
