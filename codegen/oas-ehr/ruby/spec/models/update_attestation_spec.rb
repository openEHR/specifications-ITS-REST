...
# Unit tests for OpenapiClient::UpdateAttestation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UpdateAttestation do
  let(:instance) { OpenapiClient::UpdateAttestation.new }

  describe 'test an instance of UpdateAttestation' do
    it 'should create an instance of UpdateAttestation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::UpdateAttestation)
    end
  end
  ...
  describe 'test attribute "attested_view"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
