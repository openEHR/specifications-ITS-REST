...
# Unit tests for OpenapiClient::DvText
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DvText do
  let(:instance) { OpenapiClient::DvText.new }

  describe 'test an instance of DvText' do
    it 'should create an instance of DvText' do
      expect(instance).to be_instance_of(OpenapiClient::DvText)
    end
  end
