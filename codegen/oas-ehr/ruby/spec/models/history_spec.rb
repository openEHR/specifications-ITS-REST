...
# Unit tests for OpenapiClient::History
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::History do
  let(:instance) { OpenapiClient::History.new }

  describe 'test an instance of History' do
    it 'should create an instance of History' do
      expect(instance).to be_instance_of(OpenapiClient::History)
    end
  end
