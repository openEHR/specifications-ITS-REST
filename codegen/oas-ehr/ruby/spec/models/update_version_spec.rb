...
# Unit tests for OpenapiClient::UpdateVersion
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UpdateVersion do
  let(:instance) { OpenapiClient::UpdateVersion.new }

  describe 'test an instance of UpdateVersion' do
    it 'should create an instance of UpdateVersion' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::UpdateVersion)
    end
  end
