...
# Unit tests for OpenapiClient::Attestation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Attestation do
  let(:instance) { OpenapiClient::Attestation.new }

  describe 'test an instance of Attestation' do
    it 'should create an instance of Attestation' do
      expect(instance).to be_instance_of(OpenapiClient::Attestation)
    end
  end
