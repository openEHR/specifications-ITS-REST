...
# Unit tests for OpenapiClient::CONTRIBUTIONApi
...
describe 'CONTRIBUTIONApi' do
  ...
  describe 'test an instance of CONTRIBUTIONApi' do
    it 'should create an instance of CONTRIBUTIONApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::CONTRIBUTIONApi)
    end
  end
  ...
  # @param new_contribution The CONTRIBUTION. 
