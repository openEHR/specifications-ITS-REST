...
module OpenapiClient
  class EHRApi
    ...
    # @option opts [EhrStatus] :ehr_status An EHR_STATUS resource MAY be also supplied by the client as the request body. 
    # @return [Ehr]
    def ehr_create(opts = {})
      data, _status_code, _headers = ehr_create_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;.  (default to 'return=minimal')
    # @option opts [EhrStatus] :ehr_status An EHR_STATUS resource MAY be also supplied by the client as the request body. 
    # @return [Array<(Ehr, Integer, Hash)>] Ehr data, response status code and response headers
    def ehr_create_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EHRApi.ehr_create ...'
      end
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'ehr_status'])

      # return_type
      return_type = opts[:debug_return_type] || 'Ehr'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"EHRApi.ehr_create",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EHRApi#ehr_create\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @option opts [EhrStatus] :ehr_status An EHR_STATUS resource MAY be also supplied by the client as the request body. 
    # @return [Ehr]
    def ehr_create_with_id(ehr_id, opts = {})
      data, _status_code, _headers = ehr_create_with_id_with_http_info(ehr_id, opts)
      data
    end
    ...
    # @option opts [EhrStatus] :ehr_status An EHR_STATUS resource MAY be also supplied by the client as the request body. 
    # @return [Array<(Ehr, Integer, Hash)>] Ehr data, response status code and response headers
    def ehr_create_with_id_with_http_info(ehr_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EHRApi.ehr_create_with_id ...'
      end
      # verify the required parameter 'ehr_id' is set
      if @api_client.config.client_side_validation && ehr_id.nil?
        fail ArgumentError, "Missing the required parameter 'ehr_id' when calling EHRApi.ehr_create_with_id"
      end
      allowable_values = ["return=representation", "return=minimal"]
      if @api_client.config.client_side_validation && opts[:'prefer'] && !allowable_values.include?(opts[:'prefer'])
        fail ArgumentError, "invalid value for \"prefer\", must be one of #{allowable_values}"
      ...
      # resource path
      local_var_path = '/ehr/{ehr_id}'.sub('{' + 'ehr_id' + '}', CGI.escape(ehr_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"EHRApi.ehr_create_with_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EHRApi#ehr_create_with_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Ehr]
    def ehr_get_by_id(ehr_id, opts = {})
      data, _status_code, _headers = ehr_get_by_id_with_http_info(ehr_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Ehr, Integer, Hash)>] Ehr data, response status code and response headers
    def ehr_get_by_id_with_http_info(ehr_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EHRApi.ehr_get_by_id ...'
      end
      # verify the required parameter 'ehr_id' is set
      if @api_client.config.client_side_validation && ehr_id.nil?
        fail ArgumentError, "Missing the required parameter 'ehr_id' when calling EHRApi.ehr_get_by_id"
      end
      # resource path
      local_var_path = '/ehr/{ehr_id}'.sub('{' + 'ehr_id' + '}', CGI.escape(ehr_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"EHRApi.ehr_get_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EHRApi#ehr_get_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param subject_id [String] The EHR subject id. 
    # @param subject_namespace [String] The EHR subject id namespace. 
    # @param [Hash] opts the optional parameters
    # @return [Ehr]
    def ehr_get_by_subject(subject_id, subject_namespace, opts = {})
      data, _status_code, _headers = ehr_get_by_subject_with_http_info(subject_id, subject_namespace, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Ehr, Integer, Hash)>] Ehr data, response status code and response headers
    def ehr_get_by_subject_with_http_info(subject_id, subject_namespace, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EHRApi.ehr_get_by_subject ...'
      end
      # verify the required parameter 'subject_id' is set
      if @api_client.config.client_side_validation && subject_id.nil?
        fail ArgumentError, "Missing the required parameter 'subject_id' when calling EHRApi.ehr_get_by_subject"
      end
      # verify the required parameter 'subject_namespace' is set
      if @api_client.config.client_side_validation && subject_namespace.nil?
        fail ArgumentError, "Missing the required parameter 'subject_namespace' when calling EHRApi.ehr_get_by_subject"
      end
      # resource path
      local_var_path = '/ehr'
      ...
      query_params[:'subject_namespace'] = subject_namespace
      ...
      new_options = opts.merge(
        :operation => :"EHRApi.ehr_get_by_subject",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EHRApi#ehr_get_by_subject\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
