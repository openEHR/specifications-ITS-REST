...
module OpenapiClient
  class CONTRIBUTIONApi
    ...
    # @param new_contribution [NewContribution] The CONTRIBUTION. 
    ...
    # @return [Contribution]
    def contribution_create(ehr_id, new_contribution, opts = {})
      data, _status_code, _headers = contribution_create_with_http_info(ehr_id, new_contribution, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;.  (default to 'return=minimal')
    # @return [Array<(Contribution, Integer, Hash)>] Contribution data, response status code and response headers
    def contribution_create_with_http_info(ehr_id, new_contribution, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CONTRIBUTIONApi.contribution_create ...'
      end
      # verify the required parameter 'ehr_id' is set
      if @api_client.config.client_side_validation && ehr_id.nil?
        fail ArgumentError, "Missing the required parameter 'ehr_id' when calling CONTRIBUTIONApi.contribution_create"
      end
      # verify the required parameter 'new_contribution' is set
      if @api_client.config.client_side_validation && new_contribution.nil?
        fail ArgumentError, "Missing the required parameter 'new_contribution' when calling CONTRIBUTIONApi.contribution_create"
      end
      ...
      # resource path
      local_var_path = '/ehr/{ehr_id}/contribution'.sub('{' + 'ehr_id' + '}', CGI.escape(ehr_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(new_contribution)

      # return_type
      return_type = opts[:debug_return_type] || 'Contribution'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"CONTRIBUTIONApi.contribution_create",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CONTRIBUTIONApi#contribution_create\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param ehr_id [String] EHR identifier taken from EHR.ehr_id.value. 
    # @param contribution_uid [String] The CONTRIBUTION uid. 
    # @param [Hash] opts the optional parameters
    # @return [Contribution]
    def contribution_get(ehr_id, contribution_uid, opts = {})
      data, _status_code, _headers = contribution_get_with_http_info(ehr_id, contribution_uid, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Contribution, Integer, Hash)>] Contribution data, response status code and response headers
    def contribution_get_with_http_info(ehr_id, contribution_uid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CONTRIBUTIONApi.contribution_get ...'
      end
      # verify the required parameter 'ehr_id' is set
      if @api_client.config.client_side_validation && ehr_id.nil?
        fail ArgumentError, "Missing the required parameter 'ehr_id' when calling CONTRIBUTIONApi.contribution_get"
      end
      # verify the required parameter 'contribution_uid' is set
      if @api_client.config.client_side_validation && contribution_uid.nil?
        fail ArgumentError, "Missing the required parameter 'contribution_uid' when calling CONTRIBUTIONApi.contribution_get"
      end
      # resource path
      local_var_path = '/ehr/{ehr_id}/contribution/{contribution_uid}'.sub('{' + 'ehr_id' + '}', CGI.escape(ehr_id.to_s)).sub('{' + 'contribution_uid' + '}', CGI.escape(contribution_uid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"CONTRIBUTIONApi.contribution_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CONTRIBUTIONApi#contribution_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
