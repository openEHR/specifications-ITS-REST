...
module OpenapiClient
  class COMPOSITIONApi
    ...
    # @param ehr_id [String] EHR identifier taken from EHR.ehr_id.value. 
    # @param composition [Composition] The COMPOSITION. 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;.  (default to 'return=minimal')
    # @return [Composition]
    def composition_create(ehr_id, composition, opts = {})
      data, _status_code, _headers = composition_create_with_http_info(ehr_id, composition, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;.  (default to 'return=minimal')
    # @return [Array<(Composition, Integer, Hash)>] Composition data, response status code and response headers
    def composition_create_with_http_info(ehr_id, composition, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: COMPOSITIONApi.composition_create ...'
      end
      # verify the required parameter 'ehr_id' is set
      if @api_client.config.client_side_validation && ehr_id.nil?
        fail ArgumentError, "Missing the required parameter 'ehr_id' when calling COMPOSITIONApi.composition_create"
      end
      # verify the required parameter 'composition' is set
      if @api_client.config.client_side_validation && composition.nil?
        fail ArgumentError, "Missing the required parameter 'composition' when calling COMPOSITIONApi.composition_create"
      end
      allowable_values = ["return=representation", "return=minimal"]
      if @api_client.config.client_side_validation && opts[:'prefer'] && !allowable_values.include?(opts[:'prefer'])
        fail ArgumentError, "invalid value for \"prefer\", must be one of #{allowable_values}"
      end
      # resource path
      local_var_path = '/ehr/{ehr_id}/composition'.sub('{' + 'ehr_id' + '}', CGI.escape(ehr_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Composition'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"COMPOSITIONApi.composition_create",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: COMPOSITIONApi#composition_create\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param ehr_id [String] EHR identifier taken from EHR.ehr_id.value. 
    # @param uid_based_id [String] An identifier in a form of an OBJECT_VERSION_ID identifier taken from VERSION.uid.value (i.e. a &#x60;version_uid&#x60;). 
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def composition_delete(ehr_id, uid_based_id, opts = {})
      composition_delete_with_http_info(ehr_id, uid_based_id, opts)
      nil
    end
    ...
    def composition_delete_with_http_info(ehr_id, uid_based_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: COMPOSITIONApi.composition_delete ...'
      end
      # verify the required parameter 'ehr_id' is set
      if @api_client.config.client_side_validation && ehr_id.nil?
        fail ArgumentError, "Missing the required parameter 'ehr_id' when calling COMPOSITIONApi.composition_delete"
      end
      # verify the required parameter 'uid_based_id' is set
      if @api_client.config.client_side_validation && uid_based_id.nil?
        fail ArgumentError, "Missing the required parameter 'uid_based_id' when calling COMPOSITIONApi.composition_delete"
      end
      # resource path
      local_var_path = '/ehr/{ehr_id}/composition/{uid_based_id}'.sub('{' + 'ehr_id' + '}', CGI.escape(ehr_id.to_s)).sub('{' + 'uid_based_id' + '}', CGI.escape(uid_based_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"COMPOSITIONApi.composition_delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: COMPOSITIONApi#composition_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param ehr_id [String] EHR identifier taken from EHR.ehr_id.value. 
    # @param uid_based_id [String] An abstract identifier: it can take a form of an OBJECT_VERSION_ID identifier taken from VERSION.uid.value (i.e. a &#x60;version_uid&#x60;), or a form of a HIER_OBJECT_ID identifier taken from VERSIONED_OBJECT.uid.value (i.e. a &#x60;versioned_object_uid&#x60;). 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :version_at_time A given time in the extended ISO 8601 format. 
    # @return [Composition]
    def composition_get(ehr_id, uid_based_id, opts = {})
      data, _status_code, _headers = composition_get_with_http_info(ehr_id, uid_based_id, opts)
      data
    end
    ...
    # @option opts [String] :version_at_time A given time in the extended ISO 8601 format. 
    # @return [Array<(Composition, Integer, Hash)>] Composition data, response status code and response headers
    def composition_get_with_http_info(ehr_id, uid_based_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: COMPOSITIONApi.composition_get ...'
      end
      # verify the required parameter 'ehr_id' is set
      if @api_client.config.client_side_validation && ehr_id.nil?
        fail ArgumentError, "Missing the required parameter 'ehr_id' when calling COMPOSITIONApi.composition_get"
      end
      # verify the required parameter 'uid_based_id' is set
      if @api_client.config.client_side_validation && uid_based_id.nil?
        fail ArgumentError, "Missing the required parameter 'uid_based_id' when calling COMPOSITIONApi.composition_get"
      end
      # resource path
      local_var_path = '/ehr/{ehr_id}/composition/{uid_based_id}'.sub('{' + 'ehr_id' + '}', CGI.escape(ehr_id.to_s)).sub('{' + 'uid_based_id' + '}', CGI.escape(uid_based_id.to_s))
      ...
      # query parameters
      query_params = opts[:query_params] || {}
      query_params[:'version_at_time'] = opts[:'version_at_time'] if !opts[:'version_at_time'].nil?
      ...
      new_options = opts.merge(
        :operation => :"COMPOSITIONApi.composition_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: COMPOSITIONApi#composition_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param ehr_id [String] EHR identifier taken from EHR.ehr_id.value. 
    # @param uid_based_id [String] An identifier in a form of a HIER_OBJECT_ID identifier taken from VERSIONED_OBJECT.uid.value (i.e. a &#x60;versioned_object_uid&#x60;). 
    # @param if_match [String] Header to make the request conditional.  Together with &#x60;ETag&#x60; request tag, it helps to prevent simultaneous updates of a resource from overwriting each other (\&quot;mid-air collisions\&quot;). The format is always an &#x60;version_uid&#x60; identifier enclosed by double quotes. The operation will be performed only if the existing latest &#x60;version_uid&#x60; of the resource (i.e. the &#x60;preceding_version_uid&#x60;) matches this header&#39;s value. 
    # @param composition [Composition] The new COMPOSITION. 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;.  (default to 'return=minimal')
    # @return [Composition]
    def composition_update(ehr_id, uid_based_id, if_match, composition, opts = {})
      data, _status_code, _headers = composition_update_with_http_info(ehr_id, uid_based_id, if_match, composition, opts)
      data
    end
    ...
    # @option opts [String] :prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;.  (default to 'return=minimal')
    # @return [Array<(Composition, Integer, Hash)>] Composition data, response status code and response headers
    def composition_update_with_http_info(ehr_id, uid_based_id, if_match, composition, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: COMPOSITIONApi.composition_update ...'
      end
      # verify the required parameter 'ehr_id' is set
      if @api_client.config.client_side_validation && ehr_id.nil?
        fail ArgumentError, "Missing the required parameter 'ehr_id' when calling COMPOSITIONApi.composition_update"
      end
      # verify the required parameter 'uid_based_id' is set
      if @api_client.config.client_side_validation && uid_based_id.nil?
        fail ArgumentError, "Missing the required parameter 'uid_based_id' when calling COMPOSITIONApi.composition_update"
      end
      # verify the required parameter 'if_match' is set
      if @api_client.config.client_side_validation && if_match.nil?
        fail ArgumentError, "Missing the required parameter 'if_match' when calling COMPOSITIONApi.composition_update"
      end
      # verify the required parameter 'composition' is set
      if @api_client.config.client_side_validation && composition.nil?
        fail ArgumentError, "Missing the required parameter 'composition' when calling COMPOSITIONApi.composition_update"
      end
      allowable_values = ["return=representation", "return=minimal"]
      if @api_client.config.client_side_validation && opts[:'prefer'] && !allowable_values.include?(opts[:'prefer'])
        fail ArgumentError, "invalid value for \"prefer\", must be one of #{allowable_values}"
      ...
      new_options = opts.merge(
        :operation => :"COMPOSITIONApi.composition_update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: COMPOSITIONApi#composition_update\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param ehr_id [String] EHR identifier taken from EHR.ehr_id.value. 
    # @param versioned_object_uid [String] VERSIONED_COMPOSITION identifier taken from VERSIONED_COMPOSITION.uid.value. 
    # @param [Hash] opts the optional parameters
    # @return [VersionedComposition]
    def versioned_composition_get(ehr_id, versioned_object_uid, opts = {})
      data, _status_code, _headers = versioned_composition_get_with_http_info(ehr_id, versioned_object_uid, opts)
      data
    end
    ...
    # @param versioned_object_uid [String] VERSIONED_COMPOSITION identifier taken from VERSIONED_COMPOSITION.uid.value. 
    # @param [Hash] opts the optional parameters
    # @return [Array<(VersionedComposition, Integer, Hash)>] VersionedComposition data, response status code and response headers
    def versioned_composition_get_with_http_info(ehr_id, versioned_object_uid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: COMPOSITIONApi.versioned_composition_get ...'
      end
      # verify the required parameter 'ehr_id' is set
      if @api_client.config.client_side_validation && ehr_id.nil?
        fail ArgumentError, "Missing the required parameter 'ehr_id' when calling COMPOSITIONApi.versioned_composition_get"
      end
      # verify the required parameter 'versioned_object_uid' is set
      if @api_client.config.client_side_validation && versioned_object_uid.nil?
        fail ArgumentError, "Missing the required parameter 'versioned_object_uid' when calling COMPOSITIONApi.versioned_composition_get"
      end
      # resource path
      local_var_path = '/ehr/{ehr_id}/versioned_composition/{versioned_object_uid}'.sub('{' + 'ehr_id' + '}', CGI.escape(ehr_id.to_s)).sub('{' + 'versioned_object_uid' + '}', CGI.escape(versioned_object_uid.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'VersionedComposition'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"COMPOSITIONApi.versioned_composition_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: COMPOSITIONApi#versioned_composition_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def versioned_composition_revision_history(ehr_id, versioned_object_uid, opts = {})
      data, _status_code, _headers = versioned_composition_revision_history_with_http_info(ehr_id, versioned_object_uid, opts)
      data
    end
    ...
    # @param versioned_object_uid [String] VERSIONED_COMPOSITION identifier taken from VERSIONED_COMPOSITION.uid.value. 
    # @param [Hash] opts the optional parameters
    # @return [Array<(RevisionHistory, Integer, Hash)>] RevisionHistory data, response status code and response headers
    def versioned_composition_revision_history_with_http_info(ehr_id, versioned_object_uid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: COMPOSITIONApi.versioned_composition_revision_history ...'
      end
      # verify the required parameter 'ehr_id' is set
      if @api_client.config.client_side_validation && ehr_id.nil?
        fail ArgumentError, "Missing the required parameter 'ehr_id' when calling COMPOSITIONApi.versioned_composition_revision_history"
      end
      # verify the required parameter 'versioned_object_uid' is set
      if @api_client.config.client_side_validation && versioned_object_uid.nil?
        fail ArgumentError, "Missing the required parameter 'versioned_object_uid' when calling COMPOSITIONApi.versioned_composition_revision_history"
      end
      # resource path
      local_var_path = '/ehr/{ehr_id}/versioned_composition/{versioned_object_uid}/revision_history'.sub('{' + 'ehr_id' + '}', CGI.escape(ehr_id.to_s)).sub('{' + 'versioned_object_uid' + '}', CGI.escape(versioned_object_uid.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'RevisionHistory'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"COMPOSITIONApi.versioned_composition_revision_history",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: COMPOSITIONApi#versioned_composition_revision_history\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :version_at_time A given time in the extended ISO 8601 format. 
    # @return [Version]
    def versioned_composition_version_get_at_time(ehr_id, versioned_object_uid, opts = {})
      data, _status_code, _headers = versioned_composition_version_get_at_time_with_http_info(ehr_id, versioned_object_uid, opts)
      data
    end
    ...
    def versioned_composition_version_get_at_time_with_http_info(ehr_id, versioned_object_uid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: COMPOSITIONApi.versioned_composition_version_get_at_time ...'
      end
      # verify the required parameter 'ehr_id' is set
      if @api_client.config.client_side_validation && ehr_id.nil?
        fail ArgumentError, "Missing the required parameter 'ehr_id' when calling COMPOSITIONApi.versioned_composition_version_get_at_time"
      end
      # verify the required parameter 'versioned_object_uid' is set
      if @api_client.config.client_side_validation && versioned_object_uid.nil?
        fail ArgumentError, "Missing the required parameter 'versioned_object_uid' when calling COMPOSITIONApi.versioned_composition_version_get_at_time"
      end
      # resource path
      local_var_path = '/ehr/{ehr_id}/versioned_composition/{versioned_object_uid}/version'.sub('{' + 'ehr_id' + '}', CGI.escape(ehr_id.to_s)).sub('{' + 'versioned_object_uid' + '}', CGI.escape(versioned_object_uid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"COMPOSITIONApi.versioned_composition_version_get_at_time",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: COMPOSITIONApi#versioned_composition_version_get_at_time\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param ehr_id [String] EHR identifier taken from EHR.ehr_id.value. 
    # @param versioned_object_uid [String] VERSIONED_COMPOSITION identifier taken from VERSIONED_COMPOSITION.uid.value. 
    # @param version_uid [String] VERSION identifier taken from VERSION.uid.value. 
    # @param [Hash] opts the optional parameters
    # @return [Version]
    def versioned_composition_version_get_by_id(ehr_id, versioned_object_uid, version_uid, opts = {})
      data, _status_code, _headers = versioned_composition_version_get_by_id_with_http_info(ehr_id, versioned_object_uid, version_uid, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Version, Integer, Hash)>] Version data, response status code and response headers
    def versioned_composition_version_get_by_id_with_http_info(ehr_id, versioned_object_uid, version_uid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: COMPOSITIONApi.versioned_composition_version_get_by_id ...'
      end
      # verify the required parameter 'ehr_id' is set
      if @api_client.config.client_side_validation && ehr_id.nil?
        fail ArgumentError, "Missing the required parameter 'ehr_id' when calling COMPOSITIONApi.versioned_composition_version_get_by_id"
      end
      # verify the required parameter 'versioned_object_uid' is set
      if @api_client.config.client_side_validation && versioned_object_uid.nil?
        fail ArgumentError, "Missing the required parameter 'versioned_object_uid' when calling COMPOSITIONApi.versioned_composition_version_get_by_id"
      end
      # verify the required parameter 'version_uid' is set
      if @api_client.config.client_side_validation && version_uid.nil?
        fail ArgumentError, "Missing the required parameter 'version_uid' when calling COMPOSITIONApi.versioned_composition_version_get_by_id"
      end
      # resource path
      local_var_path = '/ehr/{ehr_id}/versioned_composition/{versioned_object_uid}/version/{version_uid}'.sub('{' + 'ehr_id' + '}', CGI.escape(ehr_id.to_s)).sub('{' + 'versioned_object_uid' + '}', CGI.escape(versioned_object_uid.to_s)).sub('{' + 'version_uid' + '}', CGI.escape(version_uid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"COMPOSITIONApi.versioned_composition_version_get_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: COMPOSITIONApi#versioned_composition_version_get_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
