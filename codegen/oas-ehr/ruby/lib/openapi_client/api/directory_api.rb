...
module OpenapiClient
  class DIRECTORYApi
    ...
    # @param folder [Folder] The directory. 
    ...
    # @return [Folder]
    def directory_create(ehr_id, folder, opts = {})
      data, _status_code, _headers = directory_create_with_http_info(ehr_id, folder, opts)
      data
    end
    ...
    def directory_create_with_http_info(ehr_id, folder, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DIRECTORYApi.directory_create ...'
      end
      # verify the required parameter 'ehr_id' is set
      if @api_client.config.client_side_validation && ehr_id.nil?
        fail ArgumentError, "Missing the required parameter 'ehr_id' when calling DIRECTORYApi.directory_create"
      end
      # verify the required parameter 'folder' is set
      if @api_client.config.client_side_validation && folder.nil?
        fail ArgumentError, "Missing the required parameter 'folder' when calling DIRECTORYApi.directory_create"
      end
      ...
      # resource path
      local_var_path = '/ehr/{ehr_id}/directory'.sub('{' + 'ehr_id' + '}', CGI.escape(ehr_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(folder)
      ...
      new_options = opts.merge(
        :operation => :"DIRECTORYApi.directory_create",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DIRECTORYApi#directory_create\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def directory_delete(ehr_id, if_match, opts = {})
      directory_delete_with_http_info(ehr_id, if_match, opts)
      nil
    end
    ...
    def directory_delete_with_http_info(ehr_id, if_match, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DIRECTORYApi.directory_delete ...'
      end
      # verify the required parameter 'ehr_id' is set
      if @api_client.config.client_side_validation && ehr_id.nil?
        fail ArgumentError, "Missing the required parameter 'ehr_id' when calling DIRECTORYApi.directory_delete"
      end
      # verify the required parameter 'if_match' is set
      if @api_client.config.client_side_validation && if_match.nil?
        fail ArgumentError, "Missing the required parameter 'if_match' when calling DIRECTORYApi.directory_delete"
      end
      # resource path
      local_var_path = '/ehr/{ehr_id}/directory'.sub('{' + 'ehr_id' + '}', CGI.escape(ehr_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"DIRECTORYApi.directory_delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DIRECTORYApi#directory_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :path A path to a sub-folder; consists of slash-separated values of the name attribute of FOLDERs in the directory. 
    # @return [Folder]
    def directory_get_at_time(ehr_id, opts = {})
      data, _status_code, _headers = directory_get_at_time_with_http_info(ehr_id, opts)
      data
    end
    ...
    # @option opts [String] :path A path to a sub-folder; consists of slash-separated values of the name attribute of FOLDERs in the directory. 
    # @return [Array<(Folder, Integer, Hash)>] Folder data, response status code and response headers
    def directory_get_at_time_with_http_info(ehr_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DIRECTORYApi.directory_get_at_time ...'
      end
      # verify the required parameter 'ehr_id' is set
      if @api_client.config.client_side_validation && ehr_id.nil?
        fail ArgumentError, "Missing the required parameter 'ehr_id' when calling DIRECTORYApi.directory_get_at_time"
      end
      # resource path
      local_var_path = '/ehr/{ehr_id}/directory'.sub('{' + 'ehr_id' + '}', CGI.escape(ehr_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"DIRECTORYApi.directory_get_at_time",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DIRECTORYApi#directory_get_at_time\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :path A path to a sub-folder; consists of slash-separated values of the name attribute of FOLDERs in the directory. 
    # @return [Folder]
    def directory_get_by_version_id(ehr_id, version_uid, opts = {})
      data, _status_code, _headers = directory_get_by_version_id_with_http_info(ehr_id, version_uid, opts)
      data
    end
    ...
    # @option opts [String] :path A path to a sub-folder; consists of slash-separated values of the name attribute of FOLDERs in the directory. 
    # @return [Array<(Folder, Integer, Hash)>] Folder data, response status code and response headers
    def directory_get_by_version_id_with_http_info(ehr_id, version_uid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DIRECTORYApi.directory_get_by_version_id ...'
      end
      # verify the required parameter 'ehr_id' is set
      if @api_client.config.client_side_validation && ehr_id.nil?
        fail ArgumentError, "Missing the required parameter 'ehr_id' when calling DIRECTORYApi.directory_get_by_version_id"
      end
      # verify the required parameter 'version_uid' is set
      if @api_client.config.client_side_validation && version_uid.nil?
        fail ArgumentError, "Missing the required parameter 'version_uid' when calling DIRECTORYApi.directory_get_by_version_id"
      end
      # resource path
      local_var_path = '/ehr/{ehr_id}/directory/{version_uid}'.sub('{' + 'ehr_id' + '}', CGI.escape(ehr_id.to_s)).sub('{' + 'version_uid' + '}', CGI.escape(version_uid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"DIRECTORYApi.directory_get_by_version_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DIRECTORYApi#directory_get_by_version_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param ehr_id [String] EHR identifier taken from EHR.ehr_id.value. 
    # @param if_match [String] Header to make the request conditional.  Together with &#x60;ETag&#x60; request tag, it helps to prevent simultaneous updates of a resource from overwriting each other (\&quot;mid-air collisions\&quot;). The format is always an &#x60;version_uid&#x60; identifier enclosed by double quotes. The operation will be performed only if the existing latest &#x60;version_uid&#x60; of the resource (i.e. the &#x60;preceding_version_uid&#x60;) matches this header&#39;s value. 
    # @param folder [Folder] The new directory. 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;.  (default to 'return=minimal')
    # @return [Folder]
    def directory_update(ehr_id, if_match, folder, opts = {})
      data, _status_code, _headers = directory_update_with_http_info(ehr_id, if_match, folder, opts)
      data
    end
    ...
    # @option opts [String] :prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;.  (default to 'return=minimal')
    # @return [Array<(Folder, Integer, Hash)>] Folder data, response status code and response headers
    def directory_update_with_http_info(ehr_id, if_match, folder, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DIRECTORYApi.directory_update ...'
      end
      # verify the required parameter 'ehr_id' is set
      if @api_client.config.client_side_validation && ehr_id.nil?
        fail ArgumentError, "Missing the required parameter 'ehr_id' when calling DIRECTORYApi.directory_update"
      end
      # verify the required parameter 'if_match' is set
      if @api_client.config.client_side_validation && if_match.nil?
        fail ArgumentError, "Missing the required parameter 'if_match' when calling DIRECTORYApi.directory_update"
      end
      # verify the required parameter 'folder' is set
      if @api_client.config.client_side_validation && folder.nil?
        fail ArgumentError, "Missing the required parameter 'folder' when calling DIRECTORYApi.directory_update"
      end
      allowable_values = ["return=representation", "return=minimal"]
      if @api_client.config.client_side_validation && opts[:'prefer'] && !allowable_values.include?(opts[:'prefer'])
        fail ArgumentError, "invalid value for \"prefer\", must be one of #{allowable_values}"
      ...
      new_options = opts.merge(
        :operation => :"DIRECTORYApi.directory_update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DIRECTORYApi#directory_update\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
