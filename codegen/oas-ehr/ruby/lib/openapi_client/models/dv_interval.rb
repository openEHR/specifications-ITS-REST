...
module OpenapiClient
  class DvInterval < DataValue
    ...
    attr_accessor :lower_unbounded

    attr_accessor :upper_unbounded

    attr_accessor :lower_included

    attr_accessor :upper_included
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::DvInterval` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::DvInterval`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'_type')
        ...
        self._type = 'DV_INTERVAL'
      end

      if attributes.key?(:'lower_unbounded')
        self.lower_unbounded = attributes[:'lower_unbounded']
      else
        self.lower_unbounded = nil
      end

      if attributes.key?(:'upper_unbounded')
        self.upper_unbounded = attributes[:'upper_unbounded']
      else
        self.upper_unbounded = nil
      end

      if attributes.key?(:'lower_included')
        self.lower_included = attributes[:'lower_included']
      else
        self.lower_included = nil
      end

      if attributes.key?(:'upper_included')
        self.upper_included = attributes[:'upper_included']
      else
        self.upper_included = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @lower_unbounded.nil?
        invalid_properties.push('invalid value for "lower_unbounded", lower_unbounded cannot be nil.')
      end

      if @upper_unbounded.nil?
        invalid_properties.push('invalid value for "upper_unbounded", upper_unbounded cannot be nil.')
      end

      if @lower_included.nil?
        invalid_properties.push('invalid value for "lower_included", lower_included cannot be nil.')
      end

      if @upper_included.nil?
        invalid_properties.push('invalid value for "upper_included", upper_included cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @lower_unbounded.nil?
      return false if @upper_unbounded.nil?
      return false if @lower_included.nil?
      return false if @upper_included.nil?
      true && super
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          _type == o._type &&
          lower_unbounded == o.lower_unbounded &&
          upper_unbounded == o.upper_unbounded &&
          lower_included == o.lower_included &&
          upper_included == o.upper_included && super(o)
    end
    ...
    def hash
      [_type, lower_unbounded, upper_unbounded, lower_included, upper_included].hash
    end
