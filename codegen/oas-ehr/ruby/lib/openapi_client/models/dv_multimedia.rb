...
module OpenapiClient
  class DvMultimedia < DvEncapsulated
    ...
    attr_accessor :integrity_check_algorithm
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::DvMultimedia` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::DvMultimedia`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'integrity_check_algorithm')
        self.integrity_check_algorithm = attributes[:'integrity_check_algorithm']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          integrity_check_algorithm == o.integrity_check_algorithm &&
    ...
    def hash
      [_type, alternate_text, uri, data, media_type, compression_algorithm, integrity_check, integrity_check_algorithm, thumbnail, size].hash
    end
