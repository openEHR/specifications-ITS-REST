  ...
  class EhrStatus < Versionable
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::EhrStatus` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::EhrStatus`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_queryable')
        self.is_queryable = attributes[:'is_queryable']
      else
      ...
      if attributes.key?(:'other_details')
        self.other_details = attributes[:'other_details']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @is_queryable.nil?
        invalid_properties.push('invalid value for "is_queryable", is_queryable cannot be nil.')
      end

      if @is_modifiable.nil?
        invalid_properties.push('invalid value for "is_modifiable", is_modifiable cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @is_queryable.nil?
      return false if @is_modifiable.nil?
      true && super
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          _type == o._type &&
          subject == o.subject &&
          is_queryable == o.is_queryable &&
          is_modifiable == o.is_modifiable &&
          other_details == o.other_details && super(o)
    end
    ...
    def hash
      [_type, subject, is_queryable, is_modifiable, other_details].hash
    end
