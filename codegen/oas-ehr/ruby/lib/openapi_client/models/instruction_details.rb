  ...
  class InstructionDetails < Pathable
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::InstructionDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::InstructionDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'_type')
        ...
        self._type = 'INSTRUCTION_DETAILS'
      end
      ...
      if attributes.key?(:'wf_details')
        self.wf_details = attributes[:'wf_details']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          wf_details == o.wf_details && super(o)
    end
    ...
    def hash
      [_type, instruction_id, activity_id, wf_details].hash
    end
