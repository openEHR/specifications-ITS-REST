...
module OpenapiClient
  class Element < Item
    ...
    attr_accessor :null_flavour

    attr_accessor :value

    attr_accessor :null_reason
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::Element` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::Element`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'null_flavour')
        self.null_flavour = attributes[:'null_flavour']
      end
      ...
      if attributes.key?(:'null_reason')
        self.null_reason = attributes[:'null_reason']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          _type == o._type &&
          null_flavour == o.null_flavour &&
          value == o.value &&
          null_reason == o.null_reason && super(o)
    end
    ...
    def hash
      [_type, null_flavour, value, null_reason].hash
    end
