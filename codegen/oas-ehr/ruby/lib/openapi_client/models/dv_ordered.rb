  ...
  class DvOrdered < DataValue
    ...
    def self.openapi_types
      {
        ...
        :'other_reference_ranges' => :'Array<ReferenceRange>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::DvOrdered` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::DvOrdered`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          other_reference_ranges == o.other_reference_ranges && super(o)
    end
    ...
    def hash
      [_type, normal_status, normal_range, other_reference_ranges].hash
    end
