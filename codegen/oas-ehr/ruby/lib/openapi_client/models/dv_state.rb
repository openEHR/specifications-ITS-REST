  ...
  class DvState < DataValue
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::DvState` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::DvState`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @is_terminal.nil?
        invalid_properties.push('invalid value for "is_terminal", is_terminal cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @is_terminal.nil?
      true && super
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          _type == o._type &&
          value == o.value &&
          is_terminal == o.is_terminal && super(o)
    end
