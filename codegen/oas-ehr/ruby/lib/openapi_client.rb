...
# Models
require 'openapi_client/models/archetyped'
require 'openapi_client/models/audit_details'
require 'openapi_client/models/code_phrase'
require 'openapi_client/models/contribution'
require 'openapi_client/models/data_value'
require 'openapi_client/models/ehr'
require 'openapi_client/models/error'
require 'openapi_client/models/feeder_audit'
require 'openapi_client/models/feeder_audit_details'
require 'openapi_client/models/link'
require 'openapi_client/models/locatable_ref'
require 'openapi_client/models/new_contribution'
require 'openapi_client/models/object_id'
require 'openapi_client/models/object_ref'
require 'openapi_client/models/participation'
require 'openapi_client/models/party_proxy'
require 'openapi_client/models/party_ref'
require 'openapi_client/models/pathable'
require 'openapi_client/models/reference_range'
require 'openapi_client/models/revision_history'
require 'openapi_client/models/revision_history_item'
require 'openapi_client/models/term_mapping'
require 'openapi_client/models/terminology_code'
require 'openapi_client/models/update_audit'
require 'openapi_client/models/update_version'
require 'openapi_client/models/version'
require 'openapi_client/models/versioned_object'
require 'openapi_client/models/abstract_entry'
require 'openapi_client/models/action'
require 'openapi_client/models/activity'
require 'openapi_client/models/admin_entry'
require 'openapi_client/models/archetype_id'
require 'openapi_client/models/attestation'
require 'openapi_client/models/care_entry'
require 'openapi_client/models/clstr'
require 'openapi_client/models/composition'
require 'openapi_client/models/content_item'
require 'openapi_client/models/data_structure'
require 'openapi_client/models/dv_amount'
require 'openapi_client/models/dv_boolean'
require 'openapi_client/models/dv_coded_text'
require 'openapi_client/models/dv_count'
require 'openapi_client/models/dv_date'
require 'openapi_client/models/dv_date_time'
require 'openapi_client/models/dv_duration'
require 'openapi_client/models/dv_ehr_uri'
require 'openapi_client/models/dv_encapsulated'
require 'openapi_client/models/dv_identifier'
require 'openapi_client/models/dv_interval'
require 'openapi_client/models/dv_interval_of_date_time'
require 'openapi_client/models/dv_multimedia'
require 'openapi_client/models/dv_ordered'
require 'openapi_client/models/dv_ordinal'
require 'openapi_client/models/dv_parsable'
require 'openapi_client/models/dv_proportion'
require 'openapi_client/models/dv_quantified'
require 'openapi_client/models/dv_quantity'
require 'openapi_client/models/dv_scale'
require 'openapi_client/models/dv_state'
require 'openapi_client/models/dv_temporal'
require 'openapi_client/models/dv_text'
require 'openapi_client/models/dv_time'
require 'openapi_client/models/dv_uri'
require 'openapi_client/models/ehr_status'
require 'openapi_client/models/element'
require 'openapi_client/models/evaluation'
require 'openapi_client/models/event'
require 'openapi_client/models/event_context'
require 'openapi_client/models/folder'
require 'openapi_client/models/generic_id'
require 'openapi_client/models/hier_object_id'
require 'openapi_client/models/history'
require 'openapi_client/models/imported_version'
require 'openapi_client/models/instruction'
require 'openapi_client/models/instruction_details'
require 'openapi_client/models/ism_transition'
require 'openapi_client/models/item'
require 'openapi_client/models/item_list'
require 'openapi_client/models/item_single'
require 'openapi_client/models/item_structure'
require 'openapi_client/models/item_table'
require 'openapi_client/models/item_tree'
require 'openapi_client/models/locatable'
require 'openapi_client/models/object_version_id'
require 'openapi_client/models/observation'
require 'openapi_client/models/original_version'
require 'openapi_client/models/party_identified'
require 'openapi_client/models/party_related'
require 'openapi_client/models/party_self'
require 'openapi_client/models/template_id'
require 'openapi_client/models/terminology_id'
require 'openapi_client/models/uid_based_id'
require 'openapi_client/models/update_attestation'
require 'openapi_client/models/versionable'
require 'openapi_client/models/versioned_composition'
require 'openapi_client/models/versioned_ehr_status'

# APIs
require 'openapi_client/api/composition_api'
require 'openapi_client/api/contribution_api'
require 'openapi_client/api/directory_api'
require 'openapi_client/api/ehr_api'
require 'openapi_client/api/ehrstatus_api'
