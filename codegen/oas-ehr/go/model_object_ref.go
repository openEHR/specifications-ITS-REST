...
// ObjectRef struct for ObjectRef
...
func (o *ObjectRef) UnmarshalJSON(bytes []byte) (err error) {
	...
	varObjectRef := _ObjectRef{}

	err = json.Unmarshal(bytes, &varObjectRef)

	if err != nil {
		return err
	}

	*o = ObjectRef(varObjectRef)
