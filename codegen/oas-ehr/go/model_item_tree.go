...
// checks if the ItemTree type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemTree{}
...
func (o ItemTree) MarshalJSON() ([]byte, error) {
...
type NullableItemTree struct {
	value *ItemTree
	isSet bool
}

func (v NullableItemTree) Get() *ItemTree {
	return v.value
}

func (v *NullableItemTree) Set(val *ItemTree) {
	v.value = val
	v.isSet = true
}

func (v NullableItemTree) IsSet() bool {
	return v.isSet
}

func (v *NullableItemTree) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemTree(val *ItemTree) *NullableItemTree {
	return &NullableItemTree{value: val, isSet: true}
}

func (v NullableItemTree) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemTree) UnmarshalJSON(src []byte) error {
	v.isSet = true
