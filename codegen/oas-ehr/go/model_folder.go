...
// SetItems gets a reference to the given []ObjectRef and assigns it to the Items field.
...
// SetDetails gets a reference to the given ItemStructure and assigns it to the Details field.
