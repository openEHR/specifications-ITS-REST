...
// checks if the CareEntry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CareEntry{}
...
// SetProtocol gets a reference to the given ItemStructure and assigns it to the Protocol field.
func (o *CareEntry) SetProtocol(v ItemStructure) {
	o.Protocol = &v
}

// GetGuidelineId returns the GuidelineId field value if set, zero value otherwise.
func (o *CareEntry) GetGuidelineId() ObjectRef {
	if o == nil || IsNil(o.GuidelineId) {
		var ret ObjectRef
		return ret
	}
	return *o.GuidelineId
}

// GetGuidelineIdOk returns a tuple with the GuidelineId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CareEntry) GetGuidelineIdOk() (*ObjectRef, bool) {
	if o == nil || IsNil(o.GuidelineId) {
		return nil, false
	}
	return o.GuidelineId, true
}
...
// SetGuidelineId gets a reference to the given ObjectRef and assigns it to the GuidelineId field.
func (o *CareEntry) SetGuidelineId(v ObjectRef) {
	o.GuidelineId = &v
}

func (o CareEntry) MarshalJSON() ([]byte, error) {
...
func (o CareEntry) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.GuidelineId) {
		toSerialize["guideline_id"] = o.GuidelineId
	}
	return toSerialize, nil
}

type NullableCareEntry struct {
	value *CareEntry
	isSet bool
}

func (v NullableCareEntry) Get() *CareEntry {
	return v.value
}

func (v *NullableCareEntry) Set(val *CareEntry) {
	v.value = val
	v.isSet = true
}

func (v NullableCareEntry) IsSet() bool {
	return v.isSet
}

func (v *NullableCareEntry) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCareEntry(val *CareEntry) *NullableCareEntry {
	return &NullableCareEntry{value: val, isSet: true}
}

func (v NullableCareEntry) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCareEntry) UnmarshalJSON(src []byte) error {
	v.isSet = true
