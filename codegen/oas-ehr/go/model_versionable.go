...
// checks if the Versionable type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Versionable{}

// Versionable A Versionable resource
...
func (o Versionable) MarshalJSON() ([]byte, error) {
...
func (o Versionable) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	return toSerialize, nil
}

type NullableVersionable struct {
	value *Versionable
	isSet bool
}

func (v NullableVersionable) Get() *Versionable {
	return v.value
}

func (v *NullableVersionable) Set(val *Versionable) {
	v.value = val
	v.isSet = true
}

func (v NullableVersionable) IsSet() bool {
	return v.isSet
}

func (v *NullableVersionable) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVersionable(val *Versionable) *NullableVersionable {
	return &NullableVersionable{value: val, isSet: true}
}

func (v NullableVersionable) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVersionable) UnmarshalJSON(src []byte) error {
	v.isSet = true
