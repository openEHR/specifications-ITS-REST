...
var _ MappedNullable = &AbstractEntry{}
...
// GetOtherParticipations returns the OtherParticipations field value if set, zero value otherwise.
func (o *AbstractEntry) GetOtherParticipations() []Participation {
	if o == nil || IsNil(o.OtherParticipations) {
		var ret []Participation
		return ret
	}
	return o.OtherParticipations
}

// GetOtherParticipationsOk returns a tuple with the OtherParticipations field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AbstractEntry) GetOtherParticipationsOk() ([]Participation, bool) {
	if o == nil || IsNil(o.OtherParticipations) {
		return nil, false
	}
	return o.OtherParticipations, true
}
...
// SetOtherParticipations gets a reference to the given []Participation and assigns it to the OtherParticipations field.
func (o *AbstractEntry) SetOtherParticipations(v []Participation) {
	o.OtherParticipations = v
}
...
// SetWorkflowId gets a reference to the given ObjectRef and assigns it to the WorkflowId field.
...
// SetProvider gets a reference to the given PartyProxy and assigns it to the Provider field.
func (o *AbstractEntry) SetProvider(v PartyProxy) {
	o.Provider = &v
}

func (o AbstractEntry) MarshalJSON() ([]byte, error) {
...
func (o AbstractEntry) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.OtherParticipations) {
		toSerialize["other_participations"] = o.OtherParticipations
	}
...
func (v NullableAbstractEntry) Get() *AbstractEntry {
	return v.value
}

func (v *NullableAbstractEntry) Set(val *AbstractEntry) {
	v.value = val
	v.isSet = true
}

func (v NullableAbstractEntry) IsSet() bool {
	return v.isSet
}

func (v *NullableAbstractEntry) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAbstractEntry(val *AbstractEntry) *NullableAbstractEntry {
	return &NullableAbstractEntry{value: val, isSet: true}
}

func (v NullableAbstractEntry) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAbstractEntry) UnmarshalJSON(src []byte) error {
	v.isSet = true
