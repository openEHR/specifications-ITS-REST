...
var _ MappedNullable = &DvCodedText{}
...
func NewDvCodedText(definingCode CodePhrase) *DvCodedText {
	this := DvCodedText{}
	var type_ string = "DV_CODED_TEXT"
	this.Type = &type_
	return &this
}
...
// GetDefiningCode returns the DefiningCode field value
func (o *DvCodedText) GetDefiningCode() CodePhrase {
	...
	return o.DefiningCode
}

// GetDefiningCodeOk returns a tuple with the DefiningCode field value
// and a boolean to check if the value has been set.
func (o *DvCodedText) GetDefiningCodeOk() (*CodePhrase, bool) {
	if o == nil {
		return nil, false
	}
	return &o.DefiningCode, true
}

// SetDefiningCode sets field value
func (o *DvCodedText) SetDefiningCode(v CodePhrase) {
	o.DefiningCode = v
}

func (o DvCodedText) MarshalJSON() ([]byte, error) {
...
func (v NullableDvCodedText) Get() *DvCodedText {
	return v.value
}

func (v *NullableDvCodedText) Set(val *DvCodedText) {
	v.value = val
	v.isSet = true
}

func (v NullableDvCodedText) IsSet() bool {
	return v.isSet
}

func (v *NullableDvCodedText) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDvCodedText(val *DvCodedText) *NullableDvCodedText {
	return &NullableDvCodedText{value: val, isSet: true}
}

func (v NullableDvCodedText) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDvCodedText) UnmarshalJSON(src []byte) error {
	v.isSet = true
