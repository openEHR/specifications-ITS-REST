...
// SetTiming gets a reference to the given DvParsable and assigns it to the Timing field.
func (o *Activity) SetTiming(v DvParsable) {
	o.Timing = &v
}

// GetActionArchetypeId returns the ActionArchetypeId field value
func (o *Activity) GetActionArchetypeId() string {
	...
	return o.ActionArchetypeId
}

// GetActionArchetypeIdOk returns a tuple with the ActionArchetypeId field value
// and a boolean to check if the value has been set.
func (o *Activity) GetActionArchetypeIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ActionArchetypeId, true
}

// SetActionArchetypeId sets field value
func (o *Activity) SetActionArchetypeId(v string) {
	o.ActionArchetypeId = v
}
