...
// checks if the TemplateId type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TemplateId{}

// TemplateId struct for TemplateId
type TemplateId struct {
	ObjectId
	Type *string `json:"_type,omitempty"`
}

type _TemplateId TemplateId
...
func (o TemplateId) MarshalJSON() ([]byte, error) {
...
func (o TemplateId) ToMap() (map[string]interface{}, error) {
...
func (o *TemplateId) UnmarshalJSON(bytes []byte) (err error) {
	...
	varTemplateId := _TemplateId{}

	err = json.Unmarshal(bytes, &varTemplateId)

	if err != nil {
		return err
	}

	*o = TemplateId(varTemplateId)

	return err
}

type NullableTemplateId struct {
	value *TemplateId
	isSet bool
}

func (v NullableTemplateId) Get() *TemplateId {
	return v.value
}

func (v *NullableTemplateId) Set(val *TemplateId) {
	v.value = val
	v.isSet = true
}

func (v NullableTemplateId) IsSet() bool {
	return v.isSet
}

func (v *NullableTemplateId) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTemplateId(val *TemplateId) *NullableTemplateId {
	return &NullableTemplateId{value: val, isSet: true}
}

func (v NullableTemplateId) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTemplateId) UnmarshalJSON(src []byte) error {
	v.isSet = true
