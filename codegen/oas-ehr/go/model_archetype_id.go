...
// checks if the ArchetypeId type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ArchetypeId{}

// ArchetypeId struct for ArchetypeId
type ArchetypeId struct {
	ObjectId
	Type *string `json:"_type,omitempty"`
}

type _ArchetypeId ArchetypeId

// NewArchetypeId instantiates a new ArchetypeId object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewArchetypeId(value string) *ArchetypeId {
	this := ArchetypeId{}
	var type_ string = "ARCHETYPE_ID"
	this.Type = &type_
	this.Value = value
	return &this
}
...
func (o ArchetypeId) MarshalJSON() ([]byte, error) {
...
func (o ArchetypeId) ToMap() (map[string]interface{}, error) {
...
func (o *ArchetypeId) UnmarshalJSON(bytes []byte) (err error) {
	...
	varArchetypeId := _ArchetypeId{}

	err = json.Unmarshal(bytes, &varArchetypeId)

	if err != nil {
		return err
	}

	*o = ArchetypeId(varArchetypeId)

	return err
}

type NullableArchetypeId struct {
	value *ArchetypeId
	isSet bool
}

func (v NullableArchetypeId) Get() *ArchetypeId {
	return v.value
}

func (v *NullableArchetypeId) Set(val *ArchetypeId) {
	v.value = val
	v.isSet = true
}

func (v NullableArchetypeId) IsSet() bool {
	return v.isSet
}

func (v *NullableArchetypeId) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableArchetypeId(val *ArchetypeId) *NullableArchetypeId {
	return &NullableArchetypeId{value: val, isSet: true}
}

func (v NullableArchetypeId) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableArchetypeId) UnmarshalJSON(src []byte) error {
	v.isSet = true
