...
// checks if the PartySelf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartySelf{}
...
func (o PartySelf) MarshalJSON() ([]byte, error) {
...
type NullablePartySelf struct {
	value *PartySelf
	isSet bool
}

func (v NullablePartySelf) Get() *PartySelf {
	return v.value
}

func (v *NullablePartySelf) Set(val *PartySelf) {
	v.value = val
	v.isSet = true
}

func (v NullablePartySelf) IsSet() bool {
	return v.isSet
}

func (v *NullablePartySelf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartySelf(val *PartySelf) *NullablePartySelf {
	return &NullablePartySelf{value: val, isSet: true}
}

func (v NullablePartySelf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartySelf) UnmarshalJSON(src []byte) error {
	v.isSet = true
