...
// checks if the DvTemporal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DvTemporal{}
...
// SetAccuracy gets a reference to the given DvDuration and assigns it to the Accuracy field.
func (o *DvTemporal) SetAccuracy(v DvDuration) {
	o.Accuracy = &v
}

func (o DvTemporal) MarshalJSON() ([]byte, error) {
...
type NullableDvTemporal struct {
	value *DvTemporal
	isSet bool
}

func (v NullableDvTemporal) Get() *DvTemporal {
	return v.value
}

func (v *NullableDvTemporal) Set(val *DvTemporal) {
	v.value = val
	v.isSet = true
}

func (v NullableDvTemporal) IsSet() bool {
	return v.isSet
}

func (v *NullableDvTemporal) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDvTemporal(val *DvTemporal) *NullableDvTemporal {
	return &NullableDvTemporal{value: val, isSet: true}
}

func (v NullableDvTemporal) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDvTemporal) UnmarshalJSON(src []byte) error {
	v.isSet = true
