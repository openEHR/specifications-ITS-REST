...
func (o DvDate) MarshalJSON() ([]byte, error) {
...
func (v NullableDvDate) Get() *DvDate {
	return v.value
}

func (v *NullableDvDate) Set(val *DvDate) {
	v.value = val
	v.isSet = true
}

func (v NullableDvDate) IsSet() bool {
	return v.isSet
}

func (v *NullableDvDate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDvDate(val *DvDate) *NullableDvDate {
	return &NullableDvDate{value: val, isSet: true}
}

func (v NullableDvDate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDvDate) UnmarshalJSON(src []byte) error {
	v.isSet = true
