...
var _ MappedNullable = &DvDateTime{}
...
func (o DvDateTime) MarshalJSON() ([]byte, error) {
...
func (v NullableDvDateTime) Get() *DvDateTime {
	return v.value
}

func (v *NullableDvDateTime) Set(val *DvDateTime) {
	v.value = val
	v.isSet = true
}

func (v NullableDvDateTime) IsSet() bool {
	return v.isSet
}

func (v *NullableDvDateTime) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDvDateTime(val *DvDateTime) *NullableDvDateTime {
	return &NullableDvDateTime{value: val, isSet: true}
}

func (v NullableDvDateTime) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDvDateTime) UnmarshalJSON(src []byte) error {
	v.isSet = true
