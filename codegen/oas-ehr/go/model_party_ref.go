...
// PartyRef Identifier for parties in a demographic or identity service.
...
func (o *PartyRef) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varPartyRef)
