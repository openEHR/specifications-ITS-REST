...
var _ MappedNullable = &OriginalVersion{}
...
func NewOriginalVersion(uid ObjectVersionId, lifecycleState DvCodedText, contribution ObjectRef, commitAudit AuditDetails, data Versionable) *OriginalVersion {
	this := OriginalVersion{}
	var type_ string = "ORIGINAL_VERSION"
	this.Type = &type_
...
// GetOtherInputVersionUids returns the OtherInputVersionUids field value if set, zero value otherwise.
func (o *OriginalVersion) GetOtherInputVersionUids() []ObjectVersionId {
	if o == nil || IsNil(o.OtherInputVersionUids) {
		var ret []ObjectVersionId
		return ret
	}
	return o.OtherInputVersionUids
}

// GetOtherInputVersionUidsOk returns a tuple with the OtherInputVersionUids field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OriginalVersion) GetOtherInputVersionUidsOk() ([]ObjectVersionId, bool) {
	if o == nil || IsNil(o.OtherInputVersionUids) {
		return nil, false
	}
	return o.OtherInputVersionUids, true
}
...
// SetOtherInputVersionUids gets a reference to the given []ObjectVersionId and assigns it to the OtherInputVersionUids field.
func (o *OriginalVersion) SetOtherInputVersionUids(v []ObjectVersionId) {
	o.OtherInputVersionUids = v
}
...
// SetAttestations gets a reference to the given []Attestation and assigns it to the Attestations field.
func (o *OriginalVersion) SetAttestations(v []Attestation) {
	o.Attestations = v
}

func (o OriginalVersion) MarshalJSON() ([]byte, error) {
...
func (o OriginalVersion) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.OtherInputVersionUids) {
		toSerialize["other_input_version_uids"] = o.OtherInputVersionUids
	}
...
func (v NullableOriginalVersion) Get() *OriginalVersion {
	return v.value
}

func (v *NullableOriginalVersion) Set(val *OriginalVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableOriginalVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableOriginalVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOriginalVersion(val *OriginalVersion) *NullableOriginalVersion {
	return &NullableOriginalVersion{value: val, isSet: true}
}

func (v NullableOriginalVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOriginalVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
