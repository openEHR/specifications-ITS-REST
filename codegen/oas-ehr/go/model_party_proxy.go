...
var _ MappedNullable = &PartyProxy{}

// PartyProxy struct for PartyProxy
...
// SetExternalRef gets a reference to the given PartyRef and assigns it to the ExternalRef field.
func (o *PartyProxy) SetExternalRef(v PartyRef) {
	o.ExternalRef = &v
}

func (o PartyProxy) MarshalJSON() ([]byte, error) {
...
func (o PartyProxy) ToMap() (map[string]interface{}, error) {
...
func (v NullablePartyProxy) Get() *PartyProxy {
	return v.value
}

func (v *NullablePartyProxy) Set(val *PartyProxy) {
	v.value = val
	v.isSet = true
}

func (v NullablePartyProxy) IsSet() bool {
	return v.isSet
}

func (v *NullablePartyProxy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartyProxy(val *PartyProxy) *NullablePartyProxy {
	return &NullablePartyProxy{value: val, isSet: true}
}

func (v NullablePartyProxy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartyProxy) UnmarshalJSON(src []byte) error {
	v.isSet = true
