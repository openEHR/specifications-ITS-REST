...
// checks if the NewContribution type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewContribution{}

// NewContribution A new (un-committed) CONTRIBUTION resource
type NewContribution struct {
	Uid *HierObjectId `json:"uid,omitempty"`
	Versions []UpdateVersion `json:"versions"`
	Audit UpdateAudit `json:"audit"`
}

type _NewContribution NewContribution
...
// SetUid gets a reference to the given HierObjectId and assigns it to the Uid field.
...
func (o NewContribution) MarshalJSON() ([]byte, error) {
...
func (o NewContribution) ToMap() (map[string]interface{}, error) {
...
func (o *NewContribution) UnmarshalJSON(bytes []byte) (err error) {
	...
	varNewContribution := _NewContribution{}

	err = json.Unmarshal(bytes, &varNewContribution)

	if err != nil {
		return err
	}

	*o = NewContribution(varNewContribution)

	return err
}

type NullableNewContribution struct {
	value *NewContribution
	isSet bool
}

func (v NullableNewContribution) Get() *NewContribution {
	return v.value
}

func (v *NullableNewContribution) Set(val *NewContribution) {
	v.value = val
	v.isSet = true
}

func (v NullableNewContribution) IsSet() bool {
	return v.isSet
}

func (v *NullableNewContribution) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewContribution(val *NewContribution) *NullableNewContribution {
	return &NullableNewContribution{value: val, isSet: true}
}

func (v NullableNewContribution) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewContribution) UnmarshalJSON(src []byte) error {
	v.isSet = true
