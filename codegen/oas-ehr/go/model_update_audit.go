...
var _ MappedNullable = &UpdateAudit{}

// UpdateAudit The set of attributes required to document the committal of an information item to a repository. Used by the server to create an AUDIT_DETAILS object.
type UpdateAudit struct {
	Type *string `json:"_type,omitempty"`
	ChangeType TerminologyCode `json:"change_type"`
...
// SetDescription gets a reference to the given DvText and assigns it to the Description field.
...
func (o UpdateAudit) MarshalJSON() ([]byte, error) {
...
func (o UpdateAudit) ToMap() (map[string]interface{}, error) {
...
func (v NullableUpdateAudit) Get() *UpdateAudit {
	return v.value
}

func (v *NullableUpdateAudit) Set(val *UpdateAudit) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateAudit) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateAudit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateAudit(val *UpdateAudit) *NullableUpdateAudit {
	return &NullableUpdateAudit{value: val, isSet: true}
}

func (v NullableUpdateAudit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateAudit) UnmarshalJSON(src []byte) error {
	v.isSet = true
