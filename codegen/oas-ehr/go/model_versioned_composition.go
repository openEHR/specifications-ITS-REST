...
var _ MappedNullable = &VersionedComposition{}
...
func NewVersionedComposition(uid HierObjectId, ownerId ObjectRef, timeCreated DvDateTime) *VersionedComposition {
	this := VersionedComposition{}
	var type_ string = "VERSIONED_COMPOSITION"
	this.Type = &type_
	this.Uid = uid
...
func (o VersionedComposition) MarshalJSON() ([]byte, error) {
...
type NullableVersionedComposition struct {
	value *VersionedComposition
	isSet bool
}

func (v NullableVersionedComposition) Get() *VersionedComposition {
	return v.value
}

func (v *NullableVersionedComposition) Set(val *VersionedComposition) {
	v.value = val
	v.isSet = true
}

func (v NullableVersionedComposition) IsSet() bool {
	return v.isSet
}

func (v *NullableVersionedComposition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVersionedComposition(val *VersionedComposition) *NullableVersionedComposition {
	return &NullableVersionedComposition{value: val, isSet: true}
}

func (v NullableVersionedComposition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVersionedComposition) UnmarshalJSON(src []byte) error {
	v.isSet = true
