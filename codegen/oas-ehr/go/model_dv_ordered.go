...
// checks if the DvOrdered type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DvOrdered{}
...
// GetNormalStatus returns the NormalStatus field value if set, zero value otherwise.
func (o *DvOrdered) GetNormalStatus() CodePhrase {
	if o == nil || IsNil(o.NormalStatus) {
		var ret CodePhrase
		return ret
	}
	return *o.NormalStatus
}

// GetNormalStatusOk returns a tuple with the NormalStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DvOrdered) GetNormalStatusOk() (*CodePhrase, bool) {
	if o == nil || IsNil(o.NormalStatus) {
		return nil, false
	}
	return o.NormalStatus, true
}
...
// SetNormalStatus gets a reference to the given CodePhrase and assigns it to the NormalStatus field.
func (o *DvOrdered) SetNormalStatus(v CodePhrase) {
	o.NormalStatus = &v
}

// GetNormalRange returns the NormalRange field value if set, zero value otherwise.
func (o *DvOrdered) GetNormalRange() DvInterval {
	if o == nil || IsNil(o.NormalRange) {
		var ret DvInterval
		return ret
	}
	return *o.NormalRange
}

// GetNormalRangeOk returns a tuple with the NormalRange field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DvOrdered) GetNormalRangeOk() (*DvInterval, bool) {
	if o == nil || IsNil(o.NormalRange) {
		return nil, false
	}
	return o.NormalRange, true
}
...
// SetNormalRange gets a reference to the given DvInterval and assigns it to the NormalRange field.
func (o *DvOrdered) SetNormalRange(v DvInterval) {
	o.NormalRange = &v
}

// GetOtherReferenceRanges returns the OtherReferenceRanges field value if set, zero value otherwise.
func (o *DvOrdered) GetOtherReferenceRanges() []ReferenceRange {
	if o == nil || IsNil(o.OtherReferenceRanges) {
		var ret []ReferenceRange
		return ret
	}
	return o.OtherReferenceRanges
}

// GetOtherReferenceRangesOk returns a tuple with the OtherReferenceRanges field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DvOrdered) GetOtherReferenceRangesOk() ([]ReferenceRange, bool) {
	if o == nil || IsNil(o.OtherReferenceRanges) {
		return nil, false
	}
	return o.OtherReferenceRanges, true
}
...
// SetOtherReferenceRanges gets a reference to the given []ReferenceRange and assigns it to the OtherReferenceRanges field.
func (o *DvOrdered) SetOtherReferenceRanges(v []ReferenceRange) {
	o.OtherReferenceRanges = v
}

func (o DvOrdered) MarshalJSON() ([]byte, error) {
...
func (o DvOrdered) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NormalStatus) {
		toSerialize["normal_status"] = o.NormalStatus
	}
	if !IsNil(o.NormalRange) {
		toSerialize["normal_range"] = o.NormalRange
	}
	if !IsNil(o.OtherReferenceRanges) {
		toSerialize["other_reference_ranges"] = o.OtherReferenceRanges
	}
	return toSerialize, nil
}

type NullableDvOrdered struct {
	value *DvOrdered
	isSet bool
}

func (v NullableDvOrdered) Get() *DvOrdered {
	return v.value
}

func (v *NullableDvOrdered) Set(val *DvOrdered) {
	v.value = val
	v.isSet = true
}

func (v NullableDvOrdered) IsSet() bool {
	return v.isSet
}

func (v *NullableDvOrdered) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDvOrdered(val *DvOrdered) *NullableDvOrdered {
	return &NullableDvOrdered{value: val, isSet: true}
}

func (v NullableDvOrdered) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDvOrdered) UnmarshalJSON(src []byte) error {
	v.isSet = true
