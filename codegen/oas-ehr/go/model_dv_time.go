...
// checks if the DvTime type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DvTime{}

// DvTime struct for DvTime
type DvTime struct {
	DvTemporal
...
func (o DvTime) MarshalJSON() ([]byte, error) {
...
func (o DvTime) ToMap() (map[string]interface{}, error) {
...
func (o *DvTime) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varDvTime)
...
type NullableDvTime struct {
	value *DvTime
	isSet bool
}

func (v NullableDvTime) Get() *DvTime {
	return v.value
}

func (v *NullableDvTime) Set(val *DvTime) {
	v.value = val
	v.isSet = true
}

func (v NullableDvTime) IsSet() bool {
	return v.isSet
}

func (v *NullableDvTime) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDvTime(val *DvTime) *NullableDvTime {
	return &NullableDvTime{value: val, isSet: true}
}

func (v NullableDvTime) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDvTime) UnmarshalJSON(src []byte) error {
	v.isSet = true
