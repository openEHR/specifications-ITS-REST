...
var _ MappedNullable = &DvInterval{}
...
// GetLowerUnbounded returns the LowerUnbounded field value
func (o *DvInterval) GetLowerUnbounded() bool {
	...
	return o.LowerUnbounded
}

// GetLowerUnboundedOk returns a tuple with the LowerUnbounded field value
// and a boolean to check if the value has been set.
func (o *DvInterval) GetLowerUnboundedOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.LowerUnbounded, true
}

// SetLowerUnbounded sets field value
func (o *DvInterval) SetLowerUnbounded(v bool) {
	o.LowerUnbounded = v
}

// GetUpperUnbounded returns the UpperUnbounded field value
func (o *DvInterval) GetUpperUnbounded() bool {
	...
	return o.UpperUnbounded
}

// GetUpperUnboundedOk returns a tuple with the UpperUnbounded field value
// and a boolean to check if the value has been set.
func (o *DvInterval) GetUpperUnboundedOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.UpperUnbounded, true
}

// SetUpperUnbounded sets field value
func (o *DvInterval) SetUpperUnbounded(v bool) {
	o.UpperUnbounded = v
}

// GetLowerIncluded returns the LowerIncluded field value
func (o *DvInterval) GetLowerIncluded() bool {
	...
	return o.LowerIncluded
}

// GetLowerIncludedOk returns a tuple with the LowerIncluded field value
// and a boolean to check if the value has been set.
func (o *DvInterval) GetLowerIncludedOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.LowerIncluded, true
}

// SetLowerIncluded sets field value
func (o *DvInterval) SetLowerIncluded(v bool) {
	o.LowerIncluded = v
}

// GetUpperIncluded returns the UpperIncluded field value
func (o *DvInterval) GetUpperIncluded() bool {
	...
	return o.UpperIncluded
}

// GetUpperIncludedOk returns a tuple with the UpperIncluded field value
// and a boolean to check if the value has been set.
func (o *DvInterval) GetUpperIncludedOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.UpperIncluded, true
}

// SetUpperIncluded sets field value
func (o *DvInterval) SetUpperIncluded(v bool) {
	o.UpperIncluded = v
}

func (o DvInterval) MarshalJSON() ([]byte, error) {
...
func (o DvInterval) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["lower_unbounded"] = o.LowerUnbounded
	toSerialize["upper_unbounded"] = o.UpperUnbounded
...
func (v NullableDvInterval) Get() *DvInterval {
	return v.value
}

func (v *NullableDvInterval) Set(val *DvInterval) {
	v.value = val
	v.isSet = true
}

func (v NullableDvInterval) IsSet() bool {
	return v.isSet
}

func (v *NullableDvInterval) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDvInterval(val *DvInterval) *NullableDvInterval {
	return &NullableDvInterval{value: val, isSet: true}
}

func (v NullableDvInterval) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDvInterval) UnmarshalJSON(src []byte) error {
	v.isSet = true
