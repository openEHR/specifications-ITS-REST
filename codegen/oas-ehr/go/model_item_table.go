...
// checks if the ItemTable type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemTable{}

// ItemTable struct for ItemTable
type ItemTable struct {
	ItemStructure
	Type *string `json:"_type,omitempty"`
	Items []Clstr `json:"items,omitempty"`
}
...
// SetItems gets a reference to the given []Clstr and assigns it to the Items field.
func (o *ItemTable) SetItems(v []Clstr) {
	o.Items = v
}

func (o ItemTable) MarshalJSON() ([]byte, error) {
...
func (o ItemTable) ToMap() (map[string]interface{}, error) {
...
type NullableItemTable struct {
	value *ItemTable
	isSet bool
}

func (v NullableItemTable) Get() *ItemTable {
	return v.value
}

func (v *NullableItemTable) Set(val *ItemTable) {
	v.value = val
	v.isSet = true
}

func (v NullableItemTable) IsSet() bool {
	return v.isSet
}

func (v *NullableItemTable) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemTable(val *ItemTable) *NullableItemTable {
	return &NullableItemTable{value: val, isSet: true}
}

func (v NullableItemTable) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemTable) UnmarshalJSON(src []byte) error {
	v.isSet = true
