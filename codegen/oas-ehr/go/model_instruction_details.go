...
var _ MappedNullable = &InstructionDetails{}
...
func NewInstructionDetails(instructionId LocatableRef, activityId string) *InstructionDetails {
	...
	var type_ string = "INSTRUCTION_DETAILS"
	this.Type = &type_
	return &this
}
...
// GetInstructionId returns the InstructionId field value
func (o *InstructionDetails) GetInstructionId() LocatableRef {
	if o == nil {
		var ret LocatableRef
		return ret
	}
...
// GetInstructionIdOk returns a tuple with the InstructionId field value
// and a boolean to check if the value has been set.
...
// SetInstructionId sets field value
...
// GetWfDetails returns the WfDetails field value if set, zero value otherwise.
func (o *InstructionDetails) GetWfDetails() ItemStructure {
	if o == nil || IsNil(o.WfDetails) {
...
// GetWfDetailsOk returns a tuple with the WfDetails field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InstructionDetails) GetWfDetailsOk() (*ItemStructure, bool) {
	if o == nil || IsNil(o.WfDetails) {
		return nil, false
	}
	return o.WfDetails, true
}
...
// SetWfDetails gets a reference to the given ItemStructure and assigns it to the WfDetails field.
func (o *InstructionDetails) SetWfDetails(v ItemStructure) {
	o.WfDetails = &v
}

func (o InstructionDetails) MarshalJSON() ([]byte, error) {
...
type NullableInstructionDetails struct {
	value *InstructionDetails
	isSet bool
}

func (v NullableInstructionDetails) Get() *InstructionDetails {
	return v.value
}

func (v *NullableInstructionDetails) Set(val *InstructionDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableInstructionDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableInstructionDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstructionDetails(val *InstructionDetails) *NullableInstructionDetails {
	return &NullableInstructionDetails{value: val, isSet: true}
}

func (v NullableInstructionDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstructionDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
