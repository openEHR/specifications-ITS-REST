...
var _ MappedNullable = &PartyRelated{}
...
func NewPartyRelated(relationship DvCodedText) *PartyRelated {
	this := PartyRelated{}
	var type_ string = "PARTY_RELATED"
	this.Type = &type_
	return &this
}
...
func (o PartyRelated) MarshalJSON() ([]byte, error) {
...
func (v NullablePartyRelated) Get() *PartyRelated {
	return v.value
}

func (v *NullablePartyRelated) Set(val *PartyRelated) {
	v.value = val
	v.isSet = true
}

func (v NullablePartyRelated) IsSet() bool {
	return v.isSet
}

func (v *NullablePartyRelated) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartyRelated(val *PartyRelated) *NullablePartyRelated {
	return &NullablePartyRelated{value: val, isSet: true}
}

func (v NullablePartyRelated) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartyRelated) UnmarshalJSON(src []byte) error {
	v.isSet = true
