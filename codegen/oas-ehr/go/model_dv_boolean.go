...
// checks if the DvBoolean type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DvBoolean{}

// DvBoolean struct for DvBoolean
...
func (o DvBoolean) MarshalJSON() ([]byte, error) {
...
func (o DvBoolean) ToMap() (map[string]interface{}, error) {
...
func (o *DvBoolean) UnmarshalJSON(bytes []byte) (err error) {
	...
	varDvBoolean := _DvBoolean{}

	err = json.Unmarshal(bytes, &varDvBoolean)

	if err != nil {
		return err
	}

	*o = DvBoolean(varDvBoolean)

	return err
}

type NullableDvBoolean struct {
	value *DvBoolean
	isSet bool
}

func (v NullableDvBoolean) Get() *DvBoolean {
	return v.value
}

func (v *NullableDvBoolean) Set(val *DvBoolean) {
	v.value = val
	v.isSet = true
}

func (v NullableDvBoolean) IsSet() bool {
	return v.isSet
}

func (v *NullableDvBoolean) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDvBoolean(val *DvBoolean) *NullableDvBoolean {
	return &NullableDvBoolean{value: val, isSet: true}
}

func (v NullableDvBoolean) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDvBoolean) UnmarshalJSON(src []byte) error {
	v.isSet = true
