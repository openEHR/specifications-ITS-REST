...
var _ MappedNullable = &GenericId{}
...
func NewGenericId(scheme string, value string) *GenericId {
	this := GenericId{}
	var type_ string = "GENERIC_ID"
	this.Type = &type_
	this.Value = value
	return &this
}
...
func (o GenericId) MarshalJSON() ([]byte, error) {
...
func (v NullableGenericId) Get() *GenericId {
	return v.value
}

func (v *NullableGenericId) Set(val *GenericId) {
	v.value = val
	v.isSet = true
}

func (v NullableGenericId) IsSet() bool {
	return v.isSet
}

func (v *NullableGenericId) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGenericId(val *GenericId) *NullableGenericId {
	return &NullableGenericId{value: val, isSet: true}
}

func (v NullableGenericId) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGenericId) UnmarshalJSON(src []byte) error {
	v.isSet = true
