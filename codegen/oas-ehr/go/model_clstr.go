...
func (o Clstr) MarshalJSON() ([]byte, error) {
...
func (v NullableClstr) Get() *Clstr {
	return v.value
}

func (v *NullableClstr) Set(val *Clstr) {
	v.value = val
	v.isSet = true
}

func (v NullableClstr) IsSet() bool {
	return v.isSet
}

func (v *NullableClstr) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClstr(val *Clstr) *NullableClstr {
	return &NullableClstr{value: val, isSet: true}
}

func (v NullableClstr) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClstr) UnmarshalJSON(src []byte) error {
	v.isSet = true
