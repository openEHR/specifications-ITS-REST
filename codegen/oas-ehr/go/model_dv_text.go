...
// SetHyperlink gets a reference to the given DvUri and assigns it to the Hyperlink field.
...
// SetFormatting gets a reference to the given string and assigns it to the Formatting field.
...
// SetMappings gets a reference to the given []TermMapping and assigns it to the Mappings field.
...
// SetEncoding gets a reference to the given CodePhrase and assigns it to the Encoding field.
func (o *DvText) SetEncoding(v CodePhrase) {
	o.Encoding = &v
}

func (o DvText) MarshalJSON() ([]byte, error) {
...
func (v NullableDvText) Get() *DvText {
	return v.value
}

func (v *NullableDvText) Set(val *DvText) {
	v.value = val
	v.isSet = true
}

func (v NullableDvText) IsSet() bool {
	return v.isSet
}

func (v *NullableDvText) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDvText(val *DvText) *NullableDvText {
	return &NullableDvText{value: val, isSet: true}
}

func (v NullableDvText) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDvText) UnmarshalJSON(src []byte) error {
	v.isSet = true
