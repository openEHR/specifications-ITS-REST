...
func NewAuditDetails(systemId string, timeCommitted DvDateTime, changeType DvCodedText, committer PartyProxy) *AuditDetails {
	this := AuditDetails{}
	var type_ string = "AUDIT_DETAILS"
	this.Type = &type_
...
// GetTimeCommitted returns the TimeCommitted field value
func (o *AuditDetails) GetTimeCommitted() DvDateTime {
	...
	return o.TimeCommitted
}

// GetTimeCommittedOk returns a tuple with the TimeCommitted field value
// and a boolean to check if the value has been set.
func (o *AuditDetails) GetTimeCommittedOk() (*DvDateTime, bool) {
	if o == nil {
		return nil, false
	}
	return &o.TimeCommitted, true
}

// SetTimeCommitted sets field value
...
func (o AuditDetails) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["time_committed"] = o.TimeCommitted
...
func (o *AuditDetails) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varAuditDetails)
