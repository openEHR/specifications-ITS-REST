...
// checks if the DvEhrUri type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DvEhrUri{}
...
func (o DvEhrUri) MarshalJSON() ([]byte, error) {
...
type NullableDvEhrUri struct {
	value *DvEhrUri
	isSet bool
}

func (v NullableDvEhrUri) Get() *DvEhrUri {
	return v.value
}

func (v *NullableDvEhrUri) Set(val *DvEhrUri) {
	v.value = val
	v.isSet = true
}

func (v NullableDvEhrUri) IsSet() bool {
	return v.isSet
}

func (v *NullableDvEhrUri) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDvEhrUri(val *DvEhrUri) *NullableDvEhrUri {
	return &NullableDvEhrUri{value: val, isSet: true}
}

func (v NullableDvEhrUri) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDvEhrUri) UnmarshalJSON(src []byte) error {
	v.isSet = true
