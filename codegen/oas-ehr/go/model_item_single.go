...
// checks if the ItemSingle type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemSingle{}

// ItemSingle struct for ItemSingle
...
func (o ItemSingle) MarshalJSON() ([]byte, error) {
...
func (o ItemSingle) ToMap() (map[string]interface{}, error) {
...
func (o *ItemSingle) UnmarshalJSON(bytes []byte) (err error) {
	...
	varItemSingle := _ItemSingle{}

	err = json.Unmarshal(bytes, &varItemSingle)

	if err != nil {
		return err
	}

	*o = ItemSingle(varItemSingle)

	return err
}

type NullableItemSingle struct {
	value *ItemSingle
	isSet bool
}

func (v NullableItemSingle) Get() *ItemSingle {
	return v.value
}

func (v *NullableItemSingle) Set(val *ItemSingle) {
	v.value = val
	v.isSet = true
}

func (v NullableItemSingle) IsSet() bool {
	return v.isSet
}

func (v *NullableItemSingle) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemSingle(val *ItemSingle) *NullableItemSingle {
	return &NullableItemSingle{value: val, isSet: true}
}

func (v NullableItemSingle) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemSingle) UnmarshalJSON(src []byte) error {
	v.isSet = true
