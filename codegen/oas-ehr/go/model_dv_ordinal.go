...
var _ MappedNullable = &DvOrdinal{}
...
func (o DvOrdinal) MarshalJSON() ([]byte, error) {
...
func (v NullableDvOrdinal) Get() *DvOrdinal {
	return v.value
}

func (v *NullableDvOrdinal) Set(val *DvOrdinal) {
	v.value = val
	v.isSet = true
}

func (v NullableDvOrdinal) IsSet() bool {
	return v.isSet
}

func (v *NullableDvOrdinal) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDvOrdinal(val *DvOrdinal) *NullableDvOrdinal {
	return &NullableDvOrdinal{value: val, isSet: true}
}

func (v NullableDvOrdinal) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDvOrdinal) UnmarshalJSON(src []byte) error {
	v.isSet = true
