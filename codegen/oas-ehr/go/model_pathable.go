...
// checks if the Pathable type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Pathable{}

// Pathable struct for Pathable
...
func (o Pathable) MarshalJSON() ([]byte, error) {
...
func (o Pathable) ToMap() (map[string]interface{}, error) {
...
type NullablePathable struct {
	value *Pathable
	isSet bool
}

func (v NullablePathable) Get() *Pathable {
	return v.value
}

func (v *NullablePathable) Set(val *Pathable) {
	v.value = val
	v.isSet = true
}

func (v NullablePathable) IsSet() bool {
	return v.isSet
}

func (v *NullablePathable) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePathable(val *Pathable) *NullablePathable {
	return &NullablePathable{value: val, isSet: true}
}

func (v NullablePathable) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePathable) UnmarshalJSON(src []byte) error {
	v.isSet = true
