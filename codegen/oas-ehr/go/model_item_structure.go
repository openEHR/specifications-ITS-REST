...
// checks if the ItemStructure type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemStructure{}
...
func (o ItemStructure) MarshalJSON() ([]byte, error) {
...
type NullableItemStructure struct {
	value *ItemStructure
	isSet bool
}

func (v NullableItemStructure) Get() *ItemStructure {
	return v.value
}

func (v *NullableItemStructure) Set(val *ItemStructure) {
	v.value = val
	v.isSet = true
}

func (v NullableItemStructure) IsSet() bool {
	return v.isSet
}

func (v *NullableItemStructure) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemStructure(val *ItemStructure) *NullableItemStructure {
	return &NullableItemStructure{value: val, isSet: true}
}

func (v NullableItemStructure) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemStructure) UnmarshalJSON(src []byte) error {
	v.isSet = true
