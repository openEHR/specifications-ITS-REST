...
// checks if the TerminologyCode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TerminologyCode{}

// TerminologyCode struct for TerminologyCode
...
type _TerminologyCode TerminologyCode
...
// GetTerminologyId returns the TerminologyId field value
...
// GetTerminologyIdOk returns a tuple with the TerminologyId field value
...
// SetTerminologyId sets field value
...
// GetCodeString returns the CodeString field value
...
// GetCodeStringOk returns a tuple with the CodeString field value
// and a boolean to check if the value has been set.
...
// SetCodeString sets field value
...
func (o TerminologyCode) MarshalJSON() ([]byte, error) {
...
func (o TerminologyCode) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["terminology_id"] = o.TerminologyId
	if !IsNil(o.TerminologyVersion) {
		toSerialize["terminology_version"] = o.TerminologyVersion
	}
	toSerialize["code_string"] = o.CodeString
	if !IsNil(o.Uri) {
...
func (o *TerminologyCode) UnmarshalJSON(bytes []byte) (err error) {
	...
	varTerminologyCode := _TerminologyCode{}

	err = json.Unmarshal(bytes, &varTerminologyCode)

	if err != nil {
		return err
	}

	*o = TerminologyCode(varTerminologyCode)

	return err
}

type NullableTerminologyCode struct {
	value *TerminologyCode
	isSet bool
}

func (v NullableTerminologyCode) Get() *TerminologyCode {
	return v.value
}

func (v *NullableTerminologyCode) Set(val *TerminologyCode) {
	v.value = val
	v.isSet = true
}

func (v NullableTerminologyCode) IsSet() bool {
	return v.isSet
}

func (v *NullableTerminologyCode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTerminologyCode(val *TerminologyCode) *NullableTerminologyCode {
	return &NullableTerminologyCode{value: val, isSet: true}
}

func (v NullableTerminologyCode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTerminologyCode) UnmarshalJSON(src []byte) error {
	v.isSet = true
