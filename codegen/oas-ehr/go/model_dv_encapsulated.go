...
// checks if the DvEncapsulated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DvEncapsulated{}

// DvEncapsulated struct for DvEncapsulated
...
type _DvEncapsulated DvEncapsulated
...
func NewDvEncapsulatedWithDefaults() *DvEncapsulated {
	this := DvEncapsulated{}
	var type_ string = "DV_ENCAPSULATED"
	this.Type = type_
	return &this
}
...
// SetCharset gets a reference to the given CodePhrase and assigns it to the Charset field.
...
// SetLanguage gets a reference to the given CodePhrase and assigns it to the Language field.
func (o *DvEncapsulated) SetLanguage(v CodePhrase) {
	o.Language = &v
}

func (o DvEncapsulated) MarshalJSON() ([]byte, error) {
...
func (o DvEncapsulated) ToMap() (map[string]interface{}, error) {
...
func (o *DvEncapsulated) UnmarshalJSON(bytes []byte) (err error) {
	...
	varDvEncapsulated := _DvEncapsulated{}

	err = json.Unmarshal(bytes, &varDvEncapsulated)

	if err != nil {
		return err
	}

	*o = DvEncapsulated(varDvEncapsulated)

	return err
}

type NullableDvEncapsulated struct {
	value *DvEncapsulated
	isSet bool
}

func (v NullableDvEncapsulated) Get() *DvEncapsulated {
	return v.value
}

func (v *NullableDvEncapsulated) Set(val *DvEncapsulated) {
	v.value = val
	v.isSet = true
}

func (v NullableDvEncapsulated) IsSet() bool {
	return v.isSet
}

func (v *NullableDvEncapsulated) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDvEncapsulated(val *DvEncapsulated) *NullableDvEncapsulated {
	return &NullableDvEncapsulated{value: val, isSet: true}
}

func (v NullableDvEncapsulated) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDvEncapsulated) UnmarshalJSON(src []byte) error {
	v.isSet = true
