...
var _ MappedNullable = &TerminologyId{}
...
func NewTerminologyId(value string) *TerminologyId {
	this := TerminologyId{}
	var type_ string = "TERMINOLOGY_ID"
	this.Type = &type_
	this.Value = value
	return &this
}
...
func (o TerminologyId) MarshalJSON() ([]byte, error) {
...
func (v NullableTerminologyId) Get() *TerminologyId {
	return v.value
}

func (v *NullableTerminologyId) Set(val *TerminologyId) {
	v.value = val
	v.isSet = true
}

func (v NullableTerminologyId) IsSet() bool {
	return v.isSet
}

func (v *NullableTerminologyId) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTerminologyId(val *TerminologyId) *NullableTerminologyId {
	return &NullableTerminologyId{value: val, isSet: true}
}

func (v NullableTerminologyId) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTerminologyId) UnmarshalJSON(src []byte) error {
	v.isSet = true
