...
// checks if the TermMapping type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TermMapping{}

// TermMapping struct for TermMapping
...
// SetPurpose gets a reference to the given DvCodedText and assigns it to the Purpose field.
...
func (o TermMapping) MarshalJSON() ([]byte, error) {
...
func (o TermMapping) ToMap() (map[string]interface{}, error) {
...
func (o *TermMapping) UnmarshalJSON(bytes []byte) (err error) {
	...
	varTermMapping := _TermMapping{}

	err = json.Unmarshal(bytes, &varTermMapping)

	if err != nil {
		return err
	}

	*o = TermMapping(varTermMapping)

	return err
}

type NullableTermMapping struct {
	value *TermMapping
	isSet bool
}

func (v NullableTermMapping) Get() *TermMapping {
	return v.value
}

func (v *NullableTermMapping) Set(val *TermMapping) {
	v.value = val
	v.isSet = true
}

func (v NullableTermMapping) IsSet() bool {
	return v.isSet
}

func (v *NullableTermMapping) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTermMapping(val *TermMapping) *NullableTermMapping {
	return &NullableTermMapping{value: val, isSet: true}
}

func (v NullableTermMapping) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTermMapping) UnmarshalJSON(src []byte) error {
	v.isSet = true
