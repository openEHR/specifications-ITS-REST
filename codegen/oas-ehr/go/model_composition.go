...
// GetTerritory returns the Territory field value
...
// GetTerritoryOk returns a tuple with the Territory field value
// and a boolean to check if the value has been set.
...
// GetComposer returns the Composer field value
...
// GetComposerOk returns a tuple with the Composer field value
// and a boolean to check if the value has been set.
