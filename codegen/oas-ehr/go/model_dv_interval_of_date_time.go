...
// checks if the DvIntervalOfDateTime type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DvIntervalOfDateTime{}
...
// SetLower gets a reference to the given DvDateTime and assigns it to the Lower field.
...
// SetUpper gets a reference to the given DvDateTime and assigns it to the Upper field.
func (o *DvIntervalOfDateTime) SetUpper(v DvDateTime) {
	o.Upper = &v
}

func (o DvIntervalOfDateTime) MarshalJSON() ([]byte, error) {
...
type NullableDvIntervalOfDateTime struct {
	value *DvIntervalOfDateTime
	isSet bool
}

func (v NullableDvIntervalOfDateTime) Get() *DvIntervalOfDateTime {
	return v.value
}

func (v *NullableDvIntervalOfDateTime) Set(val *DvIntervalOfDateTime) {
	v.value = val
	v.isSet = true
}

func (v NullableDvIntervalOfDateTime) IsSet() bool {
	return v.isSet
}

func (v *NullableDvIntervalOfDateTime) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDvIntervalOfDateTime(val *DvIntervalOfDateTime) *NullableDvIntervalOfDateTime {
	return &NullableDvIntervalOfDateTime{value: val, isSet: true}
}

func (v NullableDvIntervalOfDateTime) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDvIntervalOfDateTime) UnmarshalJSON(src []byte) error {
	v.isSet = true
