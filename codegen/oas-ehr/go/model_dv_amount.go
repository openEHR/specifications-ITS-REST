...
// checks if the DvAmount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DvAmount{}

// DvAmount struct for DvAmount
...
// GetAccuracyIsPercent returns the AccuracyIsPercent field value if set, zero value otherwise.
func (o *DvAmount) GetAccuracyIsPercent() bool {
	if o == nil || IsNil(o.AccuracyIsPercent) {
		var ret bool
		return ret
	}
	return *o.AccuracyIsPercent
}

// GetAccuracyIsPercentOk returns a tuple with the AccuracyIsPercent field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DvAmount) GetAccuracyIsPercentOk() (*bool, bool) {
	if o == nil || IsNil(o.AccuracyIsPercent) {
		return nil, false
	}
	return o.AccuracyIsPercent, true
}
...
// SetAccuracyIsPercent gets a reference to the given bool and assigns it to the AccuracyIsPercent field.
func (o *DvAmount) SetAccuracyIsPercent(v bool) {
	o.AccuracyIsPercent = &v
}
...
func (o DvAmount) MarshalJSON() ([]byte, error) {
...
func (o DvAmount) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AccuracyIsPercent) {
		toSerialize["accuracy_is_percent"] = o.AccuracyIsPercent
	}
	if !IsNil(o.Accuracy) {
...
type NullableDvAmount struct {
	value *DvAmount
	isSet bool
}

func (v NullableDvAmount) Get() *DvAmount {
	return v.value
}

func (v *NullableDvAmount) Set(val *DvAmount) {
	v.value = val
	v.isSet = true
}

func (v NullableDvAmount) IsSet() bool {
	return v.isSet
}

func (v *NullableDvAmount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDvAmount(val *DvAmount) *NullableDvAmount {
	return &NullableDvAmount{value: val, isSet: true}
}

func (v NullableDvAmount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDvAmount) UnmarshalJSON(src []byte) error {
	v.isSet = true
