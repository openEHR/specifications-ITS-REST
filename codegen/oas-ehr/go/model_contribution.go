...
// checks if the Contribution type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Contribution{}
...
type _Contribution Contribution
...
func (o Contribution) MarshalJSON() ([]byte, error) {
...
func (o Contribution) ToMap() (map[string]interface{}, error) {
...
func (o *Contribution) UnmarshalJSON(bytes []byte) (err error) {
	...
	varContribution := _Contribution{}

	err = json.Unmarshal(bytes, &varContribution)

	if err != nil {
		return err
	}

	*o = Contribution(varContribution)

	return err
}

type NullableContribution struct {
	value *Contribution
	isSet bool
}

func (v NullableContribution) Get() *Contribution {
	return v.value
}

func (v *NullableContribution) Set(val *Contribution) {
	v.value = val
	v.isSet = true
}

func (v NullableContribution) IsSet() bool {
	return v.isSet
}

func (v *NullableContribution) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContribution(val *Contribution) *NullableContribution {
	return &NullableContribution{value: val, isSet: true}
}

func (v NullableContribution) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContribution) UnmarshalJSON(src []byte) error {
	v.isSet = true
