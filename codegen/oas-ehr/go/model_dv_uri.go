...
// checks if the DvUri type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DvUri{}

// DvUri struct for DvUri
type DvUri struct {
	DataValue
...
func (o DvUri) MarshalJSON() ([]byte, error) {
...
func (o DvUri) ToMap() (map[string]interface{}, error) {
...
func (o *DvUri) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varDvUri)
...
type NullableDvUri struct {
	value *DvUri
	isSet bool
}

func (v NullableDvUri) Get() *DvUri {
	return v.value
}

func (v *NullableDvUri) Set(val *DvUri) {
	v.value = val
	v.isSet = true
}

func (v NullableDvUri) IsSet() bool {
	return v.isSet
}

func (v *NullableDvUri) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDvUri(val *DvUri) *NullableDvUri {
	return &NullableDvUri{value: val, isSet: true}
}

func (v NullableDvUri) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDvUri) UnmarshalJSON(src []byte) error {
	v.isSet = true
