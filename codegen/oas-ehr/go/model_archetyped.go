...
// checks if the Archetyped type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Archetyped{}

// Archetyped struct for Archetyped
...
// GetArchetypeId returns the ArchetypeId field value
...
// GetArchetypeIdOk returns a tuple with the ArchetypeId field value
...
// SetArchetypeId sets field value
...
// SetTemplateId gets a reference to the given TemplateId and assigns it to the TemplateId field.
func (o *Archetyped) SetTemplateId(v TemplateId) {
	o.TemplateId = &v
}

// GetRmVersion returns the RmVersion field value
...
// GetRmVersionOk returns a tuple with the RmVersion field value
// and a boolean to check if the value has been set.
func (o *Archetyped) GetRmVersionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.RmVersion, true
}

// SetRmVersion sets field value
func (o *Archetyped) SetRmVersion(v string) {
	o.RmVersion = v
}

func (o Archetyped) MarshalJSON() ([]byte, error) {
...
func (o Archetyped) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["archetype_id"] = o.ArchetypeId
	if !IsNil(o.TemplateId) {
		toSerialize["template_id"] = o.TemplateId
	}
	toSerialize["rm_version"] = o.RmVersion
	return toSerialize, nil
}

func (o *Archetyped) UnmarshalJSON(bytes []byte) (err error) {
	...
	varArchetyped := _Archetyped{}

	err = json.Unmarshal(bytes, &varArchetyped)

	if err != nil {
		return err
	}

	*o = Archetyped(varArchetyped)

	return err
}

type NullableArchetyped struct {
	value *Archetyped
	isSet bool
}

func (v NullableArchetyped) Get() *Archetyped {
	return v.value
}

func (v *NullableArchetyped) Set(val *Archetyped) {
	v.value = val
	v.isSet = true
}

func (v NullableArchetyped) IsSet() bool {
	return v.isSet
}

func (v *NullableArchetyped) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableArchetyped(val *Archetyped) *NullableArchetyped {
	return &NullableArchetyped{value: val, isSet: true}
}

func (v NullableArchetyped) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableArchetyped) UnmarshalJSON(src []byte) error {
	v.isSet = true
