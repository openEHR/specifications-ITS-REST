...
// checks if the PartyIdentified type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartyIdentified{}
...
func NewPartyIdentified() *PartyIdentified {
	this := PartyIdentified{}
	var type_ string = "PARTY_IDENTIFIED"
	this.Type = &type_
	return &this
}
...
// SetIdentifiers gets a reference to the given []DvIdentifier and assigns it to the Identifiers field.
func (o *PartyIdentified) SetIdentifiers(v []DvIdentifier) {
	o.Identifiers = v
}

func (o PartyIdentified) MarshalJSON() ([]byte, error) {
...
type NullablePartyIdentified struct {
	value *PartyIdentified
	isSet bool
}

func (v NullablePartyIdentified) Get() *PartyIdentified {
	return v.value
}

func (v *NullablePartyIdentified) Set(val *PartyIdentified) {
	v.value = val
	v.isSet = true
}

func (v NullablePartyIdentified) IsSet() bool {
	return v.isSet
}

func (v *NullablePartyIdentified) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartyIdentified(val *PartyIdentified) *NullablePartyIdentified {
	return &NullablePartyIdentified{value: val, isSet: true}
}

func (v NullablePartyIdentified) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartyIdentified) UnmarshalJSON(src []byte) error {
	v.isSet = true
