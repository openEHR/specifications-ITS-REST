...
// checks if the Attestation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Attestation{}

// Attestation struct for Attestation
...
type _Attestation Attestation

// NewAttestation instantiates a new Attestation object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAttestation(reason DvText, isPending bool, systemId string, timeCommitted DvDateTime, changeType DvCodedText, committer PartyProxy) *Attestation {
	this := Attestation{}
	var type_ string = "ATTESTATION"
	this.Type = &type_
...
func (o Attestation) MarshalJSON() ([]byte, error) {
...
func (o Attestation) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	serializedAuditDetails, errAuditDetails := json.Marshal(o.AuditDetails)
	if errAuditDetails != nil {
		return map[string]interface{}{}, errAuditDetails
	}
	errAuditDetails = json.Unmarshal([]byte(serializedAuditDetails), &toSerialize)
	if errAuditDetails != nil {
		return map[string]interface{}{}, errAuditDetails
	}
	if !IsNil(o.Type) {
...
func (o *Attestation) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAttestation := _Attestation{}

	err = json.Unmarshal(bytes, &varAttestation)

	if err != nil {
		return err
	}

	*o = Attestation(varAttestation)

	return err
}

type NullableAttestation struct {
	value *Attestation
	isSet bool
}

func (v NullableAttestation) Get() *Attestation {
	return v.value
}

func (v *NullableAttestation) Set(val *Attestation) {
	v.value = val
	v.isSet = true
}

func (v NullableAttestation) IsSet() bool {
	return v.isSet
}

func (v *NullableAttestation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAttestation(val *Attestation) *NullableAttestation {
	return &NullableAttestation{value: val, isSet: true}
}

func (v NullableAttestation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAttestation) UnmarshalJSON(src []byte) error {
	v.isSet = true
