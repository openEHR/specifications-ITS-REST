...
var _ MappedNullable = &EhrStatus{}
...
func NewEhrStatusWithDefaults() *EhrStatus {
	...
	var type_ string = "EHR_STATUS"
	this.Type = &type_
	var isQueryable bool = true
	this.IsQueryable = isQueryable
	var isModifiable bool = true
...
// GetIsQueryable returns the IsQueryable field value
func (o *EhrStatus) GetIsQueryable() bool {
	...
	return o.IsQueryable
}

// GetIsQueryableOk returns a tuple with the IsQueryable field value
// and a boolean to check if the value has been set.
func (o *EhrStatus) GetIsQueryableOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.IsQueryable, true
}

// SetIsQueryable sets field value
...
func (o EhrStatus) MarshalJSON() ([]byte, error) {
...
func (o EhrStatus) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["is_queryable"] = o.IsQueryable
...
func (v NullableEhrStatus) Get() *EhrStatus {
	return v.value
}

func (v *NullableEhrStatus) Set(val *EhrStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableEhrStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableEhrStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEhrStatus(val *EhrStatus) *NullableEhrStatus {
	return &NullableEhrStatus{value: val, isSet: true}
}

func (v NullableEhrStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEhrStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
