...
// checks if the Ehr type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Ehr{}

// Ehr An EHR resource
type Ehr struct {
	SystemId *HierObjectId `json:"system_id,omitempty"`
	EhrId *HierObjectId `json:"ehr_id,omitempty"`
	EhrStatus *ObjectRef `json:"ehr_status,omitempty"`
	EhrAccess *ObjectRef `json:"ehr_access,omitempty"`
	TimeCreated *DvDateTime `json:"time_created,omitempty"`
}
...
// SetSystemId gets a reference to the given HierObjectId and assigns it to the SystemId field.
func (o *Ehr) SetSystemId(v HierObjectId) {
	o.SystemId = &v
}

// GetEhrId returns the EhrId field value if set, zero value otherwise.
func (o *Ehr) GetEhrId() HierObjectId {
	if o == nil || IsNil(o.EhrId) {
		var ret HierObjectId
		return ret
	}
	return *o.EhrId
...
// GetEhrIdOk returns a tuple with the EhrId field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetEhrId gets a reference to the given HierObjectId and assigns it to the EhrId field.
func (o *Ehr) SetEhrId(v HierObjectId) {
	o.EhrId = &v
}

// GetEhrStatus returns the EhrStatus field value if set, zero value otherwise.
func (o *Ehr) GetEhrStatus() ObjectRef {
	if o == nil || IsNil(o.EhrStatus) {
		var ret ObjectRef
		return ret
	}
	return *o.EhrStatus
...
// GetEhrStatusOk returns a tuple with the EhrStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Ehr) GetEhrStatusOk() (*ObjectRef, bool) {
	if o == nil || IsNil(o.EhrStatus) {
		return nil, false
	}
	return o.EhrStatus, true
}
...
// SetEhrStatus gets a reference to the given ObjectRef and assigns it to the EhrStatus field.
func (o *Ehr) SetEhrStatus(v ObjectRef) {
	o.EhrStatus = &v
}

// GetEhrAccess returns the EhrAccess field value if set, zero value otherwise.
func (o *Ehr) GetEhrAccess() ObjectRef {
	if o == nil || IsNil(o.EhrAccess) {
		var ret ObjectRef
		return ret
	}
	return *o.EhrAccess
...
// GetEhrAccessOk returns a tuple with the EhrAccess field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Ehr) GetEhrAccessOk() (*ObjectRef, bool) {
	if o == nil || IsNil(o.EhrAccess) {
		return nil, false
	}
	return o.EhrAccess, true
}
...
// SetEhrAccess gets a reference to the given ObjectRef and assigns it to the EhrAccess field.
...
// SetTimeCreated gets a reference to the given DvDateTime and assigns it to the TimeCreated field.
func (o *Ehr) SetTimeCreated(v DvDateTime) {
	o.TimeCreated = &v
}

func (o Ehr) MarshalJSON() ([]byte, error) {
...
func (o Ehr) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.SystemId) {
		toSerialize["system_id"] = o.SystemId
	}
	if !IsNil(o.EhrId) {
		toSerialize["ehr_id"] = o.EhrId
	}
	if !IsNil(o.EhrStatus) {
		toSerialize["ehr_status"] = o.EhrStatus
	}
	if !IsNil(o.EhrAccess) {
		toSerialize["ehr_access"] = o.EhrAccess
	}
...
type NullableEhr struct {
	value *Ehr
	isSet bool
}

func (v NullableEhr) Get() *Ehr {
	return v.value
}

func (v *NullableEhr) Set(val *Ehr) {
	v.value = val
	v.isSet = true
}

func (v NullableEhr) IsSet() bool {
	return v.isSet
}

func (v *NullableEhr) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEhr(val *Ehr) *NullableEhr {
	return &NullableEhr{value: val, isSet: true}
}

func (v NullableEhr) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEhr) UnmarshalJSON(src []byte) error {
	v.isSet = true
