...
// checks if the RevisionHistoryItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RevisionHistoryItem{}

// RevisionHistoryItem A REVISION_HISTORY_ITEM resource
type RevisionHistoryItem struct {
	VersionId ObjectVersionId `json:"version_id"`
	Audits []AuditDetails `json:"audits"`
}

type _RevisionHistoryItem RevisionHistoryItem
...
// GetAudits returns the Audits field value
...
// GetAuditsOk returns a tuple with the Audits field value
// and a boolean to check if the value has been set.
...
// SetAudits sets field value
func (o *RevisionHistoryItem) SetAudits(v []AuditDetails) {
	o.Audits = v
}

func (o RevisionHistoryItem) MarshalJSON() ([]byte, error) {
...
func (o RevisionHistoryItem) ToMap() (map[string]interface{}, error) {
...
func (o *RevisionHistoryItem) UnmarshalJSON(bytes []byte) (err error) {
	...
	varRevisionHistoryItem := _RevisionHistoryItem{}

	err = json.Unmarshal(bytes, &varRevisionHistoryItem)

	if err != nil {
		return err
	}

	*o = RevisionHistoryItem(varRevisionHistoryItem)

	return err
}

type NullableRevisionHistoryItem struct {
	value *RevisionHistoryItem
	isSet bool
}

func (v NullableRevisionHistoryItem) Get() *RevisionHistoryItem {
	return v.value
}

func (v *NullableRevisionHistoryItem) Set(val *RevisionHistoryItem) {
	v.value = val
	v.isSet = true
}

func (v NullableRevisionHistoryItem) IsSet() bool {
	return v.isSet
}

func (v *NullableRevisionHistoryItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRevisionHistoryItem(val *RevisionHistoryItem) *NullableRevisionHistoryItem {
	return &NullableRevisionHistoryItem{value: val, isSet: true}
}

func (v NullableRevisionHistoryItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRevisionHistoryItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
