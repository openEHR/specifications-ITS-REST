...
// SetPeriod gets a reference to the given DvDuration and assigns it to the Period field.
...
// SetDuration gets a reference to the given DvDuration and assigns it to the Duration field.
...
// SetSummary gets a reference to the given ItemStructure and assigns it to the Summary field.
