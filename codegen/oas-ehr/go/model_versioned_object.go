...
var _ MappedNullable = &VersionedObject{}

// VersionedObject struct for VersionedObject
...
func (o VersionedObject) MarshalJSON() ([]byte, error) {
...
func (o VersionedObject) ToMap() (map[string]interface{}, error) {
...
func (v NullableVersionedObject) Get() *VersionedObject {
	return v.value
}

func (v *NullableVersionedObject) Set(val *VersionedObject) {
	v.value = val
	v.isSet = true
}

func (v NullableVersionedObject) IsSet() bool {
	return v.isSet
}

func (v *NullableVersionedObject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVersionedObject(val *VersionedObject) *NullableVersionedObject {
	return &NullableVersionedObject{value: val, isSet: true}
}

func (v NullableVersionedObject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVersionedObject) UnmarshalJSON(src []byte) error {
	v.isSet = true
