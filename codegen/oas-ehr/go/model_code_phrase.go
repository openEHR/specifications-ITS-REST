...
var _ MappedNullable = &CodePhrase{}

// CodePhrase struct for CodePhrase
...
func (o CodePhrase) MarshalJSON() ([]byte, error) {
...
func (o CodePhrase) ToMap() (map[string]interface{}, error) {
...
func (v NullableCodePhrase) Get() *CodePhrase {
	return v.value
}

func (v *NullableCodePhrase) Set(val *CodePhrase) {
	v.value = val
	v.isSet = true
}

func (v NullableCodePhrase) IsSet() bool {
	return v.isSet
}

func (v *NullableCodePhrase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCodePhrase(val *CodePhrase) *NullableCodePhrase {
	return &NullableCodePhrase{value: val, isSet: true}
}

func (v NullableCodePhrase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCodePhrase) UnmarshalJSON(src []byte) error {
	v.isSet = true
