...
// checks if the FeederAuditDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FeederAuditDetails{}

// FeederAuditDetails struct for FeederAuditDetails
...
type _FeederAuditDetails FeederAuditDetails
...
// SetLocation gets a reference to the given PartyIdentified and assigns it to the Location field.
...
// SetSubject gets a reference to the given PartyProxy and assigns it to the Subject field.
...
// SetProvider gets a reference to the given PartyIdentified and assigns it to the Provider field.
...
// SetTime gets a reference to the given DvDateTime and assigns it to the Time field.
...
// GetOtherDetails returns the OtherDetails field value if set, zero value otherwise.
func (o *FeederAuditDetails) GetOtherDetails() ItemStructure {
	if o == nil || IsNil(o.OtherDetails) {
		var ret ItemStructure
		return ret
	}
	return *o.OtherDetails
}

// GetOtherDetailsOk returns a tuple with the OtherDetails field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FeederAuditDetails) GetOtherDetailsOk() (*ItemStructure, bool) {
	if o == nil || IsNil(o.OtherDetails) {
		return nil, false
	}
	return o.OtherDetails, true
}
...
// SetOtherDetails gets a reference to the given ItemStructure and assigns it to the OtherDetails field.
func (o *FeederAuditDetails) SetOtherDetails(v ItemStructure) {
	o.OtherDetails = &v
}

func (o FeederAuditDetails) MarshalJSON() ([]byte, error) {
...
func (o FeederAuditDetails) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.OtherDetails) {
		toSerialize["other_details"] = o.OtherDetails
	}
	return toSerialize, nil
}

func (o *FeederAuditDetails) UnmarshalJSON(bytes []byte) (err error) {
	...
	varFeederAuditDetails := _FeederAuditDetails{}

	err = json.Unmarshal(bytes, &varFeederAuditDetails)

	if err != nil {
		return err
	}

	*o = FeederAuditDetails(varFeederAuditDetails)

	return err
}

type NullableFeederAuditDetails struct {
	value *FeederAuditDetails
	isSet bool
}

func (v NullableFeederAuditDetails) Get() *FeederAuditDetails {
	return v.value
}

func (v *NullableFeederAuditDetails) Set(val *FeederAuditDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableFeederAuditDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableFeederAuditDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFeederAuditDetails(val *FeederAuditDetails) *NullableFeederAuditDetails {
	return &NullableFeederAuditDetails{value: val, isSet: true}
}

func (v NullableFeederAuditDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFeederAuditDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
