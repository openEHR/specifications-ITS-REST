...
var _ MappedNullable = &DvIdentifier{}
...
func (o DvIdentifier) MarshalJSON() ([]byte, error) {
...
func (v NullableDvIdentifier) Get() *DvIdentifier {
	return v.value
}

func (v *NullableDvIdentifier) Set(val *DvIdentifier) {
	v.value = val
	v.isSet = true
}

func (v NullableDvIdentifier) IsSet() bool {
	return v.isSet
}

func (v *NullableDvIdentifier) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDvIdentifier(val *DvIdentifier) *NullableDvIdentifier {
	return &NullableDvIdentifier{value: val, isSet: true}
}

func (v NullableDvIdentifier) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDvIdentifier) UnmarshalJSON(src []byte) error {
	v.isSet = true
