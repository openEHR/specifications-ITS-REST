...
// SetMode gets a reference to the given DvCodedText and assigns it to the Mode field.
func (o *Participation) SetMode(v DvCodedText) {
	o.Mode = &v
}

// GetPerformer returns the Performer field value
...
// GetPerformerOk returns a tuple with the Performer field value
// and a boolean to check if the value has been set.
...
// SetTime gets a reference to the given DvIntervalOfDateTime and assigns it to the Time field.
