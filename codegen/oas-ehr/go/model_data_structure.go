...
// checks if the DataStructure type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataStructure{}
...
func (o DataStructure) MarshalJSON() ([]byte, error) {
...
type NullableDataStructure struct {
	value *DataStructure
	isSet bool
}

func (v NullableDataStructure) Get() *DataStructure {
	return v.value
}

func (v *NullableDataStructure) Set(val *DataStructure) {
	v.value = val
	v.isSet = true
}

func (v NullableDataStructure) IsSet() bool {
	return v.isSet
}

func (v *NullableDataStructure) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataStructure(val *DataStructure) *NullableDataStructure {
	return &NullableDataStructure{value: val, isSet: true}
}

func (v NullableDataStructure) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataStructure) UnmarshalJSON(src []byte) error {
	v.isSet = true
