...
var _ MappedNullable = &LocatableRef{}

// LocatableRef struct for LocatableRef
...
func (o LocatableRef) MarshalJSON() ([]byte, error) {
...
func (o LocatableRef) ToMap() (map[string]interface{}, error) {
...
func (v NullableLocatableRef) Get() *LocatableRef {
	return v.value
}

func (v *NullableLocatableRef) Set(val *LocatableRef) {
	v.value = val
	v.isSet = true
}

func (v NullableLocatableRef) IsSet() bool {
	return v.isSet
}

func (v *NullableLocatableRef) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLocatableRef(val *LocatableRef) *NullableLocatableRef {
	return &NullableLocatableRef{value: val, isSet: true}
}

func (v NullableLocatableRef) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLocatableRef) UnmarshalJSON(src []byte) error {
	v.isSet = true
