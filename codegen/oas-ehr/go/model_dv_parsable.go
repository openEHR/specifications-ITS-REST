...
var _ MappedNullable = &DvParsable{}
...
// GetFormalism returns the Formalism field value
...
// GetFormalismOk returns a tuple with the Formalism field value
// and a boolean to check if the value has been set.
func (o *DvParsable) GetFormalismOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Formalism, true
}

// SetFormalism sets field value
func (o *DvParsable) SetFormalism(v string) {
	o.Formalism = v
}

func (o DvParsable) MarshalJSON() ([]byte, error) {
...
func (v NullableDvParsable) Get() *DvParsable {
	return v.value
}

func (v *NullableDvParsable) Set(val *DvParsable) {
	v.value = val
	v.isSet = true
}

func (v NullableDvParsable) IsSet() bool {
	return v.isSet
}

func (v *NullableDvParsable) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDvParsable(val *DvParsable) *NullableDvParsable {
	return &NullableDvParsable{value: val, isSet: true}
}

func (v NullableDvParsable) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDvParsable) UnmarshalJSON(src []byte) error {
	v.isSet = true
