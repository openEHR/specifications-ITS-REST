...
type CONTRIBUTIONAPI interface {
	...
	/*
	ContributionCreate Create CONTRIBUTION
  ...
  - `audit.system_id`: when provided, it will be validated
	...
	@return ApiContributionCreateRequest
	*/
	ContributionCreate(ctx context.Context, ehrId string) ApiContributionCreateRequest

	// ContributionCreateExecute executes the request
	//  @return Contribution
	ContributionCreateExecute(r ApiContributionCreateRequest) (*Contribution, *http.Response, error)

	/*
	ContributionGet Get CONTRIBUTION by id
	...
	@return ApiContributionGetRequest
	*/
	ContributionGet(ctx context.Context, ehrId string, contributionUid string) ApiContributionGetRequest

	// ContributionGetExecute executes the request
	//  @return Contribution
	ContributionGetExecute(r ApiContributionGetRequest) (*Contribution, *http.Response, error)
}

// CONTRIBUTIONAPIService CONTRIBUTIONAPI service
type CONTRIBUTIONAPIService service

type ApiContributionCreateRequest struct {
	ctx context.Context
	ApiService CONTRIBUTIONAPI
	ehrId string
...
// The CONTRIBUTION. 
func (r ApiContributionCreateRequest) NewContribution(newContribution NewContribution) ApiContributionCreateRequest {
	r.newContribution = &newContribution
	return r
}
...
func (r ApiContributionCreateRequest) Prefer(prefer string) ApiContributionCreateRequest {
	r.prefer = &prefer
	return r
}

func (r ApiContributionCreateRequest) Execute() (*Contribution, *http.Response, error) {
	return r.ApiService.ContributionCreateExecute(r)
}
...
We will use the relaxed CONTRIBUTION with the following optional attributes:
 ...
 @return ApiContributionCreateRequest
*/
func (a *CONTRIBUTIONAPIService) ContributionCreate(ctx context.Context, ehrId string) ApiContributionCreateRequest {
	return ApiContributionCreateRequest{
		ApiService: a,
		ctx: ctx,
		ehrId: ehrId,
...
//  @return Contribution
func (a *CONTRIBUTIONAPIService) ContributionCreateExecute(r ApiContributionCreateRequest) (*Contribution, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *Contribution
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CONTRIBUTIONAPIService.ContributionCreate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/ehr/{ehr_id}/contribution"
	...
	if r.newContribution == nil {
		return localVarReturnValue, nil, reportError("newContribution is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.newContribution
...
type ApiContributionGetRequest struct {
	ctx context.Context
	ApiService CONTRIBUTIONAPI
	ehrId string
...
func (r ApiContributionGetRequest) Execute() (*Contribution, *http.Response, error) {
	return r.ApiService.ContributionGetExecute(r)
}
...
Retrieves a CONTRIBUTION identified by `contribution_uid` and associated with the EHR identified by `ehr_id`.
 ...
 @return ApiContributionGetRequest
*/
func (a *CONTRIBUTIONAPIService) ContributionGet(ctx context.Context, ehrId string, contributionUid string) ApiContributionGetRequest {
	return ApiContributionGetRequest{
		ApiService: a,
		ctx: ctx,
		ehrId: ehrId,
...
// Execute executes the request
//  @return Contribution
func (a *CONTRIBUTIONAPIService) ContributionGetExecute(r ApiContributionGetRequest) (*Contribution, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CONTRIBUTIONAPIService.ContributionGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/ehr/{ehr_id}/contribution/{contribution_uid}"
	localVarPath = strings.Replace(localVarPath, "{"+"ehr_id"+"}", url.PathEscape(parameterValueToString(r.ehrId, "ehrId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"contribution_uid"+"}", url.PathEscape(parameterValueToString(r.contributionUid, "contributionUid")), -1)
