...
func (o DvCount) MarshalJSON() ([]byte, error) {
...
func (v NullableDvCount) Get() *DvCount {
	return v.value
}

func (v *NullableDvCount) Set(val *DvCount) {
	v.value = val
	v.isSet = true
}

func (v NullableDvCount) IsSet() bool {
	return v.isSet
}

func (v *NullableDvCount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDvCount(val *DvCount) *NullableDvCount {
	return &NullableDvCount{value: val, isSet: true}
}

func (v NullableDvCount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDvCount) UnmarshalJSON(src []byte) error {
	v.isSet = true
