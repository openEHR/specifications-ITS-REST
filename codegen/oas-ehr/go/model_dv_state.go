...
func (o DvState) MarshalJSON() ([]byte, error) {
...
func (v NullableDvState) Get() *DvState {
	return v.value
}

func (v *NullableDvState) Set(val *DvState) {
	v.value = val
	v.isSet = true
}

func (v NullableDvState) IsSet() bool {
	return v.isSet
}

func (v *NullableDvState) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDvState(val *DvState) *NullableDvState {
	return &NullableDvState{value: val, isSet: true}
}

func (v NullableDvState) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDvState) UnmarshalJSON(src []byte) error {
	v.isSet = true
