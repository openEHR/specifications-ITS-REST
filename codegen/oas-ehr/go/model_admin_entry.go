...
var _ MappedNullable = &AdminEntry{}
...
func (o AdminEntry) MarshalJSON() ([]byte, error) {
...
func (v NullableAdminEntry) Get() *AdminEntry {
	return v.value
}

func (v *NullableAdminEntry) Set(val *AdminEntry) {
	v.value = val
	v.isSet = true
}

func (v NullableAdminEntry) IsSet() bool {
	return v.isSet
}

func (v *NullableAdminEntry) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdminEntry(val *AdminEntry) *NullableAdminEntry {
	return &NullableAdminEntry{value: val, isSet: true}
}

func (v NullableAdminEntry) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdminEntry) UnmarshalJSON(src []byte) error {
	v.isSet = true
