...
// RevisionHistory A REVISION_HISTORY resource
type RevisionHistory struct {
	Items []RevisionHistoryItem `json:"items"`
}

type _RevisionHistory RevisionHistory
...
func (o *RevisionHistory) UnmarshalJSON(bytes []byte) (err error) {
	...
	varRevisionHistory := _RevisionHistory{}

	err = json.Unmarshal(bytes, &varRevisionHistory)

	if err != nil {
		return err
	}

	*o = RevisionHistory(varRevisionHistory)
