...
var _ MappedNullable = &VersionedEhrStatus{}
...
func NewVersionedEhrStatus(uid HierObjectId, ownerId ObjectRef, timeCreated DvDateTime) *VersionedEhrStatus {
	this := VersionedEhrStatus{}
	var type_ string = "VERSIONED_EHR_STATUS"
	this.Type = &type_
	this.Uid = uid
...
func (o VersionedEhrStatus) MarshalJSON() ([]byte, error) {
...
type NullableVersionedEhrStatus struct {
	value *VersionedEhrStatus
	isSet bool
}

func (v NullableVersionedEhrStatus) Get() *VersionedEhrStatus {
	return v.value
}

func (v *NullableVersionedEhrStatus) Set(val *VersionedEhrStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVersionedEhrStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVersionedEhrStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVersionedEhrStatus(val *VersionedEhrStatus) *NullableVersionedEhrStatus {
	return &NullableVersionedEhrStatus{value: val, isSet: true}
}

func (v NullableVersionedEhrStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVersionedEhrStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
