...
var _ MappedNullable = &DvQuantity{}
...
// GetMagnitudeOk returns a tuple with the Magnitude field value
// and a boolean to check if the value has been set.
...
// GetUnitsSystem returns the UnitsSystem field value if set, zero value otherwise.
func (o *DvQuantity) GetUnitsSystem() string {
	if o == nil || IsNil(o.UnitsSystem) {
		var ret string
		return ret
	}
	return *o.UnitsSystem
}

// GetUnitsSystemOk returns a tuple with the UnitsSystem field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DvQuantity) GetUnitsSystemOk() (*string, bool) {
	if o == nil || IsNil(o.UnitsSystem) {
		return nil, false
	}
	return o.UnitsSystem, true
}
...
// SetUnitsSystem gets a reference to the given string and assigns it to the UnitsSystem field.
func (o *DvQuantity) SetUnitsSystem(v string) {
	o.UnitsSystem = &v
}

// GetUnitsDisplayName returns the UnitsDisplayName field value if set, zero value otherwise.
func (o *DvQuantity) GetUnitsDisplayName() string {
	if o == nil || IsNil(o.UnitsDisplayName) {
		var ret string
		return ret
	}
	return *o.UnitsDisplayName
}

// GetUnitsDisplayNameOk returns a tuple with the UnitsDisplayName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DvQuantity) GetUnitsDisplayNameOk() (*string, bool) {
	if o == nil || IsNil(o.UnitsDisplayName) {
		return nil, false
	}
	return o.UnitsDisplayName, true
}
...
// SetUnitsDisplayName gets a reference to the given string and assigns it to the UnitsDisplayName field.
func (o *DvQuantity) SetUnitsDisplayName(v string) {
	o.UnitsDisplayName = &v
}

func (o DvQuantity) MarshalJSON() ([]byte, error) {
...
func (o DvQuantity) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.UnitsSystem) {
		toSerialize["units_system"] = o.UnitsSystem
	}
	if !IsNil(o.UnitsDisplayName) {
...
func (v NullableDvQuantity) Get() *DvQuantity {
	return v.value
}

func (v *NullableDvQuantity) Set(val *DvQuantity) {
	v.value = val
	v.isSet = true
}

func (v NullableDvQuantity) IsSet() bool {
	return v.isSet
}

func (v *NullableDvQuantity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDvQuantity(val *DvQuantity) *NullableDvQuantity {
	return &NullableDvQuantity{value: val, isSet: true}
}

func (v NullableDvQuantity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDvQuantity) UnmarshalJSON(src []byte) error {
	v.isSet = true
