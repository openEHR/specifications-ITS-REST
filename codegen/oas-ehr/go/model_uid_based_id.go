...
var _ MappedNullable = &UidBasedId{}
...
func NewUidBasedId(value string) *UidBasedId {
	this := UidBasedId{}
	var type_ string = "UID_BASED_ID"
	this.Type = &type_
	this.Value = value
	return &this
}
...
func (o UidBasedId) MarshalJSON() ([]byte, error) {
...
func (v NullableUidBasedId) Get() *UidBasedId {
	return v.value
}

func (v *NullableUidBasedId) Set(val *UidBasedId) {
	v.value = val
	v.isSet = true
}

func (v NullableUidBasedId) IsSet() bool {
	return v.isSet
}

func (v *NullableUidBasedId) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUidBasedId(val *UidBasedId) *NullableUidBasedId {
	return &NullableUidBasedId{value: val, isSet: true}
}

func (v NullableUidBasedId) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUidBasedId) UnmarshalJSON(src []byte) error {
	v.isSet = true
