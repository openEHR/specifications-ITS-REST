...
// checks if the HierObjectId type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HierObjectId{}

// HierObjectId struct for HierObjectId
type HierObjectId struct {
	UidBasedId
	Value string `json:"value"`
}

type _HierObjectId HierObjectId
...
func (o HierObjectId) MarshalJSON() ([]byte, error) {
...
func (o HierObjectId) ToMap() (map[string]interface{}, error) {
...
func (o *HierObjectId) UnmarshalJSON(bytes []byte) (err error) {
	...
	varHierObjectId := _HierObjectId{}

	err = json.Unmarshal(bytes, &varHierObjectId)

	if err != nil {
		return err
	}

	*o = HierObjectId(varHierObjectId)

	return err
}

type NullableHierObjectId struct {
	value *HierObjectId
	isSet bool
}

func (v NullableHierObjectId) Get() *HierObjectId {
	return v.value
}

func (v *NullableHierObjectId) Set(val *HierObjectId) {
	v.value = val
	v.isSet = true
}

func (v NullableHierObjectId) IsSet() bool {
	return v.isSet
}

func (v *NullableHierObjectId) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHierObjectId(val *HierObjectId) *NullableHierObjectId {
	return &NullableHierObjectId{value: val, isSet: true}
}

func (v NullableHierObjectId) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHierObjectId) UnmarshalJSON(src []byte) error {
	v.isSet = true
