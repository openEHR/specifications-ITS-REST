...
// checks if the DvQuantified type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DvQuantified{}
...
func NewDvQuantified() *DvQuantified {
	this := DvQuantified{}
	var type_ string = "DV_QUANTIFIED"
	this.Type = &type_
	return &this
}
...
// GetMagnitudeStatus returns the MagnitudeStatus field value if set, zero value otherwise.
func (o *DvQuantified) GetMagnitudeStatus() string {
	if o == nil || IsNil(o.MagnitudeStatus) {
		var ret string
		return ret
	}
	return *o.MagnitudeStatus
}

// GetMagnitudeStatusOk returns a tuple with the MagnitudeStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DvQuantified) GetMagnitudeStatusOk() (*string, bool) {
	if o == nil || IsNil(o.MagnitudeStatus) {
		return nil, false
	}
	return o.MagnitudeStatus, true
}
...
// SetMagnitudeStatus gets a reference to the given string and assigns it to the MagnitudeStatus field.
func (o *DvQuantified) SetMagnitudeStatus(v string) {
	o.MagnitudeStatus = &v
}

func (o DvQuantified) MarshalJSON() ([]byte, error) {
...
func (o DvQuantified) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MagnitudeStatus) {
		toSerialize["magnitude_status"] = o.MagnitudeStatus
	}
	return toSerialize, nil
}

type NullableDvQuantified struct {
	value *DvQuantified
	isSet bool
}

func (v NullableDvQuantified) Get() *DvQuantified {
	return v.value
}

func (v *NullableDvQuantified) Set(val *DvQuantified) {
	v.value = val
	v.isSet = true
}

func (v NullableDvQuantified) IsSet() bool {
	return v.isSet
}

func (v *NullableDvQuantified) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDvQuantified(val *DvQuantified) *NullableDvQuantified {
	return &NullableDvQuantified{value: val, isSet: true}
}

func (v NullableDvQuantified) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDvQuantified) UnmarshalJSON(src []byte) error {
	v.isSet = true
