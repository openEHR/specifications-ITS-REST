...
// checks if the DvDuration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DvDuration{}

// DvDuration struct for DvDuration
...
func (o DvDuration) MarshalJSON() ([]byte, error) {
...
func (o DvDuration) ToMap() (map[string]interface{}, error) {
...
type NullableDvDuration struct {
	value *DvDuration
	isSet bool
}

func (v NullableDvDuration) Get() *DvDuration {
	return v.value
}

func (v *NullableDvDuration) Set(val *DvDuration) {
	v.value = val
	v.isSet = true
}

func (v NullableDvDuration) IsSet() bool {
	return v.isSet
}

func (v *NullableDvDuration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDvDuration(val *DvDuration) *NullableDvDuration {
	return &NullableDvDuration{value: val, isSet: true}
}

func (v NullableDvDuration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDvDuration) UnmarshalJSON(src []byte) error {
	v.isSet = true
