...
// checks if the Instruction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Instruction{}
...
// SetExpiryTime gets a reference to the given DvDateTime and assigns it to the ExpiryTime field.
func (o *Instruction) SetExpiryTime(v DvDateTime) {
	o.ExpiryTime = &v
}

// GetWfDefinition returns the WfDefinition field value if set, zero value otherwise.
func (o *Instruction) GetWfDefinition() DvParsable {
	if o == nil || IsNil(o.WfDefinition) {
		var ret DvParsable
		return ret
	}
	return *o.WfDefinition
}

// GetWfDefinitionOk returns a tuple with the WfDefinition field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Instruction) GetWfDefinitionOk() (*DvParsable, bool) {
	if o == nil || IsNil(o.WfDefinition) {
		return nil, false
	}
	return o.WfDefinition, true
}
...
// SetWfDefinition gets a reference to the given DvParsable and assigns it to the WfDefinition field.
...
func (o Instruction) MarshalJSON() ([]byte, error) {
...
func (o Instruction) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.WfDefinition) {
		toSerialize["wf_definition"] = o.WfDefinition
	}
...
func (o *Instruction) UnmarshalJSON(bytes []byte) (err error) {
	...
	varInstruction := _Instruction{}

	err = json.Unmarshal(bytes, &varInstruction)

	if err != nil {
		return err
	}

	*o = Instruction(varInstruction)
