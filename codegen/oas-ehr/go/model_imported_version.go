...
var _ MappedNullable = &ImportedVersion{}
...
func NewImportedVersion(item OriginalVersion, contribution ObjectRef, commitAudit AuditDetails, data Versionable) *ImportedVersion {
	this := ImportedVersion{}
	var type_ string = "IMPORTED_VERSION"
	this.Type = &type_
...
func (o ImportedVersion) MarshalJSON() ([]byte, error) {
...
type NullableImportedVersion struct {
	value *ImportedVersion
	isSet bool
}

func (v NullableImportedVersion) Get() *ImportedVersion {
	return v.value
}

func (v *NullableImportedVersion) Set(val *ImportedVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableImportedVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableImportedVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImportedVersion(val *ImportedVersion) *NullableImportedVersion {
	return &NullableImportedVersion{value: val, isSet: true}
}

func (v NullableImportedVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImportedVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
