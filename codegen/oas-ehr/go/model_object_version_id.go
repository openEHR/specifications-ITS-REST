...
var _ MappedNullable = &ObjectVersionId{}
...
func (v NullableObjectVersionId) Get() *ObjectVersionId {
	return v.value
}

func (v *NullableObjectVersionId) Set(val *ObjectVersionId) {
	v.value = val
	v.isSet = true
}

func (v NullableObjectVersionId) IsSet() bool {
	return v.isSet
}

func (v *NullableObjectVersionId) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableObjectVersionId(val *ObjectVersionId) *NullableObjectVersionId {
	return &NullableObjectVersionId{value: val, isSet: true}
}

func (v NullableObjectVersionId) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableObjectVersionId) UnmarshalJSON(src []byte) error {
	v.isSet = true
