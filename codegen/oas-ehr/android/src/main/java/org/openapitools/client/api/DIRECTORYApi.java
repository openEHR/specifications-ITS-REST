...
public class DIRECTORYApi {
  ...
  * Creates a new directory FOLDER associated with the EHR identified by &#x60;ehr_id&#x60;. 
   ...
   * @return Folder
  */
  public Folder directoryCreate (String ehrId, Folder folder, String prefer) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = folder;
    // verify the required parameter 'ehrId' is set
    if (ehrId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ehrId' when calling directoryCreate",
        new ApiException(400, "Missing the required parameter 'ehrId' when calling directoryCreate"));
    }
    // verify the required parameter 'folder' is set
    if (folder == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'folder' when calling directoryCreate",
        new ApiException(400, "Missing the required parameter 'folder' when calling directoryCreate"));
    }

    // create path and map variables
    String path = "/ehr/{ehr_id}/directory".replaceAll("\\{" + "ehr_id" + "\\}", apiInvoker.escapeString(ehrId.toString()));
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (Folder) ApiInvoker.deserialize(localVarResponse, "", Folder.class);
      } else {
         return null;
      }
   ...
   * Create directory
   * Creates a new directory FOLDER associated with the EHR identified by &#x60;ehr_id&#x60;. 
   * @param ehrId EHR identifier taken from EHR.ehr_id.value.    * @param folder The directory.    * @param prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;. 
  */
  public void directoryCreate (String ehrId, Folder folder, String prefer, final Response.Listener<Folder> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = folder;
    ...
    // create path and map variables
    String path = "/ehr/{ehr_id}/directory".replaceAll("\\{format\\}","json").replaceAll("\\{" + "ehr_id" + "\\}", apiInvoker.escapeString(ehrId.toString()));
      ...
      apiInvoker.invokeAPI(basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((Folder) ApiInvoker.deserialize(localVarResponse,  "", Folder.class));
  ...
  * Deletes directory FOLDER associated with the EHR identified by &#x60;ehr_id&#x60;.  The existing latest &#x60;version_uid&#x60; of directory FOLDER resource (i.e. the &#x60;preceding_version_uid&#x60;) must be specified in the &#x60;If-Match&#x60; header. 
   ...
   * @return void
  */
  public void directoryDelete (String ehrId, String ifMatch) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'ehrId' is set
    if (ehrId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ehrId' when calling directoryDelete",
        new ApiException(400, "Missing the required parameter 'ehrId' when calling directoryDelete"));
    }
    // verify the required parameter 'ifMatch' is set
    if (ifMatch == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ifMatch' when calling directoryDelete",
        new ApiException(400, "Missing the required parameter 'ifMatch' when calling directoryDelete"));
    }
  ...
  */
  public void directoryDelete (String ehrId, String ifMatch, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Retrieves the version of the directory FOLDER associated with the EHR identified by &#x60;ehr_id&#x60;.  If &#x60;version_at_time&#x60; is supplied, retrieves the version extant _at specified time_, otherwise retrieves the _latest_ directory FOLDER version.   If &#x60;path&#x60; is supplied, retrieves from the directory only the sub-FOLDER that is associated with that path. 
   ...
   * @param path A path to a sub-folder; consists of slash-separated values of the name attribute of FOLDERs in the directory. 
   * @return Folder
  */
  public Folder directoryGetAtTime (String ehrId, String versionAtTime, String path) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'ehrId' is set
    if (ehrId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ehrId' when calling directoryGetAtTime",
        new ApiException(400, "Missing the required parameter 'ehrId' when calling directoryGetAtTime"));
    }
   ...
   * Get folder in directory version at time
   * Retrieves the version of the directory FOLDER associated with the EHR identified by &#x60;ehr_id&#x60;.  If &#x60;version_at_time&#x60; is supplied, retrieves the version extant _at specified time_, otherwise retrieves the _latest_ directory FOLDER version.   If &#x60;path&#x60; is supplied, retrieves from the directory only the sub-FOLDER that is associated with that path. 
   * @param ehrId EHR identifier taken from EHR.ehr_id.value.    * @param versionAtTime A given time in the extended ISO 8601 format.    * @param path A path to a sub-folder; consists of slash-separated values of the name attribute of FOLDERs in the directory. 
  */
  public void directoryGetAtTime (String ehrId, String versionAtTime, String path, final Response.Listener<Folder> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Retrieves a particular version of the directory FOLDER identified by &#x60;version_uid&#x60; and associated with the EHR identified by &#x60;ehr_id&#x60;.  If &#x60;path&#x60; is supplied, retrieves from the directory only the sub-FOLDER that is associated with that path. 
   ...
   * @return Folder
  */
  public Folder directoryGetByVersionId (String ehrId, String versionUid, String path) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'ehrId' is set
    if (ehrId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ehrId' when calling directoryGetByVersionId",
        new ApiException(400, "Missing the required parameter 'ehrId' when calling directoryGetByVersionId"));
    }
    // verify the required parameter 'versionUid' is set
    if (versionUid == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'versionUid' when calling directoryGetByVersionId",
        new ApiException(400, "Missing the required parameter 'versionUid' when calling directoryGetByVersionId"));
    }

    // create path and map variables
    String path = "/ehr/{ehr_id}/directory/{version_uid}".replaceAll("\\{" + "ehr_id" + "\\}", apiInvoker.escapeString(ehrId.toString())).replaceAll("\\{" + "version_uid" + "\\}", apiInvoker.escapeString(versionUid.toString()));
   ...
   * Get folder in directory version
   * Retrieves a particular version of the directory FOLDER identified by &#x60;version_uid&#x60; and associated with the EHR identified by &#x60;ehr_id&#x60;.  If &#x60;path&#x60; is supplied, retrieves from the directory only the sub-FOLDER that is associated with that path. 
   * @param ehrId EHR identifier taken from EHR.ehr_id.value.    * @param versionUid VERSION identifier taken from VERSION.uid.value.    * @param path A path to a sub-folder; consists of slash-separated values of the name attribute of FOLDERs in the directory. 
  */
  public void directoryGetByVersionId (String ehrId, String versionUid, String path, final Response.Listener<Folder> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/ehr/{ehr_id}/directory/{version_uid}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "ehr_id" + "\\}", apiInvoker.escapeString(ehrId.toString())).replaceAll("\\{" + "version_uid" + "\\}", apiInvoker.escapeString(versionUid.toString()));
  ...
  * Updates directory FOLDER associated with the EHR identified by &#x60;ehr_id&#x60;.  The existing latest &#x60;version_uid&#x60; of directory FOLDER resource (i.e. the &#x60;preceding_version_uid&#x60;) must be specified in the &#x60;If-Match&#x60; header. 
   ...
   * @return Folder
  */
  public Folder directoryUpdate (String ehrId, String ifMatch, Folder folder, String prefer) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = folder;
    // verify the required parameter 'ehrId' is set
    if (ehrId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ehrId' when calling directoryUpdate",
        new ApiException(400, "Missing the required parameter 'ehrId' when calling directoryUpdate"));
    }
    // verify the required parameter 'ifMatch' is set
    if (ifMatch == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ifMatch' when calling directoryUpdate",
        new ApiException(400, "Missing the required parameter 'ifMatch' when calling directoryUpdate"));
    }
    // verify the required parameter 'folder' is set
    if (folder == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'folder' when calling directoryUpdate",
        new ApiException(400, "Missing the required parameter 'folder' when calling directoryUpdate"));
    }
   ...
   * Update directory
   * Updates directory FOLDER associated with the EHR identified by &#x60;ehr_id&#x60;.  The existing latest &#x60;version_uid&#x60; of directory FOLDER resource (i.e. the &#x60;preceding_version_uid&#x60;) must be specified in the &#x60;If-Match&#x60; header. 
   * @param ehrId EHR identifier taken from EHR.ehr_id.value.    * @param ifMatch Header to make the request conditional.  Together with &#x60;ETag&#x60; request tag, it helps to prevent simultaneous updates of a resource from overwriting each other (\&quot;mid-air collisions\&quot;). The format is always an &#x60;version_uid&#x60; identifier enclosed by double quotes. The operation will be performed only if the existing latest &#x60;version_uid&#x60; of the resource (i.e. the &#x60;preceding_version_uid&#x60;) matches this header&#39;s value.    * @param folder The new directory.    * @param prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;. 
  */
  public void directoryUpdate (String ehrId, String ifMatch, Folder folder, String prefer, final Response.Listener<Folder> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = folder;
