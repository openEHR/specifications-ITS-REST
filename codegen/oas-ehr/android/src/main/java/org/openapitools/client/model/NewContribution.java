 ...
 **/
@ApiModel(description = "A new (un-committed) CONTRIBUTION resource")
public class NewContribution {
  
  @SerializedName("uid")
  private HierObjectId uid = null;
  @SerializedName("versions")
  private List<UpdateVersion> versions = null;
  @SerializedName("audit")
  private UpdateAudit audit = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.uid == null ? newContribution.uid == null : this.uid.equals(newContribution.uid)) &&
        (this.versions == null ? newContribution.versions == null : this.versions.equals(newContribution.versions)) &&
        (this.audit == null ? newContribution.audit == null : this.audit.equals(newContribution.audit));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.audit == null ? 0: this.audit.hashCode());
    return result;
  }
