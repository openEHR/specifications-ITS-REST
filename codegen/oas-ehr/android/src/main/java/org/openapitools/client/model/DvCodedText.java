...
public class DvCodedText extends DvText {
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? dvCodedText.type == null : this.type.equals(dvCodedText.type)) &&
        (this.definingCode == null ? dvCodedText.definingCode == null : this.definingCode.equals(dvCodedText.definingCode));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.definingCode == null ? 0: this.definingCode.hashCode());
    return result;
  }
  ...
  public String toString()  {
    ...
    sb.append("  definingCode: ").append(definingCode).append("\n");
    sb.append("}\n");
    return sb.toString();
  }
}
