...
public class Instruction extends CareEntry {
  ...
  private DvText narrative = null;
  @SerializedName("expiry_time")
  private DvDateTime expiryTime = null;
  @SerializedName("wf_definition")
  private DvParsable wfDefinition = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? instruction.type == null : this.type.equals(instruction.type)) &&
        (this.narrative == null ? instruction.narrative == null : this.narrative.equals(instruction.narrative)) &&
        (this.expiryTime == null ? instruction.expiryTime == null : this.expiryTime.equals(instruction.expiryTime)) &&
        (this.wfDefinition == null ? instruction.wfDefinition == null : this.wfDefinition.equals(instruction.wfDefinition)) &&
        (this.activities == null ? instruction.activities == null : this.activities.equals(instruction.activities));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.narrative == null ? 0: this.narrative.hashCode());
    result = 31 * result + (this.expiryTime == null ? 0: this.expiryTime.hashCode());
    result = 31 * result + (this.wfDefinition == null ? 0: this.wfDefinition.hashCode());
  ...
  public String toString()  {
    ...
    sb.append("  wfDefinition: ").append(wfDefinition).append("\n");
