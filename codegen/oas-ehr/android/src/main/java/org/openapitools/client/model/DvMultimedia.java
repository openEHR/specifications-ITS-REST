...
public class DvMultimedia extends DvEncapsulated {
  ...
  @SerializedName("uri")
  private DvUri uri = null;
  @SerializedName("data")
  private String data = null;
  @SerializedName("media_type")
  private CodePhrase mediaType = null;
  @SerializedName("compression_algorithm")
  private CodePhrase compressionAlgorithm = null;
  @SerializedName("integrity_check")
  private String integrityCheck = null;
  @SerializedName("integrity_check_algorithm")
  private CodePhrase integrityCheckAlgorithm = null;
  @SerializedName("thumbnail")
  private DvMultimedia thumbnail = null;
  @SerializedName("size")
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? dvMultimedia.type == null : this.type.equals(dvMultimedia.type)) &&
        (this.alternateText == null ? dvMultimedia.alternateText == null : this.alternateText.equals(dvMultimedia.alternateText)) &&
        (this.uri == null ? dvMultimedia.uri == null : this.uri.equals(dvMultimedia.uri)) &&
        (this.data == null ? dvMultimedia.data == null : this.data.equals(dvMultimedia.data)) &&
        (this.mediaType == null ? dvMultimedia.mediaType == null : this.mediaType.equals(dvMultimedia.mediaType)) &&
        (this.compressionAlgorithm == null ? dvMultimedia.compressionAlgorithm == null : this.compressionAlgorithm.equals(dvMultimedia.compressionAlgorithm)) &&
        (this.integrityCheck == null ? dvMultimedia.integrityCheck == null : this.integrityCheck.equals(dvMultimedia.integrityCheck)) &&
        (this.integrityCheckAlgorithm == null ? dvMultimedia.integrityCheckAlgorithm == null : this.integrityCheckAlgorithm.equals(dvMultimedia.integrityCheckAlgorithm)) &&
        (this.thumbnail == null ? dvMultimedia.thumbnail == null : this.thumbnail.equals(dvMultimedia.thumbnail)) &&
        (this.size == null ? dvMultimedia.size == null : this.size.equals(dvMultimedia.size));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.alternateText == null ? 0: this.alternateText.hashCode());
    result = 31 * result + (this.uri == null ? 0: this.uri.hashCode());
    result = 31 * result + (this.data == null ? 0: this.data.hashCode());
    result = 31 * result + (this.mediaType == null ? 0: this.mediaType.hashCode());
    result = 31 * result + (this.compressionAlgorithm == null ? 0: this.compressionAlgorithm.hashCode());
    result = 31 * result + (this.integrityCheck == null ? 0: this.integrityCheck.hashCode());
    result = 31 * result + (this.integrityCheckAlgorithm == null ? 0: this.integrityCheckAlgorithm.hashCode());
  ...
  public String toString()  {
    ...
    sb.append("  alternateText: ").append(alternateText).append("\n");
    sb.append("  uri: ").append(uri).append("\n");
    sb.append("  data: ").append(data).append("\n");
    sb.append("  mediaType: ").append(mediaType).append("\n");
    sb.append("  compressionAlgorithm: ").append(compressionAlgorithm).append("\n");
    sb.append("  integrityCheck: ").append(integrityCheck).append("\n");
    sb.append("  integrityCheckAlgorithm: ").append(integrityCheckAlgorithm).append("\n");
