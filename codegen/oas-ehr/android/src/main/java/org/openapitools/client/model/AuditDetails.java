 ...
 **/
@ApiModel(description = "The set of attributes required to document the committal of an information item to a repository.")
public class AuditDetails {
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? auditDetails.type == null : this.type.equals(auditDetails.type)) &&
        (this.systemId == null ? auditDetails.systemId == null : this.systemId.equals(auditDetails.systemId)) &&
        (this.timeCommitted == null ? auditDetails.timeCommitted == null : this.timeCommitted.equals(auditDetails.timeCommitted)) &&
        (this.changeType == null ? auditDetails.changeType == null : this.changeType.equals(auditDetails.changeType)) &&
        (this.description == null ? auditDetails.description == null : this.description.equals(auditDetails.description)) &&
        (this.committer == null ? auditDetails.committer == null : this.committer.equals(auditDetails.committer));
  }
