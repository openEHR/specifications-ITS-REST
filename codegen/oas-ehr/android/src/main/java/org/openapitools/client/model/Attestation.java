...
public class Attestation extends AuditDetails {
  ...
  @SerializedName("attested_view")
  private DvMultimedia attestedView = null;
  @SerializedName("proof")
  private String proof = null;
  @SerializedName("items")
  private List<DvEhrUri> items = null;
  @SerializedName("reason")
  private DvText reason = null;
  @SerializedName("is_pending")
  private Boolean isPending = null;
  @SerializedName("system_id")
  private String systemId = null;
  @SerializedName("time_committed")
  private DvDateTime timeCommitted = null;
  @SerializedName("change_type")
  private DvCodedText changeType = null;
  @SerializedName("description")
  private DvText description = null;
  @SerializedName("committer")
  private PartyProxy committer = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? attestation.type == null : this.type.equals(attestation.type)) &&
        (this.attestedView == null ? attestation.attestedView == null : this.attestedView.equals(attestation.attestedView)) &&
        (this.proof == null ? attestation.proof == null : this.proof.equals(attestation.proof)) &&
        (this.items == null ? attestation.items == null : this.items.equals(attestation.items)) &&
        (this.reason == null ? attestation.reason == null : this.reason.equals(attestation.reason)) &&
        (this.isPending == null ? attestation.isPending == null : this.isPending.equals(attestation.isPending)) &&
        (this.systemId == null ? attestation.systemId == null : this.systemId.equals(attestation.systemId)) &&
        (this.timeCommitted == null ? attestation.timeCommitted == null : this.timeCommitted.equals(attestation.timeCommitted)) &&
        (this.changeType == null ? attestation.changeType == null : this.changeType.equals(attestation.changeType)) &&
        (this.description == null ? attestation.description == null : this.description.equals(attestation.description)) &&
        (this.committer == null ? attestation.committer == null : this.committer.equals(attestation.committer));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.attestedView == null ? 0: this.attestedView.hashCode());
    result = 31 * result + (this.proof == null ? 0: this.proof.hashCode());
    result = 31 * result + (this.items == null ? 0: this.items.hashCode());
    result = 31 * result + (this.reason == null ? 0: this.reason.hashCode());
    result = 31 * result + (this.isPending == null ? 0: this.isPending.hashCode());
    result = 31 * result + (this.systemId == null ? 0: this.systemId.hashCode());
    result = 31 * result + (this.timeCommitted == null ? 0: this.timeCommitted.hashCode());
    result = 31 * result + (this.changeType == null ? 0: this.changeType.hashCode());
    result = 31 * result + (this.description == null ? 0: this.description.hashCode());
    result = 31 * result + (this.committer == null ? 0: this.committer.hashCode());
    return result;
  }
  ...
  public String toString()  {
    ...
    sb.append("  attestedView: ").append(attestedView).append("\n");
    sb.append("  proof: ").append(proof).append("\n");
    sb.append("  items: ").append(items).append("\n");
    sb.append("  reason: ").append(reason).append("\n");
    sb.append("  isPending: ").append(isPending).append("\n");
    sb.append("  systemId: ").append(systemId).append("\n");
    sb.append("  timeCommitted: ").append(timeCommitted).append("\n");
