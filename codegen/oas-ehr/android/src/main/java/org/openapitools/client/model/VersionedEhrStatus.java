 ...
 **/
@ApiModel(description = "A VERSIONED_EHR_STATUS resource")
public class VersionedEhrStatus extends VersionedObject {
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? versionedEhrStatus.type == null : this.type.equals(versionedEhrStatus.type)) &&
        (this.uid == null ? versionedEhrStatus.uid == null : this.uid.equals(versionedEhrStatus.uid)) &&
        (this.ownerId == null ? versionedEhrStatus.ownerId == null : this.ownerId.equals(versionedEhrStatus.ownerId)) &&
        (this.timeCreated == null ? versionedEhrStatus.timeCreated == null : this.timeCreated.equals(versionedEhrStatus.timeCreated));
  }
