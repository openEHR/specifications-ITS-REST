...
public class ImportedVersion extends Version {
  ...
  @SerializedName("item")
  private OriginalVersion item = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? importedVersion.type == null : this.type.equals(importedVersion.type)) &&
        (this.item == null ? importedVersion.item == null : this.item.equals(importedVersion.item)) &&
        (this.contribution == null ? importedVersion.contribution == null : this.contribution.equals(importedVersion.contribution)) &&
        (this.signature == null ? importedVersion.signature == null : this.signature.equals(importedVersion.signature)) &&
        (this.commitAudit == null ? importedVersion.commitAudit == null : this.commitAudit.equals(importedVersion.commitAudit)) &&
        (this.data == null ? importedVersion.data == null : this.data.equals(importedVersion.data));
  }
