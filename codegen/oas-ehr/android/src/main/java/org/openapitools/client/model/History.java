...
public class History extends Locatable {
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? history.type == null : this.type.equals(history.type)) &&
        (this.origin == null ? history.origin == null : this.origin.equals(history.origin)) &&
        (this.period == null ? history.period == null : this.period.equals(history.period)) &&
        (this.duration == null ? history.duration == null : this.duration.equals(history.duration)) &&
        (this.summary == null ? history.summary == null : this.summary.equals(history.summary)) &&
        (this.events == null ? history.events == null : this.events.equals(history.events));
  }
