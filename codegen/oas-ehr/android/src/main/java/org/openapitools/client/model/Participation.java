...
public class Participation {
  ...
  private DvText function = null;
  @SerializedName("mode")
  private DvCodedText mode = null;
  @SerializedName("performer")
  private PartyProxy performer = null;
  @SerializedName("time")
  private DvIntervalOfDateTime time = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.function == null ? participation.function == null : this.function.equals(participation.function)) &&
        (this.mode == null ? participation.mode == null : this.mode.equals(participation.mode)) &&
        (this.performer == null ? participation.performer == null : this.performer.equals(participation.performer)) &&
        (this.time == null ? participation.time == null : this.time.equals(participation.time));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.performer == null ? 0: this.performer.hashCode());
