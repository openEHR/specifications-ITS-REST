...
public class TerminologyCode {
  ...
  @SerializedName("terminology_id")
  private String terminologyId = null;
  @SerializedName("terminology_version")
  ...
  public boolean equals(Object o) {
    ...
    return (this.terminologyId == null ? terminologyCode.terminologyId == null : this.terminologyId.equals(terminologyCode.terminologyId)) &&
        (this.terminologyVersion == null ? terminologyCode.terminologyVersion == null : this.terminologyVersion.equals(terminologyCode.terminologyVersion)) &&
        (this.codeString == null ? terminologyCode.codeString == null : this.codeString.equals(terminologyCode.codeString)) &&
        (this.uri == null ? terminologyCode.uri == null : this.uri.equals(terminologyCode.uri));
  }

  @Override
  public int hashCode() {
    int result = 17;
    result = 31 * result + (this.terminologyId == null ? 0: this.terminologyId.hashCode());
    result = 31 * result + (this.terminologyVersion == null ? 0: this.terminologyVersion.hashCode());
    result = 31 * result + (this.codeString == null ? 0: this.codeString.hashCode());
  ...
  public String toString()  {
    ...
    sb.append("  terminologyId: ").append(terminologyId).append("\n");
    sb.append("  terminologyVersion: ").append(terminologyVersion).append("\n");
