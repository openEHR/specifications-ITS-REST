 ...
 * A FOLDER resource
 **/
@ApiModel(description = "A FOLDER resource")
public class Folder extends Locatable {
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? folder.type == null : this.type.equals(folder.type)) &&
        (this.items == null ? folder.items == null : this.items.equals(folder.items)) &&
        (this.folders == null ? folder.folders == null : this.folders.equals(folder.folders)) &&
        (this.details == null ? folder.details == null : this.details.equals(folder.details));
  }
