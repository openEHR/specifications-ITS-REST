 ...
 **/
@ApiModel(description = "Identifier for parties in a demographic or identity service.")
public class PartyRef {
  ...
  public boolean equals(Object o) {
    ...
    return (this.namespace == null ? partyRef.namespace == null : this.namespace.equals(partyRef.namespace)) &&
        (this.type == null ? partyRef.type == null : this.type.equals(partyRef.type)) &&
        (this.id == null ? partyRef.id == null : this.id.equals(partyRef.id));
  }
