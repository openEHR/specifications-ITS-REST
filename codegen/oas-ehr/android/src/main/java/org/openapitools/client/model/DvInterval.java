...
public class DvInterval extends DataValue {
  ...
  @SerializedName("lower_unbounded")
  private Boolean lowerUnbounded = null;
  @SerializedName("upper_unbounded")
  private Boolean upperUnbounded = null;
  @SerializedName("lower_included")
  private Boolean lowerIncluded = null;
  @SerializedName("upper_included")
  private Boolean upperIncluded = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? dvInterval.type == null : this.type.equals(dvInterval.type)) &&
        (this.lowerUnbounded == null ? dvInterval.lowerUnbounded == null : this.lowerUnbounded.equals(dvInterval.lowerUnbounded)) &&
        (this.upperUnbounded == null ? dvInterval.upperUnbounded == null : this.upperUnbounded.equals(dvInterval.upperUnbounded)) &&
        (this.lowerIncluded == null ? dvInterval.lowerIncluded == null : this.lowerIncluded.equals(dvInterval.lowerIncluded)) &&
        (this.upperIncluded == null ? dvInterval.upperIncluded == null : this.upperIncluded.equals(dvInterval.upperIncluded));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.lowerUnbounded == null ? 0: this.lowerUnbounded.hashCode());
    result = 31 * result + (this.upperUnbounded == null ? 0: this.upperUnbounded.hashCode());
    result = 31 * result + (this.lowerIncluded == null ? 0: this.lowerIncluded.hashCode());
    result = 31 * result + (this.upperIncluded == null ? 0: this.upperIncluded.hashCode());
    return result;
  }
  ...
  public String toString()  {
    ...
    sb.append("  lowerUnbounded: ").append(lowerUnbounded).append("\n");
    sb.append("  upperUnbounded: ").append(upperUnbounded).append("\n");
    sb.append("  lowerIncluded: ").append(lowerIncluded).append("\n");
    sb.append("  upperIncluded: ").append(upperIncluded).append("\n");
    sb.append("}\n");
    return sb.toString();
  }
}
