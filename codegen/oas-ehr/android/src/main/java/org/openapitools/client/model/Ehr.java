 ...
 * An EHR resource
 **/
@ApiModel(description = "An EHR resource")
public class Ehr {
  
  @SerializedName("system_id")
  private HierObjectId systemId = null;
  @SerializedName("ehr_id")
  private HierObjectId ehrId = null;
  @SerializedName("ehr_status")
  private ObjectRef ehrStatus = null;
  @SerializedName("ehr_access")
  private ObjectRef ehrAccess = null;
  @SerializedName("time_created")
  private DvDateTime timeCreated = null;
  ...
  public boolean equals(Object o) {
    ...
    Ehr ehr = (Ehr) o;
    return (this.systemId == null ? ehr.systemId == null : this.systemId.equals(ehr.systemId)) &&
        (this.ehrId == null ? ehr.ehrId == null : this.ehrId.equals(ehr.ehrId)) &&
        (this.ehrStatus == null ? ehr.ehrStatus == null : this.ehrStatus.equals(ehr.ehrStatus)) &&
        (this.ehrAccess == null ? ehr.ehrAccess == null : this.ehrAccess.equals(ehr.ehrAccess)) &&
        (this.timeCreated == null ? ehr.timeCreated == null : this.timeCreated.equals(ehr.timeCreated));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.ehrId == null ? 0: this.ehrId.hashCode());
    result = 31 * result + (this.ehrStatus == null ? 0: this.ehrStatus.hashCode());
    result = 31 * result + (this.ehrAccess == null ? 0: this.ehrAccess.hashCode());
    result = 31 * result + (this.timeCreated == null ? 0: this.timeCreated.hashCode());
    return result;
  }
  ...
  public String toString()  {
    ...
    sb.append("  ehrId: ").append(ehrId).append("\n");
    sb.append("  ehrStatus: ").append(ehrStatus).append("\n");
    sb.append("  ehrAccess: ").append(ehrAccess).append("\n");
