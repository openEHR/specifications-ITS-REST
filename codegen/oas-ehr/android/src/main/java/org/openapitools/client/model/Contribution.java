 ...
 **/
@ApiModel(description = "A CONTRIBUTION resource")
public class Contribution {
  
  @SerializedName("uid")
  private HierObjectId uid = null;
  @SerializedName("versions")
  private List<ObjectRef> versions = null;
  @SerializedName("audit")
  private AuditDetails audit = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.uid == null ? contribution.uid == null : this.uid.equals(contribution.uid)) &&
        (this.versions == null ? contribution.versions == null : this.versions.equals(contribution.versions)) &&
        (this.audit == null ? contribution.audit == null : this.audit.equals(contribution.audit));
  }
