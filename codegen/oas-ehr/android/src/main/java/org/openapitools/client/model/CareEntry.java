...
public class CareEntry extends AbstractEntry {
  ...
  public boolean equals(Object o) {
    ...
    return (this.protocol == null ? careEntry.protocol == null : this.protocol.equals(careEntry.protocol)) &&
        (this.guidelineId == null ? careEntry.guidelineId == null : this.guidelineId.equals(careEntry.guidelineId)) &&
        (this.type == null ? careEntry.type == null : this.type.equals(careEntry.type));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.guidelineId == null ? 0: this.guidelineId.hashCode());
