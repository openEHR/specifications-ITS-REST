...
public class LocatableRef {
  ...
  public boolean equals(Object o) {
    ...
    return (this.namespace == null ? locatableRef.namespace == null : this.namespace.equals(locatableRef.namespace)) &&
        (this.type == null ? locatableRef.type == null : this.type.equals(locatableRef.type)) &&
        (this.id == null ? locatableRef.id == null : this.id.equals(locatableRef.id)) &&
        (this.path == null ? locatableRef.path == null : this.path.equals(locatableRef.path));
  }
