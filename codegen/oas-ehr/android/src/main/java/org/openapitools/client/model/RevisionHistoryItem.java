 ...
 **/
@ApiModel(description = "A REVISION_HISTORY_ITEM resource")
public class RevisionHistoryItem {
  
  @SerializedName("version_id")
  private ObjectVersionId versionId = null;
  @SerializedName("audits")
  private List<AuditDetails> audits = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.versionId == null ? revisionHistoryItem.versionId == null : this.versionId.equals(revisionHistoryItem.versionId)) &&
        (this.audits == null ? revisionHistoryItem.audits == null : this.audits.equals(revisionHistoryItem.audits));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.audits == null ? 0: this.audits.hashCode());
    return result;
  }
