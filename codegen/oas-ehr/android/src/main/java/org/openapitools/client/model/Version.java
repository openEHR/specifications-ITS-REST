 ...
 * A VERSION resource
 **/
@ApiModel(description = "A VERSION resource")
public class Version {
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? version.type == null : this.type.equals(version.type)) &&
        (this.contribution == null ? version.contribution == null : this.contribution.equals(version.contribution)) &&
        (this.signature == null ? version.signature == null : this.signature.equals(version.signature)) &&
        (this.commitAudit == null ? version.commitAudit == null : this.commitAudit.equals(version.commitAudit)) &&
        (this.data == null ? version.data == null : this.data.equals(version.data));
  }
