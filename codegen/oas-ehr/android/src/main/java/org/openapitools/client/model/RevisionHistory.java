 ...
 **/
@ApiModel(description = "A REVISION_HISTORY resource")
public class RevisionHistory {
  
  @SerializedName("items")
  private List<RevisionHistoryItem> items = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.items == null ? revisionHistory.items == null : this.items.equals(revisionHistory.items));
  }
