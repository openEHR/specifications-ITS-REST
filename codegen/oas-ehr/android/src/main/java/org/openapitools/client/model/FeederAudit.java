...
public class FeederAudit {
  ...
  @SerializedName("originating_system_item_ids")
  private List<DvIdentifier> originatingSystemItemIds = null;
  @SerializedName("feeder_system_item_ids")
  private List<DvIdentifier> feederSystemItemIds = null;
  @SerializedName("original_content")
  private DvEncapsulated originalContent = null;
  @SerializedName("originating_system_audit")
  private FeederAuditDetails originatingSystemAudit = null;
  @SerializedName("feeder_system_audit")
  private FeederAuditDetails feederSystemAudit = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.originatingSystemItemIds == null ? feederAudit.originatingSystemItemIds == null : this.originatingSystemItemIds.equals(feederAudit.originatingSystemItemIds)) &&
        (this.feederSystemItemIds == null ? feederAudit.feederSystemItemIds == null : this.feederSystemItemIds.equals(feederAudit.feederSystemItemIds)) &&
        (this.originalContent == null ? feederAudit.originalContent == null : this.originalContent.equals(feederAudit.originalContent)) &&
        (this.originatingSystemAudit == null ? feederAudit.originatingSystemAudit == null : this.originatingSystemAudit.equals(feederAudit.originatingSystemAudit)) &&
        (this.feederSystemAudit == null ? feederAudit.feederSystemAudit == null : this.feederSystemAudit.equals(feederAudit.feederSystemAudit));
  }

  @Override
  public int hashCode() {
    int result = 17;
    result = 31 * result + (this.originatingSystemItemIds == null ? 0: this.originatingSystemItemIds.hashCode());
    result = 31 * result + (this.feederSystemItemIds == null ? 0: this.feederSystemItemIds.hashCode());
    result = 31 * result + (this.originalContent == null ? 0: this.originalContent.hashCode());
    result = 31 * result + (this.originatingSystemAudit == null ? 0: this.originatingSystemAudit.hashCode());
    result = 31 * result + (this.feederSystemAudit == null ? 0: this.feederSystemAudit.hashCode());
    return result;
  }
  ...
  public String toString()  {
    ...
    sb.append("  originatingSystemItemIds: ").append(originatingSystemItemIds).append("\n");
    sb.append("  feederSystemItemIds: ").append(feederSystemItemIds).append("\n");
    sb.append("  originalContent: ").append(originalContent).append("\n");
    sb.append("  originatingSystemAudit: ").append(originatingSystemAudit).append("\n");
    sb.append("  feederSystemAudit: ").append(feederSystemAudit).append("\n");
    sb.append("}\n");
    return sb.toString();
  }
}
