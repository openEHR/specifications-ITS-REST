 ...
 **/
@ApiModel(description = "A COMPOSITION resource")
public class Composition extends Versionable {
  ...
  private List<ContentItem> content = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? composition.type == null : this.type.equals(composition.type)) &&
        (this.language == null ? composition.language == null : this.language.equals(composition.language)) &&
        (this.territory == null ? composition.territory == null : this.territory.equals(composition.territory)) &&
        (this.category == null ? composition.category == null : this.category.equals(composition.category)) &&
        (this.context == null ? composition.context == null : this.context.equals(composition.context)) &&
        (this.composer == null ? composition.composer == null : this.composer.equals(composition.composer)) &&
        (this.content == null ? composition.content == null : this.content.equals(composition.content));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.composer == null ? 0: this.composer.hashCode());
