...
public class FeederAuditDetails {
  ...
  private PartyIdentified location = null;
  @SerializedName("subject")
  private PartyProxy subject = null;
  @SerializedName("provider")
  private PartyIdentified provider = null;
  @SerializedName("time")
  private DvDateTime time = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.systemId == null ? feederAuditDetails.systemId == null : this.systemId.equals(feederAuditDetails.systemId)) &&
        (this.location == null ? feederAuditDetails.location == null : this.location.equals(feederAuditDetails.location)) &&
        (this.subject == null ? feederAuditDetails.subject == null : this.subject.equals(feederAuditDetails.subject)) &&
        (this.provider == null ? feederAuditDetails.provider == null : this.provider.equals(feederAuditDetails.provider)) &&
        (this.time == null ? feederAuditDetails.time == null : this.time.equals(feederAuditDetails.time)) &&
        (this.versionId == null ? feederAuditDetails.versionId == null : this.versionId.equals(feederAuditDetails.versionId)) &&
        (this.otherDetails == null ? feederAuditDetails.otherDetails == null : this.otherDetails.equals(feederAuditDetails.otherDetails));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.otherDetails == null ? 0: this.otherDetails.hashCode());
    return result;
  }
