...
public class ObjectRef {
  ...
  public boolean equals(Object o) {
    ...
    return (this.namespace == null ? objectRef.namespace == null : this.namespace.equals(objectRef.namespace)) &&
        (this.type == null ? objectRef.type == null : this.type.equals(objectRef.type)) &&
        (this.id == null ? objectRef.id == null : this.id.equals(objectRef.id));
  }
