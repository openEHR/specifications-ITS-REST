...
public class Activity extends Locatable {
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? activity.type == null : this.type.equals(activity.type)) &&
        (this.timing == null ? activity.timing == null : this.timing.equals(activity.timing)) &&
        (this.actionArchetypeId == null ? activity.actionArchetypeId == null : this.actionArchetypeId.equals(activity.actionArchetypeId)) &&
        (this.description == null ? activity.description == null : this.description.equals(activity.description));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.actionArchetypeId == null ? 0: this.actionArchetypeId.hashCode());
  ...
  public String toString()  {
    ...
    sb.append("  actionArchetypeId: ").append(actionArchetypeId).append("\n");
