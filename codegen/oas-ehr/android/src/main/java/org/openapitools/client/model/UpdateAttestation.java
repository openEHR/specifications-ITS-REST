...
public class UpdateAttestation extends UpdateAudit {
  ...
  private TerminologyCode changeType = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? updateAttestation.type == null : this.type.equals(updateAttestation.type)) &&
        (this.attestedView == null ? updateAttestation.attestedView == null : this.attestedView.equals(updateAttestation.attestedView)) &&
        (this.proof == null ? updateAttestation.proof == null : this.proof.equals(updateAttestation.proof)) &&
        (this.items == null ? updateAttestation.items == null : this.items.equals(updateAttestation.items)) &&
        (this.reason == null ? updateAttestation.reason == null : this.reason.equals(updateAttestation.reason)) &&
        (this.isPending == null ? updateAttestation.isPending == null : this.isPending.equals(updateAttestation.isPending)) &&
        (this.changeType == null ? updateAttestation.changeType == null : this.changeType.equals(updateAttestation.changeType)) &&
        (this.description == null ? updateAttestation.description == null : this.description.equals(updateAttestation.description)) &&
        (this.committer == null ? updateAttestation.committer == null : this.committer.equals(updateAttestation.committer));
  }
