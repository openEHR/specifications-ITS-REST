...
public class InstructionDetails extends Pathable {
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? instructionDetails.type == null : this.type.equals(instructionDetails.type)) &&
        (this.instructionId == null ? instructionDetails.instructionId == null : this.instructionId.equals(instructionDetails.instructionId)) &&
        (this.activityId == null ? instructionDetails.activityId == null : this.activityId.equals(instructionDetails.activityId)) &&
        (this.wfDetails == null ? instructionDetails.wfDetails == null : this.wfDetails.equals(instructionDetails.wfDetails));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.instructionId == null ? 0: this.instructionId.hashCode());
    result = 31 * result + (this.activityId == null ? 0: this.activityId.hashCode());
    result = 31 * result + (this.wfDetails == null ? 0: this.wfDetails.hashCode());
    return result;
  }
  ...
  public String toString()  {
    ...
    sb.append("  wfDetails: ").append(wfDetails).append("\n");
    sb.append("}\n");
    return sb.toString();
  }
}
