...
public class OriginalVersion extends Version {
  ...
  @SerializedName("uid")
  private ObjectVersionId uid = null;
  @SerializedName("preceding_version_uid")
  private ObjectVersionId precedingVersionUid = null;
  @SerializedName("other_input_version_uids")
  private List<ObjectVersionId> otherInputVersionUids = null;
  @SerializedName("lifecycle_state")
  private DvCodedText lifecycleState = null;
  @SerializedName("attestations")
  private List<Attestation> attestations = null;
  @SerializedName("contribution")
  private ObjectRef contribution = null;
  @SerializedName("signature")
  private String signature = null;
  @SerializedName("commit_audit")
  private AuditDetails commitAudit = null;
  @SerializedName("data")
  private Versionable data = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? originalVersion.type == null : this.type.equals(originalVersion.type)) &&
        (this.uid == null ? originalVersion.uid == null : this.uid.equals(originalVersion.uid)) &&
        (this.precedingVersionUid == null ? originalVersion.precedingVersionUid == null : this.precedingVersionUid.equals(originalVersion.precedingVersionUid)) &&
        (this.otherInputVersionUids == null ? originalVersion.otherInputVersionUids == null : this.otherInputVersionUids.equals(originalVersion.otherInputVersionUids)) &&
        (this.lifecycleState == null ? originalVersion.lifecycleState == null : this.lifecycleState.equals(originalVersion.lifecycleState)) &&
        (this.attestations == null ? originalVersion.attestations == null : this.attestations.equals(originalVersion.attestations)) &&
        (this.contribution == null ? originalVersion.contribution == null : this.contribution.equals(originalVersion.contribution)) &&
        (this.signature == null ? originalVersion.signature == null : this.signature.equals(originalVersion.signature)) &&
        (this.commitAudit == null ? originalVersion.commitAudit == null : this.commitAudit.equals(originalVersion.commitAudit)) &&
        (this.data == null ? originalVersion.data == null : this.data.equals(originalVersion.data));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.precedingVersionUid == null ? 0: this.precedingVersionUid.hashCode());
    result = 31 * result + (this.otherInputVersionUids == null ? 0: this.otherInputVersionUids.hashCode());
    result = 31 * result + (this.lifecycleState == null ? 0: this.lifecycleState.hashCode());
    result = 31 * result + (this.attestations == null ? 0: this.attestations.hashCode());
    ...
    result = 31 * result + (this.commitAudit == null ? 0: this.commitAudit.hashCode());
  ...
  public String toString()  {
    ...
    sb.append("  precedingVersionUid: ").append(precedingVersionUid).append("\n");
    sb.append("  otherInputVersionUids: ").append(otherInputVersionUids).append("\n");
    ...
    sb.append("  commitAudit: ").append(commitAudit).append("\n");
