...
public class DvAmount extends DvQuantified {
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? dvAmount.type == null : this.type.equals(dvAmount.type)) &&
        (this.accuracyIsPercent == null ? dvAmount.accuracyIsPercent == null : this.accuracyIsPercent.equals(dvAmount.accuracyIsPercent)) &&
        (this.accuracy == null ? dvAmount.accuracy == null : this.accuracy.equals(dvAmount.accuracy));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.accuracyIsPercent == null ? 0: this.accuracyIsPercent.hashCode());
  ...
  public String toString()  {
    ...
    sb.append("  accuracyIsPercent: ").append(accuracyIsPercent).append("\n");
