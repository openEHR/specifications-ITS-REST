...
public class EHRSTATUSApi {
  ...
  * Retrieves a version of the EHR_STATUS associated with the EHR identified by &#x60;ehr_id&#x60;.  If &#x60;version_at_time&#x60; is supplied, retrieves the version extant _at specified time_, otherwise retrieves the _latest_ EHR_STATUS version. 
   ...
   * @return EhrStatus
  */
  public EhrStatus ehrStatusGetAtTime (String ehrId, String versionAtTime) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'ehrId' is set
    if (ehrId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ehrId' when calling ehrStatusGetAtTime",
        new ApiException(400, "Missing the required parameter 'ehrId' when calling ehrStatusGetAtTime"));
    }

    // create path and map variables
    String path = "/ehr/{ehr_id}/ehr_status".replaceAll("\\{" + "ehr_id" + "\\}", apiInvoker.escapeString(ehrId.toString()));
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (EhrStatus) ApiInvoker.deserialize(localVarResponse, "", EhrStatus.class);
      } else {
         return null;
      }
   ...
   * Get EHR_STATUS at time
   * Retrieves a version of the EHR_STATUS associated with the EHR identified by &#x60;ehr_id&#x60;.  If &#x60;version_at_time&#x60; is supplied, retrieves the version extant _at specified time_, otherwise retrieves the _latest_ EHR_STATUS version. 
   * @param ehrId EHR identifier taken from EHR.ehr_id.value.    * @param versionAtTime A given time in the extended ISO 8601 format. 
  */
  public void ehrStatusGetAtTime (String ehrId, String versionAtTime, final Response.Listener<EhrStatus> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/ehr/{ehr_id}/ehr_status".replaceAll("\\{format\\}","json").replaceAll("\\{" + "ehr_id" + "\\}", apiInvoker.escapeString(ehrId.toString()));
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EhrStatus) ApiInvoker.deserialize(localVarResponse,  "", EhrStatus.class));
  ...
  * Retrieves a particular version of the EHR_STATUS identified by &#x60;version_uid&#x60; and associated with the EHR identified by &#x60;ehr_id&#x60;. 
   ...
   * @return EhrStatus
  */
  public EhrStatus ehrStatusGetByVersionId (String ehrId, String versionUid) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'ehrId' is set
    if (ehrId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ehrId' when calling ehrStatusGetByVersionId",
        new ApiException(400, "Missing the required parameter 'ehrId' when calling ehrStatusGetByVersionId"));
    }
    // verify the required parameter 'versionUid' is set
    if (versionUid == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'versionUid' when calling ehrStatusGetByVersionId",
        new ApiException(400, "Missing the required parameter 'versionUid' when calling ehrStatusGetByVersionId"));
    }

    // create path and map variables
    String path = "/ehr/{ehr_id}/ehr_status/{version_uid}".replaceAll("\\{" + "ehr_id" + "\\}", apiInvoker.escapeString(ehrId.toString())).replaceAll("\\{" + "version_uid" + "\\}", apiInvoker.escapeString(versionUid.toString()));
   ...
   * Get EHR_STATUS by version id
   * Retrieves a particular version of the EHR_STATUS identified by &#x60;version_uid&#x60; and associated with the EHR identified by &#x60;ehr_id&#x60;. 
   * @param ehrId EHR identifier taken from EHR.ehr_id.value.    * @param versionUid VERSION identifier taken from VERSION.uid.value. 
  */
  public void ehrStatusGetByVersionId (String ehrId, String versionUid, final Response.Listener<EhrStatus> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/ehr/{ehr_id}/ehr_status/{version_uid}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "ehr_id" + "\\}", apiInvoker.escapeString(ehrId.toString())).replaceAll("\\{" + "version_uid" + "\\}", apiInvoker.escapeString(versionUid.toString()));
  ...
  * Updates EHR_STATUS associated with the EHR identified by &#x60;ehr_id&#x60;.  The existing latest &#x60;version_uid&#x60; of EHR_STATUS resource (i.e. the &#x60;preceding_version_uid&#x60;) must be specified in the &#x60;If-Match&#x60; header.  The response will contain the updated EHR_STATUS resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;. 
   ...
   * @return EhrStatus
  */
  public EhrStatus ehrStatusUpdate (String ehrId, String ifMatch, EhrStatus ehrStatus, String prefer) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = ehrStatus;
    // verify the required parameter 'ehrId' is set
    if (ehrId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ehrId' when calling ehrStatusUpdate",
        new ApiException(400, "Missing the required parameter 'ehrId' when calling ehrStatusUpdate"));
    }
    // verify the required parameter 'ifMatch' is set
    if (ifMatch == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ifMatch' when calling ehrStatusUpdate",
        new ApiException(400, "Missing the required parameter 'ifMatch' when calling ehrStatusUpdate"));
    }
    // verify the required parameter 'ehrStatus' is set
    if (ehrStatus == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ehrStatus' when calling ehrStatusUpdate",
        new ApiException(400, "Missing the required parameter 'ehrStatus' when calling ehrStatusUpdate"));
    }
   ...
   * Update EHR_STATUS
   * Updates EHR_STATUS associated with the EHR identified by &#x60;ehr_id&#x60;.  The existing latest &#x60;version_uid&#x60; of EHR_STATUS resource (i.e. the &#x60;preceding_version_uid&#x60;) must be specified in the &#x60;If-Match&#x60; header.  The response will contain the updated EHR_STATUS resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;. 
   * @param ehrId EHR identifier taken from EHR.ehr_id.value.    * @param ifMatch Header to make the request conditional.  Together with &#x60;ETag&#x60; request tag, it helps to prevent simultaneous updates of a resource from overwriting each other (\&quot;mid-air collisions\&quot;). The format is always an &#x60;version_uid&#x60; identifier enclosed by double quotes. The operation will be performed only if the existing latest &#x60;version_uid&#x60; of the resource (i.e. the &#x60;preceding_version_uid&#x60;) matches this header&#39;s value.    * @param ehrStatus The new EHR_STATUS.    * @param prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;. 
  */
  public void ehrStatusUpdate (String ehrId, String ifMatch, EhrStatus ehrStatus, String prefer, final Response.Listener<EhrStatus> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = ehrStatus;
  ...
  */
  public VersionedEhrStatus versionedEhrStatusGet (String ehrId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'ehrId' is set
    if (ehrId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ehrId' when calling versionedEhrStatusGet",
        new ApiException(400, "Missing the required parameter 'ehrId' when calling versionedEhrStatusGet"));
    }

    // create path and map variables
    String path = "/ehr/{ehr_id}/versioned_ehr_status".replaceAll("\\{" + "ehr_id" + "\\}", apiInvoker.escapeString(ehrId.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (VersionedEhrStatus) ApiInvoker.deserialize(localVarResponse, "", VersionedEhrStatus.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param ehrId EHR identifier taken from EHR.ehr_id.value. 
  */
  public void versionedEhrStatusGet (String ehrId, final Response.Listener<VersionedEhrStatus> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/ehr/{ehr_id}/versioned_ehr_status".replaceAll("\\{format\\}","json").replaceAll("\\{" + "ehr_id" + "\\}", apiInvoker.escapeString(ehrId.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((VersionedEhrStatus) ApiInvoker.deserialize(localVarResponse,  "", VersionedEhrStatus.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public RevisionHistory versionedEhrStatusRevisionHistory (String ehrId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'ehrId' is set
    if (ehrId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ehrId' when calling versionedEhrStatusRevisionHistory",
        new ApiException(400, "Missing the required parameter 'ehrId' when calling versionedEhrStatusRevisionHistory"));
    }

    // create path and map variables
    String path = "/ehr/{ehr_id}/versioned_ehr_status/revision_history".replaceAll("\\{" + "ehr_id" + "\\}", apiInvoker.escapeString(ehrId.toString()));
   ...
   * @param ehrId EHR identifier taken from EHR.ehr_id.value. 
  */
  public void versionedEhrStatusRevisionHistory (String ehrId, final Response.Listener<RevisionHistory> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/ehr/{ehr_id}/versioned_ehr_status/revision_history".replaceAll("\\{format\\}","json").replaceAll("\\{" + "ehr_id" + "\\}", apiInvoker.escapeString(ehrId.toString()));
  ...
  * Retrieves a VERSION from the VERSIONED_EHR_STATUS associated with the EHR identified by &#x60;ehr_id&#x60;.  If &#x60;version_at_time&#x60; is supplied, retrieves the VERSION extant _at specified time_, otherwise retrieves the _latest_ VERSION. 
   ...
   * @return Version
  */
  public Version versionedEhrStatusVersionGetAtTime (String ehrId, String versionAtTime) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'ehrId' is set
    if (ehrId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ehrId' when calling versionedEhrStatusVersionGetAtTime",
        new ApiException(400, "Missing the required parameter 'ehrId' when calling versionedEhrStatusVersionGetAtTime"));
    }

    // create path and map variables
    String path = "/ehr/{ehr_id}/versioned_ehr_status/version".replaceAll("\\{" + "ehr_id" + "\\}", apiInvoker.escapeString(ehrId.toString()));
   ...
   * @param ehrId EHR identifier taken from EHR.ehr_id.value.    * @param versionAtTime A given time in the extended ISO 8601 format. 
  */
  public void versionedEhrStatusVersionGetAtTime (String ehrId, String versionAtTime, final Response.Listener<Version> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/ehr/{ehr_id}/versioned_ehr_status/version".replaceAll("\\{format\\}","json").replaceAll("\\{" + "ehr_id" + "\\}", apiInvoker.escapeString(ehrId.toString()));
  ...
  * Retrieves a VERSION identified by &#x60;version_uid&#x60; of an EHR_STATUS associated with the EHR identified by &#x60;ehr_id&#x60;. 
   ...
   * @return Version
  */
  public Version versionedEhrStatusVersionGetById (String ehrId, String versionUid) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'ehrId' is set
    if (ehrId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ehrId' when calling versionedEhrStatusVersionGetById",
        new ApiException(400, "Missing the required parameter 'ehrId' when calling versionedEhrStatusVersionGetById"));
    }
    // verify the required parameter 'versionUid' is set
    if (versionUid == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'versionUid' when calling versionedEhrStatusVersionGetById",
        new ApiException(400, "Missing the required parameter 'versionUid' when calling versionedEhrStatusVersionGetById"));
    }

    // create path and map variables
    String path = "/ehr/{ehr_id}/versioned_ehr_status/version/{version_uid}".replaceAll("\\{" + "ehr_id" + "\\}", apiInvoker.escapeString(ehrId.toString())).replaceAll("\\{" + "version_uid" + "\\}", apiInvoker.escapeString(versionUid.toString()));
   ...
   * @param ehrId EHR identifier taken from EHR.ehr_id.value.    * @param versionUid VERSION identifier taken from VERSION.uid.value. 
  */
  public void versionedEhrStatusVersionGetById (String ehrId, String versionUid, final Response.Listener<Version> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/ehr/{ehr_id}/versioned_ehr_status/version/{version_uid}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "ehr_id" + "\\}", apiInvoker.escapeString(ehrId.toString())).replaceAll("\\{" + "version_uid" + "\\}", apiInvoker.escapeString(versionUid.toString()));
