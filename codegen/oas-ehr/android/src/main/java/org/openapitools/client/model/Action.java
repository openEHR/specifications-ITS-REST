...
public class Action extends CareEntry {
  ...
  @SerializedName("ism_transition")
  private IsmTransition ismTransition = null;
  @SerializedName("instruction_details")
  private InstructionDetails instructionDetails = null;
  @SerializedName("description")
  private ItemStructure description = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? action.type == null : this.type.equals(action.type)) &&
        (this.time == null ? action.time == null : this.time.equals(action.time)) &&
        (this.ismTransition == null ? action.ismTransition == null : this.ismTransition.equals(action.ismTransition)) &&
        (this.instructionDetails == null ? action.instructionDetails == null : this.instructionDetails.equals(action.instructionDetails)) &&
        (this.description == null ? action.description == null : this.description.equals(action.description));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.ismTransition == null ? 0: this.ismTransition.hashCode());
    result = 31 * result + (this.instructionDetails == null ? 0: this.instructionDetails.hashCode());
  ...
  public String toString()  {
    ...
    sb.append("  ismTransition: ").append(ismTransition).append("\n");
    sb.append("  instructionDetails: ").append(instructionDetails).append("\n");
