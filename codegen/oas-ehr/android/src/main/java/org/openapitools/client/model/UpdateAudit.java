 ...
 **/
@ApiModel(description = "The set of attributes required to document the committal of an information item to a repository. Used by the server to create an AUDIT_DETAILS object.")
public class UpdateAudit {
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? updateAudit.type == null : this.type.equals(updateAudit.type)) &&
        (this.changeType == null ? updateAudit.changeType == null : this.changeType.equals(updateAudit.changeType)) &&
        (this.description == null ? updateAudit.description == null : this.description.equals(updateAudit.description)) &&
        (this.committer == null ? updateAudit.committer == null : this.committer.equals(updateAudit.committer));
  }
