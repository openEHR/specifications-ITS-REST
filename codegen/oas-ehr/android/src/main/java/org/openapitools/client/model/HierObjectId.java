...
public class HierObjectId extends UidBasedId {
  ...
  public boolean equals(Object o) {
    ...
    return (this.value == null ? hierObjectId.value == null : this.value.equals(hierObjectId.value)) &&
        (this.type == null ? hierObjectId.type == null : this.type.equals(hierObjectId.type));
  }
