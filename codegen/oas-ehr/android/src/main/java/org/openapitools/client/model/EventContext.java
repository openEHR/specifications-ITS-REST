...
public class EventContext extends Pathable {
  ...
  private DvDateTime startTime = null;
  @SerializedName("end_time")
  private DvDateTime endTime = null;
  @SerializedName("location")
  private String location = null;
  @SerializedName("setting")
  private DvCodedText setting = null;
  @SerializedName("other_context")
  private ItemStructure otherContext = null;
  @SerializedName("health_care_facility")
  private PartyIdentified healthCareFacility = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.startTime == null ? eventContext.startTime == null : this.startTime.equals(eventContext.startTime)) &&
        (this.endTime == null ? eventContext.endTime == null : this.endTime.equals(eventContext.endTime)) &&
        (this.location == null ? eventContext.location == null : this.location.equals(eventContext.location)) &&
        (this.setting == null ? eventContext.setting == null : this.setting.equals(eventContext.setting)) &&
        (this.otherContext == null ? eventContext.otherContext == null : this.otherContext.equals(eventContext.otherContext)) &&
        (this.healthCareFacility == null ? eventContext.healthCareFacility == null : this.healthCareFacility.equals(eventContext.healthCareFacility)) &&
        (this.participations == null ? eventContext.participations == null : this.participations.equals(eventContext.participations)) &&
        (this.type == null ? eventContext.type == null : this.type.equals(eventContext.type));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.otherContext == null ? 0: this.otherContext.hashCode());
    result = 31 * result + (this.healthCareFacility == null ? 0: this.healthCareFacility.hashCode());
  ...
  public String toString()  {
    ...
    sb.append("  otherContext: ").append(otherContext).append("\n");
    sb.append("  healthCareFacility: ").append(healthCareFacility).append("\n");
