...
public class DvQuantity extends DvAmount {
  ...
  private String unitsSystem = null;
  @SerializedName("units_display_name")
  private String unitsDisplayName = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? dvQuantity.type == null : this.type.equals(dvQuantity.type)) &&
        (this.magnitude == null ? dvQuantity.magnitude == null : this.magnitude.equals(dvQuantity.magnitude)) &&
        (this.precision == null ? dvQuantity.precision == null : this.precision.equals(dvQuantity.precision)) &&
        (this.units == null ? dvQuantity.units == null : this.units.equals(dvQuantity.units)) &&
        (this.unitsSystem == null ? dvQuantity.unitsSystem == null : this.unitsSystem.equals(dvQuantity.unitsSystem)) &&
        (this.unitsDisplayName == null ? dvQuantity.unitsDisplayName == null : this.unitsDisplayName.equals(dvQuantity.unitsDisplayName));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.magnitude == null ? 0: this.magnitude.hashCode());
    result = 31 * result + (this.precision == null ? 0: this.precision.hashCode());
    result = 31 * result + (this.units == null ? 0: this.units.hashCode());
    result = 31 * result + (this.unitsSystem == null ? 0: this.unitsSystem.hashCode());
    result = 31 * result + (this.unitsDisplayName == null ? 0: this.unitsDisplayName.hashCode());
    return result;
  }
  ...
  public String toString()  {
    ...
    sb.append("  unitsSystem: ").append(unitsSystem).append("\n");
    sb.append("  unitsDisplayName: ").append(unitsDisplayName).append("\n");
    sb.append("}\n");
    return sb.toString();
  }
}
