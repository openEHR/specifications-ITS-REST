...
public class AbstractEntry extends ContentItem {
  ...
  private CodePhrase language = null;
  @SerializedName("encoding")
  private CodePhrase encoding = null;
  @SerializedName("other_participations")
  private List<Participation> otherParticipations = null;
  @SerializedName("workflow_id")
  private ObjectRef workflowId = null;
  @SerializedName("subject")
  private PartyProxy subject = null;
  @SerializedName("provider")
  private PartyProxy provider = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.language == null ? abstractEntry.language == null : this.language.equals(abstractEntry.language)) &&
        (this.encoding == null ? abstractEntry.encoding == null : this.encoding.equals(abstractEntry.encoding)) &&
        (this.otherParticipations == null ? abstractEntry.otherParticipations == null : this.otherParticipations.equals(abstractEntry.otherParticipations)) &&
        (this.workflowId == null ? abstractEntry.workflowId == null : this.workflowId.equals(abstractEntry.workflowId)) &&
        (this.subject == null ? abstractEntry.subject == null : this.subject.equals(abstractEntry.subject)) &&
        (this.provider == null ? abstractEntry.provider == null : this.provider.equals(abstractEntry.provider)) &&
        (this.type == null ? abstractEntry.type == null : this.type.equals(abstractEntry.type));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.otherParticipations == null ? 0: this.otherParticipations.hashCode());
    result = 31 * result + (this.workflowId == null ? 0: this.workflowId.hashCode());
  ...
  public String toString()  {
    ...
    sb.append("  otherParticipations: ").append(otherParticipations).append("\n");
