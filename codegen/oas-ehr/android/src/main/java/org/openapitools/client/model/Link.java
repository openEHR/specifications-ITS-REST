...
public class Link {
  ...
  private DvText meaning = null;
  @SerializedName("type")
  private DvText type = null;
  @SerializedName("target")
  private DvEhrUri target = null;
  ...
  public boolean equals(Object o) {
    ...
    Link link = (Link) o;
    return (this.meaning == null ? link.meaning == null : this.meaning.equals(link.meaning)) &&
        (this.type == null ? link.type == null : this.type.equals(link.type)) &&
        (this.target == null ? link.target == null : this.target.equals(link.target));
  }

  @Override
  public int hashCode() {
    int result = 17;
    result = 31 * result + (this.meaning == null ? 0: this.meaning.hashCode());
