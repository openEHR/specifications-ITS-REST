...
public class DvState extends DataValue {
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? dvState.type == null : this.type.equals(dvState.type)) &&
        (this.value == null ? dvState.value == null : this.value.equals(dvState.value)) &&
        (this.isTerminal == null ? dvState.isTerminal == null : this.isTerminal.equals(dvState.isTerminal));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.isTerminal == null ? 0: this.isTerminal.hashCode());
    return result;
  }
