 ...
 **/
@ApiModel(description = "Type for representing identifiers of real-world entities. Typical identifiers include drivers licence number, social security number, veterans affairs number, prescription id, order id, and so on.  DV_IDENTIFIER is used to represent any identifier of a real thing, issued by some authority or agency. ")
public class DvIdentifier extends DataValue {
  ...
  public boolean equals(Object o) {
    ...
    return (this.issuer == null ? dvIdentifier.issuer == null : this.issuer.equals(dvIdentifier.issuer)) &&
        (this.assigner == null ? dvIdentifier.assigner == null : this.assigner.equals(dvIdentifier.assigner)) &&
        (this.id == null ? dvIdentifier.id == null : this.id.equals(dvIdentifier.id)) &&
        (this.type == null ? dvIdentifier.type == null : this.type.equals(dvIdentifier.type)) &&
        (this.type == null ? dvIdentifier.type == null : this.type.equals(dvIdentifier.type));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.assigner == null ? 0: this.assigner.hashCode());
