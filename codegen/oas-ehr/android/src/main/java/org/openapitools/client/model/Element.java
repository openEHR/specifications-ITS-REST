...
public class Element extends Item {
  ...
  @SerializedName("null_flavour")
  private DvCodedText nullFlavour = null;
  @SerializedName("value")
  private DataValue value = null;
  @SerializedName("null_reason")
  private DvText nullReason = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? element.type == null : this.type.equals(element.type)) &&
        (this.nullFlavour == null ? element.nullFlavour == null : this.nullFlavour.equals(element.nullFlavour)) &&
        (this.value == null ? element.value == null : this.value.equals(element.value)) &&
        (this.nullReason == null ? element.nullReason == null : this.nullReason.equals(element.nullReason));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.nullFlavour == null ? 0: this.nullFlavour.hashCode());
    result = 31 * result + (this.value == null ? 0: this.value.hashCode());
    result = 31 * result + (this.nullReason == null ? 0: this.nullReason.hashCode());
    return result;
  }
  ...
  public String toString()  {
    ...
    sb.append("  nullFlavour: ").append(nullFlavour).append("\n");
    sb.append("  value: ").append(value).append("\n");
    sb.append("  nullReason: ").append(nullReason).append("\n");
    sb.append("}\n");
    return sb.toString();
  }
}
