...
public class Observation extends CareEntry {
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? observation.type == null : this.type.equals(observation.type)) &&
        (this.data == null ? observation.data == null : this.data.equals(observation.data)) &&
        (this.state == null ? observation.state == null : this.state.equals(observation.state));
  }
