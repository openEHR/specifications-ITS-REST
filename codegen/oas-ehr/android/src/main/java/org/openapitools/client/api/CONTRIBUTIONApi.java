...
public class CONTRIBUTIONApi {
  ...
  * We will use the relaxed CONTRIBUTION with the following optional attributes:   - &#x60;uid&#x60;: when provided, it will be accepted in case is not in-use, otherwise error will be returned   - &#x60;audit.time_committed&#x60;: server will always set it   - &#x60;audit.system_id&#x60;: when provided, it will be validated 
   ...
   * @return Contribution
  */
  public Contribution contributionCreate (String ehrId, NewContribution newContribution, String prefer) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = newContribution;
    // verify the required parameter 'ehrId' is set
    if (ehrId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ehrId' when calling contributionCreate",
        new ApiException(400, "Missing the required parameter 'ehrId' when calling contributionCreate"));
    }
    // verify the required parameter 'newContribution' is set
    if (newContribution == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'newContribution' when calling contributionCreate",
        new ApiException(400, "Missing the required parameter 'newContribution' when calling contributionCreate"));
    }

    // create path and map variables
    String path = "/ehr/{ehr_id}/contribution".replaceAll("\\{" + "ehr_id" + "\\}", apiInvoker.escapeString(ehrId.toString()));
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (Contribution) ApiInvoker.deserialize(localVarResponse, "", Contribution.class);
      } else {
         return null;
      }
   ...
   * Create CONTRIBUTION
   * We will use the relaxed CONTRIBUTION with the following optional attributes:   - &#x60;uid&#x60;: when provided, it will be accepted in case is not in-use, otherwise error will be returned   - &#x60;audit.time_committed&#x60;: server will always set it   - &#x60;audit.system_id&#x60;: when provided, it will be validated 
   * @param ehrId EHR identifier taken from EHR.ehr_id.value.    * @param newContribution The CONTRIBUTION.    * @param prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;. 
  */
  public void contributionCreate (String ehrId, NewContribution newContribution, String prefer, final Response.Listener<Contribution> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = newContribution;
    ...
    // create path and map variables
    String path = "/ehr/{ehr_id}/contribution".replaceAll("\\{format\\}","json").replaceAll("\\{" + "ehr_id" + "\\}", apiInvoker.escapeString(ehrId.toString()));
      ...
      apiInvoker.invokeAPI(basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((Contribution) ApiInvoker.deserialize(localVarResponse,  "", Contribution.class));
  ...
  * Retrieves a CONTRIBUTION identified by &#x60;contribution_uid&#x60; and associated with the EHR identified by &#x60;ehr_id&#x60;. 
   ...
   * @return Contribution
  */
  public Contribution contributionGet (String ehrId, String contributionUid) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'ehrId' is set
    if (ehrId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ehrId' when calling contributionGet",
        new ApiException(400, "Missing the required parameter 'ehrId' when calling contributionGet"));
    }
    // verify the required parameter 'contributionUid' is set
    if (contributionUid == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'contributionUid' when calling contributionGet",
        new ApiException(400, "Missing the required parameter 'contributionUid' when calling contributionGet"));
    }

    // create path and map variables
    String path = "/ehr/{ehr_id}/contribution/{contribution_uid}".replaceAll("\\{" + "ehr_id" + "\\}", apiInvoker.escapeString(ehrId.toString())).replaceAll("\\{" + "contribution_uid" + "\\}", apiInvoker.escapeString(contributionUid.toString()));
   ...
   * Get CONTRIBUTION by id
   * Retrieves a CONTRIBUTION identified by &#x60;contribution_uid&#x60; and associated with the EHR identified by &#x60;ehr_id&#x60;. 
   * @param ehrId EHR identifier taken from EHR.ehr_id.value.    * @param contributionUid The CONTRIBUTION uid. 
  */
  public void contributionGet (String ehrId, String contributionUid, final Response.Listener<Contribution> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/ehr/{ehr_id}/contribution/{contribution_uid}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "ehr_id" + "\\}", apiInvoker.escapeString(ehrId.toString())).replaceAll("\\{" + "contribution_uid" + "\\}", apiInvoker.escapeString(contributionUid.toString()));
