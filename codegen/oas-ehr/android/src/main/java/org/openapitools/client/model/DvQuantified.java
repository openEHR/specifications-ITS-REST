...
public class DvQuantified extends DvOrdered {
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? dvQuantified.type == null : this.type.equals(dvQuantified.type)) &&
        (this.magnitudeStatus == null ? dvQuantified.magnitudeStatus == null : this.magnitudeStatus.equals(dvQuantified.magnitudeStatus));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.magnitudeStatus == null ? 0: this.magnitudeStatus.hashCode());
    return result;
  }
  ...
  public String toString()  {
    ...
    sb.append("  magnitudeStatus: ").append(magnitudeStatus).append("\n");
    sb.append("}\n");
    return sb.toString();
  }
}
