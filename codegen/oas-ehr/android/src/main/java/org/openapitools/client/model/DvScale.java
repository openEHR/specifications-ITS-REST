...
public class DvScale extends DvOrdered {
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? dvScale.type == null : this.type.equals(dvScale.type)) &&
        (this.symbol == null ? dvScale.symbol == null : this.symbol.equals(dvScale.symbol)) &&
        (this.value == null ? dvScale.value == null : this.value.equals(dvScale.value));
  }
