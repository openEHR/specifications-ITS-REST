...
public class Archetyped {
  ...
  @SerializedName("archetype_id")
  private ArchetypeId archetypeId = null;
  @SerializedName("template_id")
  private TemplateId templateId = null;
  @SerializedName("rm_version")
  ...
  public boolean equals(Object o) {
    ...
    return (this.archetypeId == null ? archetyped.archetypeId == null : this.archetypeId.equals(archetyped.archetypeId)) &&
        (this.templateId == null ? archetyped.templateId == null : this.templateId.equals(archetyped.templateId)) &&
        (this.rmVersion == null ? archetyped.rmVersion == null : this.rmVersion.equals(archetyped.rmVersion));
  }

  @Override
  public int hashCode() {
    int result = 17;
    result = 31 * result + (this.archetypeId == null ? 0: this.archetypeId.hashCode());
    result = 31 * result + (this.templateId == null ? 0: this.templateId.hashCode());
    result = 31 * result + (this.rmVersion == null ? 0: this.rmVersion.hashCode());
    return result;
  }
  ...
  public String toString()  {
    ...
    sb.append("  rmVersion: ").append(rmVersion).append("\n");
    sb.append("}\n");
    return sb.toString();
  }
}
