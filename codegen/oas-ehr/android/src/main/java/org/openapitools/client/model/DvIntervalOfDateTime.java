...
public class DvIntervalOfDateTime extends DvInterval {
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? dvIntervalOfDateTime.type == null : this.type.equals(dvIntervalOfDateTime.type)) &&
        (this.lower == null ? dvIntervalOfDateTime.lower == null : this.lower.equals(dvIntervalOfDateTime.lower)) &&
        (this.upper == null ? dvIntervalOfDateTime.upper == null : this.upper.equals(dvIntervalOfDateTime.upper));
  }
