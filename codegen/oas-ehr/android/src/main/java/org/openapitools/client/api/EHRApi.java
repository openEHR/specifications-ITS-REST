...
public class EHRApi {
  ...
  * Create a new &#x60;EHR&#x60; with an auto-generated identifier.  An EHR_STATUS resource needs to be always created and committed in the new EHR. This resource MAY be also supplied by the client as the request body.  If not supplied, a default EHR_STATUS will be used by the service with following attributes:   - &#x60;is_queryable&#x60;: true   - &#x60;is_modifiable&#x60;: true   - &#x60;subject&#x60;: a PARTY_SELF object  All other required EHR attributes and resources will be automatically created as needed by the [EHR creation semantics](https://specifications.openehr.org/releases/RM/latest/ehr.html#_ehr_creation_semantics). 
   ...
   * @param ehrStatus An EHR_STATUS resource MAY be also supplied by the client as the request body. 
   * @return Ehr
  */
  public Ehr ehrCreate (String prefer, EhrStatus ehrStatus) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (Ehr) ApiInvoker.deserialize(localVarResponse, "", Ehr.class);
      } else {
         return null;
      }
   ...
   * Create EHR
   * Create a new &#x60;EHR&#x60; with an auto-generated identifier.  An EHR_STATUS resource needs to be always created and committed in the new EHR. This resource MAY be also supplied by the client as the request body.  If not supplied, a default EHR_STATUS will be used by the service with following attributes:   - &#x60;is_queryable&#x60;: true   - &#x60;is_modifiable&#x60;: true   - &#x60;subject&#x60;: a PARTY_SELF object  All other required EHR attributes and resources will be automatically created as needed by the [EHR creation semantics](https://specifications.openehr.org/releases/RM/latest/ehr.html#_ehr_creation_semantics). 
   * @param prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;.    * @param ehrStatus An EHR_STATUS resource MAY be also supplied by the client as the request body. 
  */
  public void ehrCreate (String prefer, EhrStatus ehrStatus, final Response.Listener<Ehr> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = ehrStatus;
      ...
      apiInvoker.invokeAPI(basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((Ehr) ApiInvoker.deserialize(localVarResponse,  "", Ehr.class));
  ...
  * Create a new EHR with the specified &#x60;ehr_id&#x60; identifier.  The value of the &#x60;ehr_id&#x60; unique identifier MUST be valid [HIER_OBJECT_ID](https://specifications.openehr.org/releases/BASE/latest/base_types.html#_hier_object_id_class) value.  It is strongly RECOMMENDED that an UUID always be used for this.  An EHR_STATUS resource needs to be always created and committed in the new EHR. This resource MAY be also supplied by the client as the request body.  If not supplied, a default EHR_STATUS will be used by the service with following attributes:   - &#x60;is_queryable&#x60;: true   - &#x60;is_modifiable&#x60;: true   - &#x60;subject&#x60;: a PARTY_SELF object  All other required EHR attributes and resources will be automatically created as needed by the [EHR creation semantics](https://specifications.openehr.org/releases/RM/latest/ehr.html#_ehr_creation_semantics). 
   ...
   * @return Ehr
  */
  public Ehr ehrCreateWithId (String ehrId, String prefer, EhrStatus ehrStatus) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = ehrStatus;
    // verify the required parameter 'ehrId' is set
    if (ehrId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ehrId' when calling ehrCreateWithId",
        new ApiException(400, "Missing the required parameter 'ehrId' when calling ehrCreateWithId"));
    }

    // create path and map variables
    String path = "/ehr/{ehr_id}".replaceAll("\\{" + "ehr_id" + "\\}", apiInvoker.escapeString(ehrId.toString()));
   ...
   * Create EHR with id
   * Create a new EHR with the specified &#x60;ehr_id&#x60; identifier.  The value of the &#x60;ehr_id&#x60; unique identifier MUST be valid [HIER_OBJECT_ID](https://specifications.openehr.org/releases/BASE/latest/base_types.html#_hier_object_id_class) value.  It is strongly RECOMMENDED that an UUID always be used for this.  An EHR_STATUS resource needs to be always created and committed in the new EHR. This resource MAY be also supplied by the client as the request body.  If not supplied, a default EHR_STATUS will be used by the service with following attributes:   - &#x60;is_queryable&#x60;: true   - &#x60;is_modifiable&#x60;: true   - &#x60;subject&#x60;: a PARTY_SELF object  All other required EHR attributes and resources will be automatically created as needed by the [EHR creation semantics](https://specifications.openehr.org/releases/RM/latest/ehr.html#_ehr_creation_semantics). 
   * @param ehrId EHR identifier taken from EHR.ehr_id.value.    * @param prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;.    * @param ehrStatus An EHR_STATUS resource MAY be also supplied by the client as the request body. 
  */
  public void ehrCreateWithId (String ehrId, String prefer, EhrStatus ehrStatus, final Response.Listener<Ehr> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = ehrStatus;
    ...
    // create path and map variables
    String path = "/ehr/{ehr_id}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "ehr_id" + "\\}", apiInvoker.escapeString(ehrId.toString()));
  ...
  * Retrieve the EHR with the specified &#x60;ehr_id&#x60;. 
   ...
   * @return Ehr
  */
  public Ehr ehrGetById (String ehrId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'ehrId' is set
    if (ehrId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ehrId' when calling ehrGetById",
        new ApiException(400, "Missing the required parameter 'ehrId' when calling ehrGetById"));
    }
   ...
   * @param ehrId EHR identifier taken from EHR.ehr_id.value. 
  */
  public void ehrGetById (String ehrId, final Response.Listener<Ehr> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Retrieve the EHR with the specified &#x60;subject_id&#x60; and &#x60;subject_namespace&#x60;.  These subject parameters will be matched against EHR&#39;s EHR_STATUS.subject.external_ref.id.value and  EHR_STATUS.subject.external_ref.namespace values. 
   ...
   * @return Ehr
  */
  public Ehr ehrGetBySubject (String subjectId, String subjectNamespace) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'subjectId' is set
    if (subjectId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'subjectId' when calling ehrGetBySubject",
        new ApiException(400, "Missing the required parameter 'subjectId' when calling ehrGetBySubject"));
    }
    // verify the required parameter 'subjectNamespace' is set
    if (subjectNamespace == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'subjectNamespace' when calling ehrGetBySubject",
        new ApiException(400, "Missing the required parameter 'subjectNamespace' when calling ehrGetBySubject"));
    }
    ...
    // form params
    Map<String, String> formParams = new HashMap<String, String>();
    queryParams.addAll(ApiInvoker.parameterToPairs("", "subject_id", subjectId));
    queryParams.addAll(ApiInvoker.parameterToPairs("", "subject_namespace", subjectNamespace));
    String[] contentTypes = {
    };
    String contentType = contentTypes.length > 0 ? contentTypes[0] : "application/json";
   ...
   * Get EHR by subject id
   * Retrieve the EHR with the specified &#x60;subject_id&#x60; and &#x60;subject_namespace&#x60;.  These subject parameters will be matched against EHR&#39;s EHR_STATUS.subject.external_ref.id.value and  EHR_STATUS.subject.external_ref.namespace values. 
   * @param subjectId The EHR subject id.    * @param subjectNamespace The EHR subject id namespace. 
  */
  public void ehrGetBySubject (String subjectId, String subjectNamespace, final Response.Listener<Ehr> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
