...
public class DvParsable extends DvEncapsulated {
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? dvParsable.type == null : this.type.equals(dvParsable.type)) &&
        (this.value == null ? dvParsable.value == null : this.value.equals(dvParsable.value)) &&
        (this.formalism == null ? dvParsable.formalism == null : this.formalism.equals(dvParsable.formalism));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.formalism == null ? 0: this.formalism.hashCode());
    return result;
  }
  ...
  public String toString()  {
    ...
    sb.append("  formalism: ").append(formalism).append("\n");
    sb.append("}\n");
    return sb.toString();
  }
}
