...
import org.openapitools.client.model.TermMapping;
...
public class DvText extends DataValue {
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? dvText.type == null : this.type.equals(dvText.type)) &&
        (this.value == null ? dvText.value == null : this.value.equals(dvText.value)) &&
        (this.hyperlink == null ? dvText.hyperlink == null : this.hyperlink.equals(dvText.hyperlink)) &&
        (this.formatting == null ? dvText.formatting == null : this.formatting.equals(dvText.formatting)) &&
        (this.mappings == null ? dvText.mappings == null : this.mappings.equals(dvText.mappings)) &&
        (this.language == null ? dvText.language == null : this.language.equals(dvText.language)) &&
        (this.encoding == null ? dvText.encoding == null : this.encoding.equals(dvText.encoding));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.hyperlink == null ? 0: this.hyperlink.hashCode());
    result = 31 * result + (this.formatting == null ? 0: this.formatting.hashCode());
    result = 31 * result + (this.mappings == null ? 0: this.mappings.hashCode());
