...
public class DvOrdered extends DataValue {
  ...
  private CodePhrase normalStatus = null;
  @SerializedName("normal_range")
  private DvInterval normalRange = null;
  @SerializedName("other_reference_ranges")
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? dvOrdered.type == null : this.type.equals(dvOrdered.type)) &&
        (this.normalStatus == null ? dvOrdered.normalStatus == null : this.normalStatus.equals(dvOrdered.normalStatus)) &&
        (this.normalRange == null ? dvOrdered.normalRange == null : this.normalRange.equals(dvOrdered.normalRange)) &&
        (this.otherReferenceRanges == null ? dvOrdered.otherReferenceRanges == null : this.otherReferenceRanges.equals(dvOrdered.otherReferenceRanges));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.normalStatus == null ? 0: this.normalStatus.hashCode());
    result = 31 * result + (this.normalRange == null ? 0: this.normalRange.hashCode());
    result = 31 * result + (this.otherReferenceRanges == null ? 0: this.otherReferenceRanges.hashCode());
    return result;
  }
  ...
  public String toString()  {
    ...
    sb.append("  normalStatus: ").append(normalStatus).append("\n");
    sb.append("  normalRange: ").append(normalRange).append("\n");
    sb.append("  otherReferenceRanges: ").append(otherReferenceRanges).append("\n");
    sb.append("}\n");
    return sb.toString();
  }
}
