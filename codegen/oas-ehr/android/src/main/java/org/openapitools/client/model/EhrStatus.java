 ...
 **/
@ApiModel(description = "An EHR_STATUS resource")
public class EhrStatus extends Versionable {
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? ehrStatus.type == null : this.type.equals(ehrStatus.type)) &&
        (this.subject == null ? ehrStatus.subject == null : this.subject.equals(ehrStatus.subject)) &&
        (this.isQueryable == null ? ehrStatus.isQueryable == null : this.isQueryable.equals(ehrStatus.isQueryable)) &&
        (this.isModifiable == null ? ehrStatus.isModifiable == null : this.isModifiable.equals(ehrStatus.isModifiable)) &&
        (this.otherDetails == null ? ehrStatus.otherDetails == null : this.otherDetails.equals(ehrStatus.otherDetails));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.isModifiable == null ? 0: this.isModifiable.hashCode());
