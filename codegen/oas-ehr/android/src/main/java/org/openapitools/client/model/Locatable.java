...
import org.openapitools.client.model.FeederAudit;
...
public class Locatable extends Pathable {
  ...
  @SerializedName("name")
  private DvText name = null;
  @SerializedName("archetype_node_id")
  private String archetypeNodeId = null;
  @SerializedName("uid")
  private UidBasedId uid = null;
  @SerializedName("links")
  private List<Link> links = null;
  @SerializedName("archetype_details")
  private Archetyped archetypeDetails = null;
  @SerializedName("feeder_audit")
  private FeederAudit feederAudit = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.name == null ? locatable.name == null : this.name.equals(locatable.name)) &&
        (this.archetypeNodeId == null ? locatable.archetypeNodeId == null : this.archetypeNodeId.equals(locatable.archetypeNodeId)) &&
        (this.uid == null ? locatable.uid == null : this.uid.equals(locatable.uid)) &&
        (this.links == null ? locatable.links == null : this.links.equals(locatable.links)) &&
        (this.archetypeDetails == null ? locatable.archetypeDetails == null : this.archetypeDetails.equals(locatable.archetypeDetails)) &&
        (this.feederAudit == null ? locatable.feederAudit == null : this.feederAudit.equals(locatable.feederAudit)) &&
        (this.type == null ? locatable.type == null : this.type.equals(locatable.type));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.archetypeNodeId == null ? 0: this.archetypeNodeId.hashCode());
    result = 31 * result + (this.uid == null ? 0: this.uid.hashCode());
    result = 31 * result + (this.links == null ? 0: this.links.hashCode());
    result = 31 * result + (this.archetypeDetails == null ? 0: this.archetypeDetails.hashCode());
    result = 31 * result + (this.feederAudit == null ? 0: this.feederAudit.hashCode());
  ...
  public String toString()  {
    ...
    sb.append("  archetypeNodeId: ").append(archetypeNodeId).append("\n");
    sb.append("  uid: ").append(uid).append("\n");
    sb.append("  links: ").append(links).append("\n");
    sb.append("  archetypeDetails: ").append(archetypeDetails).append("\n");
    sb.append("  feederAudit: ").append(feederAudit).append("\n");
