...
/**
 * Check if a given object implements the UpdateAudit interface.
 */
export function instanceOfUpdateAudit(value: object): boolean {
    let isInstance = true;
...
export function UpdateAuditFromJSON(json: any): UpdateAudit {
    return UpdateAuditFromJSONTyped(json, false);
}

export function UpdateAuditFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateAudit {
...
export function UpdateAuditToJSON(value?: UpdateAudit | null): any {
    ...
    return {
        ...
        '_type': value.type,
        'change_type': TerminologyCodeToJSON(value.changeType),
