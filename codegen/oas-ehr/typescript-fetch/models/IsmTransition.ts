...
/**
 * Check if a given object implements the IsmTransition interface.
 */
export function instanceOfIsmTransition(value: object): boolean {
    let isInstance = true;
...
export function IsmTransitionFromJSON(json: any): IsmTransition {
    return IsmTransitionFromJSONTyped(json, false);
}

export function IsmTransitionFromJSONTyped(json: any, ignoreDiscriminator: boolean): IsmTransition {
    ...
    return {
        ...
        'currentState': DvCodedTextFromJSON(json['current_state']),
        'transition': !exists(json, 'transition') ? undefined : DvCodedTextFromJSON(json['transition']),
        'careflowStep': !exists(json, 'careflow_step') ? undefined : DvCodedTextFromJSON(json['careflow_step']),
        'reason': !exists(json, 'reason') ? undefined : ((json['reason'] as Array<any>).map(DvTextFromJSON)),
    };
}

export function IsmTransitionToJSON(value?: IsmTransition | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        '_type': value.type,
        'current_state': DvCodedTextToJSON(value.currentState),
        'transition': DvCodedTextToJSON(value.transition),
        'careflow_step': DvCodedTextToJSON(value.careflowStep),
        'reason': value.reason === undefined ? undefined : ((value.reason as Array<any>).map(DvTextToJSON)),
    };
}
