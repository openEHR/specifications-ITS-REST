 ...
 */
export function instanceOfRevisionHistoryItem(value: object): boolean {
    let isInstance = true;
...
export function RevisionHistoryItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): RevisionHistoryItem {
    ...
    return {
        ...
        'versionId': ObjectVersionIdFromJSON(json['version_id']),
        'audits': ((json['audits'] as Array<any>).map(AuditDetailsFromJSON)),
    };
}

export function RevisionHistoryItemToJSON(value?: RevisionHistoryItem | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'version_id': ObjectVersionIdToJSON(value.versionId),
        'audits': ((value.audits as Array<any>).map(AuditDetailsToJSON)),
    };
}
