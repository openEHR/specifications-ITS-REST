...
import type { DvIntervalOfDateTime } from './DvIntervalOfDateTime';
import {
    DvIntervalOfDateTimeFromJSON,
    DvIntervalOfDateTimeFromJSONTyped,
    DvIntervalOfDateTimeToJSON,
} from './DvIntervalOfDateTime';
...
/**
 * Check if a given object implements the Participation interface.
 */
export function instanceOfParticipation(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "_function" in value;
    isInstance = isInstance && "performer" in value;

    return isInstance;
}

export function ParticipationFromJSON(json: any): Participation {
    return ParticipationFromJSONTyped(json, false);
}

export function ParticipationFromJSONTyped(json: any, ignoreDiscriminator: boolean): Participation {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        '_function': DvTextFromJSON(json['function']),
        'mode': !exists(json, 'mode') ? undefined : DvCodedTextFromJSON(json['mode']),
        'performer': PartyProxyFromJSON(json['performer']),
        'time': !exists(json, 'time') ? undefined : DvIntervalOfDateTimeFromJSON(json['time']),
    };
}

export function ParticipationToJSON(value?: Participation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'function': DvTextToJSON(value._function),
        'mode': DvCodedTextToJSON(value.mode),
        'performer': PartyProxyToJSON(value.performer),
        'time': DvIntervalOfDateTimeToJSON(value.time),
    };
}
