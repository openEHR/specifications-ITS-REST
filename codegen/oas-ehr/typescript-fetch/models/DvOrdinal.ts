...
/**
 * Check if a given object implements the DvOrdinal interface.
 */
export function instanceOfDvOrdinal(value: object): boolean {
    let isInstance = true;
...
export function DvOrdinalFromJSON(json: any): DvOrdinal {
    return DvOrdinalFromJSONTyped(json, false);
}

export function DvOrdinalFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvOrdinal {
    ...
    return {
        ...
        'symbol': DvCodedTextFromJSON(json['symbol']),
        'value': json['value'],
    };
}

export function DvOrdinalToJSON(value?: DvOrdinal | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        '_type': value.type,
        'symbol': DvCodedTextToJSON(value.symbol),
        'value': value.value,
    };
}
