...
/**
 * Check if a given object implements the DvIdentifier interface.
 */
export function instanceOfDvIdentifier(value: object): boolean {
    let isInstance = true;
...
export function DvIdentifierFromJSON(json: any): DvIdentifier {
    return DvIdentifierFromJSONTyped(json, false);
}

export function DvIdentifierFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvIdentifier {
    ...
    return {
        ...
        'assigner': !exists(json, 'assigner') ? undefined : json['assigner'],
        'id': json['id'],
        'type': !exists(json, 'type') ? undefined : json['type'],
    };
}

export function DvIdentifierToJSON(value?: DvIdentifier | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
