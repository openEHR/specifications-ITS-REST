...
export function FolderFromJSONTyped(json: any, ignoreDiscriminator: boolean): Folder {
    ...
    return {
        ...
        'items': !exists(json, 'items') ? undefined : ((json['items'] as Array<any>).map(ObjectRefFromJSON)),
        'folders': !exists(json, 'folders') ? undefined : ((json['folders'] as Array<any>).map(FolderFromJSON)),
        'details': !exists(json, 'details') ? undefined : ItemStructureFromJSON(json['details']),
    };
}
...
export function FolderToJSON(value?: Folder | null): any {
    ...
    return {
        ...
        '_type': value.type,
        'items': value.items === undefined ? undefined : ((value.items as Array<any>).map(ObjectRefToJSON)),
        'folders': value.folders === undefined ? undefined : ((value.folders as Array<any>).map(FolderToJSON)),
        'details': ItemStructureToJSON(value.details),
    };
}
