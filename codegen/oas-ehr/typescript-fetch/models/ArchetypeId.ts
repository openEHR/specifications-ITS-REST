...
/**
 * Check if a given object implements the ArchetypeId interface.
 */
export function instanceOfArchetypeId(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ArchetypeIdFromJSON(json: any): ArchetypeId {
    return ArchetypeIdFromJSONTyped(json, false);
}

export function ArchetypeIdFromJSONTyped(json: any, ignoreDiscriminator: boolean): ArchetypeId {
...
export function ArchetypeIdToJSON(value?: ArchetypeId | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
