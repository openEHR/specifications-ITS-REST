...
/**
 * Check if a given object implements the TerminologyCode interface.
 */
export function instanceOfTerminologyCode(value: object): boolean {
    let isInstance = true;
...
export function TerminologyCodeFromJSON(json: any): TerminologyCode {
    return TerminologyCodeFromJSONTyped(json, false);
}

export function TerminologyCodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): TerminologyCode {
    ...
    return {
        ...
        'terminologyVersion': !exists(json, 'terminology_version') ? undefined : json['terminology_version'],
        'codeString': json['code_string'],
        'uri': !exists(json, 'uri') ? undefined : json['uri'],
    };
}

export function TerminologyCodeToJSON(value?: TerminologyCode | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'terminology_id': value.terminologyId,
        'terminology_version': value.terminologyVersion,
