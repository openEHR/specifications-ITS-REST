...
import type { CodePhrase } from './CodePhrase';
import {
    CodePhraseFromJSON,
    CodePhraseFromJSONTyped,
    CodePhraseToJSON,
} from './CodePhrase';
...
import type { DvMultimedia } from './DvMultimedia';
import {
    DvMultimediaFromJSON,
    DvMultimediaFromJSONTyped,
    DvMultimediaToJSON,
} from './DvMultimedia';
import type { DvUri } from './DvUri';
import {
    DvUriFromJSON,
    DvUriFromJSONTyped,
    DvUriToJSON,
...
/**
 * Check if a given object implements the DvMultimedia interface.
 */
export function instanceOfDvMultimedia(value: object): boolean {
    let isInstance = true;
...
export function DvMultimediaFromJSON(json: any): DvMultimedia {
    return DvMultimediaFromJSONTyped(json, false);
}

export function DvMultimediaFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvMultimedia {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        ...DvEncapsulatedFromJSONTyped(json, ignoreDiscriminator),
        'type': !exists(json, '_type') ? undefined : json['_type'],
        'alternateText': !exists(json, 'alternate_text') ? undefined : json['alternate_text'],
        'uri': !exists(json, 'uri') ? undefined : DvUriFromJSON(json['uri']),
        'data': !exists(json, 'data') ? undefined : json['data'],
        'mediaType': CodePhraseFromJSON(json['media_type']),
        'compressionAlgorithm': !exists(json, 'compression_algorithm') ? undefined : CodePhraseFromJSON(json['compression_algorithm']),
        'integrityCheck': !exists(json, 'integrity_check') ? undefined : json['integrity_check'],
        'integrityCheckAlgorithm': !exists(json, 'integrity_check_algorithm') ? undefined : CodePhraseFromJSON(json['integrity_check_algorithm']),
        'thumbnail': !exists(json, 'thumbnail') ? undefined : DvMultimediaFromJSON(json['thumbnail']),
        'size': json['size'],
    };
}

export function DvMultimediaToJSON(value?: DvMultimedia | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...DvEncapsulatedToJSON(value),
        '_type': value.type,
        'alternate_text': value.alternateText,
        'uri': DvUriToJSON(value.uri),
        'data': value.data,
        'media_type': CodePhraseToJSON(value.mediaType),
        'compression_algorithm': CodePhraseToJSON(value.compressionAlgorithm),
        'integrity_check': value.integrityCheck,
        'integrity_check_algorithm': CodePhraseToJSON(value.integrityCheckAlgorithm),
        'thumbnail': DvMultimediaToJSON(value.thumbnail),
        'size': value.size,
    };
}
