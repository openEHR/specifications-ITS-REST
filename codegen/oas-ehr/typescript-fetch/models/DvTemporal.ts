...
import type { DvDuration } from './DvDuration';
import {
    DvDurationFromJSON,
    DvDurationFromJSONTyped,
    DvDurationToJSON,
} from './DvDuration';
import type { DvQuantified } from './DvQuantified';
import {
    DvQuantifiedFromJSON,
...
/**
 * Check if a given object implements the DvTemporal interface.
 */
export function instanceOfDvTemporal(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DvTemporalFromJSON(json: any): DvTemporal {
    return DvTemporalFromJSONTyped(json, false);
}

export function DvTemporalFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvTemporal {
    ...
    return {
        ...DvQuantifiedFromJSONTyped(json, ignoreDiscriminator),
        'type': !exists(json, '_type') ? undefined : json['_type'],
        'accuracy': !exists(json, 'accuracy') ? undefined : DvDurationFromJSON(json['accuracy']),
    };
}

export function DvTemporalToJSON(value?: DvTemporal | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...DvQuantifiedToJSON(value),
        '_type': value.type,
        'accuracy': DvDurationToJSON(value.accuracy),
    };
}
