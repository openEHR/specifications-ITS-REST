...
import type { VersionedObject } from './VersionedObject';
import {
    VersionedObjectFromJSON,
    VersionedObjectFromJSONTyped,
    VersionedObjectToJSON,
} from './VersionedObject';
...
/**
 * Check if a given object implements the VersionedComposition interface.
 */
export function instanceOfVersionedComposition(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function VersionedCompositionFromJSON(json: any): VersionedComposition {
    return VersionedCompositionFromJSONTyped(json, false);
}

export function VersionedCompositionFromJSONTyped(json: any, ignoreDiscriminator: boolean): VersionedComposition {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        ...VersionedObjectFromJSONTyped(json, ignoreDiscriminator),
        'type': !exists(json, '_type') ? undefined : json['_type'],
    };
}

export function VersionedCompositionToJSON(value?: VersionedComposition | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
