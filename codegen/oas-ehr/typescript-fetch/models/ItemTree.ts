...
/**
 * Check if a given object implements the ItemTree interface.
 */
export function instanceOfItemTree(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ItemTreeFromJSON(json: any): ItemTree {
    return ItemTreeFromJSONTyped(json, false);
}

export function ItemTreeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ItemTree {
...
export function ItemTreeToJSON(value?: ItemTree | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
