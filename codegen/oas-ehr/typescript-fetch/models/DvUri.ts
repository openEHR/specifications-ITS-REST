...
/**
 * Check if a given object implements the DvUri interface.
 */
export function instanceOfDvUri(value: object): boolean {
    let isInstance = true;
...
export function DvUriFromJSON(json: any): DvUri {
    return DvUriFromJSONTyped(json, false);
}

export function DvUriFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvUri {
...
export function DvUriToJSON(value?: DvUri | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
