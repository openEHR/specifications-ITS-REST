 ...
 */
export function instanceOfObservation(value: object): boolean {
    let isInstance = true;
...
export function ObservationFromJSONTyped(json: any, ignoreDiscriminator: boolean): Observation {
    ...
    return {
        ...
        'data': HistoryFromJSON(json['data']),
        'state': !exists(json, 'state') ? undefined : HistoryFromJSON(json['state']),
    };
}

export function ObservationToJSON(value?: Observation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        '_type': value.type,
        'data': HistoryToJSON(value.data),
        'state': HistoryToJSON(value.state),
    };
}
