...
/**
 * Check if a given object implements the DvBoolean interface.
 */
export function instanceOfDvBoolean(value: object): boolean {
    let isInstance = true;
...
export function DvBooleanFromJSON(json: any): DvBoolean {
    return DvBooleanFromJSONTyped(json, false);
}

export function DvBooleanFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvBoolean {
...
export function DvBooleanToJSON(value?: DvBoolean | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
