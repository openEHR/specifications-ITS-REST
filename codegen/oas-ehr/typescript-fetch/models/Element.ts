...
export function ElementFromJSONTyped(json: any, ignoreDiscriminator: boolean): Element {
    ...
    return {
        ...
        'nullFlavour': !exists(json, 'null_flavour') ? undefined : DvCodedTextFromJSON(json['null_flavour']),
        'value': !exists(json, 'value') ? undefined : DataValueFromJSON(json['value']),
        'nullReason': !exists(json, 'null_reason') ? undefined : DvTextFromJSON(json['null_reason']),
    };
}
...
export function ElementToJSON(value?: Element | null): any {
    ...
    return {
        ...ItemToJSON(value),
        '_type': value.type,
        'null_flavour': DvCodedTextToJSON(value.nullFlavour),
        'value': DataValueToJSON(value.value),
        'null_reason': DvTextToJSON(value.nullReason),
    };
}
