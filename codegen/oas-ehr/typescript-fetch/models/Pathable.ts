...
/**
 * Check if a given object implements the Pathable interface.
 */
export function instanceOfPathable(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PathableFromJSON(json: any): Pathable {
    return PathableFromJSONTyped(json, false);
}

export function PathableFromJSONTyped(json: any, ignoreDiscriminator: boolean): Pathable {
    ...
    if (!ignoreDiscriminator) {
        ...
        if (json['type'] === 'InstructionDetails') {
            return InstructionDetailsFromJSONTyped(json, true);
        }
        if (json['type'] === 'IsmTransition') {
            return IsmTransitionFromJSONTyped(json, true);
        }
        if (json['type'] === 'Item') {
            return ItemFromJSONTyped(json, true);
        ...
        if (json['type'] === 'ItemSingle') {
            return ItemSingleFromJSONTyped(json, true);
        }
        if (json['type'] === 'ItemStructure') {
            return ItemStructureFromJSONTyped(json, true);
        }
        if (json['type'] === 'ItemTable') {
            return ItemTableFromJSONTyped(json, true);
        }
        if (json['type'] === 'ItemTree') {
            return ItemTreeFromJSONTyped(json, true);
        }
...
export function PathableToJSON(value?: Pathable | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
