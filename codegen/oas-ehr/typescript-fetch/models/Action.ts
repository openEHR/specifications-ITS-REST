...
import type { InstructionDetails } from './InstructionDetails';
import {
    InstructionDetailsFromJSON,
    InstructionDetailsFromJSONTyped,
    InstructionDetailsToJSON,
} from './InstructionDetails';
import type { IsmTransition } from './IsmTransition';
import {
    IsmTransitionFromJSON,
    IsmTransitionFromJSONTyped,
    IsmTransitionToJSON,
} from './IsmTransition';
...
export function instanceOfAction(value: object): boolean {
    ...
    isInstance = isInstance && "ismTransition" in value;
...
export function ActionFromJSONTyped(json: any, ignoreDiscriminator: boolean): Action {
    ...
    return {
        ...CareEntryFromJSONTyped(json, ignoreDiscriminator),
        'type': !exists(json, '_type') ? undefined : json['_type'],
        'time': DvDateTimeFromJSON(json['time']),
        'ismTransition': IsmTransitionFromJSON(json['ism_transition']),
        'instructionDetails': !exists(json, 'instruction_details') ? undefined : InstructionDetailsFromJSON(json['instruction_details']),
        'description': ItemStructureFromJSON(json['description']),
    };
}
...
export function ActionToJSON(value?: Action | null): any {
    ...
    return {
        ...CareEntryToJSON(value),
        '_type': value.type,
        'time': DvDateTimeToJSON(value.time),
        'ism_transition': IsmTransitionToJSON(value.ismTransition),
        'instruction_details': InstructionDetailsToJSON(value.instructionDetails),
        'description': ItemStructureToJSON(value.description),
    };
}
