...
import type { DvEhrUri } from './DvEhrUri';
import {
    DvEhrUriFromJSON,
...
/**
 * Check if a given object implements the UpdateAttestation interface.
 */
export function instanceOfUpdateAttestation(value: object): boolean {
    let isInstance = true;
...
export function UpdateAttestationFromJSON(json: any): UpdateAttestation {
    return UpdateAttestationFromJSONTyped(json, false);
}

export function UpdateAttestationFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateAttestation {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        ...UpdateAuditFromJSONTyped(json, ignoreDiscriminator),
        'type': !exists(json, '_type') ? undefined : json['_type'],
        'attestedView': !exists(json, 'attested_view') ? undefined : DvMultimediaFromJSON(json['attested_view']),
        'proof': !exists(json, 'proof') ? undefined : json['proof'],
        'items': !exists(json, 'items') ? undefined : ((json['items'] as Array<any>).map(DvEhrUriFromJSON)),
        'reason': DvTextFromJSON(json['reason']),
        'isPending': json['is_pending'],
    };
}

export function UpdateAttestationToJSON(value?: UpdateAttestation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...UpdateAuditToJSON(value),
        '_type': value.type,
        'attested_view': DvMultimediaToJSON(value.attestedView),
        'proof': value.proof,
        'items': value.items === undefined ? undefined : ((value.items as Array<any>).map(DvEhrUriToJSON)),
        'reason': DvTextToJSON(value.reason),
