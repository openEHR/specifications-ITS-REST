...
/**
 * Check if a given object implements the DvDate interface.
 */
export function instanceOfDvDate(value: object): boolean {
    let isInstance = true;
...
export function DvDateFromJSON(json: any): DvDate {
    return DvDateFromJSONTyped(json, false);
}

export function DvDateFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvDate {
...
export function DvDateToJSON(value?: DvDate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
