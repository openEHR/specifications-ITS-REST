...
/**
 * Check if a given object implements the DvCodedText interface.
 */
export function instanceOfDvCodedText(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "definingCode" in value;

    return isInstance;
}

export function DvCodedTextFromJSON(json: any): DvCodedText {
    return DvCodedTextFromJSONTyped(json, false);
}

export function DvCodedTextFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvCodedText {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        ...DvTextFromJSONTyped(json, ignoreDiscriminator),
        'type': !exists(json, '_type') ? undefined : json['_type'],
        'definingCode': CodePhraseFromJSON(json['defining_code']),
    };
}

export function DvCodedTextToJSON(value?: DvCodedText | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...DvTextToJSON(value),
        '_type': value.type,
        'defining_code': CodePhraseToJSON(value.definingCode),
    };
}
