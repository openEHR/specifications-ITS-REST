...
/**
 * Check if a given object implements the TermMapping interface.
 */
export function instanceOfTermMapping(value: object): boolean {
    let isInstance = true;
...
export function TermMappingFromJSON(json: any): TermMapping {
    return TermMappingFromJSONTyped(json, false);
}

export function TermMappingFromJSONTyped(json: any, ignoreDiscriminator: boolean): TermMapping {
    ...
    return {
        ...
        'match': json['match'],
        'purpose': !exists(json, 'purpose') ? undefined : DvCodedTextFromJSON(json['purpose']),
        'target': CodePhraseFromJSON(json['target']),
    };
}

export function TermMappingToJSON(value?: TermMapping | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'match': value.match,
        'purpose': DvCodedTextToJSON(value.purpose),
        'target': CodePhraseToJSON(value.target),
    };
}
