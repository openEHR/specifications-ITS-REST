...
import type { DvCodedText } from './DvCodedText';
import {
    DvCodedTextFromJSON,
    DvCodedTextFromJSONTyped,
    DvCodedTextToJSON,
} from './DvCodedText';
import type { DvDateTime } from './DvDateTime';
import {
    DvDateTimeFromJSON,
    DvDateTimeFromJSONTyped,
    DvDateTimeToJSON,
} from './DvDateTime';
import type { ItemStructure } from './ItemStructure';
import {
    ItemStructureFromJSON,
    ItemStructureFromJSONTyped,
    ItemStructureToJSON,
} from './ItemStructure';
import type { Participation } from './Participation';
import {
    ParticipationFromJSON,
    ParticipationFromJSONTyped,
    ParticipationToJSON,
} from './Participation';
import type { PartyIdentified } from './PartyIdentified';
import {
    PartyIdentifiedFromJSON,
    PartyIdentifiedFromJSONTyped,
    PartyIdentifiedToJSON,
} from './PartyIdentified';
import type { Pathable } from './Pathable';
import {
    PathableFromJSON,
    PathableFromJSONTyped,
    PathableToJSON,
} from './Pathable';
...
/**
 * Check if a given object implements the EventContext interface.
 */
export function instanceOfEventContext(value: object): boolean {
    let isInstance = true;
...
export function EventContextFromJSON(json: any): EventContext {
    return EventContextFromJSONTyped(json, false);
}

export function EventContextFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventContext {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        ...PathableFromJSONTyped(json, ignoreDiscriminator),
        'startTime': DvDateTimeFromJSON(json['start_time']),
        'endTime': !exists(json, 'end_time') ? undefined : DvDateTimeFromJSON(json['end_time']),
        'location': !exists(json, 'location') ? undefined : json['location'],
        'setting': DvCodedTextFromJSON(json['setting']),
        'otherContext': !exists(json, 'other_context') ? undefined : ItemStructureFromJSON(json['other_context']),
        'healthCareFacility': !exists(json, 'health_care_facility') ? undefined : PartyIdentifiedFromJSON(json['health_care_facility']),
        'participations': !exists(json, 'participations') ? undefined : ((json['participations'] as Array<any>).map(ParticipationFromJSON)),
    };
}

export function EventContextToJSON(value?: EventContext | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...PathableToJSON(value),
        'start_time': DvDateTimeToJSON(value.startTime),
        'end_time': DvDateTimeToJSON(value.endTime),
        'location': value.location,
        'setting': DvCodedTextToJSON(value.setting),
        'other_context': ItemStructureToJSON(value.otherContext),
        'health_care_facility': PartyIdentifiedToJSON(value.healthCareFacility),
        'participations': value.participations === undefined ? undefined : ((value.participations as Array<any>).map(ParticipationToJSON)),
    };
}
