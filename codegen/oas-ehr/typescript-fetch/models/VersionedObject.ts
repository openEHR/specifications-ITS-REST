...
/**
 * Check if a given object implements the VersionedObject interface.
 */
export function instanceOfVersionedObject(value: object): boolean {
    let isInstance = true;
...
export function VersionedObjectFromJSON(json: any): VersionedObject {
    return VersionedObjectFromJSONTyped(json, false);
}

export function VersionedObjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): VersionedObject {
    ...
    return {
        ...
        'uid': HierObjectIdFromJSON(json['uid']),
        'ownerId': ObjectRefFromJSON(json['owner_id']),
        'timeCreated': DvDateTimeFromJSON(json['time_created']),
    };
}

export function VersionedObjectToJSON(value?: VersionedObject | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'owner_id': ObjectRefToJSON(value.ownerId),
