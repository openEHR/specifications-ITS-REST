...
/**
 * Check if a given object implements the Composition interface.
 */
export function instanceOfComposition(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "language" in value;
    isInstance = isInstance && "territory" in value;
    isInstance = isInstance && "category" in value;
    isInstance = isInstance && "context" in value;
    isInstance = isInstance && "composer" in value;
    isInstance = isInstance && "content" in value;

    return isInstance;
}

export function CompositionFromJSON(json: any): Composition {
    return CompositionFromJSONTyped(json, false);
}

export function CompositionFromJSONTyped(json: any, ignoreDiscriminator: boolean): Composition {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        ...VersionableFromJSONTyped(json, ignoreDiscriminator),
        'type': !exists(json, '_type') ? undefined : json['_type'],
        'language': CodePhraseFromJSON(json['language']),
        'territory': CodePhraseFromJSON(json['territory']),
        'category': DvCodedTextFromJSON(json['category']),
        'context': EventContextFromJSON(json['context']),
        'composer': PartyProxyFromJSON(json['composer']),
        'content': ((json['content'] as Array<any>).map(ContentItemFromJSON)),
    };
}

export function CompositionToJSON(value?: Composition | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...VersionableToJSON(value),
        '_type': value.type,
        'language': CodePhraseToJSON(value.language),
        'territory': CodePhraseToJSON(value.territory),
        'category': DvCodedTextToJSON(value.category),
        'context': EventContextToJSON(value.context),
        'composer': PartyProxyToJSON(value.composer),
        'content': ((value.content as Array<any>).map(ContentItemToJSON)),
    };
}
