...
import type { RevisionHistoryItem } from './RevisionHistoryItem';
import {
    RevisionHistoryItemFromJSON,
    RevisionHistoryItemFromJSONTyped,
    RevisionHistoryItemToJSON,
} from './RevisionHistoryItem';
...
/**
 * Check if a given object implements the RevisionHistory interface.
 */
export function instanceOfRevisionHistory(value: object): boolean {
    let isInstance = true;
...
export function RevisionHistoryFromJSON(json: any): RevisionHistory {
    return RevisionHistoryFromJSONTyped(json, false);
}

export function RevisionHistoryFromJSONTyped(json: any, ignoreDiscriminator: boolean): RevisionHistory {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'items': ((json['items'] as Array<any>).map(RevisionHistoryItemFromJSON)),
    };
}

export function RevisionHistoryToJSON(value?: RevisionHistory | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'items': ((value.items as Array<any>).map(RevisionHistoryItemToJSON)),
    };
}
