...
/**
 * Check if a given object implements the DvDuration interface.
 */
export function instanceOfDvDuration(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DvDurationFromJSON(json: any): DvDuration {
    return DvDurationFromJSONTyped(json, false);
}

export function DvDurationFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvDuration {
...
export function DvDurationToJSON(value?: DvDuration | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
