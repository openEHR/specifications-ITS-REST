...
/**
 * Check if a given object implements the GenericId interface.
 */
export function instanceOfGenericId(value: object): boolean {
    let isInstance = true;
...
export function GenericIdFromJSON(json: any): GenericId {
    return GenericIdFromJSONTyped(json, false);
}

export function GenericIdFromJSONTyped(json: any, ignoreDiscriminator: boolean): GenericId {
...
export function GenericIdToJSON(value?: GenericId | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
