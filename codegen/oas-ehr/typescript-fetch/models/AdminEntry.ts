...
/**
 * Check if a given object implements the AdminEntry interface.
 */
export function instanceOfAdminEntry(value: object): boolean {
    let isInstance = true;
...
export function AdminEntryFromJSON(json: any): AdminEntry {
    return AdminEntryFromJSONTyped(json, false);
}

export function AdminEntryFromJSONTyped(json: any, ignoreDiscriminator: boolean): AdminEntry {
    ...
    return {
        ...
        'data': ItemStructureFromJSON(json['data']),
    };
}

export function AdminEntryToJSON(value?: AdminEntry | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        '_type': value.type,
        'data': ItemStructureToJSON(value.data),
    };
}
