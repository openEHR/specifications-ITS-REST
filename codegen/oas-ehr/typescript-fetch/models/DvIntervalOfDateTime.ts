...
/**
 * Check if a given object implements the DvIntervalOfDateTime interface.
 */
export function instanceOfDvIntervalOfDateTime(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DvIntervalOfDateTimeFromJSON(json: any): DvIntervalOfDateTime {
    return DvIntervalOfDateTimeFromJSONTyped(json, false);
}

export function DvIntervalOfDateTimeFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvIntervalOfDateTime {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        ...DvIntervalFromJSONTyped(json, ignoreDiscriminator),
        'type': !exists(json, '_type') ? undefined : json['_type'],
        'lower': !exists(json, 'lower') ? undefined : DvDateTimeFromJSON(json['lower']),
        'upper': !exists(json, 'upper') ? undefined : DvDateTimeFromJSON(json['upper']),
    };
}

export function DvIntervalOfDateTimeToJSON(value?: DvIntervalOfDateTime | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...DvIntervalToJSON(value),
        '_type': value.type,
        'lower': DvDateTimeToJSON(value.lower),
        'upper': DvDateTimeToJSON(value.upper),
    };
}
