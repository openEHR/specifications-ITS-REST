...
import type { TerminologyId } from './TerminologyId';
import {
    TerminologyIdFromJSON,
...
/**
 * Check if a given object implements the CodePhrase interface.
 */
export function instanceOfCodePhrase(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "terminologyId" in value;
    isInstance = isInstance && "codeString" in value;

    return isInstance;
}

export function CodePhraseFromJSON(json: any): CodePhrase {
    return CodePhraseFromJSONTyped(json, false);
}

export function CodePhraseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CodePhrase {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'terminologyId': TerminologyIdFromJSON(json['terminology_id']),
        'codeString': json['code_string'],
        'preferredTerm': !exists(json, 'preferred_term') ? undefined : json['preferred_term'],
    };
}

export function CodePhraseToJSON(value?: CodePhrase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'terminology_id': TerminologyIdToJSON(value.terminologyId),
