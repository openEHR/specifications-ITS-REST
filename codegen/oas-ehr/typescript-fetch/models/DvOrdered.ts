...
import type { DvInterval } from './DvInterval';
import {
    DvIntervalFromJSON,
...
import {
    ...
    ReferenceRangeFromJSONTyped,
    ReferenceRangeToJSON,
} from './ReferenceRange';

import {
     DvAmountFromJSONTyped,
     DvCountFromJSONTyped,
     DvDateFromJSONTyped,
     DvDateTimeFromJSONTyped,
     DvDurationFromJSONTyped,
     DvOrdinalFromJSONTyped,
     DvProportionFromJSONTyped,
     DvQuantifiedFromJSONTyped,
     DvQuantityFromJSONTyped,
     DvScaleFromJSONTyped,
...
/**
 * Check if a given object implements the DvOrdered interface.
 */
export function instanceOfDvOrdered(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DvOrderedFromJSON(json: any): DvOrdered {
    return DvOrderedFromJSONTyped(json, false);
}

export function DvOrderedFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvOrdered {
    ...
    return {
        ...DataValueFromJSONTyped(json, ignoreDiscriminator),
        'type': !exists(json, '_type') ? undefined : json['_type'],
        'normalStatus': !exists(json, 'normal_status') ? undefined : CodePhraseFromJSON(json['normal_status']),
        'normalRange': !exists(json, 'normal_range') ? undefined : DvIntervalFromJSON(json['normal_range']),
        'otherReferenceRanges': !exists(json, 'other_reference_ranges') ? undefined : ((json['other_reference_ranges'] as Array<any>).map(ReferenceRangeFromJSON)),
    };
}

export function DvOrderedToJSON(value?: DvOrdered | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...DataValueToJSON(value),
        '_type': value.type,
        'normal_status': CodePhraseToJSON(value.normalStatus),
        'normal_range': DvIntervalToJSON(value.normalRange),
        'other_reference_ranges': value.otherReferenceRanges === undefined ? undefined : ((value.otherReferenceRanges as Array<any>).map(ReferenceRangeToJSON)),
    };
}
