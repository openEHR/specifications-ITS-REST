...
import type { OriginalVersion } from './OriginalVersion';
import {
    OriginalVersionFromJSON,
    OriginalVersionFromJSONTyped,
    OriginalVersionToJSON,
...
/**
 * Check if a given object implements the ImportedVersion interface.
 */
export function instanceOfImportedVersion(value: object): boolean {
    let isInstance = true;
...
export function ImportedVersionFromJSON(json: any): ImportedVersion {
    return ImportedVersionFromJSONTyped(json, false);
}

export function ImportedVersionFromJSONTyped(json: any, ignoreDiscriminator: boolean): ImportedVersion {
    ...
    return {
        ...
        'item': OriginalVersionFromJSON(json['item']),
    };
}

export function ImportedVersionToJSON(value?: ImportedVersion | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...VersionToJSON(value),
        '_type': value.type,
        'item': OriginalVersionToJSON(value.item),
    };
}
