...
/**
 * Check if a given object implements the ReferenceRange interface.
 */
export function instanceOfReferenceRange(value: object): boolean {
    let isInstance = true;
...
export function ReferenceRangeFromJSON(json: any): ReferenceRange {
    return ReferenceRangeFromJSONTyped(json, false);
}

export function ReferenceRangeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReferenceRange {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'meaning': DvTextFromJSON(json['meaning']),
        'range': DvIntervalFromJSON(json['range']),
    };
}

export function ReferenceRangeToJSON(value?: ReferenceRange | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'meaning': DvTextToJSON(value.meaning),
        'range': DvIntervalToJSON(value.range),
    };
}
