...
export function instanceOfActivity(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "actionArchetypeId" in value;
...
export function ActivityFromJSONTyped(json: any, ignoreDiscriminator: boolean): Activity {
    ...
    return {
        ...
        'timing': !exists(json, 'timing') ? undefined : DvParsableFromJSON(json['timing']),
...
export function ActivityToJSON(value?: Activity | null): any {
    ...
    return {
        ...
        '_type': value.type,
        'timing': DvParsableToJSON(value.timing),
        'action_archetype_id': value.actionArchetypeId,
