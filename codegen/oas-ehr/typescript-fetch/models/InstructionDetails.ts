...
import type { LocatableRef } from './LocatableRef';
import {
    LocatableRefFromJSON,
    LocatableRefFromJSONTyped,
    LocatableRefToJSON,
} from './LocatableRef';
...
/**
 * Check if a given object implements the InstructionDetails interface.
 */
export function instanceOfInstructionDetails(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "instructionId" in value;
    isInstance = isInstance && "activityId" in value;

    return isInstance;
}

export function InstructionDetailsFromJSON(json: any): InstructionDetails {
    return InstructionDetailsFromJSONTyped(json, false);
}

export function InstructionDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): InstructionDetails {
    ...
    return {
        ...
        'instructionId': LocatableRefFromJSON(json['instruction_id']),
        'activityId': json['activity_id'],
        'wfDetails': !exists(json, 'wf_details') ? undefined : ItemStructureFromJSON(json['wf_details']),
    };
}

export function InstructionDetailsToJSON(value?: InstructionDetails | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        '_type': value.type,
        'instruction_id': LocatableRefToJSON(value.instructionId),
        'activity_id': value.activityId,
        'wf_details': ItemStructureToJSON(value.wfDetails),
    };
}
