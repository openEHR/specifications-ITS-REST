...
/**
 * Check if a given object implements the UidBasedId interface.
 */
export function instanceOfUidBasedId(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UidBasedIdFromJSON(json: any): UidBasedId {
    return UidBasedIdFromJSONTyped(json, false);
}

export function UidBasedIdFromJSONTyped(json: any, ignoreDiscriminator: boolean): UidBasedId {
...
export function UidBasedIdToJSON(value?: UidBasedId | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
