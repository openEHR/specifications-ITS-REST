...
/**
 * Check if a given object implements the TerminologyId interface.
 */
export function instanceOfTerminologyId(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TerminologyIdFromJSON(json: any): TerminologyId {
    return TerminologyIdFromJSONTyped(json, false);
}

export function TerminologyIdFromJSONTyped(json: any, ignoreDiscriminator: boolean): TerminologyId {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        ...ObjectIdFromJSONTyped(json, ignoreDiscriminator),
        'type': !exists(json, '_type') ? undefined : json['_type'],
    };
}

export function TerminologyIdToJSON(value?: TerminologyId | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
