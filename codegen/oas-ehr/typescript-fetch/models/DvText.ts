...
import type { TermMapping } from './TermMapping';
import {
    TermMappingFromJSON,
    TermMappingFromJSONTyped,
    TermMappingToJSON,
} from './TermMapping';
 ...
 */
export function instanceOfDvText(value: object): boolean {
    let isInstance = true;
...
export function DvTextFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvText {
    ...
    return {
        ...
        'value': json['value'],
        'hyperlink': !exists(json, 'hyperlink') ? undefined : DvUriFromJSON(json['hyperlink']),
        'formatting': !exists(json, 'formatting') ? undefined : json['formatting'],
        'mappings': !exists(json, 'mappings') ? undefined : ((json['mappings'] as Array<any>).map(TermMappingFromJSON)),
        'language': !exists(json, 'language') ? undefined : CodePhraseFromJSON(json['language']),
        'encoding': !exists(json, 'encoding') ? undefined : CodePhraseFromJSON(json['encoding']),
    };
}

export function DvTextToJSON(value?: DvText | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        '_type': value.type,
        'value': value.value,
        'hyperlink': DvUriToJSON(value.hyperlink),
        'formatting': value.formatting,
        'mappings': value.mappings === undefined ? undefined : ((value.mappings as Array<any>).map(TermMappingToJSON)),
