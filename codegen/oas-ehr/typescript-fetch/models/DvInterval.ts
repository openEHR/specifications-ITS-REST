...
/**
 * Check if a given object implements the DvInterval interface.
 */
export function instanceOfDvInterval(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "lowerUnbounded" in value;
    isInstance = isInstance && "upperUnbounded" in value;
    isInstance = isInstance && "lowerIncluded" in value;
    isInstance = isInstance && "upperIncluded" in value;

    return isInstance;
}

export function DvIntervalFromJSON(json: any): DvInterval {
    return DvIntervalFromJSONTyped(json, false);
}

export function DvIntervalFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvInterval {
...
export function DvIntervalToJSON(value?: DvInterval | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        '_type': value.type,
        'lower_unbounded': value.lowerUnbounded,
        'upper_unbounded': value.upperUnbounded,
        'lower_included': value.lowerIncluded,
        'upper_included': value.upperIncluded,
    };
}
