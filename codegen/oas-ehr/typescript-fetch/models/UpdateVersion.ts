...
import type { ObjectVersionId } from './ObjectVersionId';
import {
    ObjectVersionIdFromJSON,
    ObjectVersionIdFromJSONTyped,
    ObjectVersionIdToJSON,
} from './ObjectVersionId';
import type { TerminologyCode } from './TerminologyCode';
import {
    TerminologyCodeFromJSON,
    TerminologyCodeFromJSONTyped,
    TerminologyCodeToJSON,
} from './TerminologyCode';
import type { UpdateAttestation } from './UpdateAttestation';
import {
    UpdateAttestationFromJSON,
    UpdateAttestationFromJSONTyped,
    UpdateAttestationToJSON,
} from './UpdateAttestation';
import type { UpdateAudit } from './UpdateAudit';
import {
    UpdateAuditFromJSON,
...
/**
 * Check if a given object implements the UpdateVersion interface.
 */
export function instanceOfUpdateVersion(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "lifecycleState" in value;
    isInstance = isInstance && "data" in value;
    isInstance = isInstance && "commitAudit" in value;

    return isInstance;
}

export function UpdateVersionFromJSON(json: any): UpdateVersion {
    return UpdateVersionFromJSONTyped(json, false);
}

export function UpdateVersionFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateVersion {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'precedingVersionUid': !exists(json, 'preceding_version_uid') ? undefined : ObjectVersionIdFromJSON(json['preceding_version_uid']),
        'signature': !exists(json, 'signature') ? undefined : json['signature'],
        'lifecycleState': TerminologyCodeFromJSON(json['lifecycle_state']),
        'attestations': !exists(json, 'attestations') ? undefined : ((json['attestations'] as Array<any>).map(UpdateAttestationFromJSON)),
        'data': VersionableFromJSON(json['data']),
        'commitAudit': UpdateAuditFromJSON(json['commit_audit']),
    };
}

export function UpdateVersionToJSON(value?: UpdateVersion | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'preceding_version_uid': ObjectVersionIdToJSON(value.precedingVersionUid),
        'signature': value.signature,
        'lifecycle_state': TerminologyCodeToJSON(value.lifecycleState),
        'attestations': value.attestations === undefined ? undefined : ((value.attestations as Array<any>).map(UpdateAttestationToJSON)),
        'data': VersionableToJSON(value.data),
        'commit_audit': UpdateAuditToJSON(value.commitAudit),
    };
}
