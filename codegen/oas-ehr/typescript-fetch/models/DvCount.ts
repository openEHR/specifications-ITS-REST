...
/**
 * Check if a given object implements the DvCount interface.
 */
export function instanceOfDvCount(value: object): boolean {
    let isInstance = true;
...
export function DvCountFromJSON(json: any): DvCount {
    return DvCountFromJSONTyped(json, false);
}

export function DvCountFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvCount {
...
export function DvCountToJSON(value?: DvCount | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
