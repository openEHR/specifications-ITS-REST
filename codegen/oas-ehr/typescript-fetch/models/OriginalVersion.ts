...
/**
 * Check if a given object implements the OriginalVersion interface.
 */
export function instanceOfOriginalVersion(value: object): boolean {
    let isInstance = true;
...
export function OriginalVersionFromJSON(json: any): OriginalVersion {
    return OriginalVersionFromJSONTyped(json, false);
}

export function OriginalVersionFromJSONTyped(json: any, ignoreDiscriminator: boolean): OriginalVersion {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        ...VersionFromJSONTyped(json, ignoreDiscriminator),
        'type': !exists(json, '_type') ? undefined : json['_type'],
        'uid': ObjectVersionIdFromJSON(json['uid']),
        'precedingVersionUid': !exists(json, 'preceding_version_uid') ? undefined : ObjectVersionIdFromJSON(json['preceding_version_uid']),
        'otherInputVersionUids': !exists(json, 'other_input_version_uids') ? undefined : ((json['other_input_version_uids'] as Array<any>).map(ObjectVersionIdFromJSON)),
        'lifecycleState': DvCodedTextFromJSON(json['lifecycle_state']),
        'attestations': !exists(json, 'attestations') ? undefined : ((json['attestations'] as Array<any>).map(AttestationFromJSON)),
    };
}

export function OriginalVersionToJSON(value?: OriginalVersion | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...VersionToJSON(value),
        '_type': value.type,
        'uid': ObjectVersionIdToJSON(value.uid),
        'preceding_version_uid': ObjectVersionIdToJSON(value.precedingVersionUid),
        'other_input_version_uids': value.otherInputVersionUids === undefined ? undefined : ((value.otherInputVersionUids as Array<any>).map(ObjectVersionIdToJSON)),
        'lifecycle_state': DvCodedTextToJSON(value.lifecycleState),
        'attestations': value.attestations === undefined ? undefined : ((value.attestations as Array<any>).map(AttestationToJSON)),
    };
}
