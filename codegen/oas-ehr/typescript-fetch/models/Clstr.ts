...
/**
 * Check if a given object implements the Clstr interface.
 */
export function instanceOfClstr(value: object): boolean {
    let isInstance = true;
...
export function ClstrFromJSON(json: any): Clstr {
    return ClstrFromJSONTyped(json, false);
}

export function ClstrFromJSONTyped(json: any, ignoreDiscriminator: boolean): Clstr {
...
export function ClstrToJSON(value?: Clstr | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
