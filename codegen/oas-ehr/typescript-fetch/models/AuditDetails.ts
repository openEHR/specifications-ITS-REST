...
/**
 * Check if a given object implements the AuditDetails interface.
 */
export function instanceOfAuditDetails(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "systemId" in value;
    isInstance = isInstance && "timeCommitted" in value;
    isInstance = isInstance && "changeType" in value;
    isInstance = isInstance && "committer" in value;

    return isInstance;
}

export function AuditDetailsFromJSON(json: any): AuditDetails {
    return AuditDetailsFromJSONTyped(json, false);
}

export function AuditDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuditDetails {
    ...
    return {
        ...
        'timeCommitted': DvDateTimeFromJSON(json['time_committed']),
        'changeType': DvCodedTextFromJSON(json['change_type']),
        'description': !exists(json, 'description') ? undefined : DvTextFromJSON(json['description']),
        'committer': PartyProxyFromJSON(json['committer']),
    };
}

export function AuditDetailsToJSON(value?: AuditDetails | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'time_committed': DvDateTimeToJSON(value.timeCommitted),
        'change_type': DvCodedTextToJSON(value.changeType),
        'description': DvTextToJSON(value.description),
        'committer': PartyProxyToJSON(value.committer),
    };
}
