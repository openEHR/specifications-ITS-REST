...
/**
 * Check if a given object implements the ObjectVersionId interface.
 */
export function instanceOfObjectVersionId(value: object): boolean {
    let isInstance = true;
...
export function ObjectVersionIdFromJSON(json: any): ObjectVersionId {
    return ObjectVersionIdFromJSONTyped(json, false);
}

export function ObjectVersionIdFromJSONTyped(json: any, ignoreDiscriminator: boolean): ObjectVersionId {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        ...UidBasedIdFromJSONTyped(json, ignoreDiscriminator),
        'value': json['value'],
    };
}

export function ObjectVersionIdToJSON(value?: ObjectVersionId | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
