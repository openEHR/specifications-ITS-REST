...
/**
 * Check if a given object implements the DvState interface.
 */
export function instanceOfDvState(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "value" in value;
    isInstance = isInstance && "isTerminal" in value;

    return isInstance;
}

export function DvStateFromJSON(json: any): DvState {
    return DvStateFromJSONTyped(json, false);
}

export function DvStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvState {
    ...
    return {
        ...
        'value': DvCodedTextFromJSON(json['value']),
        'isTerminal': json['is_terminal'],
    };
}

export function DvStateToJSON(value?: DvState | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        '_type': value.type,
        'value': DvCodedTextToJSON(value.value),
