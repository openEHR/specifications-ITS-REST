 ...
 */
export function instanceOfContribution(value: object): boolean {
    let isInstance = true;
...
export function ContributionFromJSONTyped(json: any, ignoreDiscriminator: boolean): Contribution {
    ...
    return {
        ...
        'versions': ((json['versions'] as Array<any>).map(ObjectRefFromJSON)),
        'audit': AuditDetailsFromJSON(json['audit']),
    };
}
...
export function ContributionToJSON(value?: Contribution | null): any {
    ...
    return {
        ...
        'versions': ((value.versions as Array<any>).map(ObjectRefToJSON)),
        'audit': AuditDetailsToJSON(value.audit),
    };
}
