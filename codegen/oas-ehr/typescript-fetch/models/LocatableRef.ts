...
/**
 * Check if a given object implements the LocatableRef interface.
 */
export function instanceOfLocatableRef(value: object): boolean {
    let isInstance = true;
...
export function LocatableRefFromJSON(json: any): LocatableRef {
    return LocatableRefFromJSONTyped(json, false);
}

export function LocatableRefFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocatableRef {
    ...
    return {
        ...
        'type': json['type'],
        'id': UidBasedIdFromJSON(json['id']),
        'path': !exists(json, 'path') ? undefined : json['path'],
    };
}

export function LocatableRefToJSON(value?: LocatableRef | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
