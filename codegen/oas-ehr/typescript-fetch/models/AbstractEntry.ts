...
import type { PartyProxy } from './PartyProxy';
import {
    PartyProxyFromJSON,
    PartyProxyFromJSONTyped,
    PartyProxyToJSON,
} from './PartyProxy';
...
/**
 * Check if a given object implements the AbstractEntry interface.
 */
export function instanceOfAbstractEntry(value: object): boolean {
    let isInstance = true;
...
export function AbstractEntryFromJSON(json: any): AbstractEntry {
    return AbstractEntryFromJSONTyped(json, false);
}

export function AbstractEntryFromJSONTyped(json: any, ignoreDiscriminator: boolean): AbstractEntry {
    ...
    return {
        ...ContentItemFromJSONTyped(json, ignoreDiscriminator),
        'language': CodePhraseFromJSON(json['language']),
        'encoding': CodePhraseFromJSON(json['encoding']),
        'otherParticipations': !exists(json, 'other_participations') ? undefined : ((json['other_participations'] as Array<any>).map(ParticipationFromJSON)),
        'workflowId': !exists(json, 'workflow_id') ? undefined : ObjectRefFromJSON(json['workflow_id']),
        'subject': PartyProxyFromJSON(json['subject']),
        'provider': !exists(json, 'provider') ? undefined : PartyProxyFromJSON(json['provider']),
    };
}

export function AbstractEntryToJSON(value?: AbstractEntry | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...ContentItemToJSON(value),
        'language': CodePhraseToJSON(value.language),
        'encoding': CodePhraseToJSON(value.encoding),
        'other_participations': value.otherParticipations === undefined ? undefined : ((value.otherParticipations as Array<any>).map(ParticipationToJSON)),
        'workflow_id': ObjectRefToJSON(value.workflowId),
        'subject': PartyProxyToJSON(value.subject),
        'provider': PartyProxyToJSON(value.provider),
    };
}
