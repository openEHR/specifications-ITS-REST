...
/**
 * Check if a given object implements the VersionedEhrStatus interface.
 */
export function instanceOfVersionedEhrStatus(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function VersionedEhrStatusFromJSON(json: any): VersionedEhrStatus {
    return VersionedEhrStatusFromJSONTyped(json, false);
}

export function VersionedEhrStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): VersionedEhrStatus {
...
export function VersionedEhrStatusToJSON(value?: VersionedEhrStatus | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
