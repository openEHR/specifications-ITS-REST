...
/**
 * Check if a given object implements the PartySelf interface.
 */
export function instanceOfPartySelf(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PartySelfFromJSON(json: any): PartySelf {
    return PartySelfFromJSONTyped(json, false);
}

export function PartySelfFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartySelf {
...
export function PartySelfToJSON(value?: PartySelf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
