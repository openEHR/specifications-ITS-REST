...
/**
 * Check if a given object implements the DvProportion interface.
 */
export function instanceOfDvProportion(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "numerator" in value;
    isInstance = isInstance && "denominator" in value;
    isInstance = isInstance && "semanticType" in value;

    return isInstance;
}

export function DvProportionFromJSON(json: any): DvProportion {
    return DvProportionFromJSONTyped(json, false);
}

export function DvProportionFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvProportion {
...
export function DvProportionToJSON(value?: DvProportion | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
