 ...
 */
export interface DvDateTime extends DataValue {
    /**
     * 
     * @type {string}
     * @memberof DvDateTime
...
/**
 * Check if a given object implements the DvDateTime interface.
 */
export function instanceOfDvDateTime(value: object): boolean {
    let isInstance = true;
...
export function DvDateTimeFromJSON(json: any): DvDateTime {
    return DvDateTimeFromJSONTyped(json, false);
}

export function DvDateTimeFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvDateTime {
...
export function DvDateTimeToJSON(value?: DvDateTime | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
