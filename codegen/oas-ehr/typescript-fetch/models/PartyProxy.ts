...
/**
 * Check if a given object implements the PartyProxy interface.
 */
export function instanceOfPartyProxy(value: object): boolean {
    let isInstance = true;
...
export function PartyProxyFromJSON(json: any): PartyProxy {
    return PartyProxyFromJSONTyped(json, false);
}

export function PartyProxyFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartyProxy {
    ...
    return {
        ...
        'type': json['_type'],
        'externalRef': !exists(json, 'external_ref') ? undefined : PartyRefFromJSON(json['external_ref']),
    };
}

export function PartyProxyToJSON(value?: PartyProxy | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        '_type': value.type,
        'external_ref': PartyRefToJSON(value.externalRef),
    };
}
