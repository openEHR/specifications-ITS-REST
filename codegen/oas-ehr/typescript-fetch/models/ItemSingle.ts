...
/**
 * Check if a given object implements the ItemSingle interface.
 */
export function instanceOfItemSingle(value: object): boolean {
    let isInstance = true;
...
export function ItemSingleFromJSON(json: any): ItemSingle {
    return ItemSingleFromJSONTyped(json, false);
}

export function ItemSingleFromJSONTyped(json: any, ignoreDiscriminator: boolean): ItemSingle {
    ...
    return {
        ...
        'item': ElementFromJSON(json['item']),
    };
}

export function ItemSingleToJSON(value?: ItemSingle | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
