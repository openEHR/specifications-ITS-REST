...
import type { DvAmount } from './DvAmount';
import {
    DvAmountFromJSON,
...
/**
 * Check if a given object implements the DvQuantity interface.
 */
export function instanceOfDvQuantity(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "magnitude" in value;
    isInstance = isInstance && "units" in value;

    return isInstance;
}

export function DvQuantityFromJSON(json: any): DvQuantity {
    return DvQuantityFromJSONTyped(json, false);
}

export function DvQuantityFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvQuantity {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        ...DvAmountFromJSONTyped(json, ignoreDiscriminator),
        'type': !exists(json, '_type') ? undefined : json['_type'],
        'magnitude': json['magnitude'],
        'precision': !exists(json, 'precision') ? undefined : json['precision'],
        'units': json['units'],
        'unitsSystem': !exists(json, 'units_system') ? undefined : json['units_system'],
        'unitsDisplayName': !exists(json, 'units_display_name') ? undefined : json['units_display_name'],
    };
}

export function DvQuantityToJSON(value?: DvQuantity | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...DvAmountToJSON(value),
        '_type': value.type,
        'magnitude': value.magnitude,
        'precision': value.precision,
        'units': value.units,
        'units_system': value.unitsSystem,
        'units_display_name': value.unitsDisplayName,
    };
}
