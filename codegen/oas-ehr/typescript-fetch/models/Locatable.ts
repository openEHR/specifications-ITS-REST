...
import type { Archetyped } from './Archetyped';
import {
    ArchetypedFromJSON,
    ArchetypedFromJSONTyped,
    ArchetypedToJSON,
} from './Archetyped';
...
import type { FeederAudit } from './FeederAudit';
import {
    FeederAuditFromJSON,
    FeederAuditFromJSONTyped,
    FeederAuditToJSON,
} from './FeederAudit';
...
import type { UidBasedId } from './UidBasedId';
import {
    UidBasedIdFromJSON,
...
/**
 * Check if a given object implements the Locatable interface.
 */
export function instanceOfLocatable(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "name" in value;
    isInstance = isInstance && "archetypeNodeId" in value;

    return isInstance;
}

export function LocatableFromJSON(json: any): Locatable {
    return LocatableFromJSONTyped(json, false);
}

export function LocatableFromJSONTyped(json: any, ignoreDiscriminator: boolean): Locatable {
    ...
    return {
        ...
        'name': DvTextFromJSON(json['name']),
        'archetypeNodeId': json['archetype_node_id'],
        'uid': !exists(json, 'uid') ? undefined : UidBasedIdFromJSON(json['uid']),
        'links': !exists(json, 'links') ? undefined : ((json['links'] as Array<any>).map(LinkFromJSON)),
        'archetypeDetails': !exists(json, 'archetype_details') ? undefined : ArchetypedFromJSON(json['archetype_details']),
        'feederAudit': !exists(json, 'feeder_audit') ? undefined : FeederAuditFromJSON(json['feeder_audit']),
    };
}

export function LocatableToJSON(value?: Locatable | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'name': DvTextToJSON(value.name),
        'archetype_node_id': value.archetypeNodeId,
        'uid': UidBasedIdToJSON(value.uid),
        'links': value.links === undefined ? undefined : ((value.links as Array<any>).map(LinkToJSON)),
        'archetype_details': ArchetypedToJSON(value.archetypeDetails),
        'feeder_audit': FeederAuditToJSON(value.feederAudit),
    };
}
