...
/**
 * Check if a given object implements the PartyRelated interface.
 */
export function instanceOfPartyRelated(value: object): boolean {
    let isInstance = true;
...
export function PartyRelatedFromJSON(json: any): PartyRelated {
    return PartyRelatedFromJSONTyped(json, false);
}

export function PartyRelatedFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartyRelated {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        ...PartyIdentifiedFromJSONTyped(json, ignoreDiscriminator),
        'type': !exists(json, '_type') ? undefined : json['_type'],
        'relationship': DvCodedTextFromJSON(json['relationship']),
    };
}

export function PartyRelatedToJSON(value?: PartyRelated | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...PartyIdentifiedToJSON(value),
        '_type': value.type,
        'relationship': DvCodedTextToJSON(value.relationship),
    };
}
