...
import type { DvParsable } from './DvParsable';
import {
    DvParsableFromJSON,
...
export function instanceOfInstruction(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "narrative" in value;
...
export function InstructionFromJSONTyped(json: any, ignoreDiscriminator: boolean): Instruction {
    ...
    return {
        ...
        'narrative': DvTextFromJSON(json['narrative']),
        'expiryTime': !exists(json, 'expiry_time') ? undefined : DvDateTimeFromJSON(json['expiry_time']),
        'wfDefinition': !exists(json, 'wf_definition') ? undefined : DvParsableFromJSON(json['wf_definition']),
...
export function InstructionToJSON(value?: Instruction | null): any {
    ...
    return {
        ...
        '_type': value.type,
        'narrative': DvTextToJSON(value.narrative),
        'expiry_time': DvDateTimeToJSON(value.expiryTime),
        'wf_definition': DvParsableToJSON(value.wfDefinition),
