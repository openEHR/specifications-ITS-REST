...
/**
 * Check if a given object implements the PartyRef interface.
 */
export function instanceOfPartyRef(value: object): boolean {
    let isInstance = true;
...
export function PartyRefFromJSON(json: any): PartyRef {
    return PartyRefFromJSONTyped(json, false);
}

export function PartyRefFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartyRef {
...
export function PartyRefToJSON(value?: PartyRef | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
