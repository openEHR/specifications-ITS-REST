...
/**
 * Check if a given object implements the HierObjectId interface.
 */
export function instanceOfHierObjectId(value: object): boolean {
    let isInstance = true;
...
export function HierObjectIdFromJSON(json: any): HierObjectId {
    return HierObjectIdFromJSONTyped(json, false);
}

export function HierObjectIdFromJSONTyped(json: any, ignoreDiscriminator: boolean): HierObjectId {
...
export function HierObjectIdToJSON(value?: HierObjectId | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
