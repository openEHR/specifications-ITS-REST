...
/**
 * Check if a given object implements the PartyIdentified interface.
 */
export function instanceOfPartyIdentified(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PartyIdentifiedFromJSON(json: any): PartyIdentified {
    return PartyIdentifiedFromJSONTyped(json, false);
}

export function PartyIdentifiedFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartyIdentified {
    ...
    return {
        ...PartyProxyFromJSONTyped(json, ignoreDiscriminator),
        'type': !exists(json, '_type') ? undefined : json['_type'],
        'name': !exists(json, 'name') ? undefined : json['name'],
        'identifiers': !exists(json, 'identifiers') ? undefined : ((json['identifiers'] as Array<any>).map(DvIdentifierFromJSON)),
    };
}

export function PartyIdentifiedToJSON(value?: PartyIdentified | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...PartyProxyToJSON(value),
        '_type': value.type,
        'name': value.name,
        'identifiers': value.identifiers === undefined ? undefined : ((value.identifiers as Array<any>).map(DvIdentifierToJSON)),
    };
}
