...
import type { DvOrdered } from './DvOrdered';
import {
    DvOrderedFromJSON,
    DvOrderedFromJSONTyped,
    DvOrderedToJSON,
} from './DvOrdered';
...
/**
 * Check if a given object implements the DvQuantified interface.
 */
export function instanceOfDvQuantified(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DvQuantifiedFromJSON(json: any): DvQuantified {
    return DvQuantifiedFromJSONTyped(json, false);
}

export function DvQuantifiedFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvQuantified {
    ...
    return {
        ...DvOrderedFromJSONTyped(json, ignoreDiscriminator),
        'type': !exists(json, '_type') ? undefined : json['_type'],
        'magnitudeStatus': !exists(json, 'magnitude_status') ? undefined : json['magnitude_status'],
    };
}

export function DvQuantifiedToJSON(value?: DvQuantified | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...DvOrderedToJSON(value),
        '_type': value.type,
        'magnitude_status': value.magnitudeStatus,
    };
}
