...
/**
 * Check if a given object implements the EhrStatus interface.
 */
export function instanceOfEhrStatus(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "subject" in value;
    isInstance = isInstance && "isQueryable" in value;
    isInstance = isInstance && "isModifiable" in value;

    return isInstance;
}

export function EhrStatusFromJSON(json: any): EhrStatus {
    return EhrStatusFromJSONTyped(json, false);
}

export function EhrStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): EhrStatus {
...
export function EhrStatusToJSON(value?: EhrStatus | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'is_queryable': value.isQueryable,
        'is_modifiable': value.isModifiable,
