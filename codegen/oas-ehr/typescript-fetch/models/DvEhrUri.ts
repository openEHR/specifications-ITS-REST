...
/**
 * Check if a given object implements the DvEhrUri interface.
 */
export function instanceOfDvEhrUri(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DvEhrUriFromJSON(json: any): DvEhrUri {
    return DvEhrUriFromJSONTyped(json, false);
}

export function DvEhrUriFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvEhrUri {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        ...DvUriFromJSONTyped(json, ignoreDiscriminator),
        'type': !exists(json, '_type') ? undefined : json['_type'],
    };
}

export function DvEhrUriToJSON(value?: DvEhrUri | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
