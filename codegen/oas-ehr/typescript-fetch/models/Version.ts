...
export function VersionFromJSONTyped(json: any, ignoreDiscriminator: boolean): Version {
    ...
    return {
        ...
        'contribution': ObjectRefFromJSON(json['contribution']),
        'signature': !exists(json, 'signature') ? undefined : json['signature'],
        'commitAudit': AuditDetailsFromJSON(json['commit_audit']),
...
export function VersionToJSON(value?: Version | null): any {
    ...
    return {
        ...
        '_type': value.type,
        'contribution': ObjectRefToJSON(value.contribution),
        'signature': value.signature,
        'commit_audit': AuditDetailsToJSON(value.commitAudit),
