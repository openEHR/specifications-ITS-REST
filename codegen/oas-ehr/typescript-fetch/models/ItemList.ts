...
export function ItemListFromJSONTyped(json: any, ignoreDiscriminator: boolean): ItemList {
    ...
    return {
        ...
        'items': !exists(json, 'items') ? undefined : ((json['items'] as Array<any>).map(ElementFromJSON)),
    };
}
...
export function ItemListToJSON(value?: ItemList | null): any {
    ...
    return {
        ...
        '_type': value.type,
        'items': value.items === undefined ? undefined : ((value.items as Array<any>).map(ElementToJSON)),
    };
}
