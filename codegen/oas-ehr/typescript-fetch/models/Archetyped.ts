...
import type { ArchetypeId } from './ArchetypeId';
import {
    ArchetypeIdFromJSON,
    ArchetypeIdFromJSONTyped,
    ArchetypeIdToJSON,
} from './ArchetypeId';
...
/**
 * Check if a given object implements the Archetyped interface.
 */
export function instanceOfArchetyped(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "archetypeId" in value;
    isInstance = isInstance && "rmVersion" in value;

    return isInstance;
}

export function ArchetypedFromJSON(json: any): Archetyped {
    return ArchetypedFromJSONTyped(json, false);
}

export function ArchetypedFromJSONTyped(json: any, ignoreDiscriminator: boolean): Archetyped {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'archetypeId': ArchetypeIdFromJSON(json['archetype_id']),
        'templateId': !exists(json, 'template_id') ? undefined : TemplateIdFromJSON(json['template_id']),
        'rmVersion': json['rm_version'],
    };
}

export function ArchetypedToJSON(value?: Archetyped | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'archetype_id': ArchetypeIdToJSON(value.archetypeId),
        'template_id': TemplateIdToJSON(value.templateId),
        'rm_version': value.rmVersion,
    };
}
