...
/**
 * Check if a given object implements the DataStructure interface.
 */
export function instanceOfDataStructure(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DataStructureFromJSON(json: any): DataStructure {
    return DataStructureFromJSONTyped(json, false);
}
...
export function DataStructureToJSON(value?: DataStructure | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
