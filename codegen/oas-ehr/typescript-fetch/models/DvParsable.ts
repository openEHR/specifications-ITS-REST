...
/**
 * Check if a given object implements the DvParsable interface.
 */
export function instanceOfDvParsable(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "value" in value;
    isInstance = isInstance && "formalism" in value;

    return isInstance;
}

export function DvParsableFromJSON(json: any): DvParsable {
    return DvParsableFromJSONTyped(json, false);
}

export function DvParsableFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvParsable {
...
export function DvParsableToJSON(value?: DvParsable | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
