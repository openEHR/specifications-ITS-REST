...
/**
 * Check if a given object implements the ItemStructure interface.
 */
export function instanceOfItemStructure(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ItemStructureFromJSON(json: any): ItemStructure {
    return ItemStructureFromJSONTyped(json, false);
}

export function ItemStructureFromJSONTyped(json: any, ignoreDiscriminator: boolean): ItemStructure {
    ...
    return {
        ...DataStructureFromJSONTyped(json, ignoreDiscriminator),
        'type': !exists(json, '_type') ? undefined : json['_type'],
    };
}

export function ItemStructureToJSON(value?: ItemStructure | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
