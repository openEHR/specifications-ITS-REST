...
/**
 * Check if a given object implements the DvAmount interface.
 */
export function instanceOfDvAmount(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DvAmountFromJSON(json: any): DvAmount {
    return DvAmountFromJSONTyped(json, false);
}

export function DvAmountFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvAmount {
    ...
    return {
        ...
        'accuracyIsPercent': !exists(json, 'accuracy_is_percent') ? undefined : json['accuracy_is_percent'],
        'accuracy': !exists(json, 'accuracy') ? undefined : json['accuracy'],
    };
}

export function DvAmountToJSON(value?: DvAmount | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        '_type': value.type,
        'accuracy_is_percent': value.accuracyIsPercent,
