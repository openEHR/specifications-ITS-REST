...
export function HistoryFromJSONTyped(json: any, ignoreDiscriminator: boolean): History {
    ...
    return {
        ...
        'origin': DvDateTimeFromJSON(json['origin']),
        'period': !exists(json, 'period') ? undefined : DvDurationFromJSON(json['period']),
        'duration': !exists(json, 'duration') ? undefined : DvDurationFromJSON(json['duration']),
        'summary': !exists(json, 'summary') ? undefined : ItemStructureFromJSON(json['summary']),
...
export function HistoryToJSON(value?: History | null): any {
    ...
    return {
        ...LocatableToJSON(value),
        '_type': value.type,
        'origin': DvDateTimeToJSON(value.origin),
        'period': DvDurationToJSON(value.period),
        'duration': DvDurationToJSON(value.duration),
        'summary': ItemStructureToJSON(value.summary),
