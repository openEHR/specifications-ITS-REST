...
/**
 * Check if a given object implements the DvScale interface.
 */
export function instanceOfDvScale(value: object): boolean {
    let isInstance = true;
...
export function DvScaleFromJSON(json: any): DvScale {
    return DvScaleFromJSONTyped(json, false);
}

export function DvScaleFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvScale {
...
export function DvScaleToJSON(value?: DvScale | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
