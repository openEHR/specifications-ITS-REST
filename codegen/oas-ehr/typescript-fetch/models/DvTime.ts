...
/**
 * Check if a given object implements the DvTime interface.
 */
export function instanceOfDvTime(value: object): boolean {
    let isInstance = true;
...
export function DvTimeFromJSON(json: any): DvTime {
    return DvTimeFromJSONTyped(json, false);
}

export function DvTimeFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvTime {
...
export function DvTimeToJSON(value?: DvTime | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
