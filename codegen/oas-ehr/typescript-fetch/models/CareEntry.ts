...
import type { AbstractEntry } from './AbstractEntry';
import {
    AbstractEntryFromJSON,
...
/**
 * Check if a given object implements the CareEntry interface.
 */
export function instanceOfCareEntry(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CareEntryFromJSON(json: any): CareEntry {
    return CareEntryFromJSONTyped(json, false);
}

export function CareEntryFromJSONTyped(json: any, ignoreDiscriminator: boolean): CareEntry {
    ...
    return {
        ...AbstractEntryFromJSONTyped(json, ignoreDiscriminator),
        'protocol': !exists(json, 'protocol') ? undefined : ItemStructureFromJSON(json['protocol']),
        'guidelineId': !exists(json, 'guideline_id') ? undefined : ObjectRefFromJSON(json['guideline_id']),
    };
}

export function CareEntryToJSON(value?: CareEntry | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...AbstractEntryToJSON(value),
        'protocol': ItemStructureToJSON(value.protocol),
        'guideline_id': ObjectRefToJSON(value.guidelineId),
    };
}
