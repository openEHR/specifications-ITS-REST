...
/**
 * Check if a given object implements the DvEncapsulated interface.
 */
export function instanceOfDvEncapsulated(value: object): boolean {
    let isInstance = true;
...
export function DvEncapsulatedFromJSON(json: any): DvEncapsulated {
    return DvEncapsulatedFromJSONTyped(json, false);
}

export function DvEncapsulatedFromJSONTyped(json: any, ignoreDiscriminator: boolean): DvEncapsulated {
    ...
    return {
        ...
        'type': json['_type'],
        'charset': !exists(json, 'charset') ? undefined : CodePhraseFromJSON(json['charset']),
        'language': !exists(json, 'language') ? undefined : CodePhraseFromJSON(json['language']),
    };
}

export function DvEncapsulatedToJSON(value?: DvEncapsulated | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        '_type': value.type,
        'charset': CodePhraseToJSON(value.charset),
