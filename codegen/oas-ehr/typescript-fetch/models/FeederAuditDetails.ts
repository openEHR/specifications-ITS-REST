...
/**
 * Check if a given object implements the FeederAuditDetails interface.
 */
export function instanceOfFeederAuditDetails(value: object): boolean {
    let isInstance = true;
...
export function FeederAuditDetailsFromJSON(json: any): FeederAuditDetails {
    return FeederAuditDetailsFromJSONTyped(json, false);
}

export function FeederAuditDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): FeederAuditDetails {
    ...
    return {
        ...
        'location': !exists(json, 'location') ? undefined : PartyIdentifiedFromJSON(json['location']),
        'subject': !exists(json, 'subject') ? undefined : PartyProxyFromJSON(json['subject']),
        'provider': !exists(json, 'provider') ? undefined : PartyIdentifiedFromJSON(json['provider']),
        'time': !exists(json, 'time') ? undefined : DvDateTimeFromJSON(json['time']),
        'versionId': !exists(json, 'version_id') ? undefined : json['version_id'],
        'otherDetails': !exists(json, 'other_details') ? undefined : ItemStructureFromJSON(json['other_details']),
    };
}

export function FeederAuditDetailsToJSON(value?: FeederAuditDetails | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'location': PartyIdentifiedToJSON(value.location),
        'subject': PartyProxyToJSON(value.subject),
        'provider': PartyIdentifiedToJSON(value.provider),
        'time': DvDateTimeToJSON(value.time),
        'version_id': value.versionId,
        'other_details': ItemStructureToJSON(value.otherDetails),
    };
}
