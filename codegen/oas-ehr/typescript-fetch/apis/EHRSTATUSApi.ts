...
export interface EhrStatusGetByVersionIdRequest {
    ehr_id: string;
    version_uid: string;
}

export interface EhrStatusUpdateRequest {
    ehr_id: string;
    If_Match: string;
    EhrStatus: EhrStatus;
    Prefer?: EhrStatusUpdatePreferEnum;
}

export interface VersionedEhrStatusGetRequest {
    ehr_id: string;
}

export interface VersionedEhrStatusRevisionHistoryRequest {
    ehr_id: string;
}

export interface VersionedEhrStatusVersionGetAtTimeRequest {
    ehr_id: string;
    version_at_time?: string;
}

export interface VersionedEhrStatusVersionGetByIdRequest {
    ehr_id: string;
    version_uid: string;
}
 ...
 * 
 */
export class EHRSTATUSApi extends runtime.BaseAPI {
     ...
     */
    async ehrStatusGetAtTimeRaw(requestParameters: EhrStatusGetAtTimeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EhrStatus>> {
        if (requestParameters.ehr_id === null || requestParameters.ehr_id === undefined) {
            throw new runtime.RequiredError('ehr_id','Required parameter requestParameters.ehr_id was null or undefined when calling ehrStatusGetAtTime.');
        }
        ...
        const response = await this.request({
            path: `/ehr/{ehr_id}/ehr_status`.replace(`{${"ehr_id"}}`, encodeURIComponent(String(requestParameters.ehr_id))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => EhrStatusFromJSON(jsonValue));
    }
     ...
     * Get EHR_STATUS at time
     */
    async ehrStatusGetAtTime(requestParameters: EhrStatusGetAtTimeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EhrStatus> {
        const response = await this.ehrStatusGetAtTimeRaw(requestParameters, initOverrides);
     ...
     */
    async ehrStatusGetByVersionIdRaw(requestParameters: EhrStatusGetByVersionIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EhrStatus>> {
        if (requestParameters.ehr_id === null || requestParameters.ehr_id === undefined) {
            throw new runtime.RequiredError('ehr_id','Required parameter requestParameters.ehr_id was null or undefined when calling ehrStatusGetByVersionId.');
        }

        if (requestParameters.version_uid === null || requestParameters.version_uid === undefined) {
            throw new runtime.RequiredError('version_uid','Required parameter requestParameters.version_uid was null or undefined when calling ehrStatusGetByVersionId.');
        }
        ...
        const response = await this.request({
            path: `/ehr/{ehr_id}/ehr_status/{version_uid}`.replace(`{${"ehr_id"}}`, encodeURIComponent(String(requestParameters.ehr_id))).replace(`{${"version_uid"}}`, encodeURIComponent(String(requestParameters.version_uid))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Get EHR_STATUS by version id
     */
    async ehrStatusGetByVersionId(requestParameters: EhrStatusGetByVersionIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EhrStatus> {
        const response = await this.ehrStatusGetByVersionIdRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Update EHR_STATUS
     */
    async ehrStatusUpdateRaw(requestParameters: EhrStatusUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EhrStatus>> {
        if (requestParameters.ehr_id === null || requestParameters.ehr_id === undefined) {
            throw new runtime.RequiredError('ehr_id','Required parameter requestParameters.ehr_id was null or undefined when calling ehrStatusUpdate.');
        }

        if (requestParameters.If_Match === null || requestParameters.If_Match === undefined) {
            throw new runtime.RequiredError('If_Match','Required parameter requestParameters.If_Match was null or undefined when calling ehrStatusUpdate.');
        }

        if (requestParameters.EhrStatus === null || requestParameters.EhrStatus === undefined) {
            throw new runtime.RequiredError('EhrStatus','Required parameter requestParameters.EhrStatus was null or undefined when calling ehrStatusUpdate.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: EhrStatusToJSON(requestParameters.EhrStatus),
        }, initOverrides);
     ...
     * Update EHR_STATUS
     */
    async ehrStatusUpdate(requestParameters: EhrStatusUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EhrStatus> {
        const response = await this.ehrStatusUpdateRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async versionedEhrStatusGetRaw(requestParameters: VersionedEhrStatusGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VersionedEhrStatus>> {
        if (requestParameters.ehr_id === null || requestParameters.ehr_id === undefined) {
            throw new runtime.RequiredError('ehr_id','Required parameter requestParameters.ehr_id was null or undefined when calling versionedEhrStatusGet.');
        }
        ...
        const response = await this.request({
            path: `/ehr/{ehr_id}/versioned_ehr_status`.replace(`{${"ehr_id"}}`, encodeURIComponent(String(requestParameters.ehr_id))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => VersionedEhrStatusFromJSON(jsonValue));
    }
     ...
     * Get versioned EHR_STATUS
     */
    async versionedEhrStatusGet(requestParameters: VersionedEhrStatusGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<VersionedEhrStatus> {
        const response = await this.versionedEhrStatusGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async versionedEhrStatusRevisionHistoryRaw(requestParameters: VersionedEhrStatusRevisionHistoryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RevisionHistory>> {
        if (requestParameters.ehr_id === null || requestParameters.ehr_id === undefined) {
            throw new runtime.RequiredError('ehr_id','Required parameter requestParameters.ehr_id was null or undefined when calling versionedEhrStatusRevisionHistory.');
        }
        ...
        const response = await this.request({
            path: `/ehr/{ehr_id}/versioned_ehr_status/revision_history`.replace(`{${"ehr_id"}}`, encodeURIComponent(String(requestParameters.ehr_id))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Get versioned EHR_STATUS revision history
     */
    async versionedEhrStatusRevisionHistory(requestParameters: VersionedEhrStatusRevisionHistoryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RevisionHistory> {
        const response = await this.versionedEhrStatusRevisionHistoryRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async versionedEhrStatusVersionGetAtTimeRaw(requestParameters: VersionedEhrStatusVersionGetAtTimeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Version>> {
        if (requestParameters.ehr_id === null || requestParameters.ehr_id === undefined) {
            throw new runtime.RequiredError('ehr_id','Required parameter requestParameters.ehr_id was null or undefined when calling versionedEhrStatusVersionGetAtTime.');
        }
        ...
        const response = await this.request({
            path: `/ehr/{ehr_id}/versioned_ehr_status/version`.replace(`{${"ehr_id"}}`, encodeURIComponent(String(requestParameters.ehr_id))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Get versioned EHR_STATUS version at time
     */
    async versionedEhrStatusVersionGetAtTime(requestParameters: VersionedEhrStatusVersionGetAtTimeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Version> {
        const response = await this.versionedEhrStatusVersionGetAtTimeRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async versionedEhrStatusVersionGetByIdRaw(requestParameters: VersionedEhrStatusVersionGetByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Version>> {
        if (requestParameters.ehr_id === null || requestParameters.ehr_id === undefined) {
            throw new runtime.RequiredError('ehr_id','Required parameter requestParameters.ehr_id was null or undefined when calling versionedEhrStatusVersionGetById.');
        }

        if (requestParameters.version_uid === null || requestParameters.version_uid === undefined) {
            throw new runtime.RequiredError('version_uid','Required parameter requestParameters.version_uid was null or undefined when calling versionedEhrStatusVersionGetById.');
        }
        ...
        const response = await this.request({
            path: `/ehr/{ehr_id}/versioned_ehr_status/version/{version_uid}`.replace(`{${"ehr_id"}}`, encodeURIComponent(String(requestParameters.ehr_id))).replace(`{${"version_uid"}}`, encodeURIComponent(String(requestParameters.version_uid))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Get versioned EHR_STATUS version by id
     */
    async versionedEhrStatusVersionGetById(requestParameters: VersionedEhrStatusVersionGetByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Version> {
        const response = await this.versionedEhrStatusVersionGetByIdRaw(requestParameters, initOverrides);
        return await response.value();
    }
 ...
 * @export
 */
export const EhrStatusUpdatePreferEnum = {
    Representation: 'return=representation',
    Minimal: 'return=minimal'
} as const;
export type EhrStatusUpdatePreferEnum = typeof EhrStatusUpdatePreferEnum[keyof typeof EhrStatusUpdatePreferEnum];
