...
export interface EhrCreateWithIdRequest {
    ehr_id: string;
    Prefer?: EhrCreateWithIdPreferEnum;
    EhrStatus?: EhrStatus;
}

export interface EhrGetByIdRequest {
    ehr_id: string;
}

export interface EhrGetBySubjectRequest {
    subject_id: string;
 ...
 * 
 */
export class EHRApi extends runtime.BaseAPI {
     ...
     * Create EHR
     */
    async ehrCreateRaw(requestParameters: EhrCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Ehr>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => EhrFromJSON(jsonValue));
    }
     ...
     * Create EHR
     */
    async ehrCreate(requestParameters: EhrCreateRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Ehr> {
        const response = await this.ehrCreateRaw(requestParameters, initOverrides);
     ...
     * Create EHR with id
     */
    async ehrCreateWithIdRaw(requestParameters: EhrCreateWithIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Ehr>> {
        if (requestParameters.ehr_id === null || requestParameters.ehr_id === undefined) {
            throw new runtime.RequiredError('ehr_id','Required parameter requestParameters.ehr_id was null or undefined when calling ehrCreateWithId.');
        }
        ...
        const response = await this.request({
            path: `/ehr/{ehr_id}`.replace(`{${"ehr_id"}}`, encodeURIComponent(String(requestParameters.ehr_id))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: EhrStatusToJSON(requestParameters.EhrStatus),
     ...
     * Create EHR with id
     */
    async ehrCreateWithId(requestParameters: EhrCreateWithIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Ehr> {
        const response = await this.ehrCreateWithIdRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Get EHR by id
     */
    async ehrGetByIdRaw(requestParameters: EhrGetByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Ehr>> {
        if (requestParameters.ehr_id === null || requestParameters.ehr_id === undefined) {
            throw new runtime.RequiredError('ehr_id','Required parameter requestParameters.ehr_id was null or undefined when calling ehrGetById.');
        }
     ...
     * Get EHR by id
     */
    async ehrGetById(requestParameters: EhrGetByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Ehr> {
        const response = await this.ehrGetByIdRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async ehrGetBySubjectRaw(requestParameters: EhrGetBySubjectRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Ehr>> {
        if (requestParameters.subject_id === null || requestParameters.subject_id === undefined) {
            throw new runtime.RequiredError('subject_id','Required parameter requestParameters.subject_id was null or undefined when calling ehrGetBySubject.');
        }

        if (requestParameters.subject_namespace === null || requestParameters.subject_namespace === undefined) {
            throw new runtime.RequiredError('subject_namespace','Required parameter requestParameters.subject_namespace was null or undefined when calling ehrGetBySubject.');
        }
        ...
        if (requestParameters.subject_namespace !== undefined) {
            queryParameters['subject_namespace'] = requestParameters.subject_namespace;
        }
     ...
     * Get EHR by subject id
     */
    async ehrGetBySubject(requestParameters: EhrGetBySubjectRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Ehr> {
        const response = await this.ehrGetBySubjectRaw(requestParameters, initOverrides);
        return await response.value();
    }
 ...
 * @export
 */
export const EhrCreatePreferEnum = {
    Representation: 'return=representation',
    Minimal: 'return=minimal'
} as const;
export type EhrCreatePreferEnum = typeof EhrCreatePreferEnum[keyof typeof EhrCreatePreferEnum];
/**
 * @export
 */
export const EhrCreateWithIdPreferEnum = {
    Representation: 'return=representation',
    Minimal: 'return=minimal'
} as const;
export type EhrCreateWithIdPreferEnum = typeof EhrCreateWithIdPreferEnum[keyof typeof EhrCreateWithIdPreferEnum];
