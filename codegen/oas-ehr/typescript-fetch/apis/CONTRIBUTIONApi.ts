...
export interface ContributionCreateRequest {
    ...
    Prefer?: ContributionCreatePreferEnum;
}

export interface ContributionGetRequest {
    ehr_id: string;
 ...
 * 
 */
export class CONTRIBUTIONApi extends runtime.BaseAPI {
     ...
     * Create CONTRIBUTION
     */
    async contributionCreateRaw(requestParameters: ContributionCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Contribution>> {
        if (requestParameters.ehr_id === null || requestParameters.ehr_id === undefined) {
            throw new runtime.RequiredError('ehr_id','Required parameter requestParameters.ehr_id was null or undefined when calling contributionCreate.');
        }

        if (requestParameters.NewContribution === null || requestParameters.NewContribution === undefined) {
            throw new runtime.RequiredError('NewContribution','Required parameter requestParameters.NewContribution was null or undefined when calling contributionCreate.');
        }
        ...
        const response = await this.request({
            path: `/ehr/{ehr_id}/contribution`.replace(`{${"ehr_id"}}`, encodeURIComponent(String(requestParameters.ehr_id))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: NewContributionToJSON(requestParameters.NewContribution),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ContributionFromJSON(jsonValue));
    }
     ...
     * Create CONTRIBUTION
     */
    async contributionCreate(requestParameters: ContributionCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Contribution> {
        const response = await this.contributionCreateRaw(requestParameters, initOverrides);
     ...
     */
    async contributionGetRaw(requestParameters: ContributionGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Contribution>> {
        if (requestParameters.ehr_id === null || requestParameters.ehr_id === undefined) {
            throw new runtime.RequiredError('ehr_id','Required parameter requestParameters.ehr_id was null or undefined when calling contributionGet.');
        }

        if (requestParameters.contribution_uid === null || requestParameters.contribution_uid === undefined) {
            throw new runtime.RequiredError('contribution_uid','Required parameter requestParameters.contribution_uid was null or undefined when calling contributionGet.');
        }
        ...
        const response = await this.request({
            path: `/ehr/{ehr_id}/contribution/{contribution_uid}`.replace(`{${"ehr_id"}}`, encodeURIComponent(String(requestParameters.ehr_id))).replace(`{${"contribution_uid"}}`, encodeURIComponent(String(requestParameters.contribution_uid))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Get CONTRIBUTION by id
     */
    async contributionGet(requestParameters: ContributionGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Contribution> {
        const response = await this.contributionGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
 ...
 * @export
 */
export const ContributionCreatePreferEnum = {
    Representation: 'return=representation',
    Minimal: 'return=minimal'
} as const;
export type ContributionCreatePreferEnum = typeof ContributionCreatePreferEnum[keyof typeof ContributionCreatePreferEnum];
