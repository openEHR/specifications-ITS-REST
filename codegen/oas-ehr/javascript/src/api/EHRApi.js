...
* @version latest
*/
export default class EHRApi {

    /**
    * Constructs a new EHRApi. 
    * @alias module:api/EHRApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the ehrCreate operation.
     * @callback module:api/EHRApi~ehrCreateCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Ehr} data The data returned by the service call.
     ...
     * @param {module:model/EhrStatus} opts.EhrStatus An EHR_STATUS resource MAY be also supplied by the client as the request body. 
     * @param {module:api/EHRApi~ehrCreateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Ehr}
     */
    ehrCreate(opts, callback) {
      opts = opts || {};
      let postBody = opts['EhrStatus'];
    ...
    /**
     * Callback function to receive the result of the ehrCreateWithId operation.
     * @callback module:api/EHRApi~ehrCreateWithIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Ehr} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/String} opts.Prefer Request header to indicate the preference over response details. The response will contain the entire resource when the `Prefer` header has a value of `return=representation`.  (default to 'return=minimal')
     * @param {module:model/EhrStatus} opts.EhrStatus An EHR_STATUS resource MAY be also supplied by the client as the request body. 
     * @param {module:api/EHRApi~ehrCreateWithIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Ehr}
     */
    ehrCreateWithId(ehr_id, opts, callback) {
      opts = opts || {};
      let postBody = opts['EhrStatus'];
      // verify the required parameter 'ehr_id' is set
      if (ehr_id === undefined || ehr_id === null) {
        throw new Error("Missing the required parameter 'ehr_id' when calling ehrCreateWithId");
      }
    ...
    /**
     * Callback function to receive the result of the ehrGetById operation.
     * @callback module:api/EHRApi~ehrGetByIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Ehr} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} ehr_id EHR identifier taken from EHR.ehr_id.value. 
     * @param {module:api/EHRApi~ehrGetByIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Ehr}
     */
    ehrGetById(ehr_id, callback) {
      let postBody = null;
      // verify the required parameter 'ehr_id' is set
      if (ehr_id === undefined || ehr_id === null) {
        throw new Error("Missing the required parameter 'ehr_id' when calling ehrGetById");
      }
    ...
    /**
     * Callback function to receive the result of the ehrGetBySubject operation.
     * @callback module:api/EHRApi~ehrGetBySubjectCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Ehr} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} subject_id The EHR subject id. 
     * @param {String} subject_namespace The EHR subject id namespace. 
     * @param {module:api/EHRApi~ehrGetBySubjectCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Ehr}
     */
    ehrGetBySubject(subject_id, subject_namespace, callback) {
      let postBody = null;
      // verify the required parameter 'subject_id' is set
      if (subject_id === undefined || subject_id === null) {
        throw new Error("Missing the required parameter 'subject_id' when calling ehrGetBySubject");
      }
      // verify the required parameter 'subject_namespace' is set
      if (subject_namespace === undefined || subject_namespace === null) {
        throw new Error("Missing the required parameter 'subject_namespace' when calling ehrGetBySubject");
      }
