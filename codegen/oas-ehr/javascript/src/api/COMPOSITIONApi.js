...
export default class COMPOSITIONApi {
    ...
    */
     ...
     * @param {module:model/String} [Prefer = 'return=minimal')] Request header to indicate the preference over response details. The response will contain the entire resource when the `Prefer` header has a value of `return=representation`. 
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [version_at_time] A given time in the extended ISO 8601 format. 
