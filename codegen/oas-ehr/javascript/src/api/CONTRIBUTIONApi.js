...
export default class CONTRIBUTIONApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the contributionCreate operation.
     * @callback module:api/CONTRIBUTIONApi~contributionCreateCallback
     ...
     * @param {module:model/NewContribution} NewContribution The CONTRIBUTION. 
     ...
     * @param {module:api/CONTRIBUTIONApi~contributionCreateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Contribution}
     */
    contributionCreate(ehr_id, NewContribution, opts, callback) {
      opts = opts || {};
      let postBody = NewContribution;
      // verify the required parameter 'ehr_id' is set
      if (ehr_id === undefined || ehr_id === null) {
        throw new Error("Missing the required parameter 'ehr_id' when calling contributionCreate");
      }
      // verify the required parameter 'NewContribution' is set
      if (NewContribution === undefined || NewContribution === null) {
        throw new Error("Missing the required parameter 'NewContribution' when calling contributionCreate");
      }
    ...
    /**
     * Callback function to receive the result of the contributionGet operation.
     * @callback module:api/CONTRIBUTIONApi~contributionGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Contribution} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} ehr_id EHR identifier taken from EHR.ehr_id.value. 
     * @param {String} contribution_uid The CONTRIBUTION uid. 
     * @param {module:api/CONTRIBUTIONApi~contributionGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Contribution}
     */
    contributionGet(ehr_id, contribution_uid, callback) {
      let postBody = null;
      // verify the required parameter 'ehr_id' is set
      if (ehr_id === undefined || ehr_id === null) {
        throw new Error("Missing the required parameter 'ehr_id' when calling contributionGet");
      }
      // verify the required parameter 'contribution_uid' is set
      if (contribution_uid === undefined || contribution_uid === null) {
        throw new Error("Missing the required parameter 'contribution_uid' when calling contributionGet");
      }
