...
/**
* EHRSTATUS service.
* @module api/EHRSTATUSApi
* @version latest
*/
export default class EHRSTATUSApi {

    /**
    * Constructs a new EHRSTATUSApi. 
    * @alias module:api/EHRSTATUSApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the ehrStatusGetAtTime operation.
     * @callback module:api/EHRSTATUSApi~ehrStatusGetAtTimeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/EhrStatus} data The data returned by the service call.
     ...
     * @param {module:api/EHRSTATUSApi~ehrStatusGetAtTimeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/EhrStatus}
     */
    ehrStatusGetAtTime(ehr_id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'ehr_id' is set
      if (ehr_id === undefined || ehr_id === null) {
        throw new Error("Missing the required parameter 'ehr_id' when calling ehrStatusGetAtTime");
      }
    ...
    /**
     * Callback function to receive the result of the ehrStatusGetByVersionId operation.
     * @callback module:api/EHRSTATUSApi~ehrStatusGetByVersionIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/EhrStatus} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/EHRSTATUSApi~ehrStatusGetByVersionIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/EhrStatus}
     */
    ehrStatusGetByVersionId(ehr_id, version_uid, callback) {
      let postBody = null;
      // verify the required parameter 'ehr_id' is set
      if (ehr_id === undefined || ehr_id === null) {
        throw new Error("Missing the required parameter 'ehr_id' when calling ehrStatusGetByVersionId");
      }
      // verify the required parameter 'version_uid' is set
      if (version_uid === undefined || version_uid === null) {
        throw new Error("Missing the required parameter 'version_uid' when calling ehrStatusGetByVersionId");
      }
    ...
    /**
     * Callback function to receive the result of the ehrStatusUpdate operation.
     * @callback module:api/EHRSTATUSApi~ehrStatusUpdateCallback
     * @param {String} error Error message, if any.
     * @param {module:model/EhrStatus} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/EhrStatus} EhrStatus The new EHR_STATUS. 
     * @param {Object} opts Optional parameters
     ...
     * @param {module:api/EHRSTATUSApi~ehrStatusUpdateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/EhrStatus}
     */
    ehrStatusUpdate(ehr_id, If_Match, EhrStatus, opts, callback) {
      opts = opts || {};
      let postBody = EhrStatus;
      // verify the required parameter 'ehr_id' is set
      if (ehr_id === undefined || ehr_id === null) {
        throw new Error("Missing the required parameter 'ehr_id' when calling ehrStatusUpdate");
      }
      // verify the required parameter 'If_Match' is set
      if (If_Match === undefined || If_Match === null) {
        throw new Error("Missing the required parameter 'If_Match' when calling ehrStatusUpdate");
      }
      // verify the required parameter 'EhrStatus' is set
      if (EhrStatus === undefined || EhrStatus === null) {
        throw new Error("Missing the required parameter 'EhrStatus' when calling ehrStatusUpdate");
      }
    ...
    /**
     * Callback function to receive the result of the versionedEhrStatusGet operation.
     * @callback module:api/EHRSTATUSApi~versionedEhrStatusGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/VersionedEhrStatus} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} ehr_id EHR identifier taken from EHR.ehr_id.value. 
     * @param {module:api/EHRSTATUSApi~versionedEhrStatusGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/VersionedEhrStatus}
     */
    versionedEhrStatusGet(ehr_id, callback) {
      let postBody = null;
      // verify the required parameter 'ehr_id' is set
      if (ehr_id === undefined || ehr_id === null) {
        throw new Error("Missing the required parameter 'ehr_id' when calling versionedEhrStatusGet");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = VersionedEhrStatus;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the versionedEhrStatusRevisionHistory operation.
     * @callback module:api/EHRSTATUSApi~versionedEhrStatusRevisionHistoryCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} ehr_id EHR identifier taken from EHR.ehr_id.value. 
     * @param {module:api/EHRSTATUSApi~versionedEhrStatusRevisionHistoryCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/RevisionHistory}
     */
    versionedEhrStatusRevisionHistory(ehr_id, callback) {
      let postBody = null;
      // verify the required parameter 'ehr_id' is set
      if (ehr_id === undefined || ehr_id === null) {
        throw new Error("Missing the required parameter 'ehr_id' when calling versionedEhrStatusRevisionHistory");
      }
    ...
    /**
     * Callback function to receive the result of the versionedEhrStatusVersionGetAtTime operation.
     * @callback module:api/EHRSTATUSApi~versionedEhrStatusVersionGetAtTimeCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.version_at_time A given time in the extended ISO 8601 format. 
     * @param {module:api/EHRSTATUSApi~versionedEhrStatusVersionGetAtTimeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Version}
     */
    versionedEhrStatusVersionGetAtTime(ehr_id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'ehr_id' is set
      if (ehr_id === undefined || ehr_id === null) {
        throw new Error("Missing the required parameter 'ehr_id' when calling versionedEhrStatusVersionGetAtTime");
      }
    ...
    /**
     * Callback function to receive the result of the versionedEhrStatusVersionGetById operation.
     * @callback module:api/EHRSTATUSApi~versionedEhrStatusVersionGetByIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Version} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} ehr_id EHR identifier taken from EHR.ehr_id.value. 
     * @param {String} version_uid VERSION identifier taken from VERSION.uid.value. 
     * @param {module:api/EHRSTATUSApi~versionedEhrStatusVersionGetByIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Version}
     */
    versionedEhrStatusVersionGetById(ehr_id, version_uid, callback) {
      let postBody = null;
      // verify the required parameter 'ehr_id' is set
      if (ehr_id === undefined || ehr_id === null) {
        throw new Error("Missing the required parameter 'ehr_id' when calling versionedEhrStatusVersionGetById");
      }
      // verify the required parameter 'version_uid' is set
      if (version_uid === undefined || version_uid === null) {
        throw new Error("Missing the required parameter 'version_uid' when calling versionedEhrStatusVersionGetById");
      }
