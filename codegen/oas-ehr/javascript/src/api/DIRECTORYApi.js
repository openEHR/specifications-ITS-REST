...
export default class DIRECTORYApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the directoryCreate operation.
     * @callback module:api/DIRECTORYApi~directoryCreateCallback
     ...
     * @param {module:model/Folder} Folder The directory. 
     ...
     * @param {module:api/DIRECTORYApi~directoryCreateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Folder}
     */
    directoryCreate(ehr_id, Folder, opts, callback) {
      opts = opts || {};
      let postBody = Folder;
      // verify the required parameter 'ehr_id' is set
      if (ehr_id === undefined || ehr_id === null) {
        throw new Error("Missing the required parameter 'ehr_id' when calling directoryCreate");
      }
      // verify the required parameter 'Folder' is set
      if (Folder === undefined || Folder === null) {
        throw new Error("Missing the required parameter 'Folder' when calling directoryCreate");
      }
    ...
    /**
     * Callback function to receive the result of the directoryDelete operation.
     * @callback module:api/DIRECTORYApi~directoryDeleteCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/DIRECTORYApi~directoryDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     */
    directoryDelete(ehr_id, If_Match, callback) {
      let postBody = null;
      // verify the required parameter 'ehr_id' is set
      if (ehr_id === undefined || ehr_id === null) {
        throw new Error("Missing the required parameter 'ehr_id' when calling directoryDelete");
      }
      // verify the required parameter 'If_Match' is set
      if (If_Match === undefined || If_Match === null) {
        throw new Error("Missing the required parameter 'If_Match' when calling directoryDelete");
      }
    ...
    /**
     * Callback function to receive the result of the directoryGetAtTime operation.
     * @callback module:api/DIRECTORYApi~directoryGetAtTimeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Folder} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.path A path to a sub-folder; consists of slash-separated values of the name attribute of FOLDERs in the directory. 
     * @param {module:api/DIRECTORYApi~directoryGetAtTimeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Folder}
     */
    directoryGetAtTime(ehr_id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'ehr_id' is set
      if (ehr_id === undefined || ehr_id === null) {
        throw new Error("Missing the required parameter 'ehr_id' when calling directoryGetAtTime");
      }
    ...
    /**
     * Callback function to receive the result of the directoryGetByVersionId operation.
     * @callback module:api/DIRECTORYApi~directoryGetByVersionIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Folder} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.path A path to a sub-folder; consists of slash-separated values of the name attribute of FOLDERs in the directory. 
     * @param {module:api/DIRECTORYApi~directoryGetByVersionIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Folder}
     */
    directoryGetByVersionId(ehr_id, version_uid, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'ehr_id' is set
      if (ehr_id === undefined || ehr_id === null) {
        throw new Error("Missing the required parameter 'ehr_id' when calling directoryGetByVersionId");
      }
      // verify the required parameter 'version_uid' is set
      if (version_uid === undefined || version_uid === null) {
        throw new Error("Missing the required parameter 'version_uid' when calling directoryGetByVersionId");
      }
    ...
    /**
     * Callback function to receive the result of the directoryUpdate operation.
     * @callback module:api/DIRECTORYApi~directoryUpdateCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Folder} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} ehr_id EHR identifier taken from EHR.ehr_id.value. 
     * @param {String} If_Match Header to make the request conditional.  Together with `ETag` request tag, it helps to prevent simultaneous updates of a resource from overwriting each other (\"mid-air collisions\"). The format is always an `version_uid` identifier enclosed by double quotes. The operation will be performed only if the existing latest `version_uid` of the resource (i.e. the `preceding_version_uid`) matches this header's value. 
     * @param {module:model/Folder} Folder The new directory. 
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.Prefer Request header to indicate the preference over response details. The response will contain the entire resource when the `Prefer` header has a value of `return=representation`.  (default to 'return=minimal')
     * @param {module:api/DIRECTORYApi~directoryUpdateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Folder}
     */
    directoryUpdate(ehr_id, If_Match, Folder, opts, callback) {
      opts = opts || {};
      let postBody = Folder;
      // verify the required parameter 'ehr_id' is set
      if (ehr_id === undefined || ehr_id === null) {
        throw new Error("Missing the required parameter 'ehr_id' when calling directoryUpdate");
      }
      // verify the required parameter 'If_Match' is set
      if (If_Match === undefined || If_Match === null) {
        throw new Error("Missing the required parameter 'If_Match' when calling directoryUpdate");
      }
      // verify the required parameter 'Folder' is set
      if (Folder === undefined || Folder === null) {
        throw new Error("Missing the required parameter 'Folder' when calling directoryUpdate");
      }
