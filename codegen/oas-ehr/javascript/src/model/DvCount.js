...
/**
 * The DvCount model module.
 * @module model/DvCount
 * @version latest
 */
class DvCount {
    /**
     * Constructs a new <code>DvCount</code>.
     * @alias module:model/DvCount
     * @extends module:model/DvAmount
     * @implements module:model/DvAmount
     */
    constructor() { 
        DvAmount.initialize(this);
        DvCount.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DvCount</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DvCount} obj Optional instance to populate.
     * @return {module:model/DvCount} The populated <code>DvCount</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>DvCount</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DvCount</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DvCount.RequiredProperties) {
            if (!data[property]) {
...
DvCount.RequiredProperties = ["magnitude"];

/**
 * @member {String} _type
 * @default 'DV_COUNT'
 */
DvCount.prototype['_type'] = 'DV_COUNT';

/**
 * @member {Number} magnitude
 */
DvCount.prototype['magnitude'] = undefined;
