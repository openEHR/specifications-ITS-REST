...
/**
 * The ArchetypeId model module.
 * @module model/ArchetypeId
 * @version latest
 */
class ArchetypeId {
    /**
     * Constructs a new <code>ArchetypeId</code>.
     * @alias module:model/ArchetypeId
    ...
    constructor(value) { 
        ...
        ArchetypeId.initialize(this, value);
    }
    ...
    /**
     * Constructs a <code>ArchetypeId</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ArchetypeId} obj Optional instance to populate.
     * @return {module:model/ArchetypeId} The populated <code>ArchetypeId</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ArchetypeId();
    ...
    /**
     * Validates the JSON data with respect to <code>ArchetypeId</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ArchetypeId</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ArchetypeId.RequiredProperties) {
            if (!data[property]) {
...
ArchetypeId.RequiredProperties = ["value"];

/**
 * @member {String} _type
 * @default 'ARCHETYPE_ID'
 */
ArchetypeId.prototype['_type'] = 'ARCHETYPE_ID';
