...
/**
 * The IsmTransition model module.
 * @module model/IsmTransition
 * @version latest
 */
class IsmTransition {
    /**
     * Constructs a new <code>IsmTransition</code>.
     * @alias module:model/IsmTransition
     * @extends module:model/Pathable
     * @implements module:model/Pathable
     */
    constructor() { 
        Pathable.initialize(this);
        IsmTransition.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IsmTransition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IsmTransition} obj Optional instance to populate.
     * @return {module:model/IsmTransition} The populated <code>IsmTransition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IsmTransition();
            ...
            if (data.hasOwnProperty('current_state')) {
                obj['current_state'] = DvCodedText.constructFromObject(data['current_state']);
            }
            if (data.hasOwnProperty('transition')) {
                obj['transition'] = DvCodedText.constructFromObject(data['transition']);
            }
            if (data.hasOwnProperty('careflow_step')) {
                obj['careflow_step'] = DvCodedText.constructFromObject(data['careflow_step']);
            }
            if (data.hasOwnProperty('reason')) {
                obj['reason'] = ApiClient.convertToType(data['reason'], [DvText]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>IsmTransition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IsmTransition</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IsmTransition.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['current_state']) { // data not null
          DvCodedText.validateJSON(data['current_state']);
        }
        // validate the optional field `transition`
        if (data['transition']) { // data not null
          DvCodedText.validateJSON(data['transition']);
        }
        // validate the optional field `careflow_step`
        if (data['careflow_step']) { // data not null
          DvCodedText.validateJSON(data['careflow_step']);
        }
        if (data['reason']) { // data not null
            ...
            // validate the optional field `reason` (array)
            for (const item of data['reason']) {
                DvText.validateJsonObject(item);
            };
        }
...
IsmTransition.RequiredProperties = ["current_state"];

/**
 * @member {String} _type
 * @default 'ISM_TRANSITION'
 */
IsmTransition.prototype['_type'] = 'ISM_TRANSITION';

/**
 * @member {module:model/DvCodedText} current_state
 */
IsmTransition.prototype['current_state'] = undefined;

/**
 * @member {module:model/DvCodedText} transition
 */
IsmTransition.prototype['transition'] = undefined;

/**
 * @member {module:model/DvCodedText} careflow_step
 */
IsmTransition.prototype['careflow_step'] = undefined;

/**
 * @member {Array.<module:model/DvText>} reason
 */
IsmTransition.prototype['reason'] = undefined;
