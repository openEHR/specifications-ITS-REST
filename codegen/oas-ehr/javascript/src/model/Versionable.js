...
/**
 * The Versionable model module.
 * @module model/Versionable
 * @version latest
 */
class Versionable {
    /**
     * Constructs a new <code>Versionable</code>.
     * A Versionable resource
     * @alias module:model/Versionable
    ...
    /**
     * Constructs a <code>Versionable</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Versionable} obj Optional instance to populate.
     * @return {module:model/Versionable} The populated <code>Versionable</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Versionable();
    ...
    /**
     * Validates the JSON data with respect to <code>Versionable</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Versionable</code>.
     */
