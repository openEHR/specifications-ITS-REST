...
/**
 * The DvQuantified model module.
 * @module model/DvQuantified
 * @version latest
 */
class DvQuantified {
    /**
     * Constructs a new <code>DvQuantified</code>.
     * @alias module:model/DvQuantified
     * @extends module:model/DvOrdered
     * @implements module:model/DvOrdered
     */
    constructor() { 
        DvOrdered.initialize(this);
        DvQuantified.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DvQuantified</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DvQuantified} obj Optional instance to populate.
     * @return {module:model/DvQuantified} The populated <code>DvQuantified</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DvQuantified();
            DvOrdered.constructFromObject(data, obj);
            DvOrdered.constructFromObject(data, obj);

            if (data.hasOwnProperty('_type')) {
                obj['_type'] = ApiClient.convertToType(data['_type'], 'String');
            }
            if (data.hasOwnProperty('magnitude_status')) {
                obj['magnitude_status'] = ApiClient.convertToType(data['magnitude_status'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DvQuantified</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DvQuantified</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['magnitude_status'] && !(typeof data['magnitude_status'] === 'string' || data['magnitude_status'] instanceof String)) {
            throw new Error("Expected the field `magnitude_status` to be a primitive type in the JSON string but got " + data['magnitude_status']);
        }
 ...
 */
DvQuantified.prototype['_type'] = 'DV_QUANTIFIED';

/**
 * @member {String} magnitude_status
 * @default '='
 */
DvQuantified.prototype['magnitude_status'] = '=';


// Implement DvOrdered interface:
/**
 * @member {String} _type
 * @default 'DV_ORDERED'
 */
