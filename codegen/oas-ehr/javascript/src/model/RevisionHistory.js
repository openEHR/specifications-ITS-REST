...
/**
 * The RevisionHistory model module.
 * @module model/RevisionHistory
 * @version latest
 */
class RevisionHistory {
    /**
     * Constructs a new <code>RevisionHistory</code>.
     * A REVISION_HISTORY resource
     * @alias module:model/RevisionHistory
     * @param items {Array.<module:model/RevisionHistoryItem>} 
     */
    constructor(items) { 
        
        RevisionHistory.initialize(this, items);
    }
    ...
    /**
     * Constructs a <code>RevisionHistory</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RevisionHistory} obj Optional instance to populate.
     * @return {module:model/RevisionHistory} The populated <code>RevisionHistory</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RevisionHistory();

            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [RevisionHistoryItem]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RevisionHistory</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RevisionHistory</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RevisionHistory.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                RevisionHistoryItem.validateJsonObject(item);
            };
        }
...
RevisionHistory.RequiredProperties = ["items"];

/**
 * @member {Array.<module:model/RevisionHistoryItem>} items
 */
RevisionHistory.prototype['items'] = undefined;
