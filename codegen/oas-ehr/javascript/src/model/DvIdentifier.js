...
/**
 * The DvIdentifier model module.
 * @module model/DvIdentifier
 * @version latest
 */
class DvIdentifier {
    /**
     * Constructs a new <code>DvIdentifier</code>.
    ...
    /**
     * Constructs a <code>DvIdentifier</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DvIdentifier} obj Optional instance to populate.
     * @return {module:model/DvIdentifier} The populated <code>DvIdentifier</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DvIdentifier();
            ...
            if (data.hasOwnProperty('assigner')) {
                obj['assigner'] = ApiClient.convertToType(data['assigner'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DvIdentifier</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DvIdentifier</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DvIdentifier.RequiredProperties) {
            if (!data[property]) {
        ...
        // ensure the json data is a string
        if (data['assigner'] && !(typeof data['assigner'] === 'string' || data['assigner'] instanceof String)) {
            throw new Error("Expected the field `assigner` to be a primitive type in the JSON string but got " + data['assigner']);
        }
        // ensure the json data is a string
...
DvIdentifier.RequiredProperties = ["id"];

/**
 * @member {String} issuer
 */
DvIdentifier.prototype['issuer'] = undefined;

/**
 * @member {String} assigner
 */
DvIdentifier.prototype['assigner'] = undefined;

/**
 * @member {String} id
 */
DvIdentifier.prototype['id'] = undefined;

/**
 * @member {String} type
 */
DvIdentifier.prototype['type'] = undefined;
