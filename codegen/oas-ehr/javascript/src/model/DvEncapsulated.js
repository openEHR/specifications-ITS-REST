...
/**
 * The DvEncapsulated model module.
 * @module model/DvEncapsulated
 * @version latest
 */
class DvEncapsulated {
    /**
     * Constructs a new <code>DvEncapsulated</code>.
     * @alias module:model/DvEncapsulated
     ...
     */
    static initialize(obj, _type) { 
        obj['_type'] = _type || 'DV_ENCAPSULATED';
    }

    /**
     * Constructs a <code>DvEncapsulated</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DvEncapsulated} obj Optional instance to populate.
     * @return {module:model/DvEncapsulated} The populated <code>DvEncapsulated</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DvEncapsulated();
            ...
            if (data.hasOwnProperty('charset')) {
                obj['charset'] = CodePhrase.constructFromObject(data['charset']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DvEncapsulated</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DvEncapsulated</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DvEncapsulated.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['charset']) { // data not null
          CodePhrase.validateJSON(data['charset']);
        }
...
DvEncapsulated.RequiredProperties = ["_type"];
...
/**
 * @member {module:model/CodePhrase} charset
 */
DvEncapsulated.prototype['charset'] = undefined;

/**
 * @member {module:model/CodePhrase} language
 */
DvEncapsulated.prototype['language'] = undefined;
