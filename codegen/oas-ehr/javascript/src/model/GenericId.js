...
/**
 * The GenericId model module.
 * @module model/GenericId
 * @version latest
 */
class GenericId {
    /**
     * Constructs a new <code>GenericId</code>.
     * @alias module:model/GenericId
    ...
    constructor(value) { 
        ...
        GenericId.initialize(this, value);
    }
    ...
    /**
     * Constructs a <code>GenericId</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenericId} obj Optional instance to populate.
     * @return {module:model/GenericId} The populated <code>GenericId</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenericId();
    ...
    /**
     * Validates the JSON data with respect to <code>GenericId</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenericId</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GenericId.RequiredProperties) {
            if (!data[property]) {
...
GenericId.RequiredProperties = ["scheme", "value"];

/**
 * @member {String} _type
 * @default 'GENERIC_ID'
 */
GenericId.prototype['_type'] = 'GENERIC_ID';

/**
 * @member {String} scheme
 */
GenericId.prototype['scheme'] = undefined;
