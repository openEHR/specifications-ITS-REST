...
class Version {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('contribution')) {
                obj['contribution'] = ObjectRef.constructFromObject(data['contribution']);
            }
            if (data.hasOwnProperty('signature')) {
                obj['signature'] = ApiClient.convertToType(data['signature'], 'String');
            }
            if (data.hasOwnProperty('commit_audit')) {
                obj['commit_audit'] = AuditDetails.constructFromObject(data['commit_audit']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['contribution']) { // data not null
          ObjectRef.validateJSON(data['contribution']);
        }
        // ensure the json data is a string
        ...
        if (data['commit_audit']) { // data not null
          AuditDetails.validateJSON(data['commit_audit']);
        }
...
Version.RequiredProperties = ["contribution", "commit_audit", "data"];
