...
/**
 * The UpdateVersion model module.
 * @module model/UpdateVersion
 * @version latest
 */
class UpdateVersion {
    /**
     * Constructs a new <code>UpdateVersion</code>.
     * @alias module:model/UpdateVersion
     * @param lifecycle_state {module:model/TerminologyCode} 
     * @param data {module:model/Versionable} 
     * @param commit_audit {module:model/UpdateAudit} 
     */
    constructor(lifecycle_state, data, commit_audit) { 
        
        UpdateVersion.initialize(this, lifecycle_state, data, commit_audit);
    }
     ...
     */
    static initialize(obj, lifecycle_state, data, commit_audit) { 
        obj['lifecycle_state'] = lifecycle_state;
        obj['data'] = data;
        obj['commit_audit'] = commit_audit;
    }

    /**
     * Constructs a <code>UpdateVersion</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateVersion} obj Optional instance to populate.
     * @return {module:model/UpdateVersion} The populated <code>UpdateVersion</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateVersion();
            ...
            if (data.hasOwnProperty('lifecycle_state')) {
                obj['lifecycle_state'] = TerminologyCode.constructFromObject(data['lifecycle_state']);
            }
            if (data.hasOwnProperty('attestations')) {
                obj['attestations'] = ApiClient.convertToType(data['attestations'], [UpdateAttestation]);
            }
            if (data.hasOwnProperty('data')) {
                obj['data'] = Versionable.constructFromObject(data['data']);
            }
            if (data.hasOwnProperty('commit_audit')) {
                obj['commit_audit'] = UpdateAudit.constructFromObject(data['commit_audit']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateVersion</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateVersion</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateVersion.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['lifecycle_state']) { // data not null
          TerminologyCode.validateJSON(data['lifecycle_state']);
        }
        if (data['attestations']) { // data not null
            ...
            for (const item of data['attestations']) {
                UpdateAttestation.validateJsonObject(item);
            };
        }
        // validate the optional field `data`
        if (data['data']) { // data not null
          Versionable.validateJSON(data['data']);
        }
        // validate the optional field `commit_audit`
        if (data['commit_audit']) { // data not null
          UpdateAudit.validateJSON(data['commit_audit']);
        }
...
UpdateVersion.RequiredProperties = ["lifecycle_state", "data", "commit_audit"];

/**
 * @member {module:model/ObjectVersionId} preceding_version_uid
 */
UpdateVersion.prototype['preceding_version_uid'] = undefined;

/**
 * @member {String} signature
 */
UpdateVersion.prototype['signature'] = undefined;

/**
 * @member {module:model/TerminologyCode} lifecycle_state
 */
UpdateVersion.prototype['lifecycle_state'] = undefined;

/**
 * @member {Array.<module:model/UpdateAttestation>} attestations
 */
UpdateVersion.prototype['attestations'] = undefined;

/**
 * @member {module:model/Versionable} data
 */
UpdateVersion.prototype['data'] = undefined;

/**
 * @member {module:model/UpdateAudit} commit_audit
 */
UpdateVersion.prototype['commit_audit'] = undefined;
