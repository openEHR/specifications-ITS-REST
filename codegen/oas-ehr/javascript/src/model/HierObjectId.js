...
/**
 * The HierObjectId model module.
 * @module model/HierObjectId
 * @version latest
 */
class HierObjectId {
    /**
     * Constructs a new <code>HierObjectId</code>.
     * @alias module:model/HierObjectId
    ...
    constructor(value) { 
        ...
        HierObjectId.initialize(this, value);
    }
    ...
    /**
     * Constructs a <code>HierObjectId</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HierObjectId} obj Optional instance to populate.
     * @return {module:model/HierObjectId} The populated <code>HierObjectId</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HierObjectId();
    ...
    /**
     * Validates the JSON data with respect to <code>HierObjectId</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HierObjectId</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HierObjectId.RequiredProperties) {
            if (!data[property]) {
...
HierObjectId.RequiredProperties = ["value"];

/**
 * @member {String} value
 */
HierObjectId.prototype['value'] = undefined;
