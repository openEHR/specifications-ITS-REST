...
/**
 * The DvState model module.
 * @module model/DvState
 * @version latest
 */
class DvState {
    /**
     * Constructs a new <code>DvState</code>.
     * @alias module:model/DvState
     * @extends module:model/DataValue
     * @implements module:model/DataValue
     */
    constructor() { 
        DataValue.initialize(this);
        DvState.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DvState</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DvState} obj Optional instance to populate.
     * @return {module:model/DvState} The populated <code>DvState</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('value')) {
                obj['value'] = DvCodedText.constructFromObject(data['value']);
            }
            if (data.hasOwnProperty('is_terminal')) {
                obj['is_terminal'] = ApiClient.convertToType(data['is_terminal'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DvState</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DvState</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DvState.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['value']) { // data not null
          DvCodedText.validateJSON(data['value']);
        }
...
DvState.RequiredProperties = ["value", "is_terminal"];

/**
 * @member {String} _type
 * @default 'DV_STATE'
 */
DvState.prototype['_type'] = 'DV_STATE';

/**
 * @member {module:model/DvCodedText} value
 */
DvState.prototype['value'] = undefined;

/**
 * @member {Boolean} is_terminal
 */
DvState.prototype['is_terminal'] = undefined;
