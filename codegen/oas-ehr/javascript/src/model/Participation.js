...
class Participation {
     ...
     * @param _function {module:model/DvText} 
     * @param performer {module:model/PartyProxy} 
     */
    constructor(_function, performer) { 
        
        Participation.initialize(this, _function, performer);
    }
     ...
     */
    static initialize(obj, _function, performer) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('function')) {
                obj['function'] = DvText.constructFromObject(data['function']);
            }
            if (data.hasOwnProperty('mode')) {
                obj['mode'] = DvCodedText.constructFromObject(data['mode']);
            }
            if (data.hasOwnProperty('performer')) {
                obj['performer'] = PartyProxy.constructFromObject(data['performer']);
            }
            if (data.hasOwnProperty('time')) {
                obj['time'] = DvIntervalOfDateTime.constructFromObject(data['time']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of Participation.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['function']) { // data not null
          DvText.validateJSON(data['function']);
        }
        // validate the optional field `mode`
        if (data['mode']) { // data not null
          DvCodedText.validateJSON(data['mode']);
        }
        // validate the optional field `performer`
        if (data['performer']) { // data not null
          PartyProxy.validateJSON(data['performer']);
        }
        // validate the optional field `time`
        if (data['time']) { // data not null
          DvIntervalOfDateTime.validateJSON(data['time']);
        }
...
Participation.RequiredProperties = ["function", "performer"];

/**
 * @member {module:model/DvText} function
 */
Participation.prototype['function'] = undefined;

/**
 * @member {module:model/DvCodedText} mode
 */
Participation.prototype['mode'] = undefined;

/**
 * @member {module:model/PartyProxy} performer
 */
Participation.prototype['performer'] = undefined;

/**
 * @member {module:model/DvIntervalOfDateTime} time
 */
Participation.prototype['time'] = undefined;
