...
class Contribution {
     ...
     * @param versions {Array.<module:model/ObjectRef>} 
     * @param audit {module:model/AuditDetails} 
     */
    constructor(uid, versions, audit) { 
        
        Contribution.initialize(this, uid, versions, audit);
    }
     ...
     */
    static initialize(obj, uid, versions, audit) { 
        obj['uid'] = uid;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('versions')) {
                obj['versions'] = ApiClient.convertToType(data['versions'], [ObjectRef]);
            }
            if (data.hasOwnProperty('audit')) {
                obj['audit'] = AuditDetails.constructFromObject(data['audit']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of Contribution.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['versions']) { // data not null
            ...
            for (const item of data['versions']) {
                ObjectRef.validateJsonObject(item);
            };
        }
        // validate the optional field `audit`
        if (data['audit']) { // data not null
          AuditDetails.validateJSON(data['audit']);
        }
...
Contribution.RequiredProperties = ["uid", "versions", "audit"];

/**
 * @member {module:model/HierObjectId} uid
 */
Contribution.prototype['uid'] = undefined;

/**
 * @member {Array.<module:model/ObjectRef>} versions
 */
Contribution.prototype['versions'] = undefined;

/**
 * @member {module:model/AuditDetails} audit
 */
Contribution.prototype['audit'] = undefined;
