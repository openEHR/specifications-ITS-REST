...
/**
 * The TerminologyId model module.
 * @module model/TerminologyId
 * @version latest
 */
class TerminologyId {
    /**
     * Constructs a new <code>TerminologyId</code>.
     * @alias module:model/TerminologyId
     * @extends module:model/ObjectId
     * @implements module:model/ObjectId
     * @param value {String} 
     */
    constructor(value) { 
        ObjectId.initialize(this, value);
        TerminologyId.initialize(this, value);
    }
    ...
    /**
     * Constructs a <code>TerminologyId</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TerminologyId} obj Optional instance to populate.
     * @return {module:model/TerminologyId} The populated <code>TerminologyId</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TerminologyId();
            ObjectId.constructFromObject(data, obj);
            ObjectId.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>TerminologyId</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TerminologyId</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TerminologyId.RequiredProperties) {
            if (!data[property]) {
...
TerminologyId.RequiredProperties = ["value"];

/**
 * @member {String} _type
 * @default 'TERMINOLOGY_ID'
 */
TerminologyId.prototype['_type'] = 'TERMINOLOGY_ID';


// Implement ObjectId interface:
/**
 * @member {String} _type
 */
ObjectId.prototype['_type'] = undefined;
/**
 * @member {String} value
 */
ObjectId.prototype['value'] = undefined;




export default TerminologyId;
