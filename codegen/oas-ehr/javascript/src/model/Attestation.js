...
class Attestation {
     ...
     * @extends module:model/AuditDetails
     * @implements module:model/AuditDetails
    ...
    constructor(system_id, time_committed, change_type, committer) { 
        ...
        Attestation.initialize(this, system_id, time_committed, change_type, committer);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            AuditDetails.constructFromObject(data, obj);
            AuditDetails.constructFromObject(data, obj);
    ...
    static validateJSON(data) {
        ...
        for (const property of Attestation.RequiredProperties) {
            if (!data[property]) {
...
Attestation.RequiredProperties = ["reason", "is_pending", "system_id", "time_committed", "change_type", "committer"];

/**
 * @member {String} _type
 * @default 'ATTESTATION'
 */
Attestation.prototype['_type'] = 'ATTESTATION';

/**
 * @member {module:model/DvMultimedia} attested_view
 */
Attestation.prototype['attested_view'] = undefined;

/**
 * @member {String} proof
 */
Attestation.prototype['proof'] = undefined;

/**
 * @member {Array.<module:model/DvEhrUri>} items
 */
Attestation.prototype['items'] = undefined;

/**
 * @member {module:model/DvText} reason
 */
Attestation.prototype['reason'] = undefined;

/**
 * @member {Boolean} is_pending
 */
Attestation.prototype['is_pending'] = undefined;


// Implement AuditDetails interface:
/**
 * @member {String} _type
