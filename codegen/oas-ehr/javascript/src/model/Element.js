...
class Element {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('null_flavour')) {
                obj['null_flavour'] = DvCodedText.constructFromObject(data['null_flavour']);
            }
            if (data.hasOwnProperty('value')) {
                obj['value'] = DataValue.constructFromObject(data['value']);
            }
            if (data.hasOwnProperty('null_reason')) {
                obj['null_reason'] = DvText.constructFromObject(data['null_reason']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `null_flavour`
        if (data['null_flavour']) { // data not null
          DvCodedText.validateJSON(data['null_flavour']);
        }
        // validate the optional field `value`
        if (data['value']) { // data not null
          DataValue.validateJSON(data['value']);
        }
        // validate the optional field `null_reason`
        if (data['null_reason']) { // data not null
          DvText.validateJSON(data['null_reason']);
        }
 ...
 * @default 'ELEMENT'
 */
Element.prototype['_type'] = 'ELEMENT';

/**
 * @member {module:model/DvCodedText} null_flavour
 */
Element.prototype['null_flavour'] = undefined;

/**
 * @member {module:model/DataValue} value
 */
Element.prototype['value'] = undefined;

/**
 * @member {module:model/DvText} null_reason
 */
Element.prototype['null_reason'] = undefined;
 ...
 * @member {String} _type
 */
Item.prototype['_type'] = undefined;
