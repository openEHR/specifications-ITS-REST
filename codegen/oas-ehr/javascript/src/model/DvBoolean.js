...
/**
 * The DvBoolean model module.
 * @module model/DvBoolean
 * @version latest
 */
class DvBoolean {
    /**
     * Constructs a new <code>DvBoolean</code>.
     * @alias module:model/DvBoolean
     * @extends module:model/DataValue
     * @implements module:model/DataValue
     */
    constructor() { 
        DataValue.initialize(this);
        DvBoolean.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DvBoolean</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DvBoolean} obj Optional instance to populate.
     * @return {module:model/DvBoolean} The populated <code>DvBoolean</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DvBoolean();
    ...
    /**
     * Validates the JSON data with respect to <code>DvBoolean</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DvBoolean</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DvBoolean.RequiredProperties) {
            if (!data[property]) {
...
DvBoolean.RequiredProperties = ["value"];

/**
 * @member {String} _type
 * @default 'DV_BOOLEAN'
 */
DvBoolean.prototype['_type'] = 'DV_BOOLEAN';

/**
 * @member {Boolean} value
 */
DvBoolean.prototype['value'] = undefined;
