...
class EventContext {
     ...
     * @param {module:model/EventContext} obj Optional instance to populate.
     * @return {module:model/EventContext} The populated <code>EventContext</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventContext();
            Pathable.constructFromObject(data, obj);
            Pathable.constructFromObject(data, obj);

            if (data.hasOwnProperty('start_time')) {
                obj['start_time'] = DvDateTime.constructFromObject(data['start_time']);
            }
            if (data.hasOwnProperty('end_time')) {
                obj['end_time'] = DvDateTime.constructFromObject(data['end_time']);
            }
            if (data.hasOwnProperty('location')) {
                obj['location'] = ApiClient.convertToType(data['location'], 'String');
            }
            if (data.hasOwnProperty('setting')) {
                obj['setting'] = DvCodedText.constructFromObject(data['setting']);
            }
            if (data.hasOwnProperty('other_context')) {
                obj['other_context'] = ItemStructure.constructFromObject(data['other_context']);
            }
            if (data.hasOwnProperty('health_care_facility')) {
                obj['health_care_facility'] = PartyIdentified.constructFromObject(data['health_care_facility']);
            }
            if (data.hasOwnProperty('participations')) {
                obj['participations'] = ApiClient.convertToType(data['participations'], [Participation]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EventContext</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventContext</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EventContext.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['start_time']) { // data not null
          DvDateTime.validateJSON(data['start_time']);
        }
        // validate the optional field `end_time`
        if (data['end_time']) { // data not null
          DvDateTime.validateJSON(data['end_time']);
        }
        ...
        if (data['setting']) { // data not null
          DvCodedText.validateJSON(data['setting']);
        }
        // validate the optional field `other_context`
        if (data['other_context']) { // data not null
          ItemStructure.validateJSON(data['other_context']);
        }
        // validate the optional field `health_care_facility`
        if (data['health_care_facility']) { // data not null
          PartyIdentified.validateJSON(data['health_care_facility']);
        }
...
EventContext.RequiredProperties = ["start_time", "setting"];

/**
 * @member {module:model/DvDateTime} start_time
 */
EventContext.prototype['start_time'] = undefined;

/**
 * @member {module:model/DvDateTime} end_time
 */
EventContext.prototype['end_time'] = undefined;

/**
 * @member {String} location
 */
EventContext.prototype['location'] = undefined;

/**
 * @member {module:model/DvCodedText} setting
 */
EventContext.prototype['setting'] = undefined;

/**
 * @member {module:model/ItemStructure} other_context
 */
EventContext.prototype['other_context'] = undefined;

/**
 * @member {module:model/PartyIdentified} health_care_facility
 */
EventContext.prototype['health_care_facility'] = undefined;

/**
 * @member {Array.<module:model/Participation>} participations
 */
EventContext.prototype['participations'] = undefined;
