...
/**
 * The FeederAudit model module.
 * @module model/FeederAudit
 * @version latest
 */
class FeederAudit {
    /**
     * Constructs a new <code>FeederAudit</code>.
     * @alias module:model/FeederAudit
     * @param originating_system_audit {module:model/FeederAuditDetails} 
     */
    constructor(originating_system_audit) { 
        
        FeederAudit.initialize(this, originating_system_audit);
    }
     ...
     */
    static initialize(obj, originating_system_audit) { 
        obj['originating_system_audit'] = originating_system_audit;
    }

    /**
     * Constructs a <code>FeederAudit</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FeederAudit} obj Optional instance to populate.
     * @return {module:model/FeederAudit} The populated <code>FeederAudit</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FeederAudit();

            if (data.hasOwnProperty('originating_system_item_ids')) {
                obj['originating_system_item_ids'] = ApiClient.convertToType(data['originating_system_item_ids'], [DvIdentifier]);
            }
            if (data.hasOwnProperty('feeder_system_item_ids')) {
                obj['feeder_system_item_ids'] = ApiClient.convertToType(data['feeder_system_item_ids'], [DvIdentifier]);
            }
            if (data.hasOwnProperty('original_content')) {
                obj['original_content'] = DvEncapsulated.constructFromObject(data['original_content']);
            }
            if (data.hasOwnProperty('originating_system_audit')) {
                obj['originating_system_audit'] = FeederAuditDetails.constructFromObject(data['originating_system_audit']);
            }
            if (data.hasOwnProperty('feeder_system_audit')) {
                obj['feeder_system_audit'] = FeederAuditDetails.constructFromObject(data['feeder_system_audit']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FeederAudit</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FeederAudit</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FeederAudit.RequiredProperties) {
            if (!data[property]) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        if (data['originating_system_item_ids']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['originating_system_item_ids'])) {
                throw new Error("Expected the field `originating_system_item_ids` to be an array in the JSON data but got " + data['originating_system_item_ids']);
            }
            // validate the optional field `originating_system_item_ids` (array)
            for (const item of data['originating_system_item_ids']) {
                DvIdentifier.validateJsonObject(item);
            };
        }
        if (data['feeder_system_item_ids']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['feeder_system_item_ids'])) {
                throw new Error("Expected the field `feeder_system_item_ids` to be an array in the JSON data but got " + data['feeder_system_item_ids']);
            }
            // validate the optional field `feeder_system_item_ids` (array)
            for (const item of data['feeder_system_item_ids']) {
                DvIdentifier.validateJsonObject(item);
            };
        }
        // validate the optional field `original_content`
        if (data['original_content']) { // data not null
          DvEncapsulated.validateJSON(data['original_content']);
        }
        // validate the optional field `originating_system_audit`
        if (data['originating_system_audit']) { // data not null
          FeederAuditDetails.validateJSON(data['originating_system_audit']);
        }
        // validate the optional field `feeder_system_audit`
        if (data['feeder_system_audit']) { // data not null
          FeederAuditDetails.validateJSON(data['feeder_system_audit']);
        }
...
FeederAudit.RequiredProperties = ["originating_system_audit"];

/**
 * @member {Array.<module:model/DvIdentifier>} originating_system_item_ids
 */
FeederAudit.prototype['originating_system_item_ids'] = undefined;

/**
 * @member {Array.<module:model/DvIdentifier>} feeder_system_item_ids
 */
FeederAudit.prototype['feeder_system_item_ids'] = undefined;

/**
 * @member {module:model/DvEncapsulated} original_content
 */
FeederAudit.prototype['original_content'] = undefined;

/**
 * @member {module:model/FeederAuditDetails} originating_system_audit
 */
FeederAudit.prototype['originating_system_audit'] = undefined;

/**
 * @member {module:model/FeederAuditDetails} feeder_system_audit
 */
FeederAudit.prototype['feeder_system_audit'] = undefined;
