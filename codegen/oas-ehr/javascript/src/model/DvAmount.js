...
/**
 * The DvAmount model module.
 * @module model/DvAmount
 * @version latest
 */
class DvAmount {
    /**
     * Constructs a new <code>DvAmount</code>.
     * @alias module:model/DvAmount
     * @extends module:model/DvQuantified
     * @implements module:model/DvQuantified
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>DvAmount</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DvAmount} obj Optional instance to populate.
     * @return {module:model/DvAmount} The populated <code>DvAmount</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DvAmount();
            DvQuantified.constructFromObject(data, obj);
            DvQuantified.constructFromObject(data, obj);

            if (data.hasOwnProperty('_type')) {
                obj['_type'] = ApiClient.convertToType(data['_type'], 'String');
            }
            if (data.hasOwnProperty('accuracy_is_percent')) {
                obj['accuracy_is_percent'] = ApiClient.convertToType(data['accuracy_is_percent'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DvAmount</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DvAmount</code>.
     */
...
/**
 * @member {Boolean} accuracy_is_percent
 */
DvAmount.prototype['accuracy_is_percent'] = undefined;

/**
 * @member {Number} accuracy
 */
DvAmount.prototype['accuracy'] = undefined;


// Implement DvQuantified interface:
/**
 * @member {String} _type
