...
/**
 * The DvMultimedia model module.
 * @module model/DvMultimedia
 * @version latest
 */
class DvMultimedia {
    /**
     * Constructs a new <code>DvMultimedia</code>.
     * @alias module:model/DvMultimedia
     * @extends module:model/DvEncapsulated
     * @implements module:model/DvEncapsulated
     */
    constructor() { 
        DvEncapsulated.initialize(this, _type);
        DvMultimedia.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DvMultimedia</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DvMultimedia} obj Optional instance to populate.
     * @return {module:model/DvMultimedia} The populated <code>DvMultimedia</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DvMultimedia();
            DvEncapsulated.constructFromObject(data, obj);
            DvEncapsulated.constructFromObject(data, obj);

            if (data.hasOwnProperty('_type')) {
                obj['_type'] = ApiClient.convertToType(data['_type'], 'String');
            }
            if (data.hasOwnProperty('alternate_text')) {
                obj['alternate_text'] = ApiClient.convertToType(data['alternate_text'], 'String');
            }
            if (data.hasOwnProperty('uri')) {
                obj['uri'] = DvUri.constructFromObject(data['uri']);
            }
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], 'String');
            }
            if (data.hasOwnProperty('media_type')) {
                obj['media_type'] = CodePhrase.constructFromObject(data['media_type']);
            }
            if (data.hasOwnProperty('compression_algorithm')) {
                obj['compression_algorithm'] = CodePhrase.constructFromObject(data['compression_algorithm']);
            }
            if (data.hasOwnProperty('integrity_check')) {
                obj['integrity_check'] = ApiClient.convertToType(data['integrity_check'], 'String');
            }
            if (data.hasOwnProperty('integrity_check_algorithm')) {
                obj['integrity_check_algorithm'] = CodePhrase.constructFromObject(data['integrity_check_algorithm']);
            }
            if (data.hasOwnProperty('thumbnail')) {
                obj['thumbnail'] = DvMultimedia.constructFromObject(data['thumbnail']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DvMultimedia</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DvMultimedia</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DvMultimedia.RequiredProperties) {
            if (!data[property]) {
        ...
        // ensure the json data is a string
        if (data['alternate_text'] && !(typeof data['alternate_text'] === 'string' || data['alternate_text'] instanceof String)) {
            throw new Error("Expected the field `alternate_text` to be a primitive type in the JSON string but got " + data['alternate_text']);
        }
        // validate the optional field `uri`
        if (data['uri']) { // data not null
          DvUri.validateJSON(data['uri']);
        }
        // ensure the json data is a string
        ...
        if (data['media_type']) { // data not null
          CodePhrase.validateJSON(data['media_type']);
        }
        // validate the optional field `compression_algorithm`
        if (data['compression_algorithm']) { // data not null
          CodePhrase.validateJSON(data['compression_algorithm']);
        }
        // ensure the json data is a string
        if (data['integrity_check'] && !(typeof data['integrity_check'] === 'string' || data['integrity_check'] instanceof String)) {
            throw new Error("Expected the field `integrity_check` to be a primitive type in the JSON string but got " + data['integrity_check']);
        }
        // validate the optional field `integrity_check_algorithm`
        if (data['integrity_check_algorithm']) { // data not null
          CodePhrase.validateJSON(data['integrity_check_algorithm']);
        }
        // validate the optional field `thumbnail`
        if (data['thumbnail']) { // data not null
          DvMultimedia.validateJSON(data['thumbnail']);
        }
...
DvMultimedia.RequiredProperties = ["media_type", "size"];

/**
 * @member {String} _type
 * @default 'DV_MULTIMEDIA'
 */
DvMultimedia.prototype['_type'] = 'DV_MULTIMEDIA';

/**
 * @member {String} alternate_text
 */
DvMultimedia.prototype['alternate_text'] = undefined;

/**
 * @member {module:model/DvUri} uri
 */
DvMultimedia.prototype['uri'] = undefined;

/**
 * @member {String} data
 */
DvMultimedia.prototype['data'] = undefined;

/**
 * @member {module:model/CodePhrase} media_type
 */
DvMultimedia.prototype['media_type'] = undefined;

/**
 * @member {module:model/CodePhrase} compression_algorithm
 */
DvMultimedia.prototype['compression_algorithm'] = undefined;

/**
 * @member {String} integrity_check
 */
DvMultimedia.prototype['integrity_check'] = undefined;

/**
 * @member {module:model/CodePhrase} integrity_check_algorithm
 */
DvMultimedia.prototype['integrity_check_algorithm'] = undefined;

/**
 * @member {module:model/DvMultimedia} thumbnail
 */
DvMultimedia.prototype['thumbnail'] = undefined;

/**
 * @member {Number} size
 */
DvMultimedia.prototype['size'] = undefined;


// Implement DvEncapsulated interface:
/**
 * @member {String} _type
 * @default 'DV_ENCAPSULATED'
 */
DvEncapsulated.prototype['_type'] = 'DV_ENCAPSULATED';




export default DvMultimedia;
