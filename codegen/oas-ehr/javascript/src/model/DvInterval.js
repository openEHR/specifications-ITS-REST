...
/**
 * The DvInterval model module.
 * @module model/DvInterval
 * @version latest
 */
class DvInterval {
    /**
     * Constructs a new <code>DvInterval</code>.
     * @alias module:model/DvInterval
     * @extends module:model/DataValue
     * @implements module:model/DataValue
     */
    constructor() { 
        DataValue.initialize(this);
        DvInterval.initialize(this);
    }
    ...
    static initialize(obj) { 
        obj['lower_unbounded'] = lower_unbounded;
        obj['upper_unbounded'] = upper_unbounded;
        obj['lower_included'] = lower_included;
        obj['upper_included'] = upper_included;
    }

    /**
     * Constructs a <code>DvInterval</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DvInterval} obj Optional instance to populate.
     * @return {module:model/DvInterval} The populated <code>DvInterval</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DvInterval();
            ...
            if (data.hasOwnProperty('lower_unbounded')) {
                obj['lower_unbounded'] = ApiClient.convertToType(data['lower_unbounded'], 'Boolean');
            }
            if (data.hasOwnProperty('upper_unbounded')) {
                obj['upper_unbounded'] = ApiClient.convertToType(data['upper_unbounded'], 'Boolean');
            }
            if (data.hasOwnProperty('lower_included')) {
                obj['lower_included'] = ApiClient.convertToType(data['lower_included'], 'Boolean');
            }
            if (data.hasOwnProperty('upper_included')) {
                obj['upper_included'] = ApiClient.convertToType(data['upper_included'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DvInterval</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DvInterval</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DvInterval.RequiredProperties) {
            if (!data[property]) {
...
DvInterval.RequiredProperties = ["lower_unbounded", "upper_unbounded", "lower_included", "upper_included"];

/**
 * @member {String} _type
 * @default 'DV_INTERVAL'
 */
DvInterval.prototype['_type'] = 'DV_INTERVAL';

/**
 * @member {Boolean} lower_unbounded
 */
DvInterval.prototype['lower_unbounded'] = undefined;

/**
 * @member {Boolean} upper_unbounded
 */
DvInterval.prototype['upper_unbounded'] = undefined;

/**
 * @member {Boolean} lower_included
 */
DvInterval.prototype['lower_included'] = undefined;

/**
 * @member {Boolean} upper_included
 */
DvInterval.prototype['upper_included'] = undefined;
