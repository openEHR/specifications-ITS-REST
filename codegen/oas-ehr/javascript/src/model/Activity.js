...
class Activity {
     ...
     * @extends module:model/Locatable
     * @implements module:model/Locatable
     */
    constructor() { 
    ...
    static initialize(obj) { 
        obj['action_archetype_id'] = action_archetype_id;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            Locatable.constructFromObject(data, obj);
            Locatable.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('timing')) {
                obj['timing'] = DvParsable.constructFromObject(data['timing']);
            }
            if (data.hasOwnProperty('action_archetype_id')) {
                obj['action_archetype_id'] = ApiClient.convertToType(data['action_archetype_id'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['timing']) { // data not null
          DvParsable.validateJSON(data['timing']);
        }
        // ensure the json data is a string
        if (data['action_archetype_id'] && !(typeof data['action_archetype_id'] === 'string' || data['action_archetype_id'] instanceof String)) {
            throw new Error("Expected the field `action_archetype_id` to be a primitive type in the JSON string but got " + data['action_archetype_id']);
        }
...
Activity.RequiredProperties = ["action_archetype_id", "description"];

/**
 * @member {String} _type
 * @default 'ACTIVITY'
 */
Activity.prototype['_type'] = 'ACTIVITY';

/**
 * @member {module:model/DvParsable} timing
 */
Activity.prototype['timing'] = undefined;

/**
 * @member {String} action_archetype_id
 */
Activity.prototype['action_archetype_id'] = undefined;
 ...
 * @member {String} _type
 */
Locatable.prototype['_type'] = undefined;
