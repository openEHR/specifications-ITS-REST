...
/**
 * The CareEntry model module.
 * @module model/CareEntry
 * @version latest
 */
class CareEntry {
    /**
     * Constructs a new <code>CareEntry</code>.
     * @alias module:model/CareEntry
     * @extends module:model/AbstractEntry
     * @implements module:model/AbstractEntry
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>CareEntry</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CareEntry} obj Optional instance to populate.
     * @return {module:model/CareEntry} The populated <code>CareEntry</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CareEntry();
            AbstractEntry.constructFromObject(data, obj);
            AbstractEntry.constructFromObject(data, obj);

            if (data.hasOwnProperty('protocol')) {
                obj['protocol'] = ItemStructure.constructFromObject(data['protocol']);
            }
            if (data.hasOwnProperty('guideline_id')) {
                obj['guideline_id'] = ObjectRef.constructFromObject(data['guideline_id']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CareEntry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CareEntry</code>.
     */
    static validateJSON(data) {
        // validate the optional field `protocol`
        if (data['protocol']) { // data not null
          ItemStructure.validateJSON(data['protocol']);
        }
        // validate the optional field `guideline_id`
        if (data['guideline_id']) { // data not null
          ObjectRef.validateJSON(data['guideline_id']);
        }
...
/**
 * @member {module:model/ItemStructure} protocol
 */
CareEntry.prototype['protocol'] = undefined;

/**
 * @member {module:model/ObjectRef} guideline_id
 */
CareEntry.prototype['guideline_id'] = undefined;


// Implement AbstractEntry interface:
/**
 * @member {String} _type
 */
AbstractEntry.prototype['_type'] = undefined;
