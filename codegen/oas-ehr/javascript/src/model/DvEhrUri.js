...
/**
 * The DvEhrUri model module.
 * @module model/DvEhrUri
 * @version latest
 */
class DvEhrUri {
    /**
     * Constructs a new <code>DvEhrUri</code>.
     * @alias module:model/DvEhrUri
     * @extends module:model/DvUri
     * @implements module:model/DvUri
     */
    constructor() { 
        DvUri.initialize(this);
        DvEhrUri.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DvEhrUri</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DvEhrUri} obj Optional instance to populate.
     * @return {module:model/DvEhrUri} The populated <code>DvEhrUri</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DvEhrUri();
            DvUri.constructFromObject(data, obj);
            DvUri.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DvEhrUri</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DvEhrUri</code>.
     */
 ...
 * @default 'DV_EHR_URI'
 */
DvEhrUri.prototype['_type'] = 'DV_EHR_URI';


// Implement DvUri interface:
/**
 * @member {String} _type
 * @default 'DV_URI'
 */
