...
class Error {
     ...
     * @param validationErrors {Array.<String>} 
     */
    constructor(message, validationErrors) { 
        
        Error.initialize(this, message, validationErrors);
    }
...
Error.RequiredProperties = ["message", "validationErrors"];
 ...
 */
Error.prototype['validationErrors'] = undefined;
