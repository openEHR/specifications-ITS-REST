...
/**
 * The TermMapping model module.
 * @module model/TermMapping
 * @version latest
 */
class TermMapping {
    /**
     * Constructs a new <code>TermMapping</code>.
     * @alias module:model/TermMapping
     * @param match {String} 
     * @param target {module:model/CodePhrase} 
     */
    constructor(match, target) { 
        
        TermMapping.initialize(this, match, target);
    }
     ...
     */
    static initialize(obj, match, target) { 
        obj['match'] = match;
        obj['target'] = target;
    }

    /**
     * Constructs a <code>TermMapping</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TermMapping} obj Optional instance to populate.
     * @return {module:model/TermMapping} The populated <code>TermMapping</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TermMapping();

            if (data.hasOwnProperty('match')) {
                obj['match'] = ApiClient.convertToType(data['match'], 'String');
            }
            if (data.hasOwnProperty('purpose')) {
                obj['purpose'] = DvCodedText.constructFromObject(data['purpose']);
            }
            if (data.hasOwnProperty('target')) {
                obj['target'] = CodePhrase.constructFromObject(data['target']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TermMapping</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TermMapping</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TermMapping.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['purpose']) { // data not null
          DvCodedText.validateJSON(data['purpose']);
        }
        // validate the optional field `target`
        if (data['target']) { // data not null
          CodePhrase.validateJSON(data['target']);
        }
...
TermMapping.RequiredProperties = ["match", "target"];

/**
 * @member {String} match
 */
TermMapping.prototype['match'] = undefined;

/**
 * @member {module:model/DvCodedText} purpose
 */
TermMapping.prototype['purpose'] = undefined;

/**
 * @member {module:model/CodePhrase} target
 */
TermMapping.prototype['target'] = undefined;
