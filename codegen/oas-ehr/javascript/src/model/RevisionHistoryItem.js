...
/**
 * The RevisionHistoryItem model module.
 * @module model/RevisionHistoryItem
 * @version latest
 */
class RevisionHistoryItem {
    /**
     * Constructs a new <code>RevisionHistoryItem</code>.
     * A REVISION_HISTORY_ITEM resource
     * @alias module:model/RevisionHistoryItem
     * @param version_id {module:model/ObjectVersionId} 
     * @param audits {Array.<module:model/AuditDetails>} 
     */
    constructor(version_id, audits) { 
        
        RevisionHistoryItem.initialize(this, version_id, audits);
    }
     ...
     */
    static initialize(obj, version_id, audits) { 
        obj['version_id'] = version_id;
        obj['audits'] = audits;
    }

    /**
     * Constructs a <code>RevisionHistoryItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RevisionHistoryItem} obj Optional instance to populate.
     * @return {module:model/RevisionHistoryItem} The populated <code>RevisionHistoryItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RevisionHistoryItem();

            if (data.hasOwnProperty('version_id')) {
                obj['version_id'] = ObjectVersionId.constructFromObject(data['version_id']);
            }
            if (data.hasOwnProperty('audits')) {
                obj['audits'] = ApiClient.convertToType(data['audits'], [AuditDetails]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RevisionHistoryItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RevisionHistoryItem</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RevisionHistoryItem.RequiredProperties) {
            if (!data[property]) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `version_id`
        if (data['version_id']) { // data not null
          ObjectVersionId.validateJSON(data['version_id']);
        }
        if (data['audits']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['audits'])) {
                throw new Error("Expected the field `audits` to be an array in the JSON data but got " + data['audits']);
            }
            // validate the optional field `audits` (array)
            for (const item of data['audits']) {
                AuditDetails.validateJsonObject(item);
            };
        }
...
RevisionHistoryItem.RequiredProperties = ["version_id", "audits"];

/**
 * @member {module:model/ObjectVersionId} version_id
 */
RevisionHistoryItem.prototype['version_id'] = undefined;

/**
 * @member {Array.<module:model/AuditDetails>} audits
 */
RevisionHistoryItem.prototype['audits'] = undefined;
...
export default RevisionHistoryItem;
