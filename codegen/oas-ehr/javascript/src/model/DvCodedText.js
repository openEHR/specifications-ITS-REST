...
/**
 * The DvCodedText model module.
 * @module model/DvCodedText
 * @version latest
 */
class DvCodedText {
    /**
     * Constructs a new <code>DvCodedText</code>.
     * @alias module:model/DvCodedText
     * @extends module:model/DvText
     * @implements module:model/DvText
     */
    constructor() { 
        DvText.initialize(this);
        DvCodedText.initialize(this);
    }
    ...
    static initialize(obj) { 
        obj['defining_code'] = defining_code;
    }

    /**
     * Constructs a <code>DvCodedText</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DvCodedText} obj Optional instance to populate.
     * @return {module:model/DvCodedText} The populated <code>DvCodedText</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DvCodedText();
            DvText.constructFromObject(data, obj);
            DvText.constructFromObject(data, obj);

            if (data.hasOwnProperty('_type')) {
                obj['_type'] = ApiClient.convertToType(data['_type'], 'String');
            }
            if (data.hasOwnProperty('defining_code')) {
                obj['defining_code'] = CodePhrase.constructFromObject(data['defining_code']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DvCodedText</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DvCodedText</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DvCodedText.RequiredProperties) {
            if (!data[property]) {
        ...
        // validate the optional field `defining_code`
        if (data['defining_code']) { // data not null
          CodePhrase.validateJSON(data['defining_code']);
        }
...
DvCodedText.RequiredProperties = ["defining_code"];

/**
 * @member {String} _type
 * @default 'DV_CODED_TEXT'
 */
DvCodedText.prototype['_type'] = 'DV_CODED_TEXT';

/**
 * @member {module:model/CodePhrase} defining_code
 */
DvCodedText.prototype['defining_code'] = undefined;


// Implement DvText interface:
/**
 * @member {String} _type
 * @default 'DV_TEXT'
 */
