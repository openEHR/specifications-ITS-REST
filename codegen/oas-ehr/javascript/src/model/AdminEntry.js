...
/**
 * The AdminEntry model module.
 * @module model/AdminEntry
 * @version latest
 */
class AdminEntry {
    /**
     * Constructs a new <code>AdminEntry</code>.
     * @alias module:model/AdminEntry
     * @extends module:model/AbstractEntry
     * @implements module:model/AbstractEntry
     */
    constructor() { 
        AbstractEntry.initialize(this);
        AdminEntry.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdminEntry</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminEntry} obj Optional instance to populate.
     * @return {module:model/AdminEntry} The populated <code>AdminEntry</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminEntry();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ItemStructure.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AdminEntry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminEntry</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminEntry.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          ItemStructure.validateJSON(data['data']);
        }
...
AdminEntry.RequiredProperties = ["data"];

/**
 * @member {String} _type
 * @default 'ADMIN_ENTRY'
 */
AdminEntry.prototype['_type'] = 'ADMIN_ENTRY';

/**
 * @member {module:model/ItemStructure} data
 */
AdminEntry.prototype['data'] = undefined;
