...
/**
 * The UidBasedId model module.
 * @module model/UidBasedId
 * @version latest
 */
class UidBasedId {
    /**
     * Constructs a new <code>UidBasedId</code>.
     * @alias module:model/UidBasedId
    ...
    /**
     * Constructs a <code>UidBasedId</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UidBasedId} obj Optional instance to populate.
     * @return {module:model/UidBasedId} The populated <code>UidBasedId</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UidBasedId();
    ...
    /**
     * Validates the JSON data with respect to <code>UidBasedId</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UidBasedId</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UidBasedId.RequiredProperties) {
            if (!data[property]) {
...
UidBasedId.RequiredProperties = ["value"];
