...
/**
 * The DvOrdered model module.
 * @module model/DvOrdered
 * @version latest
 */
class DvOrdered {
    /**
     * Constructs a new <code>DvOrdered</code>.
     * @alias module:model/DvOrdered
     * @extends module:model/DataValue
     * @implements module:model/DataValue
     */
    constructor() { 
        DataValue.initialize(this);
        DvOrdered.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DvOrdered</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DvOrdered} obj Optional instance to populate.
     * @return {module:model/DvOrdered} The populated <code>DvOrdered</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DvOrdered();
            DataValue.constructFromObject(data, obj);
            DataValue.constructFromObject(data, obj);

            if (data.hasOwnProperty('_type')) {
                obj['_type'] = ApiClient.convertToType(data['_type'], 'String');
            }
            if (data.hasOwnProperty('normal_status')) {
                obj['normal_status'] = CodePhrase.constructFromObject(data['normal_status']);
            }
            if (data.hasOwnProperty('normal_range')) {
                obj['normal_range'] = DvInterval.constructFromObject(data['normal_range']);
            }
            if (data.hasOwnProperty('other_reference_ranges')) {
                obj['other_reference_ranges'] = ApiClient.convertToType(data['other_reference_ranges'], [ReferenceRange]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DvOrdered</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DvOrdered</code>.
     */
    static validateJSON(data) {
        ...
        // validate the optional field `normal_status`
        if (data['normal_status']) { // data not null
          CodePhrase.validateJSON(data['normal_status']);
        }
        // validate the optional field `normal_range`
        if (data['normal_range']) { // data not null
          DvInterval.validateJSON(data['normal_range']);
        }
        if (data['other_reference_ranges']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['other_reference_ranges'])) {
                throw new Error("Expected the field `other_reference_ranges` to be an array in the JSON data but got " + data['other_reference_ranges']);
            }
            // validate the optional field `other_reference_ranges` (array)
            for (const item of data['other_reference_ranges']) {
                ReferenceRange.validateJsonObject(item);
            };
        }
 ...
 * @default 'DV_ORDERED'
 */
DvOrdered.prototype['_type'] = 'DV_ORDERED';

/**
 * @member {module:model/CodePhrase} normal_status
 */
DvOrdered.prototype['normal_status'] = undefined;

/**
 * @member {module:model/DvInterval} normal_range
 */
DvOrdered.prototype['normal_range'] = undefined;

/**
 * @member {Array.<module:model/ReferenceRange>} other_reference_ranges
 */
DvOrdered.prototype['other_reference_ranges'] = undefined;


// Implement DataValue interface:
/**
 * @member {String} _type
 */
DataValue.prototype['_type'] = undefined;




export default DvOrdered;
