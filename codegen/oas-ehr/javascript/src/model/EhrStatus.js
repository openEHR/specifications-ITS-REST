...
/**
 * The EhrStatus model module.
 * @module model/EhrStatus
 * @version latest
 */
class EhrStatus {
    /**
     * Constructs a new <code>EhrStatus</code>.
     * An EHR_STATUS resource
     * @alias module:model/EhrStatus
     * @extends module:model/Versionable
     * @implements module:model/Versionable
     */
    constructor() { 
        Versionable.initialize(this);
        EhrStatus.initialize(this);
    }
    ...
    static initialize(obj) { 
        obj['subject'] = subject;
        obj['is_queryable'] = is_queryable || true;
        obj['is_modifiable'] = is_modifiable || true;
    }

    /**
     * Constructs a <code>EhrStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EhrStatus} obj Optional instance to populate.
     * @return {module:model/EhrStatus} The populated <code>EhrStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EhrStatus();
            ...
            if (data.hasOwnProperty('is_queryable')) {
                obj['is_queryable'] = ApiClient.convertToType(data['is_queryable'], 'Boolean');
            }
            if (data.hasOwnProperty('is_modifiable')) {
                obj['is_modifiable'] = ApiClient.convertToType(data['is_modifiable'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>EhrStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EhrStatus</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EhrStatus.RequiredProperties) {
            if (!data[property]) {
...
EhrStatus.RequiredProperties = ["subject", "is_queryable", "is_modifiable"];

/**
 * @member {String} _type
 * @default 'EHR_STATUS'
 */
EhrStatus.prototype['_type'] = 'EHR_STATUS';

/**
 * @member {module:model/PartyProxy} subject
 */
EhrStatus.prototype['subject'] = undefined;

/**
 * @member {Boolean} is_queryable
 * @default true
 */
EhrStatus.prototype['is_queryable'] = true;

/**
 * @member {Boolean} is_modifiable
 * @default true
 */
EhrStatus.prototype['is_modifiable'] = true;

/**
 * @member {module:model/ItemStructure} other_details
 */
EhrStatus.prototype['other_details'] = undefined;
