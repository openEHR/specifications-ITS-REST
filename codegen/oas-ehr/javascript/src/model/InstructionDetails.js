...
/**
 * The InstructionDetails model module.
 * @module model/InstructionDetails
 * @version latest
 */
class InstructionDetails {
    /**
     * Constructs a new <code>InstructionDetails</code>.
     * @alias module:model/InstructionDetails
     * @extends module:model/Pathable
     * @implements module:model/Pathable
     */
    constructor() { 
        Pathable.initialize(this);
        InstructionDetails.initialize(this);
    }
    ...
    static initialize(obj) { 
        obj['instruction_id'] = instruction_id;
        obj['activity_id'] = activity_id;
    }

    /**
     * Constructs a <code>InstructionDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InstructionDetails} obj Optional instance to populate.
     * @return {module:model/InstructionDetails} The populated <code>InstructionDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InstructionDetails();
            ...
            if (data.hasOwnProperty('instruction_id')) {
                obj['instruction_id'] = LocatableRef.constructFromObject(data['instruction_id']);
            }
            if (data.hasOwnProperty('activity_id')) {
                obj['activity_id'] = ApiClient.convertToType(data['activity_id'], 'String');
            }
            if (data.hasOwnProperty('wf_details')) {
                obj['wf_details'] = ItemStructure.constructFromObject(data['wf_details']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>InstructionDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InstructionDetails</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of InstructionDetails.RequiredProperties) {
            if (!data[property]) {
        ...
        // validate the optional field `instruction_id`
        if (data['instruction_id']) { // data not null
          LocatableRef.validateJSON(data['instruction_id']);
        }
        // ensure the json data is a string
        ...
        // validate the optional field `wf_details`
        if (data['wf_details']) { // data not null
          ItemStructure.validateJSON(data['wf_details']);
        }
...
InstructionDetails.RequiredProperties = ["instruction_id", "activity_id"];

/**
 * @member {String} _type
 * @default 'INSTRUCTION_DETAILS'
 */
InstructionDetails.prototype['_type'] = 'INSTRUCTION_DETAILS';

/**
 * @member {module:model/LocatableRef} instruction_id
 */
InstructionDetails.prototype['instruction_id'] = undefined;

/**
 * @member {String} activity_id
 */
InstructionDetails.prototype['activity_id'] = undefined;

/**
 * @member {module:model/ItemStructure} wf_details
 */
InstructionDetails.prototype['wf_details'] = undefined;
