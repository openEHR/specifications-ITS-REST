...
class Action {
     ...
     * @extends module:model/CareEntry
     * @implements module:model/CareEntry
     */
    constructor() { 
        CareEntry.initialize(this);
    ...
    static initialize(obj) { 
        obj['time'] = time;
        obj['ism_transition'] = ism_transition;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Action();
            CareEntry.constructFromObject(data, obj);
            CareEntry.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('ism_transition')) {
                obj['ism_transition'] = IsmTransition.constructFromObject(data['ism_transition']);
            }
            if (data.hasOwnProperty('instruction_details')) {
                obj['instruction_details'] = InstructionDetails.constructFromObject(data['instruction_details']);
            }
            if (data.hasOwnProperty('description')) {
                obj['description'] = ItemStructure.constructFromObject(data['description']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `ism_transition`
        if (data['ism_transition']) { // data not null
          IsmTransition.validateJSON(data['ism_transition']);
        }
        // validate the optional field `instruction_details`
        if (data['instruction_details']) { // data not null
          InstructionDetails.validateJSON(data['instruction_details']);
        }
        // validate the optional field `description`
        if (data['description']) { // data not null
          ItemStructure.validateJSON(data['description']);
        }
...
Action.RequiredProperties = ["time", "ism_transition", "description"];

/**
 * @member {String} _type
 * @default 'ACTION'
 */
Action.prototype['_type'] = 'ACTION';

/**
 * @member {module:model/DvDateTime} time
 */
Action.prototype['time'] = undefined;

/**
 * @member {module:model/IsmTransition} ism_transition
 */
Action.prototype['ism_transition'] = undefined;

/**
 * @member {module:model/InstructionDetails} instruction_details
 */
Action.prototype['instruction_details'] = undefined;

/**
 * @member {module:model/ItemStructure} description
 */
Action.prototype['description'] = undefined;


// Implement CareEntry interface:
/**
 * @member {String} _type
 */
CareEntry.prototype['_type'] = undefined;
