...
/**
 * The DvDuration model module.
 * @module model/DvDuration
 * @version latest
 */
class DvDuration {
    /**
     * Constructs a new <code>DvDuration</code>.
     * @alias module:model/DvDuration
     * @extends module:model/DvAmount
     * @implements module:model/DvAmount
     */
    constructor() { 
        DvAmount.initialize(this);
        DvDuration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DvDuration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DvDuration} obj Optional instance to populate.
     * @return {module:model/DvDuration} The populated <code>DvDuration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DvDuration();
    ...
    /**
     * Validates the JSON data with respect to <code>DvDuration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DvDuration</code>.
     */
 ...
 * @default 'DV_DURATION'
 */
DvDuration.prototype['_type'] = 'DV_DURATION';
