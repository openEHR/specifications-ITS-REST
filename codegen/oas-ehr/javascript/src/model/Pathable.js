...
/**
 * The Pathable model module.
 * @module model/Pathable
 * @version latest
 */
class Pathable {
    /**
     * Constructs a new <code>Pathable</code>.
     * @alias module:model/Pathable
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>Pathable</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Pathable} obj Optional instance to populate.
     * @return {module:model/Pathable} The populated <code>Pathable</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Pathable();
    ...
    /**
     * Validates the JSON data with respect to <code>Pathable</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Pathable</code>.
     */
