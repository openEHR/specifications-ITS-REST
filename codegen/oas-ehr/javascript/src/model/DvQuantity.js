...
/**
 * The DvQuantity model module.
 * @module model/DvQuantity
 * @version latest
 */
class DvQuantity {
    /**
     * Constructs a new <code>DvQuantity</code>.
     * @alias module:model/DvQuantity
     * @extends module:model/DvAmount
     * @implements module:model/DvAmount
     */
    constructor() { 
        DvAmount.initialize(this);
        DvQuantity.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DvQuantity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DvQuantity} obj Optional instance to populate.
     * @return {module:model/DvQuantity} The populated <code>DvQuantity</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DvQuantity();
            DvAmount.constructFromObject(data, obj);
            DvAmount.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('units_system')) {
                obj['units_system'] = ApiClient.convertToType(data['units_system'], 'String');
            }
            if (data.hasOwnProperty('units_display_name')) {
                obj['units_display_name'] = ApiClient.convertToType(data['units_display_name'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DvQuantity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DvQuantity</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DvQuantity.RequiredProperties) {
            if (!data[property]) {
        ...
        // ensure the json data is a string
        if (data['units_system'] && !(typeof data['units_system'] === 'string' || data['units_system'] instanceof String)) {
            throw new Error("Expected the field `units_system` to be a primitive type in the JSON string but got " + data['units_system']);
        }
        // ensure the json data is a string
        if (data['units_display_name'] && !(typeof data['units_display_name'] === 'string' || data['units_display_name'] instanceof String)) {
            throw new Error("Expected the field `units_display_name` to be a primitive type in the JSON string but got " + data['units_display_name']);
        }
...
DvQuantity.RequiredProperties = ["magnitude", "units"];

/**
 * @member {String} _type
 * @default 'DV_QUANTITY'
 */
DvQuantity.prototype['_type'] = 'DV_QUANTITY';

/**
 * @member {Number} magnitude
 */
DvQuantity.prototype['magnitude'] = undefined;

/**
 * @member {Number} precision
 */
DvQuantity.prototype['precision'] = undefined;

/**
 * @member {String} units
 */
DvQuantity.prototype['units'] = undefined;

/**
 * @member {String} units_system
 */
DvQuantity.prototype['units_system'] = undefined;

/**
 * @member {String} units_display_name
 */
DvQuantity.prototype['units_display_name'] = undefined;


// Implement DvAmount interface:
/**
 * @member {String} _type
 * @default 'DV_AMOUNT'
 */
DvAmount.prototype['_type'] = 'DV_AMOUNT';




export default DvQuantity;
