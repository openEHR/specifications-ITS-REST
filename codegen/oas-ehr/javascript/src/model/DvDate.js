...
/**
 * The DvDate model module.
 * @module model/DvDate
 * @version latest
 */
class DvDate {
    /**
     * Constructs a new <code>DvDate</code>.
     * @alias module:model/DvDate
     * @extends module:model/DvTemporal
     * @implements module:model/DvTemporal
     */
    constructor() { 
        DvTemporal.initialize(this);
        DvDate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DvDate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DvDate} obj Optional instance to populate.
     * @return {module:model/DvDate} The populated <code>DvDate</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>DvDate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DvDate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DvDate.RequiredProperties) {
            if (!data[property]) {
...
DvDate.RequiredProperties = ["value"];

/**
 * @member {String} _type
 * @default 'DV_DATE'
 */
DvDate.prototype['_type'] = 'DV_DATE';

/**
 * @member {Date} value
 */
DvDate.prototype['value'] = undefined;
