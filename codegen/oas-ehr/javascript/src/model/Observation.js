...
class Observation {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = History.constructFromObject(data['data']);
            }
            if (data.hasOwnProperty('state')) {
                obj['state'] = History.constructFromObject(data['state']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
          History.validateJSON(data['data']);
        }
        // validate the optional field `state`
        if (data['state']) { // data not null
          History.validateJSON(data['state']);
        }
...
Observation.RequiredProperties = ["data"];

/**
 * @member {String} _type
 * @default 'OBSERVATION'
 */
Observation.prototype['_type'] = 'OBSERVATION';

/**
 * @member {module:model/History} data
 */
Observation.prototype['data'] = undefined;

/**
 * @member {module:model/History} state
 */
Observation.prototype['state'] = undefined;
