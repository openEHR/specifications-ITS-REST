...
/**
 * The FeederAuditDetails model module.
 * @module model/FeederAuditDetails
 * @version latest
 */
class FeederAuditDetails {
    /**
     * Constructs a new <code>FeederAuditDetails</code>.
     * @alias module:model/FeederAuditDetails
     * @param system_id {String} 
     */
    constructor(system_id) { 
        
        FeederAuditDetails.initialize(this, system_id);
    }
     ...
     */
    static initialize(obj, system_id) { 
        obj['system_id'] = system_id;
    }

    /**
     * Constructs a <code>FeederAuditDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FeederAuditDetails} obj Optional instance to populate.
     * @return {module:model/FeederAuditDetails} The populated <code>FeederAuditDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FeederAuditDetails();

            if (data.hasOwnProperty('system_id')) {
                obj['system_id'] = ApiClient.convertToType(data['system_id'], 'String');
            }
            if (data.hasOwnProperty('location')) {
                obj['location'] = PartyIdentified.constructFromObject(data['location']);
            }
            if (data.hasOwnProperty('subject')) {
                obj['subject'] = PartyProxy.constructFromObject(data['subject']);
            }
            if (data.hasOwnProperty('provider')) {
                obj['provider'] = PartyIdentified.constructFromObject(data['provider']);
            }
            if (data.hasOwnProperty('time')) {
                obj['time'] = DvDateTime.constructFromObject(data['time']);
            }
            if (data.hasOwnProperty('version_id')) {
                obj['version_id'] = ApiClient.convertToType(data['version_id'], 'String');
            }
            if (data.hasOwnProperty('other_details')) {
                obj['other_details'] = ItemStructure.constructFromObject(data['other_details']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FeederAuditDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FeederAuditDetails</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FeederAuditDetails.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['location']) { // data not null
          PartyIdentified.validateJSON(data['location']);
        }
        ...
        if (data['provider']) { // data not null
          PartyIdentified.validateJSON(data['provider']);
        }
        // validate the optional field `time`
        if (data['time']) { // data not null
          DvDateTime.validateJSON(data['time']);
        }
        // ensure the json data is a string
        ...
        if (data['other_details']) { // data not null
          ItemStructure.validateJSON(data['other_details']);
        }
...
FeederAuditDetails.RequiredProperties = ["system_id"];

/**
 * @member {String} system_id
 */
FeederAuditDetails.prototype['system_id'] = undefined;

/**
 * @member {module:model/PartyIdentified} location
 */
FeederAuditDetails.prototype['location'] = undefined;

/**
 * @member {module:model/PartyProxy} subject
 */
FeederAuditDetails.prototype['subject'] = undefined;

/**
 * @member {module:model/PartyIdentified} provider
 */
FeederAuditDetails.prototype['provider'] = undefined;

/**
 * @member {module:model/DvDateTime} time
 */
FeederAuditDetails.prototype['time'] = undefined;

/**
 * @member {String} version_id
 */
FeederAuditDetails.prototype['version_id'] = undefined;

/**
 * @member {module:model/ItemStructure} other_details
 */
FeederAuditDetails.prototype['other_details'] = undefined;
...
export default FeederAuditDetails;
