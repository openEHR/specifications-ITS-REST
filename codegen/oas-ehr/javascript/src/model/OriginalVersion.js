...
/**
 * The OriginalVersion model module.
 * @module model/OriginalVersion
 * @version latest
 */
class OriginalVersion {
    /**
     * Constructs a new <code>OriginalVersion</code>.
     * @alias module:model/OriginalVersion
     * @extends module:model/Version
     * @implements module:model/Version
     * @param contribution {module:model/ObjectRef} 
     * @param commit_audit {module:model/AuditDetails} 
     * @param data {module:model/Versionable} 
     */
    constructor(contribution, commit_audit, data) { 
        Version.initialize(this, contribution, commit_audit, data);
        OriginalVersion.initialize(this, contribution, commit_audit, data);
    }
     ...
     */
    static initialize(obj, contribution, commit_audit, data) { 
        obj['uid'] = uid;
        obj['lifecycle_state'] = lifecycle_state;
    }

    /**
     * Constructs a <code>OriginalVersion</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OriginalVersion} obj Optional instance to populate.
     * @return {module:model/OriginalVersion} The populated <code>OriginalVersion</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OriginalVersion();
            ...
            if (data.hasOwnProperty('uid')) {
                obj['uid'] = ObjectVersionId.constructFromObject(data['uid']);
            }
            if (data.hasOwnProperty('preceding_version_uid')) {
                obj['preceding_version_uid'] = ObjectVersionId.constructFromObject(data['preceding_version_uid']);
            }
            if (data.hasOwnProperty('other_input_version_uids')) {
                obj['other_input_version_uids'] = ApiClient.convertToType(data['other_input_version_uids'], [ObjectVersionId]);
            }
            if (data.hasOwnProperty('lifecycle_state')) {
                obj['lifecycle_state'] = DvCodedText.constructFromObject(data['lifecycle_state']);
            }
            if (data.hasOwnProperty('attestations')) {
                obj['attestations'] = ApiClient.convertToType(data['attestations'], [Attestation]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>OriginalVersion</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OriginalVersion</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OriginalVersion.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['uid']) { // data not null
          ObjectVersionId.validateJSON(data['uid']);
        }
        // validate the optional field `preceding_version_uid`
        if (data['preceding_version_uid']) { // data not null
          ObjectVersionId.validateJSON(data['preceding_version_uid']);
        }
        if (data['other_input_version_uids']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['other_input_version_uids'])) {
                throw new Error("Expected the field `other_input_version_uids` to be an array in the JSON data but got " + data['other_input_version_uids']);
            }
            // validate the optional field `other_input_version_uids` (array)
            for (const item of data['other_input_version_uids']) {
                ObjectVersionId.validateJsonObject(item);
            };
        }
        // validate the optional field `lifecycle_state`
        if (data['lifecycle_state']) { // data not null
          DvCodedText.validateJSON(data['lifecycle_state']);
        }
        if (data['attestations']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['attestations'])) {
                throw new Error("Expected the field `attestations` to be an array in the JSON data but got " + data['attestations']);
            }
            // validate the optional field `attestations` (array)
            for (const item of data['attestations']) {
                Attestation.validateJsonObject(item);
            };
        }
...
OriginalVersion.RequiredProperties = ["uid", "lifecycle_state", "contribution", "commit_audit", "data"];

/**
 * @member {String} _type
 * @default 'ORIGINAL_VERSION'
 */
OriginalVersion.prototype['_type'] = 'ORIGINAL_VERSION';

/**
 * @member {module:model/ObjectVersionId} uid
 */
OriginalVersion.prototype['uid'] = undefined;

/**
 * @member {module:model/ObjectVersionId} preceding_version_uid
 */
OriginalVersion.prototype['preceding_version_uid'] = undefined;

/**
 * @member {Array.<module:model/ObjectVersionId>} other_input_version_uids
 */
OriginalVersion.prototype['other_input_version_uids'] = undefined;

/**
 * @member {module:model/DvCodedText} lifecycle_state
 */
OriginalVersion.prototype['lifecycle_state'] = undefined;

/**
 * @member {Array.<module:model/Attestation>} attestations
 */
OriginalVersion.prototype['attestations'] = undefined;
 ...
 * @member {String} _type
 */
Version.prototype['_type'] = undefined;
/**
 * @member {module:model/ObjectRef} contribution
 */
Version.prototype['contribution'] = undefined;
/**
 * @member {String} signature
 */
Version.prototype['signature'] = undefined;
/**
 * @member {module:model/AuditDetails} commit_audit
 */
Version.prototype['commit_audit'] = undefined;
/**
 * @member {module:model/Versionable} data
 */
Version.prototype['data'] = undefined;
