...
class TemplateId {
    ...
    constructor(value) { 
        ...
        TemplateId.initialize(this, value);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TemplateId</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplateId</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TemplateId.RequiredProperties) {
            if (!data[property]) {
...
TemplateId.RequiredProperties = ["value"];

/**
 * @member {String} _type
 * @default 'TEMPLATE_ID'
 */
TemplateId.prototype['_type'] = 'TEMPLATE_ID';
