...
/**
 * The Clstr model module.
 * @module model/Clstr
 * @version latest
 */
class Clstr {
    /**
     * Constructs a new <code>Clstr</code>.
     * @alias module:model/Clstr
     * @extends module:model/Item
     * @implements module:model/Item
     */
    constructor() { 
        Item.initialize(this);
        Clstr.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Clstr</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Clstr} obj Optional instance to populate.
     * @return {module:model/Clstr} The populated <code>Clstr</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Clstr</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Clstr</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Clstr.RequiredProperties) {
            if (!data[property]) {
...
Clstr.RequiredProperties = ["items"];

/**
 * @member {String} _type
 * @default 'CLUSTER'
 */
Clstr.prototype['_type'] = 'CLUSTER';

/**
 * @member {Array.<module:model/Item>} items
 */
Clstr.prototype['items'] = undefined;
