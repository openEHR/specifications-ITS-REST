...
/**
 * The DvOrdinal model module.
 * @module model/DvOrdinal
 * @version latest
 */
class DvOrdinal {
    /**
     * Constructs a new <code>DvOrdinal</code>.
     * @alias module:model/DvOrdinal
     * @extends module:model/DvOrdered
     * @implements module:model/DvOrdered
     */
    constructor() { 
        DvOrdered.initialize(this);
        DvOrdinal.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DvOrdinal</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DvOrdinal} obj Optional instance to populate.
     * @return {module:model/DvOrdinal} The populated <code>DvOrdinal</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DvOrdinal();
            ...
            if (data.hasOwnProperty('symbol')) {
                obj['symbol'] = DvCodedText.constructFromObject(data['symbol']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DvOrdinal</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DvOrdinal</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DvOrdinal.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['symbol']) { // data not null
          DvCodedText.validateJSON(data['symbol']);
        }
...
DvOrdinal.RequiredProperties = ["symbol", "value"];

/**
 * @member {String} _type
 * @default 'DV_ORDINAL'
 */
DvOrdinal.prototype['_type'] = 'DV_ORDINAL';

/**
 * @member {module:model/DvCodedText} symbol
 */
DvOrdinal.prototype['symbol'] = undefined;

/**
 * @member {Number} value
 */
DvOrdinal.prototype['value'] = undefined;
