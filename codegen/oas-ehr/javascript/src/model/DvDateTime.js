...
/**
 * The DvDateTime model module.
 * @module model/DvDateTime
 * @version latest
 */
class DvDateTime {
    /**
     * Constructs a new <code>DvDateTime</code>.
     * @alias module:model/DvDateTime
     * @extends module:model/DvTemporal
     * @implements module:model/DvTemporal
     */
    constructor() { 
        DvTemporal.initialize(this);
        DvDateTime.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DvDateTime</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DvDateTime} obj Optional instance to populate.
     * @return {module:model/DvDateTime} The populated <code>DvDateTime</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DvDateTime();
            DvTemporal.constructFromObject(data, obj);
            DvTemporal.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DvDateTime</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DvDateTime</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DvDateTime.RequiredProperties) {
            if (!data[property]) {
...
DvDateTime.RequiredProperties = ["value"];

/**
 * @member {String} _type
 * @default 'DV_DATE_TIME'
 */
DvDateTime.prototype['_type'] = 'DV_DATE_TIME';

/**
 * @member {Date} value
 */
DvDateTime.prototype['value'] = undefined;


// Implement DvTemporal interface:
/**
 * @member {String} _type
 * @default 'DV_TEMPORAL'
 */
