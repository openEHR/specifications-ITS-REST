...
/**
 * The PartyRef model module.
 * @module model/PartyRef
 * @version latest
 */
class PartyRef {
    /**
     * Constructs a new <code>PartyRef</code>.
     * Identifier for parties in a demographic or identity service.
     * @alias module:model/PartyRef
     * @param namespace {String} 
     * @param type {String} 
     * @param id {module:model/ObjectId} 
     */
    constructor(namespace, type, id) { 
        
        PartyRef.initialize(this, namespace, type, id);
    }
    ...
    /**
     * Constructs a <code>PartyRef</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PartyRef} obj Optional instance to populate.
     * @return {module:model/PartyRef} The populated <code>PartyRef</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PartyRef();
    ...
    /**
     * Validates the JSON data with respect to <code>PartyRef</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PartyRef</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PartyRef.RequiredProperties) {
            if (!data[property]) {
...
PartyRef.RequiredProperties = ["namespace", "type", "id"];

/**
 * @member {String} namespace
 */
PartyRef.prototype['namespace'] = undefined;

/**
 * @member {String} type
 */
PartyRef.prototype['type'] = undefined;

/**
 * @member {module:model/ObjectId} id
 */
PartyRef.prototype['id'] = undefined;
