...
/**
 * The ItemSingle model module.
 * @module model/ItemSingle
 * @version latest
 */
class ItemSingle {
    /**
     * Constructs a new <code>ItemSingle</code>.
     * @alias module:model/ItemSingle
     * @extends module:model/ItemStructure
     * @implements module:model/ItemStructure
     */
    constructor() { 
        ItemStructure.initialize(this);
        ItemSingle.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ItemSingle</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ItemSingle} obj Optional instance to populate.
     * @return {module:model/ItemSingle} The populated <code>ItemSingle</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ItemSingle();
            ItemStructure.constructFromObject(data, obj);
            ItemStructure.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = Element.constructFromObject(data['item']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ItemSingle</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ItemSingle</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ItemSingle.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          Element.validateJSON(data['item']);
        }
...
ItemSingle.RequiredProperties = ["item"];

/**
 * @member {String} _type
 * @default 'ITEM_SINGLE'
 */
ItemSingle.prototype['_type'] = 'ITEM_SINGLE';

/**
 * @member {module:model/Element} item
 */
ItemSingle.prototype['item'] = undefined;


// Implement ItemStructure interface:
/**
 * @member {String} _type
 */
ItemStructure.prototype['_type'] = undefined;
