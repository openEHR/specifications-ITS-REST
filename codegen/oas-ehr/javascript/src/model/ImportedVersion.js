...
/**
 * The ImportedVersion model module.
 * @module model/ImportedVersion
 * @version latest
 */
class ImportedVersion {
    /**
     * Constructs a new <code>ImportedVersion</code>.
     * @alias module:model/ImportedVersion
    ...
    constructor(contribution, commit_audit, data) { 
        ...
        ImportedVersion.initialize(this, contribution, commit_audit, data);
    }
    ...
    /**
     * Constructs a <code>ImportedVersion</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImportedVersion} obj Optional instance to populate.
     * @return {module:model/ImportedVersion} The populated <code>ImportedVersion</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImportedVersion();
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = OriginalVersion.constructFromObject(data['item']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ImportedVersion</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImportedVersion</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ImportedVersion.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          OriginalVersion.validateJSON(data['item']);
        }
...
ImportedVersion.RequiredProperties = ["item", "contribution", "commit_audit", "data"];

/**
 * @member {String} _type
 * @default 'IMPORTED_VERSION'
 */
ImportedVersion.prototype['_type'] = 'IMPORTED_VERSION';

/**
 * @member {module:model/OriginalVersion} item
 */
ImportedVersion.prototype['item'] = undefined;
...
export default ImportedVersion;
