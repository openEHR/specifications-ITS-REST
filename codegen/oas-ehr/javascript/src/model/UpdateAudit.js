...
/**
 * The UpdateAudit model module.
 * @module model/UpdateAudit
 * @version latest
 */
class UpdateAudit {
    /**
     * Constructs a new <code>UpdateAudit</code>.
     ...
     * @alias module:model/UpdateAudit
    ...
    /**
     * Constructs a <code>UpdateAudit</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateAudit} obj Optional instance to populate.
     * @return {module:model/UpdateAudit} The populated <code>UpdateAudit</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateAudit();

            if (data.hasOwnProperty('_type')) {
                obj['_type'] = ApiClient.convertToType(data['_type'], 'String');
            }
            if (data.hasOwnProperty('change_type')) {
                obj['change_type'] = TerminologyCode.constructFromObject(data['change_type']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateAudit</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateAudit</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateAudit.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['change_type']) { // data not null
          TerminologyCode.validateJSON(data['change_type']);
        }
...
UpdateAudit.RequiredProperties = ["change_type", "committer"];
