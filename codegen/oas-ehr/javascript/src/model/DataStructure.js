...
/**
 * The DataStructure model module.
 * @module model/DataStructure
 * @version latest
 */
class DataStructure {
    /**
     * Constructs a new <code>DataStructure</code>.
     * @alias module:model/DataStructure
    ...
    /**
     * Constructs a <code>DataStructure</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DataStructure} obj Optional instance to populate.
     * @return {module:model/DataStructure} The populated <code>DataStructure</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DataStructure();
    ...
    /**
     * Validates the JSON data with respect to <code>DataStructure</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DataStructure</code>.
     */
