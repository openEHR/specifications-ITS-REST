...
/**
 * The DvScale model module.
 * @module model/DvScale
 * @version latest
 */
class DvScale {
    /**
     * Constructs a new <code>DvScale</code>.
     * @alias module:model/DvScale
     * @extends module:model/DvOrdered
     * @implements module:model/DvOrdered
     */
    constructor() { 
        DvOrdered.initialize(this);
        DvScale.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DvScale</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DvScale} obj Optional instance to populate.
     * @return {module:model/DvScale} The populated <code>DvScale</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>DvScale</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DvScale</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DvScale.RequiredProperties) {
            if (!data[property]) {
...
DvScale.RequiredProperties = ["symbol", "value"];

/**
 * @member {String} _type
 * @default 'DV_SCALE'
 */
DvScale.prototype['_type'] = 'DV_SCALE';

/**
 * @member {module:model/DvCodedText} symbol
 */
DvScale.prototype['symbol'] = undefined;

/**
 * @member {Number} value
 */
DvScale.prototype['value'] = undefined;
