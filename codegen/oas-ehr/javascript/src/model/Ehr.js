...
/**
 * The Ehr model module.
 * @module model/Ehr
 * @version latest
 */
class Ehr {
    /**
     * Constructs a new <code>Ehr</code>.
     * An EHR resource
     * @alias module:model/Ehr
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>Ehr</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Ehr} obj Optional instance to populate.
     * @return {module:model/Ehr} The populated <code>Ehr</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('system_id')) {
                obj['system_id'] = HierObjectId.constructFromObject(data['system_id']);
            }
            if (data.hasOwnProperty('ehr_id')) {
                obj['ehr_id'] = HierObjectId.constructFromObject(data['ehr_id']);
            }
            if (data.hasOwnProperty('ehr_status')) {
                obj['ehr_status'] = ObjectRef.constructFromObject(data['ehr_status']);
            }
            if (data.hasOwnProperty('ehr_access')) {
                obj['ehr_access'] = ObjectRef.constructFromObject(data['ehr_access']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Ehr</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Ehr</code>.
     */
    static validateJSON(data) {
        // validate the optional field `system_id`
        if (data['system_id']) { // data not null
          HierObjectId.validateJSON(data['system_id']);
        }
        // validate the optional field `ehr_id`
        if (data['ehr_id']) { // data not null
          HierObjectId.validateJSON(data['ehr_id']);
        }
        // validate the optional field `ehr_status`
        if (data['ehr_status']) { // data not null
          ObjectRef.validateJSON(data['ehr_status']);
        }
        // validate the optional field `ehr_access`
        if (data['ehr_access']) { // data not null
          ObjectRef.validateJSON(data['ehr_access']);
        }
...
/**
 * @member {module:model/HierObjectId} system_id
 */
Ehr.prototype['system_id'] = undefined;

/**
 * @member {module:model/HierObjectId} ehr_id
 */
Ehr.prototype['ehr_id'] = undefined;

/**
 * @member {module:model/ObjectRef} ehr_status
 */
Ehr.prototype['ehr_status'] = undefined;

/**
 * @member {module:model/ObjectRef} ehr_access
 */
Ehr.prototype['ehr_access'] = undefined;

/**
 * @member {module:model/DvDateTime} time_created
 */
Ehr.prototype['time_created'] = undefined;
