...
/**
 * The ContentItem model module.
 * @module model/ContentItem
 * @version latest
 */
class ContentItem {
    /**
     * Constructs a new <code>ContentItem</code>.
     * @alias module:model/ContentItem
    ...
    /**
     * Constructs a <code>ContentItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentItem} obj Optional instance to populate.
     * @return {module:model/ContentItem} The populated <code>ContentItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentItem();
    ...
    /**
     * Validates the JSON data with respect to <code>ContentItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentItem</code>.
     */
