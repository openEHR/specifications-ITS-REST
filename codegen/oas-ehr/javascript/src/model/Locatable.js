...
/**
 * The Locatable model module.
 * @module model/Locatable
 * @version latest
 */
class Locatable {
    /**
     * Constructs a new <code>Locatable</code>.
     * @alias module:model/Locatable
     * @extends module:model/Pathable
     * @implements module:model/Pathable
     */
    constructor() { 
        Pathable.initialize(this);
        Locatable.initialize(this);
    }
    ...
    static initialize(obj) { 
        obj['name'] = name;
        obj['archetype_node_id'] = archetype_node_id;
    }

    /**
     * Constructs a <code>Locatable</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Locatable} obj Optional instance to populate.
     * @return {module:model/Locatable} The populated <code>Locatable</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Locatable();
            Pathable.constructFromObject(data, obj);
            Pathable.constructFromObject(data, obj);

            if (data.hasOwnProperty('name')) {
                obj['name'] = DvText.constructFromObject(data['name']);
            }
            if (data.hasOwnProperty('archetype_node_id')) {
                obj['archetype_node_id'] = ApiClient.convertToType(data['archetype_node_id'], 'String');
            }
            if (data.hasOwnProperty('uid')) {
                obj['uid'] = UidBasedId.constructFromObject(data['uid']);
            }
            if (data.hasOwnProperty('links')) {
                obj['links'] = ApiClient.convertToType(data['links'], [Link]);
            }
            if (data.hasOwnProperty('archetype_details')) {
                obj['archetype_details'] = Archetyped.constructFromObject(data['archetype_details']);
            }
            if (data.hasOwnProperty('feeder_audit')) {
                obj['feeder_audit'] = FeederAudit.constructFromObject(data['feeder_audit']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Locatable</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Locatable</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Locatable.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['name']) { // data not null
          DvText.validateJSON(data['name']);
        }
        // ensure the json data is a string
        if (data['archetype_node_id'] && !(typeof data['archetype_node_id'] === 'string' || data['archetype_node_id'] instanceof String)) {
            throw new Error("Expected the field `archetype_node_id` to be a primitive type in the JSON string but got " + data['archetype_node_id']);
        }
        // validate the optional field `uid`
        if (data['uid']) { // data not null
          UidBasedId.validateJSON(data['uid']);
        }
        if (data['links']) { // data not null
            ...
            for (const item of data['links']) {
                Link.validateJsonObject(item);
            };
        }
        // validate the optional field `archetype_details`
        if (data['archetype_details']) { // data not null
          Archetyped.validateJSON(data['archetype_details']);
        }
        // validate the optional field `feeder_audit`
        if (data['feeder_audit']) { // data not null
          FeederAudit.validateJSON(data['feeder_audit']);
        }
...
Locatable.RequiredProperties = ["name", "archetype_node_id"];

/**
 * @member {module:model/DvText} name
 */
Locatable.prototype['name'] = undefined;

/**
 * @member {String} archetype_node_id
 */
Locatable.prototype['archetype_node_id'] = undefined;

/**
 * @member {module:model/UidBasedId} uid
 */
Locatable.prototype['uid'] = undefined;

/**
 * @member {Array.<module:model/Link>} links
 */
Locatable.prototype['links'] = undefined;

/**
 * @member {module:model/Archetyped} archetype_details
 */
Locatable.prototype['archetype_details'] = undefined;

/**
 * @member {module:model/FeederAudit} feeder_audit
 */
Locatable.prototype['feeder_audit'] = undefined;


// Implement Pathable interface:
/**
 * @member {String} _type
 */
Pathable.prototype['_type'] = undefined;
