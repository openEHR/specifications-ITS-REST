...
/**
 * The TerminologyCode model module.
 * @module model/TerminologyCode
 * @version latest
 */
class TerminologyCode {
    /**
     * Constructs a new <code>TerminologyCode</code>.
     * @alias module:model/TerminologyCode
     * @param terminology_id {String} 
     * @param code_string {String} 
     */
    constructor(terminology_id, code_string) { 
        
        TerminologyCode.initialize(this, terminology_id, code_string);
    }
     ...
     */
    static initialize(obj, terminology_id, code_string) { 
        obj['terminology_id'] = terminology_id;
        obj['code_string'] = code_string;
    }

    /**
     * Constructs a <code>TerminologyCode</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TerminologyCode} obj Optional instance to populate.
     * @return {module:model/TerminologyCode} The populated <code>TerminologyCode</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TerminologyCode();

            if (data.hasOwnProperty('terminology_id')) {
                obj['terminology_id'] = ApiClient.convertToType(data['terminology_id'], 'String');
            }
            if (data.hasOwnProperty('terminology_version')) {
                obj['terminology_version'] = ApiClient.convertToType(data['terminology_version'], 'String');
            }
            if (data.hasOwnProperty('code_string')) {
                obj['code_string'] = ApiClient.convertToType(data['code_string'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>TerminologyCode</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TerminologyCode</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TerminologyCode.RequiredProperties) {
            if (!data[property]) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['terminology_id'] && !(typeof data['terminology_id'] === 'string' || data['terminology_id'] instanceof String)) {
            throw new Error("Expected the field `terminology_id` to be a primitive type in the JSON string but got " + data['terminology_id']);
        }
        // ensure the json data is a string
        if (data['terminology_version'] && !(typeof data['terminology_version'] === 'string' || data['terminology_version'] instanceof String)) {
            throw new Error("Expected the field `terminology_version` to be a primitive type in the JSON string but got " + data['terminology_version']);
        }
        // ensure the json data is a string
        if (data['code_string'] && !(typeof data['code_string'] === 'string' || data['code_string'] instanceof String)) {
            throw new Error("Expected the field `code_string` to be a primitive type in the JSON string but got " + data['code_string']);
        }
        // ensure the json data is a string
...
TerminologyCode.RequiredProperties = ["terminology_id", "code_string"];

/**
 * @member {String} terminology_id
 */
TerminologyCode.prototype['terminology_id'] = undefined;

/**
 * @member {String} terminology_version
 */
TerminologyCode.prototype['terminology_version'] = undefined;

/**
 * @member {String} code_string
 */
TerminologyCode.prototype['code_string'] = undefined;

/**
 * @member {String} uri
 */
TerminologyCode.prototype['uri'] = undefined;
...
export default TerminologyCode;
