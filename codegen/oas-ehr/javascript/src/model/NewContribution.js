...
/**
 * The NewContribution model module.
 * @module model/NewContribution
 * @version latest
 */
class NewContribution {
    /**
     * Constructs a new <code>NewContribution</code>.
     * A new (un-committed) CONTRIBUTION resource
     * @alias module:model/NewContribution
     * @param versions {Array.<module:model/UpdateVersion>} 
     * @param audit {module:model/UpdateAudit} 
     */
    constructor(versions, audit) { 
        
        NewContribution.initialize(this, versions, audit);
    }
     ...
     */
    static initialize(obj, versions, audit) { 
        obj['versions'] = versions;
        obj['audit'] = audit;
    }

    /**
     * Constructs a <code>NewContribution</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NewContribution} obj Optional instance to populate.
     * @return {module:model/NewContribution} The populated <code>NewContribution</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NewContribution();

            if (data.hasOwnProperty('uid')) {
                obj['uid'] = HierObjectId.constructFromObject(data['uid']);
            }
            if (data.hasOwnProperty('versions')) {
                obj['versions'] = ApiClient.convertToType(data['versions'], [UpdateVersion]);
            }
            if (data.hasOwnProperty('audit')) {
                obj['audit'] = UpdateAudit.constructFromObject(data['audit']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>NewContribution</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewContribution</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NewContribution.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['versions']) { // data not null
            ...
            for (const item of data['versions']) {
                UpdateVersion.validateJsonObject(item);
            };
        }
        // validate the optional field `audit`
        if (data['audit']) { // data not null
          UpdateAudit.validateJSON(data['audit']);
        }
...
NewContribution.RequiredProperties = ["versions", "audit"];

/**
 * @member {module:model/HierObjectId} uid
 */
NewContribution.prototype['uid'] = undefined;

/**
 * @member {Array.<module:model/UpdateVersion>} versions
 */
NewContribution.prototype['versions'] = undefined;

/**
 * @member {module:model/UpdateAudit} audit
 */
NewContribution.prototype['audit'] = undefined;
