...
class Instruction {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('narrative')) {
                obj['narrative'] = DvText.constructFromObject(data['narrative']);
            }
            if (data.hasOwnProperty('expiry_time')) {
                obj['expiry_time'] = DvDateTime.constructFromObject(data['expiry_time']);
            }
            if (data.hasOwnProperty('wf_definition')) {
                obj['wf_definition'] = DvParsable.constructFromObject(data['wf_definition']);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of Instruction.RequiredProperties) {
            if (!data[property]) {
        ...
        // validate the optional field `narrative`
        if (data['narrative']) { // data not null
          DvText.validateJSON(data['narrative']);
        }
        // validate the optional field `expiry_time`
        if (data['expiry_time']) { // data not null
          DvDateTime.validateJSON(data['expiry_time']);
        }
        // validate the optional field `wf_definition`
        if (data['wf_definition']) { // data not null
          DvParsable.validateJSON(data['wf_definition']);
        }
...
Instruction.RequiredProperties = ["narrative"];

/**
 * @member {String} _type
 * @default 'INSTRUCTION'
 */
Instruction.prototype['_type'] = 'INSTRUCTION';

/**
 * @member {module:model/DvText} narrative
 */
Instruction.prototype['narrative'] = undefined;

/**
 * @member {module:model/DvDateTime} expiry_time
 */
Instruction.prototype['expiry_time'] = undefined;

/**
 * @member {module:model/DvParsable} wf_definition
 */
Instruction.prototype['wf_definition'] = undefined;

/**
 * @member {Array.<module:model/Activity>} activities
 */
Instruction.prototype['activities'] = undefined;
