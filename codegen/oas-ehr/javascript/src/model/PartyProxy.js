...
/**
 * The PartyProxy model module.
 * @module model/PartyProxy
 * @version latest
 */
class PartyProxy {
    /**
     * Constructs a new <code>PartyProxy</code>.
     * @alias module:model/PartyProxy
     * @param _type {String} 
     */
    constructor(_type) { 
    ...
    static initialize(obj, _type) { 
        obj['_type'] = _type || 'PARTY_PROXY';
    }

    /**
     * Constructs a <code>PartyProxy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PartyProxy} obj Optional instance to populate.
     * @return {module:model/PartyProxy} The populated <code>PartyProxy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PartyProxy();

            if (data.hasOwnProperty('_type')) {
                obj['_type'] = ApiClient.convertToType(data['_type'], 'String');
            }
            if (data.hasOwnProperty('external_ref')) {
                obj['external_ref'] = PartyRef.constructFromObject(data['external_ref']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PartyProxy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PartyProxy</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PartyProxy.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['external_ref']) { // data not null
          PartyRef.validateJSON(data['external_ref']);
        }
...
PartyProxy.RequiredProperties = ["_type"];
