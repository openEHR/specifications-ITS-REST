...
/**
 * The AbstractEntry model module.
 * @module model/AbstractEntry
 * @version latest
 */
class AbstractEntry {
    /**
     * Constructs a new <code>AbstractEntry</code>.
     * @alias module:model/AbstractEntry
     * @extends module:model/ContentItem
     * @implements module:model/ContentItem
     */
    constructor() { 
        ContentItem.initialize(this);
        AbstractEntry.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AbstractEntry</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AbstractEntry} obj Optional instance to populate.
     * @return {module:model/AbstractEntry} The populated <code>AbstractEntry</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AbstractEntry();
            ContentItem.constructFromObject(data, obj);
            ContentItem.constructFromObject(data, obj);

            if (data.hasOwnProperty('language')) {
                obj['language'] = CodePhrase.constructFromObject(data['language']);
            }
            if (data.hasOwnProperty('encoding')) {
                obj['encoding'] = CodePhrase.constructFromObject(data['encoding']);
            }
            if (data.hasOwnProperty('other_participations')) {
                obj['other_participations'] = ApiClient.convertToType(data['other_participations'], [Participation]);
            }
            if (data.hasOwnProperty('workflow_id')) {
                obj['workflow_id'] = ObjectRef.constructFromObject(data['workflow_id']);
            }
            if (data.hasOwnProperty('subject')) {
                obj['subject'] = PartyProxy.constructFromObject(data['subject']);
            }
            if (data.hasOwnProperty('provider')) {
                obj['provider'] = PartyProxy.constructFromObject(data['provider']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AbstractEntry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AbstractEntry</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AbstractEntry.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['language']) { // data not null
          CodePhrase.validateJSON(data['language']);
        }
        // validate the optional field `encoding`
        if (data['encoding']) { // data not null
          CodePhrase.validateJSON(data['encoding']);
        }
        if (data['other_participations']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['other_participations'])) {
                throw new Error("Expected the field `other_participations` to be an array in the JSON data but got " + data['other_participations']);
            }
            // validate the optional field `other_participations` (array)
            for (const item of data['other_participations']) {
                Participation.validateJsonObject(item);
            };
        }
        // validate the optional field `workflow_id`
        if (data['workflow_id']) { // data not null
          ObjectRef.validateJSON(data['workflow_id']);
        }
        // validate the optional field `subject`
        if (data['subject']) { // data not null
          PartyProxy.validateJSON(data['subject']);
        }
        // validate the optional field `provider`
        if (data['provider']) { // data not null
          PartyProxy.validateJSON(data['provider']);
        }
...
AbstractEntry.RequiredProperties = ["language", "encoding", "subject"];

/**
 * @member {module:model/CodePhrase} language
 */
AbstractEntry.prototype['language'] = undefined;

/**
 * @member {module:model/CodePhrase} encoding
 */
AbstractEntry.prototype['encoding'] = undefined;

/**
 * @member {Array.<module:model/Participation>} other_participations
 */
AbstractEntry.prototype['other_participations'] = undefined;

/**
 * @member {module:model/ObjectRef} workflow_id
 */
AbstractEntry.prototype['workflow_id'] = undefined;

/**
 * @member {module:model/PartyProxy} subject
 */
AbstractEntry.prototype['subject'] = undefined;

/**
 * @member {module:model/PartyProxy} provider
 */
AbstractEntry.prototype['provider'] = undefined;
 ...
 * @member {String} _type
 */
ContentItem.prototype['_type'] = undefined;
