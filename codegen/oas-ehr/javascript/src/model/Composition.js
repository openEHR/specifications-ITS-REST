...
/**
 * The Composition model module.
 * @module model/Composition
 * @version latest
 */
class Composition {
    /**
     * Constructs a new <code>Composition</code>.
     * A COMPOSITION resource
     * @alias module:model/Composition
     * @extends module:model/Versionable
     * @implements module:model/Versionable
     */
    constructor() { 
        Versionable.initialize(this);
    ...
    /**
     * Constructs a <code>Composition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Composition} obj Optional instance to populate.
     * @return {module:model/Composition} The populated <code>Composition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Composition();
            Versionable.constructFromObject(data, obj);
            Versionable.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('territory')) {
                obj['territory'] = CodePhrase.constructFromObject(data['territory']);
            }
            if (data.hasOwnProperty('category')) {
                obj['category'] = DvCodedText.constructFromObject(data['category']);
            }
            if (data.hasOwnProperty('context')) {
                obj['context'] = EventContext.constructFromObject(data['context']);
            }
            if (data.hasOwnProperty('composer')) {
                obj['composer'] = PartyProxy.constructFromObject(data['composer']);
            }
            if (data.hasOwnProperty('content')) {
                obj['content'] = ApiClient.convertToType(data['content'], [ContentItem]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Composition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Composition</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Composition.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['territory']) { // data not null
          CodePhrase.validateJSON(data['territory']);
        }
        // validate the optional field `category`
        if (data['category']) { // data not null
          DvCodedText.validateJSON(data['category']);
        }
        // validate the optional field `context`
        if (data['context']) { // data not null
          EventContext.validateJSON(data['context']);
        }
        // validate the optional field `composer`
        if (data['composer']) { // data not null
          PartyProxy.validateJSON(data['composer']);
        }
        if (data['content']) { // data not null
            ...
            for (const item of data['content']) {
                ContentItem.validateJsonObject(item);
            };
        }
...
Composition.RequiredProperties = ["language", "territory", "category", "context", "composer", "content"];
 ...
 */
Composition.prototype['language'] = undefined;

/**
 * @member {module:model/CodePhrase} territory
 */
Composition.prototype['territory'] = undefined;

/**
 * @member {module:model/DvCodedText} category
 */
Composition.prototype['category'] = undefined;

/**
 * @member {module:model/EventContext} context
 */
Composition.prototype['context'] = undefined;

/**
 * @member {module:model/PartyProxy} composer
 */
Composition.prototype['composer'] = undefined;

/**
 * @member {Array.<module:model/ContentItem>} content
 */
Composition.prototype['content'] = undefined;
 ...
 * @member {String} _type
 */
Versionable.prototype['_type'] = undefined;
