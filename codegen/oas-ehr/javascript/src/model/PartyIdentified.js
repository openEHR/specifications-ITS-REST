...
/**
 * The PartyIdentified model module.
 * @module model/PartyIdentified
 * @version latest
 */
class PartyIdentified {
    /**
     * Constructs a new <code>PartyIdentified</code>.
     * @alias module:model/PartyIdentified
     * @extends module:model/PartyProxy
     * @implements module:model/PartyProxy
     */
    constructor() { 
        PartyProxy.initialize(this, _type);
    ...
    /**
     * Constructs a <code>PartyIdentified</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PartyIdentified} obj Optional instance to populate.
     * @return {module:model/PartyIdentified} The populated <code>PartyIdentified</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PartyIdentified();
            PartyProxy.constructFromObject(data, obj);
            PartyProxy.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('identifiers')) {
                obj['identifiers'] = ApiClient.convertToType(data['identifiers'], [DvIdentifier]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PartyIdentified</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PartyIdentified</code>.
     */
 ...
 * @member {String} name
 */
PartyIdentified.prototype['name'] = undefined;

/**
 * @member {Array.<module:model/DvIdentifier>} identifiers
 */
PartyIdentified.prototype['identifiers'] = undefined;


// Implement PartyProxy interface:
/**
 * @member {String} _type
 * @default 'PARTY_PROXY'
 */
PartyProxy.prototype['_type'] = 'PARTY_PROXY';
/**
 * @member {module:model/PartyRef} external_ref
 */
PartyProxy.prototype['external_ref'] = undefined;




export default PartyIdentified;
