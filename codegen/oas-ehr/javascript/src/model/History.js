...
class History {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('origin')) {
                obj['origin'] = DvDateTime.constructFromObject(data['origin']);
            }
            if (data.hasOwnProperty('period')) {
                obj['period'] = DvDuration.constructFromObject(data['period']);
            }
            if (data.hasOwnProperty('duration')) {
                obj['duration'] = DvDuration.constructFromObject(data['duration']);
            }
            if (data.hasOwnProperty('summary')) {
                obj['summary'] = ItemStructure.constructFromObject(data['summary']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['origin']) { // data not null
          DvDateTime.validateJSON(data['origin']);
        }
        // validate the optional field `period`
        if (data['period']) { // data not null
          DvDuration.validateJSON(data['period']);
        }
        // validate the optional field `duration`
        if (data['duration']) { // data not null
          DvDuration.validateJSON(data['duration']);
        }
        // validate the optional field `summary`
        if (data['summary']) { // data not null
          ItemStructure.validateJSON(data['summary']);
        }
...
History.RequiredProperties = ["origin"];

/**
 * @member {String} _type
 * @default 'HISTORY'
 */
History.prototype['_type'] = 'HISTORY';

/**
 * @member {module:model/DvDateTime} origin
 */
History.prototype['origin'] = undefined;

/**
 * @member {module:model/DvDuration} period
 */
History.prototype['period'] = undefined;

/**
 * @member {module:model/DvDuration} duration
 */
History.prototype['duration'] = undefined;

/**
 * @member {module:model/ItemStructure} summary
 */
History.prototype['summary'] = undefined;
