...
/**
 * The VersionedObject model module.
 * @module model/VersionedObject
 * @version latest
 */
class VersionedObject {
    /**
     * Constructs a new <code>VersionedObject</code>.
     * @alias module:model/VersionedObject
     * @param uid {module:model/HierObjectId} 
     * @param owner_id {module:model/ObjectRef} 
     * @param time_created {module:model/DvDateTime} 
     */
    constructor(uid, owner_id, time_created) { 
        
        VersionedObject.initialize(this, uid, owner_id, time_created);
    }
     ...
     */
    static initialize(obj, uid, owner_id, time_created) { 
        obj['uid'] = uid;
    ...
    /**
     * Constructs a <code>VersionedObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VersionedObject} obj Optional instance to populate.
     * @return {module:model/VersionedObject} The populated <code>VersionedObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VersionedObject();

            if (data.hasOwnProperty('_type')) {
                obj['_type'] = ApiClient.convertToType(data['_type'], 'String');
            }
            if (data.hasOwnProperty('uid')) {
                obj['uid'] = HierObjectId.constructFromObject(data['uid']);
            }
            if (data.hasOwnProperty('owner_id')) {
                obj['owner_id'] = ObjectRef.constructFromObject(data['owner_id']);
            }
            if (data.hasOwnProperty('time_created')) {
                obj['time_created'] = DvDateTime.constructFromObject(data['time_created']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>VersionedObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VersionedObject</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VersionedObject.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['uid']) { // data not null
          HierObjectId.validateJSON(data['uid']);
        }
        // validate the optional field `owner_id`
        if (data['owner_id']) { // data not null
          ObjectRef.validateJSON(data['owner_id']);
        }
        // validate the optional field `time_created`
        if (data['time_created']) { // data not null
          DvDateTime.validateJSON(data['time_created']);
        }
...
VersionedObject.RequiredProperties = ["uid", "owner_id", "time_created"];

/**
 * @member {String} _type
 */
VersionedObject.prototype['_type'] = undefined;

/**
 * @member {module:model/HierObjectId} uid
 */
VersionedObject.prototype['uid'] = undefined;

/**
 * @member {module:model/ObjectRef} owner_id
 */
VersionedObject.prototype['owner_id'] = undefined;

/**
 * @member {module:model/DvDateTime} time_created
 */
VersionedObject.prototype['time_created'] = undefined;
...
export default VersionedObject;
