...
/**
 * The DvTime model module.
 * @module model/DvTime
 * @version latest
 */
class DvTime {
    /**
     * Constructs a new <code>DvTime</code>.
     * @alias module:model/DvTime
     * @extends module:model/DvTemporal
     * @implements module:model/DvTemporal
     */
    constructor() { 
        DvTemporal.initialize(this);
        DvTime.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DvTime</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DvTime} obj Optional instance to populate.
     * @return {module:model/DvTime} The populated <code>DvTime</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>DvTime</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DvTime</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DvTime.RequiredProperties) {
            if (!data[property]) {
...
DvTime.RequiredProperties = ["value"];

/**
 * @member {String} _type
 * @default 'DV_TIME'
 */
DvTime.prototype['_type'] = 'DV_TIME';

/**
 * @member {String} value
 */
DvTime.prototype['value'] = undefined;
