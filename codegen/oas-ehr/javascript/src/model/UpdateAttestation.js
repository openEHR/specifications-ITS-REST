...
/**
 * The UpdateAttestation model module.
 * @module model/UpdateAttestation
 * @version latest
 */
class UpdateAttestation {
    /**
     * Constructs a new <code>UpdateAttestation</code>.
     * @alias module:model/UpdateAttestation
     * @extends module:model/UpdateAudit
     * @implements module:model/UpdateAudit
     * @param change_type {module:model/TerminologyCode} 
     * @param committer {module:model/PartyProxy} 
     */
    constructor(change_type, committer) { 
        UpdateAudit.initialize(this, change_type, committer);
        UpdateAttestation.initialize(this, change_type, committer);
    }
     ...
     */
    static initialize(obj, change_type, committer) { 
        obj['reason'] = reason;
        obj['is_pending'] = is_pending;
    }

    /**
     * Constructs a <code>UpdateAttestation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateAttestation} obj Optional instance to populate.
     * @return {module:model/UpdateAttestation} The populated <code>UpdateAttestation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateAttestation();
            UpdateAudit.constructFromObject(data, obj);
            UpdateAudit.constructFromObject(data, obj);

            if (data.hasOwnProperty('_type')) {
                obj['_type'] = ApiClient.convertToType(data['_type'], 'String');
            }
            if (data.hasOwnProperty('attested_view')) {
                obj['attested_view'] = DvMultimedia.constructFromObject(data['attested_view']);
            }
            if (data.hasOwnProperty('proof')) {
                obj['proof'] = ApiClient.convertToType(data['proof'], 'String');
            }
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [DvEhrUri]);
            }
            if (data.hasOwnProperty('reason')) {
                obj['reason'] = DvText.constructFromObject(data['reason']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateAttestation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateAttestation</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateAttestation.RequiredProperties) {
            if (!data[property]) {
        ...
        // validate the optional field `attested_view`
        if (data['attested_view']) { // data not null
          DvMultimedia.validateJSON(data['attested_view']);
        }
        // ensure the json data is a string
        ...
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                DvEhrUri.validateJsonObject(item);
            };
        }
        // validate the optional field `reason`
        if (data['reason']) { // data not null
          DvText.validateJSON(data['reason']);
        }
...
UpdateAttestation.RequiredProperties = ["reason", "is_pending", "change_type", "committer"];

/**
 * @member {String} _type
 * @default 'UPDATE_ATTESTATION'
 */
UpdateAttestation.prototype['_type'] = 'UPDATE_ATTESTATION';

/**
 * @member {module:model/DvMultimedia} attested_view
 */
UpdateAttestation.prototype['attested_view'] = undefined;

/**
 * @member {String} proof
 */
UpdateAttestation.prototype['proof'] = undefined;

/**
 * @member {Array.<module:model/DvEhrUri>} items
 */
UpdateAttestation.prototype['items'] = undefined;

/**
 * @member {module:model/DvText} reason
 */
UpdateAttestation.prototype['reason'] = undefined;

/**
 * @member {Boolean} is_pending
 */
UpdateAttestation.prototype['is_pending'] = undefined;


// Implement UpdateAudit interface:
/**
 * @member {String} _type
 * @default 'UPDATE_AUDIT'
 */
UpdateAudit.prototype['_type'] = 'UPDATE_AUDIT';
/**
 * @member {module:model/TerminologyCode} change_type
 */
UpdateAudit.prototype['change_type'] = undefined;
/**
 * @member {module:model/DvText} description
 */
UpdateAudit.prototype['description'] = undefined;
/**
 * @member {module:model/PartyProxy} committer
 */
UpdateAudit.prototype['committer'] = undefined;




export default UpdateAttestation;
