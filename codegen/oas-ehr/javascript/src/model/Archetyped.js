...
/**
 * The Archetyped model module.
 * @module model/Archetyped
 * @version latest
 */
class Archetyped {
    /**
     * Constructs a new <code>Archetyped</code>.
     * @alias module:model/Archetyped
     * @param archetype_id {module:model/ArchetypeId} 
     * @param rm_version {String} 
     */
    constructor(archetype_id, rm_version) { 
        
        Archetyped.initialize(this, archetype_id, rm_version);
    }
     ...
     */
    static initialize(obj, archetype_id, rm_version) { 
        obj['archetype_id'] = archetype_id;
        obj['rm_version'] = rm_version;
    }

    /**
     * Constructs a <code>Archetyped</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Archetyped} obj Optional instance to populate.
     * @return {module:model/Archetyped} The populated <code>Archetyped</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Archetyped();

            if (data.hasOwnProperty('archetype_id')) {
                obj['archetype_id'] = ArchetypeId.constructFromObject(data['archetype_id']);
            }
            if (data.hasOwnProperty('template_id')) {
                obj['template_id'] = TemplateId.constructFromObject(data['template_id']);
            }
            if (data.hasOwnProperty('rm_version')) {
                obj['rm_version'] = ApiClient.convertToType(data['rm_version'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Archetyped</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Archetyped</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Archetyped.RequiredProperties) {
            if (!data[property]) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `archetype_id`
        if (data['archetype_id']) { // data not null
          ArchetypeId.validateJSON(data['archetype_id']);
        }
        // validate the optional field `template_id`
        if (data['template_id']) { // data not null
          TemplateId.validateJSON(data['template_id']);
        }
        // ensure the json data is a string
        if (data['rm_version'] && !(typeof data['rm_version'] === 'string' || data['rm_version'] instanceof String)) {
            throw new Error("Expected the field `rm_version` to be a primitive type in the JSON string but got " + data['rm_version']);
        }
...
Archetyped.RequiredProperties = ["archetype_id", "rm_version"];

/**
 * @member {module:model/ArchetypeId} archetype_id
 */
Archetyped.prototype['archetype_id'] = undefined;

/**
 * @member {module:model/TemplateId} template_id
 */
Archetyped.prototype['template_id'] = undefined;

/**
 * @member {String} rm_version
 */
Archetyped.prototype['rm_version'] = undefined;
