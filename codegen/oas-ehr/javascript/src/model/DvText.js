...
/**
 * The DvText model module.
 * @module model/DvText
 * @version latest
 */
class DvText {
    /**
     * Constructs a new <code>DvText</code>.
     * @alias module:model/DvText
     * @extends module:model/DataValue
     * @implements module:model/DataValue
     */
    constructor() { 
        DataValue.initialize(this);
        DvText.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DvText</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DvText} obj Optional instance to populate.
     * @return {module:model/DvText} The populated <code>DvText</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('hyperlink')) {
                obj['hyperlink'] = DvUri.constructFromObject(data['hyperlink']);
            }
            if (data.hasOwnProperty('formatting')) {
                obj['formatting'] = ApiClient.convertToType(data['formatting'], 'String');
            }
            if (data.hasOwnProperty('mappings')) {
                obj['mappings'] = ApiClient.convertToType(data['mappings'], [TermMapping]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DvText</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DvText</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DvText.RequiredProperties) {
            if (!data[property]) {
        ...
        // validate the optional field `hyperlink`
        if (data['hyperlink']) { // data not null
          DvUri.validateJSON(data['hyperlink']);
        }
        // ensure the json data is a string
        if (data['formatting'] && !(typeof data['formatting'] === 'string' || data['formatting'] instanceof String)) {
            throw new Error("Expected the field `formatting` to be a primitive type in the JSON string but got " + data['formatting']);
        }
        if (data['mappings']) { // data not null
            ...
            for (const item of data['mappings']) {
                TermMapping.validateJsonObject(item);
            };
        }
...
DvText.RequiredProperties = ["value"];

/**
 * @member {String} _type
 * @default 'DV_TEXT'
 */
DvText.prototype['_type'] = 'DV_TEXT';

/**
 * @member {String} value
 */
DvText.prototype['value'] = undefined;

/**
 * @member {module:model/DvUri} hyperlink
 */
DvText.prototype['hyperlink'] = undefined;

/**
 * @member {String} formatting
 */
DvText.prototype['formatting'] = undefined;

/**
 * @member {Array.<module:model/TermMapping>} mappings
 */
DvText.prototype['mappings'] = undefined;

/**
 * @member {module:model/CodePhrase} language
 */
DvText.prototype['language'] = undefined;

/**
 * @member {module:model/CodePhrase} encoding
 */
DvText.prototype['encoding'] = undefined;
