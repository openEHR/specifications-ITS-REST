...
/**
 * The DvParsable model module.
 * @module model/DvParsable
 * @version latest
 */
class DvParsable {
    /**
     * Constructs a new <code>DvParsable</code>.
     * @alias module:model/DvParsable
     * @extends module:model/DvEncapsulated
     * @implements module:model/DvEncapsulated
     */
    constructor() { 
        DvEncapsulated.initialize(this, _type);
        DvParsable.initialize(this);
    }
    ...
    static initialize(obj) { 
        obj['value'] = value;
        obj['formalism'] = formalism;
    }

    /**
     * Constructs a <code>DvParsable</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DvParsable} obj Optional instance to populate.
     * @return {module:model/DvParsable} The populated <code>DvParsable</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DvParsable();
            ...
            if (data.hasOwnProperty('formalism')) {
                obj['formalism'] = ApiClient.convertToType(data['formalism'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DvParsable</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DvParsable</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DvParsable.RequiredProperties) {
            if (!data[property]) {
        ...
        // ensure the json data is a string
        if (data['formalism'] && !(typeof data['formalism'] === 'string' || data['formalism'] instanceof String)) {
            throw new Error("Expected the field `formalism` to be a primitive type in the JSON string but got " + data['formalism']);
        }
...
DvParsable.RequiredProperties = ["value", "formalism"];

/**
 * @member {String} _type
 * @default 'DV_PARSABLE'
 */
DvParsable.prototype['_type'] = 'DV_PARSABLE';

/**
 * @member {String} value
 */
DvParsable.prototype['value'] = undefined;

/**
 * @member {String} formalism
 */
DvParsable.prototype['formalism'] = undefined;
