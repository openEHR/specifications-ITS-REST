...
/**
 * The DvTemporal model module.
 * @module model/DvTemporal
 * @version latest
 */
class DvTemporal {
    /**
     * Constructs a new <code>DvTemporal</code>.
     * @alias module:model/DvTemporal
     * @extends module:model/DvQuantified
     * @implements module:model/DvQuantified
     */
    constructor() { 
        DvQuantified.initialize(this);
        DvTemporal.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DvTemporal</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DvTemporal} obj Optional instance to populate.
     * @return {module:model/DvTemporal} The populated <code>DvTemporal</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DvTemporal();
            ...
            if (data.hasOwnProperty('accuracy')) {
                obj['accuracy'] = DvDuration.constructFromObject(data['accuracy']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DvTemporal</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DvTemporal</code>.
     */
    static validateJSON(data) {
        ...
        if (data['accuracy']) { // data not null
          DvDuration.validateJSON(data['accuracy']);
        }
 ...
 * @default 'DV_TEMPORAL'
 */
DvTemporal.prototype['_type'] = 'DV_TEMPORAL';

/**
 * @member {module:model/DvDuration} accuracy
 */
DvTemporal.prototype['accuracy'] = undefined;
