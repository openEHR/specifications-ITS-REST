...
/**
 * The ReferenceRange model module.
 * @module model/ReferenceRange
 * @version latest
 */
class ReferenceRange {
    /**
     * Constructs a new <code>ReferenceRange</code>.
     * @alias module:model/ReferenceRange
     * @param meaning {module:model/DvText} 
     * @param range {module:model/DvInterval} 
     */
    constructor(meaning, range) { 
        
        ReferenceRange.initialize(this, meaning, range);
    }
     ...
     */
    static initialize(obj, meaning, range) { 
        obj['meaning'] = meaning;
        obj['range'] = range;
    }

    /**
     * Constructs a <code>ReferenceRange</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReferenceRange} obj Optional instance to populate.
     * @return {module:model/ReferenceRange} The populated <code>ReferenceRange</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReferenceRange();

            if (data.hasOwnProperty('meaning')) {
                obj['meaning'] = DvText.constructFromObject(data['meaning']);
            }
            if (data.hasOwnProperty('range')) {
                obj['range'] = DvInterval.constructFromObject(data['range']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ReferenceRange</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReferenceRange</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ReferenceRange.RequiredProperties) {
            if (!data[property]) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `meaning`
        if (data['meaning']) { // data not null
          DvText.validateJSON(data['meaning']);
        }
        // validate the optional field `range`
        if (data['range']) { // data not null
          DvInterval.validateJSON(data['range']);
        }
...
ReferenceRange.RequiredProperties = ["meaning", "range"];

/**
 * @member {module:model/DvText} meaning
 */
ReferenceRange.prototype['meaning'] = undefined;

/**
 * @member {module:model/DvInterval} range
 */
ReferenceRange.prototype['range'] = undefined;
