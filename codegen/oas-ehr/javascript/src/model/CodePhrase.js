...
/**
 * The CodePhrase model module.
 * @module model/CodePhrase
 * @version latest
 */
class CodePhrase {
    /**
     * Constructs a new <code>CodePhrase</code>.
     * @alias module:model/CodePhrase
     * @param terminology_id {module:model/TerminologyId} 
     * @param code_string {String} 
     */
    constructor(terminology_id, code_string) { 
        
        CodePhrase.initialize(this, terminology_id, code_string);
    }
    ...
    /**
     * Constructs a <code>CodePhrase</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CodePhrase} obj Optional instance to populate.
     * @return {module:model/CodePhrase} The populated <code>CodePhrase</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CodePhrase();

            if (data.hasOwnProperty('terminology_id')) {
                obj['terminology_id'] = TerminologyId.constructFromObject(data['terminology_id']);
            }
            if (data.hasOwnProperty('code_string')) {
                obj['code_string'] = ApiClient.convertToType(data['code_string'], 'String');
            }
            if (data.hasOwnProperty('preferred_term')) {
                obj['preferred_term'] = ApiClient.convertToType(data['preferred_term'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CodePhrase</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CodePhrase</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CodePhrase.RequiredProperties) {
            if (!data[property]) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `terminology_id`
        if (data['terminology_id']) { // data not null
          TerminologyId.validateJSON(data['terminology_id']);
        }
        ...
        // ensure the json data is a string
        if (data['preferred_term'] && !(typeof data['preferred_term'] === 'string' || data['preferred_term'] instanceof String)) {
            throw new Error("Expected the field `preferred_term` to be a primitive type in the JSON string but got " + data['preferred_term']);
        }
...
CodePhrase.RequiredProperties = ["terminology_id", "code_string"];

/**
 * @member {module:model/TerminologyId} terminology_id
 */
CodePhrase.prototype['terminology_id'] = undefined;

/**
 * @member {String} code_string
 */
CodePhrase.prototype['code_string'] = undefined;

/**
 * @member {String} preferred_term
 */
CodePhrase.prototype['preferred_term'] = undefined;
