...
/**
 * The DvIntervalOfDateTime model module.
 * @module model/DvIntervalOfDateTime
 * @version latest
 */
class DvIntervalOfDateTime {
    /**
     * Constructs a new <code>DvIntervalOfDateTime</code>.
     * @alias module:model/DvIntervalOfDateTime
     * @extends module:model/DvInterval
     * @implements module:model/DvInterval
     */
    constructor() { 
        DvInterval.initialize(this);
        DvIntervalOfDateTime.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DvIntervalOfDateTime</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DvIntervalOfDateTime} obj Optional instance to populate.
     * @return {module:model/DvIntervalOfDateTime} The populated <code>DvIntervalOfDateTime</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DvIntervalOfDateTime();
            DvInterval.constructFromObject(data, obj);
            DvInterval.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('lower')) {
                obj['lower'] = DvDateTime.constructFromObject(data['lower']);
            }
            if (data.hasOwnProperty('upper')) {
                obj['upper'] = DvDateTime.constructFromObject(data['upper']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DvIntervalOfDateTime</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DvIntervalOfDateTime</code>.
     */
    static validateJSON(data) {
        ...
        if (data['lower']) { // data not null
          DvDateTime.validateJSON(data['lower']);
        }
        // validate the optional field `upper`
        if (data['upper']) { // data not null
          DvDateTime.validateJSON(data['upper']);
        }
 ...
 * @default 'DV_INTERVAL'
 */
DvIntervalOfDateTime.prototype['_type'] = 'DV_INTERVAL';

/**
 * @member {module:model/DvDateTime} lower
 */
DvIntervalOfDateTime.prototype['lower'] = undefined;

/**
 * @member {module:model/DvDateTime} upper
 */
DvIntervalOfDateTime.prototype['upper'] = undefined;


// Implement DvInterval interface:
/**
 * @member {String} _type
 * @default 'DV_INTERVAL'
 */
...
export default DvIntervalOfDateTime;
