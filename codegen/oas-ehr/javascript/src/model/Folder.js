...
class Folder {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [ObjectRef]);
            }
            if (data.hasOwnProperty('folders')) {
                obj['folders'] = ApiClient.convertToType(data['folders'], [Folder]);
            }
            if (data.hasOwnProperty('details')) {
                obj['details'] = ItemStructure.constructFromObject(data['details']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['details']) { // data not null
          ItemStructure.validateJSON(data['details']);
        }
 ...
 * @default 'FOLDER'
 */
Folder.prototype['_type'] = 'FOLDER';

/**
 * @member {Array.<module:model/ObjectRef>} items
 */
 ...
 */
Folder.prototype['folders'] = undefined;

/**
 * @member {module:model/ItemStructure} details
 */
Folder.prototype['details'] = undefined;
