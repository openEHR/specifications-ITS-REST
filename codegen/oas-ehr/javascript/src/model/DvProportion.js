...
/**
 * The DvProportion model module.
 * @module model/DvProportion
 * @version latest
 */
class DvProportion {
    /**
     * Constructs a new <code>DvProportion</code>.
     * @alias module:model/DvProportion
     * @extends module:model/DvAmount
     * @implements module:model/DvAmount
     */
    constructor() { 
        DvAmount.initialize(this);
        DvProportion.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DvProportion</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DvProportion} obj Optional instance to populate.
     * @return {module:model/DvProportion} The populated <code>DvProportion</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DvProportion();
            ...
            if (data.hasOwnProperty('semantic_type')) {
                obj['semantic_type'] = ApiClient.convertToType(data['semantic_type'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DvProportion</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DvProportion</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DvProportion.RequiredProperties) {
            if (!data[property]) {
...
DvProportion.RequiredProperties = ["numerator", "denominator", "semantic_type"];

/**
 * @member {String} _type
 * @default 'DV_PROPORTION'
 */
DvProportion.prototype['_type'] = 'DV_PROPORTION';

/**
 * @member {Number} numerator
 */
DvProportion.prototype['numerator'] = undefined;

/**
 * @member {Number} denominator
 */
DvProportion.prototype['denominator'] = undefined;

/**
 * @member {Number} semantic_type
 */
DvProportion.prototype['semantic_type'] = undefined;

/**
 * @member {Number} precision
 */
DvProportion.prototype['precision'] = undefined;
