...
/**
 * The VersionedEhrStatus model module.
 * @module model/VersionedEhrStatus
 * @version latest
 */
class VersionedEhrStatus {
    /**
     * Constructs a new <code>VersionedEhrStatus</code>.
     * A VERSIONED_EHR_STATUS resource
     * @alias module:model/VersionedEhrStatus
    ...
    constructor(uid, owner_id, time_created) { 
        ...
        VersionedEhrStatus.initialize(this, uid, owner_id, time_created);
    }
    ...
    /**
     * Constructs a <code>VersionedEhrStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VersionedEhrStatus} obj Optional instance to populate.
     * @return {module:model/VersionedEhrStatus} The populated <code>VersionedEhrStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VersionedEhrStatus();
    ...
    /**
     * Validates the JSON data with respect to <code>VersionedEhrStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VersionedEhrStatus</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VersionedEhrStatus.RequiredProperties) {
            if (!data[property]) {
...
VersionedEhrStatus.RequiredProperties = ["uid", "owner_id", "time_created"];

/**
 * @member {String} _type
 * @default 'VERSIONED_EHR_STATUS'
 */
VersionedEhrStatus.prototype['_type'] = 'VERSIONED_EHR_STATUS';
...
export default VersionedEhrStatus;
