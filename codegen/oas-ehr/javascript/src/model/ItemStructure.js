...
/**
 * The ItemStructure model module.
 * @module model/ItemStructure
 * @version latest
 */
class ItemStructure {
    /**
     * Constructs a new <code>ItemStructure</code>.
     * @alias module:model/ItemStructure
     * @extends module:model/DataStructure
     * @implements module:model/DataStructure
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ItemStructure</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ItemStructure} obj Optional instance to populate.
     * @return {module:model/ItemStructure} The populated <code>ItemStructure</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ItemStructure();
            DataStructure.constructFromObject(data, obj);
            DataStructure.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ItemStructure</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ItemStructure</code>.
     */
