...
/**
 * The LocatableRef model module.
 * @module model/LocatableRef
 * @version latest
 */
class LocatableRef {
    /**
     * Constructs a new <code>LocatableRef</code>.
     * @alias module:model/LocatableRef
     * @param namespace {String} 
     * @param type {String} 
     * @param id {module:model/UidBasedId} 
     */
    constructor(namespace, type, id) { 
        
        LocatableRef.initialize(this, namespace, type, id);
    }
     ...
     */
    static initialize(obj, namespace, type, id) { 
    ...
    /**
     * Constructs a <code>LocatableRef</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LocatableRef} obj Optional instance to populate.
     * @return {module:model/LocatableRef} The populated <code>LocatableRef</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LocatableRef();
            ...
            if (data.hasOwnProperty('id')) {
                obj['id'] = UidBasedId.constructFromObject(data['id']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>LocatableRef</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LocatableRef</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LocatableRef.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['id']) { // data not null
          UidBasedId.validateJSON(data['id']);
        }
        // ensure the json data is a string
...
LocatableRef.RequiredProperties = ["namespace", "type", "id"];

/**
 * @member {String} namespace
 */
LocatableRef.prototype['namespace'] = undefined;

/**
 * @member {String} type
 */
LocatableRef.prototype['type'] = undefined;

/**
 * @member {module:model/UidBasedId} id
 */
LocatableRef.prototype['id'] = undefined;

/**
 * @member {String} path
 */
LocatableRef.prototype['path'] = undefined;
