...
class Event {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('state')) {
                obj['state'] = ItemStructure.constructFromObject(data['state']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['state']) { // data not null
          ItemStructure.validateJSON(data['state']);
        }
...
Event.RequiredProperties = ["time", "data"];

/**
 * @member {String} _type
 * @default 'EVENT'
 */
Event.prototype['_type'] = 'EVENT';
...
/**
 * @member {module:model/ItemStructure} state
 */
