...
/**
 * The PartySelf model module.
 * @module model/PartySelf
 * @version latest
 */
class PartySelf {
    /**
     * Constructs a new <code>PartySelf</code>.
     * @alias module:model/PartySelf
     * @extends module:model/PartyProxy
     * @implements module:model/PartyProxy
     */
    constructor() { 
        PartyProxy.initialize(this, _type);
        PartySelf.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PartySelf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PartySelf} obj Optional instance to populate.
     * @return {module:model/PartySelf} The populated <code>PartySelf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PartySelf();
    ...
    /**
     * Validates the JSON data with respect to <code>PartySelf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PartySelf</code>.
     */
 ...
 * @default 'PARTY_SELF'
 */
PartySelf.prototype['_type'] = 'PARTY_SELF';
