...
/**
 * The ItemTree model module.
 * @module model/ItemTree
 * @version latest
 */
class ItemTree {
    /**
     * Constructs a new <code>ItemTree</code>.
     * @alias module:model/ItemTree
     * @extends module:model/ItemStructure
     * @implements module:model/ItemStructure
     */
    constructor() { 
        ItemStructure.initialize(this);
        ItemTree.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ItemTree</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ItemTree} obj Optional instance to populate.
     * @return {module:model/ItemTree} The populated <code>ItemTree</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ItemTree();
    ...
    /**
     * Validates the JSON data with respect to <code>ItemTree</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ItemTree</code>.
     */
 ...
 * @default 'ITEM_TREE'
 */
ItemTree.prototype['_type'] = 'ITEM_TREE';

/**
 * @member {Array.<module:model/Item>} items
 */
ItemTree.prototype['items'] = undefined;
