...
/**
 * The VersionedComposition model module.
 * @module model/VersionedComposition
 * @version latest
 */
class VersionedComposition {
    /**
     * Constructs a new <code>VersionedComposition</code>.
     * A VERSIONED_COMPOSITION resource
     * @alias module:model/VersionedComposition
     * @extends module:model/VersionedObject
     * @implements module:model/VersionedObject
    ...
    constructor(uid, owner_id, time_created) { 
        ...
        VersionedComposition.initialize(this, uid, owner_id, time_created);
    }
    ...
    /**
     * Constructs a <code>VersionedComposition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VersionedComposition} obj Optional instance to populate.
     * @return {module:model/VersionedComposition} The populated <code>VersionedComposition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VersionedComposition();
            VersionedObject.constructFromObject(data, obj);
            VersionedObject.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>VersionedComposition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VersionedComposition</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VersionedComposition.RequiredProperties) {
            if (!data[property]) {
...
VersionedComposition.RequiredProperties = ["uid", "owner_id", "time_created"];

/**
 * @member {String} _type
 * @default 'VERSIONED_COMPOSITION'
 */
VersionedComposition.prototype['_type'] = 'VERSIONED_COMPOSITION';


// Implement VersionedObject interface:
/**
 * @member {String} _type
 */
...
export default VersionedComposition;
