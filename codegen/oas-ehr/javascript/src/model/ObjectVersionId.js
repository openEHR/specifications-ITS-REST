...
/**
 * The ObjectVersionId model module.
 * @module model/ObjectVersionId
 * @version latest
 */
class ObjectVersionId {
    /**
     * Constructs a new <code>ObjectVersionId</code>.
     * @alias module:model/ObjectVersionId
     * @extends module:model/UidBasedId
     * @implements module:model/UidBasedId
     * @param value {String} 
     */
    constructor(value) { 
        UidBasedId.initialize(this, value);
        ObjectVersionId.initialize(this, value);
    }
    ...
    /**
     * Constructs a <code>ObjectVersionId</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ObjectVersionId} obj Optional instance to populate.
     * @return {module:model/ObjectVersionId} The populated <code>ObjectVersionId</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ObjectVersionId();
            UidBasedId.constructFromObject(data, obj);
            UidBasedId.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ObjectVersionId</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ObjectVersionId</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ObjectVersionId.RequiredProperties) {
            if (!data[property]) {
...
ObjectVersionId.RequiredProperties = ["value"];

/**
 * @member {String} value
 */
ObjectVersionId.prototype['value'] = undefined;


// Implement UidBasedId interface:
/**
 * @member {String} _type
 * @default 'UID_BASED_ID'
 */
UidBasedId.prototype['_type'] = 'UID_BASED_ID';
/**
 * @member {String} value
 */
UidBasedId.prototype['value'] = undefined;




export default ObjectVersionId;
