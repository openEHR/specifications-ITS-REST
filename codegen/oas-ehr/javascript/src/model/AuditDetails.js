...
/**
 * The AuditDetails model module.
 * @module model/AuditDetails
 * @version latest
 */
class AuditDetails {
    /**
     * Constructs a new <code>AuditDetails</code>.
     * The set of attributes required to document the committal of an information item to a repository.
     * @alias module:model/AuditDetails
     * @param system_id {String} 
     * @param time_committed {module:model/DvDateTime} 
     * @param change_type {module:model/DvCodedText} 
     * @param committer {module:model/PartyProxy} 
     */
    constructor(system_id, time_committed, change_type, committer) { 
        
        AuditDetails.initialize(this, system_id, time_committed, change_type, committer);
    }
     ...
     */
    static initialize(obj, system_id, time_committed, change_type, committer) { 
        obj['system_id'] = system_id;
        obj['time_committed'] = time_committed;
        obj['change_type'] = change_type;
        obj['committer'] = committer;
    }

    /**
     * Constructs a <code>AuditDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AuditDetails} obj Optional instance to populate.
     * @return {module:model/AuditDetails} The populated <code>AuditDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AuditDetails();

            if (data.hasOwnProperty('_type')) {
                obj['_type'] = ApiClient.convertToType(data['_type'], 'String');
            }
            if (data.hasOwnProperty('system_id')) {
                obj['system_id'] = ApiClient.convertToType(data['system_id'], 'String');
            }
            if (data.hasOwnProperty('time_committed')) {
                obj['time_committed'] = DvDateTime.constructFromObject(data['time_committed']);
            }
            if (data.hasOwnProperty('change_type')) {
                obj['change_type'] = DvCodedText.constructFromObject(data['change_type']);
            }
            if (data.hasOwnProperty('description')) {
                obj['description'] = DvText.constructFromObject(data['description']);
            }
            if (data.hasOwnProperty('committer')) {
                obj['committer'] = PartyProxy.constructFromObject(data['committer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AuditDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AuditDetails</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AuditDetails.RequiredProperties) {
            if (!data[property]) {
        ...
        // ensure the json data is a string
        if (data['system_id'] && !(typeof data['system_id'] === 'string' || data['system_id'] instanceof String)) {
            throw new Error("Expected the field `system_id` to be a primitive type in the JSON string but got " + data['system_id']);
        }
        // validate the optional field `time_committed`
        if (data['time_committed']) { // data not null
          DvDateTime.validateJSON(data['time_committed']);
        }
        // validate the optional field `change_type`
        if (data['change_type']) { // data not null
          DvCodedText.validateJSON(data['change_type']);
        }
        // validate the optional field `description`
        if (data['description']) { // data not null
          DvText.validateJSON(data['description']);
        }
        // validate the optional field `committer`
        if (data['committer']) { // data not null
          PartyProxy.validateJSON(data['committer']);
        }
...
AuditDetails.RequiredProperties = ["system_id", "time_committed", "change_type", "committer"];

/**
 * @member {String} _type
 * @default 'AUDIT_DETAILS'
 */
AuditDetails.prototype['_type'] = 'AUDIT_DETAILS';

/**
 * @member {String} system_id
 */
AuditDetails.prototype['system_id'] = undefined;

/**
 * @member {module:model/DvDateTime} time_committed
 */
AuditDetails.prototype['time_committed'] = undefined;

/**
 * @member {module:model/DvCodedText} change_type
 */
AuditDetails.prototype['change_type'] = undefined;

/**
 * @member {module:model/DvText} description
 */
AuditDetails.prototype['description'] = undefined;

/**
 * @member {module:model/PartyProxy} committer
 */
AuditDetails.prototype['committer'] = undefined;
