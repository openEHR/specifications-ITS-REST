...
/**
 * The DvUri model module.
 * @module model/DvUri
 * @version latest
 */
class DvUri {
    /**
     * Constructs a new <code>DvUri</code>.
     * @alias module:model/DvUri
     * @extends module:model/DataValue
     * @implements module:model/DataValue
     */
    constructor() { 
        DataValue.initialize(this);
        DvUri.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DvUri</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DvUri} obj Optional instance to populate.
     * @return {module:model/DvUri} The populated <code>DvUri</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>DvUri</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DvUri</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DvUri.RequiredProperties) {
            if (!data[property]) {
...
DvUri.RequiredProperties = ["value"];

/**
 * @member {String} _type
 * @default 'DV_URI'
 */
DvUri.prototype['_type'] = 'DV_URI';

/**
 * @member {String} value
 */
DvUri.prototype['value'] = undefined;
