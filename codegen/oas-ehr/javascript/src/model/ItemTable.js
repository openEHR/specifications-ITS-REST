...
/**
 * The ItemTable model module.
 * @module model/ItemTable
 * @version latest
 */
class ItemTable {
    /**
     * Constructs a new <code>ItemTable</code>.
     * @alias module:model/ItemTable
     * @extends module:model/ItemStructure
     * @implements module:model/ItemStructure
     */
    constructor() { 
        ItemStructure.initialize(this);
        ItemTable.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ItemTable</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ItemTable} obj Optional instance to populate.
     * @return {module:model/ItemTable} The populated <code>ItemTable</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ItemTable();
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [Clstr]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ItemTable</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ItemTable</code>.
     */
 ...
 * @default 'ITEM_TABLE'
 */
ItemTable.prototype['_type'] = 'ITEM_TABLE';

/**
 * @member {Array.<module:model/Clstr>} items
 */
ItemTable.prototype['items'] = undefined;
