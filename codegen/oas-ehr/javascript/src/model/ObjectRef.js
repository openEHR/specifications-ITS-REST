...
/**
 * The ObjectRef model module.
 * @module model/ObjectRef
 * @version latest
 */
class ObjectRef {
    /**
     * Constructs a new <code>ObjectRef</code>.
     * @alias module:model/ObjectRef
    ...
    constructor(namespace, type, id) { 
        ...
        ObjectRef.initialize(this, namespace, type, id);
    }
    ...
    /**
     * Constructs a <code>ObjectRef</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ObjectRef} obj Optional instance to populate.
     * @return {module:model/ObjectRef} The populated <code>ObjectRef</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ObjectRef();
    ...
    /**
     * Validates the JSON data with respect to <code>ObjectRef</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ObjectRef</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ObjectRef.RequiredProperties) {
            if (!data[property]) {
...
ObjectRef.RequiredProperties = ["namespace", "type", "id"];

/**
 * @member {String} namespace
 */
ObjectRef.prototype['namespace'] = undefined;

/**
 * @member {String} type
 */
ObjectRef.prototype['type'] = undefined;

/**
 * @member {module:model/ObjectId} id
 */
ObjectRef.prototype['id'] = undefined;
