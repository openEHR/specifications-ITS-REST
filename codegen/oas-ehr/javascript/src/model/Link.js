...
class Link {
     ...
     * @param type {module:model/DvText} 
     * @param target {module:model/DvEhrUri} 
     */
    constructor(meaning, type, target) { 
        
        Link.initialize(this, meaning, type, target);
    }
     ...
     */
    static initialize(obj, meaning, type, target) { 
        obj['meaning'] = meaning;
        obj['type'] = type;
        obj['target'] = target;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('type')) {
                obj['type'] = DvText.constructFromObject(data['type']);
            }
            if (data.hasOwnProperty('target')) {
                obj['target'] = DvEhrUri.constructFromObject(data['target']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['type']) { // data not null
          DvText.validateJSON(data['type']);
        }
        // validate the optional field `target`
        if (data['target']) { // data not null
          DvEhrUri.validateJSON(data['target']);
        }
...
Link.RequiredProperties = ["meaning", "type", "target"];

/**
 * @member {module:model/DvText} meaning
 */
Link.prototype['meaning'] = undefined;

/**
 * @member {module:model/DvText} type
 */
Link.prototype['type'] = undefined;

/**
 * @member {module:model/DvEhrUri} target
 */
Link.prototype['target'] = undefined;
