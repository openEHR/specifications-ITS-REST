...
/**
 * The PartyRelated model module.
 * @module model/PartyRelated
 * @version latest
 */
class PartyRelated {
    /**
     * Constructs a new <code>PartyRelated</code>.
     * @alias module:model/PartyRelated
     * @extends module:model/PartyIdentified
     * @implements module:model/PartyIdentified
     */
    constructor() { 
        PartyIdentified.initialize(this);
        PartyRelated.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PartyRelated</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PartyRelated} obj Optional instance to populate.
     * @return {module:model/PartyRelated} The populated <code>PartyRelated</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PartyRelated();
            PartyIdentified.constructFromObject(data, obj);
            PartyIdentified.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('relationship')) {
                obj['relationship'] = DvCodedText.constructFromObject(data['relationship']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PartyRelated</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PartyRelated</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PartyRelated.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['relationship']) { // data not null
          DvCodedText.validateJSON(data['relationship']);
        }
...
PartyRelated.RequiredProperties = ["relationship"];

/**
 * @member {String} _type
 * @default 'PARTY_RELATED'
 */
PartyRelated.prototype['_type'] = 'PARTY_RELATED';

/**
 * @member {module:model/DvCodedText} relationship
 */
PartyRelated.prototype['relationship'] = undefined;


// Implement PartyIdentified interface:
/**
 * @member {String} _type
 * @default 'PARTY_IDENTIFIED'
 */
PartyIdentified.prototype['_type'] = 'PARTY_IDENTIFIED';
/**
 * @member {module:model/PartyRef} external_ref
 */
PartyIdentified.prototype['external_ref'] = undefined;




export default PartyRelated;
