  ...
  describe('EHRApi', function() {
    describe('ehrCreate', function() {
      it('should call ehrCreate successfully', function(done) {
        //uncomment below and update the code to test ehrCreate
        //instance.ehrCreate(function(error) {
    ...
    describe('ehrCreateWithId', function() {
      it('should call ehrCreateWithId successfully', function(done) {
        //uncomment below and update the code to test ehrCreateWithId
        //instance.ehrCreateWithId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('ehrGetById', function() {
      it('should call ehrGetById successfully', function(done) {
        //uncomment below and update the code to test ehrGetById
        //instance.ehrGetById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('ehrGetBySubject', function() {
      it('should call ehrGetBySubject successfully', function(done) {
        //uncomment below and update the code to test ehrGetBySubject
        //instance.ehrGetBySubject(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
