  ...
  describe('DIRECTORYApi', function() {
    describe('directoryCreate', function() {
      it('should call directoryCreate successfully', function(done) {
        //uncomment below and update the code to test directoryCreate
        //instance.directoryCreate(function(error) {
    ...
    describe('directoryDelete', function() {
      it('should call directoryDelete successfully', function(done) {
        //uncomment below and update the code to test directoryDelete
        //instance.directoryDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('directoryGetAtTime', function() {
      it('should call directoryGetAtTime successfully', function(done) {
        //uncomment below and update the code to test directoryGetAtTime
        //instance.directoryGetAtTime(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('directoryGetByVersionId', function() {
      it('should call directoryGetByVersionId successfully', function(done) {
        //uncomment below and update the code to test directoryGetByVersionId
        //instance.directoryGetByVersionId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('directoryUpdate', function() {
      it('should call directoryUpdate successfully', function(done) {
        //uncomment below and update the code to test directoryUpdate
        //instance.directoryUpdate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
