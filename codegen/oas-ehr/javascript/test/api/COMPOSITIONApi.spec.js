  ...
  describe('COMPOSITIONApi', function() {
    describe('compositionCreate', function() {
      it('should call compositionCreate successfully', function(done) {
        //uncomment below and update the code to test compositionCreate
        //instance.compositionCreate(function(error) {
    ...
    describe('compositionDelete', function() {
      it('should call compositionDelete successfully', function(done) {
        //uncomment below and update the code to test compositionDelete
        //instance.compositionDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('compositionGet', function() {
      it('should call compositionGet successfully', function(done) {
        //uncomment below and update the code to test compositionGet
        //instance.compositionGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('compositionUpdate', function() {
      it('should call compositionUpdate successfully', function(done) {
        //uncomment below and update the code to test compositionUpdate
        //instance.compositionUpdate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('versionedCompositionGet', function() {
      it('should call versionedCompositionGet successfully', function(done) {
        //uncomment below and update the code to test versionedCompositionGet
        //instance.versionedCompositionGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('versionedCompositionRevisionHistory', function() {
      it('should call versionedCompositionRevisionHistory successfully', function(done) {
        //uncomment below and update the code to test versionedCompositionRevisionHistory
        //instance.versionedCompositionRevisionHistory(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('versionedCompositionVersionGetAtTime', function() {
      it('should call versionedCompositionVersionGetAtTime successfully', function(done) {
        //uncomment below and update the code to test versionedCompositionVersionGetAtTime
        //instance.versionedCompositionVersionGetAtTime(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('versionedCompositionVersionGetById', function() {
      it('should call versionedCompositionVersionGetById successfully', function(done) {
        //uncomment below and update the code to test versionedCompositionVersionGetById
        //instance.versionedCompositionVersionGetById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
