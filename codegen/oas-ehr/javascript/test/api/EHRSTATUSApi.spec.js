  ...
  describe('EHRSTATUSApi', function() {
    describe('ehrStatusGetAtTime', function() {
      it('should call ehrStatusGetAtTime successfully', function(done) {
        //uncomment below and update the code to test ehrStatusGetAtTime
        //instance.ehrStatusGetAtTime(function(error) {
    ...
    describe('ehrStatusGetByVersionId', function() {
      it('should call ehrStatusGetByVersionId successfully', function(done) {
        //uncomment below and update the code to test ehrStatusGetByVersionId
        //instance.ehrStatusGetByVersionId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('ehrStatusUpdate', function() {
      it('should call ehrStatusUpdate successfully', function(done) {
        //uncomment below and update the code to test ehrStatusUpdate
        //instance.ehrStatusUpdate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('versionedEhrStatusGet', function() {
      it('should call versionedEhrStatusGet successfully', function(done) {
        //uncomment below and update the code to test versionedEhrStatusGet
        //instance.versionedEhrStatusGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('versionedEhrStatusRevisionHistory', function() {
      it('should call versionedEhrStatusRevisionHistory successfully', function(done) {
        //uncomment below and update the code to test versionedEhrStatusRevisionHistory
        //instance.versionedEhrStatusRevisionHistory(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('versionedEhrStatusVersionGetAtTime', function() {
      it('should call versionedEhrStatusVersionGetAtTime successfully', function(done) {
        //uncomment below and update the code to test versionedEhrStatusVersionGetAtTime
        //instance.versionedEhrStatusVersionGetAtTime(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('versionedEhrStatusVersionGetById', function() {
      it('should call versionedEhrStatusVersionGetById successfully', function(done) {
        //uncomment below and update the code to test versionedEhrStatusVersionGetById
        //instance.versionedEhrStatusVersionGetById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
