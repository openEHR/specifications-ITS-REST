...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.ItemSingle();
  });
  ...
  describe('ItemSingle', function() {
    it('should create an instance of ItemSingle', function() {
      // uncomment below and update the code to test ItemSingle
      //var instance = new EhrApi.ItemSingle();
      //expect(instance).to.be.a(EhrApi.ItemSingle);
    });
