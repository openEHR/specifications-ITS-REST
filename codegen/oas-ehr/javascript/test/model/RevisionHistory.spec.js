...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.RevisionHistory();
  });
  ...
  describe('RevisionHistory', function() {
    it('should create an instance of RevisionHistory', function() {
      // uncomment below and update the code to test RevisionHistory
      //var instance = new EhrApi.RevisionHistory();
      //expect(instance).to.be.a(EhrApi.RevisionHistory);
    });
