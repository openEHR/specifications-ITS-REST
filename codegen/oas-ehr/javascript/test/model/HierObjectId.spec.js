...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.HierObjectId();
  });
  ...
  describe('HierObjectId', function() {
    it('should create an instance of HierObjectId', function() {
      // uncomment below and update the code to test HierObjectId
      //var instance = new EhrApi.HierObjectId();
      //expect(instance).to.be.a(EhrApi.HierObjectId);
    });
