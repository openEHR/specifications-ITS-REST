...
(function(root, factory) {
  ...
  describe('DvBoolean', function() {
    it('should create an instance of DvBoolean', function() {
      // uncomment below and update the code to test DvBoolean
      //var instance = new EhrApi.DvBoolean();
      //expect(instance).to.be.a(EhrApi.DvBoolean);
    });
