...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.TerminologyId();
  });
  ...
  describe('TerminologyId', function() {
    it('should create an instance of TerminologyId', function() {
      // uncomment below and update the code to test TerminologyId
      //var instance = new EhrApi.TerminologyId();
      //expect(instance).to.be.a(EhrApi.TerminologyId);
    });
