...
(function(root, factory) {
  ...
  describe('DvOrdered', function() {
    it('should create an instance of DvOrdered', function() {
      // uncomment below and update the code to test DvOrdered
      //var instance = new EhrApi.DvOrdered();
    ...
    it('should have the property normal_status (base name: "normal_status")', function() {
      // uncomment below and update the code to test the property normal_status
      //var instance = new EhrApi.DvOrdered();
      //expect(instance).to.be();
    });

    it('should have the property normal_range (base name: "normal_range")', function() {
      // uncomment below and update the code to test the property normal_range
      //var instance = new EhrApi.DvOrdered();
      //expect(instance).to.be();
    });

    it('should have the property other_reference_ranges (base name: "other_reference_ranges")', function() {
      // uncomment below and update the code to test the property other_reference_ranges
      //var instance = new EhrApi.DvOrdered();
      //expect(instance).to.be();
    });
