...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.LocatableRef();
  });
  ...
  describe('LocatableRef', function() {
    it('should create an instance of LocatableRef', function() {
      // uncomment below and update the code to test LocatableRef
      //var instance = new EhrApi.LocatableRef();
      //expect(instance).to.be.a(EhrApi.LocatableRef);
    });
