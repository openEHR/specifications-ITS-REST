...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.DvDuration();
  });
  ...
  describe('DvDuration', function() {
    it('should create an instance of DvDuration', function() {
      // uncomment below and update the code to test DvDuration
      //var instance = new EhrApi.DvDuration();
      //expect(instance).to.be.a(EhrApi.DvDuration);
    });
