...
(function(root, factory) {
  ...
  describe('DvDate', function() {
    it('should create an instance of DvDate', function() {
      // uncomment below and update the code to test DvDate
      //var instance = new EhrApi.DvDate();
      //expect(instance).to.be.a(EhrApi.DvDate);
    });
