...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.VersionedEhrStatus();
  });
  ...
  describe('VersionedEhrStatus', function() {
    it('should create an instance of VersionedEhrStatus', function() {
      // uncomment below and update the code to test VersionedEhrStatus
      //var instance = new EhrApi.VersionedEhrStatus();
      //expect(instance).to.be.a(EhrApi.VersionedEhrStatus);
    });
