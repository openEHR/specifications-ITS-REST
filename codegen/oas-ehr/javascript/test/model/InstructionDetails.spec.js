...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.InstructionDetails();
  });
  ...
  describe('InstructionDetails', function() {
    it('should create an instance of InstructionDetails', function() {
      // uncomment below and update the code to test InstructionDetails
      //var instance = new EhrApi.InstructionDetails();
      //expect(instance).to.be.a(EhrApi.InstructionDetails);
    });
    ...
    it('should have the property instruction_id (base name: "instruction_id")', function() {
      // uncomment below and update the code to test the property instruction_id
      //var instance = new EhrApi.InstructionDetails();
      //expect(instance).to.be();
    });
    ...
    it('should have the property wf_details (base name: "wf_details")', function() {
      // uncomment below and update the code to test the property wf_details
      //var instance = new EhrApi.InstructionDetails();
      //expect(instance).to.be();
    });
