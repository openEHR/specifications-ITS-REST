...
(function(root, factory) {
  ...
  describe('TerminologyCode', function() {
    it('should create an instance of TerminologyCode', function() {
      // uncomment below and update the code to test TerminologyCode
      //var instance = new EhrApi.TerminologyCode();
      //expect(instance).to.be.a(EhrApi.TerminologyCode);
    });

    it('should have the property terminology_id (base name: "terminology_id")', function() {
      // uncomment below and update the code to test the property terminology_id
      //var instance = new EhrApi.TerminologyCode();
      //expect(instance).to.be();
    });

    it('should have the property terminology_version (base name: "terminology_version")', function() {
      // uncomment below and update the code to test the property terminology_version
      //var instance = new EhrApi.TerminologyCode();
      //expect(instance).to.be();
    });

    it('should have the property code_string (base name: "code_string")', function() {
      // uncomment below and update the code to test the property code_string
      //var instance = new EhrApi.TerminologyCode();
      //expect(instance).to.be();
    });
