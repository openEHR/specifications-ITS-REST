...
(function(root, factory) {
  ...
  describe('Ehr', function() {
    it('should create an instance of Ehr', function() {
      // uncomment below and update the code to test Ehr
      //var instance = new EhrApi.Ehr();
      //expect(instance).to.be.a(EhrApi.Ehr);
    });

    it('should have the property system_id (base name: "system_id")', function() {
      // uncomment below and update the code to test the property system_id
      //var instance = new EhrApi.Ehr();
      //expect(instance).to.be();
    });

    it('should have the property ehr_id (base name: "ehr_id")', function() {
      // uncomment below and update the code to test the property ehr_id
      //var instance = new EhrApi.Ehr();
      //expect(instance).to.be();
    });

    it('should have the property ehr_status (base name: "ehr_status")', function() {
      // uncomment below and update the code to test the property ehr_status
      //var instance = new EhrApi.Ehr();
      //expect(instance).to.be();
    });

    it('should have the property ehr_access (base name: "ehr_access")', function() {
      // uncomment below and update the code to test the property ehr_access
      //var instance = new EhrApi.Ehr();
      //expect(instance).to.be();
    });

    it('should have the property time_created (base name: "time_created")', function() {
      // uncomment below and update the code to test the property time_created
      //var instance = new EhrApi.Ehr();
      //expect(instance).to.be();
    });
