...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.ContentItem();
  });
  ...
  describe('ContentItem', function() {
    it('should create an instance of ContentItem', function() {
      // uncomment below and update the code to test ContentItem
      //var instance = new EhrApi.ContentItem();
      //expect(instance).to.be.a(EhrApi.ContentItem);
    });
