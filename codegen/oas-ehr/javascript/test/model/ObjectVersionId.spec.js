...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.ObjectVersionId();
  });
  ...
  describe('ObjectVersionId', function() {
    it('should create an instance of ObjectVersionId', function() {
      // uncomment below and update the code to test ObjectVersionId
      //var instance = new EhrApi.ObjectVersionId();
      //expect(instance).to.be.a(EhrApi.ObjectVersionId);
    });
