...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.VersionedObject();
  });
  ...
  describe('VersionedObject', function() {
    it('should create an instance of VersionedObject', function() {
      // uncomment below and update the code to test VersionedObject
      //var instance = new EhrApi.VersionedObject();
      //expect(instance).to.be.a(EhrApi.VersionedObject);
    });
    ...
    it('should have the property owner_id (base name: "owner_id")', function() {
      // uncomment below and update the code to test the property owner_id
      //var instance = new EhrApi.VersionedObject();
      //expect(instance).to.be();
    });
