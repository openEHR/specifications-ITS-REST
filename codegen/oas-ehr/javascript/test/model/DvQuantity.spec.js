...
(function(root, factory) {
  ...
  describe('DvQuantity', function() {
    it('should create an instance of DvQuantity', function() {
      // uncomment below and update the code to test DvQuantity
      //var instance = new EhrApi.DvQuantity();
    ...
    it('should have the property units_system (base name: "units_system")', function() {
      // uncomment below and update the code to test the property units_system
      //var instance = new EhrApi.DvQuantity();
      //expect(instance).to.be();
    });

    it('should have the property units_display_name (base name: "units_display_name")', function() {
      // uncomment below and update the code to test the property units_display_name
      //var instance = new EhrApi.DvQuantity();
      //expect(instance).to.be();
    });
