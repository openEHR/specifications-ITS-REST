...
(function(root, factory) {
  ...
  describe('DataValue', function() {
    it('should create an instance of DataValue', function() {
      // uncomment below and update the code to test DataValue
      //var instance = new EhrApi.DataValue();
      //expect(instance).to.be.a(EhrApi.DataValue);
    });
