...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.PartyRelated();
  });
  ...
  describe('PartyRelated', function() {
    it('should create an instance of PartyRelated', function() {
      // uncomment below and update the code to test PartyRelated
      //var instance = new EhrApi.PartyRelated();
      //expect(instance).to.be.a(EhrApi.PartyRelated);
    });
