...
(function(root, factory) {
  ...
  describe('DvEhrUri', function() {
    it('should create an instance of DvEhrUri', function() {
      // uncomment below and update the code to test DvEhrUri
      //var instance = new EhrApi.DvEhrUri();
      //expect(instance).to.be.a(EhrApi.DvEhrUri);
    });
