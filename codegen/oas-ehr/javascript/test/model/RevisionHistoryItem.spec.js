...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.RevisionHistoryItem();
  });
  ...
  describe('RevisionHistoryItem', function() {
    it('should create an instance of RevisionHistoryItem', function() {
      // uncomment below and update the code to test RevisionHistoryItem
      //var instance = new EhrApi.RevisionHistoryItem();
      //expect(instance).to.be.a(EhrApi.RevisionHistoryItem);
    });
