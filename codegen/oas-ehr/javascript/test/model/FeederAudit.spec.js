...
(function(root, factory) {
  ...
  describe('FeederAudit', function() {
    it('should create an instance of FeederAudit', function() {
      // uncomment below and update the code to test FeederAudit
      //var instance = new EhrApi.FeederAudit();
      //expect(instance).to.be.a(EhrApi.FeederAudit);
    });

    it('should have the property originating_system_item_ids (base name: "originating_system_item_ids")', function() {
      // uncomment below and update the code to test the property originating_system_item_ids
      //var instance = new EhrApi.FeederAudit();
      //expect(instance).to.be();
    });

    it('should have the property feeder_system_item_ids (base name: "feeder_system_item_ids")', function() {
      // uncomment below and update the code to test the property feeder_system_item_ids
      //var instance = new EhrApi.FeederAudit();
      //expect(instance).to.be();
    });

    it('should have the property original_content (base name: "original_content")', function() {
      // uncomment below and update the code to test the property original_content
      //var instance = new EhrApi.FeederAudit();
      //expect(instance).to.be();
    });

    it('should have the property originating_system_audit (base name: "originating_system_audit")', function() {
      // uncomment below and update the code to test the property originating_system_audit
      //var instance = new EhrApi.FeederAudit();
      //expect(instance).to.be();
    });

    it('should have the property feeder_system_audit (base name: "feeder_system_audit")', function() {
      // uncomment below and update the code to test the property feeder_system_audit
      //var instance = new EhrApi.FeederAudit();
      //expect(instance).to.be();
    });
