...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.DvQuantified();
  });
  ...
  describe('DvQuantified', function() {
    it('should create an instance of DvQuantified', function() {
      // uncomment below and update the code to test DvQuantified
      //var instance = new EhrApi.DvQuantified();
      //expect(instance).to.be.a(EhrApi.DvQuantified);
    });
    ...
    it('should have the property magnitude_status (base name: "magnitude_status")', function() {
      // uncomment below and update the code to test the property magnitude_status
      //var instance = new EhrApi.DvQuantified();
      //expect(instance).to.be();
    });
