...
(function(root, factory) {
  ...
  describe('DvMultimedia', function() {
    it('should create an instance of DvMultimedia', function() {
      // uncomment below and update the code to test DvMultimedia
      //var instance = new EhrApi.DvMultimedia();
    ...
    it('should have the property alternate_text (base name: "alternate_text")', function() {
      // uncomment below and update the code to test the property alternate_text
      //var instance = new EhrApi.DvMultimedia();
      //expect(instance).to.be();
    });
    ...
    it('should have the property compression_algorithm (base name: "compression_algorithm")', function() {
      // uncomment below and update the code to test the property compression_algorithm
      //var instance = new EhrApi.DvMultimedia();
      //expect(instance).to.be();
    });

    it('should have the property integrity_check (base name: "integrity_check")', function() {
      // uncomment below and update the code to test the property integrity_check
      //var instance = new EhrApi.DvMultimedia();
      //expect(instance).to.be();
    });

    it('should have the property integrity_check_algorithm (base name: "integrity_check_algorithm")', function() {
      // uncomment below and update the code to test the property integrity_check_algorithm
      //var instance = new EhrApi.DvMultimedia();
      //expect(instance).to.be();
    });
