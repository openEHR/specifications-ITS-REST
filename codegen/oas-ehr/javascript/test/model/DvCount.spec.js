...
(function(root, factory) {
  ...
  describe('DvCount', function() {
    it('should create an instance of DvCount', function() {
      // uncomment below and update the code to test DvCount
      //var instance = new EhrApi.DvCount();
      //expect(instance).to.be.a(EhrApi.DvCount);
    });
