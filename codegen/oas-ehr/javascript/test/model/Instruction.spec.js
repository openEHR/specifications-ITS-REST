...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.Instruction();
  });
  ...
  describe('Instruction', function() {
    it('should create an instance of Instruction', function() {
      ...
      //var instance = new EhrApi.Instruction();
      //expect(instance).to.be.a(EhrApi.Instruction);
    });
    ...
    it('should have the property expiry_time (base name: "expiry_time")', function() {
      // uncomment below and update the code to test the property expiry_time
      //var instance = new EhrApi.Instruction();
      //expect(instance).to.be();
    });

    it('should have the property wf_definition (base name: "wf_definition")', function() {
      // uncomment below and update the code to test the property wf_definition
      //var instance = new EhrApi.Instruction();
      //expect(instance).to.be();
    });
