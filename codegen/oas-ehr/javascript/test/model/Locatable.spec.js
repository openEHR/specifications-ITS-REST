...
(function(root, factory) {
  ...
  describe('Locatable', function() {
    it('should create an instance of Locatable', function() {
      // uncomment below and update the code to test Locatable
      //var instance = new EhrApi.Locatable();
    ...
    it('should have the property archetype_node_id (base name: "archetype_node_id")', function() {
      // uncomment below and update the code to test the property archetype_node_id
      //var instance = new EhrApi.Locatable();
      //expect(instance).to.be();
    });
    ...
    it('should have the property archetype_details (base name: "archetype_details")', function() {
      // uncomment below and update the code to test the property archetype_details
      //var instance = new EhrApi.Locatable();
      //expect(instance).to.be();
    });

    it('should have the property feeder_audit (base name: "feeder_audit")', function() {
      // uncomment below and update the code to test the property feeder_audit
      //var instance = new EhrApi.Locatable();
      //expect(instance).to.be();
    });
