...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.UidBasedId();
  });
  ...
  describe('UidBasedId', function() {
    it('should create an instance of UidBasedId', function() {
      // uncomment below and update the code to test UidBasedId
      //var instance = new EhrApi.UidBasedId();
      //expect(instance).to.be.a(EhrApi.UidBasedId);
    });
