...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.DvTemporal();
  });
  ...
  describe('DvTemporal', function() {
    it('should create an instance of DvTemporal', function() {
      // uncomment below and update the code to test DvTemporal
      //var instance = new EhrApi.DvTemporal();
      //expect(instance).to.be.a(EhrApi.DvTemporal);
    });
