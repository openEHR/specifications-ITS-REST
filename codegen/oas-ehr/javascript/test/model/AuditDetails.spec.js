...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.AuditDetails();
  });
  ...
  describe('AuditDetails', function() {
    it('should create an instance of AuditDetails', function() {
      // uncomment below and update the code to test AuditDetails
      //var instance = new EhrApi.AuditDetails();
      //expect(instance).to.be.a(EhrApi.AuditDetails);
    });
    ...
    it('should have the property time_committed (base name: "time_committed")', function() {
      // uncomment below and update the code to test the property time_committed
      //var instance = new EhrApi.AuditDetails();
      //expect(instance).to.be();
    });

    it('should have the property change_type (base name: "change_type")', function() {
      // uncomment below and update the code to test the property change_type
      //var instance = new EhrApi.AuditDetails();
      //expect(instance).to.be();
    });
