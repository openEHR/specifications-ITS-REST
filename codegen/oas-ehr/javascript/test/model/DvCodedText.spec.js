...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.DvCodedText();
  });
  ...
  describe('DvCodedText', function() {
    it('should create an instance of DvCodedText', function() {
      // uncomment below and update the code to test DvCodedText
      //var instance = new EhrApi.DvCodedText();
      //expect(instance).to.be.a(EhrApi.DvCodedText);
    });
    ...
    it('should have the property defining_code (base name: "defining_code")', function() {
      // uncomment below and update the code to test the property defining_code
      //var instance = new EhrApi.DvCodedText();
      //expect(instance).to.be();
    });
