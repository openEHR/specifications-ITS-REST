...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.ItemStructure();
  });
  ...
  describe('ItemStructure', function() {
    it('should create an instance of ItemStructure', function() {
      // uncomment below and update the code to test ItemStructure
      //var instance = new EhrApi.ItemStructure();
      //expect(instance).to.be.a(EhrApi.ItemStructure);
    });
