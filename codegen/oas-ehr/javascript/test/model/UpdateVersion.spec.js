...
(function(root, factory) {
  ...
  describe('UpdateVersion', function() {
    it('should create an instance of UpdateVersion', function() {
      ...
      //var instance = new EhrApi.UpdateVersion();
    ...
    it('should have the property commit_audit (base name: "commit_audit")', function() {
      // uncomment below and update the code to test the property commit_audit
      //var instance = new EhrApi.UpdateVersion();
      //expect(instance).to.be();
    });
