...
(function(root, factory) {
  ...
  describe('DvState', function() {
    it('should create an instance of DvState', function() {
      // uncomment below and update the code to test DvState
      //var instance = new EhrApi.DvState();
      //expect(instance).to.be.a(EhrApi.DvState);
    });
    ...
    it('should have the property is_terminal (base name: "is_terminal")', function() {
      // uncomment below and update the code to test the property is_terminal
      //var instance = new EhrApi.DvState();
      //expect(instance).to.be();
    });
