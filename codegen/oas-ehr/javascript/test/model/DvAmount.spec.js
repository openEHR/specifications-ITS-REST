...
(function(root, factory) {
  ...
  describe('DvAmount', function() {
    it('should create an instance of DvAmount', function() {
      // uncomment below and update the code to test DvAmount
      //var instance = new EhrApi.DvAmount();
      //expect(instance).to.be.a(EhrApi.DvAmount);
    });
    ...
    it('should have the property accuracy_is_percent (base name: "accuracy_is_percent")', function() {
      // uncomment below and update the code to test the property accuracy_is_percent
      //var instance = new EhrApi.DvAmount();
      //expect(instance).to.be();
    });
