...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.DvParsable();
  });
  ...
  describe('DvParsable', function() {
    it('should create an instance of DvParsable', function() {
      // uncomment below and update the code to test DvParsable
      //var instance = new EhrApi.DvParsable();
      //expect(instance).to.be.a(EhrApi.DvParsable);
    });
    ...
    it('should have the property formalism (base name: "formalism")', function() {
      // uncomment below and update the code to test the property formalism
      //var instance = new EhrApi.DvParsable();
      //expect(instance).to.be();
    });
