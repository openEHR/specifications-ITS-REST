...
(function(root, factory) {
  ...
  describe('Pathable', function() {
    it('should create an instance of Pathable', function() {
      // uncomment below and update the code to test Pathable
      //var instance = new EhrApi.Pathable();
      //expect(instance).to.be.a(EhrApi.Pathable);
    });
