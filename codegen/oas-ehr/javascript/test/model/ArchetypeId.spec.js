...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.ArchetypeId();
  });
  ...
  describe('ArchetypeId', function() {
    it('should create an instance of ArchetypeId', function() {
      // uncomment below and update the code to test ArchetypeId
      //var instance = new EhrApi.ArchetypeId();
      //expect(instance).to.be.a(EhrApi.ArchetypeId);
    });
