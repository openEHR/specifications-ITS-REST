...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.DvProportion();
  });
  ...
  describe('DvProportion', function() {
    it('should create an instance of DvProportion', function() {
      // uncomment below and update the code to test DvProportion
      //var instance = new EhrApi.DvProportion();
      //expect(instance).to.be.a(EhrApi.DvProportion);
    });
    ...
    it('should have the property semantic_type (base name: "semantic_type")', function() {
      // uncomment below and update the code to test the property semantic_type
      //var instance = new EhrApi.DvProportion();
      //expect(instance).to.be();
    });
