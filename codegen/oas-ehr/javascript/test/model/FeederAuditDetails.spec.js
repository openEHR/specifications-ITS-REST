...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.FeederAuditDetails();
  });
  ...
  describe('FeederAuditDetails', function() {
    it('should create an instance of FeederAuditDetails', function() {
      // uncomment below and update the code to test FeederAuditDetails
      //var instance = new EhrApi.FeederAuditDetails();
      //expect(instance).to.be.a(EhrApi.FeederAuditDetails);
    });
