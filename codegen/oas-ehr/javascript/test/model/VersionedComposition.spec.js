...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.VersionedComposition();
  });
  ...
  describe('VersionedComposition', function() {
    it('should create an instance of VersionedComposition', function() {
      // uncomment below and update the code to test VersionedComposition
      //var instance = new EhrApi.VersionedComposition();
      //expect(instance).to.be.a(EhrApi.VersionedComposition);
    });
