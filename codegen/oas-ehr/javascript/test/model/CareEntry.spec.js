...
(function(root, factory) {
  ...
  describe('CareEntry', function() {
    it('should create an instance of CareEntry', function() {
      // uncomment below and update the code to test CareEntry
      //var instance = new EhrApi.CareEntry();
    ...
    it('should have the property guideline_id (base name: "guideline_id")', function() {
      // uncomment below and update the code to test the property guideline_id
      //var instance = new EhrApi.CareEntry();
      //expect(instance).to.be();
    });
