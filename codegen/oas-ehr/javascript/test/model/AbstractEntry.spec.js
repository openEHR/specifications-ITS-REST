...
(function(root, factory) {
  ...
  describe('AbstractEntry', function() {
    it('should create an instance of AbstractEntry', function() {
      // uncomment below and update the code to test AbstractEntry
      //var instance = new EhrApi.AbstractEntry();
    ...
    it('should have the property other_participations (base name: "other_participations")', function() {
      // uncomment below and update the code to test the property other_participations
      //var instance = new EhrApi.AbstractEntry();
      //expect(instance).to.be();
    });
