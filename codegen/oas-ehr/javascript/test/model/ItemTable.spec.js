...
(function(root, factory) {
  ...
  describe('ItemTable', function() {
    it('should create an instance of ItemTable', function() {
      // uncomment below and update the code to test ItemTable
      //var instance = new EhrApi.ItemTable();
      //expect(instance).to.be.a(EhrApi.ItemTable);
    });
