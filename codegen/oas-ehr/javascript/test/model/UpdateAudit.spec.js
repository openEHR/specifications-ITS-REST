...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.UpdateAudit();
  });
  ...
  describe('UpdateAudit', function() {
    it('should create an instance of UpdateAudit', function() {
      // uncomment below and update the code to test UpdateAudit
      //var instance = new EhrApi.UpdateAudit();
      //expect(instance).to.be.a(EhrApi.UpdateAudit);
    });
