...
(function(root, factory) {
  ...
  describe('Clstr', function() {
    it('should create an instance of Clstr', function() {
      // uncomment below and update the code to test Clstr
      //var instance = new EhrApi.Clstr();
      //expect(instance).to.be.a(EhrApi.Clstr);
    });
