...
(function(root, factory) {
  ...
  describe('ObjectRef', function() {
    it('should create an instance of ObjectRef', function() {
      // uncomment below and update the code to test ObjectRef
      //var instance = new EhrApi.ObjectRef();
      //expect(instance).to.be.a(EhrApi.ObjectRef);
    });
