...
(function(root, factory) {
  ...
  describe('CodePhrase', function() {
    it('should create an instance of CodePhrase', function() {
      // uncomment below and update the code to test CodePhrase
      //var instance = new EhrApi.CodePhrase();
    ...
    it('should have the property preferred_term (base name: "preferred_term")', function() {
      // uncomment below and update the code to test the property preferred_term
      //var instance = new EhrApi.CodePhrase();
      //expect(instance).to.be();
    });
