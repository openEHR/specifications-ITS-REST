...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.DvDateTime();
  });
  ...
  describe('DvDateTime', function() {
    it('should create an instance of DvDateTime', function() {
      // uncomment below and update the code to test DvDateTime
      //var instance = new EhrApi.DvDateTime();
      //expect(instance).to.be.a(EhrApi.DvDateTime);
    });
