...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.Archetyped();
  });
  ...
  describe('Archetyped', function() {
    it('should create an instance of Archetyped', function() {
      // uncomment below and update the code to test Archetyped
      //var instance = new EhrApi.Archetyped();
      //expect(instance).to.be.a(EhrApi.Archetyped);
    });

    it('should have the property archetype_id (base name: "archetype_id")', function() {
      // uncomment below and update the code to test the property archetype_id
      //var instance = new EhrApi.Archetyped();
    ...
    it('should have the property rm_version (base name: "rm_version")', function() {
      // uncomment below and update the code to test the property rm_version
      //var instance = new EhrApi.Archetyped();
      //expect(instance).to.be();
    });
