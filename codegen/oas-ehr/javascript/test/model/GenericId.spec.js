...
(function(root, factory) {
  ...
  describe('GenericId', function() {
    it('should create an instance of GenericId', function() {
      // uncomment below and update the code to test GenericId
      //var instance = new EhrApi.GenericId();
      //expect(instance).to.be.a(EhrApi.GenericId);
    });
