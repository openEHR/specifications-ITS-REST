...
(function(root, factory) {
  ...
  describe('EventContext', function() {
    it('should create an instance of EventContext', function() {
      ...
      //var instance = new EhrApi.EventContext();
    ...
    it('should have the property other_context (base name: "other_context")', function() {
      // uncomment below and update the code to test the property other_context
      //var instance = new EhrApi.EventContext();
      //expect(instance).to.be();
    });

    it('should have the property health_care_facility (base name: "health_care_facility")', function() {
      // uncomment below and update the code to test the property health_care_facility
      //var instance = new EhrApi.EventContext();
      //expect(instance).to.be();
    });
