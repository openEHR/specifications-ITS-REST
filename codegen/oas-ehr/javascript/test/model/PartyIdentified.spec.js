...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.PartyIdentified();
  });
  ...
  describe('PartyIdentified', function() {
    it('should create an instance of PartyIdentified', function() {
      // uncomment below and update the code to test PartyIdentified
      //var instance = new EhrApi.PartyIdentified();
      //expect(instance).to.be.a(EhrApi.PartyIdentified);
    });
