...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.DvEncapsulated();
  });
  ...
  describe('DvEncapsulated', function() {
    it('should create an instance of DvEncapsulated', function() {
      // uncomment below and update the code to test DvEncapsulated
      //var instance = new EhrApi.DvEncapsulated();
      //expect(instance).to.be.a(EhrApi.DvEncapsulated);
    });
