...
(function(root, factory) {
  ...
  describe('DvInterval', function() {
    it('should create an instance of DvInterval', function() {
      // uncomment below and update the code to test DvInterval
      //var instance = new EhrApi.DvInterval();
    ...
    it('should have the property lower_unbounded (base name: "lower_unbounded")', function() {
      // uncomment below and update the code to test the property lower_unbounded
      //var instance = new EhrApi.DvInterval();
      //expect(instance).to.be();
    });

    it('should have the property upper_unbounded (base name: "upper_unbounded")', function() {
      // uncomment below and update the code to test the property upper_unbounded
      //var instance = new EhrApi.DvInterval();
      //expect(instance).to.be();
    });

    it('should have the property lower_included (base name: "lower_included")', function() {
      // uncomment below and update the code to test the property lower_included
      //var instance = new EhrApi.DvInterval();
      //expect(instance).to.be();
    });

    it('should have the property upper_included (base name: "upper_included")', function() {
      // uncomment below and update the code to test the property upper_included
      //var instance = new EhrApi.DvInterval();
      //expect(instance).to.be();
    });
