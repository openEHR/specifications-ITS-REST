...
(function(root, factory) {
  ...
  describe('PartySelf', function() {
    it('should create an instance of PartySelf', function() {
      // uncomment below and update the code to test PartySelf
      //var instance = new EhrApi.PartySelf();
      //expect(instance).to.be.a(EhrApi.PartySelf);
    });
