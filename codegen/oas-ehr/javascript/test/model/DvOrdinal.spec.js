...
(function(root, factory) {
  ...
  describe('DvOrdinal', function() {
    it('should create an instance of DvOrdinal', function() {
      // uncomment below and update the code to test DvOrdinal
      //var instance = new EhrApi.DvOrdinal();
      //expect(instance).to.be.a(EhrApi.DvOrdinal);
    });
