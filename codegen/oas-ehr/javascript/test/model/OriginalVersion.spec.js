...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.OriginalVersion();
  });
  ...
  describe('OriginalVersion', function() {
    it('should create an instance of OriginalVersion', function() {
      // uncomment below and update the code to test OriginalVersion
      //var instance = new EhrApi.OriginalVersion();
      //expect(instance).to.be.a(EhrApi.OriginalVersion);
    });

    it('should have the property _type (base name: "_type")', function() {
      // uncomment below and update the code to test the property _type
      //var instance = new EhrApi.OriginalVersion();
    ...
    it('should have the property preceding_version_uid (base name: "preceding_version_uid")', function() {
      // uncomment below and update the code to test the property preceding_version_uid
      //var instance = new EhrApi.OriginalVersion();
      //expect(instance).to.be();
    });

    it('should have the property other_input_version_uids (base name: "other_input_version_uids")', function() {
      // uncomment below and update the code to test the property other_input_version_uids
      //var instance = new EhrApi.OriginalVersion();
      //expect(instance).to.be();
    });

    it('should have the property lifecycle_state (base name: "lifecycle_state")', function() {
      // uncomment below and update the code to test the property lifecycle_state
      //var instance = new EhrApi.OriginalVersion();
      //expect(instance).to.be();
    });

    it('should have the property attestations (base name: "attestations")', function() {
      // uncomment below and update the code to test the property attestations
      //var instance = new EhrApi.OriginalVersion();
      //expect(instance).to.be();
    });
