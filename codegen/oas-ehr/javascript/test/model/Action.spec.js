...
(function(root, factory) {
  ...
  describe('Action', function() {
    it('should create an instance of Action', function() {
      ...
      //var instance = new EhrApi.Action();
    ...
    it('should have the property ism_transition (base name: "ism_transition")', function() {
      // uncomment below and update the code to test the property ism_transition
      //var instance = new EhrApi.Action();
      //expect(instance).to.be();
    });

    it('should have the property instruction_details (base name: "instruction_details")', function() {
      // uncomment below and update the code to test the property instruction_details
      //var instance = new EhrApi.Action();
      //expect(instance).to.be();
    });
