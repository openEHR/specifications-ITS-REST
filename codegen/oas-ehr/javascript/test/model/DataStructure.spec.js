...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.DataStructure();
  });
  ...
  describe('DataStructure', function() {
    it('should create an instance of DataStructure', function() {
      // uncomment below and update the code to test DataStructure
      //var instance = new EhrApi.DataStructure();
      //expect(instance).to.be.a(EhrApi.DataStructure);
    });
