...
(function(root, factory) {
  ...
  describe('ItemTree', function() {
    it('should create an instance of ItemTree', function() {
      // uncomment below and update the code to test ItemTree
      //var instance = new EhrApi.ItemTree();
      //expect(instance).to.be.a(EhrApi.ItemTree);
    });
