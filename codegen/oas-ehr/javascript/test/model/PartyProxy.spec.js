...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.PartyProxy();
  });
  ...
  describe('PartyProxy', function() {
    it('should create an instance of PartyProxy', function() {
      // uncomment below and update the code to test PartyProxy
      //var instance = new EhrApi.PartyProxy();
      //expect(instance).to.be.a(EhrApi.PartyProxy);
    });
    ...
    it('should have the property external_ref (base name: "external_ref")', function() {
