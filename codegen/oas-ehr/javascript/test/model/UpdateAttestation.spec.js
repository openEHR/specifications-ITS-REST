...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.UpdateAttestation();
  });
  ...
  describe('UpdateAttestation', function() {
    it('should create an instance of UpdateAttestation', function() {
      // uncomment below and update the code to test UpdateAttestation
      //var instance = new EhrApi.UpdateAttestation();
      //expect(instance).to.be.a(EhrApi.UpdateAttestation);
    });
    ...
    it('should have the property attested_view (base name: "attested_view")', function() {
      // uncomment below and update the code to test the property attested_view
      //var instance = new EhrApi.UpdateAttestation();
      //expect(instance).to.be();
    });
    ...
    it('should have the property is_pending (base name: "is_pending")', function() {
      // uncomment below and update the code to test the property is_pending
      //var instance = new EhrApi.UpdateAttestation();
      //expect(instance).to.be();
    });
