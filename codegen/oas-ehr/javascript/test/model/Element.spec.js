...
(function(root, factory) {
  ...
  describe('Element', function() {
    it('should create an instance of Element', function() {
      ...
      //var instance = new EhrApi.Element();
    ...
    it('should have the property null_flavour (base name: "null_flavour")', function() {
      // uncomment below and update the code to test the property null_flavour
      //var instance = new EhrApi.Element();
      //expect(instance).to.be();
    });
    ...
    it('should have the property null_reason (base name: "null_reason")', function() {
      // uncomment below and update the code to test the property null_reason
      //var instance = new EhrApi.Element();
      //expect(instance).to.be();
    });
