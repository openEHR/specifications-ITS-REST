...
(function(root, factory) {
  ...
  describe('DvUri', function() {
    it('should create an instance of DvUri', function() {
      // uncomment below and update the code to test DvUri
      //var instance = new EhrApi.DvUri();
      //expect(instance).to.be.a(EhrApi.DvUri);
    });
