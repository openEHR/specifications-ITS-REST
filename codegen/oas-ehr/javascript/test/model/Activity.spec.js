...
(function(root, factory) {
  ...
  describe('Activity', function() {
    it('should create an instance of Activity', function() {
      ...
      //var instance = new EhrApi.Activity();
      //expect(instance).to.be.a(EhrApi.Activity);
    });
    ...
    it('should have the property action_archetype_id (base name: "action_archetype_id")', function() {
      // uncomment below and update the code to test the property action_archetype_id
      //var instance = new EhrApi.Activity();
      //expect(instance).to.be();
    });
