...
(function(root, factory) {
  ...
  describe('DvTime', function() {
    it('should create an instance of DvTime', function() {
      // uncomment below and update the code to test DvTime
      //var instance = new EhrApi.DvTime();
      //expect(instance).to.be.a(EhrApi.DvTime);
    });
