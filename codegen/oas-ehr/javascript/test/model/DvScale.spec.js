...
(function(root, factory) {
  ...
  describe('DvScale', function() {
    it('should create an instance of DvScale', function() {
      // uncomment below and update the code to test DvScale
      //var instance = new EhrApi.DvScale();
      //expect(instance).to.be.a(EhrApi.DvScale);
    });
