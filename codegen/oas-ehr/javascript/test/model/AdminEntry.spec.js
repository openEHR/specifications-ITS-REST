...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.AdminEntry();
  });
  ...
  describe('AdminEntry', function() {
    it('should create an instance of AdminEntry', function() {
      // uncomment below and update the code to test AdminEntry
      //var instance = new EhrApi.AdminEntry();
      //expect(instance).to.be.a(EhrApi.AdminEntry);
    });
