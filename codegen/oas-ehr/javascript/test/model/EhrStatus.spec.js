...
(function(root, factory) {
  ...
  describe('EhrStatus', function() {
    it('should create an instance of EhrStatus', function() {
      // uncomment below and update the code to test EhrStatus
      //var instance = new EhrApi.EhrStatus();
    ...
    it('should have the property is_queryable (base name: "is_queryable")', function() {
      // uncomment below and update the code to test the property is_queryable
      //var instance = new EhrApi.EhrStatus();
      //expect(instance).to.be();
    });

    it('should have the property is_modifiable (base name: "is_modifiable")', function() {
      // uncomment below and update the code to test the property is_modifiable
      //var instance = new EhrApi.EhrStatus();
      //expect(instance).to.be();
    });

    it('should have the property other_details (base name: "other_details")', function() {
      // uncomment below and update the code to test the property other_details
      //var instance = new EhrApi.EhrStatus();
      //expect(instance).to.be();
    });
