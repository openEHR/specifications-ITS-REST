...
(function(root, factory) {
  ...
  describe('PartyRef', function() {
    it('should create an instance of PartyRef', function() {
      // uncomment below and update the code to test PartyRef
      //var instance = new EhrApi.PartyRef();
      //expect(instance).to.be.a(EhrApi.PartyRef);
    });
