...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.Versionable();
  });
  ...
  describe('Versionable', function() {
    it('should create an instance of Versionable', function() {
      // uncomment below and update the code to test Versionable
      //var instance = new EhrApi.Versionable();
      //expect(instance).to.be.a(EhrApi.Versionable);
    });
