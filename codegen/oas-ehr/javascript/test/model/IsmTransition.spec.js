...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.IsmTransition();
  });
  ...
  describe('IsmTransition', function() {
    it('should create an instance of IsmTransition', function() {
      // uncomment below and update the code to test IsmTransition
      //var instance = new EhrApi.IsmTransition();
      //expect(instance).to.be.a(EhrApi.IsmTransition);
    });
    ...
    it('should have the property current_state (base name: "current_state")', function() {
      // uncomment below and update the code to test the property current_state
      //var instance = new EhrApi.IsmTransition();
      //expect(instance).to.be();
    });
    ...
    it('should have the property careflow_step (base name: "careflow_step")', function() {
      // uncomment below and update the code to test the property careflow_step
      //var instance = new EhrApi.IsmTransition();
      //expect(instance).to.be();
    });
