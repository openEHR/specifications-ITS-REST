...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.TermMapping();
  });
  ...
  describe('TermMapping', function() {
    it('should create an instance of TermMapping', function() {
      // uncomment below and update the code to test TermMapping
      //var instance = new EhrApi.TermMapping();
      //expect(instance).to.be.a(EhrApi.TermMapping);
    });
