...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EhrApi.ImportedVersion();
  });
  ...
  describe('ImportedVersion', function() {
    it('should create an instance of ImportedVersion', function() {
      // uncomment below and update the code to test ImportedVersion
      //var instance = new EhrApi.ImportedVersion();
      //expect(instance).to.be.a(EhrApi.ImportedVersion);
    });
