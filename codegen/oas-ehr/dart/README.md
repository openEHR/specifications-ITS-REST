...
------------ | ------------- | ------------- | -------------
*COMPOSITIONApi* | [**compositionCreate**](doc//COMPOSITIONApi.md#compositioncreate) | **POST** /ehr/{ehr_id}/composition | Create COMPOSITION
*COMPOSITIONApi* | [**compositionDelete**](doc//COMPOSITIONApi.md#compositiondelete) | **DELETE** /ehr/{ehr_id}/composition/{uid_based_id} | Delete COMPOSITION
*COMPOSITIONApi* | [**compositionGet**](doc//COMPOSITIONApi.md#compositionget) | **GET** /ehr/{ehr_id}/composition/{uid_based_id} | Get COMPOSITION
*COMPOSITIONApi* | [**compositionUpdate**](doc//COMPOSITIONApi.md#compositionupdate) | **PUT** /ehr/{ehr_id}/composition/{uid_based_id} | Update COMPOSITION
*COMPOSITIONApi* | [**versionedCompositionGet**](doc//COMPOSITIONApi.md#versionedcompositionget) | **GET** /ehr/{ehr_id}/versioned_composition/{versioned_object_uid} | Get versioned COMPOSITION
*COMPOSITIONApi* | [**versionedCompositionRevisionHistory**](doc//COMPOSITIONApi.md#versionedcompositionrevisionhistory) | **GET** /ehr/{ehr_id}/versioned_composition/{versioned_object_uid}/revision_history | Get versioned COMPOSITION revision history
*COMPOSITIONApi* | [**versionedCompositionVersionGetAtTime**](doc//COMPOSITIONApi.md#versionedcompositionversiongetattime) | **GET** /ehr/{ehr_id}/versioned_composition/{versioned_object_uid}/version | Get versioned COMPOSITION version at time
*COMPOSITIONApi* | [**versionedCompositionVersionGetById**](doc//COMPOSITIONApi.md#versionedcompositionversiongetbyid) | **GET** /ehr/{ehr_id}/versioned_composition/{versioned_object_uid}/version/{version_uid} | Get versioned COMPOSITION version by id
*CONTRIBUTIONApi* | [**contributionCreate**](doc//CONTRIBUTIONApi.md#contributioncreate) | **POST** /ehr/{ehr_id}/contribution | Create CONTRIBUTION
*CONTRIBUTIONApi* | [**contributionGet**](doc//CONTRIBUTIONApi.md#contributionget) | **GET** /ehr/{ehr_id}/contribution/{contribution_uid} | Get CONTRIBUTION by id
*DIRECTORYApi* | [**directoryCreate**](doc//DIRECTORYApi.md#directorycreate) | **POST** /ehr/{ehr_id}/directory | Create directory
*DIRECTORYApi* | [**directoryDelete**](doc//DIRECTORYApi.md#directorydelete) | **DELETE** /ehr/{ehr_id}/directory | Delete directory
*DIRECTORYApi* | [**directoryGetAtTime**](doc//DIRECTORYApi.md#directorygetattime) | **GET** /ehr/{ehr_id}/directory | Get folder in directory version at time
*DIRECTORYApi* | [**directoryGetByVersionId**](doc//DIRECTORYApi.md#directorygetbyversionid) | **GET** /ehr/{ehr_id}/directory/{version_uid} | Get folder in directory version
*DIRECTORYApi* | [**directoryUpdate**](doc//DIRECTORYApi.md#directoryupdate) | **PUT** /ehr/{ehr_id}/directory | Update directory
*EHRApi* | [**ehrCreate**](doc//EHRApi.md#ehrcreate) | **POST** /ehr | Create EHR
*EHRApi* | [**ehrCreateWithId**](doc//EHRApi.md#ehrcreatewithid) | **PUT** /ehr/{ehr_id} | Create EHR with id
*EHRApi* | [**ehrGetById**](doc//EHRApi.md#ehrgetbyid) | **GET** /ehr/{ehr_id} | Get EHR by id
*EHRApi* | [**ehrGetBySubject**](doc//EHRApi.md#ehrgetbysubject) | **GET** /ehr | Get EHR by subject id
*EHRSTATUSApi* | [**ehrStatusGetAtTime**](doc//EHRSTATUSApi.md#ehrstatusgetattime) | **GET** /ehr/{ehr_id}/ehr_status | Get EHR_STATUS at time
*EHRSTATUSApi* | [**ehrStatusGetByVersionId**](doc//EHRSTATUSApi.md#ehrstatusgetbyversionid) | **GET** /ehr/{ehr_id}/ehr_status/{version_uid} | Get EHR_STATUS by version id
*EHRSTATUSApi* | [**ehrStatusUpdate**](doc//EHRSTATUSApi.md#ehrstatusupdate) | **PUT** /ehr/{ehr_id}/ehr_status | Update EHR_STATUS
*EHRSTATUSApi* | [**versionedEhrStatusGet**](doc//EHRSTATUSApi.md#versionedehrstatusget) | **GET** /ehr/{ehr_id}/versioned_ehr_status | Get versioned EHR_STATUS
*EHRSTATUSApi* | [**versionedEhrStatusRevisionHistory**](doc//EHRSTATUSApi.md#versionedehrstatusrevisionhistory) | **GET** /ehr/{ehr_id}/versioned_ehr_status/revision_history | Get versioned EHR_STATUS revision history
*EHRSTATUSApi* | [**versionedEhrStatusVersionGetAtTime**](doc//EHRSTATUSApi.md#versionedehrstatusversiongetattime) | **GET** /ehr/{ehr_id}/versioned_ehr_status/version | Get versioned EHR_STATUS version at time
*EHRSTATUSApi* | [**versionedEhrStatusVersionGetById**](doc//EHRSTATUSApi.md#versionedehrstatusversiongetbyid) | **GET** /ehr/{ehr_id}/versioned_ehr_status/version/{version_uid} | Get versioned EHR_STATUS version by id


## Documentation For Models

 - [AbstractEntry](doc//AbstractEntry.md)
 - [Action](doc//Action.md)
 - [Activity](doc//Activity.md)
 - [AdminEntry](doc//AdminEntry.md)
 - [ArchetypeId](doc//ArchetypeId.md)
 - [Archetyped](doc//Archetyped.md)
 - [Attestation](doc//Attestation.md)
 - [AuditDetails](doc//AuditDetails.md)
 - [CareEntry](doc//CareEntry.md)
 - [Clstr](doc//Clstr.md)
 - [CodePhrase](doc//CodePhrase.md)
 - [Composition](doc//Composition.md)
 - [ContentItem](doc//ContentItem.md)
 - [Contribution](doc//Contribution.md)
 - [DataStructure](doc//DataStructure.md)
 - [DataValue](doc//DataValue.md)
 - [DvAmount](doc//DvAmount.md)
 ...
 - [DvEncapsulated](doc//DvEncapsulated.md)
 - [DvIdentifier](doc//DvIdentifier.md)
 - [DvInterval](doc//DvInterval.md)
 - [DvIntervalOfDateTime](doc//DvIntervalOfDateTime.md)
 - [DvMultimedia](doc//DvMultimedia.md)
 - [DvOrdered](doc//DvOrdered.md)
 - [DvOrdinal](doc//DvOrdinal.md)
 - [DvParsable](doc//DvParsable.md)
 - [DvProportion](doc//DvProportion.md)
 ...
 - [FeederAudit](doc//FeederAudit.md)
 - [FeederAuditDetails](doc//FeederAuditDetails.md)
 - [Folder](doc//Folder.md)
 - [GenericId](doc//GenericId.md)
 - [HierObjectId](doc//HierObjectId.md)
 - [History](doc//History.md)
 - [ImportedVersion](doc//ImportedVersion.md)
 - [Instruction](doc//Instruction.md)
 - [InstructionDetails](doc//InstructionDetails.md)
 - [IsmTransition](doc//IsmTransition.md)
 - [Item](doc//Item.md)
 - [ItemList](doc//ItemList.md)
 - [ItemSingle](doc//ItemSingle.md)
 - [ItemStructure](doc//ItemStructure.md)
 - [ItemTable](doc//ItemTable.md)
 - [ItemTree](doc//ItemTree.md)
 - [Link](doc//Link.md)
 - [Locatable](doc//Locatable.md)
 - [LocatableRef](doc//LocatableRef.md)
 - [NewContribution](doc//NewContribution.md)
 - [ObjectId](doc//ObjectId.md)
 - [ObjectRef](doc//ObjectRef.md)
 - [ObjectVersionId](doc//ObjectVersionId.md)
 - [Observation](doc//Observation.md)
 - [OriginalVersion](doc//OriginalVersion.md)
 - [Participation](doc//Participation.md)
 - [PartyIdentified](doc//PartyIdentified.md)
 - [PartyProxy](doc//PartyProxy.md)
 - [PartyRef](doc//PartyRef.md)
 - [PartyRelated](doc//PartyRelated.md)
 - [PartySelf](doc//PartySelf.md)
 - [Pathable](doc//Pathable.md)
 - [ReferenceRange](doc//ReferenceRange.md)
 ...
 - [UpdateAttestation](doc//UpdateAttestation.md)
 - [UpdateAudit](doc//UpdateAudit.md)
 - [UpdateVersion](doc//UpdateVersion.md)
 - [Version](doc//Version.md)
 - [Versionable](doc//Versionable.md)
 - [VersionedComposition](doc//VersionedComposition.md)
 - [VersionedEhrStatus](doc//VersionedEhrStatus.md)
 - [VersionedObject](doc//VersionedObject.md)
