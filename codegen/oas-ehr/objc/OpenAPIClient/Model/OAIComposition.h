...
@protocol OAIComposition
@end

@interface OAIComposition : OAIVersionable


@property(nonatomic) NSString* type;

@property(nonatomic) OAICodePhrase* language;

@property(nonatomic) OAICodePhrase* territory;

@property(nonatomic) OAIDvCodedText* category;

@property(nonatomic) OAIEventContext* context;

@property(nonatomic) OAIPartyProxy* composer;

@property(nonatomic) NSArray<OAIContentItem>* content;
