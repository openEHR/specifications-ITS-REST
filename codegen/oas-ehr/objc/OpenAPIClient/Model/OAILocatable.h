...
#import "OAIArchetyped.h"
#import "OAIDvText.h"
#import "OAIFeederAudit.h"
#import "OAILink.h"
#import "OAIPathable.h"
#import "OAIUidBasedId.h"
@protocol OAIArchetyped;
@class OAIArchetyped;
@protocol OAIDvText;
@class OAIDvText;
@protocol OAIFeederAudit;
@class OAIFeederAudit;
@protocol OAILink;
@class OAILink;
@protocol OAIPathable;
@class OAIPathable;
@protocol OAIUidBasedId;
@class OAIUidBasedId;



@protocol OAILocatable
@end

@interface OAILocatable : OAIPathable


@property(nonatomic) OAIDvText* name;

@property(nonatomic) NSString* archetypeNodeId;

@property(nonatomic) OAIUidBasedId* uid;

@property(nonatomic) NSArray<OAILink>* links;

@property(nonatomic) OAIArchetyped* archetypeDetails;

@property(nonatomic) OAIFeederAudit* feederAudit;
