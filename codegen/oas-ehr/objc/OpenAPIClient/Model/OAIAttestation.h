...
@class OAIDvDateTime;
@protocol OAIDvEhrUri;
@class OAIDvEhrUri;
@protocol OAIDvMultimedia;
@class OAIDvMultimedia;
@protocol OAIDvText;
@class OAIDvText;
...
@interface OAIAttestation : OAIAuditDetails


@property(nonatomic) NSString* type;

@property(nonatomic) OAIDvMultimedia* attestedView;

@property(nonatomic) NSString* proof;

@property(nonatomic) NSArray<OAIDvEhrUri>* items;

@property(nonatomic) OAIDvText* reason;
