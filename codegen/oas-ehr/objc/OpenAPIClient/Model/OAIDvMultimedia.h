...
@class OAICodePhrase;
@protocol OAIDvEncapsulated;
@class OAIDvEncapsulated;
...
@interface OAIDvMultimedia : OAIDvEncapsulated
...
@property(nonatomic) OAIDvUri* uri;

@property(nonatomic) NSString* data;

@property(nonatomic) OAICodePhrase* mediaType;

@property(nonatomic) OAICodePhrase* compressionAlgorithm;

@property(nonatomic) NSString* integrityCheck;

@property(nonatomic) OAICodePhrase* integrityCheckAlgorithm;

@property(nonatomic) OAIDvMultimedia* thumbnail;
