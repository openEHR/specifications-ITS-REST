...
@class OAIPartyProxy;
@protocol OAITerminologyCode;
@class OAITerminologyCode;
@protocol OAIUpdateAudit;
@class OAIUpdateAudit;



@protocol OAIUpdateAttestation
@end

@interface OAIUpdateAttestation : OAIUpdateAudit
