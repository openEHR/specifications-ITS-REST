#import "OAICareEntry.h"

@implementation OAICareEntry
...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"_protocol": @"protocol", @"guidelineId": @"guideline_id" }];
}
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"_protocol", @"guidelineId"];
