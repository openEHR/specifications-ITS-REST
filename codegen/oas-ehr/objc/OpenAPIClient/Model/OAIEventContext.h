...
#import "OAIDvDateTime.h"
#import "OAIItemStructure.h"
#import "OAIParticipation.h"
#import "OAIPartyIdentified.h"
#import "OAIPathable.h"
@protocol OAIDvCodedText;
@class OAIDvCodedText;
@protocol OAIDvDateTime;
@class OAIDvDateTime;
@protocol OAIItemStructure;
@class OAIItemStructure;
@protocol OAIParticipation;
@class OAIParticipation;
@protocol OAIPartyIdentified;
@class OAIPartyIdentified;
@protocol OAIPathable;
@class OAIPathable;



@protocol OAIEventContext
@end

@interface OAIEventContext : OAIPathable


@property(nonatomic) OAIDvDateTime* startTime;

@property(nonatomic) OAIDvDateTime* endTime;

@property(nonatomic) NSString* location;

@property(nonatomic) OAIDvCodedText* setting;

@property(nonatomic) OAIItemStructure* otherContext;

@property(nonatomic) OAIPartyIdentified* healthCareFacility;

@property(nonatomic) NSArray<OAIParticipation>* participations;
