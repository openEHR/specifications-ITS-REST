...
#import "OAIAttestation.h"
#import "OAIAuditDetails.h"
#import "OAIDvCodedText.h"
#import "OAIObjectRef.h"
#import "OAIObjectVersionId.h"
#import "OAIVersion.h"
#import "OAIVersionable.h"
@protocol OAIAttestation;
@class OAIAttestation;
@protocol OAIAuditDetails;
@class OAIAuditDetails;
@protocol OAIDvCodedText;
@class OAIDvCodedText;
@protocol OAIObjectRef;
@class OAIObjectRef;
@protocol OAIObjectVersionId;
@class OAIObjectVersionId;
@protocol OAIVersion;
@class OAIVersion;
@protocol OAIVersionable;
@class OAIVersionable;



@protocol OAIOriginalVersion
@end

@interface OAIOriginalVersion : OAIVersion


@property(nonatomic) NSString* type;

@property(nonatomic) OAIObjectVersionId* uid;

@property(nonatomic) OAIObjectVersionId* precedingVersionUid;

@property(nonatomic) NSArray<OAIObjectVersionId>* otherInputVersionUids;

@property(nonatomic) OAIDvCodedText* lifecycleState;

@property(nonatomic) NSArray<OAIAttestation>* attestations;
