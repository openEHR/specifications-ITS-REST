/**
 * @fileoverview AUTOMATICALLY GENERATED service for API.Client.DIRECTORYApi.
...
goog.provide('API.Client.DIRECTORYApi');

goog.require('API.Client.Folder');
 ...
 * @struct
 */
API.Client.DIRECTORYApi = function($http, $httpParamSerializer, $injector) {
  /** @private {!string} */
  this.basePath_ = $injector.has('DIRECTORYApiBasePath') ?
                   /** @type {!string} */ ($injector.get('DIRECTORYApiBasePath')) :
                   'https://openEHRSys.example.com/v1';

  /** @private {!Object<string, string>} */
  this.defaultHeaders_ = $injector.has('DIRECTORYApiDefaultHeaders') ?
                   /** @type {!Object<string, string>} */ (
                       $injector.get('DIRECTORYApiDefaultHeaders')) :
                   {};
...
API.Client.DIRECTORYApi.$inject = ['$http', '$httpParamSerializer', '$injector'];
 ...
 * @return {!angular.$q.Promise<!API.Client.Folder>}
 */
API.Client.DIRECTORYApi.prototype.directoryCreate = function(ehrId, folder, opt_prefer, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/ehr/{ehr_id}/directory'
  ...
  if (!ehrId) {
    throw new Error('Missing required parameter ehrId when calling directoryCreate');
  }
  // verify required parameter 'folder' is set
  if (!folder) {
    throw new Error('Missing required parameter folder when calling directoryCreate');
  }
 ...
 */
API.Client.DIRECTORYApi.prototype.directoryDelete = function(ehrId, ifMatch, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/ehr/{ehr_id}/directory'
      .replace('{' + 'ehr_id' + '}', String(ehrId));
  ...
  // verify required parameter 'ehrId' is set
  if (!ehrId) {
    throw new Error('Missing required parameter ehrId when calling directoryDelete');
  }
  // verify required parameter 'ifMatch' is set
  if (!ifMatch) {
    throw new Error('Missing required parameter ifMatch when calling directoryDelete');
  }
 ...
 * @param {!string=} opt_path A path to a sub-folder; consists of slash-separated values of the name attribute of FOLDERs in the directory. 
 * @param {!angular.$http.Config=} opt_extraHttpRequestParams Extra HTTP parameters to send.
 * @return {!angular.$q.Promise<!API.Client.Folder>}
 */
API.Client.DIRECTORYApi.prototype.directoryGetAtTime = function(ehrId, opt_versionAtTime, opt_path, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/ehr/{ehr_id}/directory'
      .replace('{' + 'ehr_id' + '}', String(ehrId));
  ...
  // verify required parameter 'ehrId' is set
  if (!ehrId) {
    throw new Error('Missing required parameter ehrId when calling directoryGetAtTime');
  }
 ...
 * @return {!angular.$q.Promise<!API.Client.Folder>}
 */
API.Client.DIRECTORYApi.prototype.directoryGetByVersionId = function(ehrId, versionUid, opt_path, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/ehr/{ehr_id}/directory/{version_uid}'
      .replace('{' + 'ehr_id' + '}', String(ehrId))
  ...
  // verify required parameter 'ehrId' is set
  if (!ehrId) {
    throw new Error('Missing required parameter ehrId when calling directoryGetByVersionId');
  }
  // verify required parameter 'versionUid' is set
  if (!versionUid) {
    throw new Error('Missing required parameter versionUid when calling directoryGetByVersionId');
  }
  if (opt_path !== undefined) {
    queryParameters['path'] = opt_path;
  }
 ...
 * @return {!angular.$q.Promise<!API.Client.Folder>}
 */
API.Client.DIRECTORYApi.prototype.directoryUpdate = function(ehrId, ifMatch, folder, opt_prefer, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/ehr/{ehr_id}/directory'
      .replace('{' + 'ehr_id' + '}', String(ehrId));
  ...
  // verify required parameter 'ehrId' is set
  if (!ehrId) {
    throw new Error('Missing required parameter ehrId when calling directoryUpdate');
  }
  // verify required parameter 'ifMatch' is set
  if (!ifMatch) {
    throw new Error('Missing required parameter ifMatch when calling directoryUpdate');
  }
  // verify required parameter 'folder' is set
  if (!folder) {
    throw new Error('Missing required parameter folder when calling directoryUpdate');
  }
  headerParams['If-Match'] = ifMatch;
