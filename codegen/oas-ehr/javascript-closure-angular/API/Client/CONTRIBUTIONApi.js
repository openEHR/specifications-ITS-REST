/**
 * @fileoverview AUTOMATICALLY GENERATED service for API.Client.CONTRIBUTIONApi.
...
goog.provide('API.Client.CONTRIBUTIONApi');

goog.require('API.Client.Contribution');
goog.require('API.Client.Error');
goog.require('API.Client.NewContribution');
 ...
 * @struct
 */
API.Client.CONTRIBUTIONApi = function($http, $httpParamSerializer, $injector) {
  /** @private {!string} */
  this.basePath_ = $injector.has('CONTRIBUTIONApiBasePath') ?
                   /** @type {!string} */ ($injector.get('CONTRIBUTIONApiBasePath')) :
                   'https://openEHRSys.example.com/v1';

  /** @private {!Object<string, string>} */
  this.defaultHeaders_ = $injector.has('CONTRIBUTIONApiDefaultHeaders') ?
                   /** @type {!Object<string, string>} */ (
                       $injector.get('CONTRIBUTIONApiDefaultHeaders')) :
                   {};
...
API.Client.CONTRIBUTIONApi.$inject = ['$http', '$httpParamSerializer', '$injector'];
 ...
 * @param {!NewContribution} newContribution The CONTRIBUTION. 
 ...
 * @return {!angular.$q.Promise<!API.Client.Contribution>}
 */
API.Client.CONTRIBUTIONApi.prototype.contributionCreate = function(ehrId, newContribution, opt_prefer, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/ehr/{ehr_id}/contribution'
  ...
  if (!ehrId) {
    throw new Error('Missing required parameter ehrId when calling contributionCreate');
  }
  // verify required parameter 'newContribution' is set
  if (!newContribution) {
    throw new Error('Missing required parameter newContribution when calling contributionCreate');
  }
 ...
 * @return {!angular.$q.Promise<!API.Client.Contribution>}
 */
API.Client.CONTRIBUTIONApi.prototype.contributionGet = function(ehrId, contributionUid, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/ehr/{ehr_id}/contribution/{contribution_uid}'
      .replace('{' + 'ehr_id' + '}', String(ehrId))
      .replace('{' + 'contribution_uid' + '}', String(contributionUid));
  ...
  // verify required parameter 'ehrId' is set
  if (!ehrId) {
    throw new Error('Missing required parameter ehrId when calling contributionGet');
  }
  // verify required parameter 'contributionUid' is set
  if (!contributionUid) {
    throw new Error('Missing required parameter contributionUid when calling contributionGet');
  }
  /** @type {!Object} */
  var httpRequestParams = {
    method: 'GET',
