...
public class DirectoryApiTest {
     ...
     */
    @Test
    public void directoryCreateTest() throws ApiException {
        String ehrId = null;
        Folder folder = null;
        String prefer = null;
        Folder response = api.directoryCreate(ehrId, folder, prefer);
     ...
     */
    @Test
    public void directoryDeleteTest() throws ApiException {
        String ehrId = null;
        String ifMatch = null;
        api.directoryDelete(ehrId, ifMatch);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void directoryGetAtTimeTest() throws ApiException {
        String ehrId = null;
        String versionAtTime = null;
        String path = null;
        Folder response = api.directoryGetAtTime(ehrId, versionAtTime, path);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void directoryGetByVersionIdTest() throws ApiException {
        String ehrId = null;
        String versionUid = null;
        String path = null;
        Folder response = api.directoryGetByVersionId(ehrId, versionUid, path);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void directoryUpdateTest() throws ApiException {
        String ehrId = null;
        String ifMatch = null;
        Folder folder = null;
        String prefer = null;
        Folder response = api.directoryUpdate(ehrId, ifMatch, folder, prefer);
        // TODO: test validations
    }
