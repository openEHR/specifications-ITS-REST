...
public class ContributionApiTest {
     ...
     */
    @Test
    public void contributionCreateTest() throws ApiException {
        String ehrId = null;
        NewContribution newContribution = null;
        String prefer = null;
        Contribution response = api.contributionCreate(ehrId, newContribution, prefer);
     ...
     */
    @Test
    public void contributionGetTest() throws ApiException {
        String ehrId = null;
        String contributionUid = null;
        Contribution response = api.contributionGet(ehrId, contributionUid);
        // TODO: test validations
    }
