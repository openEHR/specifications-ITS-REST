...
public class ItemTree extends ItemStructure {
  ...
  protected String type = "ITEM_TREE";
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ItemTree.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ItemTree' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ItemTree> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ItemTree.class));

       return (TypeAdapter<T>) new TypeAdapter<ItemTree>() {
           @Override
           public void write(JsonWriter out, ItemTree value) throws IOException {
 ...
 /**
  * Create an instance of ItemTree given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ItemTree
  * @throws IOException if the JSON string is invalid with respect to ItemTree
  */
  public static ItemTree fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ItemTree.class);
  }

 /**
  * Convert an instance of ItemTree to an JSON string
  *
  * @return JSON string
  */
