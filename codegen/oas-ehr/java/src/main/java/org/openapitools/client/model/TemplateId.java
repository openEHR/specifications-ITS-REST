...
public class TemplateId extends ObjectId {
  ...
  protected String type = "TEMPLATE_ID";
  ...
  * @throws IOException if the JSON Object is invalid with respect to TemplateId
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TemplateId.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TemplateId is not found in the empty JSON string", TemplateId.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TemplateId.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TemplateId` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TemplateId.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TemplateId.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TemplateId' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TemplateId> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TemplateId.class));

       return (TypeAdapter<T>) new TypeAdapter<TemplateId>() {
           @Override
           public void write(JsonWriter out, TemplateId value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TemplateId read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TemplateId given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TemplateId
  * @throws IOException if the JSON string is invalid with respect to TemplateId
  */
  public static TemplateId fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TemplateId.class);
  }

 /**
  * Convert an instance of TemplateId to an JSON string
  *
  * @return JSON string
  */
