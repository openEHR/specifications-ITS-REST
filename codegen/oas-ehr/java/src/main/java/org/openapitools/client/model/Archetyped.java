...
import org.openapitools.client.model.ArchetypeId;
import org.openapitools.client.model.TemplateId;
...
public class Archetyped {
  ...
  public static final String SERIALIZED_NAME_RM_VERSION = "rm_version";
  @SerializedName(SERIALIZED_NAME_RM_VERSION)
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("archetype_id");
    openapiFields.add("template_id");
    openapiFields.add("rm_version");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("archetype_id");
    openapiRequiredFields.add("rm_version");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Archetyped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Archetyped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Archetyped is not found in the empty JSON string", Archetyped.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Archetyped.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Archetyped` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Archetyped.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `archetype_id`
      ArchetypeId.validateJsonObject(jsonObj.getAsJsonObject("archetype_id"));
      // validate the optional field `template_id`
      if (jsonObj.get("template_id") != null && !jsonObj.get("template_id").isJsonNull()) {
        TemplateId.validateJsonObject(jsonObj.getAsJsonObject("template_id"));
      }
      if (!jsonObj.get("rm_version").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `rm_version` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rm_version").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Archetyped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Archetyped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Archetyped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Archetyped.class));

       return (TypeAdapter<T>) new TypeAdapter<Archetyped>() {
           @Override
           public void write(JsonWriter out, Archetyped value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Archetyped read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Archetyped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Archetyped
  * @throws IOException if the JSON string is invalid with respect to Archetyped
  */
  public static Archetyped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Archetyped.class);
  }

 /**
  * Convert an instance of Archetyped to an JSON string
  *
  * @return JSON string
  */
