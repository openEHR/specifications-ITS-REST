...
public class FeederAuditDetails {
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("other_details");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FeederAuditDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FeederAuditDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FeederAuditDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FeederAuditDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<FeederAuditDetails>() {
           @Override
           public void write(JsonWriter out, FeederAuditDetails value) throws IOException {
 ...
 /**
  * Create an instance of FeederAuditDetails given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FeederAuditDetails
  * @throws IOException if the JSON string is invalid with respect to FeederAuditDetails
  */
  public static FeederAuditDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FeederAuditDetails.class);
  }

 /**
  * Convert an instance of FeederAuditDetails to an JSON string
  *
  * @return JSON string
  */
