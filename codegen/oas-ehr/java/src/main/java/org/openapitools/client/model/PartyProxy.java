...
public class PartyProxy {
  ...
  protected String type = "PARTY_PROXY";
 ...
 /**
  * Create an instance of PartyProxy given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PartyProxy
  * @throws IOException if the JSON string is invalid with respect to PartyProxy
  */
  public static PartyProxy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PartyProxy.class);
  }

 /**
  * Convert an instance of PartyProxy to an JSON string
  *
  * @return JSON string
  */
