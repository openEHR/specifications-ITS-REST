...
public class DvCodedText extends DvText {
  ...
  protected String type = "DV_CODED_TEXT";

  public static final String SERIALIZED_NAME_DEFINING_CODE = "defining_code";
  @SerializedName(SERIALIZED_NAME_DEFINING_CODE)
  ...
  **/
  ...
  static {
    ...
    openapiRequiredFields.add("defining_code");
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to DvCodedText
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DvCodedText.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DvCodedText is not found in the empty JSON string", DvCodedText.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DvCodedText.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DvCodedText` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DvCodedText.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DvCodedText.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DvCodedText' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DvCodedText> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DvCodedText.class));

       return (TypeAdapter<T>) new TypeAdapter<DvCodedText>() {
           @Override
           public void write(JsonWriter out, DvCodedText value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DvCodedText read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DvCodedText given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DvCodedText
  * @throws IOException if the JSON string is invalid with respect to DvCodedText
  */
  public static DvCodedText fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DvCodedText.class);
  }

 /**
  * Convert an instance of DvCodedText to an JSON string
  *
  * @return JSON string
  */
