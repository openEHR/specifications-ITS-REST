...
public class ItemSingle extends ItemStructure {
  ...
  protected String type = "ITEM_SINGLE";
  ...
  * @throws IOException if the JSON Object is invalid with respect to ItemSingle
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ItemSingle.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ItemSingle is not found in the empty JSON string", ItemSingle.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ItemSingle.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ItemSingle` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ItemSingle.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ItemSingle.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ItemSingle' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ItemSingle> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ItemSingle.class));

       return (TypeAdapter<T>) new TypeAdapter<ItemSingle>() {
           @Override
           public void write(JsonWriter out, ItemSingle value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ItemSingle read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ItemSingle given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ItemSingle
  * @throws IOException if the JSON string is invalid with respect to ItemSingle
  */
  public static ItemSingle fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ItemSingle.class);
  }

 /**
  * Convert an instance of ItemSingle to an JSON string
  *
  * @return JSON string
  */
