...
import org.openapitools.client.model.NewContribution;
...
public class ContributionApi {
    ...
    /**
     * Build call for contributionCreate
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 201 </td><td> &#x60;201 Created&#x60; is returned when the CONTRIBUTION was created.  Content body is only returned when &#x60;Prefer&#x60; header has &#x60;return&#x3D;representation&#x60;, otherwise only headers are returned.  </td><td>  * ETag -  <br>  * Location -  <br>  </td></tr>
        <tr><td> 400 </td><td> &#x60;400 Bad Request&#x60; is returned when the request URL or body could not be parsed or has invalid content (e.g. invalid &#x60;ehr_id&#x60;, or either the body of the request not be converted to a valid CONTRIBUTION object, or the modification type doesn’t match the operation - i.e. first version of a composition with MODIFICATION).  </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> &#x60;404 Not Found&#x60; is returned when an EHR with &#x60;ehr_id&#x60; does not exist.  </td><td>  -  </td></tr>
        <tr><td> 409 </td><td> &#x60;409 Conflict&#x60; is returned when a resource with same identifier(s) already exists.  </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call contributionCreateCall(String ehrId, NewContribution newContribution, String prefer, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = newContribution;

        // create path and map variables
        String localVarPath = "/ehr/{ehr_id}/contribution"
    ...
    private okhttp3.Call contributionCreateValidateBeforeCall(String ehrId, NewContribution newContribution, String prefer, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'ehrId' is set
        if (ehrId == null) {
            throw new ApiException("Missing the required parameter 'ehrId' when calling contributionCreate(Async)");
        }

        // verify the required parameter 'newContribution' is set
        if (newContribution == null) {
            throw new ApiException("Missing the required parameter 'newContribution' when calling contributionCreate(Async)");
        }

        return contributionCreateCall(ehrId, newContribution, prefer, _callback);
     ...
     */
    public Contribution contributionCreate(String ehrId, NewContribution newContribution, String prefer) throws ApiException {
        ApiResponse<Contribution> localVarResp = contributionCreateWithHttpInfo(ehrId, newContribution, prefer);
     ...
     */
    public ApiResponse<Contribution> contributionCreateWithHttpInfo(String ehrId, NewContribution newContribution, String prefer) throws ApiException {
        okhttp3.Call localVarCall = contributionCreateValidateBeforeCall(ehrId, newContribution, prefer, null);
        Type localVarReturnType = new TypeToken<Contribution>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Create CONTRIBUTION (asynchronously)
     * We will use the relaxed CONTRIBUTION with the following optional attributes:   - &#x60;uid&#x60;: when provided, it will be accepted in case is not in-use, otherwise error will be returned   - &#x60;audit.time_committed&#x60;: server will always set it   - &#x60;audit.system_id&#x60;: when provided, it will be validated 
     * @param ehrId EHR identifier taken from EHR.ehr_id.value.  (required)
     * @param newContribution The CONTRIBUTION.  (required)
     * @param prefer Request header to indicate the preference over response details. The response will contain the entire resource when the &#x60;Prefer&#x60; header has a value of &#x60;return&#x3D;representation&#x60;.  (optional, default to return&#x3D;minimal)
     ...
     */
    public okhttp3.Call contributionCreateAsync(String ehrId, NewContribution newContribution, String prefer, final ApiCallback<Contribution> _callback) throws ApiException {

        okhttp3.Call localVarCall = contributionCreateValidateBeforeCall(ehrId, newContribution, prefer, _callback);
        Type localVarReturnType = new TypeToken<Contribution>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for contributionGet
     * @param ehrId EHR identifier taken from EHR.ehr_id.value.  (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> &#x60;200 OK&#x60; is returned when the CONTRIBUTION is successfully retrieved.  </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> &#x60;404 Not Found&#x60; is returned when an EHR with &#x60;ehr_id&#x60; does not exist, or when a CONTRIBUTION with &#x60;contribution_uid&#x60; does not exist.  </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call contributionGetCall(String ehrId, String contributionUid, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/ehr/{ehr_id}/contribution/{contribution_uid}"
            .replace("{" + "ehr_id" + "}", localVarApiClient.escapeString(ehrId.toString()))
            .replace("{" + "contribution_uid" + "}", localVarApiClient.escapeString(contributionUid.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call contributionGetValidateBeforeCall(String ehrId, String contributionUid, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'ehrId' is set
        if (ehrId == null) {
            throw new ApiException("Missing the required parameter 'ehrId' when calling contributionGet(Async)");
        }

        // verify the required parameter 'contributionUid' is set
        if (contributionUid == null) {
            throw new ApiException("Missing the required parameter 'contributionUid' when calling contributionGet(Async)");
        }

        return contributionGetCall(ehrId, contributionUid, _callback);
     ...
     */
    public Contribution contributionGet(String ehrId, String contributionUid) throws ApiException {
        ApiResponse<Contribution> localVarResp = contributionGetWithHttpInfo(ehrId, contributionUid);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Contribution> contributionGetWithHttpInfo(String ehrId, String contributionUid) throws ApiException {
        okhttp3.Call localVarCall = contributionGetValidateBeforeCall(ehrId, contributionUid, null);
        Type localVarReturnType = new TypeToken<Contribution>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get CONTRIBUTION by id (asynchronously)
     * Retrieves a CONTRIBUTION identified by &#x60;contribution_uid&#x60; and associated with the EHR identified by &#x60;ehr_id&#x60;. 
     * @param ehrId EHR identifier taken from EHR.ehr_id.value.  (required)
     * @param contributionUid The CONTRIBUTION uid.  (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call contributionGetAsync(String ehrId, String contributionUid, final ApiCallback<Contribution> _callback) throws ApiException {

        okhttp3.Call localVarCall = contributionGetValidateBeforeCall(ehrId, contributionUid, _callback);
        Type localVarReturnType = new TypeToken<Contribution>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
