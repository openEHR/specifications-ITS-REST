...
import org.openapitools.client.model.FeederAuditDetails;
...
public class FeederAudit {
  public static final String SERIALIZED_NAME_ORIGINATING_SYSTEM_ITEM_IDS = "originating_system_item_ids";
  @SerializedName(SERIALIZED_NAME_ORIGINATING_SYSTEM_ITEM_IDS)
  private List<DvIdentifier> originatingSystemItemIds;

  public static final String SERIALIZED_NAME_FEEDER_SYSTEM_ITEM_IDS = "feeder_system_item_ids";
  @SerializedName(SERIALIZED_NAME_FEEDER_SYSTEM_ITEM_IDS)
  private List<DvIdentifier> feederSystemItemIds;

  public static final String SERIALIZED_NAME_ORIGINAL_CONTENT = "original_content";
  @SerializedName(SERIALIZED_NAME_ORIGINAL_CONTENT)
  private DvEncapsulated originalContent;

  public static final String SERIALIZED_NAME_ORIGINATING_SYSTEM_AUDIT = "originating_system_audit";
  @SerializedName(SERIALIZED_NAME_ORIGINATING_SYSTEM_AUDIT)
  private FeederAuditDetails originatingSystemAudit;

  public static final String SERIALIZED_NAME_FEEDER_SYSTEM_AUDIT = "feeder_system_audit";
  @SerializedName(SERIALIZED_NAME_FEEDER_SYSTEM_AUDIT)
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("originating_system_item_ids");
    openapiFields.add("feeder_system_item_ids");
    openapiFields.add("original_content");
    openapiFields.add("originating_system_audit");
    openapiFields.add("feeder_system_audit");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("originating_system_audit");
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("originating_system_item_ids") != null && !jsonObj.get("originating_system_item_ids").isJsonNull()) {
        ...
        if (jsonArrayoriginatingSystemItemIds != null) {
          ...
          if (!jsonObj.get("originating_system_item_ids").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `originating_system_item_ids` to be an array in the JSON string but got `%s`", jsonObj.get("originating_system_item_ids").toString()));
          }
      ...
      if (jsonObj.get("feeder_system_item_ids") != null && !jsonObj.get("feeder_system_item_ids").isJsonNull()) {
        JsonArray jsonArrayfeederSystemItemIds = jsonObj.getAsJsonArray("feeder_system_item_ids");
        if (jsonArrayfeederSystemItemIds != null) {
          // ensure the json data is an array
          if (!jsonObj.get("feeder_system_item_ids").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `feeder_system_item_ids` to be an array in the JSON string but got `%s`", jsonObj.get("feeder_system_item_ids").toString()));
          }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FeederAudit.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FeederAudit' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FeederAudit> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FeederAudit.class));

       return (TypeAdapter<T>) new TypeAdapter<FeederAudit>() {
           @Override
           public void write(JsonWriter out, FeederAudit value) throws IOException {
 ...
 /**
  * Create an instance of FeederAudit given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FeederAudit
  * @throws IOException if the JSON string is invalid with respect to FeederAudit
  */
  public static FeederAudit fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FeederAudit.class);
  }

 /**
  * Convert an instance of FeederAudit to an JSON string
  *
  * @return JSON string
  */
