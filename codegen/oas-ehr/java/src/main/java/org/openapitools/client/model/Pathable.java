...
import org.openapitools.client.model.DataStructure;
...
import org.openapitools.client.model.EventContext;
...
import org.openapitools.client.model.IsmTransition;
...
public class Pathable {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Pathable
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Pathable.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pathable is not found in the empty JSON string", Pathable.openapiRequiredFields.toString()));
        }
      }
      ...
      switch (discriminatorValue) {
        ...
        case "EVENT":
          ...
          break;
        case "EVENT_CONTEXT":
          EventContext.validateJsonObject(jsonObj);
          break;
        case "EhrStatus":
          EhrStatus.validateJsonObject(jsonObj);
          break;
        ...
        case "INSTRUCTION_DETAILS":
          InstructionDetails.validateJsonObject(jsonObj);
          break;
        case "ISM_TRANSITION":
          IsmTransition.validateJsonObject(jsonObj);
          break;
        case "ITEM":
        ...
        case "ItemTree":
          ...
          break;
        case "Locatable":
          Locatable.validateJsonObject(jsonObj);
          break;
        case "OBSERVATION":
 ...
 /**
  * Create an instance of Pathable given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Pathable
  * @throws IOException if the JSON string is invalid with respect to Pathable
  */
  public static Pathable fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pathable.class);
  }

 /**
  * Convert an instance of Pathable to an JSON string
  *
  * @return JSON string
  */
