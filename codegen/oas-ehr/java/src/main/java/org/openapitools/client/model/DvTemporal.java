...
public class DvTemporal extends DvQuantified {
  ...
  protected String type = "DV_TEMPORAL";
 ...
 /**
  * Create an instance of DvTemporal given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DvTemporal
  * @throws IOException if the JSON string is invalid with respect to DvTemporal
  */
  public static DvTemporal fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DvTemporal.class);
  }

 /**
  * Convert an instance of DvTemporal to an JSON string
  *
  * @return JSON string
  */
