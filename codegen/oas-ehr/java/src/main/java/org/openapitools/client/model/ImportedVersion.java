...
import org.openapitools.client.model.ImportedVersion;
import org.openapitools.client.model.ObjectRef;
import org.openapitools.client.model.OriginalVersion;
...
public class ImportedVersion extends Version {
  ...
  protected String type = "IMPORTED_VERSION";
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("commit_audit");
    ...
    openapiRequiredFields.add("commit_audit");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImportedVersion
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImportedVersion.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportedVersion is not found in the empty JSON string", ImportedVersion.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ImportedVersion.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportedVersion` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImportedVersion.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportedVersion.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportedVersion' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportedVersion> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportedVersion.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportedVersion>() {
           @Override
           public void write(JsonWriter out, ImportedVersion value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportedVersion read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ImportedVersion given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ImportedVersion
  * @throws IOException if the JSON string is invalid with respect to ImportedVersion
  */
  public static ImportedVersion fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportedVersion.class);
  }

 /**
  * Convert an instance of ImportedVersion to an JSON string
  *
  * @return JSON string
  */
