...
import org.openapitools.client.model.GenericId;
...
public class TerminologyId extends ObjectId {
  ...
  protected String type = "TERMINOLOGY_ID";
  ...
  * @throws IOException if the JSON Object is invalid with respect to TerminologyId
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TerminologyId.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TerminologyId is not found in the empty JSON string", TerminologyId.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TerminologyId.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TerminologyId` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TerminologyId.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TerminologyId.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TerminologyId' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TerminologyId> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TerminologyId.class));

       return (TypeAdapter<T>) new TypeAdapter<TerminologyId>() {
           @Override
           public void write(JsonWriter out, TerminologyId value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TerminologyId read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TerminologyId given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TerminologyId
  * @throws IOException if the JSON string is invalid with respect to TerminologyId
  */
  public static TerminologyId fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TerminologyId.class);
  }

 /**
  * Convert an instance of TerminologyId to an JSON string
  *
  * @return JSON string
  */
