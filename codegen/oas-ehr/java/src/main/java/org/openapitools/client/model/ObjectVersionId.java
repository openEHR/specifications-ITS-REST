...
import org.openapitools.client.model.UidBasedId;
...
public class ObjectVersionId extends UidBasedId {
  ...
  public ObjectVersionId value(String value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ObjectVersionId objectVersionId = (ObjectVersionId) o;
    return Objects.equals(this.value, objectVersionId.value) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class ObjectVersionId {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ObjectVersionId
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ObjectVersionId.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ObjectVersionId is not found in the empty JSON string", ObjectVersionId.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ObjectVersionId.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ObjectVersionId` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ObjectVersionId.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ObjectVersionId.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ObjectVersionId' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ObjectVersionId> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ObjectVersionId.class));

       return (TypeAdapter<T>) new TypeAdapter<ObjectVersionId>() {
           @Override
           public void write(JsonWriter out, ObjectVersionId value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ObjectVersionId read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ObjectVersionId given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ObjectVersionId
  * @throws IOException if the JSON string is invalid with respect to ObjectVersionId
  */
  public static ObjectVersionId fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ObjectVersionId.class);
  }

 /**
  * Convert an instance of ObjectVersionId to an JSON string
  *
  * @return JSON string
  */
