...
public class AbstractEntry extends ContentItem {
  ...
  public static final String SERIALIZED_NAME_OTHER_PARTICIPATIONS = "other_participations";
  @SerializedName(SERIALIZED_NAME_OTHER_PARTICIPATIONS)
 ...
 /**
  * Create an instance of AbstractEntry given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AbstractEntry
  * @throws IOException if the JSON string is invalid with respect to AbstractEntry
  */
  public static AbstractEntry fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbstractEntry.class);
  }

 /**
  * Convert an instance of AbstractEntry to an JSON string
  *
  * @return JSON string
  */
