...
public class UidBasedId extends ObjectId {
  ...
  protected String type = "UID_BASED_ID";
  ...
  * @throws IOException if the JSON Element is invalid with respect to UidBasedId
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UidBasedId.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UidBasedId is not found in the empty JSON string", UidBasedId.openapiRequiredFields.toString()));
        }
      }
 ...
 /**
  * Create an instance of UidBasedId given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UidBasedId
  * @throws IOException if the JSON string is invalid with respect to UidBasedId
  */
  public static UidBasedId fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UidBasedId.class);
  }

 /**
  * Convert an instance of UidBasedId to an JSON string
  *
  * @return JSON string
  */
