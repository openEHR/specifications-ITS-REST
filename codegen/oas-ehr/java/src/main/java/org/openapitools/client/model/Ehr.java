...
public class Ehr {
  ...
  public static final String SERIALIZED_NAME_EHR_ID = "ehr_id";
  @SerializedName(SERIALIZED_NAME_EHR_ID)
  private HierObjectId ehrId;

  public static final String SERIALIZED_NAME_EHR_STATUS = "ehr_status";
  @SerializedName(SERIALIZED_NAME_EHR_STATUS)
  private ObjectRef ehrStatus;

  public static final String SERIALIZED_NAME_EHR_ACCESS = "ehr_access";
  @SerializedName(SERIALIZED_NAME_EHR_ACCESS)
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("ehr_id");
    openapiFields.add("ehr_status");
    openapiFields.add("ehr_access");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ehr.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ehr' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ehr> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ehr.class));

       return (TypeAdapter<T>) new TypeAdapter<Ehr>() {
           @Override
           public void write(JsonWriter out, Ehr value) throws IOException {
 ...
 /**
  * Create an instance of Ehr given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Ehr
  * @throws IOException if the JSON string is invalid with respect to Ehr
  */
  public static Ehr fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ehr.class);
  }

 /**
  * Convert an instance of Ehr to an JSON string
  *
  * @return JSON string
  */
