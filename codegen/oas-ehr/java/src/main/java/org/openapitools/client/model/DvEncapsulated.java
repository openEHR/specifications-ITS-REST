...
public class DvEncapsulated extends DataValue {
  ...
  * @throws IOException if the JSON Element is invalid with respect to DvEncapsulated
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DvEncapsulated.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
