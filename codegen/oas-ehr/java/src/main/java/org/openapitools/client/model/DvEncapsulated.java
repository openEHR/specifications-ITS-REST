...
public class DvEncapsulated extends DataValue {
  ...
  protected String type = "DV_ENCAPSULATED";
  ...
  * @throws IOException if the JSON Object is invalid with respect to DvEncapsulated
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DvEncapsulated.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DvEncapsulated is not found in the empty JSON string", DvEncapsulated.openapiRequiredFields.toString()));
        }
      }
 ...
 /**
  * Create an instance of DvEncapsulated given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DvEncapsulated
  * @throws IOException if the JSON string is invalid with respect to DvEncapsulated
  */
  public static DvEncapsulated fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DvEncapsulated.class);
  }

 /**
  * Convert an instance of DvEncapsulated to an JSON string
  *
  * @return JSON string
  */
