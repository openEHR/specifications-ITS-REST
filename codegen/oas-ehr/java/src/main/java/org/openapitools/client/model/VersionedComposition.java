...
import org.openapitools.client.model.VersionedObject;
...
public class VersionedComposition extends VersionedObject {
  ...
  protected String type = "VERSIONED_COMPOSITION";
  ...
  * @throws IOException if the JSON Object is invalid with respect to VersionedComposition
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VersionedComposition.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VersionedComposition is not found in the empty JSON string", VersionedComposition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!VersionedComposition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VersionedComposition` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VersionedComposition.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VersionedComposition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VersionedComposition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VersionedComposition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VersionedComposition.class));

       return (TypeAdapter<T>) new TypeAdapter<VersionedComposition>() {
           @Override
           public void write(JsonWriter out, VersionedComposition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VersionedComposition read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of VersionedComposition given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VersionedComposition
  * @throws IOException if the JSON string is invalid with respect to VersionedComposition
  */
  public static VersionedComposition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VersionedComposition.class);
  }

 /**
  * Convert an instance of VersionedComposition to an JSON string
  *
  * @return JSON string
  */
