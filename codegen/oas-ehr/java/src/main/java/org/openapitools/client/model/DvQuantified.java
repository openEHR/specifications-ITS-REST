...
public class DvQuantified extends DvOrdered {
  ...
  protected String type = "DV_QUANTIFIED";

  public static final String SERIALIZED_NAME_MAGNITUDE_STATUS = "magnitude_status";
  @SerializedName(SERIALIZED_NAME_MAGNITUDE_STATUS)
  ...
  * @throws IOException if the JSON Object is invalid with respect to DvQuantified
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DvQuantified.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DvQuantified is not found in the empty JSON string", DvQuantified.openapiRequiredFields.toString()));
        }
      }
 ...
 /**
  * Create an instance of DvQuantified given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DvQuantified
  * @throws IOException if the JSON string is invalid with respect to DvQuantified
  */
  public static DvQuantified fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DvQuantified.class);
  }

 /**
  * Convert an instance of DvQuantified to an JSON string
  *
  * @return JSON string
  */
