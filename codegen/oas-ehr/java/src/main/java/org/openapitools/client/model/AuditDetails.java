...
public class AuditDetails {
  ...
  protected String type = "AUDIT_DETAILS";

  public static final String SERIALIZED_NAME_SYSTEM_ID = "system_id";
  @SerializedName(SERIALIZED_NAME_SYSTEM_ID)
  private String systemId;

  public static final String SERIALIZED_NAME_TIME_COMMITTED = "time_committed";
  @SerializedName(SERIALIZED_NAME_TIME_COMMITTED)
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("time_committed");
    ...
    openapiRequiredFields.add("time_committed");
  ...
  * @throws IOException if the JSON Element is invalid with respect to AuditDetails
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuditDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      switch (discriminatorValue) {
        case "ATTESTATION":
          Attestation.validateJsonElement(jsonElement);
          break;
        default:
