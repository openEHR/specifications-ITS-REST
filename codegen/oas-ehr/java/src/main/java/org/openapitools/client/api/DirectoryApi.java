...
public class DirectoryApi {
    ...
    /**
     * Build call for directoryCreate
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 201 </td><td> &#x60;201 Created&#x60; is returned when the FOLDER was created.  Content body is only returned when &#x60;Prefer&#x60; header has &#x60;return&#x3D;representation&#x60;, otherwise only headers are returned.  </td><td>  * ETag -  <br>  * Location -  <br>  </td></tr>
        <tr><td> 400 </td><td> &#x60;400 Bad Request&#x60; is returned when the request URL or body (if provided) could not be parsed or has invalid content (e.g. invalid &#x60;ehr_id&#x60;, or either the body of the request could not be read, or could not be converted to a valid FOLDER object).  </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> &#x60;404 Not Found&#x60; is returned when an EHR with &#x60;ehr_id&#x60; does not exist.  </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call directoryCreateCall(String ehrId, Folder folder, String prefer, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/ehr/{ehr_id}/directory"
    ...
    private okhttp3.Call directoryCreateValidateBeforeCall(String ehrId, Folder folder, String prefer, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'ehrId' is set
        if (ehrId == null) {
            throw new ApiException("Missing the required parameter 'ehrId' when calling directoryCreate(Async)");
        }

        // verify the required parameter 'folder' is set
        if (folder == null) {
            throw new ApiException("Missing the required parameter 'folder' when calling directoryCreate(Async)");
        }

        return directoryCreateCall(ehrId, folder, prefer, _callback);
     ...
     */
    public Folder directoryCreate(String ehrId, Folder folder, String prefer) throws ApiException {
        ApiResponse<Folder> localVarResp = directoryCreateWithHttpInfo(ehrId, folder, prefer);
     ...
     */
    public ApiResponse<Folder> directoryCreateWithHttpInfo(String ehrId, Folder folder, String prefer) throws ApiException {
        okhttp3.Call localVarCall = directoryCreateValidateBeforeCall(ehrId, folder, prefer, null);
     ...
     */
    public okhttp3.Call directoryCreateAsync(String ehrId, Folder folder, String prefer, final ApiCallback<Folder> _callback) throws ApiException {

        okhttp3.Call localVarCall = directoryCreateValidateBeforeCall(ehrId, folder, prefer, _callback);
        Type localVarReturnType = new TypeToken<Folder>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for directoryDelete
     * @param ehrId EHR identifier taken from EHR.ehr_id.value.  (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 204 </td><td> &#x60;204 No Content&#x60; is returned when the resource identified by the request parameters has been (logically) deleted.  </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> &#x60;400 Bad Request&#x60; is returned when the request has invalid &#x60;ehr_id&#x60;.  </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> &#x60;404 Not Found&#x60; is returned when an EHR with &#x60;ehr_id&#x60; does not exist.  </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call directoryDeleteCall(String ehrId, String ifMatch, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call directoryDeleteValidateBeforeCall(String ehrId, String ifMatch, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'ehrId' is set
        if (ehrId == null) {
            throw new ApiException("Missing the required parameter 'ehrId' when calling directoryDelete(Async)");
        }

        // verify the required parameter 'ifMatch' is set
        if (ifMatch == null) {
            throw new ApiException("Missing the required parameter 'ifMatch' when calling directoryDelete(Async)");
        }

        return directoryDeleteCall(ehrId, ifMatch, _callback);
     ...
     */
    public void directoryDelete(String ehrId, String ifMatch) throws ApiException {
        directoryDeleteWithHttpInfo(ehrId, ifMatch);
    }
     ...
     */
    public ApiResponse<Void> directoryDeleteWithHttpInfo(String ehrId, String ifMatch) throws ApiException {
        okhttp3.Call localVarCall = directoryDeleteValidateBeforeCall(ehrId, ifMatch, null);
     ...
     */
    public okhttp3.Call directoryDeleteAsync(String ehrId, String ifMatch, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = directoryDeleteValidateBeforeCall(ehrId, ifMatch, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for directoryGetAtTime
     * @param ehrId EHR identifier taken from EHR.ehr_id.value.  (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> &#x60;200 OK&#x60; is returned when the FOLDER is successfully retrieved.  </td><td>  -  </td></tr>
        ...
        <tr><td> 404 </td><td> &#x60;404 Not Found&#x60; is returned when an EHR with &#x60;ehr_id&#x60; does not exist, or when a directory does not exist at the specified &#x60;version_at_time&#x60;, or when &#x60;path&#x60; does not exists within the directory.  </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call directoryGetAtTimeCall(String ehrId, String versionAtTime, String path, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call directoryGetAtTimeValidateBeforeCall(String ehrId, String versionAtTime, String path, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'ehrId' is set
        if (ehrId == null) {
            throw new ApiException("Missing the required parameter 'ehrId' when calling directoryGetAtTime(Async)");
        }

        return directoryGetAtTimeCall(ehrId, versionAtTime, path, _callback);
     ...
     */
    public Folder directoryGetAtTime(String ehrId, String versionAtTime, String path) throws ApiException {
        ApiResponse<Folder> localVarResp = directoryGetAtTimeWithHttpInfo(ehrId, versionAtTime, path);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Folder> directoryGetAtTimeWithHttpInfo(String ehrId, String versionAtTime, String path) throws ApiException {
        okhttp3.Call localVarCall = directoryGetAtTimeValidateBeforeCall(ehrId, versionAtTime, path, null);
        Type localVarReturnType = new TypeToken<Folder>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get folder in directory version at time (asynchronously)
     * Retrieves the version of the directory FOLDER associated with the EHR identified by &#x60;ehr_id&#x60;.  If &#x60;version_at_time&#x60; is supplied, retrieves the version extant _at specified time_, otherwise retrieves the _latest_ directory FOLDER version.   If &#x60;path&#x60; is supplied, retrieves from the directory only the sub-FOLDER that is associated with that path. 
     * @param ehrId EHR identifier taken from EHR.ehr_id.value.  (required)
     * @param versionAtTime A given time in the extended ISO 8601 format.  (optional)
     * @param path A path to a sub-folder; consists of slash-separated values of the name attribute of FOLDERs in the directory.  (optional)
     ...
     */
    public okhttp3.Call directoryGetAtTimeAsync(String ehrId, String versionAtTime, String path, final ApiCallback<Folder> _callback) throws ApiException {

        okhttp3.Call localVarCall = directoryGetAtTimeValidateBeforeCall(ehrId, versionAtTime, path, _callback);
        Type localVarReturnType = new TypeToken<Folder>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for directoryGetByVersionId
     * @param ehrId EHR identifier taken from EHR.ehr_id.value.  (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> &#x60;200 OK&#x60; is returned when the FOLDER is successfully retrieved.  </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> &#x60;404 Not Found&#x60; is returned when an EHR with &#x60;ehr_id&#x60; does not exist, or when a directory with &#x60;version_uid&#x60; does not exist, or when &#x60;path&#x60; does not exist within the directory.  </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call directoryGetByVersionIdCall(String ehrId, String versionUid, String path, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/ehr/{ehr_id}/directory/{version_uid}"
            .replace("{" + "ehr_id" + "}", localVarApiClient.escapeString(ehrId.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call directoryGetByVersionIdValidateBeforeCall(String ehrId, String versionUid, String path, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'ehrId' is set
        if (ehrId == null) {
            throw new ApiException("Missing the required parameter 'ehrId' when calling directoryGetByVersionId(Async)");
        }

        // verify the required parameter 'versionUid' is set
        if (versionUid == null) {
            throw new ApiException("Missing the required parameter 'versionUid' when calling directoryGetByVersionId(Async)");
        }

        return directoryGetByVersionIdCall(ehrId, versionUid, path, _callback);
     ...
     */
    public Folder directoryGetByVersionId(String ehrId, String versionUid, String path) throws ApiException {
        ApiResponse<Folder> localVarResp = directoryGetByVersionIdWithHttpInfo(ehrId, versionUid, path);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Folder> directoryGetByVersionIdWithHttpInfo(String ehrId, String versionUid, String path) throws ApiException {
        okhttp3.Call localVarCall = directoryGetByVersionIdValidateBeforeCall(ehrId, versionUid, path, null);
        Type localVarReturnType = new TypeToken<Folder>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get folder in directory version (asynchronously)
     * Retrieves a particular version of the directory FOLDER identified by &#x60;version_uid&#x60; and associated with the EHR identified by &#x60;ehr_id&#x60;.  If &#x60;path&#x60; is supplied, retrieves from the directory only the sub-FOLDER that is associated with that path. 
     * @param ehrId EHR identifier taken from EHR.ehr_id.value.  (required)
     * @param versionUid VERSION identifier taken from VERSION.uid.value.  (required)
     * @param path A path to a sub-folder; consists of slash-separated values of the name attribute of FOLDERs in the directory.  (optional)
     ...
     */
    public okhttp3.Call directoryGetByVersionIdAsync(String ehrId, String versionUid, String path, final ApiCallback<Folder> _callback) throws ApiException {

        okhttp3.Call localVarCall = directoryGetByVersionIdValidateBeforeCall(ehrId, versionUid, path, _callback);
        Type localVarReturnType = new TypeToken<Folder>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for directoryUpdate
     * @param ehrId EHR identifier taken from EHR.ehr_id.value.  (required)
     * @param ifMatch Header to make the request conditional.  Together with &#x60;ETag&#x60; request tag, it helps to prevent simultaneous updates of a resource from overwriting each other (\&quot;mid-air collisions\&quot;). The format is always an &#x60;version_uid&#x60; identifier enclosed by double quotes. The operation will be performed only if the existing latest &#x60;version_uid&#x60; of the resource (i.e. the &#x60;preceding_version_uid&#x60;) matches this header&#39;s value.  (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> &#x60;200 OK&#x60; is returned when directory was successfully updated and the updated resource is returned in the body when &#x60;Prefer&#x60; header value is &#x60;return&#x3D;representation&#x60;.  </td><td>  * ETag -  <br>  * Location -  <br>  </td></tr>
        <tr><td> 204 </td><td> &#x60;204 No Content&#x60; is returned when directory was updated and &#x60;Prefer&#x60; header is missing or is set to &#x60;return&#x3D;minimal&#x60;.  </td><td>  * ETag -  <br>  * Location -  <br>  </td></tr>
        <tr><td> 400 </td><td> &#x60;400 Bad Request&#x60; is returned when the request URL or body (if provided) could not be parsed or has invalid content (e.g. invalid &#x60;ehr_id&#x60;, or either the body of the request could not be read, or could not be converted to a valid FOLDER object).  </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> &#x60;404 Not Found&#x60; is returned when an EHR with &#x60;ehr_id&#x60; does not exist.  </td><td>  -  </td></tr>
        <tr><td> 412 </td><td> &#x60;412 Precondition Failed&#x60; is returned when &#x60;If-Match&#x60; request header doesn&#39;t match the latest version on the service side. Returns also latest &#x60;version_uid&#x60; in the &#x60;Location&#x60; and &#x60;ETag&#x60; headers.  </td><td>  * ETag -  <br>  * Location -  <br>  </td></tr>
     </table>
     */
    public okhttp3.Call directoryUpdateCall(String ehrId, String ifMatch, Folder folder, String prefer, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call directoryUpdateValidateBeforeCall(String ehrId, String ifMatch, Folder folder, String prefer, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'ehrId' is set
        if (ehrId == null) {
            throw new ApiException("Missing the required parameter 'ehrId' when calling directoryUpdate(Async)");
        }

        // verify the required parameter 'ifMatch' is set
        if (ifMatch == null) {
            throw new ApiException("Missing the required parameter 'ifMatch' when calling directoryUpdate(Async)");
        }

        // verify the required parameter 'folder' is set
        if (folder == null) {
            throw new ApiException("Missing the required parameter 'folder' when calling directoryUpdate(Async)");
        }

        return directoryUpdateCall(ehrId, ifMatch, folder, prefer, _callback);
     ...
     */
    public Folder directoryUpdate(String ehrId, String ifMatch, Folder folder, String prefer) throws ApiException {
        ApiResponse<Folder> localVarResp = directoryUpdateWithHttpInfo(ehrId, ifMatch, folder, prefer);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Folder> directoryUpdateWithHttpInfo(String ehrId, String ifMatch, Folder folder, String prefer) throws ApiException {
        okhttp3.Call localVarCall = directoryUpdateValidateBeforeCall(ehrId, ifMatch, folder, prefer, null);
        Type localVarReturnType = new TypeToken<Folder>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Update directory (asynchronously)
     * Updates directory FOLDER associated with the EHR identified by &#x60;ehr_id&#x60;.  The existing latest &#x60;version_uid&#x60; of directory FOLDER resource (i.e. the &#x60;preceding_version_uid&#x60;) must be specified in the &#x60;If-Match&#x60; header. 
     * @param ehrId EHR identifier taken from EHR.ehr_id.value.  (required)
     * @param ifMatch Header to make the request conditional.  Together with &#x60;ETag&#x60; request tag, it helps to prevent simultaneous updates of a resource from overwriting each other (\&quot;mid-air collisions\&quot;). The format is always an &#x60;version_uid&#x60; identifier enclosed by double quotes. The operation will be performed only if the existing latest &#x60;version_uid&#x60; of the resource (i.e. the &#x60;preceding_version_uid&#x60;) matches this header&#39;s value.  (required)
     * @param folder The new directory.  (required)
     ...
     */
    public okhttp3.Call directoryUpdateAsync(String ehrId, String ifMatch, Folder folder, String prefer, final ApiCallback<Folder> _callback) throws ApiException {

        okhttp3.Call localVarCall = directoryUpdateValidateBeforeCall(ehrId, ifMatch, folder, prefer, _callback);
        Type localVarReturnType = new TypeToken<Folder>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
