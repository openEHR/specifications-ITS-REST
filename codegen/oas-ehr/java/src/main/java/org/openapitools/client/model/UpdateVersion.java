...
public class UpdateVersion {
  public static final String SERIALIZED_NAME_PRECEDING_VERSION_UID = "preceding_version_uid";
  @SerializedName(SERIALIZED_NAME_PRECEDING_VERSION_UID)
  ...
  public static final String SERIALIZED_NAME_LIFECYCLE_STATE = "lifecycle_state";
  @SerializedName(SERIALIZED_NAME_LIFECYCLE_STATE)
  private TerminologyCode lifecycleState;

  public static final String SERIALIZED_NAME_ATTESTATIONS = "attestations";
  @SerializedName(SERIALIZED_NAME_ATTESTATIONS)
  ...
  public static final String SERIALIZED_NAME_COMMIT_AUDIT = "commit_audit";
  @SerializedName(SERIALIZED_NAME_COMMIT_AUDIT)
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("preceding_version_uid");
    openapiFields.add("signature");
    openapiFields.add("lifecycle_state");
    openapiFields.add("attestations");
    openapiFields.add("data");
    openapiFields.add("commit_audit");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("lifecycle_state");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("attestations") != null && !jsonObj.get("attestations").isJsonNull()) {
        ...
        if (jsonArrayattestations != null) {
          ...
          if (!jsonObj.get("attestations").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `attestations` to be an array in the JSON string but got `%s`", jsonObj.get("attestations").toString()));
          }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateVersion.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateVersion' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateVersion> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateVersion.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateVersion>() {
           @Override
           public void write(JsonWriter out, UpdateVersion value) throws IOException {
 ...
 /**
  * Create an instance of UpdateVersion given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateVersion
  * @throws IOException if the JSON string is invalid with respect to UpdateVersion
  */
  public static UpdateVersion fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateVersion.class);
  }

 /**
  * Convert an instance of UpdateVersion to an JSON string
  *
  * @return JSON string
  */
