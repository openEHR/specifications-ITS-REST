...
import org.openapitools.client.model.DvDate;
...
import org.openapitools.client.model.DvState;
import org.openapitools.client.model.DvTemporal;
import org.openapitools.client.model.DvText;
import org.openapitools.client.model.DvTime;
...
public class DvState extends DataValue {
  ...
  protected String type = "DV_STATE";

  public static final String SERIALIZED_NAME_VALUE = "value";
  @SerializedName(SERIALIZED_NAME_VALUE)
  private DvCodedText value;

  public static final String SERIALIZED_NAME_IS_TERMINAL = "is_terminal";
  ...
  **/
  ...
  static {
    ...
    openapiRequiredFields.add("is_terminal");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DvState
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DvState.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DvState is not found in the empty JSON string", DvState.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DvState.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DvState` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DvState.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DvState.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DvState' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DvState> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DvState.class));

       return (TypeAdapter<T>) new TypeAdapter<DvState>() {
           @Override
           public void write(JsonWriter out, DvState value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DvState read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DvState given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DvState
  * @throws IOException if the JSON string is invalid with respect to DvState
  */
  public static DvState fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DvState.class);
  }

 /**
  * Convert an instance of DvState to an JSON string
  *
  * @return JSON string
  */
