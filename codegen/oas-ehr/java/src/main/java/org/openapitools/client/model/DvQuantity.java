...
public class DvQuantity extends DvAmount {
  ...
  protected String type = "DV_QUANTITY";
  ...
  public static final String SERIALIZED_NAME_UNITS_SYSTEM = "units_system";
  @SerializedName(SERIALIZED_NAME_UNITS_SYSTEM)
  private String unitsSystem;

  public static final String SERIALIZED_NAME_UNITS_DISPLAY_NAME = "units_display_name";
  @SerializedName(SERIALIZED_NAME_UNITS_DISPLAY_NAME)
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DvQuantity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DvQuantity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DvQuantity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DvQuantity.class));

       return (TypeAdapter<T>) new TypeAdapter<DvQuantity>() {
           @Override
           public void write(JsonWriter out, DvQuantity value) throws IOException {
 ...
 /**
  * Create an instance of DvQuantity given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DvQuantity
  * @throws IOException if the JSON string is invalid with respect to DvQuantity
  */
  public static DvQuantity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DvQuantity.class);
  }

 /**
  * Convert an instance of DvQuantity to an JSON string
  *
  * @return JSON string
  */
