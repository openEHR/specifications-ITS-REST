...
public class DvCount extends DvAmount {
  ...
  protected String type = "DV_COUNT";
  ...
  **/
  ...
  static {
    ...
    openapiRequiredFields.add("magnitude");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DvCount
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DvCount.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DvCount is not found in the empty JSON string", DvCount.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DvCount.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DvCount` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DvCount.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DvCount.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DvCount' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DvCount> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DvCount.class));

       return (TypeAdapter<T>) new TypeAdapter<DvCount>() {
           @Override
           public void write(JsonWriter out, DvCount value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DvCount read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DvCount given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DvCount
  * @throws IOException if the JSON string is invalid with respect to DvCount
  */
  public static DvCount fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DvCount.class);
  }

 /**
  * Convert an instance of DvCount to an JSON string
  *
  * @return JSON string
  */
