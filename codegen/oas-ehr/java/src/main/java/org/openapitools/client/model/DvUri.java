...
public class DvUri extends DataValue {
  ...
  * @throws IOException if the JSON Object is invalid with respect to DvUri
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DvUri.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DvUri is not found in the empty JSON string", DvUri.openapiRequiredFields.toString()));
        }
      }
 ...
 /**
  * Create an instance of DvUri given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DvUri
  * @throws IOException if the JSON string is invalid with respect to DvUri
  */
  public static DvUri fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DvUri.class);
  }

 /**
  * Convert an instance of DvUri to an JSON string
  *
  * @return JSON string
  */
