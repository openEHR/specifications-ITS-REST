...
public class IsmTransition extends Pathable {
  ...
  protected String type = "ISM_TRANSITION";
  ...
  public static final String SERIALIZED_NAME_CAREFLOW_STEP = "careflow_step";
  @SerializedName(SERIALIZED_NAME_CAREFLOW_STEP)
  ...
  **/
  ...
  static {
    ...
    openapiRequiredFields.add("current_state");
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to IsmTransition
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IsmTransition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IsmTransition is not found in the empty JSON string", IsmTransition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IsmTransition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IsmTransition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IsmTransition.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IsmTransition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IsmTransition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IsmTransition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IsmTransition.class));

       return (TypeAdapter<T>) new TypeAdapter<IsmTransition>() {
           @Override
           public void write(JsonWriter out, IsmTransition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IsmTransition read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of IsmTransition given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IsmTransition
  * @throws IOException if the JSON string is invalid with respect to IsmTransition
  */
  public static IsmTransition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IsmTransition.class);
  }

 /**
  * Convert an instance of IsmTransition to an JSON string
  *
  * @return JSON string
  */
