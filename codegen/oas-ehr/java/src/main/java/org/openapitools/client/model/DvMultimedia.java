...
public class DvMultimedia extends DvEncapsulated {
  ...
  protected String type = "DV_MULTIMEDIA";

  public static final String SERIALIZED_NAME_ALTERNATE_TEXT = "alternate_text";
  ...
  public static final String SERIALIZED_NAME_INTEGRITY_CHECK_ALGORITHM = "integrity_check_algorithm";
  @SerializedName(SERIALIZED_NAME_INTEGRITY_CHECK_ALGORITHM)
  ...
  * @throws IOException if the JSON Object is invalid with respect to DvMultimedia
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DvMultimedia.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DvMultimedia is not found in the empty JSON string", DvMultimedia.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DvMultimedia.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DvMultimedia` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DvMultimedia.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DvMultimedia.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DvMultimedia' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DvMultimedia> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DvMultimedia.class));

       return (TypeAdapter<T>) new TypeAdapter<DvMultimedia>() {
           @Override
           public void write(JsonWriter out, DvMultimedia value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DvMultimedia read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DvMultimedia given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DvMultimedia
  * @throws IOException if the JSON string is invalid with respect to DvMultimedia
  */
  public static DvMultimedia fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DvMultimedia.class);
  }

 /**
  * Convert an instance of DvMultimedia to an JSON string
  *
  * @return JSON string
  */
