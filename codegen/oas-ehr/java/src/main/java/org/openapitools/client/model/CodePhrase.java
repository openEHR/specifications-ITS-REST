...
import org.openapitools.client.model.TerminologyId;
...
public class CodePhrase {
  public static final String SERIALIZED_NAME_TERMINOLOGY_ID = "terminology_id";
  @SerializedName(SERIALIZED_NAME_TERMINOLOGY_ID)
  private TerminologyId terminologyId;

  public static final String SERIALIZED_NAME_CODE_STRING = "code_string";
  @SerializedName(SERIALIZED_NAME_CODE_STRING)
  private String codeString;

  public static final String SERIALIZED_NAME_PREFERRED_TERM = "preferred_term";
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("terminology_id");
    openapiFields.add("code_string");
    openapiFields.add("preferred_term");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("terminology_id");
    openapiRequiredFields.add("code_string");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CodePhrase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CodePhrase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CodePhrase is not found in the empty JSON string", CodePhrase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CodePhrase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CodePhrase` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CodePhrase.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `terminology_id`
      TerminologyId.validateJsonObject(jsonObj.getAsJsonObject("terminology_id"));
      if (!jsonObj.get("code_string").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `code_string` to be a primitive type in the JSON string but got `%s`", jsonObj.get("code_string").toString()));
      }
      if ((jsonObj.get("preferred_term") != null && !jsonObj.get("preferred_term").isJsonNull()) && !jsonObj.get("preferred_term").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `preferred_term` to be a primitive type in the JSON string but got `%s`", jsonObj.get("preferred_term").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CodePhrase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CodePhrase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CodePhrase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CodePhrase.class));

       return (TypeAdapter<T>) new TypeAdapter<CodePhrase>() {
           @Override
           public void write(JsonWriter out, CodePhrase value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CodePhrase read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CodePhrase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CodePhrase
  * @throws IOException if the JSON string is invalid with respect to CodePhrase
  */
  public static CodePhrase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CodePhrase.class);
  }

 /**
  * Convert an instance of CodePhrase to an JSON string
  *
  * @return JSON string
  */
