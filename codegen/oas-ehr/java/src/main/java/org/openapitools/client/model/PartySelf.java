...
import org.openapitools.client.model.PartySelf;
...
public class PartySelf extends PartyProxy {
  ...
  protected String type = "PARTY_SELF";
  ...
  * @throws IOException if the JSON Object is invalid with respect to PartySelf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PartySelf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PartySelf is not found in the empty JSON string", PartySelf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PartySelf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PartySelf` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PartySelf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PartySelf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PartySelf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PartySelf.class));

       return (TypeAdapter<T>) new TypeAdapter<PartySelf>() {
           @Override
           public void write(JsonWriter out, PartySelf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PartySelf read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PartySelf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PartySelf
  * @throws IOException if the JSON string is invalid with respect to PartySelf
  */
  public static PartySelf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PartySelf.class);
  }

 /**
  * Convert an instance of PartySelf to an JSON string
  *
  * @return JSON string
  */
