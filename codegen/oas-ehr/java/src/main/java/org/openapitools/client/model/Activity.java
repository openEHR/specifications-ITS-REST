...
public class Activity extends Locatable {
  ...
  public static final String SERIALIZED_NAME_ACTION_ARCHETYPE_ID = "action_archetype_id";
  @SerializedName(SERIALIZED_NAME_ACTION_ARCHETYPE_ID)
  ...
  **/
  ...
  static {
    ...
    openapiRequiredFields.add("action_archetype_id");
