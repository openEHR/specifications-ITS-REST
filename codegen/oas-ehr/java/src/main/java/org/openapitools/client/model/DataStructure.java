...
public class DataStructure extends Locatable {
 ...
 /**
  * Create an instance of DataStructure given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DataStructure
  * @throws IOException if the JSON string is invalid with respect to DataStructure
  */
  public static DataStructure fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DataStructure.class);
  }

 /**
  * Convert an instance of DataStructure to an JSON string
  *
  * @return JSON string
  */
