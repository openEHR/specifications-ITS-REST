...
public class Action extends CareEntry {
  ...
  public static final String SERIALIZED_NAME_ISM_TRANSITION = "ism_transition";
  @SerializedName(SERIALIZED_NAME_ISM_TRANSITION)
  private IsmTransition ismTransition;

  public static final String SERIALIZED_NAME_INSTRUCTION_DETAILS = "instruction_details";
  @SerializedName(SERIALIZED_NAME_INSTRUCTION_DETAILS)
  ...
  **/
  ...
  static {
    ...
    openapiRequiredFields.add("ism_transition");
