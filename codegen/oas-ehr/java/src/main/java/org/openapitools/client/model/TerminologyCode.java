...
public class TerminologyCode {
  ...
  public static final String SERIALIZED_NAME_TERMINOLOGY_VERSION = "terminology_version";
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("terminology_version");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if ((jsonObj.get("terminology_version") != null && !jsonObj.get("terminology_version").isJsonNull()) && !jsonObj.get("terminology_version").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `terminology_version` to be a primitive type in the JSON string but got `%s`", jsonObj.get("terminology_version").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TerminologyCode.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TerminologyCode' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TerminologyCode> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TerminologyCode.class));

       return (TypeAdapter<T>) new TypeAdapter<TerminologyCode>() {
           @Override
           public void write(JsonWriter out, TerminologyCode value) throws IOException {
 ...
 /**
  * Create an instance of TerminologyCode given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TerminologyCode
  * @throws IOException if the JSON string is invalid with respect to TerminologyCode
  */
  public static TerminologyCode fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TerminologyCode.class);
  }

 /**
  * Convert an instance of TerminologyCode to an JSON string
  *
  * @return JSON string
  */
