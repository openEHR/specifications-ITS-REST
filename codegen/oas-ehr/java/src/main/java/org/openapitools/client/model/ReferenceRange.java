...
public class ReferenceRange {
  ...
  **/
  ...
  static {
    ...
    openapiRequiredFields.add("meaning");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReferenceRange
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReferenceRange.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReferenceRange is not found in the empty JSON string", ReferenceRange.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ReferenceRange.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReferenceRange` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReferenceRange.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `meaning`
      DvText.validateJsonObject(jsonObj.getAsJsonObject("meaning"));
      // validate the required field `range`
      DvInterval.validateJsonObject(jsonObj.getAsJsonObject("range"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReferenceRange.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReferenceRange' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReferenceRange> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReferenceRange.class));

       return (TypeAdapter<T>) new TypeAdapter<ReferenceRange>() {
           @Override
           public void write(JsonWriter out, ReferenceRange value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReferenceRange read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ReferenceRange given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReferenceRange
  * @throws IOException if the JSON string is invalid with respect to ReferenceRange
  */
  public static ReferenceRange fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReferenceRange.class);
  }

 /**
  * Convert an instance of ReferenceRange to an JSON string
  *
  * @return JSON string
  */
