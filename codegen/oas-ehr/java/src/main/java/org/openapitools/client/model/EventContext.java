...
public class EventContext extends Pathable {
  ...
  public static final String SERIALIZED_NAME_OTHER_CONTEXT = "other_context";
  @SerializedName(SERIALIZED_NAME_OTHER_CONTEXT)
  private ItemStructure otherContext;

  public static final String SERIALIZED_NAME_HEALTH_CARE_FACILITY = "health_care_facility";
  @SerializedName(SERIALIZED_NAME_HEALTH_CARE_FACILITY)
  private PartyIdentified healthCareFacility;

  public static final String SERIALIZED_NAME_PARTICIPATIONS = "participations";
  @SerializedName(SERIALIZED_NAME_PARTICIPATIONS)
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventContext.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventContext' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventContext> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventContext.class));

       return (TypeAdapter<T>) new TypeAdapter<EventContext>() {
           @Override
           public void write(JsonWriter out, EventContext value) throws IOException {
 ...
 /**
  * Create an instance of EventContext given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EventContext
  * @throws IOException if the JSON string is invalid with respect to EventContext
  */
  public static EventContext fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventContext.class);
  }

 /**
  * Convert an instance of EventContext to an JSON string
  *
  * @return JSON string
  */
