...
public class Locatable extends Pathable {
  ...
  public static final String SERIALIZED_NAME_ARCHETYPE_NODE_ID = "archetype_node_id";
  @SerializedName(SERIALIZED_NAME_ARCHETYPE_NODE_ID)
  ...
  public static final String SERIALIZED_NAME_ARCHETYPE_DETAILS = "archetype_details";
  @SerializedName(SERIALIZED_NAME_ARCHETYPE_DETAILS)
  private Archetyped archetypeDetails;

  public static final String SERIALIZED_NAME_FEEDER_AUDIT = "feeder_audit";
  @SerializedName(SERIALIZED_NAME_FEEDER_AUDIT)
  ...
  **/
  ...
  static {
    ...
    openapiRequiredFields.add("archetype_node_id");
  }
 ...
 /**
  * Create an instance of Locatable given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Locatable
  * @throws IOException if the JSON string is invalid with respect to Locatable
  */
  public static Locatable fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Locatable.class);
  }

 /**
  * Convert an instance of Locatable to an JSON string
  *
  * @return JSON string
  */
