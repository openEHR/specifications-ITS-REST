...
public class DvOrdered extends DataValue {
  ...
  protected String type = "DV_ORDERED";

  public static final String SERIALIZED_NAME_NORMAL_STATUS = "normal_status";
  @SerializedName(SERIALIZED_NAME_NORMAL_STATUS)
  ...
  public static final String SERIALIZED_NAME_OTHER_REFERENCE_RANGES = "other_reference_ranges";
  @SerializedName(SERIALIZED_NAME_OTHER_REFERENCE_RANGES)
 ...
 /**
  * Create an instance of DvOrdered given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DvOrdered
  * @throws IOException if the JSON string is invalid with respect to DvOrdered
  */
  public static DvOrdered fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DvOrdered.class);
  }

 /**
  * Convert an instance of DvOrdered to an JSON string
  *
  * @return JSON string
  */
