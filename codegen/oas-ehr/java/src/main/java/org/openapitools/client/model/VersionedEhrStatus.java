...
public class VersionedEhrStatus extends VersionedObject {
  ...
  protected String type = "VERSIONED_EHR_STATUS";
  ...
  * @throws IOException if the JSON Object is invalid with respect to VersionedEhrStatus
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VersionedEhrStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VersionedEhrStatus is not found in the empty JSON string", VersionedEhrStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!VersionedEhrStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VersionedEhrStatus` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VersionedEhrStatus.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VersionedEhrStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VersionedEhrStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VersionedEhrStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VersionedEhrStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<VersionedEhrStatus>() {
           @Override
           public void write(JsonWriter out, VersionedEhrStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VersionedEhrStatus read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of VersionedEhrStatus given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VersionedEhrStatus
  * @throws IOException if the JSON string is invalid with respect to VersionedEhrStatus
  */
  public static VersionedEhrStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VersionedEhrStatus.class);
  }

 /**
  * Convert an instance of VersionedEhrStatus to an JSON string
  *
  * @return JSON string
  */
