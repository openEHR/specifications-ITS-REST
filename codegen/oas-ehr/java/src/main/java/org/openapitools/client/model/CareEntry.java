...
public class CareEntry extends AbstractEntry {
  ...
  public static final String SERIALIZED_NAME_GUIDELINE_ID = "guideline_id";
 ...
 /**
  * Create an instance of CareEntry given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CareEntry
  * @throws IOException if the JSON string is invalid with respect to CareEntry
  */
  public static CareEntry fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CareEntry.class);
  }

 /**
  * Convert an instance of CareEntry to an JSON string
  *
  * @return JSON string
  */
