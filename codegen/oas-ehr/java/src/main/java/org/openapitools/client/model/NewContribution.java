...
import org.openapitools.client.model.UpdateVersion;
...
public class NewContribution {
  ...
  **/
  ...
  static {
    ...
    openapiRequiredFields.add("audit");
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewContribution.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewContribution' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewContribution> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewContribution.class));

       return (TypeAdapter<T>) new TypeAdapter<NewContribution>() {
           @Override
           public void write(JsonWriter out, NewContribution value) throws IOException {
 ...
 /**
  * Create an instance of NewContribution given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NewContribution
  * @throws IOException if the JSON string is invalid with respect to NewContribution
  */
  public static NewContribution fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewContribution.class);
  }

 /**
  * Convert an instance of NewContribution to an JSON string
  *
  * @return JSON string
  */
