...
public class VersionedObject {
 ...
 /**
  * Create an instance of VersionedObject given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VersionedObject
  * @throws IOException if the JSON string is invalid with respect to VersionedObject
  */
  public static VersionedObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VersionedObject.class);
  }

 /**
  * Convert an instance of VersionedObject to an JSON string
  *
  * @return JSON string
  */
