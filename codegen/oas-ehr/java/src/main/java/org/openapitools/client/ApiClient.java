...
public class ApiClient {
    ...
    private String basePath = "https://openEHRSys.example.com/v1";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://{baseUrl}/v1",
      "An example openEHR server URL.",
      new HashMap<String, ServerVariable>() {{
        put("baseUrl", new ServerVariable(
          "The (example) server base URL prefix providing openEHR services. This may contain server name, port and base path prefix.",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://openEHRSys.example.com/v1
