...
public class RevisionHistoryItem {
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RevisionHistoryItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RevisionHistoryItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RevisionHistoryItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RevisionHistoryItem.class));

       return (TypeAdapter<T>) new TypeAdapter<RevisionHistoryItem>() {
           @Override
           public void write(JsonWriter out, RevisionHistoryItem value) throws IOException {
 ...
 /**
  * Create an instance of RevisionHistoryItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RevisionHistoryItem
  * @throws IOException if the JSON string is invalid with respect to RevisionHistoryItem
  */
  public static RevisionHistoryItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RevisionHistoryItem.class);
  }

 /**
  * Convert an instance of RevisionHistoryItem to an JSON string
  *
  * @return JSON string
  */
