...
public class DvAmount extends DvQuantified {
  ...
  protected String type = "DV_AMOUNT";

  public static final String SERIALIZED_NAME_ACCURACY_IS_PERCENT = "accuracy_is_percent";
  @SerializedName(SERIALIZED_NAME_ACCURACY_IS_PERCENT)
  ...
  * @throws IOException if the JSON Object is invalid with respect to DvAmount
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DvAmount.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DvAmount is not found in the empty JSON string", DvAmount.openapiRequiredFields.toString()));
        }
      }
 ...
 /**
  * Create an instance of DvAmount given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DvAmount
  * @throws IOException if the JSON string is invalid with respect to DvAmount
  */
  public static DvAmount fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DvAmount.class);
  }

 /**
  * Convert an instance of DvAmount to an JSON string
  *
  * @return JSON string
  */
