...
public class DvAmount extends DvQuantified {
  ...
  * @throws IOException if the JSON Element is invalid with respect to DvAmount
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DvAmount.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
