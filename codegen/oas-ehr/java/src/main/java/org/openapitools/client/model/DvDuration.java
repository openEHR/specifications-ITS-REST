...
public class DvDuration extends DvAmount {
  ...
  protected String type = "DV_DURATION";
  ...
  * @throws IOException if the JSON Object is invalid with respect to DvDuration
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DvDuration.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DvDuration is not found in the empty JSON string", DvDuration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DvDuration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DvDuration` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DvDuration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DvDuration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DvDuration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DvDuration.class));

       return (TypeAdapter<T>) new TypeAdapter<DvDuration>() {
           @Override
           public void write(JsonWriter out, DvDuration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DvDuration read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DvDuration given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DvDuration
  * @throws IOException if the JSON string is invalid with respect to DvDuration
  */
  public static DvDuration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DvDuration.class);
  }

 /**
  * Convert an instance of DvDuration to an JSON string
  *
  * @return JSON string
  */
