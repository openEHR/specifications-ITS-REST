...
public class UpdateAudit {
  ...
  protected String type = "UPDATE_AUDIT";
 ...
 /**
  * Create an instance of UpdateAudit given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateAudit
  * @throws IOException if the JSON string is invalid with respect to UpdateAudit
  */
  public static UpdateAudit fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateAudit.class);
  }

 /**
  * Convert an instance of UpdateAudit to an JSON string
  *
  * @return JSON string
  */
