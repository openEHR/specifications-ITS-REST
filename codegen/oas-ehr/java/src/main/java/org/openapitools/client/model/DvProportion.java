...
public class DvProportion extends DvAmount {
  ...
  protected String type = "DV_PROPORTION";
  ...
  **/
  ...
  static {
    ...
    openapiRequiredFields.add("numerator");
    openapiRequiredFields.add("denominator");
    openapiRequiredFields.add("semantic_type");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DvProportion
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DvProportion.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DvProportion is not found in the empty JSON string", DvProportion.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DvProportion.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DvProportion` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DvProportion.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DvProportion.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DvProportion' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DvProportion> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DvProportion.class));

       return (TypeAdapter<T>) new TypeAdapter<DvProportion>() {
           @Override
           public void write(JsonWriter out, DvProportion value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DvProportion read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DvProportion given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DvProportion
  * @throws IOException if the JSON string is invalid with respect to DvProportion
  */
  public static DvProportion fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DvProportion.class);
  }

 /**
  * Convert an instance of DvProportion to an JSON string
  *
  * @return JSON string
  */
