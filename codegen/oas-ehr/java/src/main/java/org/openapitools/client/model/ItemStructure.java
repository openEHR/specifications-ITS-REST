...
public class ItemStructure extends DataStructure {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ItemStructure
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ItemStructure.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ItemStructure is not found in the empty JSON string", ItemStructure.openapiRequiredFields.toString()));
        }
      }
 ...
 /**
  * Create an instance of ItemStructure given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ItemStructure
  * @throws IOException if the JSON string is invalid with respect to ItemStructure
  */
  public static ItemStructure fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ItemStructure.class);
  }

 /**
  * Convert an instance of ItemStructure to an JSON string
  *
  * @return JSON string
  */
