...
public class ItemStructure extends DataStructure {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ItemStructure
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ItemStructure.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
