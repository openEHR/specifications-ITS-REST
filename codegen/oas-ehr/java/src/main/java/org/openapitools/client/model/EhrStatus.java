...
public class EhrStatus extends Versionable {
  ...
  protected String type = "EHR_STATUS";

  public static final String SERIALIZED_NAME_SUBJECT = "subject";
  @SerializedName(SERIALIZED_NAME_SUBJECT)
  private PartyProxy subject;

  public static final String SERIALIZED_NAME_IS_QUERYABLE = "is_queryable";
  @SerializedName(SERIALIZED_NAME_IS_QUERYABLE)
  private Boolean isQueryable = true;

  public static final String SERIALIZED_NAME_IS_MODIFIABLE = "is_modifiable";
  @SerializedName(SERIALIZED_NAME_IS_MODIFIABLE)
  private Boolean isModifiable = true;

  public static final String SERIALIZED_NAME_OTHER_DETAILS = "other_details";
  @SerializedName(SERIALIZED_NAME_OTHER_DETAILS)
  ...
  **/
  ...
  static {
    ...
    openapiRequiredFields.add("is_queryable");
    openapiRequiredFields.add("is_modifiable");
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EhrStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EhrStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EhrStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EhrStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<EhrStatus>() {
           @Override
           public void write(JsonWriter out, EhrStatus value) throws IOException {
 ...
 /**
  * Create an instance of EhrStatus given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EhrStatus
  * @throws IOException if the JSON string is invalid with respect to EhrStatus
  */
  public static EhrStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EhrStatus.class);
  }

 /**
  * Convert an instance of EhrStatus to an JSON string
  *
  * @return JSON string
  */
