...
public class DvIntervalOfDateTime extends DvInterval {
  ...
  protected String type = "DV_INTERVAL";
  ...
  * @throws IOException if the JSON Object is invalid with respect to DvIntervalOfDateTime
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DvIntervalOfDateTime.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DvIntervalOfDateTime is not found in the empty JSON string", DvIntervalOfDateTime.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DvIntervalOfDateTime.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DvIntervalOfDateTime` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DvIntervalOfDateTime.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DvIntervalOfDateTime' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DvIntervalOfDateTime> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DvIntervalOfDateTime.class));

       return (TypeAdapter<T>) new TypeAdapter<DvIntervalOfDateTime>() {
           @Override
           public void write(JsonWriter out, DvIntervalOfDateTime value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DvIntervalOfDateTime read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DvIntervalOfDateTime given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DvIntervalOfDateTime
  * @throws IOException if the JSON string is invalid with respect to DvIntervalOfDateTime
  */
  public static DvIntervalOfDateTime fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DvIntervalOfDateTime.class);
  }

 /**
  * Convert an instance of DvIntervalOfDateTime to an JSON string
  *
  * @return JSON string
  */
