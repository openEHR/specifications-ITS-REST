...
public class OriginalVersion extends Version {
  ...
  protected String type = "ORIGINAL_VERSION";
  ...
  public static final String SERIALIZED_NAME_OTHER_INPUT_VERSION_UIDS = "other_input_version_uids";
  @SerializedName(SERIALIZED_NAME_OTHER_INPUT_VERSION_UIDS)
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OriginalVersion.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OriginalVersion' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OriginalVersion> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OriginalVersion.class));

       return (TypeAdapter<T>) new TypeAdapter<OriginalVersion>() {
           @Override
           public void write(JsonWriter out, OriginalVersion value) throws IOException {
 ...
 /**
  * Create an instance of OriginalVersion given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OriginalVersion
  * @throws IOException if the JSON string is invalid with respect to OriginalVersion
  */
  public static OriginalVersion fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OriginalVersion.class);
  }

 /**
  * Convert an instance of OriginalVersion to an JSON string
  *
  * @return JSON string
  */
