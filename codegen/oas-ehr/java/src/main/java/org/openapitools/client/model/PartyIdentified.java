...
public class PartyIdentified extends PartyProxy {
  ...
  protected String type = "PARTY_IDENTIFIED";
 ...
 /**
  * Create an instance of PartyIdentified given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PartyIdentified
  * @throws IOException if the JSON string is invalid with respect to PartyIdentified
  */
  public static PartyIdentified fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PartyIdentified.class);
  }

 /**
  * Convert an instance of PartyIdentified to an JSON string
  *
  * @return JSON string
  */
