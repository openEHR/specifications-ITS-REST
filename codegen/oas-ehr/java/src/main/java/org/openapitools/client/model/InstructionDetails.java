...
import org.openapitools.client.model.LocatableRef;
import org.openapitools.client.model.Pathable;
...
public class InstructionDetails extends Pathable {
  ...
  protected String type = "INSTRUCTION_DETAILS";
  ...
  public static final String SERIALIZED_NAME_WF_DETAILS = "wf_details";
  @SerializedName(SERIALIZED_NAME_WF_DETAILS)
  ...
  **/
  ...
  static {
    ...
    openapiRequiredFields.add("instruction_id");
  ...
  * @throws IOException if the JSON Element is invalid with respect to InstructionDetails
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InstructionDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InstructionDetails is not found in the empty JSON string", InstructionDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InstructionDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InstructionDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InstructionDetails.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InstructionDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InstructionDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InstructionDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InstructionDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<InstructionDetails>() {
           @Override
           public void write(JsonWriter out, InstructionDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InstructionDetails read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of InstructionDetails given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InstructionDetails
  * @throws IOException if the JSON string is invalid with respect to InstructionDetails
  */
  public static InstructionDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InstructionDetails.class);
  }

 /**
  * Convert an instance of InstructionDetails to an JSON string
  *
  * @return JSON string
  */
