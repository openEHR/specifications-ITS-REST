...
import org.openapitools.client.model.UpdateAttestation;
...
public class UpdateAttestation extends UpdateAudit {
  ...
  protected String type = "UPDATE_ATTESTATION";

  public static final String SERIALIZED_NAME_ATTESTED_VIEW = "attested_view";
  @SerializedName(SERIALIZED_NAME_ATTESTED_VIEW)
  ...
  **/
  ...
  static {
    ...
    openapiRequiredFields.add("is_pending");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateAttestation
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateAttestation.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateAttestation is not found in the empty JSON string", UpdateAttestation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpdateAttestation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateAttestation` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateAttestation.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateAttestation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateAttestation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateAttestation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateAttestation.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateAttestation>() {
           @Override
           public void write(JsonWriter out, UpdateAttestation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateAttestation read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UpdateAttestation given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateAttestation
  * @throws IOException if the JSON string is invalid with respect to UpdateAttestation
  */
  public static UpdateAttestation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateAttestation.class);
  }

 /**
  * Convert an instance of UpdateAttestation to an JSON string
  *
  * @return JSON string
  */
