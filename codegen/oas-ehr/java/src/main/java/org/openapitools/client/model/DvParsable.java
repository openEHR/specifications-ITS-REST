...
public class DvParsable extends DvEncapsulated {
  ...
  protected String type = "DV_PARSABLE";

  public static final String SERIALIZED_NAME_VALUE = "value";
  @SerializedName(SERIALIZED_NAME_VALUE)
  private String value;

  public static final String SERIALIZED_NAME_FORMALISM = "formalism";
  @SerializedName(SERIALIZED_NAME_FORMALISM)
  ...
  **/
  ...
  static {
    ...
    openapiRequiredFields.add("formalism");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DvParsable
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DvParsable.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DvParsable is not found in the empty JSON string", DvParsable.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DvParsable.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DvParsable` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DvParsable.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DvParsable.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DvParsable' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DvParsable> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DvParsable.class));

       return (TypeAdapter<T>) new TypeAdapter<DvParsable>() {
           @Override
           public void write(JsonWriter out, DvParsable value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DvParsable read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DvParsable given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DvParsable
  * @throws IOException if the JSON string is invalid with respect to DvParsable
  */
  public static DvParsable fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DvParsable.class);
  }

 /**
  * Convert an instance of DvParsable to an JSON string
  *
  * @return JSON string
  */
