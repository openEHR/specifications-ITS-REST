...
public class Composition extends Versionable {
  ...
  protected String type = "COMPOSITION";
  ...
  **/
  ...
  static {
    ...
    openapiRequiredFields.add("composer");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Composition
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Composition.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Composition is not found in the empty JSON string", Composition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Composition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Composition` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
