...
import org.openapitools.client.model.Clstr;
import org.openapitools.client.model.ItemList;
import org.openapitools.client.model.ItemSingle;
import org.openapitools.client.model.ItemStructure;
import org.openapitools.client.model.ItemTable;
import org.openapitools.client.model.ItemTree;
...
public class ItemTable extends ItemStructure {
  ...
  protected String type = "ITEM_TABLE";
  ...
  * @throws IOException if the JSON Object is invalid with respect to ItemTable
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ItemTable.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ItemTable is not found in the empty JSON string", ItemTable.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ItemTable.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ItemTable` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ItemTable.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ItemTable' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ItemTable> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ItemTable.class));

       return (TypeAdapter<T>) new TypeAdapter<ItemTable>() {
           @Override
           public void write(JsonWriter out, ItemTable value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ItemTable read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ItemTable given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ItemTable
  * @throws IOException if the JSON string is invalid with respect to ItemTable
  */
  public static ItemTable fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ItemTable.class);
  }

 /**
  * Convert an instance of ItemTable to an JSON string
  *
  * @return JSON string
  */
