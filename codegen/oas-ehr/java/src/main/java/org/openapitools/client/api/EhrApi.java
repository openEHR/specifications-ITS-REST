...
import org.openapitools.client.model.Ehr;
...
public class EhrApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 201 </td><td> &#x60;201 Created&#x60; is returned when the EHR has been successfully created.  The new EHR resource is returned in the body when the request&#39;s &#x60;Prefer&#x60; header value is &#x60;return&#x3D;representation&#x60;, otherwise only headers are returned.  </td><td>  * ETag -  <br>  * Location -  <br>  </td></tr>
        ...
        <tr><td> 409 </td><td> &#x60;409 Conflict&#x60; Unable to create a new EHR due to a conflict with an already existing EHR with the same subject id, namespace pair, whenever EHR_STATUS is supplied.  </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call ehrCreateCall(String prefer, EhrStatus ehrStatus, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call ehrCreateValidateBeforeCall(String prefer, EhrStatus ehrStatus, final ApiCallback _callback) throws ApiException {
        return ehrCreateCall(prefer, ehrStatus, _callback);
     ...
     */
    public Ehr ehrCreate(String prefer, EhrStatus ehrStatus) throws ApiException {
        ApiResponse<Ehr> localVarResp = ehrCreateWithHttpInfo(prefer, ehrStatus);
     ...
     */
    public ApiResponse<Ehr> ehrCreateWithHttpInfo(String prefer, EhrStatus ehrStatus) throws ApiException {
        okhttp3.Call localVarCall = ehrCreateValidateBeforeCall(prefer, ehrStatus, null);
     ...
     */
    public okhttp3.Call ehrCreateAsync(String prefer, EhrStatus ehrStatus, final ApiCallback<Ehr> _callback) throws ApiException {

        okhttp3.Call localVarCall = ehrCreateValidateBeforeCall(prefer, ehrStatus, _callback);
        Type localVarReturnType = new TypeToken<Ehr>(){}.getType();
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 201 </td><td> &#x60;201 Created&#x60; is returned when the EHR has been successfully created.  The new EHR resource is returned in the body when the request&#39;s &#x60;Prefer&#x60; header value is &#x60;return&#x3D;representation&#x60;, otherwise only headers are returned.  </td><td>  * ETag -  <br>  * Location -  <br>  </td></tr>
        <tr><td> 400 </td><td> &#x60;400 Bad Request&#x60; is returned when the request URL or body (if provided) could not be parsed or has invalid content.  </td><td>  -  </td></tr>
        <tr><td> 409 </td><td> &#x60;409 Conflict&#x60; Unable to create a new EHR due to a conflict with an already existing EHR.  Can happen when the supplied &#x60;ehr_id&#x60; is already used by an existing EHR.  </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call ehrCreateWithIdCall(String ehrId, String prefer, EhrStatus ehrStatus, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call ehrCreateWithIdValidateBeforeCall(String ehrId, String prefer, EhrStatus ehrStatus, final ApiCallback _callback) throws ApiException {
        ...
        return ehrCreateWithIdCall(ehrId, prefer, ehrStatus, _callback);
     ...
     */
    public Ehr ehrCreateWithId(String ehrId, String prefer, EhrStatus ehrStatus) throws ApiException {
        ApiResponse<Ehr> localVarResp = ehrCreateWithIdWithHttpInfo(ehrId, prefer, ehrStatus);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Ehr> ehrCreateWithIdWithHttpInfo(String ehrId, String prefer, EhrStatus ehrStatus) throws ApiException {
        okhttp3.Call localVarCall = ehrCreateWithIdValidateBeforeCall(ehrId, prefer, ehrStatus, null);
        Type localVarReturnType = new TypeToken<Ehr>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call ehrCreateWithIdAsync(String ehrId, String prefer, EhrStatus ehrStatus, final ApiCallback<Ehr> _callback) throws ApiException {

        okhttp3.Call localVarCall = ehrCreateWithIdValidateBeforeCall(ehrId, prefer, ehrStatus, _callback);
        Type localVarReturnType = new TypeToken<Ehr>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> &#x60;200 OK&#x60; is returned when the requested EHR resource is successfully retrieved.  </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> &#x60;404 Not Found&#x60; is returned when an EHR with &#x60;ehr_id&#x60; does not exist.  </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call ehrGetByIdCall(String ehrId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call ehrGetByIdValidateBeforeCall(String ehrId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'ehrId' is set
        if (ehrId == null) {
            throw new ApiException("Missing the required parameter 'ehrId' when calling ehrGetById(Async)");
        }

        return ehrGetByIdCall(ehrId, _callback);
    ...
    public Ehr ehrGetById(String ehrId) throws ApiException {
        ApiResponse<Ehr> localVarResp = ehrGetByIdWithHttpInfo(ehrId);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<Ehr> ehrGetByIdWithHttpInfo(String ehrId) throws ApiException {
        okhttp3.Call localVarCall = ehrGetByIdValidateBeforeCall(ehrId, null);
        Type localVarReturnType = new TypeToken<Ehr>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call ehrGetByIdAsync(String ehrId, final ApiCallback<Ehr> _callback) throws ApiException {

        okhttp3.Call localVarCall = ehrGetByIdValidateBeforeCall(ehrId, _callback);
        Type localVarReturnType = new TypeToken<Ehr>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> &#x60;200 OK&#x60; is returned when the requested EHR resource is successfully retrieved.  </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> &#x60;404 Not Found&#x60; is returned when an EHR with supplied subject parameters does not exist.  </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call ehrGetBySubjectCall(String subjectId, String subjectNamespace, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        if (subjectNamespace != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("subject_namespace", subjectNamespace));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call ehrGetBySubjectValidateBeforeCall(String subjectId, String subjectNamespace, final ApiCallback _callback) throws ApiException {
        ...
        return ehrGetBySubjectCall(subjectId, subjectNamespace, _callback);
    ...
    public Ehr ehrGetBySubject(String subjectId, String subjectNamespace) throws ApiException {
        ApiResponse<Ehr> localVarResp = ehrGetBySubjectWithHttpInfo(subjectId, subjectNamespace);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<Ehr> ehrGetBySubjectWithHttpInfo(String subjectId, String subjectNamespace) throws ApiException {
        okhttp3.Call localVarCall = ehrGetBySubjectValidateBeforeCall(subjectId, subjectNamespace, null);
        Type localVarReturnType = new TypeToken<Ehr>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call ehrGetBySubjectAsync(String subjectId, String subjectNamespace, final ApiCallback<Ehr> _callback) throws ApiException {

        okhttp3.Call localVarCall = ehrGetBySubjectValidateBeforeCall(subjectId, subjectNamespace, _callback);
        Type localVarReturnType = new TypeToken<Ehr>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
