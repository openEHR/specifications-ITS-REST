...
import org.openapitools.client.model.DvBoolean;
import org.openapitools.client.model.DvCodedText;
import org.openapitools.client.model.DvCount;
import org.openapitools.client.model.DvDateTime;
import org.openapitools.client.model.DvDuration;
import org.openapitools.client.model.DvEhrUri;
import org.openapitools.client.model.DvIdentifier;
import org.openapitools.client.model.DvInterval;
import org.openapitools.client.model.DvIntervalOfDateTime;
import org.openapitools.client.model.DvMultimedia;
import org.openapitools.client.model.DvOrdered;
import org.openapitools.client.model.DvOrdinal;
import org.openapitools.client.model.DvParsable;
import org.openapitools.client.model.DvProportion;
import org.openapitools.client.model.DvQuantity;
import org.openapitools.client.model.DvScale;
import org.openapitools.client.model.DvText;
import org.openapitools.client.model.DvUri;
...
public class DvOrdinal extends DvOrdered {
  ...
  protected String type = "DV_ORDINAL";
  ...
  * @throws IOException if the JSON Object is invalid with respect to DvOrdinal
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DvOrdinal.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DvOrdinal is not found in the empty JSON string", DvOrdinal.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DvOrdinal.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DvOrdinal` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DvOrdinal.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DvOrdinal.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DvOrdinal' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DvOrdinal> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DvOrdinal.class));

       return (TypeAdapter<T>) new TypeAdapter<DvOrdinal>() {
           @Override
           public void write(JsonWriter out, DvOrdinal value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DvOrdinal read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DvOrdinal given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DvOrdinal
  * @throws IOException if the JSON string is invalid with respect to DvOrdinal
  */
  public static DvOrdinal fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DvOrdinal.class);
  }

 /**
  * Convert an instance of DvOrdinal to an JSON string
  *
  * @return JSON string
  */
