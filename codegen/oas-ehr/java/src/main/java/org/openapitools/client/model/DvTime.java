...
public class DvTime extends DvTemporal {
  ...
  * @throws IOException if the JSON Object is invalid with respect to DvTime
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DvTime.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DvTime is not found in the empty JSON string", DvTime.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DvTime.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DvTime` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DvTime.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DvTime.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DvTime' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DvTime> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DvTime.class));

       return (TypeAdapter<T>) new TypeAdapter<DvTime>() {
           @Override
           public void write(JsonWriter out, DvTime value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DvTime read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DvTime given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DvTime
  * @throws IOException if the JSON string is invalid with respect to DvTime
  */
  public static DvTime fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DvTime.class);
  }

 /**
  * Convert an instance of DvTime to an JSON string
  *
  * @return JSON string
  */
