...
public class DvInterval extends DataValue {
  ...
  public static final String SERIALIZED_NAME_LOWER_UNBOUNDED = "lower_unbounded";
  @SerializedName(SERIALIZED_NAME_LOWER_UNBOUNDED)
  private Boolean lowerUnbounded;

  public static final String SERIALIZED_NAME_UPPER_UNBOUNDED = "upper_unbounded";
  @SerializedName(SERIALIZED_NAME_UPPER_UNBOUNDED)
  private Boolean upperUnbounded;

  public static final String SERIALIZED_NAME_LOWER_INCLUDED = "lower_included";
  @SerializedName(SERIALIZED_NAME_LOWER_INCLUDED)
  private Boolean lowerIncluded;

  public static final String SERIALIZED_NAME_UPPER_INCLUDED = "upper_included";
  @SerializedName(SERIALIZED_NAME_UPPER_INCLUDED)
  ...
  **/
  ...
  static {
    ...
    openapiRequiredFields.add("lower_unbounded");
    openapiRequiredFields.add("upper_unbounded");
    openapiRequiredFields.add("lower_included");
    openapiRequiredFields.add("upper_included");
  }
 ...
 /**
  * Create an instance of DvInterval given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DvInterval
  * @throws IOException if the JSON string is invalid with respect to DvInterval
  */
  public static DvInterval fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DvInterval.class);
  }

 /**
  * Convert an instance of DvInterval to an JSON string
  *
  * @return JSON string
  */
