...
feature --Access
    ...
    other_details: detachable ITEM_STRUCTURE
...
feature -- Change Element
    ...
    set_is_queryable (a_name: like is_queryable)
        -- Set 'is_queryable' with 'a_name'.
      do
        is_queryable := a_name
      ensure
        is_queryable_set: is_queryable = a_name
      end

    set_is_modifiable (a_name: like is_modifiable)
        -- Set 'is_modifiable' with 'a_name'.
      do
        is_modifiable := a_name
      ensure
        is_modifiable_set: is_modifiable = a_name
      end

    set_other_details (a_name: like other_details)
        -- Set 'other_details' with 'a_name'.
      do
        other_details := a_name
      ensure
        other_details_set: other_details = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        if attached is_queryable as l_is_queryable then
          Result.append ("%Nis_queryable:")
          Result.append (l_is_queryable.out)
          Result.append ("%N")
        end
        if attached is_modifiable as l_is_modifiable then
          Result.append ("%Nis_modifiable:")
          Result.append (l_is_modifiable.out)
          Result.append ("%N")
        end
        if attached other_details as l_other_details then
          Result.append ("%Nother_details:")
          Result.append (l_other_details.out)
          Result.append ("%N")
        end
      end
end
