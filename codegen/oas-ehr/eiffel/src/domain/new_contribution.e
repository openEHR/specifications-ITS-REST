...
feature --Access
    ...
    versions: detachable LIST [UPDATE_VERSION]
      
    audit: detachable UPDATE_AUDIT
...
feature -- Change Element
    ...
    set_audit (a_name: like audit)
        -- Set 'audit' with 'a_name'.
      do
        audit := a_name
      ensure
        audit_set: audit = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass NEW_CONTRIBUTION%N")
        ...
        if attached audit as l_audit then
          Result.append ("%Naudit:")
          Result.append (l_audit.out)
          Result.append ("%N")
        end
      end
end
