...
feature --Access
    ...
    defining_code: detachable CODE_PHRASE
      

feature -- Change Element

    set_defining_code (a_name: like defining_code)
        -- Set 'defining_code' with 'a_name'.
      do
        defining_code := a_name
      ensure
        defining_code_set: defining_code = a_name
      end
    ...
    output: STRING
      ...
      do
        ...
        if attached defining_code as l_defining_code then
          ...
          Result.append (l_defining_code.out)
          Result.append ("%N")
        end
      end
end
