...
feature --Access
    ...
    meaning: detachable DV_TEXT
      
    range: detachable DV_INTERVAL
      

feature -- Change Element

    set_meaning (a_name: like meaning)
        -- Set 'meaning' with 'a_name'.
      do
        meaning := a_name
      ensure
        meaning_set: meaning = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass REFERENCE_RANGE%N")
        if attached meaning as l_meaning then
          Result.append ("%Nmeaning:")
          Result.append (l_meaning.out)
          Result.append ("%N")
        end
