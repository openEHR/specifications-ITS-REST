...
feature --Access
    ...
    validation_errors: detachable LIST [STRING_32]
      -- 
...
feature -- Change Element
    ...
    set_validation_errors (a_name: like validation_errors)
        -- Set 'validation_errors' with 'a_name'.
      do
        validation_errors := a_name
      ensure
        validation_errors_set: validation_errors = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        if attached validation_errors as l_validation_errors then
          across l_validation_errors as ic loop
            Result.append ("%N validation_errors:")
