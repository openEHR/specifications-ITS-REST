...
feature --Access
    ...
    archetype_id: detachable ARCHETYPE_ID
      
    template_id: detachable TEMPLATE_ID
      
    rm_version: detachable STRING_32
      

feature -- Change Element

    set_archetype_id (a_name: like archetype_id)
        -- Set 'archetype_id' with 'a_name'.
      do
        archetype_id := a_name
      ensure
        archetype_id_set: archetype_id = a_name
      end
    ...
    set_rm_version (a_name: like rm_version)
        -- Set 'rm_version' with 'a_name'.
      do
        rm_version := a_name
      ensure
        rm_version_set: rm_version = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass ARCHETYPED%N")
        if attached archetype_id as l_archetype_id then
          Result.append ("%Narchetype_id:")
          Result.append (l_archetype_id.out)
          Result.append ("%N")
        end
        ...
        if attached rm_version as l_rm_version then
          Result.append ("%Nrm_version:")
          Result.append (l_rm_version.out)
          Result.append ("%N")
        end
      end
end
