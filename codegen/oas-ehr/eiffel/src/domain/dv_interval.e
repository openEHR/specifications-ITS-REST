...
feature -- Change Element
    ...
    set_lower_unbounded (a_name: like lower_unbounded)
        -- Set 'lower_unbounded' with 'a_name'.
      do
        lower_unbounded := a_name
      ensure
        lower_unbounded_set: lower_unbounded = a_name
      end

    set_upper_unbounded (a_name: like upper_unbounded)
        -- Set 'upper_unbounded' with 'a_name'.
      do
        upper_unbounded := a_name
      ensure
        upper_unbounded_set: upper_unbounded = a_name
      end

    set_lower_included (a_name: like lower_included)
        -- Set 'lower_included' with 'a_name'.
      do
        lower_included := a_name
      ensure
        lower_included_set: lower_included = a_name
      end

    set_upper_included (a_name: like upper_included)
        -- Set 'upper_included' with 'a_name'.
      do
        upper_included := a_name
      ensure
        upper_included_set: upper_included = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass DV_INTERVAL%N")
        if attached lower_unbounded as l_lower_unbounded then
          Result.append ("%Nlower_unbounded:")
          Result.append (l_lower_unbounded.out)
          Result.append ("%N")
        end
        if attached upper_unbounded as l_upper_unbounded then
          Result.append ("%Nupper_unbounded:")
          Result.append (l_upper_unbounded.out)
          Result.append ("%N")
        end
        if attached lower_included as l_lower_included then
          Result.append ("%Nlower_included:")
          Result.append (l_lower_included.out)
          Result.append ("%N")
        end
        if attached upper_included as l_upper_included then
          Result.append ("%Nupper_included:")
          Result.append (l_upper_included.out)
          Result.append ("%N")
        end
      end
end
