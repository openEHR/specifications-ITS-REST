...
feature -- Change Element
    ...
    set_numerator (a_name: like numerator)
        -- Set 'numerator' with 'a_name'.
      do
        numerator := a_name
      ensure
        numerator_set: numerator = a_name
      end

    set_denominator (a_name: like denominator)
        -- Set 'denominator' with 'a_name'.
      do
        denominator := a_name
      ensure
        denominator_set: denominator = a_name
      end

    set_semantic_type (a_name: like semantic_type)
        -- Set 'semantic_type' with 'a_name'.
      do
        semantic_type := a_name
      ensure
        semantic_type_set: semantic_type = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass DV_PROPORTION%N")
        if attached numerator as l_numerator then
          Result.append ("%Nnumerator:")
          Result.append (l_numerator.out)
          Result.append ("%N")
        end
        if attached denominator as l_denominator then
          Result.append ("%Ndenominator:")
          Result.append (l_denominator.out)
          Result.append ("%N")
        end
        if attached semantic_type as l_semantic_type then
          Result.append ("%Nsemantic_type:")
          Result.append (l_semantic_type.out)
          Result.append ("%N")
        end
