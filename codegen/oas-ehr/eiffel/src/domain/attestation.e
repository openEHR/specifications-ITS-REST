...
inherit
  ...
  AUDIT_DETAILS
      rename
          output as out_AuditDetails
      end

feature --Access

    attested_view: detachable DV_MULTIMEDIA
      
    proof: detachable STRING_32
      
    items: detachable LIST [DV_EHR_URI]
      
    reason: detachable DV_TEXT
...
feature -- Change Element
    ...
    set_attested_view (a_name: like attested_view)
        -- Set 'attested_view' with 'a_name'.
      do
        attested_view := a_name
      ensure
        attested_view_set: attested_view = a_name
      end

    set_proof (a_name: like proof)
        -- Set 'proof' with 'a_name'.
      do
        proof := a_name
      ensure
        proof_set: proof = a_name
      end
    ...
    set_is_pending (a_name: like is_pending)
        -- Set 'is_pending' with 'a_name'.
      do
        is_pending := a_name
      ensure
        is_pending_set: is_pending = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append(out_AuditDetails)
        Result.append("%Nclass ATTESTATION%N")
        if attached attested_view as l_attested_view then
          Result.append ("%Nattested_view:")
          Result.append (l_attested_view.out)
          Result.append ("%N")
        end
        if attached proof as l_proof then
          Result.append ("%Nproof:")
          Result.append (l_proof.out)
          Result.append ("%N")
        end
        ...
        if attached is_pending as l_is_pending then
          Result.append ("%Nis_pending:")
          Result.append (l_is_pending.out)
          Result.append ("%N")
        end
      end
end
