...
feature --Access
    ...
    value: detachable DV_CODED_TEXT
...
feature -- Change Element
    ...
    set_is_terminal (a_name: like is_terminal)
        -- Set 'is_terminal' with 'a_name'.
      do
        is_terminal := a_name
      ensure
        is_terminal_set: is_terminal = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass DV_STATE%N")
        if attached value as l_value then
          Result.append ("%Nvalue:")
          Result.append (l_value.out)
          Result.append ("%N")
        end
        if attached is_terminal as l_is_terminal then
          Result.append ("%Nis_terminal:")
          Result.append (l_is_terminal.out)
          Result.append ("%N")
        end
      end
end
