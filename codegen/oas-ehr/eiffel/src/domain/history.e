...
feature --Access
    ...
    origin: detachable DV_DATE_TIME
      
    period: detachable DV_DURATION
      
    duration: detachable DV_DURATION
      
    summary: detachable ITEM_STRUCTURE
      
    events: detachable LIST [EVENT]
