...
feature --Access
    ...
    protocol: detachable ITEM_STRUCTURE
      
    guideline_id: detachable OBJECT_REF
...
feature -- Change Element
    ...
    set_guideline_id (a_name: like guideline_id)
        -- Set 'guideline_id' with 'a_name'.
      do
        guideline_id := a_name
      ensure
        guideline_id_set: guideline_id = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        if attached guideline_id as l_guideline_id then
          Result.append ("%Nguideline_id:")
          Result.append (l_guideline_id.out)
          Result.append ("%N")
        end
      end
end
