...
feature --Access
    ...
    relationship: detachable DV_CODED_TEXT
      

feature -- Change Element

    set_relationship (a_name: like relationship)
        -- Set 'relationship' with 'a_name'.
      do
        relationship := a_name
      ensure
        relationship_set: relationship = a_name
      end
    ...
    output: STRING
      ...
      do
        ...
        if attached relationship as l_relationship then
          ...
          Result.append (l_relationship.out)
          Result.append ("%N")
        end
      end
end
