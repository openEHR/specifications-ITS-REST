...
feature --Access
    ...
    name: detachable DV_TEXT
      
    archetype_node_id: detachable STRING_32
      
    uid: detachable UID_BASED_ID
      
    links: detachable LIST [LINK]
      
    archetype_details: detachable ARCHETYPED
      
    feeder_audit: detachable FEEDER_AUDIT
...
feature -- Change Element
    ...
    set_archetype_node_id (a_name: like archetype_node_id)
        -- Set 'archetype_node_id' with 'a_name'.
      do
        archetype_node_id := a_name
      ensure
        archetype_node_id_set: archetype_node_id = a_name
      end
    ...
    set_archetype_details (a_name: like archetype_details)
        -- Set 'archetype_details' with 'a_name'.
      do
        archetype_details := a_name
      ensure
        archetype_details_set: archetype_details = a_name
      end

    set_feeder_audit (a_name: like feeder_audit)
        -- Set 'feeder_audit' with 'a_name'.
      do
        feeder_audit := a_name
      ensure
        feeder_audit_set: feeder_audit = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        if attached archetype_node_id as l_archetype_node_id then
          Result.append ("%Narchetype_node_id:")
          Result.append (l_archetype_node_id.out)
          Result.append ("%N")
        end
        ...
        if attached archetype_details as l_archetype_details then
          Result.append ("%Narchetype_details:")
          Result.append (l_archetype_details.out)
          Result.append ("%N")
        end
        if attached feeder_audit as l_feeder_audit then
          Result.append ("%Nfeeder_audit:")
          Result.append (l_feeder_audit.out)
          Result.append ("%N")
        end
      end
end
