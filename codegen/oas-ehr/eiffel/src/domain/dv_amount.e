...
feature -- Change Element
    ...
    set_accuracy_is_percent (a_name: like accuracy_is_percent)
        -- Set 'accuracy_is_percent' with 'a_name'.
      do
        accuracy_is_percent := a_name
      ensure
        accuracy_is_percent_set: accuracy_is_percent = a_name
      end
    ...
    output: STRING
      ...
      do
        ...
        if attached accuracy_is_percent as l_accuracy_is_percent then
          ...
          Result.append (l_accuracy_is_percent.out)
          Result.append ("%N")
        end
