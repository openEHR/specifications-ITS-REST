...
feature --Access
    ...
    version_id: detachable OBJECT_VERSION_ID
      
    audits: detachable LIST [AUDIT_DETAILS]
...
feature -- Change Element
    ...
    set_audits (a_name: like audits)
        -- Set 'audits' with 'a_name'.
      do
        audits := a_name
      ensure
        audits_set: audits = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass REVISION_HISTORY_ITEM%N")
        if attached version_id as l_version_id then
          Result.append ("%Nversion_id:")
          Result.append (l_version_id.out)
          Result.append ("%N")
        end
        if attached audits as l_audits then
          across l_audits as ic loop
            Result.append ("%N audits:")
