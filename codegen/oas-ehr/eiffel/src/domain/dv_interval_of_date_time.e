...
class DV_INTERVAL_OF_DATE_TIME
...
feature --Access
    ...
    lower: detachable DV_DATE_TIME
      
    upper: detachable DV_DATE_TIME
      

feature -- Change Element

    set_lower (a_name: like lower)
        -- Set 'lower' with 'a_name'.
      do
        lower := a_name
      ensure
        lower_set: lower = a_name
      end

    set_upper (a_name: like upper)
        -- Set 'upper' with 'a_name'.
      do
        upper := a_name
      ensure
        upper_set: upper = a_name
      end
    ...
    output: STRING
      ...
      do
        ...
        if attached lower as l_lower then
          ...
          Result.append (l_lower.out)
          Result.append ("%N")
        end
        if attached upper as l_upper then
          Result.append ("%Nupper:")
          Result.append (l_upper.out)
          Result.append ("%N")
        end
      end
end
