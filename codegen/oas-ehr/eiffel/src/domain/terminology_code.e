...
feature --Access
    ...
    terminology_id: detachable STRING_32
      
    terminology_version: detachable STRING_32
      
    code_string: detachable STRING_32
...
feature -- Change Element
    ...
    set_terminology_id (a_name: like terminology_id)
        -- Set 'terminology_id' with 'a_name'.
      do
        terminology_id := a_name
      ensure
        terminology_id_set: terminology_id = a_name
      end

    set_terminology_version (a_name: like terminology_version)
        -- Set 'terminology_version' with 'a_name'.
      do
        terminology_version := a_name
      ensure
        terminology_version_set: terminology_version = a_name
      end

    set_code_string (a_name: like code_string)
        -- Set 'code_string' with 'a_name'.
      do
        code_string := a_name
      ensure
        code_string_set: code_string = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass TERMINOLOGY_CODE%N")
        if attached terminology_id as l_terminology_id then
          Result.append ("%Nterminology_id:")
          Result.append (l_terminology_id.out)
          Result.append ("%N")
        end
        if attached terminology_version as l_terminology_version then
          Result.append ("%Nterminology_version:")
          Result.append (l_terminology_version.out)
          Result.append ("%N")
        end
        if attached code_string as l_code_string then
          Result.append ("%Ncode_string:")
          Result.append (l_code_string.out)
          Result.append ("%N")
        end
