...
feature --Access
    ...
    language: detachable CODE_PHRASE
      
    encoding: detachable CODE_PHRASE
      
    other_participations: detachable LIST [PARTICIPATION]
      
    workflow_id: detachable OBJECT_REF
      
    subject: detachable PARTY_PROXY
      
    provider: detachable PARTY_PROXY
...
feature -- Change Element
    ...
    set_encoding (a_name: like encoding)
        -- Set 'encoding' with 'a_name'.
      do
        encoding := a_name
      ensure
        encoding_set: encoding = a_name
      end

    set_other_participations (a_name: like other_participations)
        -- Set 'other_participations' with 'a_name'.
      do
        other_participations := a_name
      ensure
        other_participations_set: other_participations = a_name
      end

    set_workflow_id (a_name: like workflow_id)
        -- Set 'workflow_id' with 'a_name'.
      do
        workflow_id := a_name
      ensure
        workflow_id_set: workflow_id = a_name
      end
    ...
    output: STRING
      ...
      do
        ...
        if attached encoding as l_encoding then
          Result.append ("%Nencoding:")
          Result.append (l_encoding.out)
          Result.append ("%N")
        end
        if attached other_participations as l_other_participations then
          across l_other_participations as ic loop
            Result.append ("%N other_participations:")
            Result.append (ic.item.out)
            Result.append ("%N")
          end
        end
        if attached workflow_id as l_workflow_id then
          Result.append ("%Nworkflow_id:")
          Result.append (l_workflow_id.out)
          Result.append ("%N")
        end
