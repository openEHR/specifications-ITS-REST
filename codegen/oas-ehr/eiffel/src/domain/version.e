...
feature --Access
    ...
    contribution: detachable OBJECT_REF
      
    signature: detachable STRING_32
      
    commit_audit: detachable AUDIT_DETAILS
...
feature -- Change Element
    ...
    set_contribution (a_name: like contribution)
        -- Set 'contribution' with 'a_name'.
      do
        contribution := a_name
      ensure
        contribution_set: contribution = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        if attached contribution as l_contribution then
          Result.append ("%Ncontribution:")
          Result.append (l_contribution.out)
          Result.append ("%N")
        end
