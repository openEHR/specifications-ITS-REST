...
feature --Access
    ...
    lifecycle_state: detachable TERMINOLOGY_CODE
      
    attestations: detachable LIST [UPDATE_ATTESTATION]
      
    data: detachable VERSIONABLE
      
    commit_audit: detachable UPDATE_AUDIT
...
feature -- Change Element
    ...
    set_commit_audit (a_name: like commit_audit)
        -- Set 'commit_audit' with 'a_name'.
      do
        commit_audit := a_name
      ensure
        commit_audit_set: commit_audit = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass UPDATE_VERSION%N")
        ...
        if attached commit_audit as l_commit_audit then
          Result.append ("%Ncommit_audit:")
          Result.append (l_commit_audit.out)
          Result.append ("%N")
        end
      end
end
