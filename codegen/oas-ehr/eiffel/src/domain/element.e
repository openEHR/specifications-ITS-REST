...
feature --Access
    ...
    null_flavour: detachable DV_CODED_TEXT
      
    value: detachable DATA_VALUE
      
    null_reason: detachable DV_TEXT
      

feature -- Change Element

    set_null_flavour (a_name: like null_flavour)
        -- Set 'null_flavour' with 'a_name'.
      do
        null_flavour := a_name
      ensure
        null_flavour_set: null_flavour = a_name
      end
    ...
    set_null_reason (a_name: like null_reason)
        -- Set 'null_reason' with 'a_name'.
      do
        null_reason := a_name
      ensure
        null_reason_set: null_reason = a_name
      end
    ...
    output: STRING
      ...
      do
        ...
        if attached null_flavour as l_null_flavour then
          ...
          Result.append (l_null_flavour.out)
          Result.append ("%N")
        end
        ...
        if attached null_reason as l_null_reason then
          Result.append ("%Nnull_reason:")
          Result.append (l_null_reason.out)
          Result.append ("%N")
        end
      end
end
