...
feature --Access
    ...
    function: detachable DV_TEXT
      
    mode: detachable DV_CODED_TEXT
      
    performer: detachable PARTY_PROXY
      
    time: detachable DV_INTERVAL_OF_DATE_TIME
...
feature -- Change Element
    ...
    set_performer (a_name: like performer)
        -- Set 'performer' with 'a_name'.
      do
        performer := a_name
      ensure
        performer_set: performer = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        if attached performer as l_performer then
          Result.append ("%Nperformer:")
          Result.append (l_performer.out)
          Result.append ("%N")
        end
