...
feature --Access
    ...
    system_id: detachable HIER_OBJECT_ID
      
    ehr_id: detachable HIER_OBJECT_ID
      
    ehr_status: detachable OBJECT_REF
      
    ehr_access: detachable OBJECT_REF
      
    time_created: detachable DV_DATE_TIME
...
feature -- Change Element
    ...
    set_ehr_id (a_name: like ehr_id)
        -- Set 'ehr_id' with 'a_name'.
      do
        ehr_id := a_name
      ensure
        ehr_id_set: ehr_id = a_name
      end

    set_ehr_status (a_name: like ehr_status)
        -- Set 'ehr_status' with 'a_name'.
      do
        ehr_status := a_name
      ensure
        ehr_status_set: ehr_status = a_name
      end

    set_ehr_access (a_name: like ehr_access)
        -- Set 'ehr_access' with 'a_name'.
      do
        ehr_access := a_name
      ensure
        ehr_access_set: ehr_access = a_name
      end

    set_time_created (a_name: like time_created)
        -- Set 'time_created' with 'a_name'.
      do
        time_created := a_name
      ensure
        time_created_set: time_created = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass EHR%N")
        if attached system_id as l_system_id then
          Result.append ("%Nsystem_id:")
          Result.append (l_system_id.out)
          Result.append ("%N")
        end
        if attached ehr_id as l_ehr_id then
          Result.append ("%Nehr_id:")
          Result.append (l_ehr_id.out)
          Result.append ("%N")
        end
        if attached ehr_status as l_ehr_status then
          Result.append ("%Nehr_status:")
          Result.append (l_ehr_status.out)
          Result.append ("%N")
        end
        if attached ehr_access as l_ehr_access then
          Result.append ("%Nehr_access:")
          Result.append (l_ehr_access.out)
          Result.append ("%N")
        end
        if attached time_created as l_time_created then
          Result.append ("%Ntime_created:")
          Result.append (l_time_created.out)
          Result.append ("%N")
        end
      end
end
