...
feature -- Change Element
    ...
    set_assigner (a_name: like assigner)
        -- Set 'assigner' with 'a_name'.
      do
        assigner := a_name
      ensure
        assigner_set: assigner = a_name
      end
    ...
    output: STRING
      ...
      do
        ...
        if attached assigner as l_assigner then
          Result.append ("%Nassigner:")
          Result.append (l_assigner.out)
          Result.append ("%N")
        end
