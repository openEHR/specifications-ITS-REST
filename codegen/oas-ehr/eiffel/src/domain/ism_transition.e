...
feature --Access
    ...
    current_state: detachable DV_CODED_TEXT
      
    transition: detachable DV_CODED_TEXT
      
    careflow_step: detachable DV_CODED_TEXT
      
    reason: detachable LIST [DV_TEXT]
      

feature -- Change Element

    set_current_state (a_name: like current_state)
        -- Set 'current_state' with 'a_name'.
      do
        current_state := a_name
      ensure
        current_state_set: current_state = a_name
      end

    set_transition (a_name: like transition)
        -- Set 'transition' with 'a_name'.
      do
        transition := a_name
      ensure
        transition_set: transition = a_name
      end

    set_careflow_step (a_name: like careflow_step)
        -- Set 'careflow_step' with 'a_name'.
      do
        careflow_step := a_name
      ensure
        careflow_step_set: careflow_step = a_name
      end
    ...
    output: STRING
      ...
      do
        ...
        if attached current_state as l_current_state then
          ...
          Result.append (l_current_state.out)
          Result.append ("%N")
        end
        if attached transition as l_transition then
          Result.append ("%Ntransition:")
          Result.append (l_transition.out)
          Result.append ("%N")
        end
        if attached careflow_step as l_careflow_step then
          Result.append ("%Ncareflow_step:")
          Result.append (l_careflow_step.out)
          Result.append ("%N")
        end
        if attached reason as l_reason then
          across l_reason as ic loop
            Result.append ("%N reason:")
