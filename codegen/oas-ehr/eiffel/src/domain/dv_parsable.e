...
feature --Access
    ...
    formalism: detachable STRING_32
...
feature -- Change Element
    ...
    set_formalism (a_name: like formalism)
        -- Set 'formalism' with 'a_name'.
      do
        formalism := a_name
      ensure
        formalism_set: formalism = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        if attached formalism as l_formalism then
          Result.append ("%Nformalism:")
          Result.append (l_formalism.out)
          Result.append ("%N")
        end
      end
end
