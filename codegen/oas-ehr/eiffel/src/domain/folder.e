...
feature --Access
    ...
    items: detachable LIST [OBJECT_REF]
      
    folders: detachable LIST [FOLDER]
      
    details: detachable ITEM_STRUCTURE
...
feature -- Change Element
    ...
    set_folders (a_name: like folders)
        -- Set 'folders' with 'a_name'.
      do
        folders := a_name
      ensure
        folders_set: folders = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        if attached folders as l_folders then
          across l_folders as ic loop
            Result.append ("%N folders:")
            Result.append (ic.item.out)
            Result.append ("%N")
          end
        end
