...
feature --Access
    ...
    var_type: detachable STRING_32
      
    system_id: detachable STRING_32
      
    time_committed: detachable DV_DATE_TIME
      
    change_type: detachable DV_CODED_TEXT
      
    description: detachable DV_TEXT
      
    committer: detachable PARTY_PROXY
      

feature -- Change Element

    set_var_type (a_name: like var_type)
        -- Set 'var_type' with 'a_name'.
      do
        var_type := a_name
      ensure
        var_type_set: var_type = a_name
      end

    set_system_id (a_name: like system_id)
        -- Set 'system_id' with 'a_name'.
      do
        system_id := a_name
      ensure
        system_id_set: system_id = a_name
      end

    set_time_committed (a_name: like time_committed)
        -- Set 'time_committed' with 'a_name'.
      do
        time_committed := a_name
      ensure
        time_committed_set: time_committed = a_name
      end

    set_change_type (a_name: like change_type)
        -- Set 'change_type' with 'a_name'.
      do
        change_type := a_name
      ensure
        change_type_set: change_type = a_name
      end
    ...
    set_committer (a_name: like committer)
        -- Set 'committer' with 'a_name'.
      do
        committer := a_name
      ensure
        committer_set: committer = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass AUDIT_DETAILS%N")
        if attached var_type as l_var_type then
          Result.append ("%Nvar_type:")
          Result.append (l_var_type.out)
          Result.append ("%N")
        end
        if attached system_id as l_system_id then
          Result.append ("%Nsystem_id:")
          Result.append (l_system_id.out)
          Result.append ("%N")
        end
        if attached time_committed as l_time_committed then
          Result.append ("%Ntime_committed:")
          Result.append (l_time_committed.out)
          Result.append ("%N")
        end
        if attached change_type as l_change_type then
          Result.append ("%Nchange_type:")
          Result.append (l_change_type.out)
          Result.append ("%N")
        end
        ...
        if attached committer as l_committer then
          Result.append ("%Ncommitter:")
          Result.append (l_committer.out)
          Result.append ("%N")
        end
      end
end
