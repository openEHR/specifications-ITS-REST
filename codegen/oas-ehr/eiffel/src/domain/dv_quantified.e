...
feature --Access
    ...
    magnitude_status: detachable STRING_32
      

feature -- Change Element

    set_magnitude_status (a_name: like magnitude_status)
        -- Set 'magnitude_status' with 'a_name'.
      do
        magnitude_status := a_name
      ensure
        magnitude_status_set: magnitude_status = a_name
      end
    ...
    output: STRING
      ...
      do
        ...
        if attached magnitude_status as l_magnitude_status then
          ...
          Result.append (l_magnitude_status.out)
          Result.append ("%N")
        end
      end
end
