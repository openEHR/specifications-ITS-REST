...
feature --Access
    ...
    time: detachable DV_DATE_TIME
      
    ism_transition: detachable ISM_TRANSITION
      
    instruction_details: detachable INSTRUCTION_DETAILS
      
    description: detachable ITEM_STRUCTURE
...
feature -- Change Element
    ...
    set_ism_transition (a_name: like ism_transition)
        -- Set 'ism_transition' with 'a_name'.
      do
        ism_transition := a_name
      ensure
        ism_transition_set: ism_transition = a_name
      end

    set_instruction_details (a_name: like instruction_details)
        -- Set 'instruction_details' with 'a_name'.
      do
        instruction_details := a_name
      ensure
        instruction_details_set: instruction_details = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        if attached ism_transition as l_ism_transition then
          Result.append ("%Nism_transition:")
          Result.append (l_ism_transition.out)
          Result.append ("%N")
        end
        if attached instruction_details as l_instruction_details then
          Result.append ("%Ninstruction_details:")
          Result.append (l_instruction_details.out)
          Result.append ("%N")
        end
