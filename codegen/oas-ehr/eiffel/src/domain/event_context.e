...
feature --Access
    ...
    start_time: detachable DV_DATE_TIME
      
    end_time: detachable DV_DATE_TIME
      
    location: detachable STRING_32
      
    setting: detachable DV_CODED_TEXT
      
    other_context: detachable ITEM_STRUCTURE
      
    health_care_facility: detachable PARTY_IDENTIFIED
      
    participations: detachable LIST [PARTICIPATION]
...
feature -- Change Element
    ...
    set_setting (a_name: like setting)
        -- Set 'setting' with 'a_name'.
      do
        setting := a_name
      ensure
        setting_set: setting = a_name
      end

    set_other_context (a_name: like other_context)
        -- Set 'other_context' with 'a_name'.
      do
        other_context := a_name
      ensure
        other_context_set: other_context = a_name
      end

    set_health_care_facility (a_name: like health_care_facility)
        -- Set 'health_care_facility' with 'a_name'.
      do
        health_care_facility := a_name
      ensure
        health_care_facility_set: health_care_facility = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        if attached setting as l_setting then
          Result.append ("%Nsetting:")
          Result.append (l_setting.out)
          Result.append ("%N")
        end
        if attached other_context as l_other_context then
          Result.append ("%Nother_context:")
          Result.append (l_other_context.out)
          Result.append ("%N")
        end
        if attached health_care_facility as l_health_care_facility then
          Result.append ("%Nhealth_care_facility:")
          Result.append (l_health_care_facility.out)
          Result.append ("%N")
        end
