...
feature --Access
    ...
    units: detachable STRING_32
      
    units_system: detachable STRING_32
      
    units_display_name: detachable STRING_32
      

feature -- Change Element

    set_magnitude (a_name: like magnitude)
        -- Set 'magnitude' with 'a_name'.
      do
        magnitude := a_name
      ensure
        magnitude_set: magnitude = a_name
      end

    set_precision (a_name: like precision)
        -- Set 'precision' with 'a_name'.
      do
        precision := a_name
      ensure
        precision_set: precision = a_name
      end
    ...
    set_units_system (a_name: like units_system)
        -- Set 'units_system' with 'a_name'.
      do
        units_system := a_name
      ensure
        units_system_set: units_system = a_name
      end

    set_units_display_name (a_name: like units_display_name)
        -- Set 'units_display_name' with 'a_name'.
      do
        units_display_name := a_name
      ensure
        units_display_name_set: units_display_name = a_name
      end
    ...
    output: STRING
      ...
      do
        ...
        if attached magnitude as l_magnitude then
          ...
          Result.append (l_magnitude.out)
          Result.append ("%N")
        end
        if attached precision as l_precision then
          Result.append ("%Nprecision:")
          Result.append (l_precision.out)
          Result.append ("%N")
        end
        if attached units as l_units then
          Result.append ("%Nunits:")
          Result.append (l_units.out)
          Result.append ("%N")
        end
        if attached units_system as l_units_system then
          Result.append ("%Nunits_system:")
          Result.append (l_units_system.out)
          Result.append ("%N")
        end
        if attached units_display_name as l_units_display_name then
          Result.append ("%Nunits_display_name:")
          Result.append (l_units_display_name.out)
          Result.append ("%N")
        end
      end
end
