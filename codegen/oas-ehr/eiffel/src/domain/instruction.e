...
feature --Access
    ...
    narrative: detachable DV_TEXT
      
    expiry_time: detachable DV_DATE_TIME
      
    wf_definition: detachable DV_PARSABLE
      
    activities: detachable LIST [ACTIVITY]
      

feature -- Change Element

    set_narrative (a_name: like narrative)
        -- Set 'narrative' with 'a_name'.
      do
        narrative := a_name
      ensure
        narrative_set: narrative = a_name
      end

    set_expiry_time (a_name: like expiry_time)
        -- Set 'expiry_time' with 'a_name'.
      do
        expiry_time := a_name
      ensure
        expiry_time_set: expiry_time = a_name
      end

    set_wf_definition (a_name: like wf_definition)
        -- Set 'wf_definition' with 'a_name'.
      do
        wf_definition := a_name
      ensure
        wf_definition_set: wf_definition = a_name
      end

    set_activities (a_name: like activities)
        -- Set 'activities' with 'a_name'.
      do
        activities := a_name
      ensure
        activities_set: activities = a_name
      end
    ...
    output: STRING
      ...
      do
        ...
        if attached narrative as l_narrative then
          ...
          Result.append (l_narrative.out)
          Result.append ("%N")
        end
        if attached expiry_time as l_expiry_time then
          Result.append ("%Nexpiry_time:")
          Result.append (l_expiry_time.out)
          Result.append ("%N")
        end
        if attached wf_definition as l_wf_definition then
          Result.append ("%Nwf_definition:")
          Result.append (l_wf_definition.out)
          Result.append ("%N")
        end
        if attached activities as l_activities then
          across l_activities as ic loop
            Result.append ("%N activities:")
