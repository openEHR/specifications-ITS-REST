...
feature --Access
    ...
    external_ref: detachable PARTY_REF
...
feature -- Change Element
    ...
    set_external_ref (a_name: like external_ref)
        -- Set 'external_ref' with 'a_name'.
      do
        external_ref := a_name
      ensure
        external_ref_set: external_ref = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass PARTY_PROXY%N")
        if attached var_type as l_var_type then
          Result.append ("%Nvar_type:")
          Result.append (l_var_type.out)
          Result.append ("%N")
        end
        if attached external_ref as l_external_ref then
          Result.append ("%Nexternal_ref:")
          Result.append (l_external_ref.out)
          Result.append ("%N")
        end
      end
end
