...
feature --Access
    ...
    normal_range: detachable DV_INTERVAL
      
    other_reference_ranges: detachable LIST [REFERENCE_RANGE]
      

feature -- Change Element

    set_normal_status (a_name: like normal_status)
        -- Set 'normal_status' with 'a_name'.
      do
        normal_status := a_name
      ensure
        normal_status_set: normal_status = a_name
      end

    set_normal_range (a_name: like normal_range)
        -- Set 'normal_range' with 'a_name'.
      do
        normal_range := a_name
      ensure
        normal_range_set: normal_range = a_name
      end

    set_other_reference_ranges (a_name: like other_reference_ranges)
        -- Set 'other_reference_ranges' with 'a_name'.
      do
        other_reference_ranges := a_name
      ensure
        other_reference_ranges_set: other_reference_ranges = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass DV_ORDERED%N")
        if attached normal_status as l_normal_status then
          Result.append ("%Nnormal_status:")
          Result.append (l_normal_status.out)
          Result.append ("%N")
        end
        if attached normal_range as l_normal_range then
          Result.append ("%Nnormal_range:")
          Result.append (l_normal_range.out)
          Result.append ("%N")
        end
        if attached other_reference_ranges as l_other_reference_ranges then
          across l_other_reference_ranges as ic loop
            Result.append ("%N other_reference_ranges:")
