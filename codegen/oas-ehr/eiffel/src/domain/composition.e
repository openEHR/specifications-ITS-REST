...
feature --Access
    ...
    territory: detachable CODE_PHRASE
      
    category: detachable DV_CODED_TEXT
      
    context: detachable EVENT_CONTEXT
      
    composer: detachable PARTY_PROXY
      
    content: detachable LIST [CONTENT_ITEM]
...
feature -- Change Element
    ...
    set_territory (a_name: like territory)
        -- Set 'territory' with 'a_name'.
      do
        territory := a_name
      ensure
        territory_set: territory = a_name
      end
    ...
    set_composer (a_name: like composer)
        -- Set 'composer' with 'a_name'.
      do
        composer := a_name
      ensure
        composer_set: composer = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        if attached territory as l_territory then
          Result.append ("%Nterritory:")
          Result.append (l_territory.out)
          Result.append ("%N")
        end
        ...
        if attached composer as l_composer then
          Result.append ("%Ncomposer:")
          Result.append (l_composer.out)
          Result.append ("%N")
        end
