...
feature --Access
    ...
    match: detachable STRING_32
      
    purpose: detachable DV_CODED_TEXT
      
    target: detachable CODE_PHRASE
      

feature -- Change Element

    set_match (a_name: like match)
        -- Set 'match' with 'a_name'.
      do
        match := a_name
      ensure
        match_set: match = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass TERM_MAPPING%N")
        if attached match as l_match then
          Result.append ("%Nmatch:")
          Result.append (l_match.out)
          Result.append ("%N")
        end
