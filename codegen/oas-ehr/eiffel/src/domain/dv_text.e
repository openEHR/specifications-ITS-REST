...
feature --Access
    ...
    formatting: detachable STRING_32
      
    mappings: detachable LIST [TERM_MAPPING]
...
feature -- Change Element
    ...
    set_hyperlink (a_name: like hyperlink)
        -- Set 'hyperlink' with 'a_name'.
      do
        hyperlink := a_name
      ensure
        hyperlink_set: hyperlink = a_name
      end

    set_formatting (a_name: like formatting)
        -- Set 'formatting' with 'a_name'.
      do
        formatting := a_name
      ensure
        formatting_set: formatting = a_name
      end

    set_mappings (a_name: like mappings)
        -- Set 'mappings' with 'a_name'.
      do
        mappings := a_name
      ensure
        mappings_set: mappings = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass DV_TEXT%N")
        ...
        if attached hyperlink as l_hyperlink then
          Result.append ("%Nhyperlink:")
          Result.append (l_hyperlink.out)
          Result.append ("%N")
        end
        if attached formatting as l_formatting then
          Result.append ("%Nformatting:")
          Result.append (l_formatting.out)
          Result.append ("%N")
        end
        if attached mappings as l_mappings then
          across l_mappings as ic loop
            Result.append ("%N mappings:")
