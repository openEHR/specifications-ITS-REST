...
feature --Access
    ...
    uid: detachable OBJECT_VERSION_ID
      
    preceding_version_uid: detachable OBJECT_VERSION_ID
      
    other_input_version_uids: detachable LIST [OBJECT_VERSION_ID]
      
    lifecycle_state: detachable DV_CODED_TEXT
      
    attestations: detachable LIST [ATTESTATION]
...
feature -- Change Element
    ...
    set_preceding_version_uid (a_name: like preceding_version_uid)
        -- Set 'preceding_version_uid' with 'a_name'.
      do
        preceding_version_uid := a_name
      ensure
        preceding_version_uid_set: preceding_version_uid = a_name
      end

    set_other_input_version_uids (a_name: like other_input_version_uids)
        -- Set 'other_input_version_uids' with 'a_name'.
      do
        other_input_version_uids := a_name
      ensure
        other_input_version_uids_set: other_input_version_uids = a_name
      end

    set_lifecycle_state (a_name: like lifecycle_state)
        -- Set 'lifecycle_state' with 'a_name'.
      do
        lifecycle_state := a_name
      ensure
        lifecycle_state_set: lifecycle_state = a_name
      end

    set_attestations (a_name: like attestations)
        -- Set 'attestations' with 'a_name'.
      do
        attestations := a_name
      ensure
        attestations_set: attestations = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        if attached preceding_version_uid as l_preceding_version_uid then
          Result.append ("%Npreceding_version_uid:")
          Result.append (l_preceding_version_uid.out)
          Result.append ("%N")
        end
        if attached other_input_version_uids as l_other_input_version_uids then
          across l_other_input_version_uids as ic loop
            Result.append ("%N other_input_version_uids:")
            Result.append (ic.item.out)
            Result.append ("%N")
          end
        end
        if attached lifecycle_state as l_lifecycle_state then
          Result.append ("%Nlifecycle_state:")
          Result.append (l_lifecycle_state.out)
          Result.append ("%N")
        end
        if attached attestations as l_attestations then
          across l_attestations as ic loop
            Result.append ("%N attestations:")
            Result.append (ic.item.out)
            Result.append ("%N")
          end
        end
