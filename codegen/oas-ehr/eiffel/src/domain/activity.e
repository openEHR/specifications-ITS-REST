...
feature --Access
    ...
    timing: detachable DV_PARSABLE
      
    action_archetype_id: detachable STRING_32
...
feature -- Change Element
    ...
    set_timing (a_name: like timing)
        -- Set 'timing' with 'a_name'.
      do
        timing := a_name
      ensure
        timing_set: timing = a_name
      end

    set_action_archetype_id (a_name: like action_archetype_id)
        -- Set 'action_archetype_id' with 'a_name'.
      do
        action_archetype_id := a_name
      ensure
        action_archetype_id_set: action_archetype_id = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        if attached timing as l_timing then
          Result.append ("%Ntiming:")
          Result.append (l_timing.out)
          Result.append ("%N")
        end
        if attached action_archetype_id as l_action_archetype_id then
          Result.append ("%Naction_archetype_id:")
          Result.append (l_action_archetype_id.out)
          Result.append ("%N")
        end
