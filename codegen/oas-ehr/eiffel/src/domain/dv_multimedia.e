...
feature --Access
    ...
    alternate_text: detachable STRING_32
      
    uri: detachable DV_URI
      
    data: detachable STRING_32
      
    media_type: detachable CODE_PHRASE
      
    compression_algorithm: detachable CODE_PHRASE
      
    integrity_check: detachable STRING_32
      
    integrity_check_algorithm: detachable CODE_PHRASE
      
    thumbnail: detachable DV_MULTIMEDIA
...
feature -- Change Element
    ...
    set_alternate_text (a_name: like alternate_text)
        -- Set 'alternate_text' with 'a_name'.
      do
        alternate_text := a_name
      ensure
        alternate_text_set: alternate_text = a_name
      end
    ...
    set_compression_algorithm (a_name: like compression_algorithm)
        -- Set 'compression_algorithm' with 'a_name'.
      do
        compression_algorithm := a_name
      ensure
        compression_algorithm_set: compression_algorithm = a_name
      end

    set_integrity_check (a_name: like integrity_check)
        -- Set 'integrity_check' with 'a_name'.
      do
        integrity_check := a_name
      ensure
        integrity_check_set: integrity_check = a_name
      end

    set_integrity_check_algorithm (a_name: like integrity_check_algorithm)
        -- Set 'integrity_check_algorithm' with 'a_name'.
      do
        integrity_check_algorithm := a_name
      ensure
        integrity_check_algorithm_set: integrity_check_algorithm = a_name
      end

    set_thumbnail (a_name: like thumbnail)
        -- Set 'thumbnail' with 'a_name'.
      do
        thumbnail := a_name
      ensure
        thumbnail_set: thumbnail = a_name
      end
    ...
    output: STRING
      ...
      do
        ...
        if attached alternate_text as l_alternate_text then
          ...
          Result.append (l_alternate_text.out)
          Result.append ("%N")
        end
        ...
        if attached compression_algorithm as l_compression_algorithm then
          Result.append ("%Ncompression_algorithm:")
          Result.append (l_compression_algorithm.out)
          Result.append ("%N")
        end
        if attached integrity_check as l_integrity_check then
          Result.append ("%Nintegrity_check:")
          Result.append (l_integrity_check.out)
          Result.append ("%N")
        end
        if attached integrity_check_algorithm as l_integrity_check_algorithm then
          Result.append ("%Nintegrity_check_algorithm:")
          Result.append (l_integrity_check_algorithm.out)
          Result.append ("%N")
        end
        if attached thumbnail as l_thumbnail then
          Result.append ("%Nthumbnail:")
          Result.append (l_thumbnail.out)
          Result.append ("%N")
        end
